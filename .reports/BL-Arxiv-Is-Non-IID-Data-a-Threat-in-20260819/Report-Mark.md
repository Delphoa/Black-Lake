# Report-Mark: Is Non-IID Data a Threat
...
| Authors | Wang, Shuyi; Zuccon, Guido |
| Identifier | arXiv:2204.09272; DOI:10.48550/arXiv.2204.09272 |
| Submitted / source date | 2022/04/20 |
| Record | https://arxiv.org/abs/2204.09272 |
| Full paper | https://arxiv.org/html/2204.09272 |
| PDF | https://arxiv.org/pdf/2204.09272 |
...
| Deployment IDs | `BLAD-2200-20260819-9951C2C3`; `BLAD-2200-20260819-9951C2C3-P68` |

## Concise Research Notes

The paper addresses federated, non-iid, online. The inspected full paper contains explicit method, evaluation, limitation, conclusion, and reference structure beyond the abstract. A short method evidence anchor is: “In this perspective paper we study the effect of non independent and identically distributed (non-IID) data on federated …”. A short evaluation anchor is: “Online learning to rank (OLTR) ( Hofmann 2013 ; Oosterhuis and de Rijke 2018 ; Zhuang and Zuccon …”. These anchors preserve traceability; they do not constitute independent reproduction.

The source positions its named approach as a response to the problem encoded by its title and abstract. A limitation-oriented anchor is: “In this perspective paper we study the effect of non independent and identically distributed (non-IID) data on federated …”. The reviewer interpretation is bounded: transfer requires versioned inputs, baseline parity, leakage checks, uncertainty handling, and failure-condition testing.
...
The selected paper contributes a federated, non-iid, online perspective. The three related DEPs overlap concretely through federated, non-iid, online, rank. Together they support a provenance-first workflow separating primary-source claims, reviewer interpretation, experimental validation, and deployment decisions.
...
2. Create a frozen comparison harness for the paper's non-iid mechanism against simple baselines and negative controls.
3. Add an abstaining review gate that blocks downstream use when provenance, calibration, privacy, or shift checks fail.

### Deeper Relationship Observations

1. FOLTR Unlearning - DEP-E overlaps through federated, rank, online, non-iid, clarifying a neighboring representation or evidence choice.
2. Decoupled Training with - DEP-E overlaps through federated, exposing a complementary evaluation or operating boundary.
...
- Deployment IDs validated: `BLAD-2200-20260819-9951C2C3`; `BLAD-2200-20260819-9951C2C3-P68`.
- Uniform draw index 24,684 of 75,964 units; duplicate exclusions 0; focus exclusions 0; reselections 0.
...
- https://arxiv.org/abs/2204.09272 - metadata, authors, abstract, dates, DOI, and public locators.
- https://arxiv.org/html/2204.09272 - verified full-paper evidence; local copy withheld.
- https://arxiv.org/pdf/2204.09272 - verified primary PDF; local copy withheld.
- https://doi.org/10.48550/arXiv.2204.09272 - publisher identifier.
