# Report-Mark: ChemSafetyBench: Benchmarking LLM Safety on Chemistry Domain
...
- Public sources: https://arxiv.org/abs/2411.16736; https://arxiv.org/html/2411.16736; https://arxiv.org/pdf/2411.16736
- Source state: complete local PDF and full-paper HTML passed the required integrity gate; source files were withheld from public output.
- Batch position: 176 of 200; selection pool contained 469 unseen valid IDs.
...
- Method: Method-related full-paper text: ChemSafetyBench: Benchmarking LLM Safety on Chemistry Domain 1 Introduction 2 Relative Works 2.1 Large Language Models for Chemistry 2.2 Safety Benchmark for LLMs 2.3 Scientific Benchmarks for LLMs 3 Method 3.1 Raw Chemical Materials Collection 3.2 Diversity Diversity of Chemical Tasks Diversity of Chemical Knowledge Diversity of Expression 3.3 Dataset Construction 3.4 Evaluation Evaluation for task property and...
- Evidence/results: Evidence-related full-paper text: ChemSafetyBench: Benchmarking LLM Safety on Chemistry Domain 1 Introduction 2 Relative Works 2.1 Large Language Models for Chemistry 2.2 Safety Benchmark for LLMs 2.3 Scientific Benchmarks for LLMs 3 Method 3.1 Raw Chemical Materials Collection 3.2 Diversity Diversity of Chemical Tasks Diversity of Chemical Knowledge Diversity of Expression 3.3 Dataset Construction 3.4 Evaluation Evaluation for task property and...
- Limitations: Limitation-related full-paper text: ChemSafetyBench: Benchmarking LLM Safety on Chemistry Domain 1 Introduction 2 Relative Works 2.1 Large Language Models for Chemistry 2.2 Safety Benchmark for LLMs 2.3 Scientific Benchmarks for LLMs 3 Method 3.1 Raw Chemical Materials Collection 3.2 Diversity Diversity of Chemical Tasks Diversity of Chemical Knowledge Diversity of Expression 3.3 Dataset Construction 3.4 Evaluation Evaluation for task property and...
...
|---|---|---|---|
| E1 | Full-paper HTML, including title, abstract, headings, and extracted method/evidence text | https://arxiv.org/html/2411.16736 | Primary evidence for notes and claims. |
| E2 | Validated PDF presence and integrity markers | https://arxiv.org/pdf/2411.16736 | Confirms complete source pair; no source file was uploaded. |
| E3 | Canonical arXiv metadata | https://arxiv.org/abs/2411.16736 | Stable identifier and public provenance. |
...
```python
record = {"paper_id": "arXiv:2411.16736", "baseline": "toy-baseline", "data": "synthetic"}
print(record)
```
