# Report-Mark: Imitation Learning with Limited Actions via Diffusion Planners and Deep Koopman Controllers
...
- Identifier: arXiv:2410.07584
- Public sources: https://arxiv.org/abs/2410.07584; https://arxiv.org/html/2410.07584; https://arxiv.org/pdf/2410.07584
- Source state: complete local PDF and full-paper HTML passed the required integrity gate; source files were withheld from public output.
- Batch position: 190 of 200; selection pool contained 469 unseen valid IDs.
...
- Method: Method-related full-paper text: In this work, we propose a plan-then-control framework aimed at improving the action-data efficiency of inverse dynamics controllers by leveraging observational demonstration data. Specifically, we adopt a Deep Koopman Operator framework to model the dynamical system and utilize observation-only trajectories to learn a latent action representation.
- Evidence/results: Evidence-related full-paper text: Imitation Learning with Limited Actions via Diffusion Planners and Deep Koopman Controllers I Introduction II Related Work III Preliminaries III-A Problem Formulation III-B Plan-then-Control with Diffusion Planners and Inverse Dynamics Controllers III-C Koopman Operator Theory IV Imitation Learning with Limited Action Data V Experiments V-A Benchmark Tasks V-B Baselines V-C Results and Analysis VI Case Study:...
- Limitations: Limitation-related full-paper text: This limitation has spurred interest in imitation from observation , where the goal is to learn policies primarily from state observations without corresponding action data. Collisions result in failure.
...
|---|---|---|---|
| E1 | Full-paper HTML, including title, abstract, headings, and extracted method/evidence text | https://arxiv.org/html/2410.07584 | Primary evidence for notes and claims. |
| E2 | Validated PDF presence and integrity markers | https://arxiv.org/pdf/2410.07584 | Confirms complete source pair; no source file was uploaded. |
| E3 | Canonical arXiv metadata | https://arxiv.org/abs/2410.07584 | Stable identifier and public provenance. |
...
```python
record = {"paper_id": "arXiv:2410.07584", "baseline": "toy-baseline", "data": "synthetic"}
print(record)
```
