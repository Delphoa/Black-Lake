...
|---|---|---|---|
| E1 | Full-paper HTML, including title, abstract, headings, and extracted method/evidence text | https://arxiv.org/html/1805.00791 | Primary evidence for notes and claims. |
| E2 | Validated PDF presence and integrity markers | https://arxiv.org/pdf/1805.00791 | Confirms complete source pair; no source file was uploaded. |
| E3 | Canonical arXiv metadata | https://arxiv.org/abs/1805.00791 | Stable identifier and public provenance. |
...
```python
record = {"paper_id": "arXiv:1805.00791", "baseline": "toy-baseline", "data": "synthetic"}
print(record)
```
