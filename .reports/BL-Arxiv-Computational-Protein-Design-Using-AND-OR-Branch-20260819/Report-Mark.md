# Report-Mark: Computational Protein
...
| Authors | Zhou, Yichao; Wu, Yuexin; Zeng, Jianyang |
| Identifier | arXiv:1412.3138; DOI:10.48550/arXiv.1412.3138 |
| Submitted / source date | 2014/12/08 |
| Record | https://arxiv.org/abs/1412.3138 |
| Full paper | https://arxiv.org/html/1412.3138 |
| PDF | https://arxiv.org/pdf/1412.3138 |
...
The selected paper contributes a branch-and-bound, computational, design perspective. The three related DEPs overlap concretely through computational, design, protein, search. Together they support a provenance-first workflow separating primary-source claims, reviewer interpretation, experimental validation, and deployment decisions.

### Potential Implementations

1. Build an offline evidence extractor for branch-and-bound that maps each output to a source section, configuration, and uncertainty record.
...
1. PTransIPs Protein PLM - DEP-E overlaps through protein, computational, design, clarifying a neighboring representation or evidence choice.
2. Calibrated Dataset - DEP-E overlaps through search, computational, design, exposing a complementary evaluation or operating boundary.
3. RL4RLA Teaching ML to - DEP-E overlaps through search, design, showing how implementation assumptions affect practical transfer.
...
- Deployment IDs validated: `BLAD-2200-20260819-8DFEF0DE`; `BLAD-2200-20260819-8DFEF0DE-P90`.
- Uniform draw index 4,638 of 75,964 units; duplicate exclusions 0; focus exclusions 1; reselections 1.
...
- https://arxiv.org/abs/1412.3138 - metadata, authors, abstract, dates, DOI, and public locators.
