# Report-Mark: MDCure: A Scalable Pipeline for Multi-Document Instruction-Following
...
|---|---|---|---|
| E1 | Full-paper HTML, including title, abstract, headings, and extracted method/evidence text | https://arxiv.org/html/2410.23463 | Primary evidence for notes and claims. |
| E2 | Validated PDF presence and integrity markers | https://arxiv.org/pdf/2410.23463 | Confirms complete source pair; no source file was uploaded. |
| E3 | Canonical arXiv metadata | https://arxiv.org/abs/2410.23463 | Stable identifier and public provenance. |
...
```python
record = {"paper_id": "arXiv:2410.23463", "baseline": "toy-baseline", "data": "synthetic"}
print(record)
```
