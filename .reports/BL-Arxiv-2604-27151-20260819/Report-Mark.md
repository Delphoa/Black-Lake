# Report-Mark: Step-level Optimization for Efficient Computer-use Agents
...
|---|---|---|---|
| E1 | Full-paper HTML, including title, abstract, headings, and extracted method/evidence text | https://arxiv.org/html/2604.27151 | Primary evidence for notes and claims. |
| E2 | Validated PDF presence and integrity markers | https://arxiv.org/pdf/2604.27151 | Confirms complete source pair; no source file was uploaded. |
| E3 | Canonical arXiv metadata | https://arxiv.org/abs/2604.27151 | Stable identifier and public provenance. |
...
```python
record = {"paper_id": "arXiv:2604.27151", "baseline": "toy-baseline", "data": "synthetic"}
print(record)
```
