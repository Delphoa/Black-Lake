# Report-Mark: ShadowNPU System and
...
| Authors | Yin, Wangsong; Xu, Daliang; Xu, Mengwei; Huang, Gang; Liu, Xuanzhe |
| Identifier | arXiv:2508.16703; DOI:10.48550/arXiv.2508.16703 |
| Submitted / source date | 2025/08/22 |
| Record | https://arxiv.org/abs/2508.16703 |
| Full paper | https://arxiv.org/html/2508.16703 |
...
| Deployment IDs | `BLAD-2200-20260819-8DFEF0DE`; `BLAD-2200-20260819-8DFEF0DE-P148` |

## Concise Research Notes

The paper addresses algorithm, co-design, inference. The inspected full paper contains explicit method, evaluation, limitation, conclusion, and reference structure beyond the abstract. A short method evidence anchor is: “On-device running Large Language Models (LLMs) is nowadays a critical enabler towards preserving user privacy. We observe that …”. A short evaluation anchor is: “On-device running Large Language Models (LLMs) is nowadays a critical enabler towards preserving user privacy. We observe that …”. These anchors preserve traceability; they do not constitute independent reproduction.

The source positions its named approach as a response to the problem encoded by its title and abstract. A limitation-oriented anchor is: “On-device running Large Language Models (LLMs) is nowadays a critical enabler towards preserving user privacy. We observe that …”. The reviewer interpretation is bounded: transfer requires versioned inputs, baseline parity, leakage checks, uncertainty handling, and failure-condition testing.
...
The selected paper contributes a algorithm, co-design, inference perspective. The three related DEPs overlap concretely through algorithm, co-design, inference, on-device. Together they support a provenance-first workflow separating primary-source claims, reviewer interpretation, experimental validation, and deployment decisions.
...
1. Co-design Hardware and - DEP-E overlaps through co-design, algorithm, clarifying a neighboring representation or evidence choice.
2. Clo-HDnn A 4 66 TFLOPS W - DEP-E overlaps through on-device, exposing a complementary evaluation or operating boundary.
3. APSQ Additive Partial Sum - DEP-E overlaps through co-design, algorithm, inference, showing how implementation assumptions affect practical transfer.
...
- Deployment IDs validated: `BLAD-2200-20260819-8DFEF0DE`; `BLAD-2200-20260819-8DFEF0DE-P148`.
- Uniform draw index 58,308 of 75,964 units; duplicate exclusions 2; focus exclusions 11; reselections 13.
...
- https://arxiv.org/abs/2508.16703 - metadata, authors, abstract, dates, DOI, and public locators.
