# Report-Mark: Metacognition in LLMs: Foundations, Progress, and Opportunities
...
|---|---|---|---|
| E1 | Full-paper HTML, including title, abstract, headings, and extracted method/evidence text | https://arxiv.org/html/2607.11881 | Primary evidence for notes and claims. |
| E2 | Validated PDF presence and integrity markers | https://arxiv.org/pdf/2607.11881 | Confirms complete source pair; no source file was uploaded. |
| E3 | Canonical arXiv metadata | https://arxiv.org/abs/2607.11881 | Stable identifier and public provenance. |
...
```python
record = {"paper_id": "arXiv:2607.11881", "baseline": "toy-baseline", "data": "synthetic"}
print(record)
```
...
- Source URL: https://arxiv.org/html/2607.11881
  - Applies to: primary research notes, evidence ledger, manuscript, and Report-Mark.
  - Notes: Full-paper HTML inspected locally; source file withheld from the public repository.
- Source URL: https://arxiv.org/pdf/2607.11881
  - Applies to: source integrity verification.
  - Notes: PDF inspected locally; source file withheld from the public repository.
- Source URL: https://arxiv.org/abs/2607.11881
