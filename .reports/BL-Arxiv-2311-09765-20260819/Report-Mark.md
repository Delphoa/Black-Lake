...
|---|---|---|---|
| E1 | Full-paper HTML, including title, abstract, headings, and extracted method/evidence text | https://arxiv.org/html/2311.09765 | Primary evidence for notes and claims. |
| E2 | Validated PDF presence and integrity markers | https://arxiv.org/pdf/2311.09765 | Confirms complete source pair; no source file was uploaded. |
| E3 | Canonical arXiv metadata | https://arxiv.org/abs/2311.09765 | Stable identifier and public provenance. |
...
```python
record = {"paper_id": "arXiv:2311.09765", "baseline": "toy-baseline", "data": "synthetic"}
print(record)
```
