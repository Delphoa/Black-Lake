# Report-Mark: Coalitional Permutation

- Deployment job ID: `BLAD-2200-20260819-8DFEF0DE`
- Deployment item ID: `BLAD-2200-20260819-8DFEF0DE-P179`
...
| Field | Value |
|---|---|
| Paper | *Coalitional Permutation Manipulations in the Gale-Shapley Algorithm* |
| Authors | Shen, Weiran; Deng, Yuan; Tang, Pingzhong |
| Identifier | arXiv:1502.07823; DOI:10.48550/arXiv.1502.07823 |
| Submitted / source date | 2015/02/27 |
| Record | https://arxiv.org/abs/1502.07823 |
| Full paper | https://arxiv.org/html/1502.07823 |
| PDF | https://arxiv.org/pdf/1502.07823 |
...
| Deployment IDs | `BLAD-2200-20260819-8DFEF0DE`; `BLAD-2200-20260819-8DFEF0DE-P179` |

## Concise Research Notes

The paper addresses algorithm, coalitional, gale-shapley. The inspected full paper contains explicit method, evaluation, limitation, conclusion, and reference structure beyond the abstract. A short method evidence anchor is: “In this paper, we consider permutation manipulations by any subset of women in the men-proposing version of the …”. A short evaluation anchor is: “In this paper, we consider permutation manipulations by any subset of women in the men-proposing version of the …”. These anchors preserve traceability; they do not constitute independent reproduction.

The source positions its named approach as a response to the problem encoded by its title and abstract. A limitation-oriented anchor is: “However, a major concern of the Gale-Shapley algorithm is its non-truthfulness. While it is known that the algorithm …”. The reviewer interpretation is bounded: transfer requires versioned inputs, baseline parity, leakage checks, uncertainty handling, and failure-condition testing.
...
1. `.lake-data/DEP-E/DEP-E-20260710-Self Learned IDC/self_learned_idc_manuscript.md` - Self-Learned IDC - DEP-E; overlap: permutation.
2. `.lake-data/DEP-E/DEP-E-20260819-Theoretical and Empirical/theoretical_and_empirical_manuscript.md` - Theoretical and Empirical - DEP-E; overlap: permutation.
...
The selected paper contributes a algorithm, coalitional, gale-shapley perspective. The three related DEPs overlap concretely through algorithm, permutation. Together they support a provenance-first workflow separating primary-source claims, reviewer interpretation, experimental validation, and deployment decisions.
...
2. Create a frozen comparison harness for the paper's coalitional mechanism against simple baselines and negative controls.
3. Add an abstaining review gate that blocks downstream use when provenance, calibration, privacy, or shift checks fail.

### Deeper Relationship Observations

1. Self-Learned IDC - DEP-E overlaps through permutation, clarifying a neighboring representation or evidence choice.
2. Theoretical and Empirical - DEP-E overlaps through permutation, exposing a complementary evaluation or operating boundary.
...
- Deployment IDs validated: `BLAD-2200-20260819-8DFEF0DE`; `BLAD-2200-20260819-8DFEF0DE-P179`.
- Uniform draw index 149 of 75,964 units; duplicate exclusions 0; focus exclusions 1; reselections 1.
...
- https://arxiv.org/abs/1502.07823 - metadata, authors, abstract, dates, DOI, and public locators.
