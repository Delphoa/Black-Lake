...
- Excluded within the 24-hour window or earlier in this batch: 28
- Eligible candidates: 89
- Selected DEP: Black-Lake-Data/.lake-data/DEP-20260625-Local AI Intel 2343
- DEP selection: accepted UInt32 3440391922; rejection limit 4294967251; attempt 1; zero-based index 1.
- Supporting source: https://arxiv.org/abs/2603.02062v1
- Supporting selection: pool 11; accepted UInt32 1221975557; zero-based index 0.
- Supporting-source status: Canonical arXiv Atom record inspected.

## Output

- DEP Class path: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-OpenRad a Curated
- Manuscript: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-OpenRad a Curated/openrad-a-curated.md
- DEP Class README: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-OpenRad a Curated/README.md
...
The selected DEP README and deposited source artifact were inspected, followed by canonical metadata for OpenRad: a Curated Repository of Open-access AI models for Radiology. Prior same-DEP review lineage was inspected where available. No original source files were collected.
...
1. Which central claim from OpenRad: a Curated Repository of Open-access AI models for Radiology should receive the first independent matched-baseline test?
