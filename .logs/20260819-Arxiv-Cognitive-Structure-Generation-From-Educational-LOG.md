...
- A uniform cryptographic random index, without a derived seed, selected one-based index 18,951 on draw 23.
...
- Keys included arXiv ID, DOI, normalized title, and `Cognitive-Structure-Generation-From-Educational` slug; the 24-hour marker cutoff was 2026-08-18.
- Duplicate exclusions: 2; focus exclusions: 20; source-gate exclusions: 0; reselections: 22.

## Source Integrity

- Final state: verified complete after one bounded local archive repair.
- PDF: 2,544,651 bytes with a valid `%PDF-` header and trailing `%%EOF`; page markers: 20; sampled text inspection: true.
- Full-paper HTML: 414,408 bytes, 95,629 body characters, 55 headings, and 7 paper-structure terms.
- Unexpected partials: 0. All source and integrity files remain local.

## Public Outputs

- `.logs/20260819-Arxiv-Cognitive-Structure-Generation-From-Educational-LOG.md`
- `.reports/BL-Arxiv-Cognitive-Structure-Generation-From-Educational-20260819/Report-Mark.md`
- `.lake-data/DEP-E/DEP-E-20260819-Cognitive Structure/README.md`
- `.lake-data/DEP-E/DEP-E-20260819-Cognitive Structure/cognitive_structure_manuscript.md`
