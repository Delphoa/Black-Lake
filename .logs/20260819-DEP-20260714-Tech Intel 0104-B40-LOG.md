...
- Excluded within the 24-hour window or earlier in this batch: 41
- Eligible candidates: 76
- Selected DEP: Black-Lake-Data/.lake-data/DEP-20260714-Tech Intel 0104
- DEP selection: accepted UInt32 2874160506; rejection limit 4294967252; attempt 1; zero-based index 30.
- Supporting source: https://arxiv.org/abs/2607.09349v1
- Supporting selection: pool 10; accepted UInt32 1322054761; zero-based index 1.
- Supporting-source status: Canonical arXiv Atom record inspected.

## Output

- DEP Class path: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-Deceptive Grounding
- Manuscript: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-Deceptive Grounding/deceptive-grounding.md
- DEP Class README: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-Deceptive Grounding/README.md
...
The selected DEP README and deposited source artifact were inspected, followed by canonical metadata for Deceptive Grounding: Entity Attribution Failure in Clinical Retrieval-Augmented Generation. No prior same-DEP review lineage was required. No original source files were collected.
...
1. Which central claim from Deceptive Grounding: Entity Attribution Failure in Clinical Retrieval-Augmented Generation should receive the first independent matched-baseline test?
