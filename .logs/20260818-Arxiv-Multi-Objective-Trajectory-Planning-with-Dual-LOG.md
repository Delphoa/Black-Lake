...
- A uniform cryptographic random index, without a derived seed, selected one-based index 40,482 on draw 5.
...
- Keys included arXiv ID, DOI, normalized title, and `Multi-Objective-Trajectory-Planning-with-Dual` slug; the 24-hour marker cutoff was 2026-08-17.
- Duplicate exclusions: 0; focus exclusions: 4; source-gate exclusions: 0; reselections: 4.

## Source Integrity

- Final state: verified complete after one bounded local archive repair.
- PDF: 1,881,694 bytes with a valid `%PDF-` header and trailing `%%EOF`; page markers: 6; sampled text inspection: true.
- Full-paper HTML: 174,451 bytes, 38,051 body characters, 31 headings, and 6 paper-structure terms.
- Unexpected partials: 0. All source and integrity files remain local.

## Public Outputs

- `.logs/20260818-Arxiv-Multi-Objective-Trajectory-Planning-with-Dual-LOG.md`
- `.reports/BL-Arxiv-Multi-Objective-Trajectory-Planning-with-Dual-20260818/Report-Mark.md`
- `.lake-data/DEP-E/DEP-E-20260818-Multi-Objective/README.md`
- `.lake-data/DEP-E/DEP-E-20260818-Multi-Objective/multi_objective_manuscript.md`
