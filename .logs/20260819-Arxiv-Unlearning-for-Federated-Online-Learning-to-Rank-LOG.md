...
- URL: https://arxiv.org/abs/2505.12791

## Random Selection

- `rg --files -g "*.pdf"` enumerated 75,967 PDFs and 75,964 unique parent units.
- A uniform cryptographic random index, without a derived seed, selected one-based index 72,617 on draw 12.
...
- Keys included arXiv ID, DOI, normalized title, and `Unlearning-for-Federated-Online-Learning-to-Rank` slug; the 24-hour marker cutoff was 2026-08-18.
- Duplicate exclusions: 0; focus exclusions: 11; source-gate exclusions: 0; reselections: 11.

## Source Integrity

- Final state: verified complete after one bounded local archive repair.
- PDF: 3,432,822 bytes with a valid `%PDF-` header and trailing `%%EOF`; page markers: 10; sampled text inspection: true.
- Full-paper HTML: 225,692 bytes, 55,690 body characters, 43 headings, and 6 paper-structure terms.
- Unexpected partials: 0. All source and integrity files remain local.

## Public Outputs

- `.logs/20260819-Arxiv-Unlearning-for-Federated-Online-Learning-to-Rank-LOG.md`
- `.reports/BL-Arxiv-Unlearning-for-Federated-Online-Learning-to-Rank-20260819/Report-Mark.md`
- `.lake-data/DEP-E/DEP-E-20260819-Unlearning for Federated/README.md`
- `.lake-data/DEP-E/DEP-E-20260819-Unlearning for Federated/unlearning_for_federated_manuscript.md`
