...
- A uniform cryptographic random index, without a derived seed, selected one-based index 26,075 on draw 13.
...
- Keys included arXiv ID, DOI, normalized title, and `Payload-trajectory-tracking-control-for-aerial` slug; the 24-hour marker cutoff was 2026-08-17.
- Duplicate exclusions: 0; focus exclusions: 12; source-gate exclusions: 0; reselections: 12.

## Source Integrity

- Final state: verified complete after one bounded local archive repair.
- PDF: 1,938,040 bytes with a valid `%PDF-` header and trailing `%%EOF`; page markers: 15; sampled text inspection: true.
- Full-paper HTML: 696,237 bytes, 91,765 body characters, 62 headings, and 8 paper-structure terms.
- Unexpected partials: 0. All source and integrity files remain local.

## Public Outputs

- `.logs/20260818-Arxiv-Payload-trajectory-tracking-control-for-aerial-LOG.md`
- `.reports/BL-Arxiv-Payload-trajectory-tracking-control-for-aerial-20260818/Report-Mark.md`
- `.lake-data/DEP-E/DEP-E-20260818-Payload trajectory/README.md`
- `.lake-data/DEP-E/DEP-E-20260818-Payload trajectory/payload_trajectory_manuscript.md`
