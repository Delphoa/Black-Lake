...
- A uniform cryptographic random index, without a derived seed, selected one-based index 17,490 on draw 1.
...
- Keys included arXiv ID, DOI, normalized title, and `DeepWideSearch-Benchmarking-Depth-and-Width-in` slug; the 24-hour marker cutoff was 2026-08-17.
- Duplicate exclusions: 0; focus exclusions: 0; source-gate exclusions: 0; reselections: 0.

## Source Integrity

- Final state: verified complete after one bounded local archive repair.
- PDF: 1,504,428 bytes with a valid `%PDF-` header and trailing `%%EOF`; page markers: 25; sampled text inspection: true.
- Full-paper HTML: 280,141 bytes, 71,200 body characters, 78 headings, and 7 paper-structure terms.
- Unexpected partials: 0. All source and integrity files remain local.

## Public Outputs

- `.logs/20260818-Arxiv-DeepWideSearch-Benchmarking-Depth-and-Width-in-LOG.md`
- `.reports/BL-Arxiv-DeepWideSearch-Benchmarking-Depth-and-Width-in-20260818/Report-Mark.md`
- `.lake-data/DEP-E/DEP-E-20260818-DeepWideSearch/README.md`
- `.lake-data/DEP-E/DEP-E-20260818-DeepWideSearch/deepwidesearch_manuscript.md`
