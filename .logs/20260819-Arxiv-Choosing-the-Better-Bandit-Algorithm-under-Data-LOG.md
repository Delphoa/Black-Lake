...
- URL: https://arxiv.org/abs/2507.11891

## Random Selection

- `rg --files -g "*.pdf"` enumerated 75,967 PDFs and 75,964 unique parent units.
- A uniform cryptographic random index, without a derived seed, selected one-based index 65,781 on draw 10.
...
- Keys included arXiv ID, DOI, normalized title, and `Choosing-the-Better-Bandit-Algorithm-under-Data` slug; the 24-hour marker cutoff was 2026-08-18.
- Duplicate exclusions: 1; focus exclusions: 8; source-gate exclusions: 0; reselections: 9.

## Source Integrity

- Final state: verified complete after one bounded local archive repair.
- PDF: 2,526,887 bytes with a valid `%PDF-` header and trailing `%%EOF`; page markers: 53; sampled text inspection: true.
- Full-paper HTML: 1,108,719 bytes, 195,835 body characters, 194 headings, and 8 paper-structure terms.
- Unexpected partials: 0. All source and integrity files remain local.

## Public Outputs

- `.logs/20260819-Arxiv-Choosing-the-Better-Bandit-Algorithm-under-Data-LOG.md`
- `.reports/BL-Arxiv-Choosing-the-Better-Bandit-Algorithm-under-Data-20260819/Report-Mark.md`
- `.lake-data/DEP-E/DEP-E-20260819-Choosing the Better/README.md`
- `.lake-data/DEP-E/DEP-E-20260819-Choosing the Better/choosing_the_better_manuscript.md`
