...
- A uniform cryptographic random index, without a derived seed, selected one-based index 49,604 on draw 18.
...
- Keys included arXiv ID, DOI, normalized title, and `Towards-Long-Lived-Robots-Continual-Learning-VLA` slug; the 24-hour marker cutoff was 2026-08-18.
- Duplicate exclusions: 1; focus exclusions: 16; source-gate exclusions: 0; reselections: 17.

## Source Integrity

- Final state: verified complete after one bounded local archive repair.
- PDF: 2,966,469 bytes with a valid `%PDF-` header and trailing `%%EOF`; page markers: 16; sampled text inspection: true.
- Full-paper HTML: 550,230 bytes, 79,009 body characters, 103 headings, and 6 paper-structure terms.
- Unexpected partials: 0. All source and integrity files remain local.

## Public Outputs

- `.logs/20260819-Arxiv-Towards-Long-Lived-Robots-Continual-Learning-VLA-LOG.md`
- `.reports/BL-Arxiv-Towards-Long-Lived-Robots-Continual-Learning-VLA-20260819/Report-Mark.md`
- `.lake-data/DEP-E/DEP-E-20260819-Towards Long-Lived Robots/README.md`
- `.lake-data/DEP-E/DEP-E-20260819-Towards Long-Lived Robots/towards_long_lived_robots_manuscript.md`
