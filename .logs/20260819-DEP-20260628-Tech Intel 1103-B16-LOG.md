...
- Excluded within the 24-hour window or earlier in this batch: 17
- Eligible candidates: 100
- Selected DEP: Black-Lake-Data/.lake-data/DEP-20260628-Tech Intel 1103
- DEP selection: accepted UInt32 312084108; rejection limit 4294967200; attempt 1; zero-based index 8.
- Supporting source: https://arxiv.org/abs/2606.27154v2
- Supporting selection: pool 31; accepted UInt32 3788164626; zero-based index 28.
- Supporting-source status: Canonical arXiv Atom record inspected.

## Output

- DEP Class path: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-OpenRCA 2 0 From Outcome
- Manuscript: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-OpenRCA 2 0 From Outcome/openrca-2-0-from-outcome.md
- DEP Class README: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-OpenRCA 2 0 From Outcome/README.md
...
The selected DEP README and deposited source artifact were inspected, followed by canonical metadata for OpenRCA 2.0: From Outcome Labels to Causal Process Supervision. Prior same-DEP review lineage was inspected where available. No original source files were collected.
...
1. Which central claim from OpenRCA 2.0: From Outcome Labels to Causal Process Supervision should receive the first independent matched-baseline test?
