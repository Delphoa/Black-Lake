...
- Excluded within the 24-hour window or earlier in this batch: 40
- Eligible candidates: 77
- Selected DEP: Black-Lake-Data/.lake-data/DEP-20260725-Tech Intel 1301
- DEP selection: accepted UInt32 1755784316; rejection limit 4294967292; attempt 1; zero-based index 55.
- Supporting source: https://arxiv.org/abs/2607.20723v1
- Supporting selection: pool 10; accepted UInt32 536255396; zero-based index 6.
- Supporting-source status: Canonical arXiv Atom record inspected.

## Output

- DEP Class path: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-Leaky Language Models
- Manuscript: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-Leaky Language Models/leaky-language-models.md
- DEP Class README: Black-Lake/.lake-data/DEP-E/DEP-E-20260819-Leaky Language Models/README.md
...
The selected DEP README and deposited source artifact were inspected, followed by canonical metadata for Leaky Language Models: Stealing Architecture and Inference Optimizations via Per-Token Timing. No prior same-DEP review lineage was required. No original source files were collected.
...
1. Which central claim from Leaky Language Models: Stealing Architecture and Inference Optimizations via Per-Token Timing should receive the first independent matched-baseline test?
