...
- A uniform cryptographic random index, without a derived seed, selected one-based index 19,765 on draw 14.
...
- Keys included arXiv ID, DOI, normalized title, and `Improving-Levenberg-Marquardt-Algorithm-for` slug; the 24-hour marker cutoff was 2026-08-18.
- Duplicate exclusions: 1; focus exclusions: 12; source-gate exclusions: 0; reselections: 13.

## Source Integrity

- Final state: verified complete after one bounded local archive repair.
- PDF: 806,259 bytes with a valid `%PDF-` header and trailing `%%EOF`; page markers: 16; sampled text inspection: true.
- Full-paper HTML: 243,605 bytes, 44,281 body characters, 64 headings, and 7 paper-structure terms.
- Unexpected partials: 0. All source and integrity files remain local.

## Public Outputs

- `.logs/20260819-Arxiv-Improving-Levenberg-Marquardt-Algorithm-for-LOG.md`
- `.reports/BL-Arxiv-Improving-Levenberg-Marquardt-Algorithm-for-20260819/Report-Mark.md`
- `.lake-data/DEP-E/DEP-E-20260819-Improving 08769/README.md`
- `.lake-data/DEP-E/DEP-E-20260819-Improving 08769/improving_08769_manuscript.md`
