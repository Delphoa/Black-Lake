# Preserved failed review record — arXiv:2606.17861v1
...
**Formal object 1 at 2.1 Problem Definition — The expression encodes definition or equality within 2.1 Problem Definition; its semantic role remains bound to that section..** `x=(s,\mathcal{E})\quad\longmapsto\quad y=G,`
Variables: "x, s, E, y, and G".
...
Source locator: private full-paper evidence dossier for arXiv:2606.17861, 2.1 Problem Definition.

**Formal object 2 at 3.1 Task Definition — The expression encodes definition or equality within 3.1 Task Definition; its semantic role remains bound to that section..** `\tau=(s,\mathcal{E},\rho),`
Variables: "s, E, and \\rho".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2606.17861, 3.1 Task Definition.

**Formal object 3 at 3.1 Task Definition — The expression encodes definition or equality within 3.1 Task Definition; its semantic role remains bound to that section..** `\mathcal{E}=(\mathcal{R},\mathcal{W},\mathcal{A},\mathcal{C}),`
Variables: "E, R, W, A, and C".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2606.17861, 3.1 Task Definition.

**Formal object 4 at 3.1 Task Definition — The expression encodes definition or equality within 3.1 Task Definition; its semantic role remains bound to that section..** `y=(G,\Pi),`
Variables: "y, and G".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2606.17861, 3.1 Task Definition.

**Formal object 5 at 3.1 Task Definition — The expression encodes definition or equality within 3.1 Task Definition; its semantic role remains bound to that section..** `\Pi=\{\pi_{i}\}_{i=1}^{n}`
Variables: "\\pi, i, and n".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2606.17861, 3.1 Task Definition.

**Formal object 6 at 3.1 Task Definition — The expression encodes definition or equality within 3.1 Task Definition; its semantic role remains bound to that section..** `O=\mathrm{Replay}_{\mathcal{R}}(G,\Pi).`
Variables: "O, R, and G".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2606.17861, 3.1 Task Definition.
...
4. At How GameCraft-Bench Fills the Gap., the paper reports an inference or deployment action involving game, GameCraft-Bench, benchmark, engine, evaluates, and Fills. *(source locator: private full-paper evidence dossier for arXiv:2606.17861, How GameCraft-Bench Fills the Gap.)*
...
|---|---|---|---|
| OpenGame-Bench | Source mentions tests, and development partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.17861, The Existing Benchmarks Fail to Meet the Desiderata. |
| open-ended | Source mentions tests, and development partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.17861, The Existing Benchmarks Fail to Meet the Desiderata. |
| real-engine | Source mentions tests, and development partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.17861, The Existing Benchmarks Fail to Meet the Desiderata. |
| GameDevBench | Source mentions tests, and development partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.17861, The Existing Benchmarks Fail to Meet the Desiderata. |
| tutorial-derived | Source mentions tests, and development partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.17861, The Existing Benchmarks Fail to Meet the Desiderata. |
| interaction-based | Source mentions tests, and development partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.17861, The Existing Benchmarks Fail to Meet the Desiderata. |
| WebGameBench | Source mentions tests, and development partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.17861, The Existing Benchmarks Fail to Meet the Desiderata. |
| game-engine | Source mentions tests, and development partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.17861, The Existing Benchmarks Fail to Meet the Desiderata. |
...
Not applicable: No explicit baseline or comparator statement was resolved from the extracted evaluation evidence; superiority is therefore not inferred. (source locator: private full-paper evidence dossier for arXiv:2606.17861, baseline and comparison inventory).
...
|---|---|---|---|
| source-defined score | Paper-defined evaluation unit at Category-level Results.; exclusions and conditioning were not mechanically resolved | higher is normally better; confirm the paper's definition and conditioning | private full-paper evidence dossier for arXiv:2606.17861, Category-level Results. |
...
|---|---|---|---|---|---|---|---|
| benchmark-level | GameCraft-Bench | family-level | configuration retained at the cited source locator | source-defined metric | 4 | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Main Results. |
| Opus-4.7 | GameCraft-Bench | comparator retained at the cited source locator; not inferred | configuration retained at the cited source locator | source-defined metric | 4.7, and 41.46% | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Main Results. |
| GPT-5.5 | GameCraft-Bench | Kimi-K2.6 | configuration retained at the cited source locator | source-defined metric | 5.5, 39.49%, 6, and 30.65% | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Main Results. |
| MiMo-V2.5-Pro | GameCraft-Bench | DeepSeek-V4-Pro | configuration retained at the cited source locator | source-defined metric | 5, 24.10%, and 2.15% | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Main Results. |
...
- No independent reproduction was performed for arXiv:2606.17861v1; agents, code, game, and games remains paper-reported. *(source locator: private full-paper evidence dossier for arXiv:2606.17861, The Existing Benchmarks Fail to Meet the Desiderata., and Interactive Evaluation (Desideratum III ))*
...
|---|---|---|---|
| GameCraft-Bench: Can Agents Build Playable Games End-to-End in a Real Game Engine?: paper-reported problem claim centered on Game, generation, agents, and coding | Located at Abstract; extracted numeric markers: 140, 15, 41.46%, and 40% (private full-paper evidence dossier for arXiv:2606.17861, Abstract) | promising but bounded to the paper's stated task | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
| GameCraft-Bench: Can Agents Build Playable Games End-to-End in a Real Game Engine?: paper-reported mechanism claim centered on GameCraft-Bench, Agents, Build, and Playable | Located at mechanism evidence inventory; extracted numeric markers: none required for this claim (private full-paper evidence dossier for arXiv:2606.17861, mechanism evidence inventory) | paper-reported mechanism; causal attribution requires matched ablation | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
| GameCraft-Bench: Can Agents Build Playable Games End-to-End in a Real Game Engine?: paper-reported result claim centered on agents, code, game, and games | Located at The Existing Benchmarks Fail to Meet the Desiderata.; extracted numeric markers: 2, 9, 10, and 1 (private full-paper evidence dossier for arXiv:2606.17861, The Existing Benchmarks Fail to Meet the Desiderata.) | supported only under reported evaluation conditions | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
...
- **Predecessor/prior work (blocked):** The bounded online record did not verify a noncanonical predecessor or prior-work source URL; the corresponding field-level claim remains unvalidated. *(evidence locator: online-vetting check for arXiv:2606.17861)*
- **Alternative or benchmark (checked):** The bounded online record verified reachability for https://tongxuluo.github.io/gamecraft-bench-website. Reachability does not establish ownership, completeness, runnability, or result reproduction. *(evidence locator: https://tongxuluo.github.io/gamecraft-bench-website)*
- **Code/data (blocked):** The bounded online record did not verify a noncanonical code or data artifact URL; the corresponding field-level claim remains unvalidated. *(evidence locator: online-vetting check for arXiv:2606.17861)*
...
Substantive evidence boundary: The profile binds arXiv:2606.17861v1 to a complete local PDF and full-paper HTML, 56 headings, 6 tables, 11 figures, and 42 extracted mathematical objects, and 1 bounded verified noncanonical or canonical URLs. No experiment, code path, data pipeline, hardware measurement, security property, or production claim was independently reproduced.
...
**Proposition:** Reviewer hypothesis: the relation between GameCraft-Bench, and Agents and agents, and code weakens under an untested scale, distribution, or budget shift.
...
> Durably, GameCraft-Bench: Can Agents Build Playable Games End-to-End in a Real Game Engine? should be remembered as a tested relation between GameCraft-Bench, Agents, and Build and agents, code, and game under the configurations at The Existing Benchmarks Fail to Meet the Desiderata., and Interactive Evaluation (Desideratum III ), not as proof outside those conditions.
...
|---|---|---|
| Table 1 | Purpose: The caption frames this object around game, Comparison, existing, generation, benchmarks, and along.; result: Paper-reported numeric markers: 1, and 10; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Table 1 caption |
| Table 2 | Purpose: The caption frames this object around Engine, automated, game-generation, benchmarking, triangle, and indicates.; result: Paper-reported numeric markers: 2; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Table 2 caption |
| Table 3 | Purpose: The caption frames this object around Task, family, coverage, GameCraft-Bench, Counts, and exclude.; result: Paper-reported numeric markers: 3; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Table 3 caption |
| Table 4 | Purpose: The caption frames this object around Benchmark-level, Mechanics, Depth, Visuals, correspond, and four.; result: Paper-reported numeric markers: 4; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Table 4 caption |
| Table 5 | Purpose: The caption frames this object around human, Judge, Preliminary, calibration, Kimi-K2.6, and submissions.; result: Paper-reported numeric markers: 5, and 6; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Table 5 caption |
| Table 6 | Purpose: The caption frames this object around Family-level, benchmark-level, rows, core, mechanics, and content.; result: Paper-reported numeric markers: 6; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Table 6 caption |
| Figure 1 | Purpose: The caption frames this object around playable, games, generated, coding, agents, and GameCraft-Bench.; result: Paper-reported numeric markers: 1, 15, and 140; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Figure 1 caption |
| Figure 2 | Purpose: The caption frames this object around Overview, GameCraft-Bench, Agents, turn, natural-language, and game.; result: Paper-reported numeric markers: 2; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Figure 2 caption |
| Figure 3 | Purpose: The caption frames this object around game, Problem, definition, generation, agent, and transforms.; result: Paper-reported numeric markers: 3; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Figure 3 caption |
| Figure 4 | Purpose: The caption frames this object around Three, desiderata, evaluating, end-to-end, game, and generation.; result: Paper-reported numeric markers: 4; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Figure 4 caption |
| Figure 5 | Purpose: The caption frames this object around game, traces, End-to-end, evaluation, pipeline, and GameCraft-Bench.; result: Paper-reported numeric markers: 5; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Figure 5 caption |
| Figure 6 | Purpose: The caption frames this object around measures, Execution, replay, statistics, across, and agents.; result: Paper-reported numeric markers: 6; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Figure 6 caption |
| Figure 7 | Purpose: The caption frames this object around Example, perception-guided, debugging, Kimi-K2.6, Repeated, and inspection.; result: Paper-reported numeric markers: 7, and 6; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Figure 7 caption |
| Figure 8 | Purpose: The caption frames this object around Tool, usage, call, MiMo-V2.5-Pro, across, and tasks.; result: Paper-reported numeric markers: 8, 5, 140, 0.016, 56.3%, and 16.5%; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Figure 8 caption |
| Figure 9 | Purpose: The caption frames this object around Judge, Bars, stability, fixed, gameplay, and evidence.; result: Paper-reported numeric markers: 9, 10, 5.5, and 1; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Figure 9 caption |
| Figure 10 | Purpose: The caption frames this object around categories, coupled, Correlation, rubric, Kimi-K2.6, and MiMo-V2.5-Pro.; result: Paper-reported numeric markers: 10, 6, and 5; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Figure 10 caption |
| Figure 11 | Purpose: The caption frames this object around Four, Case, Representative, Tasks, cell, and three.; result: Paper-reported numeric markers: 11; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.17861, Figure 11 caption |
