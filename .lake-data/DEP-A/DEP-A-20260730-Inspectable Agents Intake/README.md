# DEP-A-20260730-Inspectable Agents Intake

#ai-agents #interpretability #evaluation #privacy #scientific-agents #memory #verification #archival-intake #whitepaper-review

Public deposition date: 2026-07-30. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260729-Inspectable Agents` at source commit `12ac0b14383980668f6c4c8873752a7ef7ed2b24`. The paired task indicator is `BL-DEPPAIR-20260730-C9A01E3F`.
...
The central durable finding is: Across ten heterogeneous systems, inspectability improves when hidden decisions cross typed boundaries with explicit evidence: threat model, benchmark oracle, belief/action split, internal workspace, removable capability module, clinical action, instrument command, memory scope, cryptographic kernel, or privacy ledger. No single interface certifies the whole agent.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260729-Inspectable%20Agents
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260729-Inspectable Agents` at `12ac0b14383980668f6c4c8873752a7ef7ed2b24`
...
- Source URL: https://github.com/Delphoa/Black-Lake/tree/f91342a701df29adbb2df87886028a11f8095076/.lake-data/DEP-E/DEP-E-20260729-Inspectable%20Agents
  - Item: Persistent arXiv-issued DOI or equivalent canonical locator.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-A/DEP-A-20260719-Oracle%20Agent%20Memory
  - Item: Persistent arXiv-issued DOI or equivalent canonical locator.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
