# Preserved failed review record — arXiv:2606.25905v1
...
Original failure codes: `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `placeholder_scaffolding_present`, `metrics_na_despite_empirical_evidence`, `verified_external_context_missing`, `verified_external_context_missing`.
...
**Paper-reported problem:** For SurgAtlas: A Large-Scale Surgical Video-Language Dataset with 2,391 Hours of Open and Minimally Invasive Surgery, the formal target is bounded to the source-defined relation among surgical, videos, video, SurgAtlas, language, datasets, and public. The task assumptions and stakes are anchored to Abstract, and 1 Introduction; no objective outside those sections is inferred.
...
**Formal object 1 at 3.2 Dataset Construction Pipeline — The expression encodes definition or equality within 3.2 Dataset Construction Pipeline; its semantic role remains bound to that section..** `\mathcal{D}=\{(v_{i},\mathcal{A}_{i})\}_{i=1}^{N}`
Variables: "D, v_{i}, A, i, and N".
...
Source locator: private full-paper evidence dossier for arXiv:2606.25905, 3.2 Dataset Construction Pipeline.

**Formal object 2 at 3.2 Dataset Construction Pipeline — The expression encodes definition or equality within 3.2 Dataset Construction Pipeline; its semantic role remains bound to that section..** `v_{i}=(f_{i}^{1},\ldots,f_{i}^{T_{i}})`
Variables: "v_{i}, f_{i}^{1}, f_{i}^{T, and i".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2606.25905, 3.2 Dataset Construction Pipeline.

**Formal object 3 at 3.2 Dataset Construction Pipeline — The expression encodes definition or equality within 3.2 Dataset Construction Pipeline; its semantic role remains bound to that section..** `m_{i}=(\text{title}_{i},\text{description}_{i},\text{channel}_{i})`
Variables: "m_{i}, and i".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2606.25905, 3.2 Dataset Construction Pipeline.

**Formal object 4 at 3.2.1 Stage 1: Collection and Filtering — The expression encodes definition or equality within 3.2.1 Stage 1: Collection and Filtering; its semantic role remains bound to that section..** `\mathcal{P}=\{p_{1},\ldots,p_{|\mathcal{P}|}\}`
Variables: "P, p_{1}, and p_{".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2606.25905, 3.2.1 Stage 1: Collection and Filtering.

**Formal object 5 at 3.2.1 Stage 1: Collection and Filtering — The expression encodes definition or equality within 3.2.1 Stage 1: Collection and Filtering; its semantic role remains bound to that section..** `\sigma(\text{title}_{j},p)=|\mathcal{T}(\text{title}_{j})\cap\mathcal{T}(p)|/|\mathcal{T}(\text{title}_{j})\cup\mathcal{T}(p)|`
Variables: "j, p, and T".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2606.25905, 3.2.1 Stage 1: Collection and Filtering.

**Formal object 6 at 3.2.1 Stage 1: Collection and Filtering — The expression encodes optimization or selection within 3.2.1 Stage 1: Collection and Filtering; its semantic role remains bound to that section..** `\max_{p\in\mathcal{P}}\sigma(\text{title}_{j},p)\geq\theta_{\sigma}`
Variables: "p, and j".
...
1. At 3.2.7 Stage 7: Public Dataset Conversion, the paper reports a training-related operation involving mathcal, Public, text, splits, Dataset, and supervision. *(source locator: private full-paper evidence dossier for arXiv:2606.25905, 3.2.7 Stage 7: Public Dataset Conversion)*
2. At Cross-regime training ablation., the paper reports a training-related operation involving training, regime, partition, Cross-regime, ablation, and isolate. *(source locator: private full-paper evidence dossier for arXiv:2606.25905, Cross-regime training ablation.)*
3. At Cross-regime training ablation., the paper reports a training-related operation involving surgical, reaches, Cross-regime, training, EgoSurgery-Phase, and open-surgery. *(source locator: private full-paper evidence dossier for arXiv:2606.25905, Cross-regime training ablation.)*
...
1. At 3.2.6 Stage 6: Expert-Validated Evaluation Subset, the paper reports an inference or deployment action involving text, mathcal, Subset, Stage, supervision, and clinically. *(source locator: private full-paper evidence dossier for arXiv:2606.25905, 3.2.6 Stage 6: Expert-Validated Evaluation Subset)*
2. At Fine-grained results., the paper reports an inference or deployment action involving Fine-grained, mathcal, text, split, Open, and categories. *(source locator: private full-paper evidence dossier for arXiv:2606.25905, Fine-grained results.)*
3. At 3.2.1 Stage 1: Collection and Filtering, the paper reports an inference or deployment action involving mathcal, title, text, sigma, Collection, and surgical. *(source locator: private full-paper evidence dossier for arXiv:2606.25905, 3.2.1 Stage 1: Collection and Filtering)*
...
|---|---|---|---|
| frame-level | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.25905, Surgical video datasets. |
| CholecT50 | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.25905, Surgical video datasets. |
| AutoLaparo | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.25905, Surgical video datasets. |
| MultiBypass140 | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.25905, Surgical video datasets. |
| SAR-RARP50 | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.25905, Surgical video datasets. |
| Cataract-101 | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.25905, Surgical video datasets. |
| LEMON | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.25905, Surgical video datasets. |
| SurgBench | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2606.25905, Surgical video datasets. |
...
|---|---|---|---|
| SurgAtlas | Paper-reported comparator at Abstract; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2606.25905, Abstract |
| dataset | Paper-reported comparator at Abstract; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2606.25905, Abstract |
| YouTube | Paper-reported comparator at Abstract; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2606.25905, Abstract |
| open-surgery | Paper-reported comparator at Abstract; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2606.25905, Abstract |
| expert-validated | Paper-reported comparator at Abstract; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2606.25905, Abstract |
| subset | Paper-reported comparator at Abstract; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2606.25905, Abstract |
| segment-level | Paper-reported comparator at Abstract; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2606.25905, Abstract |
| phase-level | Paper-reported comparator at Abstract; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2606.25905, Abstract |
...
|---|---|---|---|
| accuracy | Paper-defined evaluation unit at Cross-regime training ablation.; exclusions and conditioning were not mechanically resolved | higher is normally better; confirm the paper's definition and conditioning | private full-paper evidence dossier for arXiv:2606.25905, Cross-regime training ablation. |
...
|---|---|---|---|---|---|---|---|
| SurgAtlas | SurgAtlas | MIS | configuration retained at the cited source locator | source-defined metric | 10, and 4 | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Cross-regime training ablation. |
| In-domain | SurgAtlas | MIS | configuration retained at the cited source locator | source-defined metric | 42.5, and 39.0 | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Cross-regime training ablation. |
| SurgAtlas-MIS | SurgAtlas | SurgAtlas-Open | configuration retained at the cited source locator | accuracy | 10, 29.1, and 32.2 | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Cross-regime training ablation. |
| EgoSurgery-Phase | SurgAtlas | SurgAtlas-Open | configuration retained at the cited source locator | source-defined metric | 62.5 | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Cross-regime training ablation. |
...
|---|---|---|---|
| SurgAtlas: A Large-Scale Surgical Video-Language Dataset with 2,391 Hours of Open and Minimally Invasive Surgery: paper-reported problem claim centered on surgical, videos, video, and SurgAtlas | Located at Abstract; extracted numeric markers: 15, 291, 2, and 391 (private full-paper evidence dossier for arXiv:2606.25905, Abstract) | promising but bounded to the paper's stated task | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
| SurgAtlas: A Large-Scale Surgical Video-Language Dataset with 2,391 Hours of Open and Minimally Invasive Surgery: paper-reported mechanism claim centered on datasets, surgical, videos, and hierarchical | Located at Surgical vision–language datasets and models.; extracted numeric markers: 36, 34, 35, and 20 (private full-paper evidence dossier for arXiv:2606.25905, Surgical vision–language datasets and models.) | paper-reported mechanism; causal attribution requires matched ablation | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
| SurgAtlas: A Large-Scale Surgical Video-Language Dataset with 2,391 Hours of Open and Minimally Invasive Surgery: paper-reported result claim centered on mathcal, text, surgical, and open | Located at Surgical video datasets.; extracted numeric markers: 28, 18, 31, and 15 (private full-paper evidence dossier for arXiv:2606.25905, Surgical video datasets.) | supported only under reported evaluation conditions | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
...
- **Predecessor/prior work (blocked):** The bounded online record did not verify a noncanonical predecessor or prior-work source URL; the corresponding field-level claim remains unvalidated. *(evidence locator: online-vetting check for arXiv:2606.25905)*
- **Alternative or benchmark (checked):** The bounded online record verified reachability for https://dx.doi.org/10.1016/j.media.2025.103726, https://dx.doi.org/10.1038/s41597-022-01719-2, and https://dx.doi.org/10.1038/s41597-024-03193-4. Reachability does not establish ownership, completeness, runnability, or result reproduction. *(evidence locator: https://dx.doi.org/10.1016/j.media.2025.103726)*
- **Code/data (blocked):** The bounded online record did not verify a noncanonical code or data artifact URL; the corresponding field-level claim remains unvalidated. *(evidence locator: online-vetting check for arXiv:2606.25905)*
...
Substantive evidence boundary: The profile binds arXiv:2606.25905v1 to a complete local PDF and full-paper HTML, 42 headings, 6 tables, 8 figures, and 269 extracted mathematical objects, and 3 bounded verified noncanonical or canonical URLs. No experiment, code path, data pipeline, hardware measurement, security property, or production claim was independently reproduced.
...
|---|---|---|
| Table 1 | Purpose: The caption frames this object around Phase, action, recognition, benchmarks, Macro, and across.; result: Paper-reported numeric markers: 1; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Table 1 caption |
| Table 2 | Purpose: The caption frames this object around CholecT50, triplet, recognition, Endoscapes-CVS, criterion, and accuracy.; result: Paper-reported numeric markers: 2; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Table 2 caption |
| Table 3 | Purpose: The caption frames this object around pairs, open, expert-validated, subset, mathcal, and text.; result: Paper-reported numeric markers: 3, 1, 428, 462, and 4; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Table 3 caption |
| Table 4 | Purpose: The caption frames this object around partition, Cross-regime, training, ablation, Accuracy, and expert-validated.; result: Paper-reported numeric markers: 4, and 10; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Table 4 caption |
| Table 5 | Purpose: The caption frames this object around split, mathcal, text, partition, held-out, and test.; result: Paper-reported numeric markers: 5, 5 %, 10, and 3; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Table 5 caption |
| Table 6 | Purpose: The caption frames this object around partition, expert-validated, subset, mathcal, text, and broken.; result: Paper-reported numeric markers: 6, and 10; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Table 6 caption |
| Figure 1 | Purpose: The caption frames this object around SurgAtlas, Visual, overview, Sampled, frames, and organized.; result: Paper-reported numeric markers: 1; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Figure 1 caption |
| Figure 2 | Purpose: The caption frames this object around surgical, restricted, Comparison, large-scale, video, and datasets.; result: Paper-reported numeric markers: 2, 15, 291, and 391; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Figure 2 caption |
| Figure 3 | Purpose: The caption frames this object around text, alignment, Overview, SurgAtlas, construction, and pipeline.; result: Paper-reported numeric markers: 3, 1, 18, 855, 15, and 291; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Figure 3 caption |
| Figure inventory item 4 | Purpose: The caption frames this object around Macro, phase, action, and benchmarks.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Figure inventory item 4 caption |
| Figure inventory item 5 | Purpose: The caption frames this object around Cholec80, detailed, and metrics.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Figure inventory item 5 caption |
| Figure inventory item 6 | Purpose: The caption frames this object around CholecT50, and Triplet.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Figure inventory item 6 caption |
| Figure inventory item 7 | Purpose: The caption frames this object around Endoscapes-CVS, criterion, and accuracy.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Figure inventory item 7 caption |
| Figure 4 | Purpose: The caption frames this object around specialties, total, open, surgery, Per-specialty, and composition.; result: Paper-reported numeric markers: 4, 18, 70 %, and 70; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2606.25905, Figure 4 caption |
