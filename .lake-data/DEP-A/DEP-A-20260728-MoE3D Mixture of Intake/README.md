# DEP-A-20260728-MoE3D Mixture of Intake

#computer-vision #3d-understanding #multimodal-learning #mixture-of-experts #transformers #segmentation #archival-intake #whitepaper-review

Public deposition date: 2026-07-28. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260726-MoE3D Mixture of Experts` at source commit `c3bbb1767686782d679639b0b0a4f9ec0b3a3813`. The paired task indicator is `BL-DEPPAIR-20260728-C46B15BB`.
...
The central durable finding is: MoE3D replaces one dense multimodal fusion path with top-1 routed specialists for modalities and cross-modal interactions, then combines the routed features through an information-aggregation module and progressive pre-training. The mechanism is plausible for heterogeneous signals, but the reported advantage remains tied to the selected tasks, routing policy, pre-training recipe, and comparator budgets.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260726-MoE3D%20Mixture%20of%20Experts
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260726-MoE3D Mixture of Experts` at `c3bbb1767686782d679639b0b0a4f9ec0b3a3813`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2511.22103
