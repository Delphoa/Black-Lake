# DEP-A-20260729-Local Stochastic Intake

#bilevel-optimization #federated-learning #variance-reduction #fairness #distributed-optimization #archival-intake #whitepaper-review

Public deposition date: 2026-07-29. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260728-Local Stochastic Bilevel` at source commit `6f43c61b1dc7347c0f1af45eae578f2d2ed9b04c`. The paired task indicator is `BL-DEPPAIR-20260729-94924F01`.
...
The central durable finding is: The paper formulates federated bilevel optimization under heterogeneous client data, provides a deterministic FedBiO method, and adds momentum-based variance reduction in FedBiOAcc for the stochastic case. Group-fair federated learning supplies the main application test.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260728-Local%20Stochastic%20Bilevel
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260728-Local Stochastic Bilevel` at `6f43c61b1dc7347c0f1af45eae578f2d2ed9b04c`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2205.01608
