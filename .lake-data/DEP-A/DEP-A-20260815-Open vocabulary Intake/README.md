# DEP-A-20260815-Open vocabulary Intake

#computer-vision #panoptic-segmentation #open-vocabulary #CLIP #representation-learning #archival-intake #whitepaper-review

Public deposition date: 2026-08-15. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260814-Open-vocabulary Panoptic` at source commit `788a182fd8823a0b5b019e8c547e081b5f393882`. The paired task indicator is `BL-DEPPAIR-20260815-504032BF`.
...
The central durable finding is: OPSNet uses embedding modulation as a controlled bridge between a panoptic segmenter and CLIP's aligned visual-language space, seeking novel-class recognition without sacrificing closed-vocabulary quality or requiring massive extra data. Multi-dataset results support the bridge under the reported setup, but do not establish open-world reliability, label completeness, or semantic safety.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260814-Open-vocabulary%20Panoptic
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260814-Open-vocabulary Panoptic` at `788a182fd8823a0b5b019e8c547e081b5f393882`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2303.11324
...
- Source URL: https://arxiv.org/html/2303.11324
  - Item: Complete primary paper inspected across OPSNet, embedding modulation, datasets, protocols, results, ablations, and references.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2303.11324
