# DEP-A-20260729-HeightFormer Intake

#computer-vision #3d-detection #roadside-perception #transformers #voxel-features #autonomous-driving #archival-intake #whitepaper-review

Public deposition date: 2026-07-29. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260728-HeightFormer Learning` at source commit `6f43c61b1dc7347c0f1af45eae578f2d2ed9b04c`. The paired task indicator is `BL-DEPPAIR-20260729-8495E0AB`.
...
The central durable finding is: HeightFormer keeps explicit vertical structure by grouping voxel features into local height sequences, applying attention within each sequence, and reassembling the attended features for roadside monocular 3D detection. The design targets the detail loss of BEV height collapse without paying the cost of unrestricted volumetric attention.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260728-HeightFormer%20Learning
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260728-HeightFormer Learning` at `6f43c61b1dc7347c0f1af45eae578f2d2ed9b04c`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2503.10777
