# DEP-A-20260814-Ultra3D Efficient Intake

#3D-generation #diffusion-models #sparse-voxels #attention #geometry #archival-intake #whitepaper-review

Public deposition date: 2026-08-14. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260813-Ultra3D Efficient and` at source commit `ef1ada6c114897ab17a91db92882139989f414e6`. The paired task indicator is `BL-DEPPAIR-20260814-ECBFBC07`.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260813-Ultra3D%20Efficient%20and
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260813-Ultra3D Efficient and` at `ef1ada6c114897ab17a91db92882139989f414e6`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2507.17745
...
- Source URL: https://arxiv.org/html/2507.17745
  - Item: Complete primary paper inspected, including two-stage pipeline, Part Attention, annotation filtering, resolution studies, user study, efficiency table, and conclusion.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2507.17745
