# DEP-A-20260723-Slide Autofocus Intake

#digital-pathology #whole-slide-imaging #autofocus #image-restoration #medical-imaging #quality-control #archival-intake #whitepaper-review

Public deposition date: 2026-07-23. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260722-Rapid Whole Slide Imaging` at source commit `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`. The paired task indicator is `BL-DEPPAIR-20260723-ADAE220E`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `slide-autofocus-intake-review.md`
...
The central durable finding is: Two-shot virtual autofocus trades repeated mechanical search for a learned image-recovery problem: two deliberately defocused observations carry complementary information, and a U-Net-like model fuses them. Speed is plausible, but diagnostic fidelity and failure detection are the decisive boundaries.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260722-Rapid%20Whole%20Slide%20Imaging
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260722-Rapid Whole Slide Imaging` at `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2003.06630
