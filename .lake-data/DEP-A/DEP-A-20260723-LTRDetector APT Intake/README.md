# DEP-A-20260723-LTRDetector APT Intake

#cybersecurity #advanced-persistent-threats #graph-learning #long-term-dependencies #anomaly-detection #incident-response #archival-intake #whitepaper-review

Public deposition date: 2026-07-23. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260722-LTRDetector Exploring` at source commit `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`. The paired task indicator is `BL-DEPPAIR-20260723-5243454F`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `ltrdetector-apt-intake-review.md`
...
The central durable finding is: LTRDetector's key idea is temporal evidence accumulation: isolated events may look benign, while a long-horizon relationship graph can expose coordinated activity. That advantage depends on retaining provenance, controlling graph growth, and avoiding leakage from incident labels.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260722-LTRDetector%20Exploring
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260722-LTRDetector Exploring` at `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2404.03162
