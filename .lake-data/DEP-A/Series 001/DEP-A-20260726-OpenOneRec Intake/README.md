# DEP-A-20260726-OpenOneRec Intake

#recommender-systems #generative-recommendation #large-language-models #open-source #evaluation #governance #archival-intake #whitepaper-review

Public deposition date: 2026-07-26. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260724-OpenOneRec Technical` at source commit `8552616cf447baccfab43d7f461087e0e16295b2`. The paired task indicator is `BL-DEPPAIR-20260726-432EAAF9`.
...
The central durable finding is: OpenOneRec aims to turn a proprietary-style end-to-end generative recommender into an inspectable, reproducible stack. Openness improves auditability only when data transformations, tokenization, objectives, retrieval, evaluation, and serving coordinates are all pinned rather than merely releasing selected code.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260724-OpenOneRec%20Technical
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260724-OpenOneRec Technical` at `8552616cf447baccfab43d7f461087e0e16295b2`
