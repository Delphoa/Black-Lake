# DEP-A-20260726-Unveiling the Intake

#large-language-models #prompt-optimization #lexical-sensitivity #black-box-optimization #evaluation #archival-intake #whitepaper-review

Public deposition date: 2026-07-26. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260723-Unveiling the Lexical Sen` at source commit `8552616cf447baccfab43d7f461087e0e16295b2`. The paired task indicator is `BL-DEPPAIR-20260726-CFC44121`.
...
The central durable finding is: The source shows that seemingly small lexical choices can shift task accuracy, then frames prompt repair as black-box combinatorial optimization. COPLE is therefore better viewed as search over a brittle discrete interface than as a general solution to instruction robustness.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260723-Unveiling%20the%20Lexical%20Sen
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260723-Unveiling the Lexical Sen` at `8552616cf447baccfab43d7f461087e0e16295b2`
