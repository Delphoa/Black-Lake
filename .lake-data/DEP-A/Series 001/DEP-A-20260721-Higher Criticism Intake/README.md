# DEP-A-20260721-Higher Criticism Intake

#statistics #multiple-testing #higher-criticism #berk-jones #sparse-signals #hypothesis-testing #archival-intake #whitepaper-review

Public deposition date: 2026-07-21. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260720-Higher Criticism` at source commit `f66e620eda73edf9535664de38f9703e2711cae3`. The paired task indicator is `BL-DEPPAIR-20260721-E348BEFD`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `higher-criticism-intake-review.md`
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260720-Higher%20Criticism
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260720-Higher Criticism` at `f66e620eda73edf9535664de38f9703e2711cae3`
...
- Source URL: https://arxiv.org/abs/1411.1437
  - Item: Canonical v3 identity, authors, abstract, and publication links checked.
...
- Source URL: https://ar5iv.labs.arxiv.org/html/1411.1437
  - Item: Complete-paper HTML fallback used by the DEP-E; current browser access was constrained.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.1214/15-AOS1312
  - Item: Final journal identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `higher-criticism-intake-review.md`
