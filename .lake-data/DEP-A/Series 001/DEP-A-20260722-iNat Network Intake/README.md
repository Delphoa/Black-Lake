# DEP-A-20260722-iNat Network Intake

#citizen-science #network-science #inaturalist #bipartite-graphs #link-prediction #urban-data #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260721-Network Analysis` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-8F69F001`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `inat-network-intake-review.md`
...
The central durable finding is: The paper's useful move is representational: model users and projects as two node classes so participation structure is not collapsed into a one-mode social graph. That unusual structure can become a benchmark, but it also imports platform policy, sampling, and missingness into every network conclusion.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260721-Network%20Analysis
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260721-Network Analysis` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2310.10693
  - Item: Canonical identity, authors, version, and abstract checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2310.10693
  - Item: Complete-paper locator preserved by the DEP-E.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2310.10693
  - Item: Persistent identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `inat-network-intake-review.md`
