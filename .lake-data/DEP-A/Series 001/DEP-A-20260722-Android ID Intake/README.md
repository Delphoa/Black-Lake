# DEP-A-20260722-Android ID Intake

#android #privacy #device-identifiers #access-control #custom-rom #mobile-security #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260721-Security Non resettable` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-B7045D88`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `android-id-intake-review.md`
...
The central durable finding is: Platform-level identifier restrictions can be undone downstream: custom Android vendors expose stable identifiers through properties and settings with weak access control. The security object is therefore the entire distribution and vendor customization chain, not only the upstream API.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260721-Security%20Non%20resettable
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260721-Security Non resettable` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2502.15270
  - Item: Canonical identity, authors, version, and abstract-level large-scale results checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2502.15270
  - Item: Complete-paper locator preserved by the DEP-E.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2502.15270
  - Item: Persistent identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `android-id-intake-review.md`
