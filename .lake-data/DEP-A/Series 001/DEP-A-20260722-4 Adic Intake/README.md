# DEP-A-20260722-4 Adic Intake

#information-theory #number-theory #quaternary-sequences #4-adic-complexity #autocorrelation #cryptanalysis #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260721-4 Adic Complexity` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-D7216FFD`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `4-adic-intake-review.md`
...
The central durable finding is: The durable claim is narrower than sequence security: the paper determines 4-adic complexity for specified interleaved quaternary families using correlation and finite-field Gauss-period machinery, which bears on resistance to one rational-approximation attack model under those construction assumptions.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260721-4%20Adic%20Complexity
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260721-4 Adic Complexity` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2209.10279
  - Item: Canonical identity, authors, version, and abstract-level theorem scope checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://ar5iv.labs.arxiv.org/html/2209.10279
  - Item: Complete-paper locator preserved by the DEP-E.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2209.10279
  - Item: Persistent identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `4-adic-intake-review.md`
