# DEP-A-20260721-Semantic Skill MoE Intake

#robotics #diffusion-policy #mixture-of-experts #semantic-routing #compositional-transfer #simulation #safety #archival-intake #whitepaper-review

Public deposition date: 2026-07-21. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260719-Semantic Skill MoE` at source commit `f66e620eda73edf9535664de38f9703e2711cae3`. The paired task indicator is `BL-DEPPAIR-20260721-A7BEE995`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `semantic-skill-moe-intake-review.md`
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260719-Semantic%20Skill%20MoE
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260719-Semantic Skill MoE` at `f66e620eda73edf9535664de38f9703e2711cae3`
...
- Source URL: https://arxiv.org/abs/2605.23477
  - Item: Canonical title, authors, v1 identity, abstract, and full-text locators checked.
...
- Source URL: https://arxiv.org/html/2605.23477
  - Item: Official full paper reopened for segmentation, routing, evaluation, ablations, and limitations.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2605.23477
  - Item: Persistent identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `semantic-skill-moe-intake-review.md`
