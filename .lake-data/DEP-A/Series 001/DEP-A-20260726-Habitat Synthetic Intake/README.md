# DEP-A-20260726-Habitat Synthetic Intake

#embodied-ai #object-navigation #synthetic-data #3d-scenes #simulation #dataset-governance #archival-intake #whitepaper-review

Public deposition date: 2026-07-26. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260724-Habitat Synthetic Scenes` at source commit `8552616cf447baccfab43d7f461087e0e16295b2`. The paired task indicator is `BL-DEPPAIR-20260726-95A6BF58`.
...
The central durable finding is: HSSD-200 argues that synthetic 3D scenes can be curated as serious navigation infrastructure rather than decorative assets. Their value lies in scale, controllability, and annotation, but transfer depends on asset diversity, physical plausibility, and a measured synthetic-to-real gap.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260724-Habitat%20Synthetic%20Scenes
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260724-Habitat Synthetic Scenes` at `8552616cf447baccfab43d7f461087e0e16295b2`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2306.11290
