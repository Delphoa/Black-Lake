# DEP-A-20260721-FEMOT Tracking Intake

#multi-object-tracking #event-cameras #rgb-event-fusion #frequency-domain #temporal-memory #benchmarking #archival-intake #whitepaper-review

Public deposition date: 2026-07-21. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260720-FEMOT Tracking` at source commit `f66e620eda73edf9535664de38f9703e2711cae3`. The paired task indicator is `BL-DEPPAIR-20260721-4085D280`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `femot-tracking-intake-review.md`
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260720-FEMOT%20Tracking
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260720-FEMOT Tracking` at `f66e620eda73edf9535664de38f9703e2711cae3`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2606.14094
  - Item: Canonical v1 identity, authors, abstract, and complete-text links checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2606.14094
  - Item: Official complete paper reopened for dataset construction, architecture, tables, ablations, and limitations.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://github.com/Event-AHU/FEMOT
  - Item: Paper-declared implementation locator; repository code was not executed.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `femot-tracking-intake-review.md`
