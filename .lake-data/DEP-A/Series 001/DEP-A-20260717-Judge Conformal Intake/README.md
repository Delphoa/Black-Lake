# DEP-A-20260717-Judge Conformal Intake

#llm-evaluation #conformal-prediction #uncertainty #calibration #archival-intake #whitepaper-review

Public deposition date: 2026-07-17. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260716-Judge Conformal` at source commit `695f4473ebb1174f78bd9a027184a7fb8bf2847e`. The paired task indicator is `BL-DEPPAIR-20260717-60D5570C`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `judge-conformal-intake-review.md`
...
The central durable finding is: The work is best understood as an evaluation-evidence envelope: token-logit features and held-out human ratings support split-conformal intervals whose coverage is conditional on exchangeability, while width, slice support, calibration age, judge/prompt identity, label quality, and review capacity determine whether those intervals are operationally useful.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260716-Judge%20Conformal
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260716-Judge Conformal` at `695f4473ebb1174f78bd9a027184a7fb8bf2847e`
...
- Source URL: https://arxiv.org/abs/2509.18658v1
  - Item: Canonical title, authors, version, and abstract checked in this run.
...
- Source URL: https://github.com/BruceSheng1202/Analyzing_Uncertainty_of_LLM-as-a-Judge
  - Item: Official implementation surface pinned by the source DEP-E; not executed and no visible license was re-established here.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2509.18658
  - Item: Persistent arXiv DOI.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `judge-conformal-intake-review.md`
