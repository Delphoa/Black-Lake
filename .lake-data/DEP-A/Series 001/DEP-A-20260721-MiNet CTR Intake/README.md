# DEP-A-20260721-MiNet CTR Intake

#recommender-systems #click-through-rate #cross-domain-learning #attention #behavioral-data #privacy #online-evaluation #archival-intake #whitepaper-review

Public deposition date: 2026-07-21. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer` at source commit `f66e620eda73edf9535664de38f9703e2711cae3`. The paired task indicator is `BL-DEPPAIR-20260721-D1F836ED`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `minet-ctr-intake-review.md`
...
The central durable finding is: MiNet's durable mechanism is gated behavioral transfer: long-term cross-domain, short-term source, and short-term target interests are distilled separately and then fused conditionally for each target impression. The reported gains are useful, but private data, rating-derived labels, sparse uncertainty, privacy exposure, and a two-week production test limit generality.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260719-MiNet%20CTR%20Transfer
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer` at `f66e620eda73edf9535664de38f9703e2711cae3`
...
- Source URL: https://arxiv.org/abs/2008.02974
  - Item: Canonical title, authors, CIKM 2020 status, abstract, and source locators checked.
...
- Source URL: https://ar5iv.labs.arxiv.org/html/2008.02974
  - Item: Complete-paper fallback locator recorded by the DEP-E; current browser access remained limited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2008.02974
  - Item: Persistent arXiv identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `minet-ctr-intake-review.md`
