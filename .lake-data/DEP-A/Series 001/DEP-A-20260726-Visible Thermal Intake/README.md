# DEP-A-20260726-Visible Thermal Intake

#computer-vision #visible-thermal #small-object-detection #multimodal-fusion #benchmarking #safety #archival-intake #whitepaper-review

Public deposition date: 2026-07-26. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260724-Visible-Thermal Tiny` at source commit `8552616cf447baccfab43d7f461087e0e16295b2`. The paired task indicator is `BL-DEPPAIR-20260726-44D46027`.
...
The central durable finding is: Visible-thermal tiny-object detection is fundamentally a weak-evidence fusion problem: each modality can rescue the other under adverse conditions, but alignment, scale, and sensor quality can also manufacture false confidence. Benchmark gains must be paired with modality-specific failure accounting.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260724-Visible-Thermal%20Tiny
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260724-Visible-Thermal Tiny` at `8552616cf447baccfab43d7f461087e0e16295b2`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2406.14482
