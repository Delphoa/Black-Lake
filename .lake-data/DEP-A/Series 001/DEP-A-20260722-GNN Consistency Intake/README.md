# DEP-A-20260722-GNN Consistency Intake

#graph-neural-networks #fraud-detection #sampling #attention #consistency #calibration #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260721-Alleviating Inconsistency` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-A06AC617`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `gnn-consistency-intake-review.md`
...
The central durable finding is: GraphConsis makes aggregation an explicit evidence-selection policy: enrich context, estimate neighbor consistency, sample accordingly, and weight relation channels separately. That can reduce harmful message passing, but the score remains a learned heuristic rather than proof of fraud or trustworthiness.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260721-Alleviating%20Inconsistency
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260721-Alleviating Inconsistency` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2005.00625
  - Item: Canonical current identity, authors, versions, and abstract checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://ar5iv.labs.arxiv.org/html/2005.00625
  - Item: Complete-paper locator preserved by the DEP-E.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://github.com/safe-graph/DGFraud
  - Item: Author-linked code locator; code not run.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.1145/3397271.3401253
  - Item: Publisher identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `gnn-consistency-intake-review.md`
