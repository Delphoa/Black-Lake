# DEP-A-20260720-DiscourseFlip Intake

#rag-security #retrieval-poisoning #opinion-manipulation #provenance #semantic-graphs #defense-in-depth #archival-intake #whitepaper-review

Public deposition date: 2026-07-20. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260719-DiscourseFlip RAG Risk` at source commit `5211c0ea55952389dc988c2a37444aefcaadda67`. The paired task indicator is `BL-DEPPAIR-20260720-523F81E9`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `discourseflip-intake-review.md`
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260719-DiscourseFlip%20RAG%20Risk
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260719-DiscourseFlip RAG Risk` at `5211c0ea55952389dc988c2a37444aefcaadda67`
...
- Source URL: https://arxiv.org/abs/2606.01212
  - Item: Canonical title, eight-author record, v2 history, abstract, DOI, and complete-text locators checked in this run.
...
- Source URL: https://arxiv.org/html/2606.01212
  - Item: Authorized complete-paper locator reopened for defensive primary context; no payload or source file was deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2606.01212
  - Item: Persistent arXiv identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `discourseflip-intake-review.md`
