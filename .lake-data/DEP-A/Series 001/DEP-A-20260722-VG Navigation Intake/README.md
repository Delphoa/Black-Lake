# DEP-A-20260722-VG Navigation Intake

#robotics #autonomous-navigation #gaussian-process #traversability #sensor-fusion #uncertainty #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260720-VG Navigable Space` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-527DCC02`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `vg-navigation-intake-review.md`
...
The central durable finding is: VG-SGP is best understood as a dual-evidence proposal layer: geometry defines where motion appears physically feasible, semantics defines where motion appears contextually acceptable, and uncertainty should trigger abstention rather than serve as a safety certificate.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260720-VG%20Navigable%20Space
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260720-VG Navigable Space` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
...
- Source URL: https://arxiv.org/abs/2407.06545
  - Item: Canonical identity, authors, IROS 2024 status, version, and abstract checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2407.06545
  - Item: Complete-paper locator preserved by the DEP-E; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2407.06545
  - Item: Persistent identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `vg-navigation-intake-review.md`
