# DEP-A-20260726-Shuffled Intake

#motion-generation #autoregressive-models #transformers #dependency-graphs #animation #evaluation #archival-intake #whitepaper-review

Public deposition date: 2026-07-26. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260724-Shuffled Autoregress` at source commit `8552616cf447baccfab43d7f461087e0e16295b2`. The paired task indicator is `BL-DEPPAIR-20260726-03615863`.
...
The central durable finding is: Shuffled Autoregression shows that generation order is part of the model, not a fixed chronological law. A sparse keyframe-local-fill-smoothing graph sharply outperforms left-to-right prediction on the paper's motion task, while ambiguous metrics and one constructed dataset limit generality.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260724-Shuffled%20Autoregress
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260724-Shuffled Autoregress` at `8552616cf447baccfab43d7f461087e0e16295b2`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2306.06367v1
