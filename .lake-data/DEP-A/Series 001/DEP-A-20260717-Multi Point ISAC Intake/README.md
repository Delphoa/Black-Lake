# DEP-A-20260717-Multi Point ISAC Intake

#isac #sensor-fusion #beamforming #wireless-optimization #archival-intake #whitepaper-review

Public deposition date: 2026-07-17. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC` at source commit `695f4473ebb1174f78bd9a027184a7fb8bf2847e`. The paired task indicator is `BL-DEPPAIR-20260717-3D877C1B`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `multi-point-isac-intake-review.md`
...
The central durable finding is: The paper's durable insight is negative marginal sensing value: a device helps fusion only if its calibrated view and achievable SINR add more information than the power and interference it consumes. Exact heterogeneous voting is a small-system audit oracle; zero forcing, mean-error binomial fusion, and local mode search are approximations whose gaps must remain visible.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260716-Multi-Point%20ISAC
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC` at `695f4473ebb1174f78bd9a027184a7fb8bf2847e`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2208.07592v2
...
- Source URL: https://ar5iv.labs.arxiv.org/html/2208.07592
  - Item: Approved full-paper rendering used by the source DEP-E; not reopened page by page here.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.1109/LWC.2022.3213883
  - Item: Published IEEE Wireless Communications Letters record.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2208.07592
  - Item: Persistent arXiv DOI.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `multi-point-isac-intake-review.md`
