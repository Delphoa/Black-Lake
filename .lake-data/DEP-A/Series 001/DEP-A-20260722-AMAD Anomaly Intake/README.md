# DEP-A-20260722-AMAD Anomaly Intake

#anomaly-detection #categorical-data #multiscale-learning #adversarial-autoencoder #time-series #industrial-monitoring #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260721-AMAD Anomaly` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-02265100`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `amad-anomaly-intake-review.md`
...
The central durable finding is: AMAD's durable contribution is multiresolution scoring: categorical events are reconstructed both as instances and as temporal blocks, allowing point and collective anomalies to coexist. The benchmark, however, is built from constructed anomalies and balanced tests that do not resemble live prevalence.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260721-AMAD%20Anomaly
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260721-AMAD Anomaly` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
...
- Source URL: https://arxiv.org/abs/1907.06582
  - Item: Canonical identity, authors, workshop status, and abstract checked.
...
- Source URL: https://github.com/pkumc/AMAD
  - Item: Official implementation locator; not executed.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.1145/3326937.3341256
  - Item: Published workshop identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `amad-anomaly-intake-review.md`
