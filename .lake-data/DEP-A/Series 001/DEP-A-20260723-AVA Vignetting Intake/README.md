# DEP-A-20260723-AVA Vignetting Intake

#adversarial-machine-learning #computer-vision #vignetting #robustness #physical-models #security-evaluation #archival-intake #whitepaper-review

Public deposition date: 2026-07-23. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260722-AVA Vignetting Attack` at source commit `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`. The paired task indicator is `BL-DEPPAIR-20260723-B4A4D79C`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `ava-vignetting-intake-review.md`
...
The central durable finding is: AVA demonstrates that an optical-looking transformation can be adversarial, but its strongest variant gains power by relaxing physical structure; attack success, perceptual naturalness, transfer, and camera realizability must therefore be audited as separate properties.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260722-AVA%20Vignetting%20Attack
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260722-AVA Vignetting Attack` at `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2105.05558
