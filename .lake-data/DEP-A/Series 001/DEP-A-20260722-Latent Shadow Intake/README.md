# DEP-A-20260722-Latent Shadow Intake

#computer-vision #shadow-removal #latent-diffusion #residual-generation #image-fidelity #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260721-Controlling Latent` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-CE8A37E3`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `latent-shadow-intake-review.md`
...
The central durable finding is: Residual generation narrows diffusion's freedom: preserve the observed image and synthesize only the shadow correction. Cross-timestep self-enhancement and skip-connected encoding then try to keep the correction trajectory faithful, but can still reinforce systematic artifacts.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260721-Controlling%20Latent
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260721-Controlling Latent` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
...
- Source URL: https://arxiv.org/abs/2412.02322
  - Item: Canonical identity, authors, v1 status, and abstract checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2412.02322
  - Item: Complete-paper locator preserved by the DEP-E.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2412.02322
  - Item: Persistent identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `latent-shadow-intake-review.md`
