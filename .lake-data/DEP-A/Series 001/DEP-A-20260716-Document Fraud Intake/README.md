# DEP-A-20260716-Document Fraud Intake

#document-forensics #multimodal-llm #receipt-fraud #calibration #evaluation #archival-intake #whitepaper-review

Public deposition date: 2026-07-16. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM` at source commit `84175d48e5ef802d8ed0fcef7373d4bd7717a294`. The paired task indicator is `BL-DEPPAIR-20260716-B588D3CD`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `document-fraud-intake-review.md`
...
The central durable finding is: General multimodal LLMs show useful reasoning cues on receipt manipulation but remain unreliable forensic detectors. The paper's best LLM result is moderate and denominator-sensitive; deployment should treat model explanations as triage evidence, never as dispositive authenticity judgments.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260715-Document%20Fraud%20LLM
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM` at `84175d48e5ef802d8ed0fcef7373d4bd7717a294`
...
- Source URL: https://arxiv.org/abs/2508.11021
  - Item: Canonical metadata record.
...
- Source URL: https://arxiv.org/html/2508.11021
  - Item: Complete paper rendering inspected for methods, tables, figures, and appendix evidence.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
...
- Source URL: https://doi.org/10.48550/arXiv.2508.11021
  ...
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `document-fraud-intake-review.md`
