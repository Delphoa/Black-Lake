# DEP-A-20260804-SADD RNB Intake

#naive-bayes #discretization #semi-supervised-learning #pseudo-labels #tabular-data #evaluation #archival-intake #whitepaper-review

Public deposition date: 2026-08-04. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260803-SADD RNB` at source commit `ba8a4ee74ef6128c7a43e7f27af4eee8b6a455bc`. The paired task indicator is `BL-DEPPAIR-20260804-C2987C25`.
...
The central durable finding is: SADD uses pseudo-labels and a sample-size-dependent relaxation of the MDLP split threshold to retain class-discriminative intervals, then integrates the map with regularized Naive Bayes. The results are broad within UCI, but the main framework's use of unlabeled test covariates makes protocol semantics a first-class part of the claim.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260803-SADD%20RNB
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260803-SADD RNB` at `ba8a4ee74ef6128c7a43e7f27af4eee8b6a455bc`
