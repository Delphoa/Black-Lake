# DEP-A-20260721-DUET Setwise CTR Intake

#recommender-systems #click-through-rate #pre-ranking #set-wise-modeling #co-training #pseudo-labels #industrial-ml #archival-intake #whitepaper-review

Public deposition date: 2026-07-21. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260719-DUET Setwise CTR` at source commit `f66e620eda73edf9535664de38f9703e2711cae3`. The paired task indicator is `BL-DEPPAIR-20260721-6AE0C456`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `duet-setwise-ctr-intake-review.md`
...
The central durable finding is: DUET reframes pre-ranking from independent scoring into a budgeted set decision, then extends supervision to unexposed candidates through peer pseudo-labels. The mechanism is operationally plausible and backed by offline and short online evidence, but correlated peer errors, exposure feedback, latency tails, and long-term diversity remain the governing uncertainties.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260719-DUET%20Setwise%20CTR
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260719-DUET Setwise CTR` at `f66e620eda73edf9535664de38f9703e2711cae3`
...
- Source URL: https://arxiv.org/abs/2510.24369
  - Item: Canonical identity, authors, v1 status, abstract, and full-text links checked.
...
- Source URL: https://arxiv.org/html/2510.24369
  - Item: Official full paper reopened for framework, deployment, experiments, and limitations.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2510.24369
  - Item: Persistent arXiv identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `duet-setwise-ctr-intake-review.md`
