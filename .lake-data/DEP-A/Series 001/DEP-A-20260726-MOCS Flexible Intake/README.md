# DEP-A-20260726-MOCS Flexible Intake

#communications #coding-theory #complementary-sequences #boolean-functions #correlation #formal-verification #archival-intake #whitepaper-review

Public deposition date: 2026-07-26. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260724-MOCS Flexible Lengths` at source commit `8552616cf447baccfab43d7f461087e0e16295b2`. The paired task indicator is `BL-DEPPAIR-20260726-3576811A`.
...
The central durable finding is: The paper provides direct generalized-Boolean-function constructions for non-power-of-two complementary sequence families. Its durable result is constructive existence under explicit prefix and partition conditions, not a proof that one-half is universally maximal or that the sequences improve a deployed system.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260724-MOCS%20Flexible%20Lengths
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260724-MOCS Flexible Lengths` at `8552616cf447baccfab43d7f461087e0e16295b2`
...
- Source URL: https://arxiv.org/html/2003.06991
