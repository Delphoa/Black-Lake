# DEP-A-20260722-Hallo4 Motion Intake

#portrait-animation #video-diffusion #direct-preference-optimization #motion-conditioning #synthetic-media-safety #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260721-Hallo4 Portrait Motion` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-1917E2CD`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `hallo4-motion-intake-review.md`
...
The central durable finding is: Hallo4 combines human-preference optimization with temporal-to-channel redistribution of fast motion cues. It improves selected synchronization, expression, and motion measures, but those gains coexist with weaker FID/FVD in several comparisons, making alignment explicitly metric selective.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260721-Hallo4%20Portrait%20Motion
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260721-Hallo4 Portrait Motion` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
...
- Source URL: https://arxiv.org/abs/2505.23525
  - Item: Canonical v4 identity, authors, and abstract checked.
...
- Source URL: https://github.com/fudan-generative-vision/hallo4
  - Item: Official repository locator; code not run.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2505.23525
  - Item: Persistent identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `hallo4-motion-intake-review.md`
