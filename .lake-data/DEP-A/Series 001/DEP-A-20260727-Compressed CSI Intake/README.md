# DEP-A-20260727-Compressed CSI Intake

#wireless-communications #massive-mimo #channel-state-information #compressed-sensing #autoencoders #signal-processing #archival-intake #whitepaper-review

Public deposition date: 2026-07-27. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback` at source commit `e8876bd1e9ebe85e7be041d50f78e5428fb9f089`. The paired task indicator is `BL-DEPPAIR-20260727-784EB5FE`.
...
The central durable finding is: The paper learns the measurement matrix jointly with an interpretable sparse-recovery autoencoder, moving optimization into the sensing step rather than accepting random Gaussian or Bernoulli projections. Reported low-measurement recovery is promising but distribution- and channel-model dependent.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260726-Compressed%20CSI%20Feedback
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback` at `e8876bd1e9ebe85e7be041d50f78e5428fb9f089`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/1903.02127
