# DEP-A-20260722-Urban Visual Intake

#urban-studies #street-level-imagery #computer-vision #cities #measurement #governance #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260721-Urban Visual Intelligence` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-CD522B62`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `urban-visual-intake-review.md`
...
The central durable finding is: Urban Visual Intelligence is most durable as a measurement-governance framework: street imagery and AI expand urban observation, but every inferred city property remains conditioned on camera coverage, time, platform policy, model bias, and the difference between visible form and lived experience.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260721-Urban%20Visual%20Intelligence
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260721-Urban Visual Intelligence` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2301.00580
  - Item: Canonical current v2 identity, authors, and abstract checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2301.00580
  - Item: Complete-paper locator preserved by the DEP-E.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2301.00580
  - Item: Persistent identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `urban-visual-intake-review.md`
