# DEP-A-20260721-Context Backdoor Intake

#agent-security #embodied-agents #backdoor-defense #provenance #least-privilege #runtime-safety #archival-intake #whitepaper-review

Public deposition date: 2026-07-21. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260720-Context Backdoor` at source commit `f66e620eda73edf9535664de38f9703e2711cae3`. The paired task indicator is `BL-DEPPAIR-20260721-533D4870`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `context-backdoor-intake-review.md`
...
The central durable finding is: The source demonstrates that contextual artifacts can behave like software dependencies for embodied agents. Safety therefore requires provenance, dependency visibility, least privilege, and runtime behavioral containment across the full context-to-action chain; simple prompts, filters, or unassisted human review are insufficient.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260720-Context%20Backdoor
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260720-Context Backdoor` at `f66e620eda73edf9535664de38f9703e2711cae3`
...
- Source URL: https://arxiv.org/abs/2408.02882
  - Item: Canonical identity, authors, v1 record, abstract, and complete-text links checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2408.02882
  - Item: Official full paper reopened for threat model, evaluations, defenses, and limitations.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2408.02882
  - Item: Persistent identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `context-backdoor-intake-review.md`
