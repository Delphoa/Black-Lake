# DEP-A-20260727-Removal then Intake

#computer-vision #rgb-infrared #object-detection #multimodal-fusion #thermal-imaging #autonomous-systems #archival-intake #whitepaper-review

Public deposition date: 2026-07-27. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260725-Removal then Selection A` at source commit `e8876bd1e9ebe85e7be041d50f78e5428fb9f089`. The paired task indicator is `BL-DEPPAIR-20260727-6898D633`.
...
The central durable finding is: RSDet argues that multimodal fusion should first remove within-modality interference and then select cross-modal evidence. The coarse-to-fine sequence is mechanistically plausible and supported across three datasets, but redundancy estimates may themselves suppress rare or safety-critical cues.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260725-Removal%20then%20Selection%20A
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260725-Removal then Selection A` at `e8876bd1e9ebe85e7be041d50f78e5428fb9f089`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2401.10731
