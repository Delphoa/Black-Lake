# DEP-A-20260721-VaTD Canonical Intake

#statistical-physics #variational-modeling #generative-models #temperature-dependence #ising-model #xy-model #reproducibility #archival-intake #whitepaper-review

Public deposition date: 2026-07-21. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260720-VaTD Canonical` at source commit `f66e620eda73edf9535664de38f9703e2711cae3`. The paired task indicator is `BL-DEPPAIR-20260721-ED4A4AA7`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `vatd-canonical-intake-review.md`
...
The central durable finding is: VaTD treats a continuum of temperatures as one conditional generative modeling object and minimizes a temperature-averaged free-energy objective. That abstraction can amortize thermodynamic sampling and derivative estimation across a range, but reported speed, scale, and accuracy remain conditional on model capacity, reference samplers, hardware estimates, and configuration provenance.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260720-VaTD%20Canonical
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260720-VaTD Canonical` at `f66e620eda73edf9535664de38f9703e2711cae3`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2404.18404
  - Item: Canonical v2 identity, authors, abstract, journal links, and source locators checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2404.18404
  - Item: Official complete paper reopened for the objective, derivative estimators, scaling, and comparisons.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.1103/8wx7-kyx8
  - Item: Final Physical Review Letters identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://github.com/li012589/vatd
  - Item: Paper-declared implementation locator; source DEP-E inspected an identified repository state, but no code was executed here.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `vatd-canonical-intake-review.md`
