# DEP-A-20260730-Decoupled Training Intake

#federated-learning #vision-language-models #reinforcement-learning #parameter-efficient-tuning #non-iid-data #archival-intake #whitepaper-review

Public deposition date: 2026-07-30. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260729-Decoupled Training with` at source commit `12ac0b14383980668f6c4c8873752a7ef7ed2b24`. The paired task indicator is `BL-DEPPAIR-20260730-3AC4C365`.
...
The central durable finding is: Decoupling shared representation adaptation from client-local reinforcement fine-tuning can reduce destructive interference in heterogeneous federated vision-language learning. The evidence remains bounded to the reported clients, reward construction, and communication regime; local optimization can just as easily entrench bias or gaming.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260729-Decoupled%20Training%20with
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260729-Decoupled Training with` at `12ac0b14383980668f6c4c8873752a7ef7ed2b24`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2605.27900
