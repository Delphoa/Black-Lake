# DEP-A-20260727-Global Commander Intake

#embodied-ai #vision-language-navigation #agents #planning #grounding #robotics #archival-intake #whitepaper-review

Public deposition date: 2026-07-27. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260725-Global Commander and` at source commit `e8876bd1e9ebe85e7be041d50f78e5428fb9f089`. The paired task indicator is `BL-DEPPAIR-20260727-404C397C`.
...
The central durable finding is: DACo separates long-horizon deliberation from egocentric execution through a Global Commander and Local Operative. The reported zero-shot gains support cognitive load partitioning, while real-world robustness still depends on subgoal validity, replanning triggers, perception errors, and coordination cost.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260725-Global%20Commander%20and
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260725-Global Commander and` at `e8876bd1e9ebe85e7be041d50f78e5428fb9f089`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2602.18941
