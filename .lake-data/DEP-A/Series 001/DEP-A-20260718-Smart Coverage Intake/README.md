# DEP-A-20260718-Smart Coverage Intake

#software-testing #search-based-testing #coverage #genetic-algorithms #multi-objective-optimization #evosuite #archival-intake #whitepaper-review

Public deposition date: 2026-07-18. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals` at source commit `2a010d716ea8d56b8d64a2d58641675dbdeb857a`. The paired task indicator is `BL-DEPPAIR-20260718-EFD3AAC7`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `smart-coverage-intake-review.md`
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260717-Smart%20Coverage%20Goals
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals` at `2a010d716ea8d56b8d64a2d58641675dbdeb857a`
...
- Source URL: https://arxiv.org/abs/2208.04096
  - Item: Canonical title, authors, submission, abstract, and source locators checked in this run.
...
- Source URL: https://doi.org/10.1145/3551349.3556902
  - Item: Persistent ASE publication DOI.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://conf.researchr.org/details/ase-2022/ase-2022-research-papers/14/Selectively-Combining-Multiple-Coverage-Goals-in-Search-Based-Unit-Test-Generation
  - Item: Official ASE paper record used by the source DEP-E.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `smart-coverage-intake-review.md`
