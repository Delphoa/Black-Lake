# DEP-A-20260722-Equivariant Rec Intake

#sequential-recommendation #contrastive-learning #equivariance #augmentation #user-behavior #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260721-Equivariant Contrastive` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-E11F143E`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `equivariant-rec-intake-review.md`
...
The central durable finding is: ECL-SR separates benign perturbations that should preserve user intent from invasive perturbations that should change representation predictably. Contrastive learning becomes an augmentation-semantics problem, not a blanket invariance objective.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260721-Equivariant%20Contrastive
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260721-Equivariant Contrastive` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2211.05290
  - Item: Canonical current v4 identity, RecSys 2023 status, and abstract checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2211.05290
  - Item: Complete-paper locator preserved by the DEP-E.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2211.05290
  - Item: Persistent identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `equivariant-rec-intake-review.md`
