# DEP-A-20260731-Sat3R Satellite Intake

#satellite-imagery #depth-estimation #digital-surface-models #camera-models #foundation-models #geospatial #archival-intake #whitepaper-review

Public deposition date: 2026-07-31. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260730-Sat3R Satellite DSM` at source commit `ad2ef40ef80d1c15687588a3c054a8a955334fcd`. The paired task indicator is `BL-DEPPAIR-20260731-63BE3EA9`.
...
The central durable finding is: Sat3R adapts a monocular depth foundation model to satellite imagery by deriving metric pseudo-depth from Rational Polynomial Camera geometry and fine-tuning with a scale-aware loss. The reported accuracy-speed tradeoff is promising, but pseudo-label fidelity, geographic shift, camera metadata, and evaluation alignment remain decisive.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260730-Sat3R%20Satellite%20DSM
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260730-Sat3R Satellite DSM` at `ad2ef40ef80d1c15687588a3c054a8a955334fcd`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2605.07264
