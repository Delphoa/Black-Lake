# DEP-A-20260726-Spiking Pose Intake

#event-cameras #spiking-neural-networks #human-pose #transformers #energy-efficiency #synthetic-data #archival-intake #whitepaper-review

Public deposition date: 2026-07-26. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking` at source commit `8552616cf447baccfab43d7f461087e0e16295b2`. The paired task indicator is `BL-DEPPAIR-20260726-D1355D5D`.
...
The central durable finding is: The method combines binary spiking queries and keys with real-valued regression values to track 3D pose from events alone. Its operation-count energy estimate is attractive, but physical efficiency and broad human generalization remain unproven.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260724-Spiking%20Pose%20Tracking
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking` at `8552616cf447baccfab43d7f461087e0e16295b2`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2303.09681
