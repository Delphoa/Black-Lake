# DEP-A-20260720-MA-VLM PNU Intake

#vision-language-models #content-moderation #self-training #weak-supervision #pnu-learning #model-governance #archival-intake #whitepaper-review

Public deposition date: 2026-07-20. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260719-MA-VLM PNU Moderation` at source commit `5211c0ea55952389dc988c2a37444aefcaadda67`. The paired task indicator is `BL-DEPPAIR-20260720-7713085A`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `ma-vlm-pnu-intake-review.md`
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260719-MA-VLM%20PNU%20Moderation
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260719-MA-VLM PNU Moderation` at `5211c0ea55952389dc988c2a37444aefcaadda67`
...
- Source URL: https://arxiv.org/abs/2511.13759
  - Item: Canonical title, nine-author record, v1 date, AAAI-26 comment, DOI, license, and complete-text locators checked in this run.
...
- Source URL: https://arxiv.org/html/2511.13759
  - Item: Authorized complete-paper locator reopened for primary context; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://github.com/Social-AI-Studio/MA-VLM
  - Item: Official public implementation repository inspected as availability context; code was not executed.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `ma-vlm-pnu-intake-review.md`
