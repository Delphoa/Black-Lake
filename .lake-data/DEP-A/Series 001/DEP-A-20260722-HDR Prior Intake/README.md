# DEP-A-20260722-HDR Prior Intake

#hdrtv #sdrtv #generative-priors #vqgan #color #image-processing #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260721-Beyond Feature Mapping` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-78E5C8DC`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `hdr-prior-intake-review.md`
...
The central durable finding is: The paper reframes ill-posed SDR-to-HDR conversion from unconstrained feature mapping to referenced selection: learn a discrete prior from real HDR content, then match SDR content into that prior. Reliability therefore depends on prior coverage and content-faithful matching, not generation quality alone.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260721-Beyond%20Feature%20Mapping
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260721-Beyond Feature Mapping` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2411.10775
  - Item: Canonical current v3 identity, IJCAI 2025 status, authors, and abstract checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2411.10775
  - Item: Complete-paper locator preserved by the DEP-E.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2411.10775
  - Item: Persistent identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `hdr-prior-intake-review.md`
