# DEP-A-20260723-Temporal PTQ Intake

#diffusion-models #post-training-quantization #temporal-features #model-compression #image-generation #hardware-acceleration #archival-intake #whitepaper-review

Public deposition date: 2026-07-23. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260722-Temporal Feature Matters` at source commit `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`. The paired task indicator is `BL-DEPPAIR-20260723-D44D3352`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `temporal-ptq-intake-review.md`
...
The central durable finding is: Diffusion quantization is trajectory preservation, not ordinary layer reconstruction. Temporal features steer every denoising round, so their error should determine whether a module is reconstructed, discretely calibrated, or served from a cache.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260722-Temporal%20Feature%20Matters
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260722-Temporal Feature Matters` at `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2407.19547
