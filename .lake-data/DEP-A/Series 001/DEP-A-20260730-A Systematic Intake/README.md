# DEP-A-20260730-A Systematic Intake

#large-language-models #prompt-optimization #survey #evaluation #search #reproducibility #archival-intake #whitepaper-review

Public deposition date: 2026-07-30. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260729-A Systematic Survey of` at source commit `12ac0b14383980668f6c4c8873752a7ef7ed2b24`. The paired task indicator is `BL-DEPPAIR-20260730-30B3E8BA`.
...
The central durable finding is: Automatic prompt optimization is not one algorithmic family but a five-part search system whose behavior depends on the prompt parameterization, feedback signal, search operator, evaluator, and stopping rule. The survey's main archival value is its common vocabulary; it does not establish that automated search is uniformly better than careful manual or fixed-prompt baselines.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260729-A%20Systematic%20Survey%20of
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260729-A Systematic Survey of` at `12ac0b14383980668f6c4c8873752a7ef7ed2b24`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2502.16923
