# DEP-A-20260726-OmniSQL Intake

#text-to-sql #large-language-models #synthetic-data #databases #program-synthesis #evaluation #archival-intake #whitepaper-review

Public deposition date: 2026-07-26. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260724-OmniSQL Synthesizing` at source commit `8552616cf447baccfab43d7f461087e0e16295b2`. The paired task indicator is `BL-DEPPAIR-20260726-B6ED59E2`.
...
The central durable finding is: OmniSQL's core proposition is that text-to-SQL performance can be scaled through a synthesis pipeline that expands questions, schemas, and executable queries. The durable issue is not generation volume but semantic validity, leakage control, and execution-grounded provenance.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260724-OmniSQL%20Synthesizing
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260724-OmniSQL Synthesizing` at `8552616cf447baccfab43d7f461087e0e16295b2`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2503.02240
