# DEP-A-20260716-Joint Sensing Intake

#mobile-edge-computing #age-of-information #sensing #offloading #optimization #archival-intake #whitepaper-review

Public deposition date: 2026-07-16. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260715-Joint Sensing MEC` at source commit `84175d48e5ef802d8ed0fcef7373d4bd7717a294`. The paired task indicator is `BL-DEPPAIR-20260716-81D2ADCA`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `joint-sensing-intake-review.md`
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260715-Joint%20Sensing%20MEC
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260715-Joint Sensing MEC` at `84175d48e5ef802d8ed0fcef7373d4bd7717a294`
...
- Source URL: https://arxiv.org/abs/2210.17025
  - Item: Canonical metadata and manuscript record.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2210.17025
  - Item: Canonical complete-paper locator; not deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.1109/TWC.2023.3261338
  - Item: Published IEEE Transactions on Wireless Communications record.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://www.eng.auburn.edu/~szm0001/papers/TWC2023Chen.pdf
  - Item: Author-hosted complete manuscript locator used as primary context.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `joint-sensing-intake-review.md`
