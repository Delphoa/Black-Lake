# DEP-A-20260729-FLASH Efficient Intake

#robotics #visuomotor-control #flow-matching #trajectory-representation #real-time-control #archival-intake #whitepaper-review

Public deposition date: 2026-07-29. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260728-FLASH Efficient` at source commit `6f43c61b1dc7347c0f1af45eae578f2d2ed9b04c`. The paired task indicator is `BL-DEPPAIR-20260729-CCC36FFB`.
...
The central durable finding is: FLASH replaces long discrete action chunks with compact Legendre-polynomial trajectory coefficients and initializes flow matching from recent trajectory history rather than Gaussian noise. This shortens the generative path and supports single-step policy inference while preserving analytic velocity commands.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260728-FLASH%20Efficient
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260728-FLASH Efficient` at `6f43c61b1dc7347c0f1af45eae578f2d2ed9b04c`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2605.15492
