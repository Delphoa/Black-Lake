# DEP-A-20260729-CanCal Towards Intake

#cybersecurity #ransomware #industrial-systems #behavior-detection #endpoint-security #real-time-systems #archival-intake #whitepaper-review

Public deposition date: 2026-07-29. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260728-CanCal Towards Real-time` at source commit `6f43c61b1dc7347c0f1af45eae578f2d2ed9b04c`. The paired task indicator is `BL-DEPPAIR-20260729-98620CCE`.
...
The central durable finding is: CanCal treats expensive behavioral detection as a second-stage analysis rather than a universal background process. Lightweight decoy-file and ransom-note monitors first identify suspicious processes, after which a multi-granularity behavioral classifier performs deeper analysis and the response layer isolates high-risk activity.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260728-CanCal%20Towards%20Real-time
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260728-CanCal Towards Real-time` at `6f43c61b1dc7347c0f1af45eae578f2d2ed9b04c`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2408.16515
