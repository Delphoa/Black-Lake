# DEP-A-20260722-Music Memory Intake

#music-information-retrieval #memorability #dataset #audio #behavioral-study #prediction #archival-intake #whitepaper-review

Public deposition date: 2026-07-22. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260721-Dataset Baselines` at source commit `44c247a4c18eca0d6d8113a4602600c044d76d5b`. The paired task indicator is `BL-DEPPAIR-20260722-FAA62774`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `music-memory-intake-review.md`
...
The central durable finding is: Music memorability is not an intrinsic scalar waiting to be read from audio; it is a behavioral measurement produced by an exposure, delay, participant population, and interactive protocol. Prediction quality is therefore inseparable from label reliability and population scope.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260721-Dataset%20Baselines
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260721-Dataset Baselines` at `44c247a4c18eca0d6d8113a4602600c044d76d5b`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2405.12847
  - Item: Canonical identity, ISMIR 2023 status, authors, and abstract checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2405.12847
  - Item: Complete-paper locator preserved by the DEP-E.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.5281/zenodo.10265251
  - Item: Related dataset/resource DOI.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `music-memory-intake-review.md`
