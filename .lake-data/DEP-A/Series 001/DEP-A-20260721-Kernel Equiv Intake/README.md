# DEP-A-20260721-Kernel Equiv Intake

#statistics #equivalence-testing #kernel-methods #mmd #ksd #bootstrap #model-validation #archival-intake #whitepaper-review

Public deposition date: 2026-07-21. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260719-Kernel Equivalence` at source commit `f66e620eda73edf9535664de38f9703e2711cae3`. The paired task indicator is `BL-DEPPAIR-20260721-FF1CE440`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `kernel-equivalence-intake-review.md`
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260719-Kernel%20Equivalence
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260719-Kernel Equivalence` at `f66e620eda73edf9535664de38f9703e2711cae3`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2603.10886
  - Item: Canonical v2 identity, authors, abstract, license, and complete-text locators checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2603.10886
  - Item: Official full paper reopened for hypotheses, algorithms, theory, experiments, and limitations.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://jmlr.org/papers/v13/gretton12a.html
  - Item: Primary predecessor for MMD context.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `kernel-equivalence-intake-review.md`
