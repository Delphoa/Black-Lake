# DEP-A-20260804-QFT Tuning Intake

#large-language-models #full-parameter-tuning #quantization #optimizer-state #memory-efficiency #evaluation #archival-intake #whitepaper-review

Public deposition date: 2026-08-04. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260803-QFT Tuning` at source commit `ba8a4ee74ef6128c7a43e7f27af4eee8b6a455bc`. The paired task indicator is `BL-DEPPAIR-20260804-05A0A50D`.
...
The central durable finding is: QFT compresses the persistent training state rather than reducing the trainable parameter space: gradients and Lion momentum use INT8, dense weights are quantized, sparse outliers remain protected, and stack-based gradient flow coordinates updates. The reported memory gain is substantial, but it buys additional approximation, kernels, metadata, and runtime overhead that must be measured together.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260803-QFT%20Tuning
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260803-QFT Tuning` at `ba8a4ee74ef6128c7a43e7f27af4eee8b6a455bc`
