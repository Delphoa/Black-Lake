# DEP-A-20260721-CFE2 Explain Intake

#information-retrieval #counterfactual-explanations #search-ranking #masked-language-models #human-evaluation #provenance #archival-intake #whitepaper-review

Public deposition date: 2026-07-21. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260720-CFE2 Search Explain` at source commit `f66e620eda73edf9535664de38f9703e2711cae3`. The paired task indicator is `BL-DEPPAIR-20260721-E3BA2D4F`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `cfe2-search-explain-intake-review.md`
...
The central durable finding is: CFE2 produces testable local probes by editing a query until one observed result overtakes another. The flip is valuable because it can be recomputed, but it is not a causal explanation of the ranker, and near-perfect FlipRate is partly a ceiling shared with baselines. Provenance, stability, privacy, and plain-language scope notices are required.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260720-CFE2%20Search%20Explain
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260720-CFE2 Search Explain` at `f66e620eda73edf9535664de38f9703e2711cae3`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2301.10389
  - Item: Canonical v3 identity, authors, ICTIR status, abstract, and source locators checked.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2301.10389
  - Item: Official complete-text locator reopened; browser retrieval was intermittent, so the source DEP-E remains the detailed evidence record.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.1145/3664190.3672508
  - Item: Final published DOI and venue identity.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `cfe2-search-explain-intake-review.md`
