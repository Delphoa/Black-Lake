# DEP-A-20260723-SIM MARL Power Intake

#wireless-communications #multi-agent-reinforcement-learning #massive-mimo #metasurfaces #power-allocation #constraint-control #archival-intake #whitepaper-review

Public deposition date: 2026-07-23. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260722-SIM MARL Power` at source commit `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`. The paired task indicator is `BL-DEPPAIR-20260723-69BACF54`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `sim-marl-power-intake-review.md`
...
The central durable finding is: The system converts coupled power and phase optimization into cooperative decentralized control. A shared recurrent actor can scale across access points, but noisy-value exploration and reported spectral-efficiency gains do not replace deterministic power, phase, calibration, and rollback gates.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260722-SIM%20MARL%20Power
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260722-SIM MARL Power` at `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`
...
- Source URL: https://arxiv.org/html/2502.19675
...
- Source URL: https://doi.org/10.48550/arXiv.2502.19675
  ...
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `sim-marl-power-intake-review.md`
