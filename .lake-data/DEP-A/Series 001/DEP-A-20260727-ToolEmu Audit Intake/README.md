# DEP-A-20260727-ToolEmu Audit Intake

#agent-safety #tool-use #sandboxing #evaluation #benchmarking #reproducibility #archival-intake #whitepaper-review

Public deposition date: 2026-07-27. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260725-ToolEmu Audit` at source commit `e8876bd1e9ebe85e7be041d50f78e5428fb9f089`. The paired task indicator is `BL-DEPPAIR-20260727-9D96C51F`.
...
The central durable finding is: ToolEmu makes dangerous tool-agent states cheaper to discover by emulating tools and adversarial environments, but its simulator, evaluator, and benchmark are model-dependent instruments. The DEP-E audit also finds release drift, making pinned manifests and real-sandbox confirmation essential.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260725-ToolEmu%20Audit
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260725-ToolEmu Audit` at `e8876bd1e9ebe85e7be041d50f78e5428fb9f089`
