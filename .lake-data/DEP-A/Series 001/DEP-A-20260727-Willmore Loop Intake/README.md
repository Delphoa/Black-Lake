# DEP-A-20260727-Willmore Loop Intake

#differential-geometry #willmore-surfaces #harmonic-maps #loop-groups #integrable-systems #mathematics #archival-intake #whitepaper-review

Public deposition date: 2026-07-27. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260725-Willmore Loop Groups` at source commit `e8876bd1e9ebe85e7be041d50f78e5428fb9f089`. The paired task indicator is `BL-DEPPAIR-20260727-15F00599`.
...
The central durable finding is: The paper translates Willmore-surface construction into constrained harmonic maps, normalized potentials, and loop-group factorization. This representation is powerful, but non-compact Iwasawa factorization is not global; mathematical and computational use must preserve the local validity domain.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260725-Willmore%20Loop%20Groups
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260725-Willmore Loop Groups` at `e8876bd1e9ebe85e7be041d50f78e5428fb9f089`
...
- Source URL: https://arxiv.org/html/1301.2756
...
- Source URL: https://ar5iv.labs.arxiv.org/html/1301.2756
  - Item: Persistent arXiv-issued DOI or equivalent canonical locator.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/abs/1412.7833
  - Item: Persistent arXiv-issued DOI or equivalent canonical locator.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
