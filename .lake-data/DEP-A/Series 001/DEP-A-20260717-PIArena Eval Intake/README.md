# DEP-A-20260717-PIArena Eval Intake

#prompt-injection #llm-security #adversarial-evaluation #agent-security #archival-intake #whitepaper-review

Public deposition date: 2026-07-17. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260716-PIArena Evaluation` at source commit `695f4473ebb1174f78bd9a027184a7fb8bf2847e`. The paired task indicator is `BL-DEPPAIR-20260717-4809C2EE`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `piarena-eval-intake-review.md`
...
The central durable finding is: PIArena is valuable as comparability infrastructure, not certification: a result is meaningful only with benchmark, attack budget, attacker model, defense, backend, evaluator, utility denominator, compromise stage, and version manifest. Adaptive attacks and task-aligned corruption expose risks that static instruction templates and text-only detectors systematically miss.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260716-PIArena%20Evaluation
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260716-PIArena Evaluation` at `695f4473ebb1174f78bd9a027184a7fb8bf2847e`
...
- Source URL: https://arxiv.org/abs/2604.08499v1
  - Item: Canonical title, authors, version, abstract, and current record checked in this run.
...
- Source URL: https://github.com/sleeepeer/PIArena
  - Item: Official MIT implementation and dataset surface; inspected by the source DEP-E and not executed here.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2604.08499
  - Item: Persistent arXiv DOI.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `piarena-eval-intake-review.md`
