# DEP-A-20260731-TopoDiffuser A Intake

#robotics #trajectory-prediction #diffusion-models #topometric-maps #lidar #autonomous-systems #archival-intake #whitepaper-review

Public deposition date: 2026-07-31. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260730-TopoDiffuser A` at source commit `ad2ef40ef80d1c15687588a3c054a8a955334fcd`. The paired task indicator is `BL-DEPPAIR-20260731-30FB09AB`.
...
The central durable finding is: TopoDiffuser conditions multimodal trajectory diffusion on a bird's-eye-view fusion of LiDAR, history, route information, and topometric map structure. This can make sampled futures road-compliant without explicit hard constraints, but benchmark gains do not establish safe planning or robustness to map and perception error.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260730-TopoDiffuser%20A
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260730-TopoDiffuser A` at `ad2ef40ef80d1c15687588a3c054a8a955334fcd`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2508.00303
