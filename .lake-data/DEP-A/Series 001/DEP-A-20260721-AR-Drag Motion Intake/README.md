# DEP-A-20260721-AR-Drag Motion Intake

#video-generation #autoregressive-video #diffusion-models #motion-control #reinforcement-learning #kv-cache #synthetic-media #archival-intake #whitepaper-review

Public deposition date: 2026-07-21. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion` at source commit `f66e620eda73edf9535664de38f9703e2711cae3`. The paired task indicator is `BL-DEPPAIR-20260721-55DF1A9D`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `ar-drag-motion-intake-review.md`
...
The central durable finding is: AR-Drag's durable idea is rollout conformance: train an autoregressive video student on the same generated-history distribution it will consume, then optimize motion alignment with explicit reward and controlled stochasticity. The reported quality and latency are strong on one curated benchmark, but impossible motions, cache drift, reward dependence, data rights, and absent public code bound deployment.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260720-AR-Drag%20Motion
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion` at `f66e620eda73edf9535664de38f9703e2711cae3`
...
- Source URL: https://arxiv.org/abs/2510.08131
  - Item: Canonical v3 identity, authors, ICLR status links, and complete-text locators checked.
...
- Source URL: https://arxiv.org/html/2510.08131
  - Item: Official complete paper reopened for algorithms, results, appendix, ethics, and limitations.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://iclr.cc/virtual/2026/poster/10011557
  - Item: Official ICLR 2026 poster record.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `ar-drag-motion-intake-review.md`
