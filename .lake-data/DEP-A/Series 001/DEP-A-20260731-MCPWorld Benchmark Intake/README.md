# DEP-A-20260731-MCPWorld Benchmark Intake

#computer-use-agents #mcp #gui-agents #benchmarking #white-box-evaluation #reproducibility #archival-intake #whitepaper-review

Public deposition date: 2026-07-31. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260730-MCPWorld Benchmark` at source commit `ad2ef40ef80d1c15687588a3c054a8a955334fcd`. The paired task indicator is `BL-DEPPAIR-20260731-3B176DAE`.
...
The central durable finding is: MCPWorld's lasting contribution is white-box, event-backed evaluation across GUI, MCP/API, and hybrid interfaces. Its reported hybrid advantage is configuration-specific and confounded by tool coverage; the evaluator design is more durable than the ranking of one agent release.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260730-MCPWorld%20Benchmark
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260730-MCPWorld Benchmark` at `ad2ef40ef80d1c15687588a3c054a8a955334fcd`
