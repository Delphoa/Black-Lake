# DEP-A-20260728-Language to Space Intake

#computer-vision #3d-grounding #large-language-models #program-synthesis #training-free #spatial-reasoning #archival-intake #whitepaper-review

Public deposition date: 2026-07-28. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260727-Language-to-Space` at source commit `c3bbb1767686782d679639b0b0a4f9ec0b3a3813`. The paired task indicator is `BL-DEPPAIR-20260728-38B92F57`.
...
The central durable finding is: LaSP asks an LLM to emit executable spatial-relation code, then evaluates and optimizes that code without task-specific model training. The program representation makes reasoning inspectable and reduces repeated token use, but correctness remains bounded by object detection, code generation, and evaluation coverage.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260727-Language-to-Space
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260727-Language-to-Space` at `c3bbb1767686782d679639b0b0a4f9ec0b3a3813`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2502.01401
