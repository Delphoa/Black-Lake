# DEP-A-20260723-Pixie Recommender Intake

#recommender-systems #graph-algorithms #random-walks #real-time-systems #scalability #ranking #archival-intake #whitepaper-review

Public deposition date: 2026-07-23. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260722-Pixie System Recommending` at source commit `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`. The paired task indicator is `BL-DEPPAIR-20260723-B4607D9A`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `pixie-recommender-intake-review.md`
...
The central durable finding is: Pixie is best understood as budgeted, query-conditioned graph exploration: user pins seed a random walk, degree and visit evidence allocate search effort, and pruning makes the result serveable. Its production scale is historically important, but its engagement evidence is platform- and era-specific.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260722-Pixie%20System%20Recommending
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260722-Pixie System Recommending` at `2146f0a5821db7bbfc7bad00ca0d0e29c95ace9d`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/1711.07601
