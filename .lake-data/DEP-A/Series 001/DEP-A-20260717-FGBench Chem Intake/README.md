# DEP-A-20260717-FGBench Chem Intake

#chemistry #molecular-reasoning #functional-groups #benchmark-governance #archival-intake #whitepaper-review

Public deposition date: 2026-07-17. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260716-FGBench Chemistry` at source commit `695f4473ebb1174f78bd9a027184a7fb8bf2847e`. The paired task indicator is `BL-DEPPAIR-20260717-E2763A61`.

## Contents

- `README.md`
  - Classification, item inventory, summary, relevance, one-way provenance, associated records, and attribution.
- `fgbench-chem-intake-review.md`
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260716-FGBench%20Chemistry
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260716-FGBench Chemistry` at `695f4473ebb1174f78bd9a027184a7fb8bf2847e`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2508.01055v4
...
- Source URL: https://arxiv.org/html/2508.01055v4
  - Item: Official full-paper locator used by the source DEP-E; not reopened page by page in this run.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://github.com/xuanliugit/FGBench
  - Item: Official implementation surface identified by the source DEP-E; not downloaded or run here.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://huggingface.co/datasets/xuan-liu/FGBench
  - Item: Public dataset locator; dataset content and component licenses were not re-audited here.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2508.01055
  - Item: Persistent arXiv DOI.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Generated review: `fgbench-chem-intake-review.md`
