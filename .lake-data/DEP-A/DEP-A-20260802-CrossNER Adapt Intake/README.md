# DEP-A-20260802-CrossNER Adapt Intake

#named-entity-recognition #domain-adaptation #datasets #ontology #evaluation #archival-intake #whitepaper-review

Public deposition date: 2026-08-02. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260801-CrossNER Adapt` at source commit `afd8cd4b4dded8a1306e06ce00421455e9f78957`. The paired task indicator is `BL-DEPPAIR-20260802-FCFA3439`.
...
The central durable finding is: CrossNER makes cross-domain NER harder and more informative by introducing domain-specialized labels and matched unlabeled corpora. Its strongest lesson is not one BERT recipe but that adaptation quality depends jointly on corpus content, masking policy, ontology boundaries, and specialized-label errors.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260801-CrossNER%20Adapt
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260801-CrossNER Adapt` at `afd8cd4b4dded8a1306e06ce00421455e9f78957`
...
- Source URL: https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260717-OMGEval%20Benchmark/omgeval_benchmark_manuscript.md
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260719-DoubleTransfer%20MEDIQA/doubletransfer_mediqa_manuscript.md
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260721-Dataset%20Baselines/dataset_baselines_manuscript.md
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
