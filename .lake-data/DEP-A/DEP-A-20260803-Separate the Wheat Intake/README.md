# DEP-A-20260803-Separate the Wheat Intake

#large-language-models #unlearning #parameter-efficient-tuning #truthfulness #detoxification #archival-intake #whitepaper-review

Public deposition date: 2026-08-03. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260802-Separate the Wheat from` at source commit `e93be13b36d73646f6f405a0516cffef18216ccd`. The paired task indicator is `BL-DEPPAIR-20260803-CF04A77A`.
...
The central durable finding is: Extraction-before-Subtraction treats an anti-expert adapter as a mixture of undesirable behavior and useful language competence. It first isolates the deficiency direction before subtracting it from an expert module, aiming to improve truthfulness or detoxification without erasing general ability. The decomposition is empirical, not a guaranteed separation of capabilities.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260802-Separate%20the%20Wheat%20from
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260802-Separate the Wheat from` at `e93be13b36d73646f6f405a0516cffef18216ccd`
...
- Source URL: https://arxiv.org/html/2308.08090
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2308.08090
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2308.08090
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
