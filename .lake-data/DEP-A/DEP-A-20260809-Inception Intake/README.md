# DEP-A-20260809-Inception Intake

#vision #transformer #frequency-mixing #computer-vision #efficient-backbones #archival-intake #whitepaper-review

Public deposition date: 2026-08-09. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260806-Inception Transformer` at source commit `7c5c91553bf4f4b02806cda13598a5bde42525fa`. The paired task indicator is `BL-DEPPAIR-20260809-E4D9A43A`.
...
The central durable finding is: iFormer allocates shallow and deep channel capacity differently between local high-frequency operators and pooled global attention. Its value is the explicit resource-routing hypothesis and cross-task evidence, not proof that the branches are literal causal frequency filters or that reported FLOPs translate into device efficiency.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260806-Inception%20Transformer
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260806-Inception Transformer` at `7c5c91553bf4f4b02806cda13598a5bde42525fa`
...
- Source URL: https://arxiv.org/abs/2103.14030
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/abs/2201.09450
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
