# DEP-A-20260820-ST NeRF Video Intake

#st-nerf #free-viewpoint-video #neural-rendering #dynamic-scenes #archival-intake #whitepaper-review

Public deposition date: 2026-08-20. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260818-ST-NeRF Video` at source commit `3d2403b83a72486215ae81181f71fb8171d3d29d`. The paired task indicator is `BL-DEPPAIR-20260820-1958F2DA`.
...
The central durable finding is: The durable value of the ST-NeRF Video DEP-E is its evidence-coordinate structure: it binds st nerf, free viewpoint video, neural rendering, dynamic scenes claims to source identity, declared access status, limitations, and a non-reproduction boundary. The record is suitable for archival intake as a traceable research object, but it does not by itself establish the underlying paper's experiments, proofs, generality, or deployment readiness.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260818-ST-NeRF%20Video
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260818-ST-NeRF Video` at `3d2403b83a72486215ae81181f71fb8171d3d29d`
...
- Source URL: https://jiakai-zhang.github.io/st-nerf/
  - Item: Public primary or canonical locator preserved by the complete source record; not treated as independent reproduction.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/abs/2003.08934
  - Item: Canonical metadata locator exposed by the source DEP-E; identity context only in this run.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
