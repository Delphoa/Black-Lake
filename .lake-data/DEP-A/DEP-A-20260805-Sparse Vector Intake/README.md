# DEP-A-20260805-Sparse Vector Intake

#sparse-recovery #message-passing #bernoulli-gaussian #compressed-sensing #support-estimation #signal-processing #archival-intake #whitepaper-review

Public deposition date: 2026-08-05. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260804-Sparse Vector Recovery` at source commit `ff7426206b559a45e29de03a6d3567c0b506dd28`. The paired task indicator is `BL-DEPPAIR-20260805-EBF801EC`.
...
The central durable finding is: BGMP represents sparsity and amplitude with coupled Bernoulli and Gaussian messages so support decisions and value estimates refine one another. The paper supports a low-complexity six-page algorithm and simulated advantages, not universal convergence or robustness beyond its probabilistic model.
...
- [`.lake-data/DEP-E/DEP-E-20260711-Irregular Clipped SR`](https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260711-Irregular%20Clipped%20SR) — verified related DEP-A; it remains distinct from this paired intake.
- [`.lake-data/DEP-E/DEP-E-20260714-iKalibr Calibration`](https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260714-iKalibr%20Calibration) — verified related DEP-A; it remains distinct from this paired intake.
- [`.lake-data/DEP-E/DEP-E-20260716-Acoustic Phase Retrieval`](https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260716-Acoustic%20Phase%20Retrieval) — verified related DEP-A; it remains distinct from this paired intake.

## Attribution Block

- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260804-Sparse%20Vector%20Recovery
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260804-Sparse Vector Recovery` at `ff7426206b559a45e29de03a6d3567c0b506dd28`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/1707.09613
...
- Source URL: https://arxiv.org/html/1707.09613
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/1707.09613
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.1707.09613
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
