# DEP-A-20260820-OpenRad a Curated Intake

#dep-e #research #open-source #local-ai #llm-inference #edge-computing #android #hardware #archival-intake #whitepaper-review

Public deposition date: 2026-08-20. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260819-OpenRad a Curated` at source commit `3d2403b83a72486215ae81181f71fb8171d3d29d`. The paired task indicator is `BL-DEPPAIR-20260820-8432BC3A`.
...
The central durable finding is: The durable value of the OpenRad a Curated DEP-E is its evidence-coordinate structure: it binds dep e, research, open source, local ai claims to source identity, declared access status, limitations, and a non-reproduction boundary. The record is suitable for archival intake as a traceable research object, but it does not by itself establish the underlying paper's experiments, proofs, generality, or deployment readiness.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20002/DEP-E-20260819-OpenRad%20a%20Curated
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260819-OpenRad a Curated` at `3d2403b83a72486215ae81181f71fb8171d3d29d`
...
- Source URL: https://github.com/ggml-org/llama.cpp/releases/tag/b9789
  - Item: Public primary or canonical locator preserved by the complete source record; not treated as independent reproduction.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://github.com/huggingface/transformers/releases/tag/v5.12.1
  - Item: Public primary or canonical locator preserved by the complete source record; not treated as independent reproduction.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://github.com/ollama/ollama/releases/tag/v0.30.10
  - Item: Public primary or canonical locator preserved by the complete source record; not treated as independent reproduction.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
