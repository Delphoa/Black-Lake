# DEP-A-20260730-On a Utilitarian Intake

#differential-privacy #text-generation #privacy #utility #embeddings #mechanism-design #archival-intake #whitepaper-review

Public deposition date: 2026-07-30. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260729-On a Utilitarian Approach` at source commit `12ac0b14383980668f6c4c8873752a7ef7ed2b24`. The paired task indicator is `BL-DEPPAIR-20260730-146361DE`.
...
The central durable finding is: Privacy-preserving text generation is a constrained utility frontier, not a single nearest-neighbor perturbation rule. Calibrated noise can provide a formal local privacy guarantee, but the embedding geometry and replacement policy determine whether meaning, fluency, and sensitive attributes survive.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260729-On%20a%20Utilitarian%20Approach
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260729-On a Utilitarian Approach` at `12ac0b14383980668f6c4c8873752a7ef7ed2b24`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2104.11838
