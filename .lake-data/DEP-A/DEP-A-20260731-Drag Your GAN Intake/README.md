# DEP-A-20260731-Drag Your GAN Intake

#computer-vision #generative-models #gan #image-editing #point-tracking #human-in-the-loop #archival-intake #whitepaper-review

Public deposition date: 2026-07-31. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260730-Drag Your GAN Interactive` at source commit `ad2ef40ef80d1c15687588a3c054a8a955334fcd`. The paired task indicator is `BL-DEPPAIR-20260731-67939783`.
...
The central durable finding is: DragGAN turns point-based image editing into repeated latent optimization with a feature-space motion objective and generator-feature point tracking. Its strength is precise interactive control on a pretrained GAN manifold; its boundary is that manifold coverage, inversion quality, tracking stability, and optimization latency still determine what edits are possible.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260730-Drag%20Your%20GAN%20Interactive
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260730-Drag Your GAN Interactive` at `ad2ef40ef80d1c15687588a3c054a8a955334fcd`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2305.10973
