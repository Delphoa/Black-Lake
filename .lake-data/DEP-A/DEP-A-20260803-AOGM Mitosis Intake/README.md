# DEP-A-20260803-AOGM Mitosis Intake

#cell-tracking #mitosis #graph-metrics #AOGM #biomedical-imaging #evaluation #archival-intake #whitepaper-review

Public deposition date: 2026-08-03. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260802-AOGM Mitosis` at source commit `e93be13b36d73646f6f405a0516cffef18216ccd`. The paired task indicator is `BL-DEPPAIR-20260803-30EB1999`.
...
The central durable finding is: AOGM can invert the desired ranking when semantically meaningful mother-daughter links incur more graph-edit cost than an unlinked prediction. The paper establishes a concrete metric failure mode, not the universal invalidity of AOGM, and it motivates event-aware companion metrics with component-level score disclosure.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260802-AOGM%20Mitosis
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260802-AOGM Mitosis` at `e93be13b36d73646f6f405a0516cffef18216ccd`
