# Global Existence under Slip-Boundary Geometry

## A whitepaper-grade source-bundle review and independent re-conceptualization

**Source work:** Global strong and weak solutions for two-dimensional compressible Navier-Stokes flow with density-dependent bulk viscosity.[^paper]
**Source DEP-E:** .lake-data/DEP-E/DEP-E-20260712-Global NS Existence[^dep]
...
This intake reviews Global strong and weak solutions for two-dimensional compressible Navier-Stokes flow with density-dependent bulk viscosity through the complete DEP-E repository record. It asks how boundary geometry, effective viscous flux, and density-dependent bulk viscosity permit global strong and weak solution claims for large two-dimensional compressible-flow data with vacuum. The record is coherent enough to reconstruct the mechanism, evidence, limitations, and open work, but it is not an independently reproduced full-paper review.

For constant shear viscosity, pressure proportional to density to gamma, and bulk viscosity proportional to density to beta, the proof controls effective viscous flux. A conformal map to the disk pulls back a Neumann Green function; angle preservation and slip-boundary orthogonality convert dangerous boundary terms into commutator-like velocity differences, enabling a uniform density bound.
...
How boundary geometry, effective viscous flux, and density-dependent bulk viscosity permit global strong and weak solution claims for large two-dimensional compressible-flow data with vacuum is important because it joins representation, policy, and observable outcome. A credible review must ask what information enters, how state is formed, what objective shapes behavior, and which metric stands in for the intended effect.
...
The source path is .lake-data/DEP-E/DEP-E-20260712-Global NS Existence at commit a1ffd4737ce95c14f3a15251ee4fbba4403108a5. It contains exactly README.md and global_ns_existence_manuscript.md. Both files were read from beginning to end. The README supplies classification, inventory, public context, insights, and attribution. The manuscript supplies metadata, evidence ledger, detailed reconstruction, claims, method, constraints, observations, proposed extensions, references, and validation notes.

The canonical public locator is https://arxiv.org/abs/2102.09229; a persistent or related locator is https://doi.org/10.1007/s00205-022-01790-4. The complete canonical paper was not independently used to validate all paper-level detail in this run. No source document was uploaded, no source Markdown copied, and the source record remains unchanged.
...
This is a theorem and proof-architecture review rather than an empirical study. The source inspects Theorems 1.1 and 1.2, propositions controlling effective flux and maximum density, higher-order estimates, approximation, compactness, and prior uniqueness machinery on a bounded simply connected C2,1 planar domain.
...
The authors state a unique global strong solution for beta greater than 4/3, gamma greater than one, large initial data, and possible vacuum under W1,q density and H1 velocity assumptions. With bounded initial density they state global weak existence. The range one less than beta less than or equal to 4/3 remains open.
...
The proof dependencies reveal where the result is conditional: simple connectivity enables conformal mapping, the slip condition supplies boundary orthogonality, two dimensions support the analytic framework, and beta greater than 4/3 closes the exponent inequality. This intake did not formally verify any estimate.
...
The public locator https://arxiv.org/abs/2102.09229 and related identifier https://doi.org/10.1007/s00205-022-01790-4 anchor identity and context.[^paper] They do not independently supply a reproduction. Related work named by the DEP-E is contextual, not confirmation.
...
Archive the theorem as a machine-readable dependency graph, not a detached existence sentence. Domain topology, boundary condition, coefficient law, regularity, exponent threshold, imported estimates, and conclusion should each be a reviewable node whose evidence status is distinct from formal verification.
...
Source inspection is not proof verification. This changes causal interpretation, portability, or the maximum safe claim. It is a reviewer assessment, not an assertion that the source authors ignored the issue.

### 2. Critical note

PDF extraction can corrupt formulas. This changes causal interpretation, portability, or the maximum safe claim. It is a reviewer assessment, not an assertion that the source authors ignored the issue.

### 3. Critical note

The result is specific to two-dimensional simply connected domains. This changes causal interpretation, portability, or the maximum safe claim. It is a reviewer assessment, not an assertion that the source authors ignored the issue.

### 4. Critical note

The exponent range up to 4/3 remains open. This changes causal interpretation, portability, or the maximum safe claim. It is a reviewer assessment, not an assertion that the source authors ignored the issue.

### 5. Critical note

Approximation and uniqueness depend on imported literature. This changes causal interpretation, portability, or the maximum safe claim. It is a reviewer assessment, not an assertion that the source authors ignored the issue.
...
1. **Build formula-preserving theorem anchors.** This is a system and evidence implication, not reproduced capability.
2. **Trace every hypothesis to a proof dependency.** This is a system and evidence implication, not reproduced capability.
3. **Isolate the beta-threshold bottleneck.** This is a system and evidence implication, not reproduced capability.
4. **Compare boundary and topology assumptions explicitly.** This is a system and evidence implication, not reproduced capability.
...
**Proposition:** A dependency graph identifies the exact estimate blocking beta near one.
...
**Proposition:** Multiply connected domains require additional harmonic-field controls.
...
**Proposition:** No-slip boundaries break the same commutator cancellation.
...
**Proposition:** Formula-preserving source materially improves reviewer agreement.
...
3. Match embedding dimension and tuning budget across Global Existence under Slip-Boundary Geometry, node2vec, attribute-only, and modern GNN baselines.
...
Challenge data source, scenario, domain, sample composition, resource, noise, missingness, topology, and version boundaries relevant to Global Existence under Slip-Boundary Geometry. Separate recalibration from retraining and disclose target-domain information. Report strata so averages cannot hide collapse. A method requiring target-specific search supports a different claim than zero-shot transfer.
...
- Complete authorized paper: https://arxiv.org/abs/2102.09229
- Persistent identifier: https://doi.org/10.1007/s00205-022-01790-4
- Immutable DEP-E record: https://github.com/Delphoa/Black-Lake/tree/a1ffd4737ce95c14f3a15251ee4fbba4403108a5/.lake-data/DEP-E/DEP-E-20260709-Global Existence under Slip-Boundary Geometry%20Embeddings
...
[^paper]: Global strong and weak solutions for two-dimensional compressible Navier-Stokes flow with density-dependent bulk viscosity; https://arxiv.org/abs/2102.09229; related identifier https://doi.org/10.1007/s00205-022-01790-4. Used as evidence, not instruction.
[^dep]: Complete source record at .lake-data/DEP-E/DEP-E-20260712-Global NS Existence, commit a1ffd4737ce95c14f3a15251ee4fbba4403108a5; both tracked files reviewed in place.
[^doi]: Persistent identifier: https://doi.org/10.1007/s00205-022-01790-4
...
[^pair]: Paired task indicator `BL-DEPPAIR-20260714-7B95DD27` records the one-way `DEP-E -> DEP-A` relationship.
