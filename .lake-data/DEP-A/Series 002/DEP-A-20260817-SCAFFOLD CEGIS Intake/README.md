# DEP-A-20260817-SCAFFOLD CEGIS Intake

#llm-agents #secure-coding #cegis #static-analysis #software-assurance #archival-intake #whitepaper-review

Public deposition date: 2026-08-17. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260816-SCAFFOLD-CEGIS Preventing` at source commit `81b588d864e26b3ed63be7d1c7e947940bb4a3c3`. The paired task indicator is `BL-DEPPAIR-20260817-1511C5CB`.
...
The central durable finding is: SCAFFOLD-CEGIS turns iterative LLM repair into a gated counterexample loop: candidate changes must preserve semantic anchors and pass correctness, safety-monotonicity, diff-budget, and anchor-integrity checks. The reported reduction in latent security degradation is substantial on 24 tasks, but the gate's operational monotonicity is not a formal guarantee over all vulnerabilities, languages, or tool blind spots.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260816-SCAFFOLD-CEGIS%20Preventing
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260816-SCAFFOLD-CEGIS Preventing` at `81b588d864e26b3ed63be7d1c7e947940bb4a3c3`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2603.08520
...
- Source URL: https://arxiv.org/pdf/2603.08520
  - Item: Complete canonical paper inspected; no source document uploaded.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2603.08520
