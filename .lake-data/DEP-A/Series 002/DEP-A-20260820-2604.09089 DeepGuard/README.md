# DEP-A-20260820-2604.09089 DeepGuard

#deepguard #secure #code #generation #multi-layer #semantic #aggregation #arxiv #whitepaper-review #remediation #evidence-audit

Public deposition context: enhanced remediation dossier for [DeepGuard: Secure Code Generation via Multi-Layer Semantic Aggregation](https://arxiv.org/abs/2604.09089v1), stable arXiv v1. The source documents were verified from a locally archived full PDF and matching full-paper HTML and are withheld from the repository.
...
- Canonical paper: [DeepGuard: Secure Code Generation via Multi-Layer Semantic Aggregation](https://arxiv.org/abs/2604.09089v1)
- Canonical PDF: https://arxiv.org/pdf/2604.09089v1
- Canonical full-paper HTML: https://arxiv.org/html/2604.09089v1
- Canonical DOI resolver: https://doi.org/10.48550/arXiv.2604.09089
- Authors:
  - [Li Huang](https://arxiv.org/search/?query=Li+Huang&searchtype=author)
  - [Zhongxin Liu](https://arxiv.org/search/?query=Zhongxin+Liu&searchtype=author)
  - [Yifan Wu](https://arxiv.org/search/?query=Yifan+Wu&searchtype=author)
  - [Tao Yin](https://arxiv.org/search/?query=Tao+Yin&searchtype=author)
  - [Dong Li](https://arxiv.org/search/?query=Dong+Li&searchtype=author)
  - [Jichao Bi](https://arxiv.org/search/?query=Jichao+Bi&searchtype=author)
  - [Nankun Mu](https://arxiv.org/search/?query=Nankun+Mu&searchtype=author)
  - [Hongyu Zhang](https://arxiv.org/search/?query=Hongyu+Zhang&searchtype=author)
  - [Meng Yan](https://arxiv.org/search/?query=Meng+Yan&searchtype=author)
