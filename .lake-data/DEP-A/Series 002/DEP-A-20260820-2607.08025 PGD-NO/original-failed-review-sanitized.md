# Preserved failed review record — arXiv:2607.08025v1
...
Original failure codes: `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `placeholder_scaffolding_present`, `verified_external_context_missing`, `verified_external_context_missing`.
...
Reviewer inference: the durable mechanism is the source-defined change centered on features, point, token, and geometry, rather than the paper's brand name. This interpretation predicts that a matched intervention on features changes tokens; it is not an author claim or theorem. *(paper-specific reconstruction; source locator retained in the private substantive profile).* The source's technical path is anchored to 3.2 Model Architecture, 3.3 Model Complexity Analysis. The review treats those sections as the authority for inputs, state, transformations, objectives, and outputs; heading labels alone are not promoted into performance claims. This reconstruction does not replace the authors' definitions and does not imply that a heading or architecture label proves an empirical claim.
...
**Paper-reported problem:** For PGD-NO: A Neural Operator with Precomputed Geometry Decomposition for 3D Million-scale Physics Simulations, the formal target is bounded to the source-defined relation among neural, memory, geometries, mesh, industrial, Transolver++, and solvers. The task assumptions and stakes are anchored to Abstract, and 1 Introduction; no objective outside those sections is inferred.

**Research gap reconstructed from the source:** The paper positions PGD-NO around neural, memory, geometries, features, point, and token. This records the authors' gap framing only; novelty, priority, generality, and superiority require the separate prior-work and evaluation audits.
...
**Formal object 1 at 3.1 Geometry Token Extraction — The expression encodes definition or equality within 3.1 Geometry Token Extraction; its semantic role remains bound to that section..** `\theta_{ij}=\arccos(\mathbf{n}_{a}\cdot\mathbf{n}_{b})>\theta_{\text{threshold}}`
Variables: "\\theta, n, a, and b".
...
Source locator: private full-paper evidence dossier for arXiv:2607.08025, 3.1 Geometry Token Extraction.

**Formal object 2 at 3.1 Geometry Token Extraction — The expression encodes definition or equality within 3.1 Geometry Token Extraction; its semantic role remains bound to that section..** `G^{\prime}=G[V\setminus V_{\text{sharp}}]`
Variables: "G, V, and V_{\\text{sharp}}".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2607.08025, 3.1 Geometry Token Extraction.

**Formal object 3 at 3.1 Geometry Token Extraction — The expression encodes definition or equality within 3.1 Geometry Token Extraction; its semantic role remains bound to that section..** `\mathcal{C}=\{C_{1},C_{2},\dots,C_{k}\}`
Variables: "C, C_{1}, C_{2}, and C_{k}\\}".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2607.08025, 3.1 Geometry Token Extraction.

**Formal object 4 at 3.1 Geometry Token Extraction — The expression encodes definition or equality within 3.1 Geometry Token Extraction; its semantic role remains bound to that section..** `\theta^{i+1}_{\text{threshold}}=\alpha\theta^{i}_{\text{threshold}}`
Variables: "\\theta, and i".
Sign/normalization/conditioning/surrogate audit: "Detected operations: definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2607.08025, 3.1 Geometry Token Extraction.

**Formal object 5 at 3.1 Geometry Token Extraction — The expression encodes a paper-defined formal relation within 3.1 Geometry Token Extraction; its semantic role remains bound to that section..** `S\in\mathbb{R}^{K\times N}`
Variables: "S, R, K, and N".
...
**Formal object 6 at 3.1 Geometry Token Extraction — The expression encodes ratio or normalization, conditional rule, and definition or equality within 3.1 Geometry Token Extraction; its semantic role remains bound to that section..** `S_{ki}=\begin{cases}\frac{1}{|C_{k}|}&\text{if }v_{i}\in C_{k},\\ 0&\text{otherwise}.\end{cases}`
Variables: "S_{ki}, C_{k}, and v_{i}\\in".
Sign/normalization/conditioning/surrogate audit: "Detected operations: ratio or normalization, conditional rule, and definition or equality. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2607.08025, 3.1 Geometry Token Extraction.
...
**Input/output dataflow:** The documented dataflow is reconstructed only across 3.2 Model Architecture, and 3.3 Model Complexity Analysis, where the source associates features, point, token, geometry, matrix, mathbb, and times. Exact sequencing, hidden preprocessing, and post-processing remain bounded to the cited sections.
...
2. At 4.1 Main Results, the paper reports a training-related operation involving PGD-NO, achieves, performance, improvement, dataset, and algorithm. *(source locator: private full-paper evidence dossier for arXiv:2607.08025, 4.1 Main Results)*
3. At 2.1 Neural PDE Solver, the paper reports a training-related operation involving Neural, high, like, significant, grids, and Solver. *(source locator: private full-paper evidence dossier for arXiv:2607.08025, 2.1 Neural PDE Solver)*
...
3. At 4 Experiment, the paper reports an inference or deployment action involving dataset, Prediction, datasets, physics, Experiment, and tasks. *(source locator: private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment)*
4. At 4 Experiment, the paper reports an inference or deployment action involving tokens, geometry, extracted, datasets, Experiment, and decomposition. *(source locator: private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment)*
...
The documented dataflow is reconstructed only across 3.2 Model Architecture, and 3.3 Model Complexity Analysis, where the source associates features, point, token, geometry, matrix, mathbb, and times. Exact sequencing, hidden preprocessing, and post-processing remain bounded to the cited sections.
...
|---|---|---|---|
| Data | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| two-dimensional | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| PDE | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| three-dimensional | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| real-world | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| JEB | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| DrivAerNet | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| CFD-VOL | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
...
|---|---|---|---|
| Data | Paper-reported comparator at 4 Experiment; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| two-dimensional | Paper-reported comparator at 4 Experiment; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| PDE | Paper-reported comparator at 4 Experiment; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| three-dimensional | Paper-reported comparator at 4 Experiment; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| real-world | Paper-reported comparator at 4 Experiment; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| JEB | Paper-reported comparator at 4 Experiment; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| DrivAerNet | Paper-reported comparator at 4 Experiment; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| CFD-VOL | Paper-reported comparator at 4 Experiment; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
...
|---|---|---|---|
| memory | Paper-defined evaluation unit at 4 Experiment; exclusions and conditioning were not mechanically resolved | lower is normally better; confirm the paper's sign and aggregation | private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment |
| accuracy | Paper-defined evaluation unit at 4.1 Main Results; exclusions and conditioning were not mechanically resolved | higher is normally better; confirm the paper's definition and conditioning | private full-paper evidence dossier for arXiv:2607.08025, 4.1 Main Results |
| error | Paper-defined evaluation unit at 4.1 Main Results; exclusions and conditioning were not mechanically resolved | lower is normally better; confirm the paper's sign and aggregation | private full-paper evidence dossier for arXiv:2607.08025, 4.1 Main Results |
| mAP | Paper-defined evaluation unit at 4.1 Main Results; exclusions and conditioning were not mechanically resolved | higher is normally better; confirm the paper's definition and conditioning | private full-paper evidence dossier for arXiv:2607.08025, 4.1 Main Results |
...
|---|---|---|---|---|---|---|---|
| PGD-NO | PGD-NO | comparator retained at the cited source locator; not inferred | configuration retained at the cited source locator | accuracy | 1 | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, 4.1 Main Results |
| evaluation object at 4.1 Main Results | PGD-NO | comparator retained at the cited source locator; not inferred | configuration retained at the cited source locator | error, and mAP | 4 | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, 4.1 Main Results |
| CFD-VOL | PGD-NO | dataset | configuration retained at the cited source locator | source-defined metric | 3 | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, 4.3 Ablation Studies |
| evaluation object at 4.3 Ablation Studies | PGD-NO | comparator retained at the cited source locator; not inferred | configuration retained at the cited source locator | source-defined metric | 4 | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, 4.3 Ablation Studies |
...
- No independent reproduction was performed for arXiv:2607.08025v1; tokens, dataset, geometry, and performance remains paper-reported. *(source locator: private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment, and 4.1 Main Results)*
...
|---|---|---|---|
| PGD-NO: A Neural Operator with Precomputed Geometry Decomposition for 3D Million-scale Physics Simulations: paper-reported problem claim centered on neural, memory, geometries, and mesh | Located at Abstract; extracted numeric markers: 10, 2013, 1995, and 2023 (private full-paper evidence dossier for arXiv:2607.08025, Abstract) | promising but bounded to the paper's stated task | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
| PGD-NO: A Neural Operator with Precomputed Geometry Decomposition for 3D Million-scale Physics Simulations: paper-reported mechanism claim centered on features, point, token, and geometry | Located at 3.2 Model Architecture; extracted numeric markers: 3, and 2 (private full-paper evidence dossier for arXiv:2607.08025, 3.2 Model Architecture) | paper-reported mechanism; causal attribution requires matched ablation | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
| PGD-NO: A Neural Operator with Precomputed Geometry Decomposition for 3D Million-scale Physics Simulations: paper-reported result claim centered on tokens, dataset, geometry, and performance | Located at 4 Experiment; extracted numeric markers: 2025, 128, 15, and 3 (private full-paper evidence dossier for arXiv:2607.08025, 4 Experiment) | supported only under reported evaluation conditions | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
...
- **Predecessor/prior work (blocked):** The bounded online record did not verify a noncanonical predecessor or prior-work source URL; the corresponding field-level claim remains unvalidated. *(evidence locator: online-vetting check for arXiv:2607.08025)*
- **Alternative or benchmark (blocked):** The bounded online record did not verify a noncanonical alternative or benchmark source URL; the corresponding field-level claim remains unvalidated. *(evidence locator: online-vetting check for arXiv:2607.08025)*
...
Reviewer inference: the durable mechanism is the source-defined change centered on features, point, token, and geometry, rather than the paper's brand name. This interpretation predicts that a matched intervention on features changes tokens; it is not an author claim or theorem.
...
Substantive evidence boundary: The profile binds arXiv:2607.08025v1 to a complete local PDF and full-paper HTML, 28 headings, 6 tables, 15 figures, and 108 extracted mathematical objects, and 1 bounded verified noncanonical or canonical URLs. No experiment, code path, data pipeline, hardware measurement, security property, or production claim was independently reproduced.
...
**Proposition:** Reviewer hypothesis: the source-linked features operation is causally responsible for part of the reported tokens behavior.
**Predicted observation:** Removing or neutralizing features under matched data and compute will measurably weaken tokens.
**Falsifying observation:** A competent matched control without features preserves the same tokens distribution within uncertainty.
...
**Proposition:** Reviewer hypothesis: the relation between features, and point and tokens, and dataset weakens under an untested scale, distribution, or budget shift.
...
> Durably, PGD-NO: A Neural Operator with Precomputed Geometry Decomposition for 3D Million-scale Physics Simulations should be remembered as a tested relation between features, point, and token and tokens, dataset, and geometry under the configurations at 4 Experiment, and 4.1 Main Results, not as proof outside those conditions.
...
|---|---|---|
| Table 1 | Purpose: The caption frames this object around specific, prediction, Comparative, analysis, relative, and error.; result: Paper-reported numeric markers: 1; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Table 1 caption |
| Table 2 | Purpose: The caption frames this object around Comparative, relative, error, CFD-VOL, across, and varying.; result: Paper-reported numeric markers: 2; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Table 2 caption |
| Table 3 | Purpose: The caption frames this object around Comparative, relative, error, CFD-VOL, across, and varying.; result: Paper-reported numeric markers: 3, and 2; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Table 3 caption |
| Table 4 | Purpose: The caption frames this object around Comparative, relative, error, across, varying, and number.; result: Paper-reported numeric markers: 4, and 2; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Table 4 caption |
| Table 5 | Purpose: The caption frames this object around Comparison, Training, Times, Memory, Usage, and Across.; result: Paper-reported numeric markers: 5; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Table 5 caption |
| Table 6 | Purpose: The caption frames this object around tokens, Comparison, surface, and grid-pooling.; result: Paper-reported numeric markers: 6; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Table 6 caption |
| Figure 1 | Purpose: The caption frames this object around memory, Encoding, grid-based, tokens, PGD-NO, and Architectural.; result: Paper-reported numeric markers: 1; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure 1 caption |
| Algorithm 1 | Purpose: The caption frames this object around Algorithm, Iterative, Geometry, and Decomposition.; result: Paper-reported numeric markers: 1; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Algorithm 1 caption |
| Figure 2 | Purpose: The caption frames this object around layer, variants, segmentation, matrix, tokens, and PGD-NO.; result: Paper-reported numeric markers: 2, 1, and 3; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure 2 caption |
| Figure 3 | Purpose: The caption frames this object around benchmarks, Visualization, industrial, Geometry, tokens, and generated.; result: Paper-reported numeric markers: 3; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure 3 caption |
| Figure 4 | Purpose: The caption frames this object around Error, structural, comparison, Transolver++, PGD-NO, and Geometric.; result: Paper-reported numeric markers: 4; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure 4 caption |
| Figure 5 | Purpose: The caption frames this object around nodal, importance, Geometry, Interpretability, analysis, and multi-layer.; result: Paper-reported numeric markers: 5; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure 5 caption |
| Figure 6 | Purpose: The caption frames this object around extracted, tokens, different, samples, Heat, and Sink.; result: Paper-reported numeric markers: 6; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure 6 caption |
| Figure 7 | Purpose: The caption frames this object around extracted, tokens, different, samples, dataset, and presented.; result: Paper-reported numeric markers: 7; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure 7 caption |
| Figure inventory item 9 | Purpose: The caption frames this object around view.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure inventory item 9 caption |
| Figure inventory item 10 | Purpose: The caption frames this object around Bottom, and view.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure inventory item 10 caption |
| Figure 8 | Purpose: The caption frames this object around extracted, tokens, different, samples, dataset, and presented.; result: Paper-reported numeric markers: 8; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure 8 caption |
| Figure inventory item 12 | Purpose: The caption frames this object around Front, and view.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure inventory item 12 caption |
| Figure inventory item 13 | Purpose: The caption frames this object around Back, and view.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure inventory item 13 caption |
| Figure 9 | Purpose: The caption frames this object around extracted, tokens, different, samples, DrivAerNet++, and dataset.; result: Paper-reported numeric markers: 9; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure 9 caption |
| Figure 10 | Purpose: The caption frames this object around bottom, view, extracted, tokens, different, and samples.; result: Paper-reported numeric markers: 10; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2607.08025, Figure 10 caption |
