# DEP-A-20260812-Integrating Intake

#electronic-health-records #genomics #polygenic-risk-scores #multimodal-learning #clinical-ai #archival-intake #whitepaper-review

Public deposition date: 2026-08-12. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260812-Integrating Genomics into` at source commit `a72f802c741069bc05f5c066fbc1eeb9e971b74b`. The paired task indicator is `BL-DEPPAIR-20260812-8D4600C9`.
...
The central durable finding is: The work augments a longitudinal EHR transformer with static polygenic-risk-score context through cross-attention and reports statistically lower held-out prediction loss across tasks. This supports the proposition that inherited-risk summaries add signal beyond coded clinical history in the studied All of Us cohort, but loss improvements, ancestry-sensitive PRS, diagnostic-code quality, and absent calibration or clinical-utility analysis sharply limit deployment claims.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260812-Integrating%20Genomics%20into
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260812-Integrating Genomics into` at `a72f802c741069bc05f5c066fbc1eeb9e971b74b`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2510.23639
...
- Source URL: https://arxiv.org/html/2510.23639
  - Item: Canonical full-paper rendering inspected where available.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2510.23639
  - Item: Canonical complete-paper locator; the document is not deposited here.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2510.23639
