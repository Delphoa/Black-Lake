# DEP-A-20260820-2607.14547 AdaTurn

#adaturn #budget-aware #test-time #scaling #active #visual #perception #arxiv #whitepaper-review #remediation #evidence-audit

Public deposition context: enhanced remediation dossier for [AdaTurn: Budget-Aware Test-Time Scaling for Active Visual Perception Agents](https://arxiv.org/abs/2607.14547v1), stable arXiv v1. The source documents were verified from a locally archived full PDF and matching full-paper HTML and are withheld from the repository.
...
- Canonical paper: [AdaTurn: Budget-Aware Test-Time Scaling for Active Visual Perception Agents](https://arxiv.org/abs/2607.14547v1)
- Canonical PDF: https://arxiv.org/pdf/2607.14547v1
- Canonical full-paper HTML: https://arxiv.org/html/2607.14547v1
- Canonical DOI resolver: https://doi.org/10.48550/arXiv.2607.14547
- Authors:
  - [Susan Liang](https://arxiv.org/search/?query=Susan+Liang&searchtype=author)
  - [Chao Huang](https://arxiv.org/search/?query=Chao+Huang&searchtype=author)
  - [Filippos Bellos](https://arxiv.org/search/?query=Filippos+Bellos&searchtype=author)
  - [Jing Bi](https://arxiv.org/search/?query=Jing+Bi&searchtype=author)
  - [Jason J Corso](https://arxiv.org/search/?query=Jason+J+Corso&searchtype=author)
  - [Chenliang Xu](https://arxiv.org/search/?query=Chenliang+Xu&searchtype=author)
