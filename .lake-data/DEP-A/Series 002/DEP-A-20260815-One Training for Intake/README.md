# DEP-A-20260815-One Training for Intake

#autonomous-driving #bird-eye-view #computer-vision #polar-representation #adaptive-inference #archival-intake #whitepaper-review

Public deposition date: 2026-08-15. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260814-One Training for Multiple` at source commit `788a182fd8823a0b5b019e8c547e081b5f393882`. The paired task indicator is `BL-DEPPAIR-20260815-1F6CBF33`.
...
The central durable finding is: The paper separates training from deployment resolution by using polar rays as a resampling interface: image-derived features can be sampled along rays and projected into Cartesian BEV grids of different scales without retraining a separate model for each chip. The reported autonomous-driving results support resolution elasticity, but not arbitrary hardware portability or invariant safety across grids.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260814-One%20Training%20for%20Multiple
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260814-One Training for Multiple` at `788a182fd8823a0b5b019e8c547e081b5f393882`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2304.00525
...
- Source URL: https://arxiv.org/html/2304.00525
  - Item: Complete primary paper inspected across polar representation, adaptive projection, multi-scale interaction, experiments, ablations, and references.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2304.00525
