# DEP-A-20260806-Heterogeneous Intake

#electronic-health-records #heterogeneous-graphs #graph-neural-networks #diagnosis-prediction #hub-nodes #clinical-ai #archival-intake #whitepaper-review

Public deposition date: 2026-08-06. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260805-Heterogeneous Similarity` at source commit `f36181d7a31bd6495bf0f5ab317a0a003acc28b4`. The paired task indicator is `BL-DEPPAIR-20260806-08E97AD6`.
...
The central durable finding is: HSGNN first normalizes and separates an electronic-health-record graph into relation-specific homogeneous views, then fuses learned representations for diagnosis prediction. The decomposition addresses hub-node distortion and relation heterogeneity, but reported benchmark gains do not establish clinical utility or transportability.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260805-Heterogeneous%20Similarity
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260805-Heterogeneous Similarity` at `f36181d7a31bd6495bf0f5ab317a0a003acc28b4`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2101.06800
...
- Source URL: https://arxiv.org/html/2101.06800
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2101.06800
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2101.06800
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
