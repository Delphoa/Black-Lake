# Preserved failed review record — arXiv:2603.27186v1
...
Original failure codes: `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `table_result_missing_real_header_or_value`, `metrics_na_despite_empirical_evidence`, `verified_external_context_missing`, `verified_external_context_missing`.
...
**Paper-reported problem:** For Hybrid Deep Learning with Temporal Data Augmentation for Accurate Remaining Useful Life Prediction of Lithium-Ion Batteries, the formal target is bounded to the source-defined relation among degradation, battery, data, deep, networks, temporal, and prediction. The task assumptions and stakes are anchored to Abstract, and 1 Introduction; no objective outside those sections is inferred.

**Research gap reconstructed from the source:** The paper positions Hybrid Deep Learning with Temporal Data Augmentation for Accurate Remaining Useful Life Prediction of Lithium-Ion Batteries around degradation, battery, data, and prediction. This records the authors' gap framing only; novelty, priority, generality, and superiority require the separate prior-work and evaluation audits.
...
**Formal object 1 at 3.1.1 1D-CNNs — The expression encodes a paper-defined formal relation within 3.1.1 1D-CNNs; its semantic role remains bound to that section..** `X\in\mathbb{R}^{N\times C_{in}\times L_{in}}`
Variables: "X, R, N, C_{in}\\times, and L_{in}}".
...
Source locator: private full-paper evidence dossier for arXiv:2603.27186, 3.1.1 1D-CNNs.

**Formal object 2 at 3.1.1 1D-CNNs — The expression encodes a paper-defined formal relation within 3.1.1 1D-CNNs; its semantic role remains bound to that section..** `W\in\mathbb{R}^{C_{out}\times C_{in}\times K}`
Variables: "W, R, C_{out}\\times, C_{in}\\times, and K".
Sign/normalization/conditioning/surrogate audit: "Detected operations: none mechanically classified. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2603.27186, 3.1.1 1D-CNNs.

**Formal object 3 at 3.1.1 1D-CNNs — The expression encodes a paper-defined formal relation within 3.1.1 1D-CNNs; its semantic role remains bound to that section..** `Y\in\mathbb{R}^{N\times C_{\text{out}}\times L_{\text{out}}}`
Variables: "Y, R, N, C_{\\text{out}}\\times, and L_{\\text{out}}}".
Sign/normalization/conditioning/surrogate audit: "Detected operations: none mechanically classified. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2603.27186, 3.1.1 1D-CNNs.

**Formal object 4 at 3.1.1 1D-CNNs — The expression encodes aggregation, and definition or equality within 3.1.1 1D-CNNs; its semantic role remains bound to that section..** `Y[n,c_{\text{out}},t]=\sum_{c_{\text{in}}=1}^{C_{\text{in}}}\sum_{k=1}^{K}X[n,c_{\text{in}},t+k]\cdot W[c_{\text{out}},c_{\text{in}},k]+b[c_{\text{out}}],`
Variables: "Y, n, c_{\\text{out}}, t, c_{\\text{in}}, C_{\\text{in}}}\\sum, k, X, W, and b".
...
**Formal object 5 at 3.1.1 1D-CNNs — The expression encodes a paper-defined formal relation within 3.1.1 1D-CNNs; its semantic role remains bound to that section..** `b\in\mathbb{R}^{C_{\text{out}}}`
Variables: "b, R, and C_{\\text{out}}}".
Sign/normalization/conditioning/surrogate audit: "Detected operations: none mechanically classified. The review must retain the displayed sign, denominator, conditioning, and surrogate boundary; code behavior was not independently checked.".
Source locator: private full-paper evidence dossier for arXiv:2603.27186, 3.1.1 1D-CNNs.

**Formal object 6 at 3.1.2 DRSN — The expression encodes definition or equality within 3.1.2 DRSN; its semantic role remains bound to that section..** `Y=X\cdot W+b,`
Variables: "Y, X, W, and b".
...
Source locator: private full-paper evidence dossier for arXiv:2603.27186, 3.1.2 DRSN.
...
**Input/output dataflow:** The documented dataflow is reconstructed only across 2.1 Physics-Based Modeling Methods, and 2.2 Deep Learning-Based Methods, where the source associates battery, prediction, degradation, life, modeling, electrochemical, and capacity. Exact sequencing, hidden preprocessing, and post-processing remain bounded to the cited sections.
...
| 2.2 Deep Learning-Based Methods | paper-reported component; inherited-versus-new status requires the cited method and prior-work audit | The source associates this component with Deep, prediction, applied, battery, and Learning-Based; no additional operation is inferred. | private full-paper evidence dossier for arXiv:2603.27186, 2.2 Deep Learning-Based Methods |
...
1. At 2.2 Deep Learning-Based Methods, the paper reports a training-related operation involving Deep, prediction, applied, battery, Learning-Based, and data. *(source locator: private full-paper evidence dossier for arXiv:2603.27186, 2.2 Deep Learning-Based Methods)*
2. At 5 Result and Discussion, the paper reports a training-related operation involving Result, Discussion, present, comprehensive, evaluation, and CDFormer. *(source locator: private full-paper evidence dossier for arXiv:2603.27186, 5 Result and Discussion)*
3. At 2 Related Work, the paper reports a training-related operation involving approaches, deep, learning, Existing, prediction, and broadly. *(source locator: private full-paper evidence dossier for arXiv:2603.27186, 2 Related Work)*
4. At 3.1 CDFormer, the paper reports a training-related operation involving CDFormer, temporal, capture, degradation, D-CNNs, and residual. *(source locator: private full-paper evidence dossier for arXiv:2603.27186, 3.1 CDFormer)*
...
3. At 2.2 Deep Learning-Based Methods, the paper reports an inference or deployment action involving Deep, prediction, applied, battery, Learning-Based, and data. *(source locator: private full-paper evidence dossier for arXiv:2603.27186, 2.2 Deep Learning-Based Methods)*
...
The documented dataflow is reconstructed only across 2.1 Physics-Based Modeling Methods, and 2.2 Deep Learning-Based Methods, where the source associates battery, prediction, degradation, life, modeling, electrochemical, and capacity. Exact sequencing, hidden preprocessing, and post-processing remain bounded to the cited sections.
...
|---|---|---|---|
| lithium-ion | Source mentions tested, and testing partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2603.27186, 4.1 Datasets |
| NASA | Source mentions tested, and testing partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2603.27186, 4.1 Datasets |
| PCoE | Source mentions tested, and testing partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2603.27186, 4.1 Datasets |
| dataset | Source mentions tested, and testing partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2603.27186, 4.1 Datasets |
| CALCE | Source mentions tested, and testing partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2603.27186, 4.1 Datasets |
| RUL | Source mentions tested, and testing partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2603.27186, 4.1 Datasets |
| CDFormer | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2603.27186, 5 Result and Discussion |
| state-of-the-art | Source mentions evaluation partitions; exact counts and leakage controls require the full-section audit. | Source-linked operations: none resolved from the bounded excerpt; no unreported preprocessing is inferred. | private full-paper evidence dossier for arXiv:2603.27186, 5 Result and Discussion |
...
|---|---|---|---|
| CDFormer | Paper-reported comparator at 5 Result and Discussion; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2603.27186, 5 Result and Discussion |
| state-of-the-art | Paper-reported comparator at 5 Result and Discussion; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2603.27186, 5 Result and Discussion |
| learning-based | Paper-reported comparator at 5 Result and Discussion; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2603.27186, 5 Result and Discussion |
| data | Paper-reported comparator at 5 Result and Discussion; official implementation or copied-result status is not inferred from the name. | Comparable model, data, tuning, hardware, and compute budgets require direct source or implementation receipts. | private full-paper evidence dossier for arXiv:2603.27186, 5 Result and Discussion |
...
Not applicable: No named evaluation metric was resolved from the extracted evidence; metric direction or denominator is not inferred. (source locator: private full-paper evidence dossier for arXiv:2603.27186, metric inventory).
...
|---|---|---|---|---|---|---|---|
| evaluation object at 4.1 Datasets | Hybrid Deep Learning with Temporal Data Augmentation for Accurate Remaining Useful Life Prediction of Lithium-Ion Batteries | comparator retained at the cited source locator; not inferred | configuration retained at the cited source locator | source-defined metric | 1, and 2 | Paper-reported numeric evidence only; denominator, conditioning, uncertainty, and table/prose consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, 4.1 Datasets |
...
|---|---|---|---|
| Hybrid Deep Learning with Temporal Data Augmentation for Accurate Remaining Useful Life Prediction of Lithium-Ion Batteries: paper-reported problem claim centered on degradation, battery, data, and deep | Located at Abstract; extracted numeric markers: 15, 34, 16, and 20 (private full-paper evidence dossier for arXiv:2603.27186, Abstract) | promising but bounded to the paper's stated task | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
| Hybrid Deep Learning with Temporal Data Augmentation for Accurate Remaining Useful Life Prediction of Lithium-Ion Batteries: paper-reported mechanism claim centered on battery, prediction, degradation, and life | Located at 2.1 Physics-Based Modeling Methods; extracted numeric markers: 21, 35, 9, and 28 (private full-paper evidence dossier for arXiv:2603.27186, 2.1 Physics-Based Modeling Methods) | paper-reported mechanism; causal attribution requires matched ablation | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
| Hybrid Deep Learning with Temporal Data Augmentation for Accurate Remaining Useful Life Prediction of Lithium-Ion Batteries: paper-reported result claim centered on dataset, NASA, degradation, and CALCE | Located at 4.1 Datasets; extracted numeric markers: 1, and 2 (private full-paper evidence dossier for arXiv:2603.27186, 4.1 Datasets) | supported only under reported evaluation conditions | The review does not expand this claim to untested data, scales, budgets, hardware, populations, or deployment conditions. |
...
- **Predecessor/prior work (blocked):** The bounded online record did not verify a noncanonical predecessor or prior-work source URL; the corresponding field-level claim remains unvalidated. *(evidence locator: online-vetting check for arXiv:2603.27186)*
- **Alternative or benchmark (blocked):** The bounded online record did not verify a noncanonical alternative or benchmark source URL; the corresponding field-level claim remains unvalidated. *(evidence locator: online-vetting check for arXiv:2603.27186)*
- **Code/data (blocked):** The bounded online record did not verify a noncanonical code or data artifact URL; the corresponding field-level claim remains unvalidated. *(evidence locator: online-vetting check for arXiv:2603.27186)*
...
Reviewer inference: the durable mechanism is the source-defined change centered on battery, prediction, degradation, and life, rather than the paper's brand name. This interpretation predicts that a matched intervention on battery changes dataset; it is not an author claim or theorem.
...
Substantive evidence boundary: The profile binds arXiv:2603.27186v1 to a complete local PDF and full-paper HTML, 32 headings, 10 tables, 15 figures, and 95 extracted mathematical objects, and 0 bounded verified noncanonical or canonical URLs. No experiment, code path, data pipeline, hardware measurement, security property, or production claim was independently reproduced.
...
|---|---|---|
| Table 1 | Purpose: The caption frames this object around Detailed, Information, NASA, Lithium-Ion, Battery, and Dataset.; result: Paper-reported numeric markers: 1; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Table 1 caption |
| Table 2 | Purpose: The caption frames this object around Detailed, Information, CALCE, Lithium-Ion, Battery, and Dataset.; result: Paper-reported numeric markers: 2; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Table 2 caption |
| Table 3 | Purpose: The caption frames this object around Input, features, NASA, CALCE, and datasets.; result: Paper-reported numeric markers: 3; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Table 3 caption |
| Table 4 | Purpose: The caption frames this object around Quantitative, evaluations, CDFormer, baseline, NASA, and CALCE.; result: Paper-reported numeric markers: 4; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Table 4 caption |
| Table 5 | Purpose: The caption frames this object around Quantitative, evaluations, CDFormer, deep, learning-based, and variant.; result: Paper-reported numeric markers: 5; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Table 5 caption |
| Table 6 | Purpose: The caption frames this object around Impact, temporal, data, augmentation, NASA, and CALCE.; result: Paper-reported numeric markers: 6; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Table 6 caption |
| Table 7 | Purpose: The caption frames this object around Performance, variants, temporal, data, augmentation, and NASA.; result: Paper-reported numeric markers: 7; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Table 7 caption |
| Table 8 | Purpose: The caption frames this object around Performance, variants, temporal, data, augmentation, and CALCE.; result: Paper-reported numeric markers: 8; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Table 8 caption |
| Table 9 | Purpose: The caption frames this object around temporal, Impact, data, augmentation, single, and feature.; result: Paper-reported numeric markers: 9; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Table 9 caption |
| Table 10 | Purpose: The caption frames this object around temporal, Impact, data, augmentation, single, and feature.; result: Paper-reported numeric markers: 10; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Table 10 caption |
| Figure 1 | Purpose: The caption frames this object around temporal, Workflow, CDFormer, prediction, pipeline, and including.; result: Paper-reported numeric markers: 1; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure 1 caption |
| Figure 2 | Purpose: The caption frames this object around Overall, architecture, D-CNN, time-series, feature, and extraction.; result: Paper-reported numeric markers: 2; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure 2 caption |
| Figure 3 | Purpose: The caption frames this object around Architecture, DRSN, module, convolution, soft-thresholding, and residual.; result: Paper-reported numeric markers: 3; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure 3 caption |
| Figure inventory item 4 | Purpose: The caption frames this object around Transformer, encoder, and block.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure inventory item 4 caption |
| Figure inventory item 5 | Purpose: The caption frames this object around Regression, head, and architecture.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure inventory item 5 caption |
| Figure 4 | Purpose: The caption frames this object around architectures, Transformer, encoder, block, multi-head, and attention.; result: Paper-reported numeric markers: 4; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure 4 caption |
| Figure 5 | Purpose: The caption frames this object around Three, Temporal, Augmentation, and Techniques.; result: Paper-reported numeric markers: 5; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure 5 caption |
| Figure inventory item 8 | Purpose: The caption frames this object around NASA, and dataset.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure inventory item 8 caption |
| Figure inventory item 9 | Purpose: The caption frames this object around CALCE, and dataset.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure inventory item 9 caption |
| Figure 6 | Purpose: The caption frames this object around NASA, CALCE, column, metrics, predicted, and true.; result: Paper-reported numeric markers: 6; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure 6 caption |
| Figure 7 | Purpose: The caption frames this object around RMSE, metrics, predicted, true, capacity, and curves.; result: Paper-reported numeric markers: 7; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure 7 caption |
| Figure 8 | Purpose: The caption frames this object around augmentation, NASA, CALCE, column, dataset, and Visualization.; result: Paper-reported numeric markers: 8; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure 8 caption |
| Figure inventory item 13 | Purpose: The caption frames this object around Impact, data, augmentation, different, variants, and NASA.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure inventory item 13 caption |
| Figure inventory item 14 | Purpose: The caption frames this object around Impact, data, augmentation, different, variants, and CALCE.; result: Paper-reported numeric markers: none mechanically isolated; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure inventory item 14 caption |
| Figure 9 | Purpose: The caption frames this object around Comparison, impact, data, augmentation, different, and variants.; result: Paper-reported numeric markers: 9; direction and context remain bound to the caption and surrounding section.; caveat: Caption-level disposition only; cells, axes, denominators, conditioning, and appendix consistency were not independently reproduced. | private full-paper evidence dossier for arXiv:2603.27186, Figure 9 caption |
