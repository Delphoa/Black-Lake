# DEP-A-20260814-Digital and Intake

#biometrics #face-recognition #presentation-attacks #deepfakes #forensics #security-review #archival-intake #whitepaper-review

Public deposition date: 2026-08-14. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260813-Digital and Physical Face` at source commit `ef1ada6c114897ab17a91db92882139989f414e6`. The paired task indicator is `BL-DEPPAIR-20260814-81616E1B`.
...
The central durable finding is: The survey's durable value is boundary unification: presentation attacks, digital manipulations, and adversarial perturbations can compose across capture and processing, so a face-integrity system should preserve attack provenance and evaluate joint coverage rather than operate isolated spoof and deepfake detectors. The evidence is a broad 253-reference taxonomy and dataset/method review, not a new detector or pooled benchmark result.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260813-Digital%20and%20Physical%20Face
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260813-Digital and Physical Face` at `ef1ada6c114897ab17a91db92882139989f414e6`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2209.14692
  - Item: Canonical arXiv identity and survey version record.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/html/2209.14692
  - Item: Complete primary survey inspected, including taxonomies, dataset tables, physical and digital defenses, adversarial attacks, joint detection, future work, and references.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2209.14692
