# DEP-A-20260806-AVGCN Trajectory Intake

#trajectory-prediction #graph-neural-networks #visual-attention #pedestrians #variational-models #human-data #archival-intake #whitepaper-review

Public deposition date: 2026-08-06. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260805-AVGCN Trajectory` at source commit `f36181d7a31bd6495bf0f5ab317a0a003acc28b4`. The paired task indicator is `BL-DEPPAIR-20260806-79DEFFD8`.
...
The central durable finding is: AVGCN uses separately collected human gaze to decide which nearby pedestrians deserve more weight in a graph convolution, applies visual-field constraints, and retains stochastic trajectory decoding. The evidence supports a tested attention-guided prediction design, not a universal model of human attention or safe crowd forecasting.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260805-AVGCN%20Trajectory
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260805-AVGCN Trajectory` at `f36181d7a31bd6495bf0f5ab317a0a003acc28b4`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2101.05682
...
- Source URL: https://arxiv.org/html/2101.05682
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2101.05682
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.48550/arXiv.2101.05682
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/Series%20001/DEP-E-20260711-SSP%20Oriented%20Detection
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
