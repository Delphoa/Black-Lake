# DEP-A-20260803-EncoderMI Privacy Intake

#membership-inference #contrastive-learning #encoder-privacy #security-evaluation #calibration #archival-intake #whitepaper-review

Public deposition date: 2026-08-03. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260802-EncoderMI Privacy` at source commit `e93be13b36d73646f6f405a0516cffef18216ccd`. The paired task indicator is `BL-DEPPAIR-20260803-905A599F`.
...
The central durable finding is: EncoderMI converts augmentation invariance into a black-box membership signal: member and non-member inputs can produce different pairwise-similarity distributions across views. The result is a privacy diagnostic with meaningful error, not proof that an individual sample was used for training.
...
- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260802-EncoderMI%20Privacy
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260802-EncoderMI Privacy` at `e93be13b36d73646f6f405a0516cffef18216ccd`
  - Notes: repository data was reviewed in place; no source DEP file was modified, moved, copied, renamed, deleted, or reclassified.
- Source URL: https://arxiv.org/abs/2108.11023
...
- Source URL: https://arxiv.org/html/2108.11023
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://arxiv.org/pdf/2108.11023
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://doi.org/10.1145/3460120.3484749
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
- Source URL: https://pure.psu.edu/en/publications/encodermi-membership-inference-against-pre-trained-encoders-in-co
  - Item: Canonical or primary public locator inspected or preserved by the source; no source document deposited.
  - Notes: Reviewed as primary or canonical evidence; no source document was uploaded.
