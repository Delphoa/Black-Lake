# DEP-A-20260804-Vid2Curve Intake

#3d-reconstruction #thin-structures #camera-motion #curve-graphs #self-occlusion #computer-vision #archival-intake #whitepaper-review

Public deposition date: 2026-08-04. This DEP-A is a new, public-safe archival intake derived by reviewing `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction` at source commit `ba8a4ee74ef6128c7a43e7f27af4eee8b6a455bc`. The paired task indicator is `BL-DEPPAIR-20260804-99A4172A`.
...
The central durable finding is: Vid2Curve succeeds by matching representation to evidence: a curve graph preserves connectivity, dynamic-programming correspondence respects local order, and self-occlusion logic rejects ambiguous views while pose and structure are optimized together. The strongest transfer risk is preprocessing and capture geometry, not the final optimizer alone.
...
- [`.lake-data/DEP-A/DEP-A-20260717-PaceVGGT Frame Pruning`](https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-A/DEP-A-20260717-PaceVGGT%20Frame%20Pruning) — verified related DEP-A; it remains distinct from this paired intake.

## Attribution Block

- Source DEP-E repository URL: https://github.com/Delphoa/Black-Lake/tree/main/.lake-data/DEP-E/DEP-E-20260803-Vid2Curve%20Reconstruction
  - Item: complete source record `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction` at `ba8a4ee74ef6128c7a43e7f27af4eee8b6a455bc`
