...
- Source URL: https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E-20260712-HSD%20FTI-FDet/hsd_fti_fdet_manuscript.md
  - Applies to: `pac_confidence_manuscript.md` and the cross-DEP synthesis in this README.
  - Notes: Related DEP on compact safety-critical visual inference, calibration gaps, and escalation.
- Source URL: https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E-20260711-CausalTAD%20Trajectory/causaltad_trajectory_manuscript.md
  - Applies to: `pac_confidence_manuscript.md` and the cross-DEP synthesis in this README.
