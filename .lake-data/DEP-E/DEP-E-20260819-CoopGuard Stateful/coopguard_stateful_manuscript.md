---
title: "CoopGuard Stateful - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of CoopGuard: Stateful Cooperative Agents Safeguarding LLMs Against Evolving Multi-Round Attacks."
...
primary_url: "https://arxiv.org/abs/2604.04060"
stable_identifier: "arXiv:2604.04060; DOI:10.48550/arXiv.2604.04060"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P209"
...
# CoopGuard Stateful - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2604.04060 | https://arxiv.org/abs/2604.04060 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2604.04060 rendering | https://arxiv.org/html/2604.04060 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2604.04060 | https://arxiv.org/pdf/2604.04060 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Cooperative Training of - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Cooperative Training of/cooperative_training_of_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | UAV-Assisted Cooperative - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260805-UAV-Assisted Cooperative/uav_assisted_cooperative_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P209` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Li, Siyuan; Liu, Zehao; Lin, Xi; Mao, Qinghua; Chen, Yuliang; Li, Haoyu; Wu, Jun; Li, Jianhua; Su, Xiu. Submitted/source date: 2026/04/05. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P209`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: cooperative, stateful | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies agents, attacks, cooperative. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around agents, attacks, cooperative. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Have a free development cycle? Help support accessibility at arXiv! Our collaborators at LaTeXML maintain a list of …”. The full-paper rendering contains 78 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving agents, attacks, cooperative. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 55,239 of 75,964 units; duplicate exclusions 1; focus exclusions 6; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how cooperative, stateful connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: cooperative, stateful.
...
|---|---|---|---|
| Cooperative Training of - DEP-E | Related DEP | Overlap: cooperative, stateful | `.lake-data/DEP-E/DEP-E-20260819-Cooperative Training of/cooperative_training_of_manuscript.md` |
| Empirical Study on - DEP-E | Related DEP | Overlap: cooperative | `.lake-data/DEP-E/DEP-E-20260803-Empirical Study on/empirical_study_on_manuscript.md` |
| UAV-Assisted Cooperative - DEP-E | Related DEP | Overlap: cooperative | `.lake-data/DEP-E/DEP-E-20260805-UAV-Assisted Cooperative/uav_assisted_cooperative_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2604.04060 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2604.04060 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2604.04060 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Cooperative Training of/cooperative_training_of_manuscript.md` | Related synthesis: cooperative, stateful | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260803-Empirical Study on/empirical_study_on_manuscript.md` | Related synthesis: cooperative | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260805-UAV-Assisted Cooperative/uav_assisted_cooperative_manuscript.md` | Related synthesis: cooperative | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 55,239 of 75,964 units from 75,967 PDFs.
