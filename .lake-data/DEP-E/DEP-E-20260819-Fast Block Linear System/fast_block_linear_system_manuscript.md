---
title: "Fast Block Linear System - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Fast Block Linear System Solver Using Q-Learning Schduling for Unified Dynamic Power System Simulations."
...
primary_url: "https://arxiv.org/abs/2110.05843"
stable_identifier: "arXiv:2110.05843; DOI:10.48550/arXiv.2110.05843"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P32"
...
# Fast Block Linear System - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2110.05843 | https://arxiv.org/abs/2110.05843 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2110.05843 rendering | https://arxiv.org/html/2110.05843 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2110.05843 | https://arxiv.org/pdf/2110.05843 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Meta Learning with - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Meta Learning with/meta_learning_with_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P32` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Chen, Yingshi; Song, Xinli; Dai, HanYang; Liu, Tao; Zhong, Wuzhi; Wu, Guoyang. Submitted/source date: 2021/10/12. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P32`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We present a fast block direct solver for the unified dynamic simulations of power systems. This solver uses …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We present a fast block direct solver for the unified dynamic simulations of power systems. This solver uses …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: block, fast, power, simulations, solver | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies block, dynamic, fast. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around block, dynamic, fast. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We present a fast block direct solver for the unified dynamic simulations of power systems. This solver uses …”. The full-paper rendering contains 29 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We present a fast block direct solver for the unified dynamic simulations of power systems. This solver uses …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “For sub-matrix A, a new block-reuse parallel method is proposed, which is based on the facts that A …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving block, dynamic, fast. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 28,748 of 75,964 units; duplicate exclusions 0; focus exclusions 3; source-gate exclusions 0; reselections 3.
...
- The related DEPs show how block, fast, power, simulations, solver connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: block, fast, power, simulations, solver.
...
| Meta Learning with - DEP-E | Related DEP | Overlap: solver, fast | `.lake-data/DEP-E/DEP-E-20260819-Meta Learning with/meta_learning_with_manuscript.md` |
| SIM MARL Power - DEP-E | Related DEP | Overlap: power, simulations, solver, block | `.lake-data/DEP-E/DEP-E-20260722-SIM MARL Power/sim_marl_power_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2110.05843 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2110.05843 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2110.05843 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Cooperative Training of/cooperative_training_of_manuscript.md` | Related synthesis: solver, fast | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Meta Learning with/meta_learning_with_manuscript.md` | Related synthesis: solver, fast | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260722-SIM MARL Power/sim_marl_power_manuscript.md` | Related synthesis: power, simulations, solver, block | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 28,748 of 75,964 units from 75,967 PDFs.
