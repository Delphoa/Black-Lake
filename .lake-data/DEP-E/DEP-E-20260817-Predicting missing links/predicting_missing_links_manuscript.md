---
title: "Predicting missing links - DEP-E"
generated_at: "2026-08-17 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Predicting missing links via significant paths."
...
primary_url: "https://arxiv.org/abs/1402.6225"
stable_identifier: "arXiv:1402.6225; DOI:10.1209/0295-5075/106/18008"
deployment_job_id: "BLAD-2200-20260817-2C1A830E"
deployment_item_id: "BLAD-2200-20260817-2C1A830E-P09"
...
# Predicting missing links - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1402.6225 | https://arxiv.org/abs/1402.6225 | Metadata only. | 2026-08-17 | Inspected |
| S2 | Full paper | Primary | HTML | 1402.6225 rendering | https://arxiv.org/html/1402.6225 | Verified local copy withheld. | 2026-08-17 | Inspected in full |
| S3 | PDF | Primary | PDF | 1402.6225 | https://arxiv.org/pdf/1402.6225 | Verified local copy withheld. | 2026-08-17 | Integrity checked and sampled |
| S4 | Dataset Baselines Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-Dataset Baselines/dataset_baselines_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S5 | OS Minimum Paths - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260731-OS Minimum Paths/os_minimum_paths_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S6 | DMNN Conditional Paths - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-DMNN Conditional Paths/dmnn_conditional_paths_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260817-2C1A830E-P09` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-17 | Verified |

Authors: Zhu, Xuzhen; Tian, Hui; Cai, Shimin; Zhou, Tao. Submitted/source date: 2014/02/25. Job `BLAD-2200-20260817-2C1A830E`; item `BLAD-2200-20260817-2C1A830E-P09`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Link prediction plays an important role in understanding the intrinsic evolving mechanisms of networks. With the belief that …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Link prediction plays an important role in understanding the intrinsic evolving mechanisms of networks. With the belief that …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: links, missing, paths, predicting | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies links, missing, paths. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around links, missing, paths. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Link prediction plays an important role in understanding the intrinsic evolving mechanisms of networks. With the belief that …”. The full-paper rendering contains 30 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Link prediction plays an important role in understanding the intrinsic evolving mechanisms of networks. With the belief that …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Plenty of empirical and theoretical studies aim at understanding the intrinsics of evolving networks, from characterizing topological features …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving links, missing, paths. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 6,846 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how links, missing, paths, predicting connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: links, missing, paths, predicting.
...
|---|---|---|---|
| Dataset Baselines Review - DEP-E | Related DEP | Overlap: predicting, missing | `.lake-data/DEP-E/DEP-E-20260721-Dataset Baselines/dataset_baselines_manuscript.md` |
| OS Minimum Paths - DEP-E | Related DEP | Overlap: paths, links | `.lake-data/DEP-E/DEP-E-20260731-OS Minimum Paths/os_minimum_paths_manuscript.md` |
| DMNN Conditional Paths - DEP-E | Related DEP | Overlap: paths, missing | `.lake-data/DEP-E/DEP-E-20260716-DMNN Conditional Paths/dmnn_conditional_paths_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1402.6225 | Metadata and abstract | 2026-08-17 | Metadata only |
| R2 | https://arxiv.org/html/1402.6225 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-17 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1402.6225 | Primary paper integrity | 2026-08-17 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260721-Dataset Baselines/dataset_baselines_manuscript.md` | Related synthesis: predicting, missing | 2026-08-17 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260731-OS Minimum Paths/os_minimum_paths_manuscript.md` | Related synthesis: paths, links | 2026-08-17 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260716-DMNN Conditional Paths/dmnn_conditional_paths_manuscript.md` | Related synthesis: paths, missing | 2026-08-17 | Repository-relative |

## Appendix

- Uniform selected index: 6,846 of 75,964 units from 75,967 PDFs.
