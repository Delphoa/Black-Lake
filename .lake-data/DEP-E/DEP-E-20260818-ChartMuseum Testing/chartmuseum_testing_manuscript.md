---
title: "ChartMuseum Testing - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of ChartMuseum: Testing Visual Reasoning Capabilities of Large Vision-Language Models."
...
primary_url: "https://arxiv.org/abs/2505.13444"
stable_identifier: "arXiv:2505.13444; DOI:10.48550/arXiv.2505.13444"
deployment_job_id: "BLAD-2200-20260818-50A35360"
deployment_item_id: "BLAD-2200-20260818-50A35360-P04"
...
# ChartMuseum Testing - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2505.13444 | https://arxiv.org/abs/2505.13444 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2505.13444 rendering | https://arxiv.org/html/2505.13444 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2505.13444 | https://arxiv.org/pdf/2505.13444 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
...
| S5 | RL of Thoughts Navigating - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-RL of Thoughts Navigating/rl_of_thoughts_navigating_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | ComfyUI-R1 Workflow - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260714-ComfyUI R1/comfyui_r1_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-50A35360-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Tang, Liyan; Kim, Grace; Zhao, Xinyu; Lake, Thom; Ding, Wenxuan; Yin, Fangcong; Singhal, Prasann; Wadhwa, Manya; Liu, Zeyu Leo; Sprague, Zayne; Namuduri, Ramya; Hu, Bodun; Rodriguez, Juan Diego; Peng, Puyuan; Durrett, Greg. Submitted/source date: 2025/05/19. Job `BLAD-2200-20260818-50A35360`; item `BLAD-2200-20260818-50A35360-P04`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: capabilities, reasoning, testing, vision-language, visual | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies capabilities, chartmuseum, reasoning. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around capabilities, chartmuseum, reasoning. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 112 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving capabilities, chartmuseum, reasoning. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 11,241 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how capabilities, reasoning, testing, vision-language, visual connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: capabilities, reasoning, testing, vision-language, visual.
...
|---|---|---|---|
| OViP Preference - DEP-E | Related DEP | Overlap: vision-language, visual | `.lake-data/DEP-E/DEP-E-20260714-OViP Preference/ovip_preference_manuscript.md` |
| RL of Thoughts Navigating - DEP-E | Related DEP | Overlap: reasoning, capabilities, testing | `.lake-data/DEP-E/DEP-E-20260818-RL of Thoughts Navigating/rl_of_thoughts_navigating_manuscript.md` |
| ComfyUI-R1 Workflow - DEP-E | Related DEP | Overlap: reasoning, visual, testing | `.lake-data/DEP-E/DEP-E-20260714-ComfyUI R1/comfyui_r1_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2505.13444 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2505.13444 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2505.13444 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260714-OViP Preference/ovip_preference_manuscript.md` | Related synthesis: vision-language, visual | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-RL of Thoughts Navigating/rl_of_thoughts_navigating_manuscript.md` | Related synthesis: reasoning, capabilities, testing | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260714-ComfyUI R1/comfyui_r1_manuscript.md` | Related synthesis: reasoning, visual, testing | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 11,241 of 75,964 units from 75,967 PDFs.
