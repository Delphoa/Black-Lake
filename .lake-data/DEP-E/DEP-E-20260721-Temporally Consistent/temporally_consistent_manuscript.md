---
title: "Temporally Consistent Review - DEP-E"
generated_at: "2026-07-21 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Temporally Consistent Stereo Matching."
...
primary_url: "https://arxiv.org/abs/2407.11950"
stable_identifier: "arXiv:2407.11950; DOI:10.48550/arXiv.2407.11950"
deployment_job_id: "BLAD-2200-20260721-F7EDC854"
deployment_item_id: "BLAD-2200-20260721-F7EDC854-P08"
...
# Temporally Consistent Review - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2407.11950 | https://arxiv.org/abs/2407.11950 | Metadata only. | 2026-07-21 | Inspected |
| S2 | Full paper | Primary | HTML | 2407.11950 rendering | https://arxiv.org/html/2407.11950 | Verified local copy withheld. | 2026-07-21 | Inspected in full |
| S3 | PDF | Primary | PDF | 2407.11950 | https://arxiv.org/pdf/2407.11950 | Verified local copy withheld. | 2026-07-21 | Integrity checked |
| S4 | VideoWeave - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260709-VideoWeave Geometry/videoweave_geometry_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S5 | ViT Semantic Robustness - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-ViT Semantic Robustness/vit_semantic_robustness_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S6 | AV Emotion Fusion - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260713-AV Emotion Fusion/av_emotion_fusion_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260721-F7EDC854-P08` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-21 | Verified |

Authors: Zeng, Jiaxi; Yao, Chengtang; Wu, Yuwei; Jia, Yunde. Submitted/source date: 2024/07/16. Job `BLAD-2200-20260721-F7EDC854`; item `BLAD-2200-20260721-F7EDC854-P08`.
...
| E2 | S2/S3 | Primary paper | Problem framing around disparity, temporally, stereo | Research objective | High for transcription | Source framing is not independent validation |
...
This paper studies disparity, temporally, stereo and presents the proposed method as its central contribution. The inspected full paper connects the method to matching, temporal, completion and reports empirical or analytical support in its chosen setting. The review preserves those claims as source-reported evidence. It does not claim independent reproduction, current operational validity, or deployment readiness. The main downstream value is a versioned evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

The research object is *Temporally Consistent Stereo Matching*. Its problem framing concentrates on disparity, temporally, stereo. The paper positions the proposed method as a way to organize or improve the relevant mechanism and connects the proposal to matching, temporal, completion.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a meaningful problem involving disparity, temporally, stereo. | Author claim | E2 | Directly supported as source framing; practical importance depends on target context. | Medium-high |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2407.11950 | Metadata and abstract | 2026-07-21 | Metadata only |
| R2 | https://arxiv.org/html/2407.11950 | Full-paper method and evidence | 2026-07-21 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2407.11950 | Primary paper integrity | 2026-07-21 | Verified local copy withheld |
| R4 | https://doi.org/10.48550/arXiv.2407.11950 | Publisher identifier | 2026-07-21 | DOI locator |
| R5 | `.lake-data/DEP-E/DEP-E-20260709-VideoWeave Geometry/videoweave_geometry_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260716-ViT Semantic Robustness/vit_semantic_robustness_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |
| R7 | `.lake-data/DEP-E/DEP-E-20260713-AV Emotion Fusion/av_emotion_fusion_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |

## Appendix

Uniform selected index 58,472 of 75,776 units from 75,779 PDFs; duplicate exclusions 0; reselections 0. The complete-source gate passed after one bounded archive repair. Source documents and companion integrity records remain local; none was staged or uploaded.
