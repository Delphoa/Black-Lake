---
title: "Canonical Intermediate - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Canonical Intermediate Representation for LLM-based optimization problem formulation and code generation."
...
primary_url: "https://arxiv.org/abs/2602.02029"
stable_identifier: "arXiv:2602.02029; DOI:10.48550/arXiv.2602.02029"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P08"
...
# Canonical Intermediate - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2602.02029 | https://arxiv.org/abs/2602.02029 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2602.02029 rendering | https://arxiv.org/html/2602.02029 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2602.02029 | https://arxiv.org/pdf/2602.02029 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | UnityMAS-O A General RL - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-UnityMAS-O A General RL/unitymas_o_a_general_rl_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Efficient LLM-based - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260802-Efficient LLM-based/efficient_llm_based_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P08` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Lyu, Zhongyuan; Hu, Shuoyu; Liu, Lujie; Yang, Hongxia; LI, Ming. Submitted/source date: 2026/02/02. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P08`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: formulation, generation, llm-based, optimization, problem | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies canonical, formulation, generation. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around canonical, formulation, generation. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 131 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving canonical, formulation, generation. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 74,003 of 75,964 units; duplicate exclusions 0; focus exclusions 15; source-gate exclusions 0; reselections 15.
...
- The related DEPs show how formulation, generation, llm-based, optimization, problem connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: formulation, generation, llm-based, optimization, problem.
...
|---|---|---|---|
| COEVO Co-Evolutionary Framework - DEP-E | Related DEP | Overlap: llm-based, generation, optimization, formulation, representation | `.lake-data/DEP-E/DEP-E-20260723-COEVO Co-Evolutionary Fra/coevo_co_evolutionary_fra_manuscript.md` |
| UnityMAS-O A General RL - DEP-E | Related DEP | Overlap: llm-based, optimization, generation, representation, problem | `.lake-data/DEP-E/DEP-E-20260819-UnityMAS-O A General RL/unitymas_o_a_general_rl_manuscript.md` |
| Efficient LLM-based - DEP-E | Related DEP | Overlap: llm-based, representation, problem | `.lake-data/DEP-E/DEP-E-20260802-Efficient LLM-based/efficient_llm_based_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2602.02029 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2602.02029 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2602.02029 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260723-COEVO Co-Evolutionary Fra/coevo_co_evolutionary_fra_manuscript.md` | Related synthesis: llm-based, generation, optimization, formulation, representation | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-UnityMAS-O A General RL/unitymas_o_a_general_rl_manuscript.md` | Related synthesis: llm-based, optimization, generation, representation, problem | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260802-Efficient LLM-based/efficient_llm_based_manuscript.md` | Related synthesis: llm-based, representation, problem | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 74,003 of 75,964 units from 75,967 PDFs.
