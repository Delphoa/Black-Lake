---
title: "Pandora Towards General - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Pandora: Towards General World Model with Natural Language Actions and Video States."
...
primary_url: "https://arxiv.org/abs/2406.09455"
stable_identifier: "arXiv:2406.09455; DOI:10.48550/arXiv.2406.09455"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P329"
...
# Pandora Towards General - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2406.09455 | https://arxiv.org/abs/2406.09455 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2406.09455 rendering | https://arxiv.org/html/2406.09455 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2406.09455 | https://arxiv.org/pdf/2406.09455 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | MobileWorldBench Towards - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-MobileWorldBench Towards/mobileworldbench_towards_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P329` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Xiang, Jiannan; Liu, Guangyi; Gu, Yi; Gao, Qiyue; Ning, Yuting; Zha, Yuheng; Feng, Zeyu; Tao, Tianhua; Hao, Shibo; Shi, Yemin; Liu, Zhengzhong; Xing, Eric P.; Hu, Zhiting. Submitted/source date: 2024/06/12. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P329`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: actions, states, towards, video, world | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies actions, general, language. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around actions, general, language. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 45 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving actions, general, language. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 74,663 of 75,964 units; duplicate exclusions 1; focus exclusions 7; source-gate exclusions 0; reselections 8.
...
- The related DEPs show how actions, states, towards, video, world connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: actions, states, towards, video, world.
...
|---|---|---|---|
| WildWorld A Large-Scale - DEP-E | Related DEP | Overlap: actions, world, states | `.lake-data/DEP-E/DEP-E-20260819-WildWorld A Large-Scale/wildworld_a_large_scale_manuscript.md` |
| Stereo World Model - DEP-E | Related DEP | Overlap: video, world, actions, states | `.lake-data/DEP-E/DEP-E-20260819-Stereo World Model/stereo_world_model_manuscript.md` |
| MobileWorldBench Towards - DEP-E | Related DEP | Overlap: towards, world, states | `.lake-data/DEP-E/DEP-E-20260819-MobileWorldBench Towards/mobileworldbench_towards_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2406.09455 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2406.09455 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2406.09455 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-WildWorld A Large-Scale/wildworld_a_large_scale_manuscript.md` | Related synthesis: actions, world, states | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Stereo World Model/stereo_world_model_manuscript.md` | Related synthesis: video, world, actions, states | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-MobileWorldBench Towards/mobileworldbench_towards_manuscript.md` | Related synthesis: towards, world, states | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 74,663 of 75,964 units from 75,967 PDFs.
