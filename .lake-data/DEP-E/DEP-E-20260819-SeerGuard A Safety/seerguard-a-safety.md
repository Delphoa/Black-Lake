...
primary_subject: "SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260720-Tech Intel 1501"
selection_record: "117 candidates; 35 excluded; 82 eligible; draw 3385036802; zero-based index 50"
expansion_record: "10 retained public locators; draw 4190325964; zero-based index 4"
...
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260720-Tech Intel 1501 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260720-Tech%20Intel%201501/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-20_1501.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260720-Tech%20Intel%201501/daily_research_findings_2026-07-20_1501.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction | Selected supporting source | arXiv record | 2607.15550 | https://arxiv.org/abs/2607.15550v1 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction
- Authors or producing organization: Xue Yu; Bo Yuan; Pengshuai Yang; Kailin Zhao; Hong Hu; Junlan Feng
- Source platform: arXiv
- Publication date: 2026-07-17
- Revision/version date: 2026-07-17
- Stable identifier: 2607.15550
- Categories: cs.AI
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260720-Tech%20Intel%201501/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260720-Tech%20Intel%201501/daily_research_findings_2026-07-20_1501.md | Deposited source synthesis | ** SeerGuard screens instructions before execution and evaluates proposed actions against current mobile GUI states. Its safety-augmented world model predicts semantic next states while estimating action risk. On Qwen3-VL-8B-Instruct, the paper reports a safety-utility score increase from 0.191 to 0.596 under one operating point and a risk-cost reduction from 0.347 to 0.130. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2607.15550v1 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction. The deposited source package reports that ** SeerGuard screens instructions before execution and evaluates proposed actions against current mobile GUI states. Its safety-augmented world model predicts semantic next states while estimating action risk. On Qwen3-VL-8B-Instruct, the paper reports a safety-utility score increase from 0.191 to 0.596 under one operating point and a risk-cost reduction from 0.347 to 0.130. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** Mobile agents can trigger irreversible actions in apps, accounts, and devices. Predicting consequences before tapping or submitting provides a concrete control point for Android and GUI-agent deployments, complementing reactive monitoring with action-level risk assessment. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** Mobile agents can trigger irreversible actions in apps, accounts, and devices. Predicting consequences before tapping or submitting provides a concrete control point for Android and GUI-agent deployments, complementing reactive monitoring with action-level risk assessment.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** SeerGuard screens instructions before execution and evaluates proposed actions against current mobile GUI states. Its safety-augmented world model predicts semantic next states while estimating action risk. On Qwen3-VL-8B-Instruct, the paper reports a safety-utility score increase from 0.191 to 0.596 under one operating point and a risk-cost reduction from 0.347 to 0.130. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction, credited to Xue Yu; Bo Yuan; Pengshuai Yang; Kailin Zhao; Hong Hu; Junlan Feng. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** Mobile agents can trigger irreversible actions in apps, accounts, and devices. Predicting consequences before tapping or submitting provides a concrete control point for Android and GUI-agent deployments, complementing reactive monitoring with action-level risk assessment. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260720-Tech Intel 1501 as a schema-complete DEP-E research artifact.
...
### New in this pass: SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction](https://arxiv.org/abs/2607.15550v1) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://deepmind.google/blog/our-approach-to-bioresilience/ | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.15286 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.16133 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.15610 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.15686 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260720-Tech%20Intel%201501/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260720-Tech%20Intel%201501/daily_research_findings_2026-07-20_1501.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2607.15550v1 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 34 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 35; eligible count 82.
- DEP draw: accepted UInt32 3385036802; rejection limit 4294967218; attempts 1; zero-based index 50.
- Supporting draw: pool 10; accepted UInt32 4190325964; rejection limit 4294967290; attempts 1; zero-based index 4.
