---
title: "Multi-Scale Simulation of - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Multi-Scale Simulation of Complex Systems: A Perspective of Integrating Knowledge and Data."
...
primary_url: "https://arxiv.org/abs/2306.10275"
stable_identifier: "arXiv:2306.10275; DOI:10.48550/arXiv.2306.10275"
deployment_job_id: "BLAD-2200-20260818-A4DB6AFC"
deployment_item_id: "BLAD-2200-20260818-A4DB6AFC-P06"
...
# Multi-Scale Simulation of - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2306.10275 | https://arxiv.org/abs/2306.10275 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2306.10275 rendering | https://arxiv.org/html/2306.10275 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2306.10275 | https://arxiv.org/pdf/2306.10275 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | Multi-scale Deep Neural - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260805-Multi-scale Deep Neural/multi_scale_deep_neural_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | 3D Dehomogenization - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260801-Dehomogenized 3D Topology/dehomogenized_3d_topology_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | SCAN Enhance Time Series - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260816-SCAN Enhance Time Series/scan_enhance_time_series_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-A4DB6AFC-P06` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Wang, Huandong; Yan, Huan; Rong, Can; Yuan, Yuan; Jiang, Fenyu; Han, Zhenyu; Sui, Hongjie; Jin, Depeng; Li, Yong. Submitted/source date: 2023/06/17. Job `BLAD-2200-20260818-A4DB6AFC`; item `BLAD-2200-20260818-A4DB6AFC-P06`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “RNN : RNN is dedicated to capturing the temporal dependencies, by learning the conditional distributions for current and …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The technique of multi-scale simulation, which has been investigated for several decades, can help us solve these two …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: complex, multi-scale, simulation, systems | Cross-DEP synthesis | Medium | No joint experiment exists |
...
The work is organized around complex, integrating, knowledge. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “RNN : RNN is dedicated to capturing the temporal dependencies, by learning the conditional distributions for current and …”. The full-paper rendering contains 78 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The technique of multi-scale simulation, which has been investigated for several decades, can help us solve these two …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Complex system simulation has been playing an irreplaceable role in understanding, predicting, and controlling diverse complex systems. In …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving complex, integrating, knowledge. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 50,981 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how complex, multi-scale, simulation, systems connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: complex, multi-scale, simulation, systems.
...
|---|---|---|---|
| Multi-scale Deep Neural - DEP-E | Related DEP | Overlap: multi-scale, complex | `.lake-data/DEP-E/DEP-E-20260805-Multi-scale Deep Neural/multi_scale_deep_neural_manuscript.md` |
| 3D Dehomogenization - DEP-E | Related DEP | Overlap: multi-scale, simulation, systems | `.lake-data/DEP-E/DEP-E-20260801-Dehomogenized 3D Topology/dehomogenized_3d_topology_manuscript.md` |
| SCAN Enhance Time Series - DEP-E | Related DEP | Overlap: multi-scale | `.lake-data/DEP-E/DEP-E-20260816-SCAN Enhance Time Series/scan_enhance_time_series_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2306.10275 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2306.10275 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2306.10275 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260805-Multi-scale Deep Neural/multi_scale_deep_neural_manuscript.md` | Related synthesis: multi-scale, complex | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260801-Dehomogenized 3D Topology/dehomogenized_3d_topology_manuscript.md` | Related synthesis: multi-scale, simulation, systems | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260816-SCAN Enhance Time Series/scan_enhance_time_series_manuscript.md` | Related synthesis: multi-scale | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 50,981 of 75,964 units from 75,967 PDFs.
