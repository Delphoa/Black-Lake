---
title: "A Novel K-Repetition - DEP-E"
generated_at: "2026-08-13 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A Novel K-Repetition Design for SCMA."
...
primary_url: "https://arxiv.org/abs/2205.08149"
stable_identifier: "arXiv:2205.08149; DOI:10.48550/arXiv.2205.08149"
deployment_job_id: "BLAD-2200-20260813-F994AA5E"
deployment_item_id: "BLAD-2200-20260813-F994AA5E-P04"
...
# A Novel K-Repetition - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2205.08149 | https://arxiv.org/abs/2205.08149 | Metadata only. | 2026-08-13 | Inspected |
| S2 | Full paper | Primary | HTML | 2205.08149 rendering | https://arxiv.org/html/2205.08149 | Verified local copy withheld. | 2026-08-13 | Inspected in full |
| S3 | PDF | Primary | PDF | 2205.08149 | https://arxiv.org/pdf/2205.08149 | Verified local copy withheld. | 2026-08-13 | Integrity checked and sampled |
| S4 | A novel metric for - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260811-A novel metric for/a_novel_metric_for_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S5 | MSAIC ECG - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260715-MSAIC ECG/msaic_ecg_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S6 | FEMOT Tracking Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-FEMOT Tracking/femot_tracking_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260813-F994AA5E-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-13 | Verified |

Authors: Lai, Ke; Liu, Zilong; Lei, Jing; Wen, Lei; Chen, Gaojie; Xiao, Pei. Submitted/source date: 2022/05/17. Job `BLAD-2200-20260813-F994AA5E`; item `BLAD-2200-20260813-F994AA5E-P04`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “This work presents a novel K-Repetition based HARQ scheme for LDPC coded uplink SCMA by employing a network …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “This work presents a novel K-Repetition based HARQ scheme for LDPC coded uplink SCMA by employing a network …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: design, novel | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies design, k-repetition, novel. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around design, k-repetition, novel. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “This work presents a novel K-Repetition based HARQ scheme for LDPC coded uplink SCMA by employing a network …”. The full-paper rendering contains 38 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “This work presents a novel K-Repetition based HARQ scheme for LDPC coded uplink SCMA by employing a network …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Although numerous works concerning enhanced error probability of SCMA have been studied in recent years [ 5 , …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving design, k-repetition, novel. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 39,310 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how design, novel connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: design, novel.
...
|---|---|---|---|
| A novel metric for - DEP-E | Related DEP | Overlap: novel, design | `.lake-data/DEP-E/DEP-E-20260811-A novel metric for/a_novel_metric_for_manuscript.md` |
| MSAIC ECG - DEP-E | Related DEP | Overlap: design | `.lake-data/DEP-E/DEP-E-20260715-MSAIC ECG/msaic_ecg_manuscript.md` |
| FEMOT Tracking Review - DEP-E | Related DEP | Overlap: design | `.lake-data/DEP-E/DEP-E-20260720-FEMOT Tracking/femot_tracking_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2205.08149 | Metadata and abstract | 2026-08-13 | Metadata only |
| R2 | https://arxiv.org/html/2205.08149 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-13 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2205.08149 | Primary paper integrity | 2026-08-13 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260811-A novel metric for/a_novel_metric_for_manuscript.md` | Related synthesis: novel, design | 2026-08-13 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260715-MSAIC ECG/msaic_ecg_manuscript.md` | Related synthesis: design | 2026-08-13 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260720-FEMOT Tracking/femot_tracking_manuscript.md` | Related synthesis: design | 2026-08-13 | Repository-relative |

## Appendix

- Uniform selected index: 39,310 of 75,964 units from 75,967 PDFs.
