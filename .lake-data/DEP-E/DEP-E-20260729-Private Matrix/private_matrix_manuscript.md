---
title: "Private Matrix - DEP-E"
generated_at: "2026-07-29 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Private Matrix Approximation and Geometry of Unitary Orbits."
...
primary_url: "https://arxiv.org/abs/2207.02794"
stable_identifier: "arXiv:2207.02794; DOI:10.48550/arXiv.2207.02794"
deployment_job_id: "BLAD-2200-20260729-5EE3EF9C"
deployment_item_id: "BLAD-2200-20260729-5EE3EF9C-P02"
...
# Private Matrix - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2207.02794 | https://arxiv.org/abs/2207.02794 | Metadata only. | 2026-07-29 | Inspected |
| S2 | Full paper | Primary | HTML | 2207.02794 rendering | https://ar5iv.labs.arxiv.org/html/2207.02794 | Verified local copy withheld. | 2026-07-29 | Inspected in full |
| S3 | PDF | Primary | PDF | 2207.02794 | https://arxiv.org/pdf/2207.02794 | Verified local copy withheld. | 2026-07-29 | Integrity checked and sampled |
| S4 | Provably Faster Algorithms for B - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-Provably Faster Algorithm/provably_faster_algorithm_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S5 | Spiking Pose Tracking - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S6 | GenTune Traceable Prompts Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260722-GenTune Traceable Prompts/gentune_traceable_prompts_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260729-5EE3EF9C-P02` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-29 | Verified |

Authors: Mangoubi, Oren; Wu, Yikai; Kale, Satyen; Thakurta, Abhradeep Guha; Vishnoi, Nisheeth K.. Submitted/source date: 2022/07/06. Job `BLAD-2200-20260729-5EE3EF9C`; item `BLAD-2200-20260729-5EE3EF9C-P02`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Since such matrix approximation problems are often applied to matrices arising from user data (i.e. each user contributes …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Consider the following optimization problem: Given n × n 𝑛 𝑛 n\times n matrices A 𝐴 A and …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithms, human, image, improve, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies approximation, matrix, private. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around approximation, matrix, private. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Since such matrix approximation problems are often applied to matrices arising from user data (i.e. each user contributes …”. The full-paper rendering contains 134 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Consider the following optimization problem: Given n × n 𝑛 𝑛 n\times n matrices A 𝐴 A and …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “All the algorithms mentioned above that come with pure differential privacy guarantees utilize the exponential mechanism [ 18 …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving approximation, matrix, private. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 22,919 of 75,778 units; duplicate exclusions 0; source-gate exclusions 1; reselections 1.
...
- The related DEPs show how algorithms, human, image, improve, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithms, human, image, improve, optimization.
...
|---|---|---|---|
| Provably Faster Algorithms for B - DEP-E | Related DEP | Overlap: algorithms, optimization | `.lake-data/DEP-E/DEP-E-20260723-Provably Faster Algorithm/provably_faster_algorithm_manuscript.md` |
| Spiking Pose Tracking - DEP-E | Related DEP | Overlap: human, pose | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` |
| GenTune Traceable Prompts Review - DEP-E | Related DEP | Overlap: improve, image | `.lake-data/DEP-E/DEP-E-20260722-GenTune Traceable Prompts/gentune_traceable_prompts_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2207.02794 | Metadata and abstract | 2026-07-29 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/2207.02794 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-29 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2207.02794 | Primary paper integrity | 2026-07-29 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260723-Provably Faster Algorithm/provably_faster_algorithm_manuscript.md` | Related synthesis: algorithms, optimization | 2026-07-29 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Related synthesis: human, pose | 2026-07-29 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260722-GenTune Traceable Prompts/gentune_traceable_prompts_manuscript.md` | Related synthesis: improve, image | 2026-07-29 | Repository-relative |

## Appendix

- Uniform selected index: 22,919 of 75,778 units from 75,781 PDFs.
...
- Duplicate exclusions: 0; source-gate exclusions: 1; reselections: 1; 24-hour cutoff: 2026-07-28.
