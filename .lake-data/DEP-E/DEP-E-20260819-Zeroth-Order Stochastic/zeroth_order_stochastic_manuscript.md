---
title: "Zeroth-Order Stochastic - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Zeroth-Order Stochastic Mirror Descent Algorithms for Minimax Excess Risk Optimization."
...
primary_url: "https://arxiv.org/abs/2408.12209"
stable_identifier: "arXiv:2408.12209; DOI:10.48550/arXiv.2408.12209"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P416"
...
# Zeroth-Order Stochastic - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2408.12209 | https://arxiv.org/abs/2408.12209 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2408.12209 rendering | https://arxiv.org/html/2408.12209 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2408.12209 | https://arxiv.org/pdf/2408.12209 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Sample Complexity of - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Sample Complexity of/sample_complexity_of_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | GPMD Regularized RL - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-GPMD Regularized RL/gpmd_regularized_rl_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | A Mirror Descent-Based - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A Mirror Descent-Based/a_mirror_descent_based_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P416` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Gu, Zhihao; Xu, Zi. Submitted/source date: 2024/08/22. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P416`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The minimax excess risk optimization (MERO) problem is a new variation of the traditional distributionally robust optimization (DRO) …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The minimax excess risk optimization (MERO) problem is a new variation of the traditional distributionally robust optimization (DRO) …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithms, descent, mirror, optimization, risk | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithms, descent, excess. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithms, descent, excess. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The minimax excess risk optimization (MERO) problem is a new variation of the traditional distributionally robust optimization (DRO) …”. The full-paper rendering contains 53 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The minimax excess risk optimization (MERO) problem is a new variation of the traditional distributionally robust optimization (DRO) …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “MERO can be described as deducting each distribution’s inherent level of difficulty i.e., the minimum risk R i …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithms, descent, excess. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 18,653 of 75,964 units; duplicate exclusions 1; focus exclusions 7; source-gate exclusions 0; reselections 8.
...
- The related DEPs show how algorithms, descent, mirror, optimization, risk connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithms, descent, mirror, optimization, risk.
...
|---|---|---|---|
| Sample Complexity of - DEP-E | Related DEP | Overlap: mirror, descent, optimization, risk | `.lake-data/DEP-E/DEP-E-20260819-Sample Complexity of/sample_complexity_of_manuscript.md` |
| GPMD Regularized RL - DEP-E | Related DEP | Overlap: mirror, descent, stochastic, optimization, risk | `.lake-data/DEP-E/DEP-E-20260716-GPMD Regularized RL/gpmd_regularized_rl_manuscript.md` |
| A Mirror Descent-Based - DEP-E | Related DEP | Overlap: mirror, descent, algorithms, risk | `.lake-data/DEP-E/DEP-E-20260819-A Mirror Descent-Based/a_mirror_descent_based_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2408.12209 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2408.12209 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2408.12209 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Sample Complexity of/sample_complexity_of_manuscript.md` | Related synthesis: mirror, descent, optimization, risk | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260716-GPMD Regularized RL/gpmd_regularized_rl_manuscript.md` | Related synthesis: mirror, descent, stochastic, optimization, risk | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-A Mirror Descent-Based/a_mirror_descent_based_manuscript.md` | Related synthesis: mirror, descent, algorithms, risk | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 18,653 of 75,964 units from 75,967 PDFs.
