---
title: "SPikE-SSM A Sparse - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of SPikE-SSM: A Sparse, Precise, and Efficient Spiking State Space Model for Long Sequences Learning."
...
primary_url: "https://arxiv.org/abs/2410.17268"
stable_identifier: "arXiv:2410.17268; DOI:10.1109/TCDS.2026.3698720"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P82"
...
# SPikE-SSM A Sparse - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2410.17268 | https://arxiv.org/abs/2410.17268 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2410.17268 rendering | https://arxiv.org/html/2410.17268 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2410.17268 | https://arxiv.org/pdf/2410.17268 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Spiking Pose Tracking - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P82` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhong, Yan; Zhao, Ruoyu; Wang, Chao; Guo, Qinghai; Zhang, Jianguo; Lu, Zhichao; Leng, Luziwei. Submitted/source date: 2024/10/07. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P82`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Spiking neural networks (SNNs) provide a low-power, energy-efficient solution by utilizing the spike-based and sparse nature of biological …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Spiking neural networks (SNNs) provide a low-power, energy-efficient solution by utilizing the spike-based and sparse nature of biological …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: long, precise, sequences, sparse, spiking | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies long, precise, sequences. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around long, precise, sequences. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Spiking neural networks (SNNs) provide a low-power, energy-efficient solution by utilizing the spike-based and sparse nature of biological …”. The full-paper rendering contains 80 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Spiking neural networks (SNNs) provide a low-power, energy-efficient solution by utilizing the spike-based and sparse nature of biological …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Spiking neural networks (SNNs) provide a low-power, energy-efficient solution by utilizing the spike-based and sparse nature of biological …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving long, precise, sequences. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 11,724 of 75,964 units; duplicate exclusions 1; focus exclusions 9; source-gate exclusions 0; reselections 10.
...
- The related DEPs show how long, precise, sequences, sparse, spiking connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: long, precise, sequences, sparse, spiking.
...
|---|---|---|---|
| Spiking Pose Tracking - DEP-E | Related DEP | Overlap: spiking, sequences, long, sparse, state | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` |
| Dynamical Dictionary - DEP-E | Related DEP | Overlap: spiking, precise, sparse, state | `.lake-data/DEP-E/DEP-E-20260713-Dynamical Dictionary/dynamical_dictionary_manuscript.md` |
| MoCom MAV Comms - DEP-E | Related DEP | Overlap: spiking, long, sparse, state | `.lake-data/DEP-E/DEP-E-20260819-MoCom MAV Comms/mocom_mav_comms_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2410.17268 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2410.17268 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2410.17268 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Related synthesis: spiking, sequences, long, sparse, state | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260713-Dynamical Dictionary/dynamical_dictionary_manuscript.md` | Related synthesis: spiking, precise, sparse, state | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-MoCom MAV Comms/mocom_mav_comms_manuscript.md` | Related synthesis: spiking, long, sparse, state | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 11,724 of 75,964 units from 75,967 PDFs.
