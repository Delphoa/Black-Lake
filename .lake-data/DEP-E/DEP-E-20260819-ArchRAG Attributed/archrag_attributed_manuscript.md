---
title: "ArchRAG Attributed - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of ArchRAG: Attributed Community-based Hierarchical Retrieval-Augmented Generation."
...
primary_url: "https://arxiv.org/abs/2502.09891"
stable_identifier: "arXiv:2502.09891; DOI:10.1609/aaai.v40i19.38619"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P98"
...
# ArchRAG Attributed - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2502.09891 | https://arxiv.org/abs/2502.09891 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2502.09891 rendering | https://arxiv.org/html/2502.09891 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2502.09891 | https://arxiv.org/pdf/2502.09891 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | BookRAG A Hierarchical - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-BookRAG A Hierarchical/bookrag_a_hierarchical_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P98` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Shu; Fang, Yixiang; Zhou, Yingli; Liu, Xilin; Ma, Yuchi. Submitted/source date: 2025/02/14. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P98`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: attributed, generation, hierarchical, retrieval-augmented | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies archrag, attributed, community-based. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around archrag, attributed, community-based. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 75 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving archrag, attributed, community-based. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 19,051 of 75,964 units; duplicate exclusions 0; focus exclusions 11; source-gate exclusions 0; reselections 11.
...
- The related DEPs show how attributed, generation, hierarchical, retrieval-augmented connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: attributed, generation, hierarchical, retrieval-augmented.
...
| DiscourseFlip Risk Review | Related DEP | Overlap: retrieval-augmented, generation, attributed | `.lake-data/DEP-E/DEP-E-20260719-DiscourseFlip RAG Risk/discourseflip_rag_risk_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2502.09891 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2502.09891 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2502.09891 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
...
| R5 | `.lake-data/DEP-E/DEP-E-20260819-BookRAG A Hierarchical/bookrag_a_hierarchical_manuscript.md` | Related synthesis: retrieval-augmented, hierarchical, generation | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260719-DiscourseFlip RAG Risk/discourseflip_rag_risk_manuscript.md` | Related synthesis: retrieval-augmented, generation, attributed | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 19,051 of 75,964 units from 75,967 PDFs.
