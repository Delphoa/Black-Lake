---
title: "From Sim-to-Real Toward - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of From Sim-to-Real: Toward General Event-based Low-light Frame Interpolation with Per-scene Optimization."
...
primary_url: "https://arxiv.org/abs/2406.08090"
stable_identifier: "arXiv:2406.08090; DOI:10.1145/3680528.3687649"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P36"
...
# From Sim-to-Real Toward - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2406.08090 | https://arxiv.org/abs/2406.08090 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2406.08090 rendering | https://arxiv.org/html/2406.08090 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2406.08090 | https://arxiv.org/pdf/2406.08090 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | RetinaGAN Transfer - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260805-RetinaGAN Sim-to-Real/retinagan_sim_to_real_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Shuffled Autoregression - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260724-Shuffled Autoregress/shuffled_autoregression_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P36` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhang, Ziran; Ma, Yongrui; Chen, Yueting; Zhang, Feng; Gu, Jinwei; Xue, Tianfan; Guo, Shi. Submitted/source date: 2024/06/12. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P36`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Video Frame Interpolation (VFI) is important for video enhancement, frame rate up-conversion, and slow-motion generation. The introduction of …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Video Frame Interpolation (VFI) is important for video enhancement, frame rate up-conversion, and slow-motion generation. The introduction of …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: frame, general, interpolation, low-light, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies event-based, frame, general. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around event-based, frame, general. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Video Frame Interpolation (VFI) is important for video enhancement, frame rate up-conversion, and slow-motion generation. The introduction of …”. The full-paper rendering contains 62 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Video Frame Interpolation (VFI) is important for video enhancement, frame rate up-conversion, and slow-motion generation. The introduction of …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Video Frame Interpolation (VFI) is important for video enhancement, frame rate up-conversion, and slow-motion generation. The introduction of …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving event-based, frame, general. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 22,399 of 75,964 units; duplicate exclusions 0; focus exclusions 7; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how frame, general, interpolation, low-light, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: frame, general, interpolation, low-light, optimization.
...
|---|---|---|---|
| RetinaGAN Transfer - DEP-E | Related DEP | Overlap: sim-to-real, interpolation, frame, general, optimization | `.lake-data/DEP-E/DEP-E-20260805-RetinaGAN Sim-to-Real/retinagan_sim_to_real_manuscript.md` |
| Shuffled Autoregression - DEP-E | Related DEP | Overlap: interpolation, frame, general, optimization | `.lake-data/DEP-E/DEP-E-20260724-Shuffled Autoregress/shuffled_autoregression_manuscript.md` |
| Light the Night A - DEP-E | Related DEP | Overlap: low-light | `.lake-data/DEP-E/DEP-E-20260805-Light the Night A/light_the_night_a_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2406.08090 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2406.08090 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2406.08090 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260805-RetinaGAN Sim-to-Real/retinagan_sim_to_real_manuscript.md` | Related synthesis: sim-to-real, interpolation, frame, general, optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260724-Shuffled Autoregress/shuffled_autoregression_manuscript.md` | Related synthesis: interpolation, frame, general, optimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260805-Light the Night A/light_the_night_a_manuscript.md` | Related synthesis: low-light | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 22,399 of 75,964 units from 75,967 PDFs.
