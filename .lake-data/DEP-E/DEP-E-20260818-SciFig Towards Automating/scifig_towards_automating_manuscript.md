---
title: "SciFig Towards Automating - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of SciFig: Towards Automating Editable Figure Generation for Scientific Papers."
...
primary_url: "https://arxiv.org/abs/2601.04390"
stable_identifier: "arXiv:2601.04390; DOI:10.48550/arXiv.2601.04390"
deployment_job_id: "BLAD-2200-20260818-A4DB6AFC"
deployment_item_id: "BLAD-2200-20260818-A4DB6AFC-P01"
...
# SciFig Towards Automating - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2601.04390 | https://arxiv.org/abs/2601.04390 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2601.04390 rendering | https://arxiv.org/html/2601.04390 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2601.04390 | https://arxiv.org/pdf/2601.04390 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | PreGenie Slides - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260806-PreGenie Slides/pregenie_slides_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | ST-NeRF - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-ST-NeRF Video/st_nerf_video_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | CanCal Towards Real-time - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260728-CanCal Towards Real-time/cancal_towards_real_time_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-A4DB6AFC-P01` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Huang, Siyuan; Zhou, Yifan; Gao, Yutong; Yin, Zi; Bai, Juyang; Liu, Xinxin; Chellappa, Rama; Lau, Chun Pong; Peng, Cheng; Nag, Sayan; Pramanick, Shraman. Submitted/source date: 2026/01/07. Job `BLAD-2200-20260818-A4DB6AFC`; item `BLAD-2200-20260818-A4DB6AFC-P01`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: editable, figure, generation, papers, scientific | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies automating, editable, figure. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around automating, editable, figure. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 102 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving automating, editable, figure. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 62,606 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how editable, figure, generation, papers, scientific connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: editable, figure, generation, papers, scientific.
...
|---|---|---|---|
| PreGenie Slides - DEP-E | Related DEP | Overlap: editable, generation, scientific, figure | `.lake-data/DEP-E/DEP-E-20260806-PreGenie Slides/pregenie_slides_manuscript.md` |
| ST-NeRF - DEP-E | Related DEP | Overlap: editable, scientific, generation | `.lake-data/DEP-E/DEP-E-20260818-ST-NeRF Video/st_nerf_video_manuscript.md` |
| CanCal Towards Real-time - DEP-E | Related DEP | Overlap: towards, papers | `.lake-data/DEP-E/DEP-E-20260728-CanCal Towards Real-time/cancal_towards_real_time_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2601.04390 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2601.04390 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2601.04390 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260806-PreGenie Slides/pregenie_slides_manuscript.md` | Related synthesis: editable, generation, scientific, figure | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-ST-NeRF Video/st_nerf_video_manuscript.md` | Related synthesis: editable, scientific, generation | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260728-CanCal Towards Real-time/cancal_towards_real_time_manuscript.md` | Related synthesis: towards, papers | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 62,606 of 75,964 units from 75,967 PDFs.
