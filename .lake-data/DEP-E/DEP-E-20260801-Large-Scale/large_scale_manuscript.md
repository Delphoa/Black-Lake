---
title: "Large-Scale - DEP-E"
generated_at: "2026-08-01 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Large-Scale Spatio-Temporal Person Re-identification: Algorithms and Benchmark."
...
primary_url: "https://arxiv.org/abs/2105.15076"
stable_identifier: "arXiv:2105.15076; DOI:10.48550/arXiv.2105.15076"
deployment_job_id: "BLAD-2200-20260801-A1ED7FC9"
deployment_item_id: "BLAD-2200-20260801-A1ED7FC9-P04"
...
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2105.15076 | https://arxiv.org/abs/2105.15076 | Metadata only. | 2026-08-01 | Inspected |
| S2 | Full paper | Primary | HTML | 2105.15076 rendering | https://ar5iv.labs.arxiv.org/html/2105.15076 | Verified local copy withheld. | 2026-08-01 | Inspected in full |
| S3 | PDF | Primary | PDF | 2105.15076 | https://arxiv.org/pdf/2105.15076 | Verified local copy withheld. | 2026-08-01 | Integrity checked and text extracted |
| S4 | SLFE Redundancy - DEP-E | Related DEP | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260730-SLFE Redundancy Review/slfe_redundancy_manuscript.md` | Synthesis only. | 2026-08-01 | Inspected |
| S5 | Smart Coverage Goals - DEP-E | Related DEP | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` | Synthesis only. | 2026-08-01 | Inspected |
| S6 | MI-Motion - DEP-E | Related DEP | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260728-MI-Motion Review/mi_motion_manuscript.md` | Synthesis only. | 2026-08-01 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260801-A1ED7FC9-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-01 | Verified |

Authors: Shu, Xiujun; Wang, Xiao; Zang, Xianghao; Zhang, Shiliang; Chen, Yuanqi; Li, Ge; Tian, Qi. Submitted/source date: 2021/05/31. Deployment job `BLAD-2200-20260801-A1ED7FC9`; deployment item `BLAD-2200-20260801-A1ED7FC9-P04`.
...
| E2 | S2/S3 | Primary paper | Abstract anchor: "Person re-identification (re-ID) in the scenario with large spatial and temporal spans has not been fully explored. This is partially..." | Problem framing | High for transcription | Source framing is not independent validation |
| E3 | S2/S3 | Primary paper | Method anchor: "In this section, we present a simple but effective method that directly optimizes the mAP value during training." | Proposed mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Result anchor: "For example, it achieves the Rank1 accuracy of 39.3% on PRCC, 13.1% higher than MSMT17." | Author-reported evaluation | Medium | Measurements were not reproduced |
| E5 | S4/S5/S6 | Related DEP manuscripts | Shared concepts: algorithms, benchmark, last, person | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies person, re-id, last. The complete source contains an identifiable problem statement, proposed mechanism, evaluation narrative, and limitations. This review preserves those elements as source claims tied to the paper rather than independent reproduction. Its durable value is an auditable path from claim to baseline comparison, sensitivity testing, uncertainty, abstention, and explicit deployment boundaries.

## Detailed Summary

The authors frame the research object with this concise abstract anchor: "Person re-identification (re-ID) in the scenario with large spatial and temporal spans has not been fully explored. This is partially...". The main technical mechanism is represented by: "In this section, we present a simple but effective method that directly optimizes the mAP value during training.". The paper's full HTML contains 87 heading or section markers and 7 paper-structure terms, while the PDF contains 14 pages and 61,624 extracted text characters.

The strongest result-oriented anchor located during full-text inspection is: "For example, it achieves the Rank1 accuracy of 39.3% on PRCC, 13.1% higher than MSMT17.". This is an author-reported result in the source setting; code, data, exact configuration, and measurements were not rerun. The limitation anchor is: "Not available from inspected sources.". The conclusion anchor is: "This work studies large-scale spatio-temporal person re-identification.". Consequently, external validity, production readiness, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper addresses a problem involving person, re-id, last. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 8,974 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs connect the source to neighboring choices through algorithms, benchmark, last, person.
...
- Connects to three repository artifacts through algorithms, benchmark, last, person.
...
- `Product name`: Person Evidence Bench.
...
|---|---|---|---|
| SLFE Redundancy - DEP-E | Related DEP | Overlap: algorithms, benchmark, last | `.lake-data/DEP-E/DEP-E-20260730-SLFE Redundancy Review/slfe_redundancy_manuscript.md` |
| Smart Coverage Goals - DEP-E | Related DEP | Overlap: algorithms, benchmark, last | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` |
| MI-Motion - DEP-E | Related DEP | Overlap: benchmark, person | `.lake-data/DEP-E/DEP-E-20260728-MI-Motion Review/mi_motion_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2105.15076 | Metadata and abstract | 2026-08-01 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/2105.15076 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-01 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2105.15076 | Primary paper integrity and page-level text extraction | 2026-08-01 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260730-SLFE Redundancy Review/slfe_redundancy_manuscript.md` | Related synthesis: algorithms, benchmark, last | 2026-08-01 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` | Related synthesis: algorithms, benchmark, last | 2026-08-01 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260728-MI-Motion Review/mi_motion_manuscript.md` | Related synthesis: benchmark, person | 2026-08-01 | Repository-relative |

## Appendix

- Uniform selected index: 8,974 of 75,957 units from 75,960 PDFs.
