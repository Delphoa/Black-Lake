---
title: "LPO Towards Accurate GUI - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of LPO: Towards Accurate GUI Agent Interaction via Location Preference Optimization."
...
primary_url: "https://arxiv.org/abs/2506.09373"
stable_identifier: "arXiv:2506.09373; DOI:10.48550/arXiv.2506.09373"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P436"
...
# LPO Towards Accurate GUI - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2506.09373 | https://arxiv.org/abs/2506.09373 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2506.09373 rendering | https://arxiv.org/html/2506.09373 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2506.09373 | https://arxiv.org/pdf/2506.09373 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Rethinking Memory - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Rethinking Memory/rethinking_memory_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P436` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Tang, Jiaqi; Xia, Yu; Wu, Yi-Feng; Hu, Yuwei; Chen, Yuhui; Chen, Qing-Guo; Xu, Xiaogang; Wu, Xiangyu; Lu, Hao; Ma, Yanqing; Lu, Shiyin; Chen, Qifeng. Submitted/source date: 2025/06/11. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P436`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: agent, gui, interaction, optimization, towards | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies accurate, agent, gui. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around accurate, agent, gui. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Have a free development cycle? Help support accessibility at arXiv! Our collaborators at LaTeXML maintain a list of …”. The full-paper rendering contains 106 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving accurate, agent, gui. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 50,402 of 75,964 units; duplicate exclusions 5; focus exclusions 17; source-gate exclusions 0; reselections 22.
...
- The related DEPs show how agent, gui, interaction, optimization, towards connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: agent, gui, interaction, optimization, towards.
...
|---|---|---|---|
| ARPO End-to-End Policy - DEP-E | Related DEP | Overlap: gui, optimization | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` |
| Rethinking Memory - DEP-E | Related DEP | Overlap: towards, agent | `.lake-data/DEP-E/DEP-E-20260819-Rethinking Memory/rethinking_memory_manuscript.md` |
| MCPWorld - DEP-E | Related DEP | Overlap: gui, interaction, agent | `.lake-data/DEP-E/DEP-E-20260730-MCPWorld Benchmark/mcpworld_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2506.09373 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2506.09373 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2506.09373 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` | Related synthesis: gui, optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Rethinking Memory/rethinking_memory_manuscript.md` | Related synthesis: towards, agent | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260730-MCPWorld Benchmark/mcpworld_manuscript.md` | Related synthesis: gui, interaction, agent | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 50,402 of 75,964 units from 75,967 PDFs.
