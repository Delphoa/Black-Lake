...
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260709-Tech Intel 1100 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260709-Tech%20Intel%201100/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-09_1100.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260709-Tech%20Intel%201100/daily_research_findings_2026-07-09_1100.md | Repository evidence; public URL | 2026-08-19 | Inspected |
...
| S4 | Prior Report-Mark | Lineage context | Markdown | BL-DEP-Mark001 Report-Mark.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260709-Tech%20Intel%201100/BL-DEP-Mark001%20Report-Mark.md | Prior review context | 2026-08-19 | Inspected |
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260709-Tech%20Intel%201100/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260709-Tech%20Intel%201100/daily_research_findings_2026-07-09_1100.md | Deposited source synthesis | SciReasoner represents coordinates, molecular topology, and periodic crystal connectivity as structure-aware tokens so a multimodal scientific model can reason over proteins, small molecules, and inorganic crystals. The paper reports state-of-the-art results on 67 of 86 benchmarks, improved low-homology protein annotation, better single-step retrosynthesis accuracy, and expert-preferred or comparable reasoning traces in 98% of evaluated cases. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
...
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260709-Tech%20Intel%201100/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260709-Tech%20Intel%201100/daily_research_findings_2026-07-09_1100.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
...
| R4 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260709-Tech%20Intel%201100/BL-DEP-Mark001%20Report-Mark.md | E4 and prior review lineage | 2026-08-19 | Prior Report-Mark inspected for iterative context. |
