---
title: "Joint Active and Passive - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Joint Active and Passive Beamforming Optimization for Beyond Diagonal RIS-aided Multi-User Communications."
...
primary_url: "https://arxiv.org/abs/2501.10227"
stable_identifier: "arXiv:2501.10227; DOI:10.1109/LCOMM.2025.3528968"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P451"
...
# Joint Active and Passive - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2501.10227 | https://arxiv.org/abs/2501.10227 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2501.10227 rendering | https://arxiv.org/html/2501.10227 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2501.10227 | https://arxiv.org/pdf/2501.10227 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Low-complexity Joint - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Low-complexity Joint/low_complexity_joint_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Low-Complexity - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Movable Antenna-Aided - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Movable Antenna-Aided/movable_antenna_aided_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P451` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhou, Xiaohua; Fang, Tianyu; Mao, Yijie. Submitted/source date: 2025/01/17. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P451`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Benefiting from its capability to generalize existing reconfigurable intelligent surface (RIS) architectures and provide additional design flexibility via …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Benefiting from its capability to generalize existing reconfigurable intelligent surface (RIS) architectures and provide additional design flexibility via …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: beamforming, communications, joint, multi-user, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies active, beamforming, communications. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around active, beamforming, communications. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Benefiting from its capability to generalize existing reconfigurable intelligent surface (RIS) architectures and provide additional design flexibility via …”. The full-paper rendering contains 36 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Benefiting from its capability to generalize existing reconfigurable intelligent surface (RIS) architectures and provide additional design flexibility via …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Benefiting from its capability to generalize existing reconfigurable intelligent surface (RIS) architectures and provide additional design flexibility via …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving active, beamforming, communications. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 25,530 of 75,964 units; duplicate exclusions 3; focus exclusions 4; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how beamforming, communications, joint, multi-user, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: beamforming, communications, joint, multi-user, optimization.
...
|---|---|---|---|
| Low-complexity Joint - DEP-E | Related DEP | Overlap: ris-aided, multi-user, beamforming, joint, communications | `.lake-data/DEP-E/DEP-E-20260819-Low-complexity Joint/low_complexity_joint_manuscript.md` |
| Low-Complexity - DEP-E | Related DEP | Overlap: multi-user, beamforming, optimization, joint | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` |
| Movable Antenna-Aided - DEP-E | Related DEP | Overlap: beamforming, optimization, joint, communications | `.lake-data/DEP-E/DEP-E-20260819-Movable Antenna-Aided/movable_antenna_aided_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2501.10227 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2501.10227 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2501.10227 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Low-complexity Joint/low_complexity_joint_manuscript.md` | Related synthesis: ris-aided, multi-user, beamforming, joint, communications | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` | Related synthesis: multi-user, beamforming, optimization, joint | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Movable Antenna-Aided/movable_antenna_aided_manuscript.md` | Related synthesis: beamforming, optimization, joint, communications | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 25,530 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 3; focus exclusions: 4; source-gate exclusions: 0; reselections: 7; 24-hour cutoff: 2026-08-18.
