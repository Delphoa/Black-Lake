---
title: "An improved approximation - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of An improved approximation algorithm for maximizing a DR-submodular function over a convex set."
...
primary_url: "https://arxiv.org/abs/2203.14740"
stable_identifier: "arXiv:2203.14740; DOI:10.48550/arXiv.2203.14740"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P193"
...
# An improved approximation - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2203.14740 | https://arxiv.org/abs/2203.14740 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2203.14740 rendering | https://arxiv.org/html/2203.14740 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2203.14740 | https://arxiv.org/pdf/2203.14740 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Kernel Taylor-Based Value - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Kernel Taylor-Based Value/kernel_taylor_based_value_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | HiKonv Maximizing the - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260817-HiKonv Maximizing the/hikonv_maximizing_the_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | A local search 4 3 - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A local search 4 3/a_local_search_4_3_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P193` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Du, Donglei; Liu, Zhicheng; Wu, Chenchen; Xu, Dachuan; Zhou, Yang. Submitted/source date: 2022/03/28. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P193`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Maximizing a DR-submodular function subject to a general convex set is an NP-hard problem arising from many applications …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Maximizing a DR-submodular function subject to a general convex set is an NP-hard problem arising from many applications …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, approximation, function, maximizing, set | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, approximation, convex. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, approximation, convex. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Maximizing a DR-submodular function subject to a general convex set is an NP-hard problem arising from many applications …”. The full-paper rendering contains 33 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Maximizing a DR-submodular function subject to a general convex set is an NP-hard problem arising from many applications …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In this work, we consider the problem without any of the two assumptions. This problem was first studied …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, approximation, convex. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 14,789 of 75,964 units; duplicate exclusions 2; focus exclusions 24; source-gate exclusions 0; reselections 26.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; title/abstract evidence terms approximation algorithm.
...
- The related DEPs show how algorithm, approximation, function, maximizing, set connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, approximation, function, maximizing, set.
...
|---|---|---|---|
| Kernel Taylor-Based Value - DEP-E | Related DEP | Overlap: approximation, function, algorithm, set | `.lake-data/DEP-E/DEP-E-20260819-Kernel Taylor-Based Value/kernel_taylor_based_value_manuscript.md` |
| HiKonv Maximizing the - DEP-E | Related DEP | Overlap: maximizing, set | `.lake-data/DEP-E/DEP-E-20260817-HiKonv Maximizing the/hikonv_maximizing_the_manuscript.md` |
| A local search 4 3 - DEP-E | Related DEP | Overlap: approximation, algorithm, set | `.lake-data/DEP-E/DEP-E-20260819-A local search 4 3/a_local_search_4_3_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2203.14740 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2203.14740 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2203.14740 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Kernel Taylor-Based Value/kernel_taylor_based_value_manuscript.md` | Related synthesis: approximation, function, algorithm, set | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260817-HiKonv Maximizing the/hikonv_maximizing_the_manuscript.md` | Related synthesis: maximizing, set | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-A local search 4 3/a_local_search_4_3_manuscript.md` | Related synthesis: approximation, algorithm, set | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 14,789 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 2; focus exclusions: 24; source-gate exclusions: 0; reselections: 26; 24-hour cutoff: 2026-08-18.
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; terms approximation algorithm.
