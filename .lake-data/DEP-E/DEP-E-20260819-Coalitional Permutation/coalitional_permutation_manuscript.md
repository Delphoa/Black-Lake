---
title: "Coalitional Permutation - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Coalitional Permutation Manipulations in the Gale-Shapley Algorithm."
...
primary_url: "https://arxiv.org/abs/1502.07823"
stable_identifier: "arXiv:1502.07823; DOI:10.48550/arXiv.1502.07823"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P179"
...
# Coalitional Permutation - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1502.07823 | https://arxiv.org/abs/1502.07823 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1502.07823 rendering | https://arxiv.org/html/1502.07823 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1502.07823 | https://arxiv.org/pdf/1502.07823 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Self-Learned IDC - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260710-Self Learned IDC/self_learned_idc_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Theoretical and Empirical - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Theoretical and Empirical/theoretical_and_empirical_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P179` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Shen, Weiran; Deng, Yuan; Tang, Pingzhong. Submitted/source date: 2015/02/27. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P179`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In this paper, we consider permutation manipulations by any subset of women in the men-proposing version of the …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In this paper, we consider permutation manipulations by any subset of women in the men-proposing version of the …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, permutation | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, coalitional, gale-shapley. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, coalitional, gale-shapley. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In this paper, we consider permutation manipulations by any subset of women in the men-proposing version of the …”. The full-paper rendering contains 170 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In this paper, we consider permutation manipulations by any subset of women in the men-proposing version of the …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “However, a major concern of the Gale-Shapley algorithm is its non-truthfulness. While it is known that the algorithm …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, coalitional, gale-shapley. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 149 of 75,964 units; duplicate exclusions 0; focus exclusions 1; source-gate exclusions 0; reselections 1.
...
- The related DEPs show how algorithm, permutation connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, permutation.
...
|---|---|---|---|
| Self-Learned IDC - DEP-E | Related DEP | Overlap: permutation | `.lake-data/DEP-E/DEP-E-20260710-Self Learned IDC/self_learned_idc_manuscript.md` |
| Theoretical and Empirical - DEP-E | Related DEP | Overlap: permutation | `.lake-data/DEP-E/DEP-E-20260819-Theoretical and Empirical/theoretical_and_empirical_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1502.07823 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1502.07823 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1502.07823 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260710-Self Learned IDC/self_learned_idc_manuscript.md` | Related synthesis: permutation | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Theoretical and Empirical/theoretical_and_empirical_manuscript.md` | Related synthesis: permutation | 2026-08-19 | Repository-relative |
...
- Uniform selected index: 149 of 75,964 units from 75,967 PDFs.
