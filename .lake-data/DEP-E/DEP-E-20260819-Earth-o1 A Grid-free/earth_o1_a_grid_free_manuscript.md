---
title: "Earth-o1 A Grid-free - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Earth-o1: A Grid-free Observation-native Atmospheric World Model."
...
primary_url: "https://arxiv.org/abs/2605.06337"
stable_identifier: "arXiv:2605.06337; DOI:10.48550/arXiv.2605.06337"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P39"
...
# Earth-o1 A Grid-free - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2605.06337 | https://arxiv.org/abs/2605.06337 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2605.06337 rendering | https://arxiv.org/html/2605.06337 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2605.06337 | https://arxiv.org/pdf/2605.06337 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | In-Context World Modeling - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260804-In-Context World Modeling/in_context_world_modeling_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P39` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Gong, Junchao; Xu, Kaiyi; Wei, Wangxu; Tu, Siwei; Xu, Jingyi; Liu, Zili; Fan, Hang; Zhou, Zhiwang; Han, Tao; Xiao, Yi; Gu, Xinyu; Li, Zhangrui; Zhang, Wenlong; Chen, Hao; Yang, Xiaokang; Wang, Yaqiang; Cheng, Lijing; Gentine, Pierre; Ouyang, Wanli; Zhang, Feng; Tan, Zhe-Min; Zhou, Bowen; Ling, Fenghua; Fei, Ben; Bai, Lei. Submitted/source date: 2026/05/07. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P39`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Observations are the primary means by which the Earth system can be directly measured and explored, and they …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Despite the unprecedented volume of multimodal data provided by modern Earth observation systems, our ability to model atmospheric …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: world | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies atmospheric, earth-o1, grid-free. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around atmospheric, earth-o1, grid-free. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Observations are the primary means by which the Earth system can be directly measured and explored, and they …”. The full-paper rendering contains 45 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Despite the unprecedented volume of multimodal data provided by modern Earth observation systems, our ability to model atmospheric …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Despite the unprecedented volume of multimodal data provided by modern Earth observation systems, our ability to model atmospheric …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving atmospheric, earth-o1, grid-free. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 349 of 75,964 units; duplicate exclusions 0; focus exclusions 15; source-gate exclusions 0; reselections 15.
...
- The related DEPs show how world connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: world.
...
|---|---|---|---|
| HERMES World Model - DEP-E | Related DEP | Overlap: world | `.lake-data/DEP-E/DEP-E-20260712-HERMES World Model/hermes_world_model_manuscript.md` |
| In-Context World Modeling - DEP-E | Related DEP | Overlap: world | `.lake-data/DEP-E/DEP-E-20260804-In-Context World Modeling/in_context_world_modeling_manuscript.md` |
| FutureX Enhance - DEP-E | Related DEP | Overlap: world | `.lake-data/DEP-E/DEP-E-20260818-FutureX Enhance/futurex_enhance_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2605.06337 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2605.06337 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2605.06337 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260712-HERMES World Model/hermes_world_model_manuscript.md` | Related synthesis: world | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260804-In-Context World Modeling/in_context_world_modeling_manuscript.md` | Related synthesis: world | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-FutureX Enhance/futurex_enhance_manuscript.md` | Related synthesis: world | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 349 of 75,964 units from 75,967 PDFs.
