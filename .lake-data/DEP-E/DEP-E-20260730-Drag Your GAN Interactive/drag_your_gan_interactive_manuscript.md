---
title: "Drag Your GAN Interactive - DEP-E"
generated_at: "2026-07-30 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Drag Your GAN: Interactive Point-based Manipulation on the Generative Image Manifold."
...
primary_url: "https://arxiv.org/abs/2305.10973"
stable_identifier: "arXiv:2305.10973; DOI:10.1145/3588432.3591500"
deployment_job_id: "BLAD-2200-20260730-2FDDC232"
deployment_item_id: "BLAD-2200-20260730-2FDDC232-P07"
...
# Drag Your GAN Interactive - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2305.10973 | https://arxiv.org/abs/2305.10973 | Metadata only. | 2026-07-30 | Inspected |
| S2 | Full paper | Primary | HTML | 2305.10973 rendering | https://arxiv.org/html/2305.10973 | Verified local copy withheld. | 2026-07-30 | Inspected in full |
| S3 | PDF | Primary | PDF | 2305.10973 | https://arxiv.org/pdf/2305.10973 | Verified local copy withheld. | 2026-07-30 | Integrity checked and sampled |
| S4 | Spiking Pose Tracking - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Synthesis only. | 2026-07-30 | Inspected |
| S5 | Controlling Latent Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-Controlling Latent/controlling_latent_manuscript.md` | Synthesis only. | 2026-07-30 | Inspected |
| S6 | RRT-CBF Motion - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260711-RRT-CBF Motion/rrt_cbf_motion_manuscript.md` | Synthesis only. | 2026-07-30 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260730-2FDDC232-P07` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-30 | Verified |

Authors: Pan, Xingang; Tewari, Ayush; Leimkühler, Thomas; Liu, Lingjie; Meka, Abhimitra; Theobalt, Christian. Submitted/source date: 2023/05/18. Job `BLAD-2200-20260730-2FDDC232`; item `BLAD-2200-20260730-2FDDC232-P07`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Synthesizing visual content that meets users’ needs often requires flexible and precise controllability of the pose, shape, expression, …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “To achieve flexible, precise, and generic controllability of GANs, in this work, we explore a powerful yet much …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: control, controlling, generative, human, image | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies image, gan, generative. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around image, gan, generative. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Synthesizing visual content that meets users’ needs often requires flexible and precise controllability of the pose, shape, expression, …”. The full-paper rendering contains 72 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “To achieve flexible, precise, and generic controllability of GANs, in this work, we explore a powerful yet much …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Deep generative models such as generative adversarial networks (GANs) (Goodfellow et al . , 2014 ) have achieved …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving image, gan, generative. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 15,176 of 75,957 units; duplicate exclusions 1; source-gate exclusions 0; reselections 1.
...
- The related DEPs show how control, controlling, generative, human, image connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: control, controlling, generative, human, image.
...
|---|---|---|---|
| Spiking Pose Tracking - DEP-E | Related DEP | Overlap: pose, human, tracking | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` |
| Controlling Latent Review - DEP-E | Related DEP | Overlap: controlling, image, generative | `.lake-data/DEP-E/DEP-E-20260721-Controlling Latent/controlling_latent_manuscript.md` |
| RRT-CBF Motion - DEP-E | Related DEP | Overlap: tracking, motion, control | `.lake-data/DEP-E/DEP-E-20260711-RRT-CBF Motion/rrt_cbf_motion_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2305.10973 | Metadata and abstract | 2026-07-30 | Metadata only |
| R2 | https://arxiv.org/html/2305.10973 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-30 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2305.10973 | Primary paper integrity | 2026-07-30 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Related synthesis: pose, human, tracking | 2026-07-30 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260721-Controlling Latent/controlling_latent_manuscript.md` | Related synthesis: controlling, image, generative | 2026-07-30 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260711-RRT-CBF Motion/rrt_cbf_motion_manuscript.md` | Related synthesis: tracking, motion, control | 2026-07-30 | Repository-relative |

## Appendix

- Uniform selected index: 15,176 of 75,957 units from 75,960 PDFs.
...
- Duplicate exclusions: 1; source-gate exclusions: 0; reselections: 1; 24-hour cutoff: 2026-07-29.
