---
title: "MambaPupil Bidirectional - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of MambaPupil: Bidirectional Selective Recurrent model for Event-based Eye tracking."
...
primary_url: "https://arxiv.org/abs/2404.12083"
stable_identifier: "arXiv:2404.12083; DOI:10.48550/arXiv.2404.12083"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P164"
...
# MambaPupil Bidirectional - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2404.12083 | https://arxiv.org/abs/2404.12083 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2404.12083 rendering | https://arxiv.org/html/2404.12083 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2404.12083 | https://arxiv.org/pdf/2404.12083 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | From Sim-to-Real Toward - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-From Sim-to-Real Toward/from_sim_to_real_toward_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P164` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Zhong; Wan, Zengyu; Han, Han; Liao, Bohao; Wu, Yuliang; Zhai, Wei; Cao, Yang; Zha, Zheng-jun. Submitted/source date: 2024/04/18. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P164`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: bidirectional, event-based, selective, tracking | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies bidirectional, event-based, eye. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around bidirectional, event-based, eye. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 41 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving bidirectional, event-based, eye. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 35,733 of 75,964 units; duplicate exclusions 5; focus exclusions 38; source-gate exclusions 0; reselections 43.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; title/abstract evidence terms model, recurrent.
...
- The related DEPs show how bidirectional, event-based, selective, tracking connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: bidirectional, event-based, selective, tracking.
...
|---|---|---|---|
| S3MOT Monocular 3D Object - DEP-E | Related DEP | Overlap: selective, tracking | `.lake-data/DEP-E/DEP-E-20260818-S3MOT Monocular 3D Object/s3mot_monocular_3d_object_manuscript.md` |
| From Sim-to-Real Toward - DEP-E | Related DEP | Overlap: event-based | `.lake-data/DEP-E/DEP-E-20260819-From Sim-to-Real Toward/from_sim_to_real_toward_manuscript.md` |
| RawBMamba Review - DEP-E | Related DEP | Overlap: bidirectional, selective | `.lake-data/DEP-E/DEP-E-20260801-RawBMamba/rawbmamba_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2404.12083 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2404.12083 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2404.12083 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-S3MOT Monocular 3D Object/s3mot_monocular_3d_object_manuscript.md` | Related synthesis: selective, tracking | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-From Sim-to-Real Toward/from_sim_to_real_toward_manuscript.md` | Related synthesis: event-based | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260801-RawBMamba/rawbmamba_manuscript.md` | Related synthesis: bidirectional, selective | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 35,733 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 5; focus exclusions: 38; source-gate exclusions: 0; reselections: 43; 24-hour cutoff: 2026-08-18.
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; terms model, recurrent.
