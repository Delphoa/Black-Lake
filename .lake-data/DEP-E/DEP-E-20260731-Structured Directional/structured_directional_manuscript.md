---
title: "Structured Directional - DEP-E"
generated_at: "2026-07-31 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Structured Directional Pruning via Perturbation Orthogonal Projection."
...
primary_url: "https://arxiv.org/abs/2107.05328"
stable_identifier: "arXiv:2107.05328; DOI:10.48550/arXiv.2107.05328"
deployment_job_id: "BLAD-2200-20260731-3D09E72F"
deployment_item_id: "BLAD-2200-20260731-3D09E72F-P05"
...
# Structured Directional - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2107.05328 | https://arxiv.org/abs/2107.05328 | Metadata only. | 2026-07-31 | Inspected |
| S2 | Full paper | Primary | HTML | 2107.05328 rendering | https://arxiv.org/html/2107.05328 | Verified local copy withheld. | 2026-07-31 | Inspected in full |
| S3 | PDF | Primary | PDF | 2107.05328 | https://arxiv.org/pdf/2107.05328 | Verified local copy withheld. | 2026-07-31 | Integrity checked and sampled |
...
| S5 | Medical Diff VQA - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Medical Diff VQA/medical_diff_vqa_manuscript.md` | Synthesis only. | 2026-07-31 | Inspected |
| S6 | Residual Gaussian CBCT - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260717-Residual Gaussian/residual_gaussian_cbct_manuscript.md` | Synthesis only. | 2026-07-31 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260731-3D09E72F-P05` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-31 | Verified |

Authors: Li, Yinchuan; Liu, Xiaofeng; Shao, Yunfeng; Wang, Qing; Geng, Yanhui. Submitted/source date: 2021/07/12. Job `BLAD-2200-20260731-3D09E72F`; item `BLAD-2200-20260731-3D09E72F-P05`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Structured pruning is an effective compression technique to reduce the computation of neural networks, which is usually achieved …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Structured pruning is an effective compression technique to reduce the computation of neural networks, which is usually achieved …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: compression, directional, memory, perturbation, projection | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies directional, orthogonal, perturbation. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around directional, orthogonal, perturbation. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Structured pruning is an effective compression technique to reduce the computation of neural networks, which is usually achieved …”. The full-paper rendering contains 76 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Structured pruning is an effective compression technique to reduce the computation of neural networks, which is usually achieved …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Deep Neural Network (DNN) has developed rapidly in recent years owing to its state-of-the-art performance in various domains …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving directional, orthogonal, perturbation. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 65,168 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how compression, directional, memory, perturbation, projection connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: compression, directional, memory, perturbation, projection.
...
|---|---|---|---|
| CAP Compression - DEP-E | Related DEP | Overlap: quantization, pruning, projection, sparsity, compression | `.lake-data/DEP-E/DEP-E-20260719-CAP Rank Sparsity/cap_rank_sparsity_manuscript.md` |
| Medical Diff VQA - DEP-E | Related DEP | Overlap: directional, projection, perturbation, structured, memory | `.lake-data/DEP-E/DEP-E-20260716-Medical Diff VQA/medical_diff_vqa_manuscript.md` |
| Residual Gaussian CBCT - DEP-E | Related DEP | Overlap: directional, projection, sparsity, structured, memory | `.lake-data/DEP-E/DEP-E-20260717-Residual Gaussian/residual_gaussian_cbct_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2107.05328 | Metadata and abstract | 2026-07-31 | Metadata only |
| R2 | https://arxiv.org/html/2107.05328 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-31 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2107.05328 | Primary paper integrity | 2026-07-31 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260719-CAP Rank Sparsity/cap_rank_sparsity_manuscript.md` | Related synthesis: quantization, pruning, projection, sparsity, compression | 2026-07-31 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260716-Medical Diff VQA/medical_diff_vqa_manuscript.md` | Related synthesis: directional, projection, perturbation, structured, memory | 2026-07-31 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260717-Residual Gaussian/residual_gaussian_cbct_manuscript.md` | Related synthesis: directional, projection, sparsity, structured, memory | 2026-07-31 | Repository-relative |

## Appendix

- Uniform selected index: 65,168 of 75,957 units from 75,960 PDFs.
