---
title: "Heterogeneous Similarity - DEP-E"
generated_at: "2026-08-05 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Heterogeneous Similarity Graph Neural Network on Electronic Health Records."
...
primary_url: "https://arxiv.org/abs/2101.06800"
stable_identifier: "arXiv:2101.06800; DOI:10.48550/arXiv.2101.06800"
deployment_job_id: "BLAD-2200-20260805-6C10E207"
deployment_item_id: "BLAD-2200-20260805-6C10E207-P08"
...
# Heterogeneous Similarity - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2101.06800 | https://arxiv.org/abs/2101.06800 | Metadata only. | 2026-08-05 | Inspected |
| S2 | Full paper | Primary | HTML | 2101.06800 rendering | https://arxiv.org/html/2101.06800 | Verified local copy withheld. | 2026-08-05 | Inspected in full |
| S3 | PDF | Primary | PDF | 2101.06800 | https://arxiv.org/pdf/2101.06800 | Verified local copy withheld. | 2026-08-05 | Integrity checked and sampled |
| S4 | Reconstruction Guarantee - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260804-Reconstruction Guarantee/reconstruction_guarantee_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S5 | WKGM MRI Reconstruction - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-WKGM MRI Reconstruction/wkgm_mri_reconstruction_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S6 | Residual Gaussian CBCT - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260717-Residual Gaussian/residual_gaussian_cbct_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260805-6C10E207-P08` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-05 | Verified |

Authors: Liu, Zheng; Li, Xiaohan; Peng, Hao; He, Lifang; Yu, Philip S.. Submitted/source date: 2021/01/17. Job `BLAD-2200-20260805-6C10E207`; item `BLAD-2200-20260805-6C10E207-P08`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Mining Electronic Health Records (EHRs) becomes a promising topic because of the rich information they contain. By learning …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Mining Electronic Health Records (EHRs) becomes a promising topic because of the rich information they contain. By learning …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: attenuation, cbct, health, imaging, mri | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies electronic, graph, health. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around electronic, graph, health. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Mining Electronic Health Records (EHRs) becomes a promising topic because of the rich information they contain. By learning …”. The full-paper rendering contains 76 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Mining Electronic Health Records (EHRs) becomes a promising topic because of the rich information they contain. By learning …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Mining Electronic Health Records (EHRs) becomes a promising topic because of the rich information they contain. By learning …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving electronic, graph, health. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 48,460 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how attenuation, cbct, health, imaging, mri connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: attenuation, cbct, health, imaging, mri.
...
|---|---|---|---|
| Reconstruction Guarantee - DEP-E | Related DEP | Overlap: pediatric, pet, tomography, patients, scatter | `.lake-data/DEP-E/DEP-E-20260804-Reconstruction Guarantee/reconstruction_guarantee_manuscript.md` |
| WKGM MRI Reconstruction - DEP-E | Related DEP | Overlap: cbct, patient, mri, imaging, health | `.lake-data/DEP-E/DEP-E-20260720-WKGM MRI Reconstruction/wkgm_mri_reconstruction_manuscript.md` |
| Residual Gaussian CBCT - DEP-E | Related DEP | Overlap: tomography, scatter, attenuation, cbct, mri | `.lake-data/DEP-E/DEP-E-20260717-Residual Gaussian/residual_gaussian_cbct_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2101.06800 | Metadata and abstract | 2026-08-05 | Metadata only |
| R2 | https://arxiv.org/html/2101.06800 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-05 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2101.06800 | Primary paper integrity | 2026-08-05 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260804-Reconstruction Guarantee/reconstruction_guarantee_manuscript.md` | Related synthesis: pediatric, pet, tomography, patients, scatter | 2026-08-05 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260720-WKGM MRI Reconstruction/wkgm_mri_reconstruction_manuscript.md` | Related synthesis: cbct, patient, mri, imaging, health | 2026-08-05 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260717-Residual Gaussian/residual_gaussian_cbct_manuscript.md` | Related synthesis: tomography, scatter, attenuation, cbct, mri | 2026-08-05 | Repository-relative |

## Appendix

- Uniform selected index: 48,460 of 75,957 units from 75,960 PDFs.
