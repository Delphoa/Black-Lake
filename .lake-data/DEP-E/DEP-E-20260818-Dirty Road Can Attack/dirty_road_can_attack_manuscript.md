---
title: "Dirty Road Can Attack - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Dirty Road Can Attack: Security of Deep Learning based Automated Lane Centering under Physical-World Attack."
...
primary_url: "https://arxiv.org/abs/2009.06701"
stable_identifier: "arXiv:2009.06701; DOI:10.48550/arXiv.2009.06701"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P05"
...
# Dirty Road Can Attack - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2009.06701 | https://arxiv.org/abs/2009.06701 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2009.06701 rendering | https://arxiv.org/html/2009.06701 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2009.06701 | https://arxiv.org/pdf/2009.06701 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | Stereo Lane Detection - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Stereo Lane Detection/stereo_lane_detection_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | From Similarity to - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260809-From Similarity to/from_similarity_to_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | DexMimicGen Automated - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260810-DexMimicGen Automated/dexmimicgen_automated_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P05` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Sato, Takami; Shen, Junjie; Wang, Ningfei; Jia, Yunhan Jack; Lin, Xue; Chen, Qi Alfred. Submitted/source date: 2020/09/14. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P05`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Automated Lane Centering (ALC) systems are convenient and widely deployed today, but also highly security and safety critical. …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We evaluate our attack on a production ALC using 80 scenarios from real-world driving traces. The results show …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: attack, automated, lane, road, security | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies attack, automated, centering. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around attack, automated, centering. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Automated Lane Centering (ALC) systems are convenient and widely deployed today, but also highly security and safety critical. …”. The full-paper rendering contains 112 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We evaluate our attack on a production ALC using 80 scenarios from real-world driving traces. The results show …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Automated Lane Centering (ALC) systems are convenient and widely deployed today, but also highly security and safety critical. …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving attack, automated, centering. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 7,759 of 75,964 units; duplicate exclusions 1; source-gate exclusions 0; reselections 1.
...
- The related DEPs show how attack, automated, lane, road, security connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: attack, automated, lane, road, security.
...
|---|---|---|---|
| Stereo Lane Detection - DEP-E | Related DEP | Overlap: lane, road, under | `.lake-data/DEP-E/DEP-E-20260716-Stereo Lane Detection/stereo_lane_detection_manuscript.md` |
| From Similarity to - DEP-E | Related DEP | Overlap: attack, security, under | `.lake-data/DEP-E/DEP-E-20260809-From Similarity to/from_similarity_to_manuscript.md` |
| DexMimicGen Automated - DEP-E | Related DEP | Overlap: automated, under | `.lake-data/DEP-E/DEP-E-20260810-DexMimicGen Automated/dexmimicgen_automated_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2009.06701 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2009.06701 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2009.06701 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260716-Stereo Lane Detection/stereo_lane_detection_manuscript.md` | Related synthesis: lane, road, under | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260809-From Similarity to/from_similarity_to_manuscript.md` | Related synthesis: attack, security, under | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260810-DexMimicGen Automated/dexmimicgen_automated_manuscript.md` | Related synthesis: automated, under | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 7,759 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 1; source-gate exclusions: 0; reselections: 1; 24-hour cutoff: 2026-08-17.
