---
title: "Simulated annealing for - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Simulated annealing for optimization of graphs and sequences."
...
primary_url: "https://arxiv.org/abs/2110.01384"
stable_identifier: "arXiv:2110.01384; DOI:10.1016/j.neucom.2021.09.003"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P39"
...
# Simulated annealing for - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2110.01384 | https://arxiv.org/abs/2110.01384 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2110.01384 rendering | https://arxiv.org/html/2110.01384 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2110.01384 | https://arxiv.org/pdf/2110.01384 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Link Prediction on Latent - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260729-Link Prediction on Latent/link_prediction_on_latent_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Exploring the Potential - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Exploring the Potential/exploring_the_potential_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Automated Retrosynthesis - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Automated Retrosynthesis/automated_retrosynthesis_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P39` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Xianggen; Li, Pengyong; Meng, Fandong; Zhou, Hao; Zhong, Huasong; Zhou, Jie; Mou, Lili; Song, Sen. Submitted/source date: 2021/10/01. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P39`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Optimization of discrete structures aims at generating a new structure with the better property given an existing one, …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Optimization of discrete structures aims at generating a new structure with the better property given an existing one, …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: graphs | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies annealing, graphs, optimization. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around annealing, graphs, optimization. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Optimization of discrete structures aims at generating a new structure with the better property given an existing one, …”. The full-paper rendering contains 63 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Optimization of discrete structures aims at generating a new structure with the better property given an existing one, …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “However, optimization on discrete structures is challenging. On the one hand, the solution space of structures is not …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving annealing, graphs, optimization. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 47,335 of 75,964 units; duplicate exclusions 1; focus exclusions 6; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how graphs connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: graphs.
...
|---|---|---|---|
| Link Prediction on Latent - DEP-E | Related DEP | Overlap: graphs | `.lake-data/DEP-E/DEP-E-20260729-Link Prediction on Latent/link_prediction_on_latent_manuscript.md` |
| Exploring the Potential - DEP-E | Related DEP | Overlap: graphs | `.lake-data/DEP-E/DEP-E-20260818-Exploring the Potential/exploring_the_potential_manuscript.md` |
| Automated Retrosynthesis - DEP-E | Related DEP | Overlap: graphs | `.lake-data/DEP-E/DEP-E-20260819-Automated Retrosynthesis/automated_retrosynthesis_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2110.01384 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2110.01384 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2110.01384 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260729-Link Prediction on Latent/link_prediction_on_latent_manuscript.md` | Related synthesis: graphs | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Exploring the Potential/exploring_the_potential_manuscript.md` | Related synthesis: graphs | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Automated Retrosynthesis/automated_retrosynthesis_manuscript.md` | Related synthesis: graphs | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 47,335 of 75,964 units from 75,967 PDFs.
