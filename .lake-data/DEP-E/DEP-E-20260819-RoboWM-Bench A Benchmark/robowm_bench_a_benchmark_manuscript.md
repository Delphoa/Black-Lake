---
title: "RoboWM-Bench A Benchmark - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of RoboWM-Bench: A Benchmark for Evaluating World Models in Robotic Manipulation."
...
primary_url: "https://arxiv.org/abs/2604.19092"
stable_identifier: "arXiv:2604.19092; DOI:10.48550/arXiv.2604.19092"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P113"
...
# RoboWM-Bench A Benchmark - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2604.19092 | https://arxiv.org/abs/2604.19092 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2604.19092 rendering | https://arxiv.org/html/2604.19092 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2604.19092 | https://arxiv.org/pdf/2604.19092 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Semantic Skill MoE Policies | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-Semantic Skill MoE/semantic_skill_moe_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P113` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Jiang, Feng; Chen, Yang; Xu, Kyle; Liu, Yuchen; Wang, Haifeng; Shen, Zhenhao; Lu, Jasper; Huang, Shengze; Wang, Yuanfei; Xie, Chen; Wu, Ruihai. Submitted/source date: 2026/04/21. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P113`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: benchmark, manipulation, robotic | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies benchmark, evaluating, manipulation. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around benchmark, evaluating, manipulation. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 85 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving benchmark, evaluating, manipulation. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 8,940 of 75,964 units; duplicate exclusions 0; focus exclusions 9; source-gate exclusions 0; reselections 9.
...
- The related DEPs show how benchmark, manipulation, robotic connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: benchmark, manipulation, robotic.
...
|---|---|---|---|
| Semantic Skill MoE Policies | Related DEP | Overlap: manipulation, robotic, benchmark | `.lake-data/DEP-E/DEP-E-20260719-Semantic Skill MoE/semantic_skill_moe_manuscript.md` |
| FAVLA Fast-Slow - DEP-E | Related DEP | Overlap: manipulation, robotic, benchmark | `.lake-data/DEP-E/DEP-E-20260722-FAVLA Fast-Slow/favla_fast_slow_manuscript.md` |
| See Plan Rewind - DEP-E | Related DEP | Overlap: manipulation, robotic | `.lake-data/DEP-E/DEP-E-20260726-See Plan Rewind/see_plan_rewind_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2604.19092 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2604.19092 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2604.19092 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260719-Semantic Skill MoE/semantic_skill_moe_manuscript.md` | Related synthesis: manipulation, robotic, benchmark | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260722-FAVLA Fast-Slow/favla_fast_slow_manuscript.md` | Related synthesis: manipulation, robotic, benchmark | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260726-See Plan Rewind/see_plan_rewind_manuscript.md` | Related synthesis: manipulation, robotic | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 8,940 of 75,964 units from 75,967 PDFs.
