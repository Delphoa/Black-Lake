---
title: "Non-Forgetting Knowledge - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Non-Forgetting Knowledge Allocation with Bi-level Competition for Class-Incremental Learning."
...
primary_url: "https://arxiv.org/abs/2605.29592"
stable_identifier: "arXiv:2605.29592; DOI:10.48550/arXiv.2605.29592"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P174"
...
# Non-Forgetting Knowledge - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2605.29592 | https://arxiv.org/abs/2605.29592 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2605.29592 rendering | https://arxiv.org/html/2605.29592 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2605.29592 | https://arxiv.org/pdf/2605.29592 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Few-shot - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Few-shot/few_shot_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Input-Output Coordinated CIL | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-Coordinated CIL/coordinated_cil_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P174` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Tan, Xiang; He, Run; Cui, Yawen; Zhao, Mengchen; Wu, Yan; Chen, Tianyi; Zhuang, Huiping; Luo, Xiaonan; Li, Guanbin. Submitted/source date: 2026/05/28. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P174`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Class-Incremental Learning (CIL) with pre-trained models (PTMs) aims to sequentially adapt PTMs to new categories without forgetting old …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Class-Incremental Learning (CIL) with pre-trained models (PTMs) aims to sequentially adapt PTMs to new categories without forgetting old …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: class-incremental, knowledge | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies allocation, bi-level, class-incremental. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around allocation, bi-level, class-incremental. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Class-Incremental Learning (CIL) with pre-trained models (PTMs) aims to sequentially adapt PTMs to new categories without forgetting old …”. The full-paper rendering contains 75 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Class-Incremental Learning (CIL) with pre-trained models (PTMs) aims to sequentially adapt PTMs to new categories without forgetting old …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Class-Incremental Learning (CIL) with pre-trained models (PTMs) aims to sequentially adapt PTMs to new categories without forgetting old …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving allocation, bi-level, class-incremental. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 41,055 of 75,964 units; duplicate exclusions 0; focus exclusions 12; source-gate exclusions 0; reselections 12.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories ML memory; title/abstract evidence terms forgetting, learning.
...
- The related DEPs show how class-incremental, knowledge connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: class-incremental, knowledge.
...
|---|---|---|---|
| Few-shot - DEP-E | Related DEP | Overlap: class-incremental, knowledge | `.lake-data/DEP-E/DEP-E-20260818-Few-shot/few_shot_manuscript.md` |
| Input-Output Coordinated CIL | Related DEP | Overlap: class-incremental | `.lake-data/DEP-E/DEP-E-20260719-Coordinated CIL/coordinated_cil_manuscript.md` |
| Make Domain Shift a - DEP-E | Related DEP | Overlap: class-incremental | `.lake-data/DEP-E/DEP-E-20260819-Make Domain Shift a/make_domain_shift_a_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2605.29592 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2605.29592 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2605.29592 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Few-shot/few_shot_manuscript.md` | Related synthesis: class-incremental, knowledge | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260719-Coordinated CIL/coordinated_cil_manuscript.md` | Related synthesis: class-incremental | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Make Domain Shift a/make_domain_shift_a_manuscript.md` | Related synthesis: class-incremental | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 41,055 of 75,964 units from 75,967 PDFs.
...
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories ML memory; terms forgetting, learning.
