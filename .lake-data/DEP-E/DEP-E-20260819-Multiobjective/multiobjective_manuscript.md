---
title: "Multiobjective - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Multiobjective Multitasking Optimization Based on Decomposition with Dual Neighborhoods."
...
primary_url: "https://arxiv.org/abs/2101.07548"
stable_identifier: "arXiv:2101.07548; DOI:10.48550/arXiv.2101.07548"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P444"
...
# Multiobjective - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2101.07548 | https://arxiv.org/abs/2101.07548 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2101.07548 rendering | https://arxiv.org/html/2101.07548 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2101.07548 | https://arxiv.org/pdf/2101.07548 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Variable Division and - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Variable Division and/variable_division_and_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | SANE Embeddings - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260709-SANE Embeddings/sane_embeddings_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P444` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Xianpeng; Dong, Zhiming; Tang, Lixin; Zhang, Qingfu. Submitted/source date: 2021/01/19. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P444`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “This paper proposes a multiobjective multitasking optimization evolutionary algorithm based on decomposition with dual neighborhood. In our proposed …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “This paper proposes a multiobjective multitasking optimization evolutionary algorithm based on decomposition with dual neighborhood. In our proposed …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: multiobjective, neighborhoods, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies decomposition, dual, multiobjective. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around decomposition, dual, multiobjective. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “This paper proposes a multiobjective multitasking optimization evolutionary algorithm based on decomposition with dual neighborhood. In our proposed …”. The full-paper rendering contains 56 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “This paper proposes a multiobjective multitasking optimization evolutionary algorithm based on decomposition with dual neighborhood. In our proposed …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Decomposition-based multiobjective evolutionary algorithm (MOEA/D) has been widely used in multiobjective optimization [ 17 , 18 ] . …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving decomposition, dual, multiobjective. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 14,943 of 75,964 units; duplicate exclusions 3; focus exclusions 5; source-gate exclusions 0; reselections 8.
...
- The related DEPs show how multiobjective, neighborhoods, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: multiobjective, neighborhoods, optimization.
...
|---|---|---|---|
| An Online Prediction - DEP-E | Related DEP | Overlap: multiobjective, optimization | `.lake-data/DEP-E/DEP-E-20260819-An Online Prediction/an_online_prediction_manuscript.md` |
| Variable Division and - DEP-E | Related DEP | Overlap: multiobjective, optimization | `.lake-data/DEP-E/DEP-E-20260819-Variable Division and/variable_division_and_manuscript.md` |
| SANE Embeddings - DEP-E | Related DEP | Overlap: neighborhoods, optimization | `.lake-data/DEP-E/DEP-E-20260709-SANE Embeddings/sane_embeddings_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2101.07548 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2101.07548 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2101.07548 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-An Online Prediction/an_online_prediction_manuscript.md` | Related synthesis: multiobjective, optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Variable Division and/variable_division_and_manuscript.md` | Related synthesis: multiobjective, optimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260709-SANE Embeddings/sane_embeddings_manuscript.md` | Related synthesis: neighborhoods, optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 14,943 of 75,964 units from 75,967 PDFs.
