---
title: "Network Analysis Review - DEP-E"
generated_at: "2026-07-21 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Network Analysis of the iNaturalist Citizen Science Community."
...
primary_url: "https://arxiv.org/abs/2310.10693"
stable_identifier: "arXiv:2310.10693; DOI:10.48550/arXiv.2310.10693"
deployment_job_id: "BLAD-2200-20260721-F7EDC854"
deployment_item_id: "BLAD-2200-20260721-F7EDC854-P10"
...
# Network Analysis Review - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2310.10693 | https://arxiv.org/abs/2310.10693 | Metadata only. | 2026-07-21 | Inspected |
| S2 | Full paper | Primary | HTML | 2310.10693 rendering | https://arxiv.org/html/2310.10693 | Verified local copy withheld. | 2026-07-21 | Inspected in full |
| S3 | PDF | Primary | PDF | 2310.10693 | https://arxiv.org/pdf/2310.10693 | Verified local copy withheld. | 2026-07-21 | Integrity checked |
...
| S5 | PIArena Evaluation - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-PIArena Evaluation/piarena_evaluation_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S6 | CorrKD Missing Modal - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-CorrKD Missing Modal/corrkd_missing_modal_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260721-F7EDC854-P10` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-21 | Verified |

Authors: Liu, Yu Lu; Jiralerspong, Thomas. Submitted/source date: 2023/10/16. Job `BLAD-2200-20260721-F7EDC854`; item `BLAD-2200-20260721-F7EDC854-P10`.
...
| E2 | S2/S3 | Primary paper | Problem framing around science, network, citizen | Research objective | High for transcription | Source framing is not independent validation |
...
This paper studies science, network, citizen and presents the proposed method as its central contribution. The inspected full paper connects the method to inaturalist, structure, projects and reports empirical or analytical support in its chosen setting. The review preserves those claims as source-reported evidence. It does not claim independent reproduction, current operational validity, or deployment readiness. The main downstream value is a versioned evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

The research object is *Network Analysis of the iNaturalist Citizen Science Community*. Its problem framing concentrates on science, network, citizen. The paper positions the proposed method as a way to organize or improve the relevant mechanism and connects the proposal to inaturalist, structure, projects.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a meaningful problem involving science, network, citizen. | Author claim | E2 | Directly supported as source framing; practical importance depends on target context. | Medium-high |
...
| PIArena Evaluation - DEP-E | Related DEP | Related representation, evidence, or implementation lens | `.lake-data/DEP-E/DEP-E-20260716-PIArena Evaluation/piarena_evaluation_manuscript.md` |
| CorrKD Missing Modal - DEP-E | Related DEP | Related representation, evidence, or implementation lens | `.lake-data/DEP-E/DEP-E-20260716-CorrKD Missing Modal/corrkd_missing_modal_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2310.10693 | Metadata and abstract | 2026-07-21 | Metadata only |
| R2 | https://arxiv.org/html/2310.10693 | Full-paper method and evidence | 2026-07-21 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2310.10693 | Primary paper integrity | 2026-07-21 | Verified local copy withheld |
| R4 | https://doi.org/10.48550/arXiv.2310.10693 | Publisher identifier | 2026-07-21 | DOI locator |
...
| R6 | `.lake-data/DEP-E/DEP-E-20260716-PIArena Evaluation/piarena_evaluation_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |
| R7 | `.lake-data/DEP-E/DEP-E-20260716-CorrKD Missing Modal/corrkd_missing_modal_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |

## Appendix

Uniform selected index 26,682 of 75,776 units from 75,779 PDFs; duplicate exclusions 0; reselections 0. The complete-source gate passed after one bounded archive repair. Source documents and companion integrity records remain local; none was staged or uploaded.
