---
title: "STGCN-LSTM for Olympic - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of STGCN-LSTM for Olympic Medal Prediction: Dynamic Power Modeling and Causal Policy Optimization."
...
primary_url: "https://arxiv.org/abs/2501.17711"
stable_identifier: "arXiv:2501.17711; DOI:10.48550/arXiv.2501.17711"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P182"
...
# STGCN-LSTM for Olympic - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2501.17711 | https://arxiv.org/abs/2501.17711 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2501.17711 rendering | https://arxiv.org/html/2501.17711 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2501.17711 | https://arxiv.org/pdf/2501.17711 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | DynFlowDrive Flow-Based - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-DynFlowDrive Flow-Based/dynflowdrive_flow_based_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P182` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Yiquan; Wang, Jiaying; Huang, Tin-Yeh; Yang, Jingyi; Xu, Zihao. Submitted/source date: 2025/01/29. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P182`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: causal, dynamic, modeling, power | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies causal, dynamic, medal. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around causal, dynamic, medal. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 150 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving causal, dynamic, medal. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 17,628 of 75,964 units; duplicate exclusions 2; focus exclusions 14; source-gate exclusions 0; reselections 16.
...
- The related DEPs show how causal, dynamic, modeling, power connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: causal, dynamic, modeling, power.
...
|---|---|---|---|
| Fast Block Linear System - DEP-E | Related DEP | Overlap: power, dynamic, causal | `.lake-data/DEP-E/DEP-E-20260819-Fast Block Linear System/fast_block_linear_system_manuscript.md` |
| DynFlowDrive Flow-Based - DEP-E | Related DEP | Overlap: dynamic, modeling, causal | `.lake-data/DEP-E/DEP-E-20260819-DynFlowDrive Flow-Based/dynflowdrive_flow_based_manuscript.md` |
| WildWorld A Large-Scale - DEP-E | Related DEP | Overlap: dynamic, modeling, causal | `.lake-data/DEP-E/DEP-E-20260819-WildWorld A Large-Scale/wildworld_a_large_scale_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2501.17711 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2501.17711 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2501.17711 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Fast Block Linear System/fast_block_linear_system_manuscript.md` | Related synthesis: power, dynamic, causal | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-DynFlowDrive Flow-Based/dynflowdrive_flow_based_manuscript.md` | Related synthesis: dynamic, modeling, causal | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-WildWorld A Large-Scale/wildworld_a_large_scale_manuscript.md` | Related synthesis: dynamic, modeling, causal | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 17,628 of 75,964 units from 75,967 PDFs.
