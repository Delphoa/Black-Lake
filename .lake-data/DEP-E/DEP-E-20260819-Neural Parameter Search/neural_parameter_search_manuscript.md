---
title: "Neural Parameter Search - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Neural Parameter Search for Slimmer Fine-Tuned Models and Better Transfer."
...
primary_url: "https://arxiv.org/abs/2505.18713"
stable_identifier: "arXiv:2505.18713; DOI:10.48550/arXiv.2505.18713"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P191"
...
# Neural Parameter Search - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2505.18713 | https://arxiv.org/abs/2505.18713 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2505.18713 rendering | https://arxiv.org/html/2505.18713 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2505.18713 | https://arxiv.org/pdf/2505.18713 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P191` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Du, Guodong; Fang, Zitao; Li, Jing; Li, Junlin; Jiang, Runhua; Yu, Shuyang; Guo, Yifei; Chen, Yangneng; Goh, Sim Kuan; Tang, Ho-Kin; He, Daojing; Liu, Honghai; Zhang, Min. Submitted/source date: 2025/05/24. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P191`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: better, neural, parameter, search, transfer | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies better, fine-tuned, neural. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around better, fine-tuned, neural. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 117 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving better, fine-tuned, neural. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 60,490 of 75,964 units; duplicate exclusions 0; focus exclusions 3; source-gate exclusions 0; reselections 3.
...
- The related DEPs show how better, neural, parameter, search, transfer connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: better, neural, parameter, search, transfer.
...
|---|---|---|---|
| Beetle Antennae Search - DEP-E | Related DEP | Overlap: parameter, search, better, transfer | `.lake-data/DEP-E/DEP-E-20260819-Beetle Antennae Search/beetle_antennae_search_manuscript.md` |
| Neural Architecture - DEP-E | Related DEP | Overlap: neural, search, better, transfer | `.lake-data/DEP-E/DEP-E-20260818-Neural Architecture/neural_architecture_manuscript.md` |
| Neural Ensemble Search - DEP-E | Related DEP | Overlap: neural, search, better, transfer | `.lake-data/DEP-E/DEP-E-20260818-Neural Ensemble Search/neural_ensemble_search_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2505.18713 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2505.18713 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2505.18713 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Beetle Antennae Search/beetle_antennae_search_manuscript.md` | Related synthesis: parameter, search, better, transfer | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Neural Architecture/neural_architecture_manuscript.md` | Related synthesis: neural, search, better, transfer | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Neural Ensemble Search/neural_ensemble_search_manuscript.md` | Related synthesis: neural, search, better, transfer | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 60,490 of 75,964 units from 75,967 PDFs.
