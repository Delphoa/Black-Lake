---
title: "A novel metric for - DEP-E"
generated_at: "2026-08-11 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A novel metric for community detection."
...
primary_url: "https://arxiv.org/abs/1909.12467"
stable_identifier: "arXiv:1909.12467; DOI:10.1209/0295-5075/129/68002"
deployment_job_id: "BLAD-2200-20260811-BB3E2A1B"
deployment_item_id: "BLAD-2200-20260811-BB3E2A1B-P09"
...
# A novel metric for - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1909.12467 | https://arxiv.org/abs/1909.12467 | Metadata only. | 2026-08-11 | Inspected |
| S2 | Full paper | Primary | HTML | 1909.12467 rendering | https://arxiv.org/html/1909.12467 | Verified local copy withheld. | 2026-08-11 | Inspected in full |
| S3 | PDF | Primary | PDF | 1909.12467 | https://arxiv.org/pdf/1909.12467 | Verified local copy withheld. | 2026-08-11 | Integrity checked and sampled |
| S4 | Graph-based data - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260811-Graph-based data/graph_based_data_manuscript.md` | Synthesis only. | 2026-08-11 | Inspected |
| S5 | Network Analysis Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-Network Analysis/network_analysis_manuscript.md` | Synthesis only. | 2026-08-11 | Inspected |
| S6 | AMAD Anomaly Detection - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-AMAD Anomaly/amad_anomaly_manuscript.md` | Synthesis only. | 2026-08-11 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260811-BB3E2A1B-P09` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-11 | Verified |

Authors: Shang, Ke-ke; Small, Michael; Wang, Yan; Yin, Di; Li, Shu. Submitted/source date: 2019/09/27. Job `BLAD-2200-20260811-BB3E2A1B`; item `BLAD-2200-20260811-BB3E2A1B-P09`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Research into detection of dense communities has recently attracted increasing attention within network science, various metrics for detection …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Research into detection of dense communities has recently attracted increasing attention within network science, various metrics for detection …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: community, detection, metric, novel | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies community, detection, metric. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around community, detection, metric. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Research into detection of dense communities has recently attracted increasing attention within network science, various metrics for detection …”. The full-paper rendering contains 43 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Research into detection of dense communities has recently attracted increasing attention within network science, various metrics for detection …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Research into detection of dense communities has recently attracted increasing attention within network science, various metrics for detection …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving community, detection, metric. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 7,607 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how community, detection, metric, novel connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: community, detection, metric, novel.
...
|---|---|---|---|
| Graph-based data - DEP-E | Related DEP | Overlap: community, detection, metric | `.lake-data/DEP-E/DEP-E-20260811-Graph-based data/graph_based_data_manuscript.md` |
| Network Analysis Review - DEP-E | Related DEP | Overlap: community, detection, metric | `.lake-data/DEP-E/DEP-E-20260721-Network Analysis/network_analysis_manuscript.md` |
| AMAD Anomaly Detection - DEP-E | Related DEP | Overlap: detection, novel, metric | `.lake-data/DEP-E/DEP-E-20260721-AMAD Anomaly/amad_anomaly_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1909.12467 | Metadata and abstract | 2026-08-11 | Metadata only |
| R2 | https://arxiv.org/html/1909.12467 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-11 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1909.12467 | Primary paper integrity | 2026-08-11 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260811-Graph-based data/graph_based_data_manuscript.md` | Related synthesis: community, detection, metric | 2026-08-11 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260721-Network Analysis/network_analysis_manuscript.md` | Related synthesis: community, detection, metric | 2026-08-11 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260721-AMAD Anomaly/amad_anomaly_manuscript.md` | Related synthesis: detection, novel, metric | 2026-08-11 | Repository-relative |

## Appendix

- Uniform selected index: 7,607 of 75,964 units from 75,967 PDFs.
