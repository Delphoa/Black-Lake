---
title: "From Space-Time to - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of From Space-Time to Space-Order: Directly Planning a Temporal Planning Graph by Redefining CBS."
...
primary_url: "https://arxiv.org/abs/2404.15137"
stable_identifier: "arXiv:2404.15137; DOI:10.48550/arXiv.2404.15137"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P297"
...
# From Space-Time to - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2404.15137 | https://arxiv.org/abs/2404.15137 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2404.15137 rendering | https://arxiv.org/html/2404.15137 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2404.15137 | https://arxiv.org/pdf/2404.15137 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Alleviating Inconsistency Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-Alleviating Inconsistency/alleviating_inconsistency_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Graph Alignment Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260722-Graph Alignment/graph_alignment_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Harnessing Adaptive Topology Rep - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-Harnessing Adaptive Topol/harnessing_adaptive_topol_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P297` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wu, Yu; Veerapaneni, Rishi; Li, Jiaoyang; Likhachev, Maxim. Submitted/source date: 2024/04/23. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P297`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The majority of multi-agent path finding (MAPF) methods compute collision-free space-time paths which require agents to be at …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The majority of multi-agent path finding (MAPF) methods compute collision-free space-time paths which require agents to be at …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: directly, graph, planning, temporal | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies planning, cbs, directly. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around planning, cbs, directly. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The majority of multi-agent path finding (MAPF) methods compute collision-free space-time paths which require agents to be at …”. The full-paper rendering contains 99 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The majority of multi-agent path finding (MAPF) methods compute collision-free space-time paths which require agents to be at …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The majority of multi-agent path finding (MAPF) methods compute collision-free space-time paths which require agents to be at …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving planning, cbs, directly. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 38,038 of 75,964 units; duplicate exclusions 6; focus exclusions 24; source-gate exclusions 0; reselections 30.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; title/abstract evidence terms graph, planning.
...
- The related DEPs show how directly, graph, planning, temporal connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: directly, graph, planning, temporal.
...
|---|---|---|---|
| Alleviating Inconsistency Review - DEP-E | Related DEP | Overlap: graph, directly, planning, temporal | `.lake-data/DEP-E/DEP-E-20260721-Alleviating Inconsistency/alleviating_inconsistency_manuscript.md` |
| Graph Alignment Review - DEP-E | Related DEP | Overlap: graph, directly, planning, temporal | `.lake-data/DEP-E/DEP-E-20260722-Graph Alignment/graph_alignment_manuscript.md` |
| Harnessing Adaptive Topology Rep - DEP-E | Related DEP | Overlap: graph, directly, planning, temporal | `.lake-data/DEP-E/DEP-E-20260723-Harnessing Adaptive Topol/harnessing_adaptive_topol_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2404.15137 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2404.15137 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2404.15137 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260721-Alleviating Inconsistency/alleviating_inconsistency_manuscript.md` | Related synthesis: graph, directly, planning, temporal | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260722-Graph Alignment/graph_alignment_manuscript.md` | Related synthesis: graph, directly, planning, temporal | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260723-Harnessing Adaptive Topol/harnessing_adaptive_topol_manuscript.md` | Related synthesis: graph, directly, planning, temporal | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 38,038 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 6; focus exclusions: 24; source-gate exclusions: 0; reselections: 30; 24-hour cutoff: 2026-08-18.
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; terms graph, planning.
