---
title: "Learning Large - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Learning Large Neighborhood Search Policy for Integer Programming."
...
primary_url: "https://arxiv.org/abs/2111.03466"
stable_identifier: "arXiv:2111.03466; DOI:10.48550/arXiv.2111.03466"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P80"
...
# Learning Large - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2111.03466 | https://arxiv.org/abs/2111.03466 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2111.03466 rendering | https://arxiv.org/html/2111.03466 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2111.03466 | https://arxiv.org/pdf/2111.03466 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Dynamic Partial Removal A - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Dynamic Partial Removal A/dynamic_partial_removal_a_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Language-to-Space - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260727-Language-to-Space/language_to_space_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P80` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wu, Yaoxin; Song, Wen; Cao, Zhiguang; Zhang, Jie. Submitted/source date: 2021/11/01. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P80`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We propose a deep reinforcement learning (RL) method to learn large neighborhood search (LNS) policy for integer programming …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We propose a deep reinforcement learning (RL) method to learn large neighborhood search (LNS) policy for integer programming …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: neighborhood, policy, programming, search | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies integer, neighborhood, policy. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around integer, neighborhood, policy. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We propose a deep reinforcement learning (RL) method to learn large neighborhood search (LNS) policy for integer programming …”. The full-paper rendering contains 65 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We propose a deep reinforcement learning (RL) method to learn large neighborhood search (LNS) policy for integer programming …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “We propose a deep reinforcement learning (RL) method to learn large neighborhood search (LNS) policy for integer programming …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving integer, neighborhood, policy. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 18,243 of 75,964 units; duplicate exclusions 1; focus exclusions 7; source-gate exclusions 0; reselections 8.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; title/abstract evidence terms integer programming.
...
- The related DEPs show how neighborhood, policy, programming, search connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: neighborhood, policy, programming, search.
...
|---|---|---|---|
| Dynamic Partial Removal A - DEP-E | Related DEP | Overlap: neighborhood, search | `.lake-data/DEP-E/DEP-E-20260819-Dynamic Partial Removal A/dynamic_partial_removal_a_manuscript.md` |
| BEAGLE Learner - DEP-E | Related DEP | Overlap: programming, search, policy | `.lake-data/DEP-E/DEP-E-20260710-BEAGLE Learner/beagle_learner_manuscript.md` |
| Language-to-Space - DEP-E | Related DEP | Overlap: programming | `.lake-data/DEP-E/DEP-E-20260727-Language-to-Space/language_to_space_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2111.03466 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2111.03466 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2111.03466 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Dynamic Partial Removal A/dynamic_partial_removal_a_manuscript.md` | Related synthesis: neighborhood, search | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260710-BEAGLE Learner/beagle_learner_manuscript.md` | Related synthesis: programming, search, policy | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260727-Language-to-Space/language_to_space_manuscript.md` | Related synthesis: programming | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 18,243 of 75,964 units from 75,967 PDFs.
...
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; terms integer programming.
