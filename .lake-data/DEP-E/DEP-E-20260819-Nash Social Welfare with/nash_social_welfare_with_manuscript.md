---
title: "Nash Social Welfare with - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Nash Social Welfare with Submodular Valuations: Approximation Algorithms and Integrality Gaps."
...
primary_url: "https://arxiv.org/abs/2504.09669"
stable_identifier: "arXiv:2504.09669; DOI:10.48550/arXiv.2504.09669"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P237"
...
# Nash Social Welfare with - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2504.09669 | https://arxiv.org/abs/2504.09669 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2504.09669 rendering | https://arxiv.org/html/2504.09669 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2504.09669 | https://arxiv.org/pdf/2504.09669 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Approximation algor 14520 - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Approximation algor 14520/approximation_algor_14520_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Approximation Algorithms - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Approximation Algorithms/approximation_algorithms_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Approximation algor 04699 - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Approximation algor 04699/approximation_algor_04699_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P237` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Bei, Xiaohui; Feng, Yuda; Hu, Yang; Li, Shi; Zhang, Ruilong. Submitted/source date: 2025/04/13. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P237`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In this work, we present a ( 3.56 + ϵ ) (3.56+\epsilon) -approximation algorithm for weighted NSW maximization …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We study the problem of allocating items to agents with submodular valuations with the goal of maximizing the …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithms, approximation, submodular | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithms, approximation, gaps. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithms, approximation, gaps. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In this work, we present a ( 3.56 + ϵ ) (3.56+\epsilon) -approximation algorithm for weighted NSW maximization …”. The full-paper rendering contains 192 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We study the problem of allocating items to agents with submodular valuations with the goal of maximizing the …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “On the hardness side, we analyze the integrality gap of the natural configuration LP relaxation for the Nash …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithms, approximation, gaps. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 41,472 of 75,964 units; duplicate exclusions 0; focus exclusions 10; source-gate exclusions 0; reselections 10.
...
- The related DEPs show how algorithms, approximation, submodular connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithms, approximation, submodular.
...
|---|---|---|---|
| Approximation algor 14520 - DEP-E | Related DEP | Overlap: submodular, approximation, algorithms | `.lake-data/DEP-E/DEP-E-20260819-Approximation algor 14520/approximation_algor_14520_manuscript.md` |
| Approximation Algorithms - DEP-E | Related DEP | Overlap: approximation, algorithms | `.lake-data/DEP-E/DEP-E-20260819-Approximation Algorithms/approximation_algorithms_manuscript.md` |
| Approximation algor 04699 - DEP-E | Related DEP | Overlap: approximation, algorithms | `.lake-data/DEP-E/DEP-E-20260819-Approximation algor 04699/approximation_algor_04699_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2504.09669 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2504.09669 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2504.09669 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Approximation algor 14520/approximation_algor_14520_manuscript.md` | Related synthesis: submodular, approximation, algorithms | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Approximation Algorithms/approximation_algorithms_manuscript.md` | Related synthesis: approximation, algorithms | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Approximation algor 04699/approximation_algor_04699_manuscript.md` | Related synthesis: approximation, algorithms | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 41,472 of 75,964 units from 75,967 PDFs.
