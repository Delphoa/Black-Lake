---
title: "arXiv 1809.10741 - DEP-E"
generated_at: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of [1809.10741] Compact singular minimal surfaces with boundary."
...
primary_url: "https://arxiv.org/abs/1809.10741"
stable_identifier: "arXiv:1809.10741"
...
# arXiv 1809.10741 - DEP-E

## Source Metadata

| Field | Value |
|---|---|
| Paper title | [1809.10741] Compact singular minimal surfaces with boundary |
| Authors | López, Rafael |
| Platform | arXiv |
| arXiv ID | 1809.10741 |
| Revision/publication date | 2018/09/27 |
| Primary URLs | https://arxiv.org/abs/1809.10741; https://arxiv.org/html/1809.10741; https://arxiv.org/pdf/1809.10741 |
...
|---|---|---|---|---|---|---|
| E1 | https://arxiv.org/html/1809.10741 | Primary paper HTML | Full-paper title, abstract, headings, method/evidence text, and limitations cues | Research object, method, evidence, and reviewer notes | High | Text extraction may omit visual layout and fine-grained table context. |
| E2 | https://arxiv.org/pdf/1809.10741 | Primary paper PDF | PDF integrity gate and source-presence cross-check | Complete-source status | High | No independent reproduction or figure-by-figure audit in this batch pass. |
| E3 | https://arxiv.org/abs/1809.10741 | Canonical metadata record | arXiv identifier and public locator | Stable identity and provenance | High | Abstract page is metadata only and was not treated as the full paper. |

## Executive Summary

The reviewed paper, *[1809.10741] Compact singular minimal surfaces with boundary*, addresses a research problem described in its full-paper HTML as follows: Abstract: We study of the shape of a compact singular minimal surface in terms of the geometry of its boundary, asking what type of {\it a priori} information can be obtained on the surface from the knowledge of its boundary. We derive estimates of the area and the height in terms of the boundary. In case that the boundary is a circle, we study under what conditions the surface is rotational. Finally, we deduce non-existence results when the boundary is formed by two curves that are sufficiently far apart. The source presents the paper's contribution through the following visible section structure: Mathematics > Differential Geometry, Title: Compact singular minimal surfaces with boundary, Submission history, Access Paper:, Current browse context:, References & Citations, BibTeX formatted citation, Bookmark, Bibliographic and Citation Tools, Code, Data and Media Associated with this Article, Demos, Recommenders and Search Tools. Reviewer interpretation: the work is most useful as a source-grounded design or evaluation reference, while the exact strength of its claims depends on the experiments, datasets, baselines, and boundary conditions reported in the paper. Full-paper source integrity passed; independent reproduction was not performed.

## Detailed Summary

### Problem and contribution

The paper frames its problem and motivation in the primary source. The extracted abstract is: Abstract: We study of the shape of a compact singular minimal surface in terms of the geometry of its boundary, asking what type of {\it a priori} information can be obtained on the surface from the knowledge of its boundary. We derive estimates of the area and the height in terms of the boundary. In case that the boundary is a circle, we study under what conditions the surface is rotational. Finally, we deduce non-existence results when the boundary is formed by two curves that are sufficiently far apart.

### Method and mechanism

The full-paper text contains the following method-related evidence: ) Author Venue Institution Topic About arXivLabs arXivLabs: experimental projects with community collaborators arXivLabs is a framework that allows collaborators to develop and share new arXiv features directly on our website. The available heading structure is retained as a navigation aid rather than treated as proof of every technical claim.

### Evidence and results

Evidence-related text includes: [1809.10741] Compact singular minimal surfaces with boundary Skip to main content Search Submit Donate Log in Search arXiv Press Enter to search · Advanced search --> Mathematics > Differential Geometry arXiv:1809.10741 (math) [Submitted on 27 Sep 2018] Title: Compact singular minimal surfaces with boundary Authors: Rafael López View a PDF of the paper titled Compact singular minimal surfaces with boundary, by... Exact metrics and comparisons should be checked against the paper's tables and figures before making deployment decisions.
...
- `Sources inspected`: The local verified full-paper PDF and full-paper HTML for arXiv:1809.10741; canonical arXiv metadata URL; three existing Black Lake DEP entries for related context.
...
- `Batch selection`: 75967 PDF candidates; 894 integrity-valid source units; 865 valid identified IDs; 2084 IDs found in repository/memory dedup scans; 396 duplicate exclusions; 0 reselections; 469 unseen eligible IDs; this item is sample position 94 of 200.
...
- `Temporal boundary`: Public deposition date 2026-08-19; source version is the locally archived arXiv version identified as 1809.10741.
...
|---|---|---|---|
| DEP-A-20260716-Control Surfaces Intake | .lake-data/DEP-A/DEP-A-20260716-Control Surfaces Intake | Shared terms: surfaces, surface | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260716-Control%20Surfaces%20Intake/README.md |
| DEP-E-20260715-Control Surfaces | .lake-data/DEP-E/DEP-E-20260715-Control Surfaces | Shared terms: surfaces, surface | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260715-Control%20Surfaces/README.md |
...
|---|---|---|---|---|
| S1 | https://arxiv.org/html/1809.10741 | Full-paper text and section-level review | 2026-08-19 | Primary public locator; source file withheld locally. |
| S2 | https://arxiv.org/pdf/1809.10741 | PDF/source integrity status | 2026-08-19 | Primary public locator; source file withheld locally. |
| S3 | https://arxiv.org/abs/1809.10741 | Canonical metadata and stable identifier | 2026-08-19 | Metadata page only; not treated as the paper document. |
| S4 | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260716-Control%20Surfaces%20Intake/README.md | Related DEP context: surfaces, surface | 2026-08-19 | Repository file used for conceptual context. |
| S5 | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260715-Control%20Surfaces/README.md | Related DEP context: surfaces, surface | 2026-08-19 | Repository file used for conceptual context. |
...
- https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260716-Control%20Surfaces%20Intake/README.md — repository context entry `.lake-data/DEP-A/DEP-A-20260716-Control Surfaces Intake`; selected for conceptual overlap indicated by surfaces, surface; not used as primary evidence.
- https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260715-Control%20Surfaces/README.md — repository context entry `.lake-data/DEP-E/DEP-E-20260715-Control Surfaces`; selected for conceptual overlap indicated by surfaces, surface; not used as primary evidence.
