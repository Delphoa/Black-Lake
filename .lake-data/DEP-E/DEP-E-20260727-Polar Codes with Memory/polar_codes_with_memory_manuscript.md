---
title: "Polar Codes with Memory - DEP-E"
generated_at: "2026-07-27 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Polar Codes with Memory."
...
primary_url: "https://arxiv.org/abs/1907.00527"
stable_identifier: "arXiv:1907.00527; DOI:10.48550/arXiv.1907.00527"
deployment_job_id: "BLAD-2200-20260727-ADBD50D5"
deployment_item_id: "BLAD-2200-20260727-ADBD50D5-P02"
...
# Polar Codes with Memory - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1907.00527 | https://arxiv.org/abs/1907.00527 | Metadata only. | 2026-07-27 | Inspected |
| S2 | Full paper | Primary | HTML | 1907.00527 rendering | https://ar5iv.labs.arxiv.org/html/1907.00527 | Verified local copy withheld. | 2026-07-27 | Inspected in full |
| S3 | PDF | Primary | PDF | 1907.00527 | https://arxiv.org/pdf/1907.00527 | Verified local copy withheld. | 2026-07-27 | Integrity checked and sampled |
| S4 | 4 Adic Complexity Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-4 Adic Complexity/4_adic_complexity_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S5 | Irregular Clipped SR - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260711-Irregular Clipped SR/irregular_clipped_sr_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S6 | Device Tuning MTL - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-Device Tuning MTL/device_tuning_mtl_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260727-ADBD50D5-P02` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-27 | Verified |

Authors: Zhou, Wenyue; Liu, Qiang; Shen, Yifei; Zhou, Xiaofeng; Zhang, Chuan; Xu, Yaohua; Li, Liping. Submitted/source date: 2019/07/01. Job `BLAD-2200-20260727-ADBD50D5`; item `BLAD-2200-20260727-ADBD50D5-P02`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Polar codes invented by Arıkan [ 1 ] have been proven to be a coding scheme that can …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Polar codes with memory (PCM) are proposed in this paper: a pair of consecutive code blocks containing a …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: codes, complexity, decoder, interleaved, length | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies decoding, codes, polar. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around decoding, codes, polar. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Polar codes invented by Arıkan [ 1 ] have been proven to be a coding scheme that can …”. The full-paper rendering contains 50 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Polar codes with memory (PCM) are proposed in this paper: a pair of consecutive code blocks containing a …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In this section, a general encoding scheme of PCM is proposed. From the discussions in the previous section, …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving decoding, codes, polar. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 3,040 of 75,778 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how codes, complexity, decoder, interleaved, length connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: codes, complexity, decoder, interleaved, length.
...
|---|---|---|---|
| 4 Adic Complexity Review - DEP-E | Related DEP | Overlap: complexity, interleaved, length | `.lake-data/DEP-E/DEP-E-20260721-4 Adic Complexity/4_adic_complexity_manuscript.md` |
| Irregular Clipped SR - DEP-E | Related DEP | Overlap: codes | `.lake-data/DEP-E/DEP-E-20260711-Irregular Clipped SR/irregular_clipped_sr_manuscript.md` |
| Device Tuning MTL - DEP-E | Related DEP | Overlap: decoder | `.lake-data/DEP-E/DEP-E-20260719-Device Tuning MTL/device_tuning_mtl_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1907.00527 | Metadata and abstract | 2026-07-27 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/1907.00527 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-27 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1907.00527 | Primary paper integrity | 2026-07-27 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260721-4 Adic Complexity/4_adic_complexity_manuscript.md` | Related synthesis: complexity, interleaved, length | 2026-07-27 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260711-Irregular Clipped SR/irregular_clipped_sr_manuscript.md` | Related synthesis: codes | 2026-07-27 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260719-Device Tuning MTL/device_tuning_mtl_manuscript.md` | Related synthesis: decoder | 2026-07-27 | Repository-relative |

## Appendix

- Uniform selected index: 3,040 of 75,778 units from 75,781 PDFs.
