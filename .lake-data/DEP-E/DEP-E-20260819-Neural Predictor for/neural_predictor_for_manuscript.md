---
title: "Neural Predictor for - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Neural Predictor for Neural Architecture Search."
...
primary_url: "https://arxiv.org/abs/1912.00848"
stable_identifier: "arXiv:1912.00848; DOI:10.48550/arXiv.1912.00848"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P126"
...
# Neural Predictor for - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1912.00848 | https://arxiv.org/abs/1912.00848 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1912.00848 rendering | https://arxiv.org/html/1912.00848 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1912.00848 | https://arxiv.org/pdf/1912.00848 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P126` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wen, Wei; Liu, Hanxiao; Li, Hai; Chen, Yiran; Bender, Gabriel; Kindermans, Pieter-Jan. Submitted/source date: 2019/12/02. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P126`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Neural Architecture Search methods are effective but often use complex algorithms to come up with the best architecture. …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Neural Architecture Search methods are effective but often use complex algorithms to come up with the best architecture. …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: architecture, neural, search | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies neural, architecture, predictor. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around neural, architecture, predictor. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Neural Architecture Search methods are effective but often use complex algorithms to come up with the best architecture. …”. The full-paper rendering contains 68 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Neural Architecture Search methods are effective but often use complex algorithms to come up with the best architecture. …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “With an infinite compute budget, a naïve approach to architecture search would be to sample tens or hundreds …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving neural, architecture, predictor. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 17,242 of 75,964 units; duplicate exclusions 2; focus exclusions 38; source-gate exclusions 0; reselections 40.
...
- The related DEPs show how architecture, neural, search connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: architecture, neural, search.
...
| A Novel Training Protocol - DEP-E | Related DEP | Overlap: neural, search, architecture | `.lake-data/DEP-E/DEP-E-20260819-A Novel Training Protocol/a_novel_training_protocol_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1912.00848 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1912.00848 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1912.00848 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Neural Architecture/neural_architecture_manuscript.md` | Related synthesis: neural, search, architecture | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Stacked BNAS Rethinking/stacked_bnas_rethinking_manuscript.md` | Related synthesis: neural, search, architecture | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-A Novel Training Protocol/a_novel_training_protocol_manuscript.md` | Related synthesis: neural, search, architecture | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 17,242 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 2; focus exclusions: 38; source-gate exclusions: 0; reselections: 40; 24-hour cutoff: 2026-08-18.
