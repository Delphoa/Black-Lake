---
title: "Aligned but Fragile - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Aligned but Fragile: Enhancing LLM Safety Robustness via Zeroth-Order Optimization."
...
primary_url: "https://arxiv.org/abs/2605.29396"
stable_identifier: "arXiv:2605.29396; DOI:10.48550/arXiv.2605.29396"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P253"
...
# Aligned but Fragile - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2605.29396 | https://arxiv.org/abs/2605.29396 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2605.29396 rendering | https://arxiv.org/html/2605.29396 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2605.29396 | https://arxiv.org/pdf/2605.29396 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Model Evolution Under - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Model Evolution Under/model_evolution_under_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | CoLVR Enhancing - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-CoLVR Enhancing/colvr_enhancing_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | From Answer to Think - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-From Answer to Think/from_answer_to_think_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P253` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Zhihao; Wu, Yifan; Lou, Jian; Wang, Di; Zhou, Yuxi; Hu, Yuke. Submitted/source date: 2026/05/28. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P253`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In this paper, we are the first to study the robustness of safety alignment from the perspective of …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Safety alignment for large language models (LLMs) aims to reduce harmful or unsafe behavior while preserving general utility. …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: but, enhancing, llm, optimization, robustness | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies aligned, but, enhancing. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around aligned, but, enhancing. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In this paper, we are the first to study the robustness of safety alignment from the perspective of …”. The full-paper rendering contains 73 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Safety alignment for large language models (LLMs) aims to reduce harmful or unsafe behavior while preserving general utility. …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Safety alignment for large language models (LLMs) aims to reduce harmful or unsafe behavior while preserving general utility. …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving aligned, but, enhancing. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 29,950 of 75,964 units; duplicate exclusions 2; focus exclusions 14; source-gate exclusions 0; reselections 16.
...
- The related DEPs show how but, enhancing, llm, optimization, robustness connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: but, enhancing, llm, optimization, robustness.
...
|---|---|---|---|
| Model Evolution Under - DEP-E | Related DEP | Overlap: zeroth-order, optimization, robustness, safety, but | `.lake-data/DEP-E/DEP-E-20260819-Model Evolution Under/model_evolution_under_manuscript.md` |
| CoLVR Enhancing - DEP-E | Related DEP | Overlap: enhancing, optimization, robustness, safety, but | `.lake-data/DEP-E/DEP-E-20260818-CoLVR Enhancing/colvr_enhancing_manuscript.md` |
| From Answer to Think - DEP-E | Related DEP | Overlap: llm, optimization, enhancing, robustness, safety | `.lake-data/DEP-E/DEP-E-20260819-From Answer to Think/from_answer_to_think_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2605.29396 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2605.29396 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2605.29396 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Model Evolution Under/model_evolution_under_manuscript.md` | Related synthesis: zeroth-order, optimization, robustness, safety, but | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-CoLVR Enhancing/colvr_enhancing_manuscript.md` | Related synthesis: enhancing, optimization, robustness, safety, but | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-From Answer to Think/from_answer_to_think_manuscript.md` | Related synthesis: llm, optimization, enhancing, robustness, safety | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 29,950 of 75,964 units from 75,967 PDFs.
