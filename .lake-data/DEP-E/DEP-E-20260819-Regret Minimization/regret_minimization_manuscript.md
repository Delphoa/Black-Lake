---
title: "Regret Minimization - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Regret Minimization Experience Replay in Off-Policy Reinforcement Learning."
...
primary_url: "https://arxiv.org/abs/2105.07253"
stable_identifier: "arXiv:2105.07253; DOI:10.48550/arXiv.2105.07253"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P130"
...
# Regret Minimization - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2105.07253 | https://arxiv.org/abs/2105.07253 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2105.07253 rendering | https://arxiv.org/html/2105.07253 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2105.07253 | https://arxiv.org/pdf/2105.07253 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | CT-UCBVI Regret - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260731-CT-UCBVI Regret/ct_ucbvi_regret_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P130` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Xu-Hui; Xue, Zhenghai; Pang, Jing-Cheng; Jiang, Shengyi; Xu, Feng; Yu, Yang. Submitted/source date: 2021/05/15. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P130`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We then provide tractable approximations to the theoretical results. The on-policiness can be estimated by training a classifier …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In reinforcement learning, experience replay stores past samples for further reuse. Prioritized sampling is a promising technique to …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: experience, minimization, regret, reinforcement, replay | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies experience, minimization, off-policy. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around experience, minimization, off-policy. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We then provide tractable approximations to the theoretical results. The on-policiness can be estimated by training a classifier …”. The full-paper rendering contains 115 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In reinforcement learning, experience replay stores past samples for further reuse. Prioritized sampling is a promising technique to …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Reinforcement learning (RL) [ 1 ] has achieved great success in sequential decision making problems. Off-policy RL algorithms …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving experience, minimization, off-policy. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 49,139 of 75,964 units; duplicate exclusions 0; focus exclusions 13; source-gate exclusions 0; reselections 13.
...
- The related DEPs show how experience, minimization, regret, reinforcement, replay connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: experience, minimization, regret, reinforcement, replay.
...
|---|---|---|---|
| ARPO End-to-End Policy - DEP-E | Related DEP | Overlap: experience, replay, minimization | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` |
| ONER Online Experience - DEP-E | Related DEP | Overlap: experience, replay, minimization | `.lake-data/DEP-E/DEP-E-20260819-ONER Online Experience/oner_online_experience_manuscript.md` |
| CT-UCBVI Regret - DEP-E | Related DEP | Overlap: regret, reinforcement | `.lake-data/DEP-E/DEP-E-20260731-CT-UCBVI Regret/ct_ucbvi_regret_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2105.07253 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2105.07253 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2105.07253 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` | Related synthesis: experience, replay, minimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-ONER Online Experience/oner_online_experience_manuscript.md` | Related synthesis: experience, replay, minimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260731-CT-UCBVI Regret/ct_ucbvi_regret_manuscript.md` | Related synthesis: regret, reinforcement | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 49,139 of 75,964 units from 75,967 PDFs.
