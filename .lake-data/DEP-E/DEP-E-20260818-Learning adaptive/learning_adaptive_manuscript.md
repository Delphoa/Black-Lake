---
title: "Learning adaptive - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Learning adaptive differential evolution algorithm from optimization experiences by policy gradient."
...
primary_url: "https://arxiv.org/abs/2102.03572"
stable_identifier: "arXiv:2102.03572; DOI:10.48550/arXiv.2102.03572"
deployment_job_id: "BLAD-2200-20260818-BBEE0F31"
deployment_item_id: "BLAD-2200-20260818-BBEE0F31-P19"
...
# Learning adaptive - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2102.03572 | https://arxiv.org/abs/2102.03572 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2102.03572 rendering | https://arxiv.org/html/2102.03572 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2102.03572 | https://arxiv.org/pdf/2102.03572 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | Last-Iterate Convergence - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Last-Iterate Convergence/last_iterate_convergence_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | RPDG Incremental Gradient - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260804-RPDG Incremental Grad/rpdg_incremental_gradient_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | Constrained Bayesian - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260728-Constrained Bayesian/constrained_bayesian_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-BBEE0F31-P19` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Sun, Jianyong; Liu, Xin; Bäck, Thomas; Xu, Zongben. Submitted/source date: 2021/02/06. Job `BLAD-2200-20260818-BBEE0F31`; item `BLAD-2200-20260818-BBEE0F31-P19`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Differential evolution is one of the most prestigious population-based stochastic optimization algorithm for black-box problems. The performance of …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Differential evolution is one of the most prestigious population-based stochastic optimization algorithm for black-box problems. The performance of …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: adaptive, algorithm, gradient, optimization, policy | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies adaptive, algorithm, differential. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around adaptive, algorithm, differential. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Differential evolution is one of the most prestigious population-based stochastic optimization algorithm for black-box problems. The performance of …”. The full-paper rendering contains 60 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Differential evolution is one of the most prestigious population-based stochastic optimization algorithm for black-box problems. The performance of …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Differential evolution is one of the most prestigious population-based stochastic optimization algorithm for black-box problems. The performance of …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving adaptive, algorithm, differential. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 61,143 of 75,964 units; duplicate exclusions 0; focus exclusions 1; source-gate exclusions 0; reselections 1.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; title/abstract evidence terms algorithm, optimization.
...
- The related DEPs show how adaptive, algorithm, gradient, optimization, policy connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: adaptive, algorithm, gradient, optimization, policy.
...
|---|---|---|---|
| Last-Iterate Convergence - DEP-E | Related DEP | Overlap: gradient, adaptive | `.lake-data/DEP-E/DEP-E-20260818-Last-Iterate Convergence/last_iterate_convergence_manuscript.md` |
| RPDG Incremental Gradient - DEP-E | Related DEP | Overlap: gradient, optimization, adaptive, algorithm, policy | `.lake-data/DEP-E/DEP-E-20260804-RPDG Incremental Grad/rpdg_incremental_gradient_manuscript.md` |
| Constrained Bayesian - DEP-E | Related DEP | Overlap: adaptive, optimization, algorithm | `.lake-data/DEP-E/DEP-E-20260728-Constrained Bayesian/constrained_bayesian_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2102.03572 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2102.03572 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2102.03572 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Last-Iterate Convergence/last_iterate_convergence_manuscript.md` | Related synthesis: gradient, adaptive | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260804-RPDG Incremental Grad/rpdg_incremental_gradient_manuscript.md` | Related synthesis: gradient, optimization, adaptive, algorithm, policy | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260728-Constrained Bayesian/constrained_bayesian_manuscript.md` | Related synthesis: adaptive, optimization, algorithm | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 61,143 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 0; focus exclusions: 1; source-gate exclusions: 0; reselections: 1; 24-hour cutoff: 2026-08-17.
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; terms algorithm, optimization.
