---
title: "arXiv 1804.05685 - DEP-E"
generated_at: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of [1804.05685] A Discourse-Aware Attention Model for Abstractive Summarization of Long Documents."
...
primary_url: "https://arxiv.org/abs/1804.05685"
stable_identifier: "arXiv:1804.05685"
...
# arXiv 1804.05685 - DEP-E

## Source Metadata

| Field | Value |
|---|---|
| Paper title | [1804.05685] A Discourse-Aware Attention Model for Abstractive Summarization of Long Documents |
| Authors | Not available from inspected sources |
| Platform | arXiv |
| arXiv ID | 1804.05685 |
| Revision/publication date | Not available from inspected sources |
| Primary URLs | https://arxiv.org/abs/1804.05685; https://arxiv.org/html/1804.05685; https://arxiv.org/pdf/1804.05685 |
...
|---|---|---|---|---|---|---|
| E1 | https://arxiv.org/html/1804.05685 | Primary paper HTML | Full-paper title, abstract, headings, method/evidence text, and limitations cues | Research object, method, evidence, and reviewer notes | High | Text extraction may omit visual layout and fine-grained table context. |
| E2 | https://arxiv.org/pdf/1804.05685 | Primary paper PDF | PDF integrity gate and source-presence cross-check | Complete-source status | High | No independent reproduction or figure-by-figure audit in this batch pass. |
| E3 | https://arxiv.org/abs/1804.05685 | Canonical metadata record | arXiv identifier and public locator | Stable identity and provenance | High | Abstract page is metadata only and was not treated as the full paper. |

## Executive Summary

The reviewed paper, *[1804.05685] A Discourse-Aware Attention Model for Abstractive Summarization of Long Documents*, addresses a research problem described in its full-paper HTML as follows: Abstract Neural abstractive summarization models have led to promising results in summarizing relatively short documents. We propose the first model for abstractive summarization of single, longer-form documents (e.g., research papers). Our approach consists of a new hierarchical encoder that models the discourse structure of a document, and an attentive discourse-aware decoder to generate the summary. Empirical results on two large-scale datasets of scientific papers show that our model significantly outperforms state-of-the-art models. The source presents the paper's contribution through the following visible section structure: A Discourse-Aware Attention Model for Abstractive Summarization of Long Documents, Abstract, 1 Introduction, 2 Background, Attentive decoding, 3 Model, Encoder, Discourse-aware decoder, Copying from source, Decoder coverage, 4 Related work, 5 Data. Reviewer interpretation: the work is most useful as a source-grounded design or evaluation reference, while the exact strength of its claims depends on the experiments, datasets, baselines, and boundary conditions reported in the paper. Full-paper source integrity passed; independent reproduction was not performed.

## Detailed Summary

### Problem and contribution

The paper frames its problem and motivation in the primary source. The extracted abstract is: Abstract Neural abstractive summarization models have led to promising results in summarizing relatively short documents. We propose the first model for abstractive summarization of single, longer-form documents (e.g., research papers). Our approach consists of a new hierarchical encoder that models the discourse structure of a document, and an attentive discourse-aware decoder to generate the summary. Empirical results on two large-scale datasets of scientific papers show that our model significantly outperforms state-of-the-art models.

### Method and mechanism

The full-paper text contains the following method-related evidence: They also follow a standard discourse structure describing the problem, methodology, experiments/results, and finally conclusions Suppe ( 1998 ) . Examples of prominent approaches include frequency-based methods Vanderwende et al. The available heading structure is retained as a navigation aid rather than treated as proof of every technical claim.

### Evidence and results

Evidence-related text includes: [1804.05685] A Discourse-Aware Attention Model for Abstractive Summarization of Long Documents A Discourse-Aware Attention Model for Abstractive Summarization of Long Documents Arman Cohan † Franck Dernoncourt ⋆ Doo Soon Kim ⋆ Trung Bui ⋆ Seokhwan Kim ⋆ Walter Chang ⋆ Nazli Goharian † † IRLab, Georgetown University, Washington, DC {arman,nazli}@ir.cs.georgetown.edu ⋆ Adobe Research, San Jose, CA... Exact metrics and comparisons should be checked against the paper's tables and figures before making deployment decisions.

### Limitations and conclusion

Limitation-related text includes: Figure 2: Example of a generated summary 7 Conclusions and future work This work was the first attempt at addressing neural abstractive summarization of single, long documents. It is non-trivial to evaluate such qualities especially for long document summarization; future work can design expert human evaluations to explore these nuances. Where the source did not expose a clear limitation in the extracted text, this review records the gap rather than inferring that no limitation exists.
...
- `Sources inspected`: The local verified full-paper PDF and full-paper HTML for arXiv:1804.05685; canonical arXiv metadata URL; three existing Black Lake DEP entries for related context.
...
- `Batch selection`: 75967 PDF candidates; 894 integrity-valid source units; 865 valid identified IDs; 2084 IDs found in repository/memory dedup scans; 396 duplicate exclusions; 0 reselections; 469 unseen eligible IDs; this item is sample position 126 of 200.
...
- `Temporal boundary`: Public deposition date 2026-08-19; source version is the locally archived arXiv version identified as 1804.05685.
...
|---|---|---|---|
| DEP-A-20260718-Lifelong Attention | .lake-data/DEP-A/DEP-A-20260718-Lifelong Attention | Shared terms: attention, long | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260718-Lifelong%20Attention/README.md |
...
|---|---|---|---|---|
| S1 | https://arxiv.org/html/1804.05685 | Full-paper text and section-level review | 2026-08-19 | Primary public locator; source file withheld locally. |
| S2 | https://arxiv.org/pdf/1804.05685 | PDF/source integrity status | 2026-08-19 | Primary public locator; source file withheld locally. |
| S3 | https://arxiv.org/abs/1804.05685 | Canonical metadata and stable identifier | 2026-08-19 | Metadata page only; not treated as the paper document. |
| S4 | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260718-Lifelong%20Attention/README.md | Related DEP context: attention, long | 2026-08-19 | Repository file used for conceptual context. |
...
- https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260718-Lifelong%20Attention/README.md — repository context entry `.lake-data/DEP-A/DEP-A-20260718-Lifelong Attention`; selected for conceptual overlap indicated by attention, long; not used as primary evidence.
