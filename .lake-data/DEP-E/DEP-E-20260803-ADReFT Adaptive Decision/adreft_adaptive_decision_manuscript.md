---
title: "ADReFT Adaptive Decision - DEP-E"
generated_at: "2026-08-03 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of ADReFT: Adaptive Decision Repair for Safe Autonomous Driving via Reinforcement Fine-Tuning."
...
primary_url: "https://arxiv.org/abs/2506.23960"
stable_identifier: "arXiv:2506.23960; DOI:10.48550/arXiv.2506.23960"
deployment_job_id: "BLAD-2200-20260803-11C1283E"
deployment_item_id: "BLAD-2200-20260803-11C1283E-P10"
...
# ADReFT Adaptive Decision - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2506.23960 | https://arxiv.org/abs/2506.23960 | Metadata only. | 2026-08-03 | Inspected |
| S2 | Full paper | Primary | HTML | 2506.23960 rendering | https://arxiv.org/html/2506.23960 | Verified local copy withheld. | 2026-08-03 | Inspected in full |
| S3 | PDF | Primary | PDF | 2506.23960 | https://arxiv.org/pdf/2506.23960 | Verified local copy withheld. | 2026-08-03 | Integrity checked and sampled |
...
| S5 | Decoupled Training with - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260729-Decoupled Training with/decoupled_training_with_manuscript.md` | Synthesis only. | 2026-08-03 | Inspected |
| S6 | LA-Pose Latent Action - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260713-LA-Pose Latent Action/la_pose_latent_action_manuscript.md` | Synthesis only. | 2026-08-03 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260803-11C1283E-P10` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-03 | Verified |

Authors: Cheng, Mingfei; Xie, Xiaofei; Wang, Renzhi; Zhou, Yuan; Hu, Ming. Submitted/source date: 2025/06/30. Job `BLAD-2200-20260803-11C1283E`; item `BLAD-2200-20260803-11C1283E-P10`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “To address this issue, we propose Adaptive Decision Repair ( ADReFT ), a novel and effective repair method …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Autonomous Driving Systems (ADSs) continue to face safety-critical risks due to the inherent limitations in their design and …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: adaptive, autonomous, decision, driving, fine-tuning | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies adaptive, adreft, autonomous. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around adaptive, adreft, autonomous. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “To address this issue, we propose Adaptive Decision Repair ( ADReFT ), a novel and effective repair method …”. The full-paper rendering contains 62 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Autonomous Driving Systems (ADSs) continue to face safety-critical risks due to the inherent limitations in their design and …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Autonomous Driving Systems (ADSs) continue to face safety-critical risks due to the inherent limitations in their design and …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving adaptive, adreft, autonomous. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 40,072 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how adaptive, autonomous, decision, driving, fine-tuning connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: adaptive, autonomous, decision, driving, fine-tuning.
...
|---|---|---|---|
| Stealth Memory Trust - DEP-E | Related DEP | Overlap: reinforcement, fine-tuning, adaptive, decision | `.lake-data/DEP-E/DEP-E-20260721-Stealth Memory Injection/stealth_memory_trust_manuscript.md` |
| Decoupled Training with - DEP-E | Related DEP | Overlap: reinforcement, fine-tuning, autonomous, decision, safe | `.lake-data/DEP-E/DEP-E-20260729-Decoupled Training with/decoupled_training_with_manuscript.md` |
| LA-Pose Latent Action - DEP-E | Related DEP | Overlap: driving, fine-tuning, decision, safe | `.lake-data/DEP-E/DEP-E-20260713-LA-Pose Latent Action/la_pose_latent_action_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2506.23960 | Metadata and abstract | 2026-08-03 | Metadata only |
| R2 | https://arxiv.org/html/2506.23960 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-03 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2506.23960 | Primary paper integrity | 2026-08-03 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260721-Stealth Memory Injection/stealth_memory_trust_manuscript.md` | Related synthesis: reinforcement, fine-tuning, adaptive, decision | 2026-08-03 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260729-Decoupled Training with/decoupled_training_with_manuscript.md` | Related synthesis: reinforcement, fine-tuning, autonomous, decision, safe | 2026-08-03 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260713-LA-Pose Latent Action/la_pose_latent_action_manuscript.md` | Related synthesis: driving, fine-tuning, decision, safe | 2026-08-03 | Repository-relative |

## Appendix

- Uniform selected index: 40,072 of 75,957 units from 75,960 PDFs.
