---
title: "The Case of FBA as a DEX - DEP-E"
generated_at: "2026-07-27 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of The Case of FBA as a DEX Processing Model."
...
primary_url: "https://arxiv.org/abs/2302.01177"
stable_identifier: "arXiv:2302.01177; DOI:10.48550/arXiv.2302.01177"
deployment_job_id: "BLAD-2200-20260727-ADBD50D5"
deployment_item_id: "BLAD-2200-20260727-ADBD50D5-P07"
...
# The Case of FBA as a DEX - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2302.01177 | https://arxiv.org/abs/2302.01177 | Metadata only. | 2026-07-27 | Inspected |
| S2 | Full paper | Primary | HTML | 2302.01177 rendering | https://arxiv.org/html/2302.01177 | Verified local copy withheld. | 2026-07-27 | Inspected in full |
| S3 | PDF | Primary | PDF | 2302.01177 | https://arxiv.org/pdf/2302.01177 | Verified local copy withheld. | 2026-07-27 | Integrity checked and sampled |
| S4 | MA-VLM Moderation - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-MA-VLM PNU Moderation/ma_vlm_pnu_moderation_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S5 | Weak Diffusion Priors - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260722-Weak Diffusion Priors/weak_diffusion_priors_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S6 | Decentralized SSL Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-Decentralized SSL/decentralized_ssl_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260727-ADBD50D5-P07` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-27 | Verified |

Authors: Gong, Tiantian; Liu, Zeyu; Kate, Aniket. Submitted/source date: 2023/02/02. Job `BLAD-2200-20260727-ADBD50D5`; item `BLAD-2200-20260727-ADBD50D5-P07`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “( λ p ⁢ b = 0 subscript 𝜆 𝑝 𝑏 0 {\color[rgb]{0,0,1}\definecolor[named]{pgfstrokecolor}{rgb}{0,0,1}\lambda_{pb}% }=0 italic_λ start_POSTSUBSCRIPT italic_p italic_b …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Putting ourselves in LPs’ shoes, common investors are price takers and thus the source of profits . Informed …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: decentralized, loss, when | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies fba, processing, dex. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around fba, processing, dex. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “( λ p ⁢ b = 0 subscript 𝜆 𝑝 𝑏 0 {\color[rgb]{0,0,1}\definecolor[named]{pgfstrokecolor}{rgb}{0,0,1}\lambda_{pb}% }=0 italic_λ start_POSTSUBSCRIPT italic_p italic_b …”. The full-paper rendering contains 97 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Putting ourselves in LPs’ shoes, common investors are price takers and thus the source of profits . Informed …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Blockchain-based decentralized exchanges (DEX) enable users to trade assets without relying on intermediary authorities through blockchain transactions. They …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving fba, processing, dex. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 59,181 of 75,778 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how decentralized, loss, when connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: decentralized, loss, when.
...
|---|---|---|---|
| MA-VLM Moderation - DEP-E | Related DEP | Overlap: loss | `.lake-data/DEP-E/DEP-E-20260719-MA-VLM PNU Moderation/ma_vlm_pnu_moderation_manuscript.md` |
| Weak Diffusion Priors - DEP-E | Related DEP | Overlap: when | `.lake-data/DEP-E/DEP-E-20260722-Weak Diffusion Priors/weak_diffusion_priors_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2302.01177 | Metadata and abstract | 2026-07-27 | Metadata only |
| R2 | https://arxiv.org/html/2302.01177 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-27 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2302.01177 | Primary paper integrity | 2026-07-27 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260719-MA-VLM PNU Moderation/ma_vlm_pnu_moderation_manuscript.md` | Related synthesis: loss | 2026-07-27 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260722-Weak Diffusion Priors/weak_diffusion_priors_manuscript.md` | Related synthesis: when | 2026-07-27 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260720-Decentralized SSL/decentralized_ssl_manuscript.md` | Related synthesis: decentralized | 2026-07-27 | Repository-relative |

## Appendix

- Uniform selected index: 59,181 of 75,778 units from 75,781 PDFs.
