---
title: "ManipulationNet An - DEP-E"
generated_at: "2026-07-26 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of ManipulationNet: An Infrastructure for Benchmarking Real-World Robot Manipulation with Physical Skill Challenges and Embodied Multimodal Reasoning."
...
primary_url: "https://arxiv.org/abs/2603.04363"
stable_identifier: "arXiv:2603.04363; DOI:10.48550/arXiv.2603.04363"
deployment_job_id: "BLAD-2200-20260726-1DBD5211"
deployment_item_id: "BLAD-2200-20260726-1DBD5211-P09"
...
# ManipulationNet An - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2603.04363 | https://arxiv.org/abs/2603.04363 | Metadata only. | 2026-07-26 | Inspected |
| S2 | Full paper | Primary | HTML | 2603.04363 rendering | https://arxiv.org/html/2603.04363 | Verified local copy withheld. | 2026-07-26 | Inspected in full |
| S3 | PDF | Primary | PDF | 2603.04363 | https://arxiv.org/pdf/2603.04363 | Verified local copy withheld. | 2026-07-26 | Integrity checked and sampled |
| S4 | Semantic Skill MoE Policies | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-Semantic Skill MoE/semantic_skill_moe_manuscript.md` | Synthesis only. | 2026-07-26 | Inspected |
| S5 | Document Fraud LLM - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM/document_fraud_llm_manuscript.md` | Synthesis only. | 2026-07-26 | Inspected |
| S6 | HERMES World Model - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260712-HERMES World Model/hermes_world_model_manuscript.md` | Synthesis only. | 2026-07-26 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260726-1DBD5211-P09` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-26 | Verified |

Authors: Chen, Yiting; Kimble, Kenneth; Adelson, Edward H.; Asfour, Tamim; Chanrungmaneekul, Podshara; Chitta, Sachin; Chitambar, Yash; Chen, Ziyang; Goldberg, Ken; Kragic, Danica; Li, Hui; Li, Xiang; Li, Yunzhu; Prather, Aaron; Pollard, Nancy; Roa-Garzon, Maximo A.; Seney, Robert; Sha, Shuo; Wang, Shihefeng; Xiang, Yu; Zhang, Kaifeng; Zhu, Yuke; Hang, Kaiyu. Submitted/source date: 2026/03/04. Job `BLAD-2200-20260726-1DBD5211`; item `BLAD-2200-20260726-1DBD5211-P09`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: manipulation, multimodal, reasoning, robotic, scene | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies manipulation, physical, infrastructure. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around manipulation, physical, infrastructure. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving manipulation, physical, infrastructure. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 51,716 of 75,778 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how manipulation, multimodal, reasoning, robotic, scene connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: manipulation, multimodal, reasoning, robotic, scene.
...
|---|---|---|---|
| Semantic Skill MoE Policies | Related DEP | Overlap: skill, robotic, manipulation | `.lake-data/DEP-E/DEP-E-20260719-Semantic Skill MoE/semantic_skill_moe_manuscript.md` |
| Document Fraud LLM - DEP-E | Related DEP | Overlap: manipulation, reasoning, multimodal | `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM/document_fraud_llm_manuscript.md` |
| HERMES World Model - DEP-E | Related DEP | Overlap: world, unified, scene | `.lake-data/DEP-E/DEP-E-20260712-HERMES World Model/hermes_world_model_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2603.04363 | Metadata and abstract | 2026-07-26 | Metadata only |
| R2 | https://arxiv.org/html/2603.04363 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-26 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2603.04363 | Primary paper integrity | 2026-07-26 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260719-Semantic Skill MoE/semantic_skill_moe_manuscript.md` | Related synthesis: skill, robotic, manipulation | 2026-07-26 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM/document_fraud_llm_manuscript.md` | Related synthesis: manipulation, reasoning, multimodal | 2026-07-26 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260712-HERMES World Model/hermes_world_model_manuscript.md` | Related synthesis: world, unified, scene | 2026-07-26 | Repository-relative |

## Appendix

- Uniform selected index: 51,716 of 75,778 units from 75,781 PDFs.
