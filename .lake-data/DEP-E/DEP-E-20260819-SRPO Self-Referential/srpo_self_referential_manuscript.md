---
title: "SRPO Self-Referential - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of SRPO: Self-Referential Policy Optimization for Vision-Language-Action Models."
...
primary_url: "https://arxiv.org/abs/2511.15605"
stable_identifier: "arXiv:2511.15605; DOI:10.48550/arXiv.2511.15605"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P173"
...
# SRPO Self-Referential - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2511.15605 | https://arxiv.org/abs/2511.15605 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2511.15605 rendering | https://arxiv.org/html/2511.15605 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2511.15605 | https://arxiv.org/pdf/2511.15605 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Escher-Loop Mutual - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Escher-Loop Mutual/escher_loop_mutual_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | FAVLA Fast-Slow - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260722-FAVLA Fast-Slow/favla_fast_slow_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | See Plan Rewind - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260726-See Plan Rewind/see_plan_rewind_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P173` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Fei, Senyu; Wang, Siyin; Ji, Li; Li, Ao; Zhang, Shiduo; Liu, Liming; Hou, Jinlong; Gong, Jingjing; Zhao, Xianzhong; Qiu, Xipeng. Submitted/source date: 2025/11/19. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P173`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Vision-Language-Action (VLA) models excel in robotic manipulation but are constrained by their heavy reliance on expert demonstrations, leading …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Vision-Language-Action (VLA) models excel in robotic manipulation but are constrained by their heavy reliance on expert demonstrations, leading …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: optimization, policy, self-referential, vision-language-action | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies optimization, policy, self-referential. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around optimization, policy, self-referential. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Vision-Language-Action (VLA) models excel in robotic manipulation but are constrained by their heavy reliance on expert demonstrations, leading …”. The full-paper rendering contains 82 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Vision-Language-Action (VLA) models excel in robotic manipulation but are constrained by their heavy reliance on expert demonstrations, leading …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving optimization, policy, self-referential. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 8,446 of 75,964 units; duplicate exclusions 1; focus exclusions 16; source-gate exclusions 0; reselections 17.
...
- The related DEPs show how optimization, policy, self-referential, vision-language-action connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: optimization, policy, self-referential, vision-language-action.
...
|---|---|---|---|
| Escher-Loop Mutual - DEP-E | Related DEP | Overlap: self-referential, optimization | `.lake-data/DEP-E/DEP-E-20260819-Escher-Loop Mutual/escher_loop_mutual_manuscript.md` |
| FAVLA Fast-Slow - DEP-E | Related DEP | Overlap: vision-language-action, policy | `.lake-data/DEP-E/DEP-E-20260722-FAVLA Fast-Slow/favla_fast_slow_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2511.15605 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2511.15605 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2511.15605 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Escher-Loop Mutual/escher_loop_mutual_manuscript.md` | Related synthesis: self-referential, optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260722-FAVLA Fast-Slow/favla_fast_slow_manuscript.md` | Related synthesis: vision-language-action, policy | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260726-See Plan Rewind/see_plan_rewind_manuscript.md` | Related synthesis: vision-language-action | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 8,446 of 75,964 units from 75,967 PDFs.
