---
title: "Decoupled Temporal - DEP-E"
generated_at: "2026-08-19T22:59:33Z"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Decoupled Temporal Encoding for Generative Recommendation"
...
primary_url: "https://arxiv.org/abs/2608.16274"
stable_identifier: "arXiv:2608.16274"
...
# Decoupled Temporal - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Repository-relative path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Decoupled Temporal Encoding for Generative Recommendation | Primary research artifact | arXiv HTML and Atom metadata | arXiv:2608.16274 | https://arxiv.org/abs/2608.16274; https://arxiv.org/html/2608.16274 | Public research source; no source file redistributed | 2026-08-20 | Metadata inspected; full HTML inaccessible |
| S2 | Selected source DEP | Provenance and deposited finding | Markdown | DEP-20260819-Research Data 2234 D0837 | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/DEP-20260819-Research%20Data%202234%20D0837 | Repository evidence; no source file copied | 2026-08-20 | Inspected |
...
This DEP-E artifact reviews *Decoupled Temporal Encoding for Generative Recommendation*, attributed to Pengfei Jia; Jingjian Wang; Jingmao Li; Ge Zhang; Feng Shi. The selected source DEP characterizes the work as a current research claim and summarizes it as follows: The paper studies “Decoupled Temporal Encoding for Generative Recommendation”. Its abstract foregrounds Positional encoding is a fundamental component of Transformer-based generative recommendation models, where user histories are modeled as autoregressive… This deposition preserves that statement only as an author-reported preprint claim. [E1, E3]. Official arXiv metadata and the source DEP were inspected; full HTML was inaccessible, while no source file, dataset, code repository, model, or execution trace was collected.
...
The primary source addresses the research object identified by its canonical title, *Decoupled Temporal Encoding for Generative Recommendation*. The source DEP preserves the following concise account: The paper studies “Decoupled Temporal Encoding for Generative Recommendation”. Its abstract foregrounds Positional encoding is a fundamental component of Transformer-based generative recommendation models, where user histories are modeled as autoregressive… This deposition preserves that statement only as an author-reported preprint claim. [E1, E3]. This artifact treats that account as a source-reported claim rather than an independently established fact.
...
- Sources inspected: Every Markdown file in `Black-Lake-Data/.lake-data/DEP-20260819-Research Data 2234 D0837`, the canonical primary record, official metadata, and full HTML when accessible; the latest Report-Mark was also inspected for iterative passes.
...
|---|---|---|---|
| Decoupled Temporal Encoding for Generative Recommendation | Primary research thread | Primary work selected from the source DEP and inspected in this pass. | https://arxiv.org/abs/2608.16274 |
| Official full-text representation | Primary source format | Full HTML used to locate abstract, methodology, evaluation, limitations, and conclusion evidence where available. | https://arxiv.org/html/2608.16274 |
| Selected source DEP | Provenance record | Preserves the deposited finding, source inventory, and explicit non-reproduction boundary. | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/DEP-20260819-Research%20Data%202234%20D0837 |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2608.16274 | Canonical title, authors, abstract, identifier, and source status | 2026-08-20 | Canonical locator preserved; official metadata inspected through the arXiv API |
| R2 | https://arxiv.org/html/2608.16274 | Full-text section structure, method/evaluation trace, limitations, and conclusion | 2026-08-20 | Full HTML inaccessible |
| R3 | https://export.arxiv.org/api/query?id_list=2608.16274 | Canonical Atom metadata and abstract | 2026-08-20 | Official arXiv API inspected |
| R4 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260819-Research%20Data%202234%20D0837/dep0837_research_findings_2026-08-19_2234.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
| R5 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260819-Research%20Data%202234%20D0837/README.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
...
- Selection order: 39 of 200
- Cryptographic draw: `2679669617` accepted on attempt 1, rejection limit `4294966620`, zero-based index `737` from a pool of 980.
...
- `Black-Lake-Data/.lake-data/DEP-20260819-Research Data 2234 D0837/dep0837_research_findings_2026-08-19_2234.md` - inspected repository file
- `Black-Lake-Data/.lake-data/DEP-20260819-Research Data 2234 D0837/README.md` - inspected repository file
