---
title: "Last-Iterate Convergence - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Last-Iterate Convergence of Adaptive Riemannian Gradient Descent for Equilibrium Computation."
...
primary_url: "https://arxiv.org/abs/2306.16617"
stable_identifier: "arXiv:2306.16617; DOI:10.48550/arXiv.2306.16617"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P16"
...
# Last-Iterate Convergence - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2306.16617 | https://arxiv.org/abs/2306.16617 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2306.16617 rendering | https://arxiv.org/html/2306.16617 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2306.16617 | https://arxiv.org/pdf/2306.16617 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | Multi-Step Alignment as - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260812-Multi-Step Alignment as/multi_step_alignment_as_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | GPMD Regularized RL - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-GPMD Regularized RL/gpmd_regularized_rl_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | RPDG Incremental Gradient - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260804-RPDG Incremental Grad/rpdg_incremental_gradient_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P16` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Cai, Yang; Jordan, Michael I.; Lin, Tianyi; Oikonomou, Argyris; Vlatakis-Gkaragkounis, Emmanouil-Vasileios. Submitted/source date: 2023/06/29. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P16`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: adaptive, computation, convergence, descent, gradient | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies adaptive, computation, convergence. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around adaptive, computation, convergence. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 72 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving adaptive, computation, convergence. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 3,453 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how adaptive, computation, convergence, descent, gradient connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: adaptive, computation, convergence, descent, gradient.
...
|---|---|---|---|
| Multi-Step Alignment as - DEP-E | Related DEP | Overlap: descent, convergence, gradient | `.lake-data/DEP-E/DEP-E-20260812-Multi-Step Alignment as/multi_step_alignment_as_manuscript.md` |
| GPMD Regularized RL - DEP-E | Related DEP | Overlap: descent, convergence, gradient, computation | `.lake-data/DEP-E/DEP-E-20260716-GPMD Regularized RL/gpmd_regularized_rl_manuscript.md` |
| RPDG Incremental Gradient - DEP-E | Related DEP | Overlap: gradient, descent, convergence, computation, adaptive | `.lake-data/DEP-E/DEP-E-20260804-RPDG Incremental Grad/rpdg_incremental_gradient_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2306.16617 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2306.16617 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2306.16617 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260812-Multi-Step Alignment as/multi_step_alignment_as_manuscript.md` | Related synthesis: descent, convergence, gradient | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260716-GPMD Regularized RL/gpmd_regularized_rl_manuscript.md` | Related synthesis: descent, convergence, gradient, computation | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260804-RPDG Incremental Grad/rpdg_incremental_gradient_manuscript.md` | Related synthesis: gradient, descent, convergence, computation, adaptive | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 3,453 of 75,964 units from 75,967 PDFs.
