---
title: "QIENet Quantitative - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of QIENet: Quantitative irradiance estimation network using recurrent neural network based on satellite remote sensing data."
...
primary_url: "https://arxiv.org/abs/2312.00299"
stable_identifier: "arXiv:2312.00299; DOI:10.48550/arXiv.2312.00299"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P490"
...
# QIENet Quantitative - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2312.00299 | https://arxiv.org/abs/2312.00299 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2312.00299 rendering | https://arxiv.org/html/2312.00299 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2312.00299 | https://arxiv.org/pdf/2312.00299 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P490` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Nie, Longfeng; Chen, Yuntian; Zhang, Dongxiao; Liu, Xinyue; Yuan, Wentian. Submitted/source date: 2023/12/01. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P490`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In order to estimate solar irradiance on the Earth’s surface [ Jiao & Mu 2022 , Olpenda et …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In order to estimate solar irradiance on the Earth’s surface [ Jiao & Mu 2022 , Olpenda et …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: estimation, network, neural, recurrent | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies network, estimation, irradiance. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around network, estimation, irradiance. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In order to estimate solar irradiance on the Earth’s surface [ Jiao & Mu 2022 , Olpenda et …”. The full-paper rendering contains 50 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In order to estimate solar irradiance on the Earth’s surface [ Jiao & Mu 2022 , Olpenda et …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In order to estimate solar irradiance on the Earth’s surface [ Jiao & Mu 2022 , Olpenda et …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving network, estimation, irradiance. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 74,253 of 75,964 units; duplicate exclusions 7; focus exclusions 26; source-gate exclusions 0; reselections 33.
...
- The related DEPs show how estimation, network, neural, recurrent connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: estimation, network, neural, recurrent.
...
|---|---|---|---|
| Direct Estimation of - DEP-E | Related DEP | Overlap: recurrent, estimation, network, neural | `.lake-data/DEP-E/DEP-E-20260819-Direct Estimation of/direct_estimation_of_manuscript.md` |
| Multi-Path Feedback - DEP-E | Related DEP | Overlap: recurrent, network, neural | `.lake-data/DEP-E/DEP-E-20260818-Multi-Path Feedback/multi_path_feedback_manuscript.md` |
| Explore Recurrent Neural - DEP-E | Related DEP | Overlap: recurrent, network, neural | `.lake-data/DEP-E/DEP-E-20260819-Explore Recurrent Neural/explore_recurrent_neural_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2312.00299 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2312.00299 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2312.00299 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Direct Estimation of/direct_estimation_of_manuscript.md` | Related synthesis: recurrent, estimation, network, neural | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Multi-Path Feedback/multi_path_feedback_manuscript.md` | Related synthesis: recurrent, network, neural | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Explore Recurrent Neural/explore_recurrent_neural_manuscript.md` | Related synthesis: recurrent, network, neural | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 74,253 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 7; focus exclusions: 26; source-gate exclusions: 0; reselections: 33; 24-hour cutoff: 2026-08-18.
