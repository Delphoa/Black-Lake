---
title: "Vulseye Detect Smart - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Vulseye: Detect Smart Contract Vulnerabilities via Stateful Directed Graybox Fuzzing."
...
primary_url: "https://arxiv.org/abs/2408.10116"
stable_identifier: "arXiv:2408.10116; DOI:10.48550/arXiv.2408.10116"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P60"
...
# Vulseye Detect Smart - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2408.10116 | https://arxiv.org/abs/2408.10116 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2408.10116 rendering | https://arxiv.org/html/2408.10116 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2408.10116 | https://arxiv.org/pdf/2408.10116 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | ORFuzz Fuzzing the Other - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260817-ORFuzz Fuzzing the Other/orfuzz_fuzzing_the_other_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Smart Coverage Goals - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Construction and - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Construction and/construction_and_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P60` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liang, Ruichao; Chen, Jing; Wu, Cong; He, Kun; Wu, Yueming; Cao, Ruochen; Du, Ruiying; Liu, Yang; Zhao, Ziming. Submitted/source date: 2024/08/19. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P60`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “To address these challenges, we propose Vulseye , a stateful directed graybox fuzzer for smart contracts guided by …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “To address these challenges, we propose Vulseye , a stateful directed graybox fuzzer for smart contracts guided by …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: contract, fuzzing, smart, stateful | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies contract, detect, directed. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around contract, detect, directed. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “To address these challenges, we propose Vulseye , a stateful directed graybox fuzzer for smart contracts guided by …”. The full-paper rendering contains 68 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “To address these challenges, we propose Vulseye , a stateful directed graybox fuzzer for smart contracts guided by …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Smart contracts, the cornerstone of decentralized applications, have become increasingly prominent in revolutionizing the digital landscape. However, vulnerabilities …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving contract, detect, directed. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 75,677 of 75,964 units; duplicate exclusions 6; focus exclusions 55; source-gate exclusions 1; reselections 62.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; title/abstract evidence terms stateful.
...
- The related DEPs show how contract, fuzzing, smart, stateful connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: contract, fuzzing, smart, stateful.
...
|---|---|---|---|
| ORFuzz Fuzzing the Other - DEP-E | Related DEP | Overlap: fuzzing | `.lake-data/DEP-E/DEP-E-20260817-ORFuzz Fuzzing the Other/orfuzz_fuzzing_the_other_manuscript.md` |
| Smart Coverage Goals - DEP-E | Related DEP | Overlap: smart, contract | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` |
| Construction and - DEP-E | Related DEP | Overlap: smart, stateful | `.lake-data/DEP-E/DEP-E-20260819-Construction and/construction_and_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2408.10116 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2408.10116 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2408.10116 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260817-ORFuzz Fuzzing the Other/orfuzz_fuzzing_the_other_manuscript.md` | Related synthesis: fuzzing | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` | Related synthesis: smart, contract | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Construction and/construction_and_manuscript.md` | Related synthesis: smart, stateful | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 75,677 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 6; focus exclusions: 55; source-gate exclusions: 1; reselections: 62; 24-hour cutoff: 2026-08-18.
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; terms stateful.
