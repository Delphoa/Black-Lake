---
title: "Memory Augmented Graph - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Memory Augmented Graph Neural Networks for Sequential Recommendation."
...
primary_url: "https://arxiv.org/abs/1912.11730"
stable_identifier: "arXiv:1912.11730; DOI:10.48550/arXiv.1912.11730"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P265"
...
# Memory Augmented Graph - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1912.11730 | https://arxiv.org/abs/1912.11730 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1912.11730 rendering | https://arxiv.org/html/1912.11730 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1912.11730 | https://arxiv.org/pdf/1912.11730 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Equivariant Contrastive Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-Equivariant Contrastive/equivariant_contrastive_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Rethinking Translation - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Rethinking Translation/rethinking_translation_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Graph Alignment Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260722-Graph Alignment/graph_alignment_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P265` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Ma, Chen; Ma, Liheng; Zhang, Yingxue; Sun, Jianing; Liu, Xue; Coates, Mark. Submitted/source date: 2019/12/26. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P265`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The chronological order of user-item interactions can reveal time-evolving and sequential user behaviors in many recommender systems. The …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The chronological order of user-item interactions can reveal time-evolving and sequential user behaviors in many recommender systems. The …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: augmented, graph, memory, neural, recommendation | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies augmented, graph, memory. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around augmented, graph, memory. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The chronological order of user-item interactions can reveal time-evolving and sequential user behaviors in many recommender systems. The …”. The full-paper rendering contains 56 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The chronological order of user-item interactions can reveal time-evolving and sequential user behaviors in many recommender systems. The …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The chronological order of user-item interactions can reveal time-evolving and sequential user behaviors in many recommender systems. The …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving augmented, graph, memory. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 36,144 of 75,964 units; duplicate exclusions 0; focus exclusions 4; source-gate exclusions 0; reselections 4.
...
- The related DEPs show how augmented, graph, memory, neural, recommendation connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: augmented, graph, memory, neural, recommendation.
...
|---|---|---|---|
| Equivariant Contrastive Review - DEP-E | Related DEP | Overlap: sequential, recommendation, memory | `.lake-data/DEP-E/DEP-E-20260721-Equivariant Contrastive/equivariant_contrastive_manuscript.md` |
| Rethinking Translation - DEP-E | Related DEP | Overlap: augmented, neural, memory | `.lake-data/DEP-E/DEP-E-20260819-Rethinking Translation/rethinking_translation_manuscript.md` |
| Graph Alignment Review - DEP-E | Related DEP | Overlap: recommendation, graph, memory | `.lake-data/DEP-E/DEP-E-20260722-Graph Alignment/graph_alignment_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1912.11730 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1912.11730 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1912.11730 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260721-Equivariant Contrastive/equivariant_contrastive_manuscript.md` | Related synthesis: sequential, recommendation, memory | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Rethinking Translation/rethinking_translation_manuscript.md` | Related synthesis: augmented, neural, memory | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260722-Graph Alignment/graph_alignment_manuscript.md` | Related synthesis: recommendation, graph, memory | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 36,144 of 75,964 units from 75,967 PDFs.
