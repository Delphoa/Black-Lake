...
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260804-Tech Intel 1103 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260804-Tech%20Intel%201103/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-08-04_1103.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260804-Tech%20Intel%201103/daily_research_findings_2026-08-04_1103.md | Repository evidence; public URL | 2026-08-19 | Inspected |
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260804-Tech%20Intel%201103/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260804-Tech%20Intel%201103/daily_research_findings_2026-08-04_1103.md | Deposited source synthesis | ** RTLCurator addresses scarce and noisy specification-to-RTL corpora, noting that only 24.4% and 53.5% of pairs pass generated functional tests in two widely used datasets. Rather than filtering only by correctness, it learns a behavior-aware compatibility prior from simulation failures and balances alignment, representation coverage, and structural richness. On CodeV and RTLCoder, retaining 80% of the corpus with only 10% of the pool validated improves all reported metrics over full-corpus training, while score-only ranking performs worse than random selection. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
...
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260804-Tech%20Intel%201103/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260804-Tech%20Intel%201103/daily_research_findings_2026-08-04_1103.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
