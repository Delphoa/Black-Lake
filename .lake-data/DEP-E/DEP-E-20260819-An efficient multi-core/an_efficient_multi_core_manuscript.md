---
title: "An efficient multi-core - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of An efficient multi-core implementation of a novel HSS-structured multifrontal solver using randomized sampling."
...
primary_url: "https://arxiv.org/abs/1502.07405"
stable_identifier: "arXiv:1502.07405; DOI:10.48550/arXiv.1502.07405"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P374"
...
# An efficient multi-core - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1502.07405 | https://arxiv.org/abs/1502.07405 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1502.07405 rendering | https://arxiv.org/html/1502.07405 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1502.07405 | https://arxiv.org/pdf/1502.07405 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | DPM-Solver A Fast ODE - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-DPM-Solver A Fast ODE/dpm_solver_a_fast_ode_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Differentiable Solver - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Differentiable Solver/differentiable_solver_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P374` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Ghysels, Pieter; Li, Xiaoye S.; Rouet, Francois-Henry; Williams, Samuel; Napov, Artem. Submitted/source date: 2015/02/25. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P374`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We present a sparse linear system solver that is based on a multifrontal variant of Gaussian elimination, and …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We present a sparse linear system solver that is based on a multifrontal variant of Gaussian elimination, and …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: randomized, sampling, solver | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies hss-structured, multi-core, multifrontal. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around hss-structured, multi-core, multifrontal. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We present a sparse linear system solver that is based on a multifrontal variant of Gaussian elimination, and …”. The full-paper rendering contains 75 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We present a sparse linear system solver that is based on a multifrontal variant of Gaussian elimination, and …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Solving large linear systems efficiently on modern hardware is an important requirement for many engineering high performance computing …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving hss-structured, multi-core, multifrontal. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 10,076 of 75,964 units; duplicate exclusions 4; focus exclusions 7; source-gate exclusions 0; reselections 11.
...
- The related DEPs show how randomized, sampling, solver connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: randomized, sampling, solver.
...
|---|---|---|---|
| DPM-Solver A Fast ODE - DEP-E | Related DEP | Overlap: solver, sampling | `.lake-data/DEP-E/DEP-E-20260819-DPM-Solver A Fast ODE/dpm_solver_a_fast_ode_manuscript.md` |
| Differentiable Solver - DEP-E | Related DEP | Overlap: solver, sampling | `.lake-data/DEP-E/DEP-E-20260819-Differentiable Solver/differentiable_solver_manuscript.md` |
| RPDG Incremental Gradient - DEP-E | Related DEP | Overlap: randomized, solver, sampling | `.lake-data/DEP-E/DEP-E-20260804-RPDG Incremental Grad/rpdg_incremental_gradient_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1502.07405 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1502.07405 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1502.07405 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-DPM-Solver A Fast ODE/dpm_solver_a_fast_ode_manuscript.md` | Related synthesis: solver, sampling | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Differentiable Solver/differentiable_solver_manuscript.md` | Related synthesis: solver, sampling | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260804-RPDG Incremental Grad/rpdg_incremental_gradient_manuscript.md` | Related synthesis: randomized, solver, sampling | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 10,076 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 4; focus exclusions: 7; source-gate exclusions: 0; reselections: 11; 24-hour cutoff: 2026-08-18.
