---
title: "arXiv 2109.11621 - DEP-E"
generated_at: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of [2109.11621] iFacetSum: Coreference-based Interactive Faceted Summarization for Multi-Document Exploration."
...
primary_url: "https://arxiv.org/abs/2109.11621"
stable_identifier: "arXiv:2109.11621"
...
# arXiv 2109.11621 - DEP-E

## Source Metadata

| Field | Value |
|---|---|
| Paper title | [2109.11621] iFacetSum: Coreference-based Interactive Faceted Summarization for Multi-Document Exploration |
| Authors | Not available from inspected sources |
| Platform | arXiv |
| arXiv ID | 2109.11621 |
| Revision/publication date | Not available from inspected sources |
| Primary URLs | https://arxiv.org/abs/2109.11621; https://arxiv.org/html/2109.11621; https://arxiv.org/pdf/2109.11621 |
...
|---|---|---|---|---|---|---|
| E1 | https://arxiv.org/html/2109.11621 | Primary paper HTML | Full-paper title, abstract, headings, method/evidence text, and limitations cues | Research object, method, evidence, and reviewer notes | High | Text extraction may omit visual layout and fine-grained table context. |
| E2 | https://arxiv.org/pdf/2109.11621 | Primary paper PDF | PDF integrity gate and source-presence cross-check | Complete-source status | High | No independent reproduction or figure-by-figure audit in this batch pass. |
| E3 | https://arxiv.org/abs/2109.11621 | Canonical metadata record | arXiv identifier and public locator | Stable identity and provenance | High | Abstract page is metadata only and was not treated as the full paper. |

## Executive Summary

The reviewed paper, *[2109.11621] iFacetSum: Coreference-based Interactive Faceted Summarization for Multi-Document Exploration*, addresses a research problem described in its full-paper HTML as follows: Abstract We introduce i FacetSum , 1 1 1 Demo at https://biu-nlp.github.io/iFACETSUM/WebApp/client/ , and code at https://github.com/BIU-NLP/iFACETSUM . a web application for exploring topical document sets. i FacetSum integrates interactive summarization together with faceted search, by providing a novel faceted navigation scheme that yields abstractive summaries for the user’s selections. This approach offers both a comprehensive overview as well as concise details regarding subtopics of choice. Fine-grained facets are automatically produced based on cross-document coreference pipelines, rendering generic concepts, entities and statements surfacing in the source texts. We analyze the effectiveness of our application through small-scale user studies, which suggest the usefulness of our approach. The source presents the paper's contribution through the following visible section structure: i FacetSum : Coreference-based Interactive Faceted Summarization for Multi-Document Exploration, Abstract, 1 Introduction, 2 i FacetSum Interface, 2.1 Faceted Navigation, 2.2 Facet-based Summarization, 3 Backend Algorithms, 3.1 Coreference-based Facet Formation, Concepts., Entities., Statements., 3.2 Abstractive Facet Summarization. Reviewer interpretation: the work is most useful as a source-grounded design or evaluation reference, while the exact strength of its claims depends on the experiments, datasets, baselines, and boundary conditions reported in the paper. Full-paper source integrity passed; independent reproduction was not performed.

## Detailed Summary

### Problem and contribution

The paper frames its problem and motivation in the primary source. The extracted abstract is: Abstract We introduce i FacetSum , 1 1 1 Demo at https://biu-nlp.github.io/iFACETSUM/WebApp/client/ , and code at https://github.com/BIU-NLP/iFACETSUM . a web application for exploring topical document sets. i FacetSum integrates interactive summarization together with faceted search, by providing a novel faceted navigation scheme that yields abstractive summaries for the user’s selections. This approach offers both a comprehensive overview as well as concise details regarding subtopics of choice. Fine-grained facets are automatically produced based on cross-document coreference pipelines, rendering generic concepts, entities and statements surfacing in the source texts. We analyze the effectiveness of our application through small-scale user studies, which suggest the usefulness of our approach.

### Method and mechanism

The full-paper text contains the following method-related evidence: 3 Backend Algorithms Figure 2 : The i FacetSum architecture. The purpose of this experiment was to get general feedback, from human subjects, on the usability of the system, following established usability study methodologies ( Nielsen , 1994 ) . The available heading structure is retained as a navigation aid rather than treated as proof of every technical claim.

### Evidence and results

Evidence-related text includes: Furthermore, short answers, such as those output in conversational QA, may be insufficient, while lists of relevant textual results, such as in conversational search, may be overwhelming and provoke an inefficient navigation process. This is followed by the description and results of our usability investigations in § 4 , an overview of related work in § 5 , and finally conclusions and suggestions for future work... Exact metrics and comparisons should be checked against the paper's tables and figures before making deployment decisions.

### Limitations and conclusion

Limitation-related text includes: This is followed by the description and results of our usability investigations in § 4 , an overview of related work in § 5 , and finally conclusions and suggestions for future work in § 6 . 6 Conclusion and Future Work In this paper, we presented i FacetSum , a novel text exploration approach and tool over large document sets, which incorporates faceted search into interactive summarization. Where the source did not expose a clear limitation in the extracted text, this review records the gap rather than inferring that no limitation exists.
...
- `Sources inspected`: The local verified full-paper PDF and full-paper HTML for arXiv:2109.11621; canonical arXiv metadata URL; three existing Black Lake DEP entries for related context.
...
- `Batch selection`: 75967 PDF candidates; 894 integrity-valid source units; 865 valid identified IDs; 2084 IDs found in repository/memory dedup scans; 396 duplicate exclusions; 0 reselections; 469 unseen eligible IDs; this item is sample position 55 of 200.
...
- `Temporal boundary`: Public deposition date 2026-08-19; source version is the locally archived arXiv version identified as 2109.11621.
...
|---|---|---|---|---|
| S1 | https://arxiv.org/html/2109.11621 | Full-paper text and section-level review | 2026-08-19 | Primary public locator; source file withheld locally. |
| S2 | https://arxiv.org/pdf/2109.11621 | PDF/source integrity status | 2026-08-19 | Primary public locator; source file withheld locally. |
| S3 | https://arxiv.org/abs/2109.11621 | Canonical metadata and stable identifier | 2026-08-19 | Metadata page only; not treated as the paper document. |
