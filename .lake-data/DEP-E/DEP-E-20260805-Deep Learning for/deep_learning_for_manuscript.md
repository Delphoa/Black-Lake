...
primary_subject: "Source-grounded review of Deep Learning for Hyperspectral Image Classification: An Overview."
...
primary_url: "https://arxiv.org/abs/1910.12861"
stable_identifier: "arXiv:1910.12861; DOI:10.1109/TGRS.2019.2907932"
deployment_job_id: "BLAD-2200-20260805-6C10E207"
deployment_item_id: "BLAD-2200-20260805-6C10E207-P07"
...
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1910.12861 | https://arxiv.org/abs/1910.12861 | Metadata only. | 2026-08-05 | Inspected |
| S2 | Full paper | Primary | HTML | 1910.12861 rendering | https://arxiv.org/html/1910.12861 | Verified local copy withheld. | 2026-08-05 | Inspected in full |
| S3 | PDF | Primary | PDF | 1910.12861 | https://arxiv.org/pdf/1910.12861 | Verified local copy withheld. | 2026-08-05 | Integrity checked and sampled |
...
| S5 | Biometric Identity Gaps - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Biometric Identity Gaps/biometric_identity_gaps_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S6 | CAR Avatar - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260709-Clothed Avatar CAR/clothed_avatar_car_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260805-6C10E207-P07` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-05 | Verified |

Authors: Li, Shutao; Song, Weiwei; Fang, Leyuan; Chen, Yushi; Ghamisi, Pedram; Benediktsson, Jón Atli. Submitted/source date: 2019/10/26. Job `BLAD-2200-20260805-6C10E207`; item `BLAD-2200-20260805-6C10E207-P07`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Hyperspectral image (HSI) classification has become a hot topic in the field of remote sensing. In general, the …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Hyperspectral image (HSI) classification has become a hot topic in the field of remote sensing. In general, the …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: avatar, avatars, classification, geometric, manifold | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies classification, hyperspectral, image. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around classification, hyperspectral, image. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Hyperspectral image (HSI) classification has become a hot topic in the field of remote sensing. In general, the …”. The full-paper rendering contains 73 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Hyperspectral image (HSI) classification has become a hot topic in the field of remote sensing. In general, the …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Hyperspectral image (HSI) classification has become a hot topic in the field of remote sensing. In general, the …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving classification, hyperspectral, image. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 51,028 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how avatar, avatars, classification, geometric, manifold connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: avatar, avatars, classification, geometric, manifold.
...
|---|---|---|---|
| Vid2Curve Reconstruction - DEP-E | Related DEP | Overlap: topological, overview, geometric, topology, pose | `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction/vid2curve_reconstruction_manuscript.md` |
| Biometric Identity Gaps - DEP-E | Related DEP | Overlap: avatars, persistence, manifold, avatar, classification | `.lake-data/DEP-E/DEP-E-20260716-Biometric Identity Gaps/biometric_identity_gaps_manuscript.md` |
| CAR Avatar - DEP-E | Related DEP | Overlap: avatars, avatar, geometric, pose, classification | `.lake-data/DEP-E/DEP-E-20260709-Clothed Avatar CAR/clothed_avatar_car_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1910.12861 | Metadata and abstract | 2026-08-05 | Metadata only |
| R2 | https://arxiv.org/html/1910.12861 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-05 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1910.12861 | Primary paper integrity | 2026-08-05 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction/vid2curve_reconstruction_manuscript.md` | Related synthesis: topological, overview, geometric, topology, pose | 2026-08-05 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260716-Biometric Identity Gaps/biometric_identity_gaps_manuscript.md` | Related synthesis: avatars, persistence, manifold, avatar, classification | 2026-08-05 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260709-Clothed Avatar CAR/clothed_avatar_car_manuscript.md` | Related synthesis: avatars, avatar, geometric, pose, classification | 2026-08-05 | Repository-relative |

## Appendix

- Uniform selected index: 51,028 of 75,957 units from 75,960 PDFs.
