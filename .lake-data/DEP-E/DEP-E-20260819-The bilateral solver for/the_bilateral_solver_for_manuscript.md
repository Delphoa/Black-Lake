---
title: "The bilateral solver for - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of The bilateral solver for quality estimation based multi-focus image fusion."
...
primary_url: "https://arxiv.org/abs/1904.01417"
stable_identifier: "arXiv:1904.01417; DOI:10.48550/arXiv.1904.01417"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P189"
...
# The bilateral solver for - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1904.01417 | https://arxiv.org/abs/1904.01417 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1904.01417 rendering | https://arxiv.org/html/1904.01417 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1904.01417 | https://arxiv.org/pdf/1904.01417 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | A Quantum SMT Solver for - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A Quantum SMT Solver for/a_quantum_smt_solver_for_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P189` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Guan, Jingwei; Chen, Yibo; Cham, Wai-kuen. Submitted/source date: 2019/04/01. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P189`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Architecture of QNN is illustrated in Fig. 3 . To avoid the blocking artifacts in quality score map …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In this work, a fast Bilateral Solver for Quality Estimation Based multi-focus Image Fusion method (BS-QEBIF) is proposed. …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: estimation, quality, solver | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies bilateral, estimation, fusion. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around bilateral, estimation, fusion. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Architecture of QNN is illustrated in Fig. 3 . To avoid the blocking artifacts in quality score map …”. The full-paper rendering contains 46 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In this work, a fast Bilateral Solver for Quality Estimation Based multi-focus Image Fusion method (BS-QEBIF) is proposed. …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In this work, a fast Bilateral Solver for Quality Estimation Based multi-focus Image Fusion method (BS-QEBIF) is proposed. …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving bilateral, estimation, fusion. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 12,801 of 75,964 units; duplicate exclusions 1; focus exclusions 12; source-gate exclusions 0; reselections 13.
...
- The related DEPs show how estimation, quality, solver connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: estimation, quality, solver.
...
|---|---|---|---|
| PIS A Generalized - DEP-E | Related DEP | Overlap: solver, estimation, quality | `.lake-data/DEP-E/DEP-E-20260819-PIS A Generalized/pis_a_generalized_manuscript.md` |
| A Quantum SMT Solver for - DEP-E | Related DEP | Overlap: solver, quality | `.lake-data/DEP-E/DEP-E-20260819-A Quantum SMT Solver for/a_quantum_smt_solver_for_manuscript.md` |
| Cooperative Training of - DEP-E | Related DEP | Overlap: solver, quality | `.lake-data/DEP-E/DEP-E-20260819-Cooperative Training of/cooperative_training_of_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1904.01417 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1904.01417 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1904.01417 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-PIS A Generalized/pis_a_generalized_manuscript.md` | Related synthesis: solver, estimation, quality | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-A Quantum SMT Solver for/a_quantum_smt_solver_for_manuscript.md` | Related synthesis: solver, quality | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Cooperative Training of/cooperative_training_of_manuscript.md` | Related synthesis: solver, quality | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 12,801 of 75,964 units from 75,967 PDFs.
