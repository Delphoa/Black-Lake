---
title: "Integrating Genomics into - DEP-E"
generated_at: "2026-08-12 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Integrating Genomics into Multimodal EHR Foundation Models."
...
primary_url: "https://arxiv.org/abs/2510.23639"
stable_identifier: "arXiv:2510.23639; DOI:10.48550/arXiv.2510.23639"
deployment_job_id: "BLAD-2200-20260812-9483C5E4"
deployment_item_id: "BLAD-2200-20260812-9483C5E4-P06"
...
# Integrating Genomics into - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2510.23639 | https://arxiv.org/abs/2510.23639 | Metadata only. | 2026-08-12 | Inspected |
| S2 | Full paper | Primary | HTML | 2510.23639 rendering | https://arxiv.org/html/2510.23639 | Verified local copy withheld. | 2026-08-12 | Inspected in full |
| S3 | PDF | Primary | PDF | 2510.23639 | https://arxiv.org/pdf/2510.23639 | Verified local copy withheld. | 2026-08-12 | Integrity checked and sampled |
| S4 | Efficient FM Survey - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` | Synthesis only. | 2026-08-12 | Inspected |
| S5 | Beyond Feature Mapping Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-Beyond Feature Mapping/beyond_feature_mapping_manuscript.md` | Synthesis only. | 2026-08-12 | Inspected |
| S6 | Deep Learning for - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260731-Deep Learning for/deep_learning_for_manuscript.md` | Synthesis only. | 2026-08-12 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260812-9483C5E4-P06` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-12 | Verified |

Authors: Amar, Jonathan; Liu, Edward; Breschi, Alessandra; Zhang, Liangliang; Kheradpour, Pouya; Li, Sylvia; Lehmann, Lisa Soleymani; Giulianelli, Alessandro; Edwards, Matt; Jia, Yugang; Nola, David; Mani, Raghav; Vats, Pankaj; Tetreault, Jesse; Chen, T. J.; McLean, Cory Y.. Submitted/source date: 2025/10/24. Job `BLAD-2200-20260812-9483C5E4`; item `BLAD-2200-20260812-9483C5E4-P06`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “This paper introduces an innovative Electronic Health Record (EHR) foundation model that integrates Polygenic Risk Scores (PRS) as …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “This paper introduces an innovative Electronic Health Record (EHR) foundation model that integrates Polygenic Risk Scores (PRS) as …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: foundation, integrating, multimodal | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies ehr, foundation, genomics. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around ehr, foundation, genomics. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “This paper introduces an innovative Electronic Health Record (EHR) foundation model that integrates Polygenic Risk Scores (PRS) as …”. The full-paper rendering contains 89 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “This paper introduces an innovative Electronic Health Record (EHR) foundation model that integrates Polygenic Risk Scores (PRS) as …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “However, these models are often limited by their reliance on a single data modality. While EHRs are widely …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving ehr, foundation, genomics. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 57,544 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how foundation, integrating, multimodal connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: foundation, integrating, multimodal.
...
|---|---|---|---|
| Efficient FM Survey - DEP-E | Related DEP | Overlap: foundation, multimodal | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` |
| Beyond Feature Mapping Review - DEP-E | Related DEP | Overlap: integrating | `.lake-data/DEP-E/DEP-E-20260721-Beyond Feature Mapping/beyond_feature_mapping_manuscript.md` |
| Deep Learning for - DEP-E | Related DEP | Overlap: integrating | `.lake-data/DEP-E/DEP-E-20260731-Deep Learning for/deep_learning_for_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2510.23639 | Metadata and abstract | 2026-08-12 | Metadata only |
| R2 | https://arxiv.org/html/2510.23639 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-12 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2510.23639 | Primary paper integrity | 2026-08-12 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` | Related synthesis: foundation, multimodal | 2026-08-12 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260721-Beyond Feature Mapping/beyond_feature_mapping_manuscript.md` | Related synthesis: integrating | 2026-08-12 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260731-Deep Learning for/deep_learning_for_manuscript.md` | Related synthesis: integrating | 2026-08-12 | Repository-relative |

## Appendix

- Uniform selected index: 57,544 of 75,964 units from 75,967 PDFs.
