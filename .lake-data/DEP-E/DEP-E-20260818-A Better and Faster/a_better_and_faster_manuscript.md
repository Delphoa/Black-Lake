---
title: "A Better and Faster - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A Better and Faster End-to-End Model for Streaming ASR."
...
primary_url: "https://arxiv.org/abs/2011.10798"
stable_identifier: "arXiv:2011.10798; DOI:10.48550/arXiv.2011.10798"
deployment_job_id: "BLAD-2200-20260818-BBEE0F31"
deployment_item_id: "BLAD-2200-20260818-BBEE0F31-P32"
...
# A Better and Faster - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2011.10798 | https://arxiv.org/abs/2011.10798 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2011.10798 rendering | https://arxiv.org/html/2011.10798 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2011.10798 | https://arxiv.org/pdf/2011.10798 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | Streaming - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260809-Streaming/streaming_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | Learning-Augmented - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Learning-Augmented/learning_augmented_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | Streaming Autoregressive - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Streaming Autoregressive/streaming_autoregressive_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-BBEE0F31-P32` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Li, Bo; Gulati, Anmol; Yu, Jiahui; Sainath, Tara N.; Chiu, Chung-Cheng; Narayanan, Arun; Chang, Shuo-Yiin; Pang, Ruoming; He, Yanzhang; Qin, James; Han, Wei; Liang, Qiao; Zhang, Yu; Strohman, Trevor; Wu, Yonghui. Submitted/source date: 2020/11/21. Job `BLAD-2200-20260818-BBEE0F31`; item `BLAD-2200-20260818-BBEE0F31-P32`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “End-to-end (E2E) models have shown to outperform state-of-the-art conventional models for streaming speech recognition [ 1 ] across …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “End-to-end (E2E) models have shown to outperform state-of-the-art conventional models for streaming speech recognition [ 1 ] across …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: better, streaming | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies asr, better, end-to-end. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around asr, better, end-to-end. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “End-to-end (E2E) models have shown to outperform state-of-the-art conventional models for streaming speech recognition [ 1 ] across …”. The full-paper rendering contains 55 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “End-to-end (E2E) models have shown to outperform state-of-the-art conventional models for streaming speech recognition [ 1 ] across …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “End-to-end (E2E) models have shown to outperform state-of-the-art conventional models for streaming speech recognition [ 1 ] across …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving asr, better, end-to-end. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 12,200 of 75,964 units; duplicate exclusions 0; focus exclusions 8; source-gate exclusions 0; reselections 8.
...
- The related DEPs show how better, streaming connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: better, streaming.
...
|---|---|---|---|
| Streaming - DEP-E | Related DEP | Overlap: streaming, better | `.lake-data/DEP-E/DEP-E-20260809-Streaming/streaming_manuscript.md` |
| Learning-Augmented - DEP-E | Related DEP | Overlap: streaming, better | `.lake-data/DEP-E/DEP-E-20260818-Learning-Augmented/learning_augmented_manuscript.md` |
| Streaming Autoregressive - DEP-E | Related DEP | Overlap: streaming, better | `.lake-data/DEP-E/DEP-E-20260818-Streaming Autoregressive/streaming_autoregressive_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2011.10798 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2011.10798 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2011.10798 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260809-Streaming/streaming_manuscript.md` | Related synthesis: streaming, better | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Learning-Augmented/learning_augmented_manuscript.md` | Related synthesis: streaming, better | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Streaming Autoregressive/streaming_autoregressive_manuscript.md` | Related synthesis: streaming, better | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 12,200 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 0; focus exclusions: 8; source-gate exclusions: 0; reselections: 8; 24-hour cutoff: 2026-08-17.
