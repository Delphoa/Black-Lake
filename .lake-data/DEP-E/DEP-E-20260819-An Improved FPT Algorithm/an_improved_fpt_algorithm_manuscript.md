...
primary_subject: "Source-grounded review of An Improved FPT Algorithm for the Flip Distance Problem."
...
primary_url: "https://arxiv.org/abs/1910.06185"
stable_identifier: "arXiv:1910.06185; DOI:10.4230/LIPIcs.MFCS.2017.65"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P225"
...
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1910.06185 | https://arxiv.org/abs/1910.06185 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1910.06185 rendering | https://arxiv.org/html/1910.06185 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1910.06185 | https://arxiv.org/pdf/1910.06185 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | An improved FPT algorithm - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-An improved FPT algorithm/an_improved_fpt_algorithm_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Efficient approximation - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Efficient approximation/efficient_approximation_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Barycode-based GJK - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Barycode-based GJK/barycode_based_gjk_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P225` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Feng, Qilong; Li, Shaohua; Meng, Xiangzhong; Wang, Jianxin. Submitted/source date: 2019/10/14. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P225`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Given a set 𝒫 \cal P of points in the Euclidean plane and two triangulations of 𝒫 \cal …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Given a set 𝒫 \cal P of points in the Euclidean plane and two triangulations of 𝒫 \cal …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, distance, fpt, problem | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, distance, flip. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, distance, flip. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Given a set 𝒫 \cal P of points in the Euclidean plane and two triangulations of 𝒫 \cal …”. The full-paper rendering contains 38 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Given a set 𝒫 \cal P of points in the Euclidean plane and two triangulations of 𝒫 \cal …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Flip Distance problem consists in computing the flip distance between two triangulations of 𝒫 \cal P , which …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, distance, flip. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 22,080 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how algorithm, distance, fpt, problem connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, distance, fpt, problem.
...
|---|---|---|---|
| An improved FPT algorithm - DEP-E | Related DEP | Overlap: fpt, algorithm, problem | `.lake-data/DEP-E/DEP-E-20260818-An improved FPT algorithm/an_improved_fpt_algorithm_manuscript.md` |
| Efficient approximation - DEP-E | Related DEP | Overlap: distance, problem | `.lake-data/DEP-E/DEP-E-20260819-Efficient approximation/efficient_approximation_manuscript.md` |
| Barycode-based GJK - DEP-E | Related DEP | Overlap: algorithm, distance, problem | `.lake-data/DEP-E/DEP-E-20260819-Barycode-based GJK/barycode_based_gjk_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1910.06185 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1910.06185 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1910.06185 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-An improved FPT algorithm/an_improved_fpt_algorithm_manuscript.md` | Related synthesis: fpt, algorithm, problem | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Efficient approximation/efficient_approximation_manuscript.md` | Related synthesis: distance, problem | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Barycode-based GJK/barycode_based_gjk_manuscript.md` | Related synthesis: algorithm, distance, problem | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 22,080 of 75,964 units from 75,967 PDFs.
