---
title: "NLP-AKG Few-Shot - DEP-E"
generated_at: "2026-08-02 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of NLP-AKG: Few-Shot Construction of NLP Academic Knowledge Graph Based on LLM."
...
primary_url: "https://arxiv.org/abs/2502.14192"
stable_identifier: "arXiv:2502.14192; DOI:10.48550/arXiv.2502.14192"
deployment_job_id: "BLAD-2200-20260802-0D11B2FA"
deployment_item_id: "BLAD-2200-20260802-0D11B2FA-P04"
...
# NLP-AKG Few-Shot - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2502.14192 | https://arxiv.org/abs/2502.14192 | Metadata only. | 2026-08-02 | Inspected |
| S2 | Full paper | Primary | HTML | 2502.14192 rendering | https://arxiv.org/html/2502.14192 | Verified local copy withheld. | 2026-08-02 | Inspected in full |
| S3 | PDF | Primary | PDF | 2502.14192 | https://arxiv.org/pdf/2502.14192 | Verified local copy withheld. | 2026-08-02 | Integrity checked and sampled |
| S4 | OMGEval Benchmark - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260717-OMGEval Benchmark/omgeval_benchmark_manuscript.md` | Synthesis only. | 2026-08-02 | Inspected |
| S5 | COVID Fake News - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` | Synthesis only. | 2026-08-02 | Inspected |
| S6 | BEAGLE Learner - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260710-BEAGLE Learner/beagle_learner_manuscript.md` | Synthesis only. | 2026-08-02 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260802-0D11B2FA-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-02 | Verified |

Authors: Lan, Jiayin; Li, Jiaqi; Wang, Baoxin; Liu, Ming; Wu, Dayong; Wang, Shijin; Qin, Bing. Submitted/source date: 2025/02/20. Job `BLAD-2200-20260802-0D11B2FA`; item `BLAD-2200-20260802-0D11B2FA-P04`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Large language models (LLMs) have been widely applied in question answering over scientific research papers. To enhance the …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Large language models (LLMs) have been widely applied in question answering over scientific research papers. To enhance the …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: construction, few-shot, graph, knowledge, llm | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies academic, construction, few-shot. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around academic, construction, few-shot. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Large language models (LLMs) have been widely applied in question answering over scientific research papers. To enhance the …”. The full-paper rendering contains 56 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Large language models (LLMs) have been widely applied in question answering over scientific research papers. To enhance the …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Large language models (LLMs) have been widely applied in question answering over scientific research papers. To enhance the …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving academic, construction, few-shot. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 30,672 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how construction, few-shot, graph, knowledge, llm connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: construction, few-shot, graph, knowledge, llm.
...
|---|---|---|---|
| OMGEval Benchmark - DEP-E | Related DEP | Overlap: nlp, knowledge, llm, construction | `.lake-data/DEP-E/DEP-E-20260717-OMGEval Benchmark/omgeval_benchmark_manuscript.md` |
| COVID Fake News - DEP-E | Related DEP | Overlap: nlp, knowledge, graph, construction | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` |
| BEAGLE Learner - DEP-E | Related DEP | Overlap: few-shot, knowledge, llm | `.lake-data/DEP-E/DEP-E-20260710-BEAGLE Learner/beagle_learner_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2502.14192 | Metadata and abstract | 2026-08-02 | Metadata only |
| R2 | https://arxiv.org/html/2502.14192 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-02 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2502.14192 | Primary paper integrity | 2026-08-02 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260717-OMGEval Benchmark/omgeval_benchmark_manuscript.md` | Related synthesis: nlp, knowledge, llm, construction | 2026-08-02 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` | Related synthesis: nlp, knowledge, graph, construction | 2026-08-02 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260710-BEAGLE Learner/beagle_learner_manuscript.md` | Related synthesis: few-shot, knowledge, llm | 2026-08-02 | Repository-relative |

## Appendix

- Uniform selected index: 30,672 of 75,957 units from 75,960 PDFs.
