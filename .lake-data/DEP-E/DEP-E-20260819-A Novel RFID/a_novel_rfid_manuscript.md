---
title: "A Novel RFID - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A Novel RFID Authentication Protocol Based on A Block-Order-Modulus Variable Matrix Encryption Algorithm."
...
primary_url: "https://arxiv.org/abs/2312.10593"
stable_identifier: "arXiv:2312.10593; DOI:10.48550/arXiv.2312.10593"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P363"
...
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2312.10593 | https://arxiv.org/abs/2312.10593 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2312.10593 rendering | https://arxiv.org/html/2312.10593 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2312.10593 | https://arxiv.org/pdf/2312.10593 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | A Novel Learning - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A Novel Learning/a_novel_learning_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Remarks on the - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260729-Remarks on the/remarks_on_the_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P363` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Yan; Liu, Ruiqi; Gao, Tong; Shu, Feng; Lei, Xuemei; Wu, Yongpeng; Gui, Guan; Wang, Jiangzhou. Submitted/source date: 2023/12/17. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P363`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In this paper, authentication for mobile radio frequency identification (RFID) systems with low-cost tags is studied. Firstly, an …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In this paper, authentication for mobile radio frequency identification (RFID) systems with low-cost tags is studied. Firstly, an …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, encryption, novel, protocol | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, authentication, block-order-modulus. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, authentication, block-order-modulus. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In this paper, authentication for mobile radio frequency identification (RFID) systems with low-cost tags is studied. Firstly, an …”. The full-paper rendering contains 50 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In this paper, authentication for mobile radio frequency identification (RFID) systems with low-cost tags is studied. Firstly, an …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “On the other hand, with the rapid deployment of RFID in a multitude fields, its security and privacy …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, authentication, block-order-modulus. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 70,072 of 75,964 units; duplicate exclusions 0; focus exclusions 10; source-gate exclusions 0; reselections 10.
...
- The related DEPs show how algorithm, encryption, novel, protocol connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, encryption, novel, protocol.
...
|---|---|---|---|
| A Novel Training Protocol - DEP-E | Related DEP | Overlap: novel, protocol, algorithm | `.lake-data/DEP-E/DEP-E-20260819-A Novel Training Protocol/a_novel_training_protocol_manuscript.md` |
| A Novel Learning - DEP-E | Related DEP | Overlap: novel, algorithm | `.lake-data/DEP-E/DEP-E-20260819-A Novel Learning/a_novel_learning_manuscript.md` |
| Remarks on the - DEP-E | Related DEP | Overlap: encryption | `.lake-data/DEP-E/DEP-E-20260729-Remarks on the/remarks_on_the_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2312.10593 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2312.10593 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2312.10593 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-A Novel Training Protocol/a_novel_training_protocol_manuscript.md` | Related synthesis: novel, protocol, algorithm | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-A Novel Learning/a_novel_learning_manuscript.md` | Related synthesis: novel, algorithm | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260729-Remarks on the/remarks_on_the_manuscript.md` | Related synthesis: encryption | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 70,072 of 75,964 units from 75,967 PDFs.
