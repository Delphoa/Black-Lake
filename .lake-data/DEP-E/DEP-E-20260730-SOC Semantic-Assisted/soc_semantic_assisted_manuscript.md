---
title: "SOC Semantic-Assisted - DEP-E"
generated_at: "2026-07-30 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of SOC: Semantic-Assisted Object Cluster for Referring Video Object Segmentation."
...
primary_url: "https://arxiv.org/abs/2305.17011"
stable_identifier: "arXiv:2305.17011; DOI:10.48550/arXiv.2305.17011"
deployment_job_id: "BLAD-2200-20260730-2FDDC232"
deployment_item_id: "BLAD-2200-20260730-2FDDC232-P10"
...
# SOC Semantic-Assisted - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2305.17011 | https://arxiv.org/abs/2305.17011 | Metadata only. | 2026-07-30 | Inspected |
| S2 | Full paper | Primary | HTML | 2305.17011 rendering | https://ar5iv.labs.arxiv.org/html/2305.17011 | Verified local copy withheld. | 2026-07-30 | Inspected in full |
| S3 | PDF | Primary | PDF | 2305.17011 | https://arxiv.org/pdf/2305.17011 | Verified local copy withheld. | 2026-07-30 | Integrity checked and sampled |
| S4 | AR-Drag Motion Control - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` | Synthesis only. | 2026-07-30 | Inspected |
| S5 | MoE3D Mixture of Experts - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260726-MoE3D Mixture of Experts/moe3d_mixture_of_experts_manuscript.md` | Synthesis only. | 2026-07-30 | Inspected |
| S6 | Multi-step Problem - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260728-Multi-step Problem/multi_step_problem_manuscript.md` | Synthesis only. | 2026-07-30 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260730-2FDDC232-P10` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-30 | Verified |

Authors: Luo, Zhuoyan; Xiao, Yicheng; Liu, Yong; Li, Shuyan; Wang, Yitong; Tang, Yansong; Li, Xiu; Yang, Yujiu. Submitted/source date: 2023/05/26. Job `BLAD-2200-20260730-2FDDC232`; item `BLAD-2200-20260730-2FDDC232-P10`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: alignment, multi-modal, problem, supervision, understanding | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies object, video, segmentation. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around object, video, segmentation. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving object, video, segmentation. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 40,440 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how alignment, multi-modal, problem, supervision, understanding connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: alignment, multi-modal, problem, supervision, understanding.
...
|---|---|---|---|
| AR-Drag Motion Control - DEP-E | Related DEP | Overlap: video, alignment | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` |
| MoE3D Mixture of Experts - DEP-E | Related DEP | Overlap: multi-modal, understanding | `.lake-data/DEP-E/DEP-E-20260726-MoE3D Mixture of Experts/moe3d_mixture_of_experts_manuscript.md` |
| Multi-step Problem - DEP-E | Related DEP | Overlap: supervision, problem | `.lake-data/DEP-E/DEP-E-20260728-Multi-step Problem/multi_step_problem_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2305.17011 | Metadata and abstract | 2026-07-30 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/2305.17011 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-30 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2305.17011 | Primary paper integrity | 2026-07-30 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` | Related synthesis: video, alignment | 2026-07-30 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260726-MoE3D Mixture of Experts/moe3d_mixture_of_experts_manuscript.md` | Related synthesis: multi-modal, understanding | 2026-07-30 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260728-Multi-step Problem/multi_step_problem_manuscript.md` | Related synthesis: supervision, problem | 2026-07-30 | Repository-relative |

## Appendix

- Uniform selected index: 40,440 of 75,957 units from 75,960 PDFs.
