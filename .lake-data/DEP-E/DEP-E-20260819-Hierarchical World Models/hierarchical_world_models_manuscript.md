---
title: "Hierarchical World Models - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Hierarchical World Models as Visual Whole-Body Humanoid Controllers."
...
primary_url: "https://arxiv.org/abs/2405.18418"
stable_identifier: "arXiv:2405.18418; DOI:10.48550/arXiv.2405.18418"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P427"
...
# Hierarchical World Models - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2405.18418 | https://arxiv.org/abs/2405.18418 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2405.18418 rendering | https://arxiv.org/html/2405.18418 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2405.18418 | https://arxiv.org/pdf/2405.18418 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | WT-UMI Tactile-based - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-WT-UMI Tactile-based/wt_umi_tactile_based_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P427` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Hansen, Nicklas; S V, Jyothir; Sobal, Vlad; LeCun, Yann; Wang, Xiaolong; Su, Hao. Submitted/source date: 2024/05/28. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P427`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: hierarchical, humanoid, visual, whole-body, world | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies controllers, hierarchical, humanoid. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around controllers, hierarchical, humanoid. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 48 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving controllers, hierarchical, humanoid. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 10,754 of 75,964 units; duplicate exclusions 1; focus exclusions 0; source-gate exclusions 0; reselections 1.
...
- The related DEPs show how hierarchical, humanoid, visual, whole-body, world connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: hierarchical, humanoid, visual, whole-body, world.
...
|---|---|---|---|
| One-shot Adaptation of - DEP-E | Related DEP | Overlap: humanoid, whole-body | `.lake-data/DEP-E/DEP-E-20260818-One-shot Adaptation of/one_shot_adaptation_of_manuscript.md` |
| Self-supervised - DEP-E | Related DEP | Overlap: hierarchical, world, visual | `.lake-data/DEP-E/DEP-E-20260819-Self-supervised/self_supervised_manuscript.md` |
| WT-UMI Tactile-based - DEP-E | Related DEP | Overlap: whole-body | `.lake-data/DEP-E/DEP-E-20260819-WT-UMI Tactile-based/wt_umi_tactile_based_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2405.18418 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2405.18418 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2405.18418 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-One-shot Adaptation of/one_shot_adaptation_of_manuscript.md` | Related synthesis: humanoid, whole-body | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Self-supervised/self_supervised_manuscript.md` | Related synthesis: hierarchical, world, visual | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-WT-UMI Tactile-based/wt_umi_tactile_based_manuscript.md` | Related synthesis: whole-body | 2026-08-19 | Repository-relative |
