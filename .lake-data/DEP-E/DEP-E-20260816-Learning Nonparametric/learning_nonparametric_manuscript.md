---
title: "Learning Nonparametric - DEP-E"
generated_at: "2026-08-16 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Learning Nonparametric Human Mesh Reconstruction from a Single Image without Ground Truth Meshes."
...
primary_url: "https://arxiv.org/abs/2003.00052"
stable_identifier: "arXiv:2003.00052; DOI:10.48550/arXiv.2003.00052"
deployment_job_id: "BLAD-2200-20260816-7EAAB41B"
deployment_item_id: "BLAD-2200-20260816-7EAAB41B-P02"
...
# Learning Nonparametric - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2003.00052 | https://arxiv.org/abs/2003.00052 | Metadata only. | 2026-08-16 | Inspected |
| S2 | Full paper | Primary | HTML | 2003.00052 rendering | https://arxiv.org/html/2003.00052 | Verified local copy withheld. | 2026-08-16 | Inspected in full |
| S3 | PDF | Primary | PDF | 2003.00052 | https://arxiv.org/pdf/2003.00052 | Verified local copy withheld. | 2026-08-16 | Integrity checked and sampled |
| S4 | Texturing and Deforming - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Texturing and Deforming/texturing_and_deforming_manuscript.md` | Synthesis only. | 2026-08-16 | Inspected |
| S5 | CAR Avatar - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260709-Clothed Avatar CAR/clothed_avatar_car_manuscript.md` | Synthesis only. | 2026-08-16 | Inspected |
| S6 | Vid2Curve Reconstruction - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction/vid2curve_reconstruction_manuscript.md` | Synthesis only. | 2026-08-16 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260816-7EAAB41B-P02` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-16 | Verified |

Authors: Lin, Kevin; Wang, Lijuan; Jin, Ying; Liu, Zicheng; Sun, Ming-Ting. Submitted/source date: 2020/02/28. Job `BLAD-2200-20260816-7EAAB41B`; item `BLAD-2200-20260816-7EAAB41B-P02`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Nonparametric approaches have shown promising results on reconstructing 3D human mesh from a single monocular image. Unlike previous …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Nonparametric approaches have shown promising results on reconstructing 3D human mesh from a single monocular image. Unlike previous …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: ground, human, mesh, meshes, reconstruction | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies ground, human, image. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around ground, human, image. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Nonparametric approaches have shown promising results on reconstructing 3D human mesh from a single monocular image. Unlike previous …”. The full-paper rendering contains 51 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Nonparametric approaches have shown promising results on reconstructing 3D human mesh from a single monocular image. Unlike previous …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Nonparametric approaches have shown promising results on reconstructing 3D human mesh from a single monocular image. Unlike previous …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving ground, human, image. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 48,002 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how ground, human, mesh, meshes, reconstruction connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: ground, human, mesh, meshes, reconstruction.
...
|---|---|---|---|
| Texturing and Deforming - DEP-E | Related DEP | Overlap: meshes, reconstruction, human | `.lake-data/DEP-E/DEP-E-20260803-Texturing and Deforming/texturing_and_deforming_manuscript.md` |
| CAR Avatar - DEP-E | Related DEP | Overlap: reconstruction, meshes, mesh, ground, truth | `.lake-data/DEP-E/DEP-E-20260709-Clothed Avatar CAR/clothed_avatar_car_manuscript.md` |
| Vid2Curve Reconstruction - DEP-E | Related DEP | Overlap: reconstruction, meshes, mesh, ground, truth | `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction/vid2curve_reconstruction_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2003.00052 | Metadata and abstract | 2026-08-16 | Metadata only |
| R2 | https://arxiv.org/html/2003.00052 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-16 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2003.00052 | Primary paper integrity | 2026-08-16 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260803-Texturing and Deforming/texturing_and_deforming_manuscript.md` | Related synthesis: meshes, reconstruction, human | 2026-08-16 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260709-Clothed Avatar CAR/clothed_avatar_car_manuscript.md` | Related synthesis: reconstruction, meshes, mesh, ground, truth | 2026-08-16 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction/vid2curve_reconstruction_manuscript.md` | Related synthesis: reconstruction, meshes, mesh, ground, truth | 2026-08-16 | Repository-relative |

## Appendix

- Uniform selected index: 48,002 of 75,964 units from 75,967 PDFs.
