---
title: "Metric-Solver Sliding - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Metric-Solver: Sliding Anchored Metric Depth Estimation from a Single Image."
...
primary_url: "https://arxiv.org/abs/2504.12103"
stable_identifier: "arXiv:2504.12103; DOI:10.48550/arXiv.2504.12103"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P231"
...
# Metric-Solver Sliding - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2504.12103 | https://arxiv.org/abs/2504.12103 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2504.12103 rendering | https://arxiv.org/html/2504.12103 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2504.12103 | https://arxiv.org/pdf/2504.12103 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Stable Diffusion Depth - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260718-Stable Diffusion Depth/stable_diffusion_depth_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | The bilateral solver for - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-The bilateral solver for/the_bilateral_solver_for_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Learning Nonparametric - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260816-Learning Nonparametric/learning_nonparametric_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P231` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wen, Tao; Wang, Jiepeng; Chen, Yabo; Xu, Shugong; Zhang, Chi; Li, Xuelong. Submitted/source date: 2025/04/16. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P231`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Accurate and generalizable metric depth estimation is crucial for various computer vision applications but remains challenging due to …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Accurate and generalizable metric depth estimation is crucial for various computer vision applications but remains challenging due to …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: depth, estimation, image, metric, single | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies anchored, depth, estimation. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around anchored, depth, estimation. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Accurate and generalizable metric depth estimation is crucial for various computer vision applications but remains challenging due to …”. The full-paper rendering contains 73 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Accurate and generalizable metric depth estimation is crucial for various computer vision applications but remains challenging due to …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Monocular depth estimation from a single image [ 7 , 8 , 1 , 50 , 12 , …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving anchored, depth, estimation. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 63,762 of 75,964 units; duplicate exclusions 1; focus exclusions 4; source-gate exclusions 0; reselections 5.
...
- The related DEPs show how depth, estimation, image, metric, single connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: depth, estimation, image, metric, single.
...
|---|---|---|---|
| Stable Diffusion Depth - DEP-E | Related DEP | Overlap: estimation, depth, single, image, metric | `.lake-data/DEP-E/DEP-E-20260718-Stable Diffusion Depth/stable_diffusion_depth_manuscript.md` |
| The bilateral solver for - DEP-E | Related DEP | Overlap: estimation, image, metric | `.lake-data/DEP-E/DEP-E-20260819-The bilateral solver for/the_bilateral_solver_for_manuscript.md` |
| Learning Nonparametric - DEP-E | Related DEP | Overlap: single, image, metric | `.lake-data/DEP-E/DEP-E-20260816-Learning Nonparametric/learning_nonparametric_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2504.12103 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2504.12103 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2504.12103 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260718-Stable Diffusion Depth/stable_diffusion_depth_manuscript.md` | Related synthesis: estimation, depth, single, image, metric | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-The bilateral solver for/the_bilateral_solver_for_manuscript.md` | Related synthesis: estimation, image, metric | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260816-Learning Nonparametric/learning_nonparametric_manuscript.md` | Related synthesis: single, image, metric | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 63,762 of 75,964 units from 75,967 PDFs.
