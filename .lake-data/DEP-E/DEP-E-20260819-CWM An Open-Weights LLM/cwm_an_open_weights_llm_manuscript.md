---
title: "CWM An Open-Weights LLM - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of CWM: An Open-Weights LLM for Research on Code Generation with World Models."
...
primary_url: "https://arxiv.org/abs/2510.02387"
stable_identifier: "arXiv:2510.02387; DOI:10.48550/arXiv.2510.02387"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P33"
...
# CWM An Open-Weights LLM - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2510.02387 | https://arxiv.org/abs/2510.02387 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2510.02387 rendering | https://arxiv.org/html/2510.02387 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2510.02387 | https://arxiv.org/pdf/2510.02387 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | NaLA A 3D Native LLM - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260809-NaLA A 3D Native LLM/nala_a_3d_native_llm_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Inner-Probe Discovering - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Inner-Probe Discovering/inner_probe_discovering_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P33` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: FAIR CodeGen team; Copet, Jade; Carbonneaux, Quentin; Cohen, Gal; Gehring, Jonas; Kahn, Jacob; Kossen, Jannik; Kreuk, Felix; McMilin, Emily; Meyer, Michel; Wei, Yuxiang; Zhang, David; Zheng, Kunhao; Armengol-Estapé, Jordi; Bashiri, Pedram; Beck, Maximilian; Chambon, Pierre; Charnalia, Abhishek; Cummins, Chris; Decugis, Juliette; Fisches, Zacharias V.; Fleuret, François; Gloeckle, Fabian; Gu, Alex; Hassid, Michael; Haziza, Daniel; Idrissi, Badr Youbi; Keller, Christian; Kindi, Rahul; Leather, Hugh; Maimon, Gallil; Markosyan, Aram; Massa, Francisco; Mazaré, Pierre-Emmanuel; Mella, Vegard; Murray, Naila; Muzumdar, Keyur; O'Hearn, Peter; Pagliardini, Matteo; Pedchenko, Dmitrii; Remez, Tal; Seeker, Volker; Selvi, Marco; Sultan, Oren; Wang, Sida; Wehrstedt, Luca; Yoran, Ori; Zhang, Lingming; Cohen, Taco; Adi, Yossi; Synnaeve, Gabriel. Submitted/source date: 2025/09/30. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P33`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “CWM uses a dense, decoder-only Transformer architecture ( Vaswani et al. 2017 ; Radford et al. 2018 ) …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We release Code World Model ( CWM ), a 32-billion-parameter open-weights LLM, to advance research on code generation …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: generation, llm, world | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies cwm, generation, llm. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around cwm, generation, llm. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “CWM uses a dense, decoder-only Transformer architecture ( Vaswani et al. 2017 ; Radford et al. 2018 ) …”. The full-paper rendering contains 120 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We release Code World Model ( CWM ), a 32-billion-parameter open-weights LLM, to advance research on code generation …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Software development is one of the domains where Large Language Models (LLMs) have already had a significant real-world …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving cwm, generation, llm. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 16,356 of 75,964 units; duplicate exclusions 0; focus exclusions 7; source-gate exclusions 0; reselections 7.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; title/abstract evidence terms world model.
...
- The related DEPs show how generation, llm, world connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: generation, llm, world.
...
|---|---|---|---|
| HERMES World Model - DEP-E | Related DEP | Overlap: world, generation | `.lake-data/DEP-E/DEP-E-20260712-HERMES World Model/hermes_world_model_manuscript.md` |
| NaLA A 3D Native LLM - DEP-E | Related DEP | Overlap: llm, generation | `.lake-data/DEP-E/DEP-E-20260809-NaLA A 3D Native LLM/nala_a_3d_native_llm_manuscript.md` |
| Inner-Probe Discovering - DEP-E | Related DEP | Overlap: llm, generation | `.lake-data/DEP-E/DEP-E-20260818-Inner-Probe Discovering/inner_probe_discovering_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2510.02387 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2510.02387 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2510.02387 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260712-HERMES World Model/hermes_world_model_manuscript.md` | Related synthesis: world, generation | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260809-NaLA A 3D Native LLM/nala_a_3d_native_llm_manuscript.md` | Related synthesis: llm, generation | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Inner-Probe Discovering/inner_probe_discovering_manuscript.md` | Related synthesis: llm, generation | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 16,356 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 0; focus exclusions: 7; source-gate exclusions: 0; reselections: 7; 24-hour cutoff: 2026-08-18.
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; terms world model.
