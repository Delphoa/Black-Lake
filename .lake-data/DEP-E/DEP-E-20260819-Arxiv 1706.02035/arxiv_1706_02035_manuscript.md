---
title: "arXiv 1706.02035 - DEP-E"
generated_at: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of [1706.02035] The damage inflicted by a computer virus: A new estimation method."
...
primary_url: "https://arxiv.org/abs/1706.02035"
stable_identifier: "arXiv:1706.02035"
...
# arXiv 1706.02035 - DEP-E

## Source Metadata

| Field | Value |
|---|---|
| Paper title | [1706.02035] The damage inflicted by a computer virus: A new estimation method |
| Authors | Not available from inspected sources |
| Platform | arXiv |
| arXiv ID | 1706.02035 |
| Revision/publication date | Not available from inspected sources |
| Primary URLs | https://arxiv.org/abs/1706.02035; https://arxiv.org/html/1706.02035; https://arxiv.org/pdf/1706.02035 |
...
|---|---|---|---|---|---|---|
| E1 | https://arxiv.org/html/1706.02035 | Primary paper HTML | Full-paper title, abstract, headings, method/evidence text, and limitations cues | Research object, method, evidence, and reviewer notes | High | Text extraction may omit visual layout and fine-grained table context. |
| E2 | https://arxiv.org/pdf/1706.02035 | Primary paper PDF | PDF integrity gate and source-presence cross-check | Complete-source status | High | No independent reproduction or figure-by-figure audit in this batch pass. |
| E3 | https://arxiv.org/abs/1706.02035 | Canonical metadata record | arXiv identifier and public locator | Stable identity and provenance | High | Abstract page is metadata only and was not treated as the full paper. |

## Executive Summary

The reviewed paper, *[1706.02035] The damage inflicted by a computer virus: A new estimation method*, addresses a research problem described in its full-paper HTML as follows: Abstract This paper addressed the issue of estimating the damage caused by a computer virus. First, an individual-level delayed SIR model capturing the spreading process of a digital virus is derived. Second, the damage inflicted by the virus is modeled as the sum of the economic losses and the cost for developing the antivirus. Next, the impact of different factors, including the delay and the network structure, on the damage is explored by means of computer simulations. Thereby some measures of reducing the damage of a virus are recommended. To our knowledge, this is the first time the antivirus-developing cost is taken into account when estimating the damage of a virus. The source presents the paper's contribution through the following visible section structure: The damage inflicted by a computer virus: A new estimation method, Abstract, keywords:, 1 Introduction, 2 Measuring the overall damage, 2.1 Notions, notations and hypotheses, 2.2 A delayed SIR model, 2.3 Measuring the overall damage, 3 The influence of different factors on the overall damage, 3.1 The influence of the three dynamic parameters, 3.2 The influence of the two cost parameters, 3.3 The influence of the time delay. Reviewer interpretation: the work is most useful as a source-grounded design or evaluation reference, while the exact strength of its claims depends on the experiments, datasets, baselines, and boundary conditions reported in the paper. Full-paper source integrity passed; independent reproduction was not performed.

## Detailed Summary

### Problem and contribution

The paper frames its problem and motivation in the primary source. The extracted abstract is: Abstract This paper addressed the issue of estimating the damage caused by a computer virus. First, an individual-level delayed SIR model capturing the spreading process of a digital virus is derived. Second, the damage inflicted by the virus is modeled as the sum of the economic losses and the cost for developing the antivirus. Next, the impact of different factors, including the delay and the network structure, on the damage is explored by means of computer simulations. Thereby some measures of reducing the damage of a virus are recommended. To our knowledge, this is the first time the antivirus-developing cost is taken into account when estimating the damage of a virus.

### Method and mechanism

The full-paper text contains the following method-related evidence: [1706.02035] The damage inflicted by a computer virus: A new estimation method The damage inflicted by a computer virus: A new estimation method Jichao Bi 272573022@qq.com Lu-Xing Yang ylx910920@gmail.com Xiaofan Yang xfyang1964@gmail.com Yingbo Wu wyb@cqu.edu.cn Yuan Yan Tang yytang@umac.mo College of Software Engineering, Chongqing University, Chongqing, 400044, China Faculty of Electrical Engineering,... The available heading structure is retained as a navigation aid rather than treated as proof of every technical claim.

### Evidence and results

Evidence-related text includes: Next, the impact of different factors, including the delay and the network structure, on the virus damage is uncovered experimentally, thereby some measures of reducing the overall damage are recommended. Section 3 experimentally explores the influence of different factors on the damage. Exact metrics and comparisons should be checked against the paper's tables and figures before making deployment decisions.
...
- `Sources inspected`: The local verified full-paper PDF and full-paper HTML for arXiv:1706.02035; canonical arXiv metadata URL; three existing Black Lake DEP entries for related context.
...
- `Batch selection`: 75967 PDF candidates; 894 integrity-valid source units; 865 valid identified IDs; 2084 IDs found in repository/memory dedup scans; 396 duplicate exclusions; 0 reselections; 469 unseen eligible IDs; this item is sample position 108 of 200.
...
- `Temporal boundary`: Public deposition date 2026-08-19; source version is the locally archived arXiv version identified as 1706.02035.
...
|---|---|---|---|---|
| S1 | https://arxiv.org/html/1706.02035 | Full-paper text and section-level review | 2026-08-19 | Primary public locator; source file withheld locally. |
| S2 | https://arxiv.org/pdf/1706.02035 | PDF/source integrity status | 2026-08-19 | Primary public locator; source file withheld locally. |
| S3 | https://arxiv.org/abs/1706.02035 | Canonical metadata and stable identifier | 2026-08-19 | Metadata page only; not treated as the paper document. |
