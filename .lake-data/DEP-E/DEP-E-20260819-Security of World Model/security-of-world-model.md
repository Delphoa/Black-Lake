...
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260731-Tech Intel 1111 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260731-Tech%20Intel%201111/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-31_1111.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260731-Tech%20Intel%201111/daily_research_findings_2026-07-31_1111.md | Repository evidence; public URL | 2026-08-19 | Inspected |
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260731-Tech%20Intel%201111/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260731-Tech%20Intel%201111/daily_research_findings_2026-07-31_1111.md | Deposited source synthesis | ** SemPIC targets long-context retrieval and agent workloads that repeatedly reuse the same documents under different instructions, histories, and document orders. It trains a LoRA-enabled Writer to compile native per-layer document KV caches through behavioral distillation while leaving the pretrained decoder Reader unchanged, reporting mean micro-F1 improvement over KV Packet from 0.53 to 0.60 and approaching Full Recompute at 0.62. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
...
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260731-Tech%20Intel%201111/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260731-Tech%20Intel%201111/daily_research_findings_2026-07-31_1111.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
