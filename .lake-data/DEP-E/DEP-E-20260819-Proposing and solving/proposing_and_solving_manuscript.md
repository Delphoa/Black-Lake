---
title: "Proposing and solving - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Proposing and solving olympiad geometry with guided tree search."
...
primary_url: "https://arxiv.org/abs/2412.10673"
stable_identifier: "arXiv:2412.10673; DOI:10.48550/arXiv.2412.10673"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P170"
...
# Proposing and solving - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2412.10673 | https://arxiv.org/abs/2412.10673 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2412.10673 rendering | https://arxiv.org/html/2412.10673 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2412.10673 | https://arxiv.org/pdf/2412.10673 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P170` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhang, Chi; Song, Jiajun; Li, Siyu; Liang, Yitao; Ma, Yuxi; Wang, Wei; Zhu, Yixin; Zhu, Song-Chun. Submitted/source date: 2024/12/14. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P170`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Table 1 (left) shows the performance of different models and human averages on IMO-AG-30. While the latest reasoning-enhanced …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Mathematics olympiads are prestigious competitions, with problem proposing and solving highly honored. Building artificial intelligence that proposes and …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: guided, search, solving, tree | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies geometry, guided, olympiad. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around geometry, guided, olympiad. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Table 1 (left) shows the performance of different models and human averages on IMO-AG-30. While the latest reasoning-enhanced …”. The full-paper rendering contains 57 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Mathematics olympiads are prestigious competitions, with problem proposing and solving highly honored. Building artificial intelligence that proposes and …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Mathematics olympiads are prestigious competitions, with problem proposing and solving highly honored. Building artificial intelligence that proposes and …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving geometry, guided, olympiad. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 48,368 of 75,964 units; duplicate exclusions 1; focus exclusions 15; source-gate exclusions 0; reselections 16.
...
- The related DEPs show how guided, search, solving, tree connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: guided, search, solving, tree.
...
|---|---|---|---|
| OpenClaw-Skill Collective - DEP-E | Related DEP | Overlap: tree, search, solving | `.lake-data/DEP-E/DEP-E-20260818-OpenClaw-Skill Collective/openclaw_skill_collective_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2412.10673 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2412.10673 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2412.10673 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-OpenClaw-Skill Collective/openclaw_skill_collective_manuscript.md` | Related synthesis: tree, search, solving | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260805-AVGCN Trajectory/avgcn_trajectory_manuscript.md` | Related synthesis: guided | 2026-08-19 | Repository-relative |
...
- Uniform selected index: 48,368 of 75,964 units from 75,967 PDFs.
