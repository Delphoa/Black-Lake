---
title: "Optimization-Free - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Optimization-Free Test-Time Adaptation for Cross-Person Activity Recognition."
...
primary_url: "https://arxiv.org/abs/2310.18562"
stable_identifier: "arXiv:2310.18562; DOI:10.48550/arXiv.2310.18562"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P157"
...
# Optimization-Free - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2310.18562 | https://arxiv.org/abs/2310.18562 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2310.18562 rendering | https://arxiv.org/html/2310.18562 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2310.18562 | https://arxiv.org/pdf/2310.18562 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | DPO Dual-Perturbation - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-DPO Dual-Perturbation/dpo_dual_perturbation_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Reimagination with - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Reimagination with/reimagination_with_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | RAR Visual Reranking - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-RAR Visual Reranking/rar_visual_reranking_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P157` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Shuoyuan; Wang, Jindong; Xi, HuaJun; Zhang, Bob; Zhang, Lei; Wei, Hongxin. Submitted/source date: 2023/10/28. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P157`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Human Activity Recognition (HAR) models often suffer from performance degradation in real-world applications due to distribution shifts in …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Human Activity Recognition (HAR) models often suffer from performance degradation in real-world applications due to distribution shifts in …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: adaptation, recognition, test-time | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies activity, adaptation, cross-person. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around activity, adaptation, cross-person. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Human Activity Recognition (HAR) models often suffer from performance degradation in real-world applications due to distribution shifts in …”. The full-paper rendering contains 76 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Human Activity Recognition (HAR) models often suffer from performance degradation in real-world applications due to distribution shifts in …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Human Activity Recognition (HAR) models often suffer from performance degradation in real-world applications due to distribution shifts in …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving activity, adaptation, cross-person. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 25,064 of 75,964 units; duplicate exclusions 2; focus exclusions 9; source-gate exclusions 0; reselections 11.
...
- The related DEPs show how adaptation, recognition, test-time connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: adaptation, recognition, test-time.
...
|---|---|---|---|
| DPO Dual-Perturbation - DEP-E | Related DEP | Overlap: test-time, adaptation | `.lake-data/DEP-E/DEP-E-20260819-DPO Dual-Perturbation/dpo_dual_perturbation_manuscript.md` |
| Reimagination with - DEP-E | Related DEP | Overlap: test-time | `.lake-data/DEP-E/DEP-E-20260819-Reimagination with/reimagination_with_manuscript.md` |
| RAR Visual Reranking - DEP-E | Related DEP | Overlap: recognition, adaptation | `.lake-data/DEP-E/DEP-E-20260723-RAR Visual Reranking/rar_visual_reranking_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2310.18562 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2310.18562 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2310.18562 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-DPO Dual-Perturbation/dpo_dual_perturbation_manuscript.md` | Related synthesis: test-time, adaptation | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Reimagination with/reimagination_with_manuscript.md` | Related synthesis: test-time | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260723-RAR Visual Reranking/rar_visual_reranking_manuscript.md` | Related synthesis: recognition, adaptation | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 25,064 of 75,964 units from 75,967 PDFs.
