---
title: "Cosh-DiT Co-Speech - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Cosh-DiT: Co-Speech Gesture Video Synthesis via Hybrid Audio-Visual Diffusion Transformers."
...
primary_url: "https://arxiv.org/abs/2503.09942"
stable_identifier: "arXiv:2503.09942; DOI:10.48550/arXiv.2503.09942"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P20"
...
# Cosh-DiT Co-Speech - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2503.09942 | https://arxiv.org/abs/2503.09942 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2503.09942 rendering | https://arxiv.org/html/2503.09942 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2503.09942 | https://arxiv.org/pdf/2503.09942 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | AR-Drag Motion Control - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | Watching Too Much - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260804-Watching Too Much/watching_too_much_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | On Aligning Hierarchical - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260817-On Aligning Hierarchical/on_aligning_hierarchical_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P20` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Sun, Yasheng; Xu, Zhiliang; Zhou, Hang; Guan, Jiazhi; Yang, Quanwei; Wang, Kaisiyuan; Liang, Borong; Li, Yingying; Feng, Haocheng; Wang, Jingdong; Liu, Ziwei; Hideki, Koike. Submitted/source date: 2025/03/13. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P20`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Co-speech gesture video synthesis is a challenging task that requires both probabilistic modeling of human gestures and the …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Co-speech gesture video synthesis is a challenging task that requires both probabilistic modeling of human gestures and the …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: audio-visual, diffusion, synthesis, video | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies audio-visual, co-speech, cosh-dit. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around audio-visual, co-speech, cosh-dit. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Co-speech gesture video synthesis is a challenging task that requires both probabilistic modeling of human gestures and the …”. The full-paper rendering contains 79 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Co-speech gesture video synthesis is a challenging task that requires both probabilistic modeling of human gestures and the …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Co-speech gesture video synthesis is a challenging task that requires both probabilistic modeling of human gestures and the …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving audio-visual, co-speech, cosh-dit. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 18,230 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how audio-visual, diffusion, synthesis, video connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: audio-visual, diffusion, synthesis, video.
...
|---|---|---|---|
| AR-Drag Motion Control - DEP-E | Related DEP | Overlap: video, diffusion, synthesis | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` |
| Watching Too Much - DEP-E | Related DEP | Overlap: audio-visual, synthesis | `.lake-data/DEP-E/DEP-E-20260804-Watching Too Much/watching_too_much_manuscript.md` |
| On Aligning Hierarchical - DEP-E | Related DEP | Overlap: audio-visual, synthesis | `.lake-data/DEP-E/DEP-E-20260817-On Aligning Hierarchical/on_aligning_hierarchical_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2503.09942 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2503.09942 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2503.09942 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` | Related synthesis: video, diffusion, synthesis | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260804-Watching Too Much/watching_too_much_manuscript.md` | Related synthesis: audio-visual, synthesis | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260817-On Aligning Hierarchical/on_aligning_hierarchical_manuscript.md` | Related synthesis: audio-visual, synthesis | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 18,230 of 75,964 units from 75,967 PDFs.
