---
title: "Link Prediction on Latent - DEP-E"
generated_at: "2026-07-29 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Link Prediction on Latent Heterogeneous Graphs."
...
primary_url: "https://arxiv.org/abs/2302.10432"
stable_identifier: "arXiv:2302.10432; DOI:10.48550/arXiv.2302.10432"
deployment_job_id: "BLAD-2200-20260729-5EE3EF9C"
deployment_item_id: "BLAD-2200-20260729-5EE3EF9C-P08"
...
# Link Prediction on Latent - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2302.10432 | https://arxiv.org/abs/2302.10432 | Metadata only. | 2026-07-29 | Inspected |
| S2 | Full paper | Primary | HTML | 2302.10432 rendering | https://ar5iv.labs.arxiv.org/html/2302.10432 | Verified local copy withheld. | 2026-07-29 | Inspected in full |
| S3 | PDF | Primary | PDF | 2302.10432 | https://arxiv.org/pdf/2302.10432 | Verified local copy withheld. | 2026-07-29 | Integrity checked and sampled |
| S4 | Alleviating Inconsistency Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-Alleviating Inconsistency/alleviating_inconsistency_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S5 | MI-Motion - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260728-MI-Motion Review/mi_motion_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S6 | ViT Semantic Robustness - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-ViT Semantic Robustness/vit_semantic_robustness_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260729-5EE3EF9C-P08` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-29 | Verified |

Authors: Nguyen, Trung-Kien; Liu, Zemin; Fang, Yuan. Submitted/source date: 2023/02/21. Job `BLAD-2200-20260729-5EE3EF9C`; item `BLAD-2200-20260729-5EE3EF9C-P08`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “On graph data, the multitude of node or edge types gives rise to heterogeneous information networks (HINs). To …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “On graph data, the multitude of node or edge types gives rise to heterogeneous information networks (HINs). To …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: aggregation, benchmark, graph, prediction, representation | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies heterogeneous, latent, information. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around heterogeneous, latent, information. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “On graph data, the multitude of node or edge types gives rise to heterogeneous information networks (HINs). To …”. The full-paper rendering contains 57 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “On graph data, the multitude of node or edge types gives rise to heterogeneous information networks (HINs). To …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “On graph data, the multitude of node or edge types gives rise to heterogeneous information networks (HINs). To …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving heterogeneous, latent, information. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 18,876 of 75,778 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how aggregation, benchmark, graph, prediction, representation connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: aggregation, benchmark, graph, prediction, representation.
...
|---|---|---|---|
| Alleviating Inconsistency Review - DEP-E | Related DEP | Overlap: aggregation, graph | `.lake-data/DEP-E/DEP-E-20260721-Alleviating Inconsistency/alleviating_inconsistency_manuscript.md` |
| MI-Motion - DEP-E | Related DEP | Overlap: prediction, benchmark | `.lake-data/DEP-E/DEP-E-20260728-MI-Motion Review/mi_motion_manuscript.md` |
| ViT Semantic Robustness - DEP-E | Related DEP | Overlap: representation, semantic | `.lake-data/DEP-E/DEP-E-20260716-ViT Semantic Robustness/vit_semantic_robustness_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2302.10432 | Metadata and abstract | 2026-07-29 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/2302.10432 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-29 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2302.10432 | Primary paper integrity | 2026-07-29 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260721-Alleviating Inconsistency/alleviating_inconsistency_manuscript.md` | Related synthesis: aggregation, graph | 2026-07-29 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260728-MI-Motion Review/mi_motion_manuscript.md` | Related synthesis: prediction, benchmark | 2026-07-29 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260716-ViT Semantic Robustness/vit_semantic_robustness_manuscript.md` | Related synthesis: representation, semantic | 2026-07-29 | Repository-relative |

## Appendix

- Uniform selected index: 18,876 of 75,778 units from 75,781 PDFs.
