---
title: "GeoDM Geometry-aware - DEP-E"
generated_at: "2026-07-31 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of GeoDM: Geometry-aware Distribution Matching for Dataset Distillation."
...
primary_url: "https://arxiv.org/abs/2512.08317"
stable_identifier: "arXiv:2512.08317; DOI:10.48550/arXiv.2512.08317"
deployment_job_id: "BLAD-2200-20260731-3D09E72F"
deployment_item_id: "BLAD-2200-20260731-3D09E72F-P09"
...
# GeoDM Geometry-aware - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2512.08317 | https://arxiv.org/abs/2512.08317 | Metadata only. | 2026-07-31 | Inspected |
| S2 | Full paper | Primary | HTML | 2512.08317 rendering | https://arxiv.org/html/2512.08317 | Verified local copy withheld. | 2026-07-31 | Inspected in full |
| S3 | PDF | Primary | PDF | 2512.08317 | https://arxiv.org/pdf/2512.08317 | Verified local copy withheld. | 2026-07-31 | Integrity checked and sampled |
| S4 | AR-Drag Motion Control - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` | Synthesis only. | 2026-07-31 | Inspected |
| S5 | VideoWeave - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260709-VideoWeave Geometry/videoweave_geometry_manuscript.md` | Synthesis only. | 2026-07-31 | Inspected |
| S6 | HERMES World Model - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260712-HERMES World Model/hermes_world_model_manuscript.md` | Synthesis only. | 2026-07-31 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260731-3D09E72F-P09` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-31 | Verified |

Authors: Li, Xuhui; Luo, Zhengquan; Cui, Zihui; Xu, Zhiqiang. Submitted/source date: 2025/12/09. Job `BLAD-2200-20260731-3D09E72F`; item `BLAD-2200-20260731-3D09E72F-P09`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Dataset distillation aims to synthesize a compact subset of the original data, enabling models trained on it to …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Dataset distillation aims to synthesize a compact subset of the original data, enabling models trained on it to …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: distillation, distribution, geometry-aware, matching | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies distillation, distribution, geodm. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around distillation, distribution, geodm. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Dataset distillation aims to synthesize a compact subset of the original data, enabling models trained on it to …”. The full-paper rendering contains 122 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Dataset distillation aims to synthesize a compact subset of the original data, enabling models trained on it to …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Dataset distillation aims to synthesize a compact subset of the original data, enabling models trained on it to …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving distillation, distribution, geodm. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 33,474 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how distillation, distribution, geometry-aware, matching connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: distillation, distribution, geometry-aware, matching.
...
|---|---|---|---|
| AR-Drag Motion Control - DEP-E | Related DEP | Overlap: geometry-aware, distillation, matching, distribution | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` |
| VideoWeave - DEP-E | Related DEP | Overlap: geometry-aware, distillation, distribution | `.lake-data/DEP-E/DEP-E-20260709-VideoWeave Geometry/videoweave_geometry_manuscript.md` |
| HERMES World Model - DEP-E | Related DEP | Overlap: geometry-aware, matching, distribution | `.lake-data/DEP-E/DEP-E-20260712-HERMES World Model/hermes_world_model_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2512.08317 | Metadata and abstract | 2026-07-31 | Metadata only |
| R2 | https://arxiv.org/html/2512.08317 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-31 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2512.08317 | Primary paper integrity | 2026-07-31 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` | Related synthesis: geometry-aware, distillation, matching, distribution | 2026-07-31 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260709-VideoWeave Geometry/videoweave_geometry_manuscript.md` | Related synthesis: geometry-aware, distillation, distribution | 2026-07-31 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260712-HERMES World Model/hermes_world_model_manuscript.md` | Related synthesis: geometry-aware, matching, distribution | 2026-07-31 | Repository-relative |

## Appendix

- Uniform selected index: 33,474 of 75,957 units from 75,960 PDFs.
