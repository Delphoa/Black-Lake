---
title: "An Inexact Augmented - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of An Inexact Augmented Lagrangian Algorithm for Training Leaky ReLU Neural Network with Group Sparsity."
...
primary_url: "https://arxiv.org/abs/2205.05428"
stable_identifier: "arXiv:2205.05428; DOI:10.48550/arXiv.2205.05428"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P305"
...
# An Inexact Augmented - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2205.05428 | https://arxiv.org/abs/2205.05428 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2205.05428 rendering | https://arxiv.org/html/2205.05428 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2205.05428 | https://arxiv.org/pdf/2205.05428 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Path-Normalized - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Path-Normalized/path_normalized_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Predictive Lagrangian - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Predictive Lagrangian/predictive_lagrangian_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P305` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Wei; Liu, Xin; Chen, Xiaojun. Submitted/source date: 2022/05/11. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P305`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The leaky ReLU network with a group sparse regularization term has been widely used in the recent years. …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The leaky ReLU network with a group sparse regularization term has been widely used in the recent years. …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, group, lagrangian, leaky, network | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, augmented, group. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, augmented, group. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The leaky ReLU network with a group sparse regularization term has been widely used in the recent years. …”. The full-paper rendering contains 91 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The leaky ReLU network with a group sparse regularization term has been widely used in the recent years. …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The leaky ReLU network with a group sparse regularization term has been widely used in the recent years. …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, augmented, group. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 46,806 of 75,964 units; duplicate exclusions 0; focus exclusions 5; source-gate exclusions 0; reselections 5.
...
- The related DEPs show how algorithm, group, lagrangian, leaky, network connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, group, lagrangian, leaky, network.
...
|---|---|---|---|
| Path-Normalized - DEP-E | Related DEP | Overlap: relu, neural | `.lake-data/DEP-E/DEP-E-20260819-Path-Normalized/path_normalized_manuscript.md` |
| Predictive Lagrangian - DEP-E | Related DEP | Overlap: lagrangian, neural | `.lake-data/DEP-E/DEP-E-20260819-Predictive Lagrangian/predictive_lagrangian_manuscript.md` |
| MoCom MAV Comms - DEP-E | Related DEP | Overlap: neural, network, leaky, group, algorithm | `.lake-data/DEP-E/DEP-E-20260819-MoCom MAV Comms/mocom_mav_comms_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2205.05428 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2205.05428 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2205.05428 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Path-Normalized/path_normalized_manuscript.md` | Related synthesis: relu, neural | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Predictive Lagrangian/predictive_lagrangian_manuscript.md` | Related synthesis: lagrangian, neural | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-MoCom MAV Comms/mocom_mav_comms_manuscript.md` | Related synthesis: neural, network, leaky, group, algorithm | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 46,806 of 75,964 units from 75,967 PDFs.
