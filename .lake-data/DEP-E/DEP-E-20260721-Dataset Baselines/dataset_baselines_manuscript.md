---
title: "Dataset Baselines Review - DEP-E"
generated_at: "2026-07-21 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A Dataset and Baselines for Measuring and Predicting the Music Piece Memorability."
...
primary_url: "https://arxiv.org/abs/2405.12847"
stable_identifier: "arXiv:2405.12847; DOI:10.5281/zenodo.10265251"
deployment_job_id: "BLAD-2200-20260721-F7EDC854"
deployment_item_id: "BLAD-2200-20260721-F7EDC854-P07"
...
# Dataset Baselines Review - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2405.12847 | https://arxiv.org/abs/2405.12847 | Metadata only. | 2026-07-21 | Inspected |
| S2 | Full paper | Primary | HTML | 2405.12847 rendering | https://arxiv.org/html/2405.12847 | Verified local copy withheld. | 2026-07-21 | Inspected in full |
| S3 | PDF | Primary | PDF | 2405.12847 | https://arxiv.org/pdf/2405.12847 | Verified local copy withheld. | 2026-07-21 | Integrity checked |
| S4 | LA-Pose Latent Action - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260713-LA-Pose Latent Action/la_pose_latent_action_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S5 | KDFlow LLM Distill - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260712-KDFlow LLM Distill/kdflow_llm_distill_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S6 | Kernel Equivalence Tests | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-Kernel Equivalence/kernel_equivalence_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260721-F7EDC854-P07` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-21 | Verified |

Authors: Tseng, Li-Yang; Lin, Tzu-Ling; Shuai, Hong-Han; Huang, Jen-Wei; Chang, Wen-Whei. Submitted/source date: 2024/05/21. Job `BLAD-2200-20260721-F7EDC854`; item `BLAD-2200-20260721-F7EDC854-P07`.
...
| E2 | S2/S3 | Primary paper | Problem framing around music, memorability, predicting | Research objective | High for transcription | Source framing is not independent validation |
...
This paper studies music, memorability, predicting and presents the proposed method as its central contribution. The inspected full paper connects the method to dataset, baselines, measuring and reports empirical or analytical support in its chosen setting. The review preserves those claims as source-reported evidence. It does not claim independent reproduction, current operational validity, or deployment readiness. The main downstream value is a versioned evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

The research object is *A Dataset and Baselines for Measuring and Predicting the Music Piece Memorability*. Its problem framing concentrates on music, memorability, predicting. The paper positions the proposed method as a way to organize or improve the relevant mechanism and connects the proposal to dataset, baselines, measuring.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a meaningful problem involving music, memorability, predicting. | Author claim | E2 | Directly supported as source framing; practical importance depends on target context. | Medium-high |
...
| KDFlow LLM Distill - DEP-E | Related DEP | Related representation, evidence, or implementation lens | `.lake-data/DEP-E/DEP-E-20260712-KDFlow LLM Distill/kdflow_llm_distill_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2405.12847 | Metadata and abstract | 2026-07-21 | Metadata only |
| R2 | https://arxiv.org/html/2405.12847 | Full-paper method and evidence | 2026-07-21 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2405.12847 | Primary paper integrity | 2026-07-21 | Verified local copy withheld |
| R4 | https://doi.org/10.5281/zenodo.10265251 | Publisher identifier | 2026-07-21 | DOI locator |
| R5 | `.lake-data/DEP-E/DEP-E-20260713-LA-Pose Latent Action/la_pose_latent_action_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260712-KDFlow LLM Distill/kdflow_llm_distill_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |
| R7 | `.lake-data/DEP-E/DEP-E-20260719-Kernel Equivalence/kernel_equivalence_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |

## Appendix

Uniform selected index 24,277 of 75,776 units from 75,779 PDFs; duplicate exclusions 0; reselections 0. The complete-source gate passed after one bounded archive repair. Source documents and companion integrity records remain local; none was staged or uploaded.
