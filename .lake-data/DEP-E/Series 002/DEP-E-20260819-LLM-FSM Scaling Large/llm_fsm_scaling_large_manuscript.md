---
title: "LLM-FSM Scaling Large - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of LLM-FSM: Scaling Large Language Models for Finite-State Reasoning in RTL Code Generation."
...
primary_url: "https://arxiv.org/abs/2602.07032"
stable_identifier: "arXiv:2602.07032; DOI:10.48550/arXiv.2602.07032"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P54"
...
# LLM-FSM Scaling Large - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2602.07032 | https://arxiv.org/abs/2602.07032 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2602.07032 rendering | https://arxiv.org/html/2602.07032 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2602.07032 | https://arxiv.org/pdf/2602.07032 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | Avatar V Scaling - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260810-Avatar V Scaling/avatar_v_scaling_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P54` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wu, Yuheng; Gokmen, Berk; Xie, Zhouhua; Li, Peijing; Trippel, Caroline; Raina, Priyanka; Tambe, Thierry. Submitted/source date: 2026/02/03. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P54`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In this paper, we present LLM-FSM, a large-scale NL specification-to-RTL benchmark designed to evaluate finite-state reasoning in LLMs. …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Finite-state reasoning, the ability to understand and implement state-dependent behavior, is central to hardware design. In this paper, …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: generation, language, reasoning, rtl, scaling | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies finite-state, generation, language. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around finite-state, generation, language. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In this paper, we present LLM-FSM, a large-scale NL specification-to-RTL benchmark designed to evaluate finite-state reasoning in LLMs. …”. The full-paper rendering contains 93 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Finite-state reasoning, the ability to understand and implement state-dependent behavior, is central to hardware design. In this paper, …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In evaluating LLMs’ ability to generate RTL, an important component is their finite-state reasoning capability, which refers to …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving finite-state, generation, language. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 71,564 of 75,964 units; duplicate exclusions 1; focus exclusions 1; source-gate exclusions 0; reselections 2.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; title/abstract evidence terms finite state.
...
- The related DEPs show how generation, language, reasoning, rtl, scaling connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: generation, language, reasoning, rtl, scaling.
...
|---|---|---|---|
| COEVO Co-Evolutionary Framework - DEP-E | Related DEP | Overlap: rtl, generation, reasoning | `.lake-data/DEP-E/DEP-E-20260723-COEVO Co-Evolutionary Fra/coevo_co_evolutionary_fra_manuscript.md` |
| A-RAG Scaling Agentic - DEP-E | Related DEP | Overlap: scaling, generation, reasoning, language | `.lake-data/DEP-E/DEP-E-20260818-A-RAG Scaling Agentic/a_rag_scaling_agentic_manuscript.md` |
| Avatar V Scaling - DEP-E | Related DEP | Overlap: scaling, generation | `.lake-data/DEP-E/DEP-E-20260810-Avatar V Scaling/avatar_v_scaling_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2602.07032 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2602.07032 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2602.07032 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260723-COEVO Co-Evolutionary Fra/coevo_co_evolutionary_fra_manuscript.md` | Related synthesis: rtl, generation, reasoning | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-A-RAG Scaling Agentic/a_rag_scaling_agentic_manuscript.md` | Related synthesis: scaling, generation, reasoning, language | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260810-Avatar V Scaling/avatar_v_scaling_manuscript.md` | Related synthesis: scaling, generation | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 71,564 of 75,964 units from 75,967 PDFs.
...
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; terms finite state.
