---
title: "Predicting Long-Term - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Predicting Long-Term Skeletal Motions by a Spatio-Temporal Hierarchical Recurrent Network."
...
primary_url: "https://arxiv.org/abs/1911.02404"
stable_identifier: "arXiv:1911.02404; DOI:10.48550/arXiv.1911.02404"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P204"
...
# Predicting Long-Term - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1911.02404 | https://arxiv.org/abs/1911.02404 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1911.02404 rendering | https://arxiv.org/html/1911.02404 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1911.02404 | https://arxiv.org/pdf/1911.02404 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Explore Recurrent Neural - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Explore Recurrent Neural/explore_recurrent_neural_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | ST-NeRF - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-ST-NeRF Video/st_nerf_video_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P204` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Hu, Junfeng; Fan, Zhencheng; Liao, Jun; Liu, Li. Submitted/source date: 2019/11/06. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P204`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The primary goal of skeletal motion prediction is to generate future motion by observing a sequence of 3D …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The primary goal of skeletal motion prediction is to generate future motion by observing a sequence of 3D …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: network, recurrent, spatio-temporal | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies hierarchical, long-term, motions. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around hierarchical, long-term, motions. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The primary goal of skeletal motion prediction is to generate future motion by observing a sequence of 3D …”. The full-paper rendering contains 55 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The primary goal of skeletal motion prediction is to generate future motion by observing a sequence of 3D …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The primary goal of skeletal motion prediction is to generate future motion by observing a sequence of 3D …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving hierarchical, long-term, motions. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 60,303 of 75,964 units; duplicate exclusions 1; focus exclusions 25; source-gate exclusions 0; reselections 26.
...
- The related DEPs show how network, recurrent, spatio-temporal connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: network, recurrent, spatio-temporal.
...
|---|---|---|---|
| Multi-Path Feedback - DEP-E | Related DEP | Overlap: recurrent, network | `.lake-data/DEP-E/DEP-E-20260818-Multi-Path Feedback/multi_path_feedback_manuscript.md` |
| Explore Recurrent Neural - DEP-E | Related DEP | Overlap: recurrent, network | `.lake-data/DEP-E/DEP-E-20260819-Explore Recurrent Neural/explore_recurrent_neural_manuscript.md` |
| ST-NeRF - DEP-E | Related DEP | Overlap: spatio-temporal, network | `.lake-data/DEP-E/DEP-E-20260818-ST-NeRF Video/st_nerf_video_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1911.02404 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1911.02404 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1911.02404 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Multi-Path Feedback/multi_path_feedback_manuscript.md` | Related synthesis: recurrent, network | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Explore Recurrent Neural/explore_recurrent_neural_manuscript.md` | Related synthesis: recurrent, network | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-ST-NeRF Video/st_nerf_video_manuscript.md` | Related synthesis: spatio-temporal, network | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 60,303 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 1; focus exclusions: 25; source-gate exclusions: 0; reselections: 26; 24-hour cutoff: 2026-08-18.
