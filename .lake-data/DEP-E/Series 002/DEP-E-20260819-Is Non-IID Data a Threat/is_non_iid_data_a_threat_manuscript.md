---
title: "Is Non-IID Data a Threat - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Is Non-IID Data a Threat in Federated Online Learning to Rank?."
...
primary_url: "https://arxiv.org/abs/2204.09272"
stable_identifier: "arXiv:2204.09272; DOI:10.48550/arXiv.2204.09272"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P68"
...
# Is Non-IID Data a Threat - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2204.09272 | https://arxiv.org/abs/2204.09272 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2204.09272 rendering | https://arxiv.org/html/2204.09272 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2204.09272 | https://arxiv.org/pdf/2204.09272 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P68` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Shuyi; Zuccon, Guido. Submitted/source date: 2022/04/20. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P68`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In this perspective paper we study the effect of non independent and identically distributed (non-IID) data on federated …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Online learning to rank (OLTR) ( Hofmann 2013 ; Oosterhuis and de Rijke 2018 ; Zhuang and Zuccon …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: federated, non-iid, online, rank | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies federated, non-iid, online. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around federated, non-iid, online. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In this perspective paper we study the effect of non independent and identically distributed (non-IID) data on federated …”. The full-paper rendering contains 58 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Online learning to rank (OLTR) ( Hofmann 2013 ; Oosterhuis and de Rijke 2018 ; Zhuang and Zuccon …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In this perspective paper we study the effect of non independent and identically distributed (non-IID) data on federated …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving federated, non-iid, online. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 24,684 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how federated, non-iid, online, rank connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: federated, non-iid, online, rank.
...
|---|---|---|---|
| FOLTR Unlearning - DEP-E | Related DEP | Overlap: federated, rank, online, non-iid | `.lake-data/DEP-E/DEP-E-20260804-Forget FOLTR/forget_foltr_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2204.09272 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2204.09272 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2204.09272 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260804-Forget FOLTR/forget_foltr_manuscript.md` | Related synthesis: federated, rank, online, non-iid | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260729-Decoupled Training with/decoupled_training_with_manuscript.md` | Related synthesis: federated | 2026-08-19 | Repository-relative |
...
- Uniform selected index: 24,684 of 75,964 units from 75,967 PDFs.
