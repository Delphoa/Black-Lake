---
title: "Extremely Weak 1770 - DEP-E"
generated_at: "2026-08-21 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Extremely Weak Supervision Inversion of Multi-physical Properties."
...
primary_url: "https://arxiv.org/abs/2202.01770"
stable_identifier: "arXiv:2202.01770; DOI:10.48550/arXiv.2202.01770"
deployment_job_id: "BLAD-2200-20260821-909CA89B"
deployment_item_id: "BLAD-2200-20260821-909CA89B-P02"
...
# Extremely Weak 1770 - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2202.01770 | https://arxiv.org/abs/2202.01770 | Metadata only. | 2026-08-21 | Inspected |
| S2 | Full paper | Primary | HTML | 2202.01770 rendering | https://arxiv.org/html/2202.01770 | Verified local copy withheld. | 2026-08-21 | Inspected in full |
| S3 | PDF | Primary | PDF | 2202.01770 | https://arxiv.org/pdf/2202.01770 | Verified local copy withheld. | 2026-08-21 | Integrity checked and sampled |
| S4 | PIS A Generalized - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/Series 002/DEP-E-20260819-PIS A Generalized/pis_a_generalized_manuscript.md` | Synthesis only. | 2026-08-21 | Inspected |
| S5 | AV Parsing CMA - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/Series 002/DEP-E-20260820-AV Parsing CMA/av_parsing_cma_manuscript.md` | Synthesis only. | 2026-08-21 | Inspected |
| S6 | Quantum Recurrent Neural - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/Series 002/DEP-E-20260819-Quantum Recurrent Neural/quantum_recurrent_neural_manuscript.md` | Synthesis only. | 2026-08-21 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260821-909CA89B-P02` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-21 | Verified |

Authors: Feng, Shihang; Jin, Peng; Zhang, Xitong; Chen, Yinpeng; Alumbaugh, David; Commer, Michael; Lin, Youzuo. Submitted/source date: 2022/02/03. Job `BLAD-2200-20260821-909CA89B`; item `BLAD-2200-20260821-909CA89B-P02`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The mean-square errors (MSE), mean-absolute errors (MAE), and structural similarity (SSIM) are used for evaluating the conductivity and …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Multi-physical inversion plays a critical role in geophysics. It has been widely used to infer various physical properties …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: differential, equations, infer, inversion, issue | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies inversion, properties, multi-physical. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around inversion, properties, multi-physical. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The mean-square errors (MSE), mean-absolute errors (MAE), and structural similarity (SSIM) are used for evaluating the conductivity and …”. The full-paper rendering contains 29 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Multi-physical inversion plays a critical role in geophysics. It has been widely used to infer various physical properties …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Properties without explicit governing equations can be obtained with supervised data-driven methods. However, the acquisition of the labeled …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving inversion, properties, multi-physical. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 18,042 of 75,964 units; duplicate exclusions 13959; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how differential, equations, infer, inversion, issue connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: differential, equations, infer, inversion, issue.
...
|---|---|---|---|
| PIS A Generalized - DEP-E | Related DEP | Overlap: inversion, physical, sparse, pdes, differential | `.lake-data/DEP-E/Series 002/DEP-E-20260819-PIS A Generalized/pis_a_generalized_manuscript.md` |
| AV Parsing CMA - DEP-E | Related DEP | Overlap: pseudo, supervision, issue, times, equations | `.lake-data/DEP-E/Series 002/DEP-E-20260820-AV Parsing CMA/av_parsing_cma_manuscript.md` |
| Quantum Recurrent Neural - DEP-E | Related DEP | Overlap: differential, equations, partial, infer, weak | `.lake-data/DEP-E/Series 002/DEP-E-20260819-Quantum Recurrent Neural/quantum_recurrent_neural_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2202.01770 | Metadata and abstract | 2026-08-21 | Metadata only |
| R2 | https://arxiv.org/html/2202.01770 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-21 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2202.01770 | Primary paper integrity | 2026-08-21 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/Series 002/DEP-E-20260819-PIS A Generalized/pis_a_generalized_manuscript.md` | Related synthesis: inversion, physical, sparse, pdes, differential | 2026-08-21 | Repository-relative |
| R5 | `.lake-data/DEP-E/Series 002/DEP-E-20260820-AV Parsing CMA/av_parsing_cma_manuscript.md` | Related synthesis: pseudo, supervision, issue, times, equations | 2026-08-21 | Repository-relative |
| R6 | `.lake-data/DEP-E/Series 002/DEP-E-20260819-Quantum Recurrent Neural/quantum_recurrent_neural_manuscript.md` | Related synthesis: differential, equations, partial, infer, weak | 2026-08-21 | Repository-relative |

## Appendix

- Uniform selected index: 18,042 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 13959; focus exclusions: 0; source-gate exclusions: 0; reselections: 0; 24-hour cutoff: 2026-08-20.
