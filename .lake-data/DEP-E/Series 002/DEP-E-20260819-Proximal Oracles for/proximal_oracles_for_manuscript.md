---
title: "Proximal Oracles for - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Proximal Oracles for Optimization and Sampling."
...
primary_url: "https://arxiv.org/abs/2404.02239"
stable_identifier: "arXiv:2404.02239; DOI:10.48550/arXiv.2404.02239"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P484"
...
# Proximal Oracles for - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2404.02239 | https://arxiv.org/abs/2404.02239 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2404.02239 rendering | https://arxiv.org/html/2404.02239 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2404.02239 | https://arxiv.org/pdf/2404.02239 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | A Learned Proximal - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A Learned Proximal/a_learned_proximal_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Curriculum Proximal - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Curriculum Proximal/curriculum_proximal_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Mission schedule of agile - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Mission schedule of agile/mission_schedule_of_agile_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P484` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liang, Jiaming; Chen, Yongxin. Submitted/source date: 2024/04/02. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P484`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We consider convex optimization with non-smooth objective function and log-concave sampling with non-smooth potential (negative log density). In …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We consider convex optimization with non-smooth objective function and log-concave sampling with non-smooth potential (negative log density). In …” | Author-reported results | Medium | Measurements were not reproduced |
...
This paper studies optimization, oracles, proximal. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around optimization, oracles, proximal. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We consider convex optimization with non-smooth objective function and log-concave sampling with non-smooth potential (negative log density). In …”. The full-paper rendering contains 65 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving optimization, oracles, proximal. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 58,424 of 75,964 units; duplicate exclusions 46; focus exclusions 131; source-gate exclusions 13; reselections 190.
...
|---|---|---|---|
| A Learned Proximal - DEP-E | Related DEP | Overlap: proximal, optimization | `.lake-data/DEP-E/DEP-E-20260819-A Learned Proximal/a_learned_proximal_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2404.02239 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2404.02239 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2404.02239 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-A Learned Proximal/a_learned_proximal_manuscript.md` | Related synthesis: proximal, optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Curriculum Proximal/curriculum_proximal_manuscript.md` | Related synthesis: proximal, optimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Mission schedule of agile/mission_schedule_of_agile_manuscript.md` | Related synthesis: proximal, optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 58,424 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 46; focus exclusions: 131; source-gate exclusions: 13; reselections: 190; 24-hour cutoff: 2026-08-18.
