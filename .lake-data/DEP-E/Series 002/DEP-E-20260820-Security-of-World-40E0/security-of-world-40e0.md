...
primary_subject: "Source-grounded review of Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation"
...
primary_url: "https://arxiv.org/abs/2607.28226"
stable_identifier: "arXiv:2607.28226"
...
|---|---|---|---|---|---|---|---|---|
| S1 | Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation | Primary research artifact | arXiv HTML and Atom metadata | arXiv:2607.28226 | https://arxiv.org/abs/2607.28226; https://arxiv.org/html/2607.28226 | Public research source; no source file redistributed | 2026-08-20 | Inspected |
| S2 | Selected source DEP | Provenance and deposited finding | Markdown | DEP-20260731-Tech Intel 1111 | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201111 | Repository evidence; no source file copied | 2026-08-20 | Inspected |
| S3 | Latest prior Report-Mark | Iterative-expansion context | Markdown | Black-Lake-Data/.lake-data/DEP-20260731-Tech Intel 1111/BL-DEP-Mark001 Report-Mark.md | Black-Lake-Data/.lake-data/DEP-20260731-Tech Intel 1111/BL-DEP-Mark001 Report-Mark.md | Repository evidence | 2026-08-20 | Inspected |

The selected DEP contains 3 inspected Markdown file(s) and no newly collected source payload. The primary publication date recorded by official metadata is `2026-07-30T13:58:33Z`. Prior material was detected. The latest Report-Mark was reviewed first, and one research thread was selected from its related-reading/source-reference pool using cryptographic rejection sampling. The chosen thread was `https://arxiv.org/abs/2607.28226`; inaccessible candidates, if any, are recorded in the artifact log.
...
This DEP-E artifact reviews *Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation*, attributed to Fazhong Liu; Zhuoyan Chen; Haozhen Tan; Yan Meng; Guoxing Chen; Haojin Zhu. The selected source DEP characterizes the work as a current research claim and summarizes it as follows: MIND addresses memory-injection attacks against memory-augmented LLM agents. It uses an intent-aware information bottleneck to extract compact intent-behavior representations across turns, preserving attack signals while reducing redundant context and avoiding repeated LLM audits. On ReAct-StrategyQA, the paper reports mean attack-success reductions of about 55% while maintaining average accuracy and latency. [E1, E3]. Official arXiv metadata and full HTML were inspected, while no source file, dataset, code repository, model, or execution trace was collected.
...
Reviewer interpretation: Prior Black Lake runs identified memory poisoning as a practical agent risk; this source adds a defense mechanism that is explicitly designed for multi-turn memory contexts. It is relevant to agent harnesses that need lightweight pre-action memory checks without making every turn depend on expensive model review. This is a reason to prioritize structured evaluation, not a basis for production, clinical, security, procurement, or policy decisions without the independent checks listed below.

## Detailed Summary

### Problem and contribution

The primary source addresses the research object identified by its canonical title, *Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation*. The source DEP preserves the following concise account: MIND addresses memory-injection attacks against memory-augmented LLM agents. It uses an intent-aware information bottleneck to extract compact intent-behavior representations across turns, preserving attack signals while reducing redundant context and avoiding repeated LLM audits. On ReAct-StrategyQA, the paper reports mean attack-success reductions of about 55% while maintaining average accuracy and latency. [E1, E3]. This artifact treats that account as a source-reported claim rather than an independently established fact.
...
- Sources inspected: Every Markdown file in `Black-Lake-Data/.lake-data/DEP-20260731-Tech Intel 1111`, the canonical primary record, official metadata, and full HTML when accessible; the latest Report-Mark was also inspected for iterative passes.
...
|---|---|---|---|
| Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation | Primary research thread | New in this pass; randomly selected from the latest Report-Mark research pool and inspected as the primary expansion thread. | https://arxiv.org/abs/2607.28226 |
| Official full-text representation | Primary source format | Full HTML used to locate abstract, methodology, evaluation, limitations, and conclusion evidence where available. | https://arxiv.org/html/2607.28226 |
| Selected source DEP | Provenance record | Preserves the deposited finding, source inventory, and explicit non-reproduction boundary. | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201111 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | http://pattrn.ai/research/infoopsbench |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://aka.ms/echoverse |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2607.28069 |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2607.28226 | Canonical title, authors, abstract, identifier, and source status | 2026-08-20 | Primary record inspected |
| R2 | https://arxiv.org/html/2607.28226 | Full-text section structure, method/evaluation trace, limitations, and conclusion | 2026-08-20 | Full HTML inspected |
| R3 | https://export.arxiv.org/api/query?id_list=2607.28226 | Canonical Atom metadata and abstract | 2026-08-20 | Official arXiv API inspected |
| R4 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201111/BL-DEP-Mark001%20Report-Mark.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
| R5 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201111/daily_research_findings_2026-07-31_1111.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
| R6 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201111/README.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
...
- Selection order: 138 of 200
- Cryptographic draw: `1707788628` accepted on attempt 1, rejection limit `4294966624`, zero-based index `82` from a pool of 881.
...
- `Black-Lake-Data/.lake-data/DEP-20260731-Tech Intel 1111/BL-DEP-Mark001 Report-Mark.md` - inspected repository file
- `Black-Lake-Data/.lake-data/DEP-20260731-Tech Intel 1111/daily_research_findings_2026-07-31_1111.md` - inspected repository file
- `Black-Lake-Data/.lake-data/DEP-20260731-Tech Intel 1111/README.md` - inspected repository file
