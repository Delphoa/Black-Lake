---
title: "OpenRCA 2 0 From Outcome - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "OpenRCA 2.0: From Outcome Labels to Causal Process Supervision"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260628-Tech Intel 1103"
selection_record: "117 candidates; 17 excluded; 100 eligible; draw 312084108; zero-based index 8"
expansion_record: "31 retained public locators; draw 3788164626; zero-based index 28"
...
# OpenRCA 2 0 From Outcome - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260628-Tech Intel 1103 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260628-Tech%20Intel%201103/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-06-28_1103.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260628-Tech%20Intel%201103/daily_research_findings_2026-06-28_1103.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | OpenRCA 2.0: From Outcome Labels to Causal Process Supervision | Selected supporting source | arXiv record | 2606.27154 | https://arxiv.org/abs/2606.27154v2 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |
| S4 | Prior Report-Mark | Lineage context | Markdown | BL-DEP-Mark001 Report-Mark.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260628-Tech%20Intel%201103/BL-DEP-Mark001%20Report-Mark.md | Prior review context | 2026-08-19 | Inspected |

- Paper/work title: OpenRCA 2.0: From Outcome Labels to Causal Process Supervision
- Authors or producing organization: Aoyang Fang; Yifan Yang; Jin'ao Shang; Qisheng Lu; Junjielung Xu; Rui Wang; Songhan Zhang; Yuzhong Zhang; Boxi Yu; Pinjia He
- Source platform: arXiv
- Publication date: 2026-06-25
- Revision/version date: 2026-06-30
- Stable identifier: 2606.27154
- Categories: cs.AI
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260628-Tech%20Intel%201103/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260628-Tech%20Intel%201103/daily_research_findings_2026-06-28_1103.md | Deposited source synthesis | ** Chai uses AI-driven differential testing to discover and validate cryptographic misuse vulnerabilities across X.509, JWT, and SAML libraries, then propagates library-level findings through dependency graphs to identify downstream risk. The authors report a previously unknown critical SSL-library vulnerability affecting billions of devices, browser- and Linux-distribution-relevant bugs, and more than 100 total vulnerabilities surfaced. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2606.27154v2 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |
| E4 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260628-Tech%20Intel%201103/BL-DEP-Mark001%20Report-Mark.md | Prior Report-Mark | Earlier review lineage and preserved references | Iterative-expansion context | Medium-high | Prior interpretation was not treated as fresh primary evidence. |

## Executive Summary

This artifact expands the selected DEP through OpenRCA 2.0: From Outcome Labels to Causal Process Supervision. The deposited source package reports that ** Chai uses AI-driven differential testing to discover and validate cryptographic misuse vulnerabilities across X.509, JWT, and SAML libraries, then propagates library-level findings through dependency graphs to identify downstream risk. The authors report a previously unknown critical SSL-library vulnerability affecting billions of devices, browser- and Linux-distribution-relevant bugs, and more than 100 total vulnerabilities surfaced. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** This is a concrete step from AI-assisted bug finding toward agentic vulnerability discovery in bug classes that lack simple crash or sanitizer signals. It is directly relevant to software supply-chain defense, cryptographic dependency governance, and AI-enabled offensive/defensive security tooling. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** This is a concrete step from AI-assisted bug finding toward agentic vulnerability discovery in bug classes that lack simple crash or sanitizer signals. It is directly relevant to software supply-chain defense, cryptographic dependency governance, and AI-enabled offensive/defensive security tooling.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** Chai uses AI-driven differential testing to discover and validate cryptographic misuse vulnerabilities across X.509, JWT, and SAML libraries, then propagates library-level findings through dependency graphs to identify downstream risk. The authors report a previously unknown critical SSL-library vulnerability affecting billions of devices, browser- and Linux-distribution-relevant bugs, and more than 100 total vulnerabilities surfaced. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is OpenRCA 2.0: From Outcome Labels to Causal Process Supervision, credited to Aoyang Fang; Yifan Yang; Jin'ao Shang; Qisheng Lu; Junjielung Xu; Rui Wang; Songhan Zhang; Yuzhong Zhang; Boxi Yu; Pinjia He. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** This is a concrete step from AI-assisted bug finding toward agentic vulnerability discovery in bug classes that lack simple crash or sanitizer signals. It is directly relevant to software supply-chain defense, cryptographic dependency governance, and AI-enabled offensive/defensive security tooling. | Reviewer interpretation grounded in source package | E1-E3, E4 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260628-Tech Intel 1103 as a schema-complete DEP-E research artifact.
...
### New in this pass: OpenRCA 2.0: From Outcome Labels to Causal Process Supervision

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [OpenRCA 2.0: From Outcome Labels to Causal Process Supervision](https://arxiv.org/abs/2606.27154v2) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://arxiv.org/abs/2606.26933 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://doi.org/10.48550/arXiv.2606.26933 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/pdf/2606.26933 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2606.27027 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://doi.org/10.48550/arXiv.2606.27027 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260628-Tech%20Intel%201103/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260628-Tech%20Intel%201103/daily_research_findings_2026-06-28_1103.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2606.27154v2 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
| R4 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260628-Tech%20Intel%201103/BL-DEP-Mark001%20Report-Mark.md | E4 and prior review lineage | 2026-08-19 | Prior Report-Mark inspected for iterative context. |
...
- Batch item: 16 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 17; eligible count 100.
- DEP draw: accepted UInt32 312084108; rejection limit 4294967200; attempts 1; zero-based index 8.
- Supporting draw: pool 31; accepted UInt32 3788164626; rejection limit 4294967292; attempts 1; zero-based index 28.
