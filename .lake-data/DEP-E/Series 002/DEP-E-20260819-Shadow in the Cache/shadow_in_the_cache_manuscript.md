---
title: "Shadow in the Cache - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Shadow in the Cache: Unveiling and Mitigating Privacy Risks of KV-cache in LLM Inference."
...
primary_url: "https://arxiv.org/abs/2508.09442"
stable_identifier: "arXiv:2508.09442; DOI:10.48550/arXiv.2508.09442"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P131"
...
# Shadow in the Cache - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2508.09442 | https://arxiv.org/abs/2508.09442 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2508.09442 rendering | https://arxiv.org/html/2508.09442 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2508.09442 | https://arxiv.org/pdf/2508.09442 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | KSHSeek Data-Driven Approaches t - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-KSHSeek Data-Driven Appro/kshseek_data_driven_appro_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | A Hierarchical Gradient - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A Hierarchical Gradient/a_hierarchical_gradient_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P131` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Luo, Zhifan; Shao, Shuo; Zhang, Su; Zhou, Lijing; Hu, Yuke; Zhao, Chenxu; Liu, Zhihao; Qin, Zhan. Submitted/source date: 2025/08/13. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P131`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The Key-Value (KV) cache, which stores intermediate attention computations (Key and Value pairs) to avoid redundant calculations, is …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The Key-Value (KV) cache, which stores intermediate attention computations (Key and Value pairs) to avoid redundant calculations, is …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: cache, mitigating, privacy, unveiling | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies cache, inference, kv-cache. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around cache, inference, kv-cache. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The Key-Value (KV) cache, which stores intermediate attention computations (Key and Value pairs) to avoid redundant calculations, is …”. The full-paper rendering contains 114 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The Key-Value (KV) cache, which stores intermediate attention computations (Key and Value pairs) to avoid redundant calculations, is …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The Key-Value (KV) cache, which stores intermediate attention computations (Key and Value pairs) to avoid redundant calculations, is …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving cache, inference, kv-cache. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 68,862 of 75,964 units; duplicate exclusions 1; focus exclusions 13; source-gate exclusions 0; reselections 14.
...
- The related DEPs show how cache, mitigating, privacy, unveiling connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: cache, mitigating, privacy, unveiling.
...
|---|---|---|---|
| KSHSeek Data-Driven Approaches t - DEP-E | Related DEP | Overlap: mitigating, privacy, cache | `.lake-data/DEP-E/DEP-E-20260723-KSHSeek Data-Driven Appro/kshseek_data_driven_appro_manuscript.md` |
| A Hierarchical Gradient - DEP-E | Related DEP | Overlap: mitigating, privacy, cache | `.lake-data/DEP-E/DEP-E-20260819-A Hierarchical Gradient/a_hierarchical_gradient_manuscript.md` |
| Unveiling the Lexical Sensitivit - DEP-E | Related DEP | Overlap: unveiling, privacy, cache | `.lake-data/DEP-E/DEP-E-20260723-Unveiling the Lexical Sen/unveiling_the_lexical_sen_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2508.09442 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2508.09442 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2508.09442 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260723-KSHSeek Data-Driven Appro/kshseek_data_driven_appro_manuscript.md` | Related synthesis: mitigating, privacy, cache | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-A Hierarchical Gradient/a_hierarchical_gradient_manuscript.md` | Related synthesis: mitigating, privacy, cache | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260723-Unveiling the Lexical Sen/unveiling_the_lexical_sen_manuscript.md` | Related synthesis: unveiling, privacy, cache | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 68,862 of 75,964 units from 75,967 PDFs.
