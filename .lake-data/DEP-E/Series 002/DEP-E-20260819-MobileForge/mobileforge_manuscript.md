---
title: "MobileForge - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of MobileForge: Annotation-Free Adaptation for Mobile GUI Agents with Hierarchical Feedback-Guided Policy Optimization."
...
primary_url: "https://arxiv.org/abs/2606.19930"
stable_identifier: "arXiv:2606.19930; DOI:10.48550/arXiv.2606.19930"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P480"
...
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2606.19930 | https://arxiv.org/abs/2606.19930 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2606.19930 rendering | https://arxiv.org/html/2606.19930 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2606.19930 | https://arxiv.org/pdf/2606.19930 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | How Mobile World Model - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-How Mobile World Model/how_mobile_world_model_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Building Autonomous GUI - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Building Autonomous GUI/building_autonomous_gui_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P480` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Guangyi; Zhao, Pengxiang; Wu, Gao; Yin, Yiwen; Li, Mading; Liu, Liang; Liu, Congxiao; Qi, Zhang; Wang, Mengyan; Guo, Liang; Zhang, Jiangning; Liu, Yong. Submitted/source date: 2026/06/18. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P480`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “(1) We identify two bottlenecks in annotation-free mobile GUI adaptation: the lack of a unified target-app interaction and …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “MLLM-based mobile GUI agents have made substantial progress in UI understanding and action execution, but adapting them to …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: agents, gui, mobile, optimization, policy | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies adaptation, agents, annotation-free. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around adaptation, agents, annotation-free. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “(1) We identify two bottlenecks in annotation-free mobile GUI adaptation: the lack of a unified target-app interaction and …”. The full-paper rendering contains 120 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “MLLM-based mobile GUI agents have made substantial progress in UI understanding and action execution, but adapting them to …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “MLLM-based mobile GUI agents have made substantial progress in UI understanding and action execution [ 8 , 58 …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving adaptation, agents, annotation-free. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 57,762 of 75,964 units; duplicate exclusions 5; focus exclusions 8; source-gate exclusions 0; reselections 13.
...
- The related DEPs show how agents, gui, mobile, optimization, policy connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: agents, gui, mobile, optimization, policy.
...
|---|---|---|---|
| How Mobile World Model - DEP-E | Related DEP | Overlap: gui, mobile, agents, policy | `.lake-data/DEP-E/DEP-E-20260819-How Mobile World Model/how_mobile_world_model_manuscript.md` |
| ARPO End-to-End Policy - DEP-E | Related DEP | Overlap: gui, agents, policy, optimization | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` |
| Building Autonomous GUI - DEP-E | Related DEP | Overlap: gui, policy, optimization | `.lake-data/DEP-E/DEP-E-20260819-Building Autonomous GUI/building_autonomous_gui_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2606.19930 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2606.19930 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2606.19930 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-How Mobile World Model/how_mobile_world_model_manuscript.md` | Related synthesis: gui, mobile, agents, policy | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` | Related synthesis: gui, agents, policy, optimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Building Autonomous GUI/building_autonomous_gui_manuscript.md` | Related synthesis: gui, policy, optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 57,762 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 5; focus exclusions: 8; source-gate exclusions: 0; reselections: 13; 24-hour cutoff: 2026-08-18.
