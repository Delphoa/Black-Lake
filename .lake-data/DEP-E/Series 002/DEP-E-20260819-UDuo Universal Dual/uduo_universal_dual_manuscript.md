---
title: "UDuo Universal Dual - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of UDuo: Universal Dual Optimization Framework for Online Matching."
...
primary_url: "https://arxiv.org/abs/2505.22243"
stable_identifier: "arXiv:2505.22243; DOI:10.48550/arXiv.2505.22243"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P203"
...
# UDuo Universal Dual - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2505.22243 | https://arxiv.org/abs/2505.22243 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2505.22243 rendering | https://arxiv.org/html/2505.22243 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2505.22243 | https://arxiv.org/pdf/2505.22243 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Traceable Group-Wise - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Traceable Group-Wise/traceable_group_wise_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Payload trajectory - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Payload trajectory/payload_trajectory_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Boosting One-Point - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Boosting One-Point/boosting_one_point_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P203` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Li, Bin; Liu, Diwei; Hu, Zehong; Jia, Jia. Submitted/source date: 2025/05/28. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P203`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Online resource allocation under budget constraints critically depends on proper modeling of user arrival dynamics. Classical approaches employ …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Online resource allocation under budget constraints critically depends on proper modeling of user arrival dynamics. Classical approaches employ …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: dual, matching, online, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies dual, matching, online. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around dual, matching, online. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Online resource allocation under budget constraints critically depends on proper modeling of user arrival dynamics. Classical approaches employ …”. The full-paper rendering contains 49 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Online resource allocation under budget constraints critically depends on proper modeling of user arrival dynamics. Classical approaches employ …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Online resource allocation under budget constraints critically depends on proper modeling of user arrival dynamics. Classical approaches employ …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving dual, matching, online. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 15,763 of 75,964 units; duplicate exclusions 6; focus exclusions 18; source-gate exclusions 0; reselections 24.
...
- The related DEPs show how dual, matching, online, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: dual, matching, online, optimization.
...
|---|---|---|---|
| Traceable Group-Wise - DEP-E | Related DEP | Overlap: dual, optimization, matching | `.lake-data/DEP-E/DEP-E-20260819-Traceable Group-Wise/traceable_group_wise_manuscript.md` |
| Payload trajectory - DEP-E | Related DEP | Overlap: online, optimization, matching | `.lake-data/DEP-E/DEP-E-20260818-Payload trajectory/payload_trajectory_manuscript.md` |
| Boosting One-Point - DEP-E | Related DEP | Overlap: online, optimization, matching | `.lake-data/DEP-E/DEP-E-20260819-Boosting One-Point/boosting_one_point_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2505.22243 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2505.22243 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2505.22243 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Traceable Group-Wise/traceable_group_wise_manuscript.md` | Related synthesis: dual, optimization, matching | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Payload trajectory/payload_trajectory_manuscript.md` | Related synthesis: online, optimization, matching | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Boosting One-Point/boosting_one_point_manuscript.md` | Related synthesis: online, optimization, matching | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 15,763 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 6; focus exclusions: 18; source-gate exclusions: 0; reselections: 24; 24-hour cutoff: 2026-08-18.
