---
title: "ICAE Bench Evaluating - DEP-E"
generated_at: "2026-08-19T22:59:33Z"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of ICAE-Bench: Evaluating Coding Agents as Interactive Project Builders"
...
primary_url: "https://arxiv.org/abs/2607.21217"
stable_identifier: "arXiv:2607.21217"
...
# ICAE Bench Evaluating - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Repository-relative path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | ICAE-Bench: Evaluating Coding Agents as Interactive Project Builders | Primary research artifact | arXiv HTML and Atom metadata | arXiv:2607.21217 | https://arxiv.org/abs/2607.21217; https://arxiv.org/html/2607.21217 | Public research source; no source file redistributed | 2026-08-20 | Inspected |
| S2 | Selected source DEP | Provenance and deposited finding | Markdown | DEP-20260726-Tech Intel 1302 | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260726-Tech%20Intel%201302 | Repository evidence; no source file copied | 2026-08-20 | Inspected |
| S3 | Latest prior Report-Mark | Iterative-expansion context | Markdown | Black-Lake-Data/.lake-data/DEP-20260726-Tech Intel 1302/BL-DEP-Mark001 Report-Mark.md | Black-Lake-Data/.lake-data/DEP-20260726-Tech Intel 1302/BL-DEP-Mark001 Report-Mark.md | Repository evidence | 2026-08-20 | Inspected |

The selected DEP contains 3 inspected Markdown file(s) and no newly collected source payload. The primary publication date recorded by official metadata is `2026-07-23T11:31:38Z`. Prior material was detected. The latest Report-Mark was reviewed first, and one research thread was selected from its related-reading/source-reference pool using cryptographic rejection sampling. The chosen thread was `https://arxiv.org/abs/2607.21217`; inaccessible candidates, if any, are recorded in the artifact log.
...
This DEP-E artifact reviews *ICAE-Bench: Evaluating Coding Agents as Interactive Project Builders*, attributed to Zhongyuan Peng; Dan Huang; Chuyu Zhang; et al. The selected source DEP characterizes the work as a current research claim and summarizes it as follows: This paper argues that deterministic top-k KV-cache eviction cannot consistently estimate what was lost, because evicted values can change the true attention error while retained state stays identical. It proposes Poisson-sampled tail retention with known inclusion probabilities, a Hajek-style correction inside softmax, and a survey-sampling variance estimator that functions as a per-step cache-error certificate. The reported surviving value is attribution: certificates separate cache-induced failures from inherent failures better than output confidence. - **Why it matters:** Long-context serving needs memory reduction that is not just cheaper but auditable. This result is directly relevant to context compression, KV-cache governance, and failure triage in large-scale inference systems. - **Relevance tags:** #kv-cache #long-context #ml-systems #inference-serving #evaluation - **Source type:** arXiv preprint; primary scholarly source. - **Source references:** https://arxiv.org/abs/2607.21475 [E1, E3]. Official arXiv metadata and full HTML were inspected, while no source file, dataset, code repository, model, or execution trace was collected.
...
Reviewer interpretation: Long-context serving needs memory reduction that is not just cheaper but auditable. This result is directly relevant to context compression, KV-cache governance, and failure triage in large-scale inference systems. - **Relevance tags:** #kv-cache #long-context #ml-systems #inference-serving #evaluation - **Source type:** arXiv preprint; primary scholarly source. - **Source references:** https://arxiv.org/abs/2607.21475 This is a reason to prioritize structured evaluation, not a basis for production, clinical, security, procurement, or policy decisions without the independent checks listed below.

## Detailed Summary

### Problem and contribution

The primary source addresses the research object identified by its canonical title, *ICAE-Bench: Evaluating Coding Agents as Interactive Project Builders*. The source DEP preserves the following concise account: This paper argues that deterministic top-k KV-cache eviction cannot consistently estimate what was lost, because evicted values can change the true attention error while retained state stays identical. It proposes Poisson-sampled tail retention with known inclusion probabilities, a Hajek-style correction inside softmax, and a survey-sampling variance estimator that functions as a per-step cache-error certificate. The reported surviving value is attribution: certificates separate cache-induced failures from inherent failures better than output confidence. - **Why it matters:** Long-context serving needs memory reduction that is not just cheaper but auditable. This result is directly relevant to context compression, KV-cache governance, and failure triage in large-scale inference systems. - **Relevance tags:** #kv-cache #long-context #ml-systems #inference-serving #evaluation - **Source type:** arXiv preprint; primary scholarly source. - **Source references:** https://arxiv.org/abs/2607.21475 [E1, E3]. This artifact treats that account as a source-reported claim rather than an independently established fact.
...
- Sources inspected: Every Markdown file in `Black-Lake-Data/.lake-data/DEP-20260726-Tech Intel 1302`, the canonical primary record, official metadata, and full HTML when accessible; the latest Report-Mark was also inspected for iterative passes.
...
|---|---|---|---|
| ICAE-Bench: Evaluating Coding Agents as Interactive Project Builders | Primary research thread | New in this pass; randomly selected from the latest Report-Mark research pool and inspected as the primary expansion thread. | https://arxiv.org/abs/2607.21217 |
| Official full-text representation | Primary source format | Full HTML used to locate abstract, methodology, evaluation, limitations, and conclusion evidence where available. | https://arxiv.org/html/2607.21217 |
| Selected source DEP | Provenance record | Preserves the deposited finding, source inventory, and explicit non-reproduction boundary. | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260726-Tech%20Intel%201302 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2607.21325 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2607.21403 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2607.21412 |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2607.21217 | Canonical title, authors, abstract, identifier, and source status | 2026-08-20 | Primary record inspected |
| R2 | https://arxiv.org/html/2607.21217 | Full-text section structure, method/evaluation trace, limitations, and conclusion | 2026-08-20 | Full HTML inspected |
| R3 | https://export.arxiv.org/api/query?id_list=2607.21217 | Canonical Atom metadata and abstract | 2026-08-20 | Official arXiv API inspected |
| R4 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260726-Tech%20Intel%201302/BL-DEP-Mark001%20Report-Mark.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
| R5 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260726-Tech%20Intel%201302/daily_research_findings_2026-07-26_1302.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
| R6 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260726-Tech%20Intel%201302/README.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
...
- Selection order: 164 of 200
- Cryptographic draw: `3275175041` accepted on attempt 1, rejection limit `4294966815`, zero-based index `71` from a pool of 855.
...
- `Black-Lake-Data/.lake-data/DEP-20260726-Tech Intel 1302/BL-DEP-Mark001 Report-Mark.md` - inspected repository file
- `Black-Lake-Data/.lake-data/DEP-20260726-Tech Intel 1302/daily_research_findings_2026-07-26_1302.md` - inspected repository file
- `Black-Lake-Data/.lake-data/DEP-20260726-Tech Intel 1302/README.md` - inspected repository file
