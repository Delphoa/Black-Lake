---
title: "Optimization of - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Optimization of Fast-Decodable Full-Rate STBC with Non-Vanishing Determinants."
...
primary_url: "https://arxiv.org/abs/1103.2573"
stable_identifier: "arXiv:1103.2573; DOI:10.1109/TCOMM.2011.050911.090148"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P155"
...
# Optimization of - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1103.2573 | https://arxiv.org/abs/1103.2573 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1103.2573 rendering | https://arxiv.org/html/1103.2573 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1103.2573 | https://arxiv.org/pdf/1103.2573 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P155` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Ren, Tian Peng; Guan, Yong Liang; Yuen, Chau; Zhou, Yue; Zhang, Er Yang. Submitted/source date: 2011/03/14. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P155`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Although the code X in ( 2 ) with M M -PSK constellations has vanishing determinant, the code …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Firstly, we show the ML bit error rate (BER) performances of the proposed code X in ( 2 …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies determinants, fast-decodable, full-rate. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around determinants, fast-decodable, full-rate. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Although the code X in ( 2 ) with M M -PSK constellations has vanishing determinant, the code …”. The full-paper rendering contains 36 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Firstly, we show the ML bit error rate (BER) performances of the proposed code X in ( 2 …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Remark : The method of proof in this paper, specifically Case I and Case II , are presented …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving determinants, fast-decodable, full-rate. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 2,029 of 75,964 units; duplicate exclusions 0; focus exclusions 11; source-gate exclusions 0; reselections 11.
...
- The related DEPs show how optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: optimization.
...
| Provably Faster Algorithms for B - DEP-E | Related DEP | Overlap: optimization | `.lake-data/DEP-E/DEP-E-20260723-Provably Faster Algorithm/provably_faster_algorithm_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1103.2573 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1103.2573 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1103.2573 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260715-Joint Sensing MEC/joint_sensing_mec_manuscript.md` | Related synthesis: optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260723-COEVO Co-Evolutionary Fra/coevo_co_evolutionary_fra_manuscript.md` | Related synthesis: optimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260723-Provably Faster Algorithm/provably_faster_algorithm_manuscript.md` | Related synthesis: optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 2,029 of 75,964 units from 75,967 PDFs.
