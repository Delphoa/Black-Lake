---
title: "UAV s Rotor Micro-Doppler - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of UAV's Rotor Micro-Doppler Feature Extraction Using Integrated Sensing and Communication Signal: Algorithm Design and Testbed Evaluation."
...
primary_url: "https://arxiv.org/abs/2408.16415"
stable_identifier: "arXiv:2408.16415; DOI:10.1109/TWC.2025.3578033"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P334"
...
# UAV s Rotor Micro-Doppler - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2408.16415 | https://arxiv.org/abs/2408.16415 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2408.16415 rendering | https://arxiv.org/html/2408.16415 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2408.16415 | https://arxiv.org/pdf/2408.16415 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Joint Pilot Optimization - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Joint Pilot Optimization/joint_pilot_optimization_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Multi-Modal UAV Detection - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Multi-Modal UAV Detection/multi_modal_uav_detection_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P334` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wei, Jiachen; Ma, Dingyou; He, Feiyang; Zhang, Qixun; Feng, Zhiyong; Liu, Zhengfeng; Liang, Taohong. Submitted/source date: 2024/08/29. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P334`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “With the rapid application of uav in urban areas, the identification and tracking of hovering UAVs have become …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “With the rapid application of uav in urban areas, the identification and tracking of hovering UAVs have become …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, communication, design, extraction, integrated | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, communication, design. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, communication, design. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “With the rapid application of uav in urban areas, the identification and tracking of hovering UAVs have become …”. The full-paper rendering contains 50 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “With the rapid application of uav in urban areas, the identification and tracking of hovering UAVs have become …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “With the rapid application of uav in urban areas, the identification and tracking of hovering UAVs have become …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, communication, design. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 74,399 of 75,964 units; duplicate exclusions 0; focus exclusions 1; source-gate exclusions 0; reselections 1.
...
- The related DEPs show how algorithm, communication, design, extraction, integrated connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, communication, design, extraction, integrated.
...
|---|---|---|---|
| Multi-Point ISAC - DEP-E | Related DEP | Overlap: integrated, communication, sensing, signal, algorithm | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` |
| Joint Pilot Optimization - DEP-E | Related DEP | Overlap: integrated, communication, sensing, algorithm, design | `.lake-data/DEP-E/DEP-E-20260819-Joint Pilot Optimization/joint_pilot_optimization_manuscript.md` |
| Multi-Modal UAV Detection - DEP-E | Related DEP | Overlap: uav, algorithm, design, extraction | `.lake-data/DEP-E/DEP-E-20260819-Multi-Modal UAV Detection/multi_modal_uav_detection_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2408.16415 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2408.16415 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2408.16415 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Related synthesis: integrated, communication, sensing, signal, algorithm | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Joint Pilot Optimization/joint_pilot_optimization_manuscript.md` | Related synthesis: integrated, communication, sensing, algorithm, design | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Multi-Modal UAV Detection/multi_modal_uav_detection_manuscript.md` | Related synthesis: uav, algorithm, design, extraction | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 74,399 of 75,964 units from 75,967 PDFs.
