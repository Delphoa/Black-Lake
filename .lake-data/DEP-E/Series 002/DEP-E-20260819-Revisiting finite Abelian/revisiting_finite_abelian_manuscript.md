---
title: "Revisiting finite Abelian - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Revisiting finite Abelian hidden subgroup problem and its distributed exact quantum algorithm."
...
primary_url: "https://arxiv.org/abs/2512.22959"
stable_identifier: "arXiv:2512.22959; DOI:10.48550/arXiv.2512.22959"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P356"
...
# Revisiting finite Abelian - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2512.22959 | https://arxiv.org/abs/2512.22959 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2512.22959 rendering | https://arxiv.org/html/2512.22959 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2512.22959 | https://arxiv.org/pdf/2512.22959 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Distributed Quantum - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Distributed Quantum/distributed_quantum_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | An Improved Quantum - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-An Improved Quantum/an_improved_quantum_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Remarks on Quantum - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Remarks on Quantum/remarks_on_quantum_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P356` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Dong, Ziyuan; Fan, Xiang; Zhong, Tengxun; Qiu, Daowen. Submitted/source date: 2025/12/28. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P356`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We revisit the finite Abelian hidden subgroup problem (AHSP) from a mathematical perspective and make the following contributions. …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In this paper, we first present the iteration count for achieving success probability 1 − ϵ 1-\epsilon in …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, distributed, its, problem, quantum | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies abelian, algorithm, distributed. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around abelian, algorithm, distributed. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We revisit the finite Abelian hidden subgroup problem (AHSP) from a mathematical perspective and make the following contributions. …”. The full-paper rendering contains 97 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In this paper, we first present the iteration count for achieving success probability 1 − ϵ 1-\epsilon in …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “For finite Abelian hidden subgroup problem (AHSP), researchers have developed a relatively mature research framework, in which quantum …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving abelian, algorithm, distributed. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 38,688 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how algorithm, distributed, its, problem, quantum connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, distributed, its, problem, quantum.
...
|---|---|---|---|
| Distributed Quantum - DEP-E | Related DEP | Overlap: quantum, distributed, algorithm, its, problem | `.lake-data/DEP-E/DEP-E-20260819-Distributed Quantum/distributed_quantum_manuscript.md` |
| An Improved Quantum - DEP-E | Related DEP | Overlap: quantum, algorithm, distributed, its, problem | `.lake-data/DEP-E/DEP-E-20260819-An Improved Quantum/an_improved_quantum_manuscript.md` |
| Remarks on Quantum - DEP-E | Related DEP | Overlap: quantum, algorithm, distributed, its, problem | `.lake-data/DEP-E/DEP-E-20260819-Remarks on Quantum/remarks_on_quantum_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2512.22959 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2512.22959 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2512.22959 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Distributed Quantum/distributed_quantum_manuscript.md` | Related synthesis: quantum, distributed, algorithm, its, problem | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-An Improved Quantum/an_improved_quantum_manuscript.md` | Related synthesis: quantum, algorithm, distributed, its, problem | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Remarks on Quantum/remarks_on_quantum_manuscript.md` | Related synthesis: quantum, algorithm, distributed, its, problem | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 38,688 of 75,964 units from 75,967 PDFs.
