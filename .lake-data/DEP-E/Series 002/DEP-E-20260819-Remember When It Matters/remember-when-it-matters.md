---
title: "Remember When It Matters - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260710-Tech Intel 1104"
selection_record: "117 candidates; 21 excluded; 96 eligible; draw 2128485055; zero-based index 31"
expansion_record: "20 retained public locators; draw 4223400007; zero-based index 7"
...
# Remember When It Matters - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260710-Tech Intel 1104 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260710-Tech%20Intel%201104/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-10_1104.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260710-Tech%20Intel%201104/daily_research_findings_2026-07-10_1104.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents | Selected supporting source | arXiv record | 2607.08716 | https://arxiv.org/abs/2607.08716v1 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents
- Authors or producing organization: Yifan Wu; Lizhu Zhang; Yuhang Zhou; Mingyi Wang; Bo Peng; Serena Li; Xiangjun Fan; Zhuokai Zhao
- Source platform: arXiv
- Publication date: 2026-07-09
- Revision/version date: 2026-07-09
- Stable identifier: 2607.08716
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260710-Tech%20Intel%201104/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260710-Tech%20Intel%201104/daily_research_findings_2026-07-10_1104.md | Deposited source synthesis | ** The paper defines "behavioral state decay" for long-horizon agents and introduces a separate memory agent that maintains a structured memory bank and selectively injects reminders into an unmodified action agent. On Terminal-Bench 2.0 and tau^2-Bench, the method reports pass@1 gains of +8.3 and +6.8 percentage points, with ablations favoring selective intervention over passive or always-on memory exposure. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2607.08716v1 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents. The deposited source package reports that ** The paper defines "behavioral state decay" for long-horizon agents and introduces a separate memory agent that maintains a structured memory bank and selectively injects reminders into an unmodified action agent. On Terminal-Bench 2.0 and tau^2-Bench, the method reports pass@1 gains of +8.3 and +6.8 percentage points, with ablations favoring selective intervention over passive or always-on memory exposure. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** This is directly relevant to agent memory architecture because it treats memory as an active control policy rather than a retrieval add-on, and it provides benchmark evidence for plug-in memory modules around frontier agents. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** This is directly relevant to agent memory architecture because it treats memory as an active control policy rather than a retrieval add-on, and it provides benchmark evidence for plug-in memory modules around frontier agents.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** The paper defines "behavioral state decay" for long-horizon agents and introduces a separate memory agent that maintains a structured memory bank and selectively injects reminders into an unmodified action agent. On Terminal-Bench 2.0 and tau^2-Bench, the method reports pass@1 gains of +8.3 and +6.8 percentage points, with ablations favoring selective intervention over passive or always-on memory exposure. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents, credited to Yifan Wu; Lizhu Zhang; Yuhang Zhou; Mingyi Wang; Bo Peng; Serena Li; Xiangjun Fan; Zhuokai Zhao. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** This is directly relevant to agent memory architecture because it treats memory as an active control policy rather than a retrieval add-on, and it provides benchmark evidence for plug-in memory modules around frontier agents. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260710-Tech Intel 1104 as a schema-complete DEP-E research artifact.
...
### New in this pass: Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents](https://arxiv.org/abs/2607.08716v1) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://doi.org/10.48550/arXiv.2607.08716 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.08740 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://doi.org/10.48550/arXiv.2607.08740 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.08284 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://doi.org/10.48550/arXiv.2607.08284 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260710-Tech%20Intel%201104/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260710-Tech%20Intel%201104/daily_research_findings_2026-07-10_1104.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2607.08716v1 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 20 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 21; eligible count 96.
- DEP draw: accepted UInt32 2128485055; rejection limit 4294967232; attempts 1; zero-based index 31.
- Supporting draw: pool 20; accepted UInt32 4223400007; rejection limit 4294967280; attempts 1; zero-based index 7.
