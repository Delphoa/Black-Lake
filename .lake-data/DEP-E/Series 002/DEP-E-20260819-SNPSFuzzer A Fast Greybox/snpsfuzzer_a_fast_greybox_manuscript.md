---
title: "SNPSFuzzer A Fast Greybox - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of SNPSFuzzer: A Fast Greybox Fuzzer for Stateful Network Protocols using Snapshots."
...
primary_url: "https://arxiv.org/abs/2202.03643"
stable_identifier: "arXiv:2202.03643; DOI:10.48550/arXiv.2202.03643"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P194"
...
# SNPSFuzzer A Fast Greybox - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2202.03643 | https://arxiv.org/abs/2202.03643 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2202.03643 rendering | https://arxiv.org/html/2202.03643 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2202.03643 | https://arxiv.org/pdf/2202.03643 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | FAST A Synergistic - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-FAST A Synergistic/fast_a_synergistic_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P194` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Li, Junqiang; Li, Senyi; Sun, Gang; Chen, Ting; Yu, Hongfang. Submitted/source date: 2022/02/08. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P194`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Greybox fuzzing has been widely used in stateless programs and has achieved great success. However, most state-of-the-art greybox …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Greybox fuzzing has been widely used in stateless programs and has achieved great success. However, most state-of-the-art greybox …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: fast, network, stateful | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies fast, fuzzer, greybox. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around fast, fuzzer, greybox. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Greybox fuzzing has been widely used in stateless programs and has achieved great success. However, most state-of-the-art greybox …”. The full-paper rendering contains 58 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Greybox fuzzing has been widely used in stateless programs and has achieved great success. However, most state-of-the-art greybox …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Greybox fuzzing has been widely used in stateless programs and has achieved great success. However, most state-of-the-art greybox …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving fast, fuzzer, greybox. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 29,933 of 75,964 units; duplicate exclusions 4; focus exclusions 28; source-gate exclusions 0; reselections 32.
...
- The related DEPs show how fast, network, stateful connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: fast, network, stateful.
...
|---|---|---|---|
| FAST A Synergistic - DEP-E | Related DEP | Overlap: fast, network, stateful | `.lake-data/DEP-E/DEP-E-20260819-FAST A Synergistic/fast_a_synergistic_manuscript.md` |
| PAC Confidence - DEP-E | Related DEP | Overlap: fast, network | `.lake-data/DEP-E/DEP-E-20260713-PAC Confidence/pac_confidence_manuscript.md` |
| Cooperative Training of - DEP-E | Related DEP | Overlap: fast, stateful | `.lake-data/DEP-E/DEP-E-20260819-Cooperative Training of/cooperative_training_of_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2202.03643 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2202.03643 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2202.03643 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-FAST A Synergistic/fast_a_synergistic_manuscript.md` | Related synthesis: fast, network, stateful | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260713-PAC Confidence/pac_confidence_manuscript.md` | Related synthesis: fast, network | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Cooperative Training of/cooperative_training_of_manuscript.md` | Related synthesis: fast, stateful | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 29,933 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 4; focus exclusions: 28; source-gate exclusions: 0; reselections: 32; 24-hour cutoff: 2026-08-18.
