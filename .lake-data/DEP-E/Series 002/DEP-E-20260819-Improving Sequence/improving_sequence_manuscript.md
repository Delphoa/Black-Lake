---
title: "Improving Sequence - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Improving Sequence Modeling Ability of Recurrent Neural Networks via Sememes."
...
primary_url: "https://arxiv.org/abs/1910.08910"
stable_identifier: "arXiv:1910.08910; DOI:10.1109/TASLP.2020.3012060"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P252"
...
# Improving Sequence - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1910.08910 | https://arxiv.org/abs/1910.08910 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1910.08910 rendering | https://arxiv.org/html/1910.08910 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1910.08910 | https://arxiv.org/pdf/1910.08910 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Quantum Recurrent Neural - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Quantum Recurrent Neural/quantum_recurrent_neural_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | On Multiplicative - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-On Multiplicative/on_multiplicative_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P252` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Qin, Yujia; Qi, Fanchao; Ouyang, Sicong; Liu, Zhiyuan; Yang, Cheng; Wang, Yasheng; Liu, Qun; Sun, Maosong. Submitted/source date: 2019/10/20. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P252`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Sememes, the minimum semantic units of human languages, have been successfully utilized in various natural language processing applications. …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Sememes, the minimum semantic units of human languages, have been successfully utilized in various natural language processing applications. …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: modeling, networks, neural, recurrent | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies ability, improving, modeling. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around ability, improving, modeling. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Sememes, the minimum semantic units of human languages, have been successfully utilized in various natural language processing applications. …”. The full-paper rendering contains 101 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Sememes, the minimum semantic units of human languages, have been successfully utilized in various natural language processing applications. …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Sememes, the minimum semantic units of human languages, have been successfully utilized in various natural language processing applications. …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving ability, improving, modeling. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 46,572 of 75,964 units; duplicate exclusions 0; focus exclusions 5; source-gate exclusions 0; reselections 5.
...
- The related DEPs show how modeling, networks, neural, recurrent connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: modeling, networks, neural, recurrent.
...
|---|---|---|---|
| Quantum Recurrent Neural - DEP-E | Related DEP | Overlap: recurrent, networks, neural, modeling | `.lake-data/DEP-E/DEP-E-20260819-Quantum Recurrent Neural/quantum_recurrent_neural_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1910.08910 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1910.08910 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1910.08910 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Quantum Recurrent Neural/quantum_recurrent_neural_manuscript.md` | Related synthesis: recurrent, networks, neural, modeling | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Effective Quantization/effective_quantization_manuscript.md` | Related synthesis: recurrent, networks, neural | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-On Multiplicative/on_multiplicative_manuscript.md` | Related synthesis: recurrent, networks, neural | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 46,572 of 75,964 units from 75,967 PDFs.
