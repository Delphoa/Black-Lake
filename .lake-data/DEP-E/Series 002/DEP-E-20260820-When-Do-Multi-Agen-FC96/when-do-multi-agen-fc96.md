---
title: "When Do Multi Agent - DEP-E"
generated_at: "2026-08-19T22:59:33Z"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of When Do Multi-Agent Systems Help? An Information Bottleneck Perspective"
...
primary_url: "https://arxiv.org/abs/2607.16133"
stable_identifier: "arXiv:2607.16133"
...
# When Do Multi Agent - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Repository-relative path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | When Do Multi-Agent Systems Help? An Information Bottleneck Perspective | Primary research artifact | arXiv HTML and Atom metadata | arXiv:2607.16133 | https://arxiv.org/abs/2607.16133; https://arxiv.org/html/2607.16133 | Public research source; no source file redistributed | 2026-08-20 | Inspected |
| S2 | Selected source DEP | Provenance and deposited finding | Markdown | DEP-20260721-Tech Intel 0102 | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260721-Tech%20Intel%200102 | Repository evidence; no source file copied | 2026-08-20 | Inspected |

The selected DEP contains 2 inspected Markdown file(s) and no newly collected source payload. The primary publication date recorded by official metadata is `2026-07-17T17:13:44Z`. No prior Report-Mark was present in the selected DEP, so this is an initial processing pass and no iterative supporting-document draw was required.
...
This DEP-E artifact reviews *When Do Multi-Agent Systems Help? An Information Bottleneck Perspective*, attributed to Wendi Yu; Lianhao Zhou; Xiangjue Dong; et al. The selected source DEP characterizes the work as a current research claim and summarizes it as follows: ToolSciVer gives a vision-language mode [E1, E3]. Official arXiv metadata and full HTML were inspected, while no source file, dataset, code repository, model, or execution trace was collected.
...
Reviewer interpretation: Local multi-agent prompt optimization can reduce data movement and manual prompt engineering for structured clinical extraction, while the prevalence-sensitive sensitivity result is a direct deployment warning. The study is not clinical validation and requires external cohorts, calibration, governance, and clinician review. This is a reason to prioritize structured evaluation, not a basis for production, clinical, security, procurement, or policy decisions without the independent checks listed below.

## Detailed Summary

### Problem and contribution

The primary source addresses the research object identified by its canonical title, *When Do Multi-Agent Systems Help? An Information Bottleneck Perspective*. The source DEP preserves the following concise account: ToolSciVer gives a vision-language mode [E1, E3]. This artifact treats that account as a source-reported claim rather than an independently established fact.
...
- Sources inspected: Every Markdown file in `Black-Lake-Data/.lake-data/DEP-20260721-Tech Intel 0102`, the canonical primary record, official metadata, and full HTML when accessible; the latest Report-Mark was also inspected for iterative passes.
...
|---|---|---|---|
| When Do Multi-Agent Systems Help? An Information Bottleneck Perspective | Primary research thread | Primary work selected from the source DEP and inspected in this pass. | https://arxiv.org/abs/2607.16133 |
| Official full-text representation | Primary source format | Full HTML used to locate abstract, methodology, evaluation, limitations, and conclusion evidence where available. | https://arxiv.org/html/2607.16133 |
| Selected source DEP | Provenance record | Preserves the deposited finding, source inventory, and explicit non-reproduction boundary. | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260721-Tech%20Intel%200102 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2505.18286 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2604.02460 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2607.12886 |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2607.16133 | Canonical title, authors, abstract, identifier, and source status | 2026-08-20 | Primary record inspected |
| R2 | https://arxiv.org/html/2607.16133 | Full-text section structure, method/evaluation trace, limitations, and conclusion | 2026-08-20 | Full HTML inspected |
| R3 | https://export.arxiv.org/api/query?id_list=2607.16133 | Canonical Atom metadata and abstract | 2026-08-20 | Official arXiv API inspected |
| R4 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260721-Tech%20Intel%200102/daily_research_findings_2026-07-21_0102.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
| R5 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260721-Tech%20Intel%200102/README.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
...
- Selection order: 4 of 200
- Cryptographic draw: `4148218793` accepted on attempt 1, rejection limit `4294966410`, zero-based index `68` from a pool of 1015.
...
- `Black-Lake-Data/.lake-data/DEP-20260721-Tech Intel 0102/daily_research_findings_2026-07-21_0102.md` - inspected repository file
- `Black-Lake-Data/.lake-data/DEP-20260721-Tech Intel 0102/README.md` - inspected repository file
