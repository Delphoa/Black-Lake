---
title: "Remarks on Quantum - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Remarks on Quantum Modular Exponentiation and Some Experimental Demonstrations of Shor's Algorithm."
...
primary_url: "https://arxiv.org/abs/1408.6252"
stable_identifier: "arXiv:1408.6252; DOI:10.48550/arXiv.1408.6252"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P273"
...
# Remarks on Quantum - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1408.6252 | https://arxiv.org/abs/1408.6252 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1408.6252 rendering | https://arxiv.org/html/1408.6252 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1408.6252 | https://arxiv.org/pdf/1408.6252 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Remarks on the - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260729-Remarks on the/remarks_on_the_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | An Improved Quantum - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-An Improved Quantum/an_improved_quantum_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P273` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Cao, Zhengjun; Cao, Zhenfu; Liu, Lihua. Submitted/source date: 2014/08/24. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P273`.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, demonstrations, experimental. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 1,286 of 75,964 units; duplicate exclusions 1; focus exclusions 5; source-gate exclusions 0; reselections 6.
...
- The related DEPs show how algorithm, quantum, remarks, shor, some connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, quantum, remarks, shor, some.
...
|---|---|---|---|
| Distributed Quantum - DEP-E | Related DEP | Overlap: quantum, algorithm, shor | `.lake-data/DEP-E/DEP-E-20260819-Distributed Quantum/distributed_quantum_manuscript.md` |
| Remarks on the - DEP-E | Related DEP | Overlap: remarks, some | `.lake-data/DEP-E/DEP-E-20260729-Remarks on the/remarks_on_the_manuscript.md` |
| An Improved Quantum - DEP-E | Related DEP | Overlap: quantum, algorithm | `.lake-data/DEP-E/DEP-E-20260819-An Improved Quantum/an_improved_quantum_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1408.6252 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1408.6252 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1408.6252 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Distributed Quantum/distributed_quantum_manuscript.md` | Related synthesis: quantum, algorithm, shor | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260729-Remarks on the/remarks_on_the_manuscript.md` | Related synthesis: remarks, some | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-An Improved Quantum/an_improved_quantum_manuscript.md` | Related synthesis: quantum, algorithm | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 1,286 of 75,964 units from 75,967 PDFs.
