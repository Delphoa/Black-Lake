---
title: "Kernel Taylor-Based Value - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Kernel Taylor-Based Value Function Approximation for Continuous-State Markov Decision Processes."
...
primary_url: "https://arxiv.org/abs/2006.02008"
stable_identifier: "arXiv:2006.02008; DOI:10.48550/arXiv.2006.02008"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P12"
...
# Kernel Taylor-Based Value - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2006.02008 | https://arxiv.org/abs/2006.02008 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2006.02008 rendering | https://arxiv.org/html/2006.02008 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2006.02008 | https://arxiv.org/pdf/2006.02008 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | CT-UCBVI Regret - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260731-CT-UCBVI Regret/ct_ucbvi_regret_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P12` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Xu, Junhong; Yin, Kai; Liu, Lantao. Submitted/source date: 2020/06/03. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P12`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We propose a principled kernel-based policy iteration algorithm to solve the continuous-state Markov Decision Processes (MDPs). In contrast …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We propose a principled kernel-based policy iteration algorithm to solve the continuous-state Markov Decision Processes (MDPs). In contrast …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: approximation, decision, markov, processes, value | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies approximation, continuous-state, decision. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around approximation, continuous-state, decision. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We propose a principled kernel-based policy iteration algorithm to solve the continuous-state Markov Decision Processes (MDPs). In contrast …”. The full-paper rendering contains 48 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We propose a principled kernel-based policy iteration algorithm to solve the continuous-state Markov Decision Processes (MDPs). In contrast …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “However, the discretization can be problematic. Specifically, if the discretization is low in resolution (i.e., large but few …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving approximation, continuous-state, decision. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 17,980 of 75,964 units; duplicate exclusions 1; focus exclusions 3; source-gate exclusions 0; reselections 4.
...
- The related DEPs show how approximation, decision, markov, processes, value connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: approximation, decision, markov, processes, value.
...
|---|---|---|---|
| CT-UCBVI Regret - DEP-E | Related DEP | Overlap: markov, processes, decision, approximation, value | `.lake-data/DEP-E/DEP-E-20260731-CT-UCBVI Regret/ct_ucbvi_regret_manuscript.md` |
| Learning Adversarial - DEP-E | Related DEP | Overlap: markov, processes, decision, value | `.lake-data/DEP-E/DEP-E-20260818-Learning Adversarial/learning_adversarial_manuscript.md` |
| Dynamic Service Migration - DEP-E | Related DEP | Overlap: markov, decision, value | `.lake-data/DEP-E/DEP-E-20260819-Dynamic Service Migration/dynamic_service_migration_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2006.02008 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2006.02008 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2006.02008 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260731-CT-UCBVI Regret/ct_ucbvi_regret_manuscript.md` | Related synthesis: markov, processes, decision, approximation, value | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Learning Adversarial/learning_adversarial_manuscript.md` | Related synthesis: markov, processes, decision, value | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Dynamic Service Migration/dynamic_service_migration_manuscript.md` | Related synthesis: markov, decision, value | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 17,980 of 75,964 units from 75,967 PDFs.
