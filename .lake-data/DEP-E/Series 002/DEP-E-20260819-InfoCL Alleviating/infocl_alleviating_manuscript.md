---
title: "InfoCL Alleviating - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of InfoCL: Alleviating Catastrophic Forgetting in Continual Text Classification from An Information Theoretic Perspective."
...
primary_url: "https://arxiv.org/abs/2310.06362"
stable_identifier: "arXiv:2310.06362; DOI:10.48550/arXiv.2310.06362"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P233"
...
# InfoCL Alleviating - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2310.06362 | https://arxiv.org/abs/2310.06362 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2310.06362 rendering | https://arxiv.org/html/2310.06362 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2310.06362 | https://arxiv.org/pdf/2310.06362 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Make Domain Shift a - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Make Domain Shift a/make_domain_shift_a_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Alleviating Inconsistency Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-Alleviating Inconsistency/alleviating_inconsistency_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Disentangled Knowledge - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260815-Disentangled Knowledge/disentangled_knowledge_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P233` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Song, Yifan; Wang, Peiyi; Xiong, Weimin; Zhu, Dawei; Liu, Tianyu; Sui, Zhifang; Li, Sujian. Submitted/source date: 2023/10/10. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P233`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: alleviating, catastrophic, classification, forgetting, information | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies alleviating, catastrophic, classification. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around alleviating, catastrophic, classification. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Have a free development cycle? Help support accessibility at arXiv! Our collaborators at LaTeXML maintain a list of …”. The full-paper rendering contains 99 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving alleviating, catastrophic, classification. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 41,112 of 75,964 units; duplicate exclusions 0; focus exclusions 1; source-gate exclusions 0; reselections 1.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories ML memory; title/abstract evidence terms catastrophic forgetting.
...
- The related DEPs show how alleviating, catastrophic, classification, forgetting, information connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: alleviating, catastrophic, classification, forgetting, information.
...
|---|---|---|---|
| Make Domain Shift a - DEP-E | Related DEP | Overlap: catastrophic, forgetting, alleviating, text | `.lake-data/DEP-E/DEP-E-20260819-Make Domain Shift a/make_domain_shift_a_manuscript.md` |
| Alleviating Inconsistency Review - DEP-E | Related DEP | Overlap: alleviating, classification, information, text | `.lake-data/DEP-E/DEP-E-20260721-Alleviating Inconsistency/alleviating_inconsistency_manuscript.md` |
| Disentangled Knowledge - DEP-E | Related DEP | Overlap: alleviating, text | `.lake-data/DEP-E/DEP-E-20260815-Disentangled Knowledge/disentangled_knowledge_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2310.06362 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2310.06362 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2310.06362 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Make Domain Shift a/make_domain_shift_a_manuscript.md` | Related synthesis: catastrophic, forgetting, alleviating, text | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260721-Alleviating Inconsistency/alleviating_inconsistency_manuscript.md` | Related synthesis: alleviating, classification, information, text | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260815-Disentangled Knowledge/disentangled_knowledge_manuscript.md` | Related synthesis: alleviating, text | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 41,112 of 75,964 units from 75,967 PDFs.
...
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories ML memory; terms catastrophic forgetting.
