---
title: "texttt Complex-Edit - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of $\\texttt{Complex-Edit}$: CoT-Like Instruction Generation for Complexity-Controllable Image Editing Benchmark."
...
primary_url: "https://arxiv.org/abs/2504.13143"
stable_identifier: "arXiv:2504.13143; DOI:10.48550/arXiv.2504.13143"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P01"
...
# texttt Complex-Edit - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2504.13143 | https://arxiv.org/abs/2504.13143 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2504.13143 rendering | https://arxiv.org/html/2504.13143 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2504.13143 | https://arxiv.org/pdf/2504.13143 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | An Item is Worth a Prompt - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260817-An Item is Worth a Prompt/an_item_is_worth_a_prompt_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Unveil Inversion and - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Unveil Inversion and/unveil_inversion_and_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P01` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Yang, Siwei; Hui, Mude; Zhao, Bingchen; Zhou, Yuyin; Ruiz, Nataniel; Xie, Cihang. Submitted/source date: 2025/04/17. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P01`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We introduce Complex-Edit , a comprehensive benchmark designed to systematically evaluate instruction-based image editing models across instructions of …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We introduce Complex-Edit , a comprehensive benchmark designed to systematically evaluate instruction-based image editing models across instructions of …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: benchmark, editing, generation, image | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies benchmark, complex-edit, complexity-controllable. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around benchmark, complex-edit, complexity-controllable. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We introduce Complex-Edit , a comprehensive benchmark designed to systematically evaluate instruction-based image editing models across instructions of …”. The full-paper rendering contains 111 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We introduce Complex-Edit , a comprehensive benchmark designed to systematically evaluate instruction-based image editing models across instructions of …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Following prior works [ 13 , 10 ] , we employ VLM-based autograders to facilitate large-scale evaluation. However, …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving benchmark, complex-edit, complexity-controllable. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 23,505 of 75,964 units; duplicate exclusions 1; focus exclusions 3; source-gate exclusions 0; reselections 4.
...
- The related DEPs show how benchmark, editing, generation, image connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: benchmark, editing, generation, image.
...
|---|---|---|---|
| Invisible Backdoor - DEP-E | Related DEP | Overlap: editing, image, generation, benchmark | `.lake-data/DEP-E/DEP-E-20260818-Invisible Backdoor/invisible_backdoor_manuscript.md` |
| An Item is Worth a Prompt - DEP-E | Related DEP | Overlap: editing, image | `.lake-data/DEP-E/DEP-E-20260817-An Item is Worth a Prompt/an_item_is_worth_a_prompt_manuscript.md` |
| Unveil Inversion and - DEP-E | Related DEP | Overlap: editing, image | `.lake-data/DEP-E/DEP-E-20260818-Unveil Inversion and/unveil_inversion_and_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2504.13143 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2504.13143 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2504.13143 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Invisible Backdoor/invisible_backdoor_manuscript.md` | Related synthesis: editing, image, generation, benchmark | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260817-An Item is Worth a Prompt/an_item_is_worth_a_prompt_manuscript.md` | Related synthesis: editing, image | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Unveil Inversion and/unveil_inversion_and_manuscript.md` | Related synthesis: editing, image | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 23,505 of 75,964 units from 75,967 PDFs.
