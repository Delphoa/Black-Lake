---
title: "Orthogonal Time Freq 5011 - DEP-E"
generated_at: "2026-08-21 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Orthogonal Time Frequency Space Modulation -- Part I: Fundamentals and Challenges Ahead."
...
primary_url: "https://arxiv.org/abs/2209.05011"
stable_identifier: "arXiv:2209.05011; DOI:10.48550/arXiv.2209.05011"
deployment_job_id: "BLAD-2200-20260821-909CA89B"
deployment_item_id: "BLAD-2200-20260821-909CA89B-P07"
...
# Orthogonal Time Freq 5011 - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2209.05011 | https://arxiv.org/abs/2209.05011 | Metadata only. | 2026-08-21 | Inspected |
| S2 | Full paper | Primary | HTML | 2209.05011 rendering | https://arxiv.org/html/2209.05011 | Verified local copy withheld. | 2026-08-21 | Inspected in full |
| S3 | PDF | Primary | PDF | 2209.05011 | https://arxiv.org/pdf/2209.05011 | Verified local copy withheld. | 2026-08-21 | Integrity checked and sampled |
| S4 | Multi-Point ISAC - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/Series 001/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Synthesis only. | 2026-08-21 | Inspected |
...
| S6 | Joint Pilot Optimization - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/Series 002/DEP-E-20260819-Joint Pilot Optimization/joint_pilot_optimization_manuscript.md` | Synthesis only. | 2026-08-21 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260821-909CA89B-P07` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-21 | Verified |

Authors: Wei, Zhiqiang; Li, Shuangyang; Yuan, Weijie; Schober, Robert; Caire, Giuseppe. Submitted/source date: 2022/09/12. Job `BLAD-2200-20260821-909CA89B`; item `BLAD-2200-20260821-909CA89B-P07`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The SFFT-based OTFS transceiver architecture is shown in Fig. 1 [ 10 , 11 ] . We assume …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “where g rx ​ ( t ) {{g_{{\rm{rx}}}}\left({t}\right)} is the RX filter. Then, the TF domain received signal …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: communication, delay-doppler, future, integrated, isac | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies modulation, otfs, ahead. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around modulation, otfs, ahead. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The SFFT-based OTFS transceiver architecture is shown in Fig. 1 [ 10 , 11 ] . We assume …”. The full-paper rendering contains 46 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “where g rx ​ ( t ) {{g_{{\rm{rx}}}}\left({t}\right)} is the RX filter. Then, the TF domain received signal …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “This letter is the first part of a three-part tutorial on orthogonal time frequency space (OTFS) modulation, which …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving modulation, otfs, ahead. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 21,226 of 75,964 units; duplicate exclusions 13964; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how communication, delay-doppler, future, integrated, isac connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: communication, delay-doppler, future, integrated, isac.
...
|---|---|---|---|
| Multi-Point ISAC - DEP-E | Related DEP | Overlap: isac, integrated, communication, sensing, otfs | `.lake-data/DEP-E/Series 001/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` |
| MOCS Flexible Lengths - DEP-E | Related DEP | Overlap: orthogonal, delay-doppler, waveform, modulation, otfs | `.lake-data/DEP-E/Series 001/DEP-E-20260724-MOCS Flexible Lengths/mocs_flexible_lengths_manuscript.md` |
| Joint Pilot Optimization - DEP-E | Related DEP | Overlap: integrated, communication, sensing, isac, future | `.lake-data/DEP-E/Series 002/DEP-E-20260819-Joint Pilot Optimization/joint_pilot_optimization_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2209.05011 | Metadata and abstract | 2026-08-21 | Metadata only |
| R2 | https://arxiv.org/html/2209.05011 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-21 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2209.05011 | Primary paper integrity | 2026-08-21 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/Series 001/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Related synthesis: isac, integrated, communication, sensing, otfs | 2026-08-21 | Repository-relative |
| R5 | `.lake-data/DEP-E/Series 001/DEP-E-20260724-MOCS Flexible Lengths/mocs_flexible_lengths_manuscript.md` | Related synthesis: orthogonal, delay-doppler, waveform, modulation, otfs | 2026-08-21 | Repository-relative |
| R6 | `.lake-data/DEP-E/Series 002/DEP-E-20260819-Joint Pilot Optimization/joint_pilot_optimization_manuscript.md` | Related synthesis: integrated, communication, sensing, isac, future | 2026-08-21 | Repository-relative |

## Appendix

- Uniform selected index: 21,226 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 13964; focus exclusions: 0; source-gate exclusions: 0; reselections: 0; 24-hour cutoff: 2026-08-20.
