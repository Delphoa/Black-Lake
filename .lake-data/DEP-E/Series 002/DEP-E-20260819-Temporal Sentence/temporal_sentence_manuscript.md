---
title: "Temporal Sentence - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Temporal Sentence Grounding in Streaming Videos."
...
primary_url: "https://arxiv.org/abs/2308.07102"
stable_identifier: "arXiv:2308.07102; DOI:10.1145/3581783.3612120"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P94"
...
# Temporal Sentence - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2308.07102 | https://arxiv.org/abs/2308.07102 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2308.07102 rendering | https://arxiv.org/html/2308.07102 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2308.07102 | https://arxiv.org/pdf/2308.07102 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Streaming - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260809-Streaming/streaming_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | A Better and Faster - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-A Better and Faster/a_better_and_faster_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Learning-Augmented - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Learning-Augmented/learning_augmented_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P94` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Gan, Tian; Wang, Xiao; Sun, Yan; Wu, Jianlong; Guo, Qingpei; Nie, Liqiang. Submitted/source date: 2023/08/14. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P94`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “This paper aims to tackle a novel task - Temporal Sentence Grounding in Streaming Videos (TSGSV). The goal …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “This paper aims to tackle a novel task - Temporal Sentence Grounding in Streaming Videos (TSGSV). The goal …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: streaming, temporal | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies grounding, sentence, streaming. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around grounding, sentence, streaming. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “This paper aims to tackle a novel task - Temporal Sentence Grounding in Streaming Videos (TSGSV). The goal …”. The full-paper rendering contains 80 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “This paper aims to tackle a novel task - Temporal Sentence Grounding in Streaming Videos (TSGSV). The goal …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “This paper aims to tackle a novel task - Temporal Sentence Grounding in Streaming Videos (TSGSV). The goal …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving grounding, sentence, streaming. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 23,148 of 75,964 units; duplicate exclusions 0; focus exclusions 5; source-gate exclusions 0; reselections 5.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; title/abstract evidence terms streaming, temporal.
...
- The related DEPs show how streaming, temporal connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: streaming, temporal.
...
|---|---|---|---|
| Streaming - DEP-E | Related DEP | Overlap: streaming, temporal | `.lake-data/DEP-E/DEP-E-20260809-Streaming/streaming_manuscript.md` |
| A Better and Faster - DEP-E | Related DEP | Overlap: streaming, temporal | `.lake-data/DEP-E/DEP-E-20260818-A Better and Faster/a_better_and_faster_manuscript.md` |
| Learning-Augmented - DEP-E | Related DEP | Overlap: streaming, temporal | `.lake-data/DEP-E/DEP-E-20260818-Learning-Augmented/learning_augmented_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2308.07102 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2308.07102 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2308.07102 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260809-Streaming/streaming_manuscript.md` | Related synthesis: streaming, temporal | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-A Better and Faster/a_better_and_faster_manuscript.md` | Related synthesis: streaming, temporal | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Learning-Augmented/learning_augmented_manuscript.md` | Related synthesis: streaming, temporal | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 23,148 of 75,964 units from 75,967 PDFs.
...
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; terms streaming, temporal.
