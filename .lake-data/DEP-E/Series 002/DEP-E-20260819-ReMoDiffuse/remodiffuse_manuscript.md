---
title: "ReMoDiffuse - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of ReMoDiffuse: Retrieval-Augmented Motion Diffusion Model."
...
primary_url: "https://arxiv.org/abs/2304.01116"
stable_identifier: "arXiv:2304.01116; DOI:10.48550/arXiv.2304.01116"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P458"
...
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2304.01116 | https://arxiv.org/abs/2304.01116 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2304.01116 rendering | https://arxiv.org/html/2304.01116 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2304.01116 | https://arxiv.org/pdf/2304.01116 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P458` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhang, Mingyuan; Guo, Xinying; Pan, Liang; Cai, Zhongang; Hong, Fangzhou; Li, Huirong; Yang, Lei; Liu, Ziwei. Submitted/source date: 2023/04/03. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P458`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “3D human motion generation is crucial for creative industry. Recent advances rely on generative models with domain knowledge …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “3D human motion generation is crucial for creative industry. Recent advances rely on generative models with domain knowledge …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: diffusion, motion | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies diffusion, motion, remodiffuse. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around diffusion, motion, remodiffuse. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “3D human motion generation is crucial for creative industry. Recent advances rely on generative models with domain knowledge …”. The full-paper rendering contains 75 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “3D human motion generation is crucial for creative industry. Recent advances rely on generative models with domain knowledge …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “3D human motion generation is crucial for creative industry. Recent advances rely on generative models with domain knowledge …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving diffusion, motion, remodiffuse. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 46,038 of 75,964 units; duplicate exclusions 0; focus exclusions 1; source-gate exclusions 0; reselections 1.
...
- The related DEPs show how diffusion, motion connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: diffusion, motion.
...
|---|---|---|---|
| AR-Drag Motion Control - DEP-E | Related DEP | Overlap: diffusion, motion | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` |
| Towards - DEP-E | Related DEP | Overlap: diffusion, motion | `.lake-data/DEP-E/DEP-E-20260819-Towards/towards_manuscript.md` |
| Temporal Feature Matters Review - DEP-E | Related DEP | Overlap: diffusion, motion | `.lake-data/DEP-E/DEP-E-20260722-Temporal Feature Matters/temporal_feature_matters_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2304.01116 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2304.01116 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2304.01116 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` | Related synthesis: diffusion, motion | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Towards/towards_manuscript.md` | Related synthesis: diffusion, motion | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260722-Temporal Feature Matters/temporal_feature_matters_manuscript.md` | Related synthesis: diffusion, motion | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 46,038 of 75,964 units from 75,967 PDFs.
