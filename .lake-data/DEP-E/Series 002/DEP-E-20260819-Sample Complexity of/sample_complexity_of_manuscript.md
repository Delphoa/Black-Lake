---
title: "Sample Complexity of - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Sample Complexity of Neural Policy Mirror Descent for Policy Optimization on Low-Dimensional Manifolds."
...
primary_url: "https://arxiv.org/abs/2309.13915"
stable_identifier: "arXiv:2309.13915; DOI:10.48550/arXiv.2309.13915"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P05"
...
# Sample Complexity of - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2309.13915 | https://arxiv.org/abs/2309.13915 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2309.13915 rendering | https://arxiv.org/html/2309.13915 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2309.13915 | https://arxiv.org/pdf/2309.13915 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P05` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Xu, Zhenghao; Ji, Xiang; Chen, Minshuo; Wang, Mengdi; Zhao, Tuo. Submitted/source date: 2023/09/25. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P05`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Policy gradient methods equipped with deep neural networks have achieved great success in solving high-dimensional reinforcement learning (RL) …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Policy gradient methods equipped with deep neural networks have achieved great success in solving high-dimensional reinforcement learning (RL) …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: complexity, descent, manifolds, mirror, policy | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies policy, complexity, descent. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around policy, complexity, descent. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Policy gradient methods equipped with deep neural networks have achieved great success in solving high-dimensional reinforcement learning (RL) …”. The full-paper rendering contains 187 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Policy gradient methods equipped with deep neural networks have achieved great success in solving high-dimensional reinforcement learning (RL) …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Policy gradient methods equipped with deep neural networks have achieved great success in solving high-dimensional reinforcement learning (RL) …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving policy, complexity, descent. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 56,735 of 75,964 units; duplicate exclusions 6; focus exclusions 40; source-gate exclusions 0; reselections 46.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; title/abstract evidence terms complexity, optimization.
...
- The related DEPs show how complexity, descent, manifolds, mirror, policy connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: complexity, descent, manifolds, mirror, policy.
...
|---|---|---|---|
| GPMD Regularized RL - DEP-E | Related DEP | Overlap: mirror, descent, policy, complexity, sample | `.lake-data/DEP-E/DEP-E-20260716-GPMD Regularized RL/gpmd_regularized_rl_manuscript.md` |
| Integrals and Rigidity - DEP-E | Related DEP | Overlap: manifolds, policy | `.lake-data/DEP-E/DEP-E-20260717-Integrals and Rigidity/integrals_and_rigidity_manuscript.md` |
| Breaking the Sample - DEP-E | Related DEP | Overlap: complexity, sample | `.lake-data/DEP-E/DEP-E-20260818-Breaking the Sample/breaking_the_sample_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2309.13915 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2309.13915 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2309.13915 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260716-GPMD Regularized RL/gpmd_regularized_rl_manuscript.md` | Related synthesis: mirror, descent, policy, complexity, sample | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260717-Integrals and Rigidity/integrals_and_rigidity_manuscript.md` | Related synthesis: manifolds, policy | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Breaking the Sample/breaking_the_sample_manuscript.md` | Related synthesis: complexity, sample | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 56,735 of 75,964 units from 75,967 PDFs.
...
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; terms complexity, optimization.
