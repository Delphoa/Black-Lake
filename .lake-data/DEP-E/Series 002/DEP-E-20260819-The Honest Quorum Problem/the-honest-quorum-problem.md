...
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260721-Tech Intel 1101 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260721-Tech%20Intel%201101/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-21_1101.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260721-Tech%20Intel%201101/daily_research_findings_2026-07-21_1101.md | Repository evidence; public URL | 2026-08-19 | Inspected |
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260721-Tech%20Intel%201101/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260721-Tech%20Intel%201101/daily_research_findings_2026-07-21_1101.md | Deposited source synthesis | The paper argues that authenticated, responsive, protocol-compliant agent validators can still endorse semantically invalid state transitions because of reasoning errors. It defines epistemic faults and an Epistemic Byzantine Fault Tolerance model with separate confidence-indexed budgets for invalid endorsements and unusable validator support, then derives quorum conditions for semantic validity, agreement, liveness, and threshold selection. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
...
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260721-Tech%20Intel%201101/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260721-Tech%20Intel%201101/daily_research_findings_2026-07-21_1101.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
