---
title: "XR-DT Extended - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of XR-DT: Extended Reality-Enhanced Digital Twin for Safe Motion Planning via Human-Aware Model Predictive Path Integral Control."
...
primary_url: "https://arxiv.org/abs/2512.05270"
stable_identifier: "arXiv:2512.05270; DOI:10.48550/arXiv.2512.05270"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P184"
...
# XR-DT Extended - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2512.05270 | https://arxiv.org/abs/2512.05270 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2512.05270 rendering | https://arxiv.org/html/2512.05270 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2512.05270 | https://arxiv.org/pdf/2512.05270 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Agentic Neuro-Symbolic - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Agentic Neuro-Symbolic/agentic_neuro_symbolic_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Extended to Reality - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Extended to Reality/extended_to_reality_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Digital and Physical Face - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260813-Digital and Physical Face/digital_and_physical_face_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P184` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Tianyi; Byeon, Jiseop; Yehia, Ahmad; Xu, Yiming; Park, Jihyung; Zeng, Tianyi; Chen, Sikai; Wang, Ziran; Jiao, Junfeng; Claudel, Christian. Submitted/source date: 2025/12/04. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P184`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “As mobile robots increasingly operate alongside humans in shared workspaces, ensuring safe, efficient, and interpretable Human-Robot Interaction (HRI) …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “As mobile robots increasingly operate alongside humans in shared workspaces, ensuring safe, efficient, and interpretable Human-Robot Interaction (HRI) …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: control, digital, extended, path, planning | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies control, digital, extended. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around control, digital, extended. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “As mobile robots increasingly operate alongside humans in shared workspaces, ensuring safe, efficient, and interpretable Human-Robot Interaction (HRI) …”. The full-paper rendering contains 62 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “As mobile robots increasingly operate alongside humans in shared workspaces, ensuring safe, efficient, and interpretable Human-Robot Interaction (HRI) …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “As mobile robots increasingly operate alongside humans in shared workspaces, ensuring safe, efficient, and interpretable Human-Robot Interaction (HRI) …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving control, digital, extended. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 19,605 of 75,964 units; duplicate exclusions 0; focus exclusions 13; source-gate exclusions 0; reselections 13.
...
- The related DEPs show how control, digital, extended, path, planning connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: control, digital, extended, path, planning.
...
|---|---|---|---|
| Agentic Neuro-Symbolic - DEP-E | Related DEP | Overlap: digital, planning, safe, path, control | `.lake-data/DEP-E/DEP-E-20260819-Agentic Neuro-Symbolic/agentic_neuro_symbolic_manuscript.md` |
| Extended to Reality - DEP-E | Related DEP | Overlap: extended, safe, path, planning, control | `.lake-data/DEP-E/DEP-E-20260803-Extended to Reality/extended_to_reality_manuscript.md` |
| Digital and Physical Face - DEP-E | Related DEP | Overlap: digital, safe, path, planning, control | `.lake-data/DEP-E/DEP-E-20260813-Digital and Physical Face/digital_and_physical_face_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2512.05270 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2512.05270 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2512.05270 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Agentic Neuro-Symbolic/agentic_neuro_symbolic_manuscript.md` | Related synthesis: digital, planning, safe, path, control | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260803-Extended to Reality/extended_to_reality_manuscript.md` | Related synthesis: extended, safe, path, planning, control | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260813-Digital and Physical Face/digital_and_physical_face_manuscript.md` | Related synthesis: digital, safe, path, planning, control | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 19,605 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 0; focus exclusions: 13; source-gate exclusions: 0; reselections: 13; 24-hour cutoff: 2026-08-18.
