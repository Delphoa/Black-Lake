---
title: "Make LLM Inference - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Make LLM Inference Affordable to Everyone: Augmenting GPU Memory with NDP-DIMM."
...
primary_url: "https://arxiv.org/abs/2502.16963"
stable_identifier: "arXiv:2502.16963; DOI:10.48550/arXiv.2502.16963"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P185"
...
# Make LLM Inference - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2502.16963 | https://arxiv.org/abs/2502.16963 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2502.16963 rendering | https://arxiv.org/html/2502.16963 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2502.16963 | https://arxiv.org/pdf/2502.16963 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | N-Grammer Augmenting - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260802-N-Grammer Augmenting/n_grammer_augmenting_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Accelerating LLM - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Accelerating LLM/accelerating_llm_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P185` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Lian; Zhao, Shixin; Li, Bing; Ren, Haimeng; Xu, Zhaohui; Wang, Mengdi; Li, Xiaowei; Han, Yinhe; Wang, Ying. Submitted/source date: 2025/02/24. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P185`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “This work introduces Hermes, a budget-friendly system that leverages the near-data processing units (NDP) within commodity DRAM DIMMs …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “To investigate the development of cost-effective LLM inference systems, researchers have shifted their focus to more budget-friendly hardware, …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: augmenting, inference, llm, make, memory | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies affordable, augmenting, everyone. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around affordable, augmenting, everyone. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “This work introduces Hermes, a budget-friendly system that leverages the near-data processing units (NDP) within commodity DRAM DIMMs …”. The full-paper rendering contains 96 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “To investigate the development of cost-effective LLM inference systems, researchers have shifted their focus to more budget-friendly hardware, …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The billion-scale Large Language Models (LLMs) necessitate deployment on expensive server-grade GPUs with large-storage HBMs and abundant computation …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving affordable, augmenting, everyone. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 21,324 of 75,964 units; duplicate exclusions 3; focus exclusions 16; source-gate exclusions 0; reselections 19.
...
- The related DEPs show how augmenting, inference, llm, make, memory connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: augmenting, inference, llm, make, memory.
...
|---|---|---|---|
| N-Grammer Augmenting - DEP-E | Related DEP | Overlap: augmenting, make, memory | `.lake-data/DEP-E/DEP-E-20260802-N-Grammer Augmenting/n_grammer_augmenting_manuscript.md` |
| Accelerating LLM - DEP-E | Related DEP | Overlap: llm, inference, memory, make | `.lake-data/DEP-E/DEP-E-20260819-Accelerating LLM/accelerating_llm_manuscript.md` |
| Shadow in the Cache - DEP-E | Related DEP | Overlap: llm, inference, make, memory | `.lake-data/DEP-E/DEP-E-20260819-Shadow in the Cache/shadow_in_the_cache_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2502.16963 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2502.16963 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2502.16963 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260802-N-Grammer Augmenting/n_grammer_augmenting_manuscript.md` | Related synthesis: augmenting, make, memory | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Accelerating LLM/accelerating_llm_manuscript.md` | Related synthesis: llm, inference, memory, make | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Shadow in the Cache/shadow_in_the_cache_manuscript.md` | Related synthesis: llm, inference, make, memory | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 21,324 of 75,964 units from 75,967 PDFs.
