---
title: "State Space Model Meets - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of State Space Model Meets Transformer: A New Paradigm for 3D Object Detection."
...
primary_url: "https://arxiv.org/abs/2503.14493"
stable_identifier: "arXiv:2503.14493; DOI:10.48550/arXiv.2503.14493"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P175"
...
# State Space Model Meets - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2503.14493 | https://arxiv.org/abs/2503.14493 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2503.14493 rendering | https://arxiv.org/html/2503.14493 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2503.14493 | https://arxiv.org/pdf/2503.14493 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | HeightFormer Learning - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260728-HeightFormer Learning/heightformer_learning_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P175` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Chuxin; Yang, Wenfei; Liu, Xiang; Zhang, Tianzhu. Submitted/source date: 2025/03/18. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P175`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: detection, meets, object, space, state | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies detection, meets, object. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around detection, meets, object. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving detection, meets, object. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 46,829 of 75,964 units; duplicate exclusions 1; focus exclusions 10; source-gate exclusions 0; reselections 11.
...
- The related DEPs show how detection, meets, object, space, state connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: detection, meets, object, space, state.
...
|---|---|---|---|
| S3MOT Monocular 3D Object - DEP-E | Related DEP | Overlap: space, object, state, detection | `.lake-data/DEP-E/DEP-E-20260818-S3MOT Monocular 3D Object/s3mot_monocular_3d_object_manuscript.md` |
| HeightFormer Learning - DEP-E | Related DEP | Overlap: transformer, object, detection, space, state | `.lake-data/DEP-E/DEP-E-20260728-HeightFormer Learning/heightformer_learning_manuscript.md` |
| MoE3D Mixture of Experts - DEP-E | Related DEP | Overlap: meets, transformer, detection | `.lake-data/DEP-E/DEP-E-20260726-MoE3D Mixture of Experts/moe3d_mixture_of_experts_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2503.14493 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2503.14493 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2503.14493 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-S3MOT Monocular 3D Object/s3mot_monocular_3d_object_manuscript.md` | Related synthesis: space, object, state, detection | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260728-HeightFormer Learning/heightformer_learning_manuscript.md` | Related synthesis: transformer, object, detection, space, state | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260726-MoE3D Mixture of Experts/moe3d_mixture_of_experts_manuscript.md` | Related synthesis: meets, transformer, detection | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 46,829 of 75,964 units from 75,967 PDFs.
