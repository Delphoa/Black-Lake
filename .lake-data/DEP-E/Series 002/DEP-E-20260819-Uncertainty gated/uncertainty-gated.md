...
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260710-Tech Intel 1302 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%201302/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-10_1302.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%201302/daily_research_findings_2026-07-10_1302.md | Repository evidence; public URL | 2026-08-19 | Inspected |
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%201302/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%201302/daily_research_findings_2026-07-10_1302.md | Deposited source synthesis | ** Proposes a live relational Context Graph for enterprise entities, relationships, and state transitions, plus delta detection, proactivity scoring, and LLM-based surfacing. The paper reports Precision@5 of 0.83, false-positive rate of 0.11, and mean time to surface under 30 seconds across contract, incident-response, and sales-pipeline case studies. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
...
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%201302/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%201302/daily_research_findings_2026-07-10_1302.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
