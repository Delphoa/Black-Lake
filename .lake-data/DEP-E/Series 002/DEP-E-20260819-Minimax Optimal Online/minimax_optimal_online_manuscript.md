---
title: "Minimax Optimal Online - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Minimax Optimal Online Imitation Learning via Replay Estimation."
...
primary_url: "https://arxiv.org/abs/2205.15397"
stable_identifier: "arXiv:2205.15397; DOI:10.48550/arXiv.2205.15397"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P412"
...
# Minimax Optimal Online - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2205.15397 | https://arxiv.org/abs/2205.15397 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2205.15397 rendering | https://arxiv.org/html/2205.15397 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2205.15397 | https://arxiv.org/pdf/2205.15397 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Multitask Identity-Aware - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Multitask Identity-Aware/multitask_identity_aware_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | DexMimicGen Automated - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260810-DexMimicGen Automated/dexmimicgen_automated_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P412` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Swamy, Gokul; Rajaraman, Nived; Peng, Matthew; Choudhury, Sanjiban; Bagnell, J. Andrew; Wu, Zhiwei Steven; Jiao, Jiantao; Ramchandran, Kannan. Submitted/source date: 2022/05/30. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P412`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Online imitation learning is the problem of how best to mimic expert demonstrations, given access to the environment …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Online imitation learning is the problem of how best to mimic expert demonstrations, given access to the environment …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: imitation, minimax, online, replay | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies estimation, imitation, minimax. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around estimation, imitation, minimax. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Online imitation learning is the problem of how best to mimic expert demonstrations, given access to the environment …”. The full-paper rendering contains 139 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Online imitation learning is the problem of how best to mimic expert demonstrations, given access to the environment …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Online imitation learning is the problem of how best to mimic expert demonstrations, given access to the environment …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving estimation, imitation, minimax. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 8,474 of 75,964 units; duplicate exclusions 4; focus exclusions 25; source-gate exclusions 0; reselections 29.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories ML memory; title/abstract evidence terms learning, replay.
...
- The related DEPs show how imitation, minimax, online, replay connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: imitation, minimax, online, replay.
...
|---|---|---|---|
| Multitask Identity-Aware - DEP-E | Related DEP | Overlap: minimax | `.lake-data/DEP-E/DEP-E-20260819-Multitask Identity-Aware/multitask_identity_aware_manuscript.md` |
| ONER Online Experience - DEP-E | Related DEP | Overlap: replay, online | `.lake-data/DEP-E/DEP-E-20260819-ONER Online Experience/oner_online_experience_manuscript.md` |
| DexMimicGen Automated - DEP-E | Related DEP | Overlap: imitation | `.lake-data/DEP-E/DEP-E-20260810-DexMimicGen Automated/dexmimicgen_automated_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2205.15397 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2205.15397 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2205.15397 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Multitask Identity-Aware/multitask_identity_aware_manuscript.md` | Related synthesis: minimax | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-ONER Online Experience/oner_online_experience_manuscript.md` | Related synthesis: replay, online | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260810-DexMimicGen Automated/dexmimicgen_automated_manuscript.md` | Related synthesis: imitation | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 8,474 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 4; focus exclusions: 25; source-gate exclusions: 0; reselections: 29; 24-hour cutoff: 2026-08-18.
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories ML memory; terms learning, replay.
