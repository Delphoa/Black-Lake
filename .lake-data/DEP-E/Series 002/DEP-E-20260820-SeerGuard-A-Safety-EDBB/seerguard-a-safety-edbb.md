---
title: "SeerGuard A Safety - DEP-E"
generated_at: "2026-08-19T22:59:33Z"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction"
...
primary_url: "https://arxiv.org/abs/2607.15550"
stable_identifier: "arXiv:2607.15550"
...
# SeerGuard A Safety - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Repository-relative path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction | Primary research artifact | arXiv HTML and Atom metadata | arXiv:2607.15550 | https://arxiv.org/abs/2607.15550; https://arxiv.org/html/2607.15550 | Public research source; no source file redistributed | 2026-08-20 | Inspected |
| S2 | Selected source DEP | Provenance and deposited finding | Markdown | DEP-20260720-Tech Intel 1303 | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260720-Tech%20Intel%201303 | Repository evidence; no source file copied | 2026-08-20 | Inspected |
| S3 | Latest prior Report-Mark | Iterative-expansion context | Markdown | Black-Lake-Data/.lake-data/DEP-20260720-Tech Intel 1303/BL-DEP-Mark001 Report-Mark.md | Black-Lake-Data/.lake-data/DEP-20260720-Tech Intel 1303/BL-DEP-Mark001 Report-Mark.md | Repository evidence | 2026-08-20 | Inspected |

The selected DEP contains 3 inspected Markdown file(s) and no newly collected source payload. The primary publication date recorded by official metadata is `2026-07-17T01:45:54Z`. Prior material was detected. The latest Report-Mark was reviewed first, and one research thread was selected from its related-reading/source-reference pool using cryptographic rejection sampling. The chosen thread was `https://arxiv.org/abs/2607.15550`; inaccessible candidates, if any, are recorded in the artifact log.
...
This DEP-E artifact reviews *SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction*, attributed to Xue Yu; Bo Yuan; Pengshuai Yang; Kailin Zhao; Hong Hu; Junlan Feng. The selected source DEP characterizes the work as a current research claim and summarizes it as follows: Lucid crafts imperceptible image perturbations under an image-only threat model, without access to the target MLLM, retrieval encoder, or text channel. It targets both in-context memory poisoning and out-of-context memory injection, and is evaluated across five black-box memory architectures including graph-structured, LLM-summarized, and commercial systems. The reported attack-success rates are 61.6% for poisoning and 58.4% for injection. - **Why it matters:** Persistent multimodal memory turns apparently passive media into durable control surface. Memory stores need provenance and trust separation, media sanitization, retrieval-time checks, and cross-session adversarial tests rather than assuming that only text can inject instructions. The evaluation is source-reported and should not be generalized to every production memory stack. - **Relevance tags:** #ai-memory #context-systems #agentic-ai #ai-safety #cyber-security #cyber-privacy #multimodal-ai - **Source type:** Primary arXiv cryptography-and-security, computer-vision, and machine-learning preprint; submitted 2026-07-17. - **Source references:** - https://arxiv.org/abs/2607.15657 [E1, E3]. Official arXiv metadata and full HTML were inspected, while no source file, dataset, code repository, model, or execution trace was collected.
...
Reviewer interpretation: Persistent multimodal memory turns apparently passive media into durable control surface. Memory stores need provenance and trust separation, media sanitization, retrieval-time checks, and cross-session adversarial tests rather than assuming that only text can inject instructions. The evaluation is source-reported and should not be generalized to every production memory stack. - **Relevance tags:** #ai-memory #context-systems #agentic-ai #ai-safety #cyber-security #cyber-privacy #multimodal-ai - **Source type:** Primary arXiv cryptography-and-security, computer-vision, and machine-learning preprint; submitted 2026-07-17. - **Source references:** - https://arxiv.org/abs/2607.15657 This is a reason to prioritize structured evaluation, not a basis for production, clinical, security, procurement, or policy decisions without the independent checks listed below.

## Detailed Summary

### Problem and contribution

The primary source addresses the research object identified by its canonical title, *SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction*. The source DEP preserves the following concise account: Lucid crafts imperceptible image perturbations under an image-only threat model, without access to the target MLLM, retrieval encoder, or text channel. It targets both in-context memory poisoning and out-of-context memory injection, and is evaluated across five black-box memory architectures including graph-structured, LLM-summarized, and commercial systems. The reported attack-success rates are 61.6% for poisoning and 58.4% for injection. - **Why it matters:** Persistent multimodal memory turns apparently passive media into durable control surface. Memory stores need provenance and trust separation, media sanitization, retrieval-time checks, and cross-session adversarial tests rather than assuming that only text can inject instructions. The evaluation is source-reported and should not be generalized to every production memory stack. - **Relevance tags:** #ai-memory #context-systems #agentic-ai #ai-safety #cyber-security #cyber-privacy #multimodal-ai - **Source type:** Primary arXiv cryptography-and-security, computer-vision, and machine-learning preprint; submitted 2026-07-17. - **Source references:** - https://arxiv.org/abs/2607.15657 [E1, E3]. This artifact treats that account as a source-reported claim rather than an independently established fact.
...
- Sources inspected: Every Markdown file in `Black-Lake-Data/.lake-data/DEP-20260720-Tech Intel 1303`, the canonical primary record, official metadata, and full HTML when accessible; the latest Report-Mark was also inspected for iterative passes.
...
|---|---|---|---|
| SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction | Primary research thread | New in this pass; randomly selected from the latest Report-Mark research pool and inspected as the primary expansion thread. | https://arxiv.org/abs/2607.15550 |
| Official full-text representation | Primary source format | Full HTML used to locate abstract, methodology, evaluation, limitations, and conclusion evidence where available. | https://arxiv.org/html/2607.15550 |
| Selected source DEP | Provenance record | Preserves the deposited finding, source inventory, and explicit non-reproduction boundary. | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260720-Tech%20Intel%201303 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2212.08073 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2411.00820 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2411.10414 |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2607.15550 | Canonical title, authors, abstract, identifier, and source status | 2026-08-20 | Primary record inspected |
| R2 | https://arxiv.org/html/2607.15550 | Full-text section structure, method/evaluation trace, limitations, and conclusion | 2026-08-20 | Full HTML inspected |
| R3 | https://export.arxiv.org/api/query?id_list=2607.15550 | Canonical Atom metadata and abstract | 2026-08-20 | Official arXiv API inspected |
| R4 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260720-Tech%20Intel%201303/BL-DEP-Mark001%20Report-Mark.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
| R5 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260720-Tech%20Intel%201303/daily_research_findings_2026-07-20_1303.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
| R6 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260720-Tech%20Intel%201303/README.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
...
- Selection order: 104 of 200
- Cryptographic draw: `854676857` accepted on attempt 1, rejection limit `4294966995`, zero-based index `62` from a pool of 915.
...
- `Black-Lake-Data/.lake-data/DEP-20260720-Tech Intel 1303/BL-DEP-Mark001 Report-Mark.md` - inspected repository file
- `Black-Lake-Data/.lake-data/DEP-20260720-Tech Intel 1303/daily_research_findings_2026-07-20_1303.md` - inspected repository file
- `Black-Lake-Data/.lake-data/DEP-20260720-Tech Intel 1303/README.md` - inspected repository file
