---
title: "Low-complexity Joint - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Low-complexity Joint Beamforming for RIS-Aided Multi-User Downlink over Correlated Channels."
...
primary_url: "https://arxiv.org/abs/2202.11354"
stable_identifier: "arXiv:2202.11354; DOI:10.48550/arXiv.2202.11354"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P295"
...
# Low-complexity Joint - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2202.11354 | https://arxiv.org/abs/2202.11354 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2202.11354 rendering | https://arxiv.org/html/2202.11354 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2202.11354 | https://arxiv.org/pdf/2202.11354 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Low-Complexity - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Multi-Point ISAC - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Designing Low-Complexity - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Designing Low-Complexity/designing_low_complexity_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P295` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wu, Yu-Tse; Liu, Kuang-Hao. Submitted/source date: 2022/02/23. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P295`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “This paper considers the reconfigurable intelligent surface (RIS)-assisted multi-user communications, where an RIS is used to assist the …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “This paper considers the reconfigurable intelligent surface (RIS)-assisted multi-user communications, where an RIS is used to assist the …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: beamforming, channels, correlated, downlink, joint | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies beamforming, channels, correlated. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around beamforming, channels, correlated. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “This paper considers the reconfigurable intelligent surface (RIS)-assisted multi-user communications, where an RIS is used to assist the …”. The full-paper rendering contains 26 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “This paper considers the reconfigurable intelligent surface (RIS)-assisted multi-user communications, where an RIS is used to assist the …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In this work, we focus on low-complexity methods to solve the joint beamforming design when a single RIS …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving beamforming, channels, correlated. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 19,457 of 75,964 units; duplicate exclusions 0; focus exclusions 2; source-gate exclusions 1; reselections 3.
...
- The related DEPs show how beamforming, channels, correlated, downlink, joint connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: beamforming, channels, correlated, downlink, joint.
...
|---|---|---|---|
| Low-Complexity - DEP-E | Related DEP | Overlap: downlink, multi-user, beamforming, low-complexity, joint | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` |
| Multi-Point ISAC - DEP-E | Related DEP | Overlap: beamforming, correlated, channels, joint | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` |
| Designing Low-Complexity - DEP-E | Related DEP | Overlap: low-complexity, joint | `.lake-data/DEP-E/DEP-E-20260819-Designing Low-Complexity/designing_low_complexity_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2202.11354 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2202.11354 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2202.11354 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` | Related synthesis: downlink, multi-user, beamforming, low-complexity, joint | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Related synthesis: beamforming, correlated, channels, joint | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Designing Low-Complexity/designing_low_complexity_manuscript.md` | Related synthesis: low-complexity, joint | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 19,457 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 0; focus exclusions: 2; source-gate exclusions: 1; reselections: 3; 24-hour cutoff: 2026-08-18.
