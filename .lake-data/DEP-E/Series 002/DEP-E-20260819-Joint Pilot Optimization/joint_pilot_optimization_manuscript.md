---
title: "Joint Pilot Optimization - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Joint Pilot Optimization, Target Detection and Channel Estimation for Integrated Sensing and Communication Systems."
...
primary_url: "https://arxiv.org/abs/2202.02688"
stable_identifier: "arXiv:2202.02688; DOI:10.48550/arXiv.2202.02688"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P100"
...
# Joint Pilot Optimization - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2202.02688 | https://arxiv.org/abs/2202.02688 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2202.02688 rendering | https://arxiv.org/html/2202.02688 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2202.02688 | https://arxiv.org/pdf/2202.02688 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Multi-Point ISAC - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Joint Sensing MEC - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260715-Joint Sensing MEC/joint_sensing_mec_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P100` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Huang, Zhe; Wang, Kexuan; Liu, An; Cai, Yunlong; Du, Rui; Han, Tony Xiao. Submitted/source date: 2022/02/06. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P100`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Radar sensing will be integrated into the 6G communication system to support various applications. In this integrated sensing …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “It is expected that future 6G communication system will integrate radar sensing and communication functions to support various …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: channel, communication, detection, estimation, integrated | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies channel, communication, detection. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around channel, communication, detection. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Radar sensing will be integrated into the 6G communication system to support various applications. In this integrated sensing …”. The full-paper rendering contains 65 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “It is expected that future 6G communication system will integrate radar sensing and communication functions to support various …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “It is expected that future 6G communication system will integrate radar sensing and communication functions to support various …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving channel, communication, detection. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 1,639 of 75,964 units; duplicate exclusions 0; focus exclusions 8; source-gate exclusions 0; reselections 8.
...
- The related DEPs show how channel, communication, detection, estimation, integrated connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: channel, communication, detection, estimation, integrated.
...
|---|---|---|---|
| Multi-Point ISAC - DEP-E | Related DEP | Overlap: integrated, sensing, communication, estimation, channel | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` |
| An Efficient Algorithm - DEP-E | Related DEP | Overlap: estimation, channel, systems, detection, sensing | `.lake-data/DEP-E/DEP-E-20260819-An Efficient Algorithm/an_efficient_algorithm_manuscript.md` |
| Joint Sensing MEC - DEP-E | Related DEP | Overlap: sensing, optimization, joint, channel, systems | `.lake-data/DEP-E/DEP-E-20260715-Joint Sensing MEC/joint_sensing_mec_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2202.02688 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2202.02688 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2202.02688 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Related synthesis: integrated, sensing, communication, estimation, channel | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-An Efficient Algorithm/an_efficient_algorithm_manuscript.md` | Related synthesis: estimation, channel, systems, detection, sensing | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260715-Joint Sensing MEC/joint_sensing_mec_manuscript.md` | Related synthesis: sensing, optimization, joint, channel, systems | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 1,639 of 75,964 units from 75,967 PDFs.
