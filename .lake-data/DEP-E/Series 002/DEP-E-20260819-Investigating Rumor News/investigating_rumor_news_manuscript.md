---
title: "Investigating Rumor News - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Investigating Rumor News Using Agreement-Aware Search."
...
primary_url: "https://arxiv.org/abs/1802.07398"
stable_identifier: "arXiv:1802.07398; DOI:10.1145/3269206.3272020"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P118"
...
# Investigating Rumor News - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1802.07398 | https://arxiv.org/abs/1802.07398 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1802.07398 rendering | https://arxiv.org/html/1802.07398 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1802.07398 | https://arxiv.org/pdf/1802.07398 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | COVID Fake News - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Fantastic Semantics and - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260802-Fantastic Semantics and/fantastic_semantics_and_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Lower Quantity Higher - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Lower Quantity Higher/lower_quantity_higher_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P118` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Shang, Jingbo; Sun, Tianhang; Shen, Jiaming; Liu, Xingbang; Gruenheid, Anja; Korn, Flip; Lelkes, Adam; Yu, Cong; Han, Jiawei. Submitted/source date: 2018/02/21. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P118`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Recent years have witnessed a widespread increase of rumor news generated by humans and machines. Therefore, tools for …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Recent years have witnessed a widespread increase of rumor news generated by humans and machines. Therefore, tools for …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: investigating, news, rumor, search | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies agreement-aware, investigating, news. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around agreement-aware, investigating, news. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Recent years have witnessed a widespread increase of rumor news generated by humans and machines. Therefore, tools for …”. The full-paper rendering contains 61 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Recent years have witnessed a widespread increase of rumor news generated by humans and machines. Therefore, tools for …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Recent years have witnessed a widespread increase of rumor news generated by humans and machines. Therefore, tools for …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving agreement-aware, investigating, news. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 4,630 of 75,964 units; duplicate exclusions 0; focus exclusions 7; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how investigating, news, rumor, search connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: investigating, news, rumor, search.
...
|---|---|---|---|
| COVID Fake News - DEP-E | Related DEP | Overlap: news, rumor, search | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` |
| Fantastic Semantics and - DEP-E | Related DEP | Overlap: investigating, search | `.lake-data/DEP-E/DEP-E-20260802-Fantastic Semantics and/fantastic_semantics_and_manuscript.md` |
| Lower Quantity Higher - DEP-E | Related DEP | Overlap: news, investigating | `.lake-data/DEP-E/DEP-E-20260818-Lower Quantity Higher/lower_quantity_higher_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1802.07398 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1802.07398 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1802.07398 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` | Related synthesis: news, rumor, search | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260802-Fantastic Semantics and/fantastic_semantics_and_manuscript.md` | Related synthesis: investigating, search | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Lower Quantity Higher/lower_quantity_higher_manuscript.md` | Related synthesis: news, investigating | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 4,630 of 75,964 units from 75,967 PDFs.
