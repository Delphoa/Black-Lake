---
title: "Road Curb Detection Using - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Road Curb Detection Using A Novel Tensor Voting Algorithm."
...
primary_url: "https://arxiv.org/abs/1911.12937"
stable_identifier: "arXiv:1911.12937; DOI:10.48550/arXiv.1911.12937"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P386"
...
# Road Curb Detection Using - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1911.12937 | https://arxiv.org/abs/1911.12937 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1911.12937 rendering | https://arxiv.org/html/1911.12937 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1911.12937 | https://arxiv.org/pdf/1911.12937 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Mask Proposal Voting - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Mask Proposal Voting/mask_proposal_voting_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | A Novel Learning - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A Novel Learning/a_novel_learning_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P386` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhu, Yilong; Han, Dong; Xue, Bohuan; Jiao, Jianhao; Zou, Zuhao; Liu, Ming; Fan, Rui. Submitted/source date: 2019/11/29. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P386`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Road curb detection is very important and neces-sary for autonomous driving because it can improve the safety and …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Road curb detection is very important and neces-sary for autonomous driving because it can improve the safety and …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, detection, novel, voting | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, curb, detection. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, curb, detection. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Road curb detection is very important and neces-sary for autonomous driving because it can improve the safety and …”. The full-paper rendering contains 59 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Road curb detection is very important and neces-sary for autonomous driving because it can improve the safety and …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “However, most of the algorithms require some expen-sive Lidar, such as, Velodyne HDL-64-E, StreetMapper, and RIEGL VMX-250. These …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, curb, detection. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 6,776 of 75,964 units; duplicate exclusions 2; focus exclusions 16; source-gate exclusions 0; reselections 18.
...
- The related DEPs show how algorithm, detection, novel, voting connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, detection, novel, voting.
...
|---|---|---|---|
| Multi-Point ISAC - DEP-E | Related DEP | Overlap: voting, algorithm, detection | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` |
| Mask Proposal Voting - DEP-E | Related DEP | Overlap: voting, detection | `.lake-data/DEP-E/DEP-E-20260818-Mask Proposal Voting/mask_proposal_voting_manuscript.md` |
| A Novel Learning - DEP-E | Related DEP | Overlap: novel, algorithm, detection | `.lake-data/DEP-E/DEP-E-20260819-A Novel Learning/a_novel_learning_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1911.12937 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1911.12937 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1911.12937 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Related synthesis: voting, algorithm, detection | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Mask Proposal Voting/mask_proposal_voting_manuscript.md` | Related synthesis: voting, detection | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-A Novel Learning/a_novel_learning_manuscript.md` | Related synthesis: novel, algorithm, detection | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 6,776 of 75,964 units from 75,967 PDFs.
