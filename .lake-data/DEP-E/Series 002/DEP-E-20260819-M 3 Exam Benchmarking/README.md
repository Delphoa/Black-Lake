...
The three related DEPs connect the selected work to InterDance Reactive 3D Dance Gen - DEP-E, ManipulationNet An - DEP-E, and FGBench Chemistry - DEP-E. Their concrete shared concepts include benchmarking, interactions, memory, multimodal, realistic. The combined lesson is to preserve source provenance, compare against strong simple baselines, test shift and sensitivity, and use abstention plus human review when evidence is incomplete.

## Attribution Block

- Deployment IDs: `BLAD-2200-20260819-8DFEF0DE`; `BLAD-2200-20260819-8DFEF0DE-P303`.
- https://arxiv.org/abs/2606.07402 - metadata and source locators.
- https://arxiv.org/html/2606.07402 - verified full paper; local copy withheld.
- https://arxiv.org/pdf/2606.07402 - verified PDF; local copy withheld.
