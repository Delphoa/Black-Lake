---
title: "Long Short-Term Memory - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Long Short-Term Memory Networks for CSI300 Volatility Prediction with Baidu Search Volume."
...
primary_url: "https://arxiv.org/abs/1805.11954"
stable_identifier: "arXiv:1805.11954; DOI:10.1002/cpe.4721"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P336"
...
# Long Short-Term Memory - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1805.11954 | https://arxiv.org/abs/1805.11954 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1805.11954 rendering | https://arxiv.org/html/1805.11954 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1805.11954 | https://arxiv.org/pdf/1805.11954 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | An Attention-based Long - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-An Attention-based Long/an_attention_based_long_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P336` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhou, Yu-Long; Han, Ren-Jie; Xu, Qian; Zhang, Wei-Ke. Submitted/source date: 2018/05/29. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P336`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “According to Herbert Simon, actors begin their decision-making process by attempting to gather information [ 17 ] . …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Intense volatility in financial markets affect humans worldwide. Therefore, relatively accurate prediction of volatility is critical. We suggest …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: long, memory, networks, prediction, short-term | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies baidu, csi300, long. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around baidu, csi300, long. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “According to Herbert Simon, actors begin their decision-making process by attempting to gather information [ 17 ] . …”. The full-paper rendering contains 22 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Intense volatility in financial markets affect humans worldwide. Therefore, relatively accurate prediction of volatility is critical. We suggest …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “One may try to use the time series { X j i , △ ​ t , k …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving baidu, csi300, long. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 4,925 of 75,964 units; duplicate exclusions 1; focus exclusions 3; source-gate exclusions 0; reselections 4.
...
- The related DEPs show how long, memory, networks, prediction, short-term connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: long, memory, networks, prediction, short-term.
...
|---|---|---|---|
| ALERTA-Net A Temporal - DEP-E | Related DEP | Overlap: volatility, prediction, networks, memory | `.lake-data/DEP-E/DEP-E-20260819-ALERTA-Net A Temporal/alerta_net_a_temporal_manuscript.md` |
| Deep Learning with Long - DEP-E | Related DEP | Overlap: short-term, long, prediction, memory | `.lake-data/DEP-E/DEP-E-20260819-Deep Learning with Long/deep_learning_with_long_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1805.11954 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1805.11954 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1805.11954 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-ALERTA-Net A Temporal/alerta_net_a_temporal_manuscript.md` | Related synthesis: volatility, prediction, networks, memory | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Deep Learning with Long/deep_learning_with_long_manuscript.md` | Related synthesis: short-term, long, prediction, memory | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-An Attention-based Long/an_attention_based_long_manuscript.md` | Related synthesis: short-term, long, memory | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 4,925 of 75,964 units from 75,967 PDFs.
