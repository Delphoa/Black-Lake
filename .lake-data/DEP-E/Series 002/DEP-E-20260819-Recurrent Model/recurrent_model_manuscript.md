---
title: "Recurrent Model - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Recurrent Model Predictive Control."
...
primary_url: "https://arxiv.org/abs/2102.11736"
stable_identifier: "arXiv:2102.11736; DOI:10.48550/arXiv.2102.11736"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P348"
...
# Recurrent Model - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2102.11736 | https://arxiv.org/abs/2102.11736 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2102.11736 rendering | https://arxiv.org/html/2102.11736 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2102.11736 | https://arxiv.org/pdf/2102.11736 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Contact Optimization for - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Contact Optimization for/contact_optimization_for_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | AdaReP Adaptive - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-AdaReP Adaptive/adarep_adaptive_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Reimagination with - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Reimagination with/reimagination_with_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P348` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Zhengyu; Duan, Jingliang; Wang, Wenxuan; Li, Shengbo Eben; Yin, Yuming; Lin, Ziyu; Sun, Qi; Cheng, Bo. Submitted/source date: 2021/02/23. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P348`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “This paper proposes an offline control algorithm, called Recurrent Model Predictive Control (RMPC), in order to solve large-scale …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “This paper proposes an offline control algorithm, called Recurrent Model Predictive Control (RMPC), in order to solve large-scale …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: control, predictive | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies control, predictive, recurrent. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around control, predictive, recurrent. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “This paper proposes an offline control algorithm, called Recurrent Model Predictive Control (RMPC), in order to solve large-scale …”. The full-paper rendering contains 41 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “This paper proposes an offline control algorithm, called Recurrent Model Predictive Control (RMPC), in order to solve large-scale …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Model Predictive Control (MPC) is a well-known method to solve finite-horizon optimal control problems online, which has been …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving control, predictive, recurrent. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 44,108 of 75,964 units; duplicate exclusions 4; focus exclusions 24; source-gate exclusions 0; reselections 28.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; title/abstract evidence terms control, model, recurrent.
...
- The related DEPs show how control, predictive connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: control, predictive.
...
|---|---|---|---|
| Contact Optimization for - DEP-E | Related DEP | Overlap: predictive, control | `.lake-data/DEP-E/DEP-E-20260818-Contact Optimization for/contact_optimization_for_manuscript.md` |
| AdaReP Adaptive - DEP-E | Related DEP | Overlap: predictive, control | `.lake-data/DEP-E/DEP-E-20260819-AdaReP Adaptive/adarep_adaptive_manuscript.md` |
| Reimagination with - DEP-E | Related DEP | Overlap: predictive, control | `.lake-data/DEP-E/DEP-E-20260819-Reimagination with/reimagination_with_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2102.11736 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2102.11736 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2102.11736 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Contact Optimization for/contact_optimization_for_manuscript.md` | Related synthesis: predictive, control | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-AdaReP Adaptive/adarep_adaptive_manuscript.md` | Related synthesis: predictive, control | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Reimagination with/reimagination_with_manuscript.md` | Related synthesis: predictive, control | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 44,108 of 75,964 units from 75,967 PDFs.
...
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; terms control, model, recurrent.
