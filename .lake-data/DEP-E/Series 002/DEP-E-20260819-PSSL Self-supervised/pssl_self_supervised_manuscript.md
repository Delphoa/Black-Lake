---
title: "PSSL Self-supervised - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of PSSL: Self-supervised Learning for Personalized Search with Contrastive Sampling."
...
primary_url: "https://arxiv.org/abs/2111.12614"
stable_identifier: "arXiv:2111.12614; DOI:10.48550/arXiv.2111.12614"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P198"
...
# PSSL Self-supervised - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2111.12614 | https://arxiv.org/abs/2111.12614 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2111.12614 rendering | https://arxiv.org/html/2111.12614 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2111.12614 | https://arxiv.org/pdf/2111.12614 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Contrastive Neural - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Contrastive Neural/contrastive_neural_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | MSINet Twins Contrastive - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-MSINet Twins Contrastive/msinet_twins_contrastive_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Personalized Safety in - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260730-Personalized Safety in/personalized_safety_in_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P198` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhou, Yujia; Dou, Zhicheng; Zhu, Yutao; Wen, Ji-Rong. Submitted/source date: 2021/11/24. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P198`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: contrastive, personalized, search | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies contrastive, personalized, pssl. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around contrastive, personalized, pssl. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 68 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving contrastive, personalized, pssl. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 11,933 of 75,964 units; duplicate exclusions 0; focus exclusions 3; source-gate exclusions 0; reselections 3.
...
- The related DEPs show how contrastive, personalized, search connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: contrastive, personalized, search.
...
|---|---|---|---|
| Contrastive Neural - DEP-E | Related DEP | Overlap: contrastive, search | `.lake-data/DEP-E/DEP-E-20260819-Contrastive Neural/contrastive_neural_manuscript.md` |
| MSINet Twins Contrastive - DEP-E | Related DEP | Overlap: contrastive, search | `.lake-data/DEP-E/DEP-E-20260819-MSINet Twins Contrastive/msinet_twins_contrastive_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2111.12614 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2111.12614 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2111.12614 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Contrastive Neural/contrastive_neural_manuscript.md` | Related synthesis: contrastive, search | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-MSINet Twins Contrastive/msinet_twins_contrastive_manuscript.md` | Related synthesis: contrastive, search | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260730-Personalized Safety in/personalized_safety_in_manuscript.md` | Related synthesis: personalized | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 11,933 of 75,964 units from 75,967 PDFs.
