---
title: "OpenRad a Curated - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "OpenRad: a Curated Repository of Open-access AI models for Radiology"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260625-Local AI Intel 2343"
selection_record: "117 candidates; 28 excluded; 89 eligible; draw 3440391922; zero-based index 1"
expansion_record: "11 retained public locators; draw 1221975557; zero-based index 0"
...
# OpenRad a Curated - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260625-Local AI Intel 2343 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260625-Local%20AI%20Intel%202343/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-06-25_2343.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260625-Local%20AI%20Intel%202343/daily_research_findings_2026-06-25_2343.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | OpenRad: a Curated Repository of Open-access AI models for Radiology | Selected supporting source | arXiv record | 2603.02062 | https://arxiv.org/abs/2603.02062v1 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |
| S4 | Prior Report-Mark | Lineage context | Markdown | BL-DEP-Mark002 Report-Mark.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260625-Local%20AI%20Intel%202343/BL-DEP-Mark002%20Report-Mark.md | Prior review context | 2026-08-19 | Inspected |

- Paper/work title: OpenRad: a Curated Repository of Open-access AI models for Radiology
- Authors or producing organization: Konstantinos Vrettos; Galini Papadaki; Emmanouil Brilakis; Matthaios Triantafyllou; Dimitrios Leventis; Despina Staraki; Maria Mavroforou; Eleftherios Tzanis; Konstantina Giouroukou; Michail E. Klontzas
- Source platform: arXiv
- Publication date: 2026-03-02
- Revision/version date: 2026-03-02
- Stable identifier: 2603.02062
- Categories: cs.AI
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260625-Local%20AI%20Intel%202343/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260625-Local%20AI%20Intel%202343/daily_research_findings_2026-06-25_2343.md | Deposited source synthesis | ** The June 25 llama.cpp release b9789 packages binaries for macOS, Linux, Android arm64, Windows, CUDA 12/13, ROCm 7.2, Vulkan, OpenVINO 2026.2, SYCL, HIP/Radeon, and Windows OpenCL Adreno. The release commit fixes quantizing MoE models with MTP by using the full layer count in quantization state initialization. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2603.02062v1 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |
| E4 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260625-Local%20AI%20Intel%202343/BL-DEP-Mark002%20Report-Mark.md | Prior Report-Mark | Earlier review lineage and preserved references | Iterative-expansion context | Medium-high | Prior interpretation was not treated as fresh primary evidence. |

## Executive Summary

This artifact expands the selected DEP through OpenRad: a Curated Repository of Open-access AI models for Radiology. The deposited source package reports that ** The June 25 llama.cpp release b9789 packages binaries for macOS, Linux, Android arm64, Windows, CUDA 12/13, ROCm 7.2, Vulkan, OpenVINO 2026.2, SYCL, HIP/Radeon, and Windows OpenCL Adreno. The release commit fixes quantizing MoE models with MTP by using the full layer count in quantization state initialization. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** llama.cpp remains one of the most important local LLM runtimes, and the breadth of current artifacts shows local hosting is moving across consumer GPUs, mobile/Android, Intel OpenVINO, AMD ROCm/HIP, and cross-platform CPU paths. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** llama.cpp remains one of the most important local LLM runtimes, and the breadth of current artifacts shows local hosting is moving across consumer GPUs, mobile/Android, Intel OpenVINO, AMD ROCm/HIP, and cross-platform CPU paths.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** The June 25 llama.cpp release b9789 packages binaries for macOS, Linux, Android arm64, Windows, CUDA 12/13, ROCm 7.2, Vulkan, OpenVINO 2026.2, SYCL, HIP/Radeon, and Windows OpenCL Adreno. The release commit fixes quantizing MoE models with MTP by using the full layer count in quantization state initialization. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
|---|---|---|---|---|---|
| C1 | The deposited source package reports that ** The June 25 llama.cpp release b9789 packages binaries for macOS, Linux, Android arm64, Windows, CUDA 12/13, ROCm 7.2, Vulkan, OpenVINO 2026.2, SYCL, HIP/Radeon, and Windows OpenCL Adreno. The release commit fixes quantizing MoE models with MTP by using the full layer count in quantization state initialization. | Source-package claim | E2 | Preserved as a source claim; no independent rerun was performed. | Medium |
| C2 | The selected supporting record is OpenRad: a Curated Repository of Open-access AI models for Radiology, credited to Konstantinos Vrettos; Galini Papadaki; Emmanouil Brilakis; Matthaios Triantafyllou; Dimitrios Leventis; Despina Staraki; Maria Mavroforou; Eleftherios Tzanis; Konstantina Giouroukou; Michail E. Klontzas. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** llama.cpp remains one of the most important local LLM runtimes, and the breadth of current artifacts shows local hosting is moving across consumer GPUs, mobile/Android, Intel OpenVINO, AMD ROCm/HIP, and cross-platform CPU paths. | Reviewer interpretation grounded in source package | E1-E3, E4 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260625-Local AI Intel 2343 as a schema-complete DEP-E research artifact.
...
### New in this pass: OpenRad: a Curated Repository of Open-access AI models for Radiology

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [OpenRad: a Curated Repository of Open-access AI models for Radiology](https://arxiv.org/abs/2603.02062v1) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://github.com/ggml-org/llama.cpp/releases/tag/b9789 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://github.com/ggml-org/llama.cpp/commit/b3ce5cedf4c007b78a45befe839fa3abada03c0b | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://github.com/vllm-project/vllm/releases/tag/v0.23.0 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://github.com/ollama/ollama/releases/tag/v0.30.10 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://github.com/huggingface/transformers/releases/tag/v5.12.1 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260625-Local%20AI%20Intel%202343/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260625-Local%20AI%20Intel%202343/daily_research_findings_2026-06-25_2343.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2603.02062v1 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
| R4 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260625-Local%20AI%20Intel%202343/BL-DEP-Mark002%20Report-Mark.md | E4 and prior review lineage | 2026-08-19 | Prior Report-Mark inspected for iterative context. |
...
- Batch item: 27 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 28; eligible count 89.
- DEP draw: accepted UInt32 3440391922; rejection limit 4294967251; attempts 1; zero-based index 1.
- Supporting draw: pool 11; accepted UInt32 1221975557; rejection limit 4294967292; attempts 1; zero-based index 0.
