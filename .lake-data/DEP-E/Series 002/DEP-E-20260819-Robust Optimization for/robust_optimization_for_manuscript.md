---
title: "Robust Optimization for - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Robust Optimization for Fairness with Noisy Protected Groups."
...
primary_url: "https://arxiv.org/abs/2002.09343"
stable_identifier: "arXiv:2002.09343; DOI:10.48550/arXiv.2002.09343"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P103"
...
# Robust Optimization for - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2002.09343 | https://arxiv.org/abs/2002.09343 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2002.09343 rendering | https://arxiv.org/html/2002.09343 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2002.09343 | https://arxiv.org/pdf/2002.09343 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Improving Robust Fairness - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Improving Robust Fairness/improving_robust_fairness_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P103` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Serena; Guo, Wenshuo; Narasimhan, Harikrishna; Cotter, Andrew; Gupta, Maya; Jordan, Michael I.. Submitted/source date: 2020/02/21. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P103`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: fairness, groups, noisy, optimization, robust | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies fairness, groups, noisy. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around fairness, groups, noisy. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 137 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving fairness, groups, noisy. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 11,750 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how fairness, groups, noisy, optimization, robust connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: fairness, groups, noisy, optimization, robust.
...
|---|---|---|---|
| Improving Robust Fairness - DEP-E | Related DEP | Overlap: fairness, robust | `.lake-data/DEP-E/DEP-E-20260819-Improving Robust Fairness/improving_robust_fairness_manuscript.md` |
| HERO Hessian-Enhanced - DEP-E | Related DEP | Overlap: robust, optimization, fairness | `.lake-data/DEP-E/DEP-E-20260819-HERO Hessian-Enhanced/hero_hessian_enhanced_manuscript.md` |
| Noisy Poisson Inference - DEP-E | Related DEP | Overlap: noisy, groups, robust, optimization | `.lake-data/DEP-E/DEP-E-20260716-Noisy Poisson Inference/noisy_poisson_inference_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2002.09343 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2002.09343 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2002.09343 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Improving Robust Fairness/improving_robust_fairness_manuscript.md` | Related synthesis: fairness, robust | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-HERO Hessian-Enhanced/hero_hessian_enhanced_manuscript.md` | Related synthesis: robust, optimization, fairness | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260716-Noisy Poisson Inference/noisy_poisson_inference_manuscript.md` | Related synthesis: noisy, groups, robust, optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 11,750 of 75,964 units from 75,967 PDFs.
