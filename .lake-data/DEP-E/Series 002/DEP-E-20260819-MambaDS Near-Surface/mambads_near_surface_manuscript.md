---
title: "MambaDS Near-Surface - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of MambaDS: Near-Surface Meteorological Field Downscaling with Topography Constrained Selective State Space Modeling."
...
primary_url: "https://arxiv.org/abs/2408.10854"
stable_identifier: "arXiv:2408.10854; DOI:10.48550/arXiv.2408.10854"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P83"
...
# MambaDS Near-Surface - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2408.10854 | https://arxiv.org/abs/2408.10854 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2408.10854 rendering | https://arxiv.org/html/2408.10854 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2408.10854 | https://arxiv.org/pdf/2408.10854 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | Swimba Switch Mamba Model - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Swimba Switch Mamba Model/swimba_switch_mamba_model_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P83` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Zili; Chen, Hao; Bai, Lei; Li, Wenyuan; Ouyang, Wanli; Zou, Zhengxia; Shi, Zhenwei. Submitted/source date: 2024/08/20. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P83`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Recently, state space model (SSM), particularly its improved versions known as Mamba [ 39 ] , has garnered …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In an era of frequent extreme weather and global warming, obtaining precise, fine-grained near-surface weather forecasts is increasingly …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: modeling, selective, space, state | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies constrained, downscaling, field. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around constrained, downscaling, field. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Recently, state space model (SSM), particularly its improved versions known as Mamba [ 39 ] , has garnered …”. The full-paper rendering contains 68 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In an era of frequent extreme weather and global warming, obtaining precise, fine-grained near-surface weather forecasts is increasingly …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In an era of frequent extreme weather and global warming, obtaining precise, fine-grained near-surface weather forecasts is increasingly …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving constrained, downscaling, field. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 61,058 of 75,964 units; duplicate exclusions 0; focus exclusions 12; source-gate exclusions 0; reselections 12.
...
- The related DEPs show how modeling, selective, space, state connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: modeling, selective, space, state.
...
|---|---|---|---|
| S3MOT Monocular 3D Object - DEP-E | Related DEP | Overlap: selective, space, state | `.lake-data/DEP-E/DEP-E-20260818-S3MOT Monocular 3D Object/s3mot_monocular_3d_object_manuscript.md` |
| CMamba Learned Image - DEP-E | Related DEP | Overlap: space, state, modeling | `.lake-data/DEP-E/DEP-E-20260812-CMamba Learned Image/cmamba_learned_image_manuscript.md` |
| Swimba Switch Mamba Model - DEP-E | Related DEP | Overlap: space, state, modeling | `.lake-data/DEP-E/DEP-E-20260818-Swimba Switch Mamba Model/swimba_switch_mamba_model_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2408.10854 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2408.10854 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2408.10854 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-S3MOT Monocular 3D Object/s3mot_monocular_3d_object_manuscript.md` | Related synthesis: selective, space, state | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260812-CMamba Learned Image/cmamba_learned_image_manuscript.md` | Related synthesis: space, state, modeling | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Swimba Switch Mamba Model/swimba_switch_mamba_model_manuscript.md` | Related synthesis: space, state, modeling | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 61,058 of 75,964 units from 75,967 PDFs.
