---
title: "Lifetime-based - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Lifetime-based Optimization for Simulating Quantum Circuits on a New Sunway Supercomputer."
...
primary_url: "https://arxiv.org/abs/2205.00393"
stable_identifier: "arXiv:2205.00393; DOI:10.1145/3572848.3577529"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P177"
...
# Lifetime-based - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2205.00393 | https://arxiv.org/abs/2205.00393 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2205.00393 rendering | https://arxiv.org/html/2205.00393 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2205.00393 | https://arxiv.org/pdf/2205.00393 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | AutoQ 2 0 From - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-AutoQ 2 0 From/autoq_2_0_from_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Simulating Classroom - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260727-Simulating Classroom/simulating_classroom_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | PICBench Benchmarking - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260815-PICBench Benchmarking/picbench_benchmarking_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P177` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Chen, Yaojian; Liu, Yong; Shi, Xinmin; Song, Jiawei; Liu, Xin; Gan, Lin; Guo, Chu; Fu, Haohuan; Gao, Jie; Chen, Dexun; Yang, Guangwen. Submitted/source date: 2022/05/01. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P177`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: circuits, quantum, simulating | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies circuits, lifetime-based, optimization. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around circuits, lifetime-based, optimization. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving circuits, lifetime-based, optimization. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 55,198 of 75,964 units; duplicate exclusions 0; focus exclusions 2; source-gate exclusions 0; reselections 2.
...
- The related DEPs show how circuits, quantum, simulating connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: circuits, quantum, simulating.
...
|---|---|---|---|
| AutoQ 2 0 From - DEP-E | Related DEP | Overlap: circuits, quantum | `.lake-data/DEP-E/DEP-E-20260819-AutoQ 2 0 From/autoq_2_0_from_manuscript.md` |
...
| PICBench Benchmarking - DEP-E | Related DEP | Overlap: circuits, quantum | `.lake-data/DEP-E/DEP-E-20260815-PICBench Benchmarking/picbench_benchmarking_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2205.00393 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2205.00393 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2205.00393 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-AutoQ 2 0 From/autoq_2_0_from_manuscript.md` | Related synthesis: circuits, quantum | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260727-Simulating Classroom/simulating_classroom_manuscript.md` | Related synthesis: simulating | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260815-PICBench Benchmarking/picbench_benchmarking_manuscript.md` | Related synthesis: circuits, quantum | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 55,198 of 75,964 units from 75,967 PDFs.
