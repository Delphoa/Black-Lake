---
title: "Security of World Model - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260731-Tech Intel 1111"
selection_record: "117 candidates; 9 excluded; 108 eligible; draw 3730545698; zero-based index 86"
expansion_record: "24 retained public locators; draw 1782860790; zero-based index 6"
...
# Security of World Model - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260731-Tech Intel 1111 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201111/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-31_1111.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201111/daily_research_findings_2026-07-31_1111.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation | Selected supporting source | arXiv record | 2607.28226 | https://arxiv.org/abs/2607.28226v1 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation
- Authors or producing organization: Fazhong Liu; Zhuoyan Chen; Haozhen Tan; Yan Meng; Guoxing Chen; Haojin Zhu
- Source platform: arXiv
- Publication date: 2026-07-30
- Revision/version date: 2026-07-30
- Stable identifier: 2607.28226
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201111/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201111/daily_research_findings_2026-07-31_1111.md | Deposited source synthesis | ** SemPIC targets long-context retrieval and agent workloads that repeatedly reuse the same documents under different instructions, histories, and document orders. It trains a LoRA-enabled Writer to compile native per-layer document KV caches through behavioral distillation while leaving the pretrained decoder Reader unchanged, reporting mean micro-F1 improvement over KV Packet from 0.53 to 0.60 and approaching Full Recompute at 0.62. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2607.28226v1 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation. The deposited source package reports that ** SemPIC targets long-context retrieval and agent workloads that repeatedly reuse the same documents under different instructions, histories, and document orders. It trains a LoRA-enabled Writer to compile native per-layer document KV caches through behavioral distillation while leaving the pretrained decoder Reader unchanged, reporting mean micro-F1 improvement over KV Packet from 0.53 to 0.60 and approaching Full Recompute at 0.62. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** This is highly relevant to context systems because it treats reusable document context as a compiled serving object rather than prompt text. If robust, it could reduce repeated prefill cost for long-lived agents, retrieval-heavy assistants, and data-center inference workloads without changing the standard KV cache interface. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** This is highly relevant to context systems because it treats reusable document context as a compiled serving object rather than prompt text. If robust, it could reduce repeated prefill cost for long-lived agents, retrieval-heavy assistants, and data-center inference workloads without changing the standard KV cache interface.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** SemPIC targets long-context retrieval and agent workloads that repeatedly reuse the same documents under different instructions, histories, and document orders. It trains a LoRA-enabled Writer to compile native per-layer document KV caches through behavioral distillation while leaving the pretrained decoder Reader unchanged, reporting mean micro-F1 improvement over KV Packet from 0.53 to 0.60 and approaching Full Recompute at 0.62. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation, credited to Fazhong Liu; Zhuoyan Chen; Haozhen Tan; Yan Meng; Guoxing Chen; Haojin Zhu. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** This is highly relevant to context systems because it treats reusable document context as a compiled serving object rather than prompt text. If robust, it could reduce repeated prefill cost for long-lived agents, retrieval-heavy assistants, and data-center inference workloads without changing the standard KV cache interface. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260731-Tech Intel 1111 as a schema-complete DEP-E research artifact.
...
### New in this pass: Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [Security of World-Model-Based Embodied AI: A Lifecycle of Threats, Defenses, and Evaluation](https://arxiv.org/abs/2607.28226v1) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://arxiv.org/abs/2607.28069 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://doi.org/10.48550/arXiv.2607.28069 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.28272 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://doi.org/10.48550/arXiv.2607.28272 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.28103 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201111/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201111/daily_research_findings_2026-07-31_1111.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2607.28226v1 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 8 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 9; eligible count 108.
- DEP draw: accepted UInt32 3730545698; rejection limit 4294967220; attempts 1; zero-based index 86.
- Supporting draw: pool 24; accepted UInt32 1782860790; rejection limit 4294967280; attempts 1; zero-based index 6.
