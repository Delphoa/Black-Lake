---
title: "Robust Critics Defending - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Robust Critics: Defending LLMs Against Multi-Turn Attacks"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260725-Tech Intel 1101"
selection_record: "117 candidates; 20 excluded; 97 eligible; draw 1026952164; zero-based index 69"
expansion_record: "13 retained public locators; draw 3471170199; zero-based index 3"
...
# Robust Critics Defending - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260725-Tech Intel 1101 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260725-Tech%20Intel%201101/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-25_1101.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260725-Tech%20Intel%201101/daily_research_findings_2026-07-25_1101.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | Robust Critics: Defending LLMs Against Multi-Turn Attacks | Selected supporting source | arXiv record | 2607.20472 | https://arxiv.org/abs/2607.20472v1 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: Robust Critics: Defending LLMs Against Multi-Turn Attacks
- Authors or producing organization: Roman Belaire; Arunesh Sinha; Pradeep Varakantham
- Source platform: arXiv
- Publication date: 2026-05-24
- Revision/version date: 2026-05-24
- Stable identifier: 2607.20472
- Categories: cs.AI
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260725-Tech%20Intel%201101/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260725-Tech%20Intel%201101/daily_research_findings_2026-07-25_1101.md | Deposited source synthesis | Dialogue Critic Guided Sampling treats adversarial dialogue as a Markov decision process, infers intent at every turn, and scores candidate responses with token- and utterance-level value and regret critics. The paper reports improvements over robust baselines and frontier models on CARES-18k, WildJailbreak, Redbench, and HarmBench, with transfer to frontier models without fine-tuning. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2607.20472v1 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through Robust Critics: Defending LLMs Against Multi-Turn Attacks. The deposited source package reports that Dialogue Critic Guided Sampling treats adversarial dialogue as a Markov decision process, infers intent at every turn, and scores candidate responses with token- and utterance-level value and regret critics. The paper reports improvements over robust baselines and frontier models on CARES-18k, WildJailbreak, Redbench, and HarmBench, with transfer to frontier models without fine-tuning. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that Harmful intent can emerge only after several individually benign exchanges, so single-turn refusal tests under-measure agent risk. A trajectory-aware critic provides a concrete defense and evaluation pattern for long-horizon conversations, while adaptive attackers, false positives, and deployment costs remain open validation requirements. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: Harmful intent can emerge only after several individually benign exchanges, so single-turn refusal tests under-measure agent risk. A trajectory-aware critic provides a concrete defense and evaluation pattern for long-horizon conversations, while adaptive attackers, false positives, and deployment costs remain open validation requirements.

### Source-reported contribution

The selected DEP summarizes the contribution this way: Dialogue Critic Guided Sampling treats adversarial dialogue as a Markov decision process, infers intent at every turn, and scores candidate responses with token- and utterance-level value and regret critics. The paper reports improvements over robust baselines and frontier models on CARES-18k, WildJailbreak, Redbench, and HarmBench, with transfer to frontier models without fine-tuning. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is Robust Critics: Defending LLMs Against Multi-Turn Attacks, credited to Roman Belaire; Arunesh Sinha; Pradeep Varakantham. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | Harmful intent can emerge only after several individually benign exchanges, so single-turn refusal tests under-measure agent risk. A trajectory-aware critic provides a concrete defense and evaluation pattern for long-horizon conversations, while adaptive attackers, false positives, and deployment costs remain open validation requirements. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260725-Tech Intel 1101 as a schema-complete DEP-E research artifact.
...
### New in this pass: Robust Critics: Defending LLMs Against Multi-Turn Attacks

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [Robust Critics: Defending LLMs Against Multi-Turn Attacks](https://arxiv.org/abs/2607.20472v1) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://arxiv.org/abs/2607.20466 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.20468 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.20469 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.20527 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.21000 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260725-Tech%20Intel%201101/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260725-Tech%20Intel%201101/daily_research_findings_2026-07-25_1101.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2607.20472v1 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 19 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 20; eligible count 97.
- DEP draw: accepted UInt32 1026952164; rejection limit 4294967261; attempts 1; zero-based index 69.
- Supporting draw: pool 13; accepted UInt32 3471170199; rejection limit 4294967287; attempts 1; zero-based index 3.
