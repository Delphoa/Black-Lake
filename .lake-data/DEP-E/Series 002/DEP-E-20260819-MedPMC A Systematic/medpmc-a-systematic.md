...
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260710-Tech Intel 0103 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%200103/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-10_0103.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%200103/daily_research_findings_2026-07-10_0103.md | Repository evidence; public URL | 2026-08-19 | Inspected |
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%200103/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%200103/daily_research_findings_2026-07-10_0103.md | Deposited source synthesis | ** Introduces SAO, an asynchronous RL method for long-horizon LLM agents that uses one rollout per prompt, value-model design changes, and strict double-sided token-level clipping. The paper reports stable thousand-step training and gains over GRPO variants on agentic coding and reasoning benchmarks, with deployment in the GLM-5.2 agentic RL pipeline. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
...
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%200103/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260710-Tech%20Intel%200103/daily_research_findings_2026-07-10_0103.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
