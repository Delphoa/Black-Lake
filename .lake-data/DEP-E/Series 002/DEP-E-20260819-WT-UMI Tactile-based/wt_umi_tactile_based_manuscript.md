---
title: "WT-UMI Tactile-based - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of WT-UMI: Tactile-based Whole-Body Manipulation via Force-Supervised Contact-Aware Planning."
...
primary_url: "https://arxiv.org/abs/2606.13232"
stable_identifier: "arXiv:2606.13232; DOI:10.48550/arXiv.2606.13232"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P120"
...
# WT-UMI Tactile-based - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2606.13232 | https://arxiv.org/abs/2606.13232 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2606.13232 rendering | https://arxiv.org/html/2606.13232 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2606.13232 | https://arxiv.org/pdf/2606.13232 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | One-shot Adaptation of - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-One-shot Adaptation of/one_shot_adaptation_of_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P120` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Jang, Jaehwi; Gu, Zhaoyuan; Cueva, Alfred; Chai, Zimeng; Sheng, Junjie; Nguyen, Thong; Galundia, Himank; Wu, Yifan; Xue, Huishu; Legene, Isaac; Mediratta, Ojas; Doan, Davin; Collins, Andrew; Sadegh, Sarah; Kim, KyoungMok; Dhalbisoi, Rishita; Chen, Zun; Zhao, Ye. Submitted/source date: 2026/06/11. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P120`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: contact-aware, manipulation, planning, whole-body | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies contact-aware, force-supervised, manipulation. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around contact-aware, force-supervised, manipulation. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving contact-aware, force-supervised, manipulation. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 26,844 of 75,964 units; duplicate exclusions 0; focus exclusions 5; source-gate exclusions 0; reselections 5.
...
- The related DEPs show how contact-aware, manipulation, planning, whole-body connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: contact-aware, manipulation, planning, whole-body.
...
|---|---|---|---|
| One-shot Adaptation of - DEP-E | Related DEP | Overlap: whole-body, planning | `.lake-data/DEP-E/DEP-E-20260818-One-shot Adaptation of/one_shot_adaptation_of_manuscript.md` |
| FAVLA Fast-Slow - DEP-E | Related DEP | Overlap: manipulation, contact-aware, planning | `.lake-data/DEP-E/DEP-E-20260722-FAVLA Fast-Slow/favla_fast_slow_manuscript.md` |
| Document Fraud LLM - DEP-E | Related DEP | Overlap: manipulation, planning | `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM/document_fraud_llm_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2606.13232 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2606.13232 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2606.13232 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-One-shot Adaptation of/one_shot_adaptation_of_manuscript.md` | Related synthesis: whole-body, planning | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260722-FAVLA Fast-Slow/favla_fast_slow_manuscript.md` | Related synthesis: manipulation, contact-aware, planning | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM/document_fraud_llm_manuscript.md` | Related synthesis: manipulation, planning | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 26,844 of 75,964 units from 75,967 PDFs.
