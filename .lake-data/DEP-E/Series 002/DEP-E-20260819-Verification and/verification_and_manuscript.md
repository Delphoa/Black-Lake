---
title: "Verification and - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Verification and Synthesis of Robust Control Barrier Functions: Multilevel Polynomial Optimization and Semidefinite Relaxation."
...
primary_url: "https://arxiv.org/abs/2303.10081"
stable_identifier: "arXiv:2303.10081; DOI:10.48550/arXiv.2303.10081"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P122"
...
# Verification and - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2303.10081 | https://arxiv.org/abs/2303.10081 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2303.10081 rendering | https://arxiv.org/html/2303.10081 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2303.10081 | https://arxiv.org/pdf/2303.10081 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | RRT-CBF Motion - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260711-RRT-CBF Motion/rrt_cbf_motion_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Visual-inertial state - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Visual-inertial state/visual_inertial_state_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Breaking the Sample - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Breaking the Sample/breaking_the_sample_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P122` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Kang, Shucheng; Chen, Yuxiao; Yang, Heng; Pavone, Marco. Submitted/source date: 2023/03/17. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P122`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We study the problem of verification and synthesis of robust control barrier functions (CBF) for control-affine polynomial systems …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We now apply semidefinite relaxations to solve the verification problem (Section 4.1 ) and the synthesis problem (Section …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: barrier, control, functions, optimization, polynomial | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies barrier, control, functions. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around barrier, control, functions. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We study the problem of verification and synthesis of robust control barrier functions (CBF) for control-affine polynomial systems …”. The full-paper rendering contains 69 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We now apply semidefinite relaxations to solve the verification problem (Section 4.1 ) and the synthesis problem (Section …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Current literature around (robust) CBF mainly focus on the CBF deployment problem: given a CBF, synthesize a safe …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving barrier, control, functions. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 71,563 of 75,964 units; duplicate exclusions 5; focus exclusions 37; source-gate exclusions 0; reselections 42.
...
- The related DEPs show how barrier, control, functions, optimization, polynomial connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: barrier, control, functions, optimization, polynomial.
...
|---|---|---|---|
| RRT-CBF Motion - DEP-E | Related DEP | Overlap: barrier, functions, control, optimization, verification | `.lake-data/DEP-E/DEP-E-20260711-RRT-CBF Motion/rrt_cbf_motion_manuscript.md` |
| Visual-inertial state - DEP-E | Related DEP | Overlap: polynomial, optimization, verification, control, synthesis | `.lake-data/DEP-E/DEP-E-20260819-Visual-inertial state/visual_inertial_state_manuscript.md` |
| Breaking the Sample - DEP-E | Related DEP | Overlap: barrier, verification, control, synthesis | `.lake-data/DEP-E/DEP-E-20260818-Breaking the Sample/breaking_the_sample_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2303.10081 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2303.10081 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2303.10081 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260711-RRT-CBF Motion/rrt_cbf_motion_manuscript.md` | Related synthesis: barrier, functions, control, optimization, verification | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Visual-inertial state/visual_inertial_state_manuscript.md` | Related synthesis: polynomial, optimization, verification, control, synthesis | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Breaking the Sample/breaking_the_sample_manuscript.md` | Related synthesis: barrier, verification, control, synthesis | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 71,563 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 5; focus exclusions: 37; source-gate exclusions: 0; reselections: 42; 24-hour cutoff: 2026-08-18.
