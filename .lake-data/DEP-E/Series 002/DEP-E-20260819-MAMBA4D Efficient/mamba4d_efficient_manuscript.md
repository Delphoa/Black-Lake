---
title: "MAMBA4D Efficient - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of MAMBA4D: Efficient Long-Sequence Point Cloud Video Understanding with Disentangled Spatial-Temporal State Space Models."
...
primary_url: "https://arxiv.org/abs/2405.14338"
stable_identifier: "arXiv:2405.14338; DOI:10.48550/arXiv.2405.14338"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P176"
...
# MAMBA4D Efficient - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2405.14338 | https://arxiv.org/abs/2405.14338 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2405.14338 rendering | https://arxiv.org/html/2405.14338 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2405.14338 | https://arxiv.org/pdf/2405.14338 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Efficient Global - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Efficient Global/efficient_global_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | AdaVideoRAG - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-AdaVideoRAG/adavideorag_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Counting How the Seconds - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Counting How the Seconds/counting_how_the_seconds_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P176` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Jiuming; Han, Jinru; Liu, Lihao; Aviles-Rivero, Angelica I.; Jiang, Chaokang; Liu, Zhe; Wang, Hesheng. Submitted/source date: 2024/05/23. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P176`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Per a passed 2018 PAMI-TC motion, reviewers should refrain from requesting significant additional experiments for the rebuttal or …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The author rebuttal is optional and, following similar guidelines to previous conferences, is meant to provide you with …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: cloud, point, understanding, video | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies cloud, disentangled, long-sequence. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around cloud, disentangled, long-sequence. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Per a passed 2018 PAMI-TC motion, reviewers should refrain from requesting significant additional experiments for the rebuttal or …”. The full-paper rendering contains 13 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The author rebuttal is optional and, following similar guidelines to previous conferences, is meant to provide you with …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “After receiving paper reviews, authors may optionally submit a rebuttal to address the reviewers’ comments, which will be …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving cloud, disentangled, long-sequence. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 56,206 of 75,964 units; duplicate exclusions 3; focus exclusions 34; source-gate exclusions 0; reselections 37.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; title/abstract evidence terms state space model, state space models, temporal state.
...
- The related DEPs show how cloud, point, understanding, video connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: cloud, point, understanding, video.
...
|---|---|---|---|
| Efficient Global - DEP-E | Related DEP | Overlap: cloud, point, understanding | `.lake-data/DEP-E/DEP-E-20260819-Efficient Global/efficient_global_manuscript.md` |
| AdaVideoRAG - DEP-E | Related DEP | Overlap: understanding, video | `.lake-data/DEP-E/DEP-E-20260819-AdaVideoRAG/adavideorag_manuscript.md` |
| Counting How the Seconds - DEP-E | Related DEP | Overlap: understanding, video | `.lake-data/DEP-E/DEP-E-20260819-Counting How the Seconds/counting_how_the_seconds_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2405.14338 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2405.14338 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2405.14338 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Efficient Global/efficient_global_manuscript.md` | Related synthesis: cloud, point, understanding | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-AdaVideoRAG/adavideorag_manuscript.md` | Related synthesis: understanding, video | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Counting How the Seconds/counting_how_the_seconds_manuscript.md` | Related synthesis: understanding, video | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 56,206 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 3; focus exclusions: 34; source-gate exclusions: 0; reselections: 37; 24-hour cutoff: 2026-08-18.
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories stateful systems; terms state space model, state space models, temporal state.
