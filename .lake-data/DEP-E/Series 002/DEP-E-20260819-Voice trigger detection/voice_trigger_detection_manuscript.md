---
title: "Voice trigger detection - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Voice trigger detection from LVCSR hypothesis lattices using bidirectional lattice recurrent neural networks."
...
primary_url: "https://arxiv.org/abs/2003.00304"
stable_identifier: "arXiv:2003.00304; DOI:10.1109/ICASSP.2019.8682617"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P384"
...
# Voice trigger detection - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2003.00304 | https://arxiv.org/abs/2003.00304 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2003.00304 rendering | https://arxiv.org/html/2003.00304 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2003.00304 | https://arxiv.org/pdf/2003.00304 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | ST-GIN An Uncertainty - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-ST-GIN An Uncertainty/st_gin_an_uncertainty_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Unifying Isolated and - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Unifying Isolated and/unifying_isolated_and_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Lattice Spoken LM - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260731-Lattice Spoken LM/lattice_spoken_lm_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P384` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Jeon, Woojay; Liu, Leo; Mason, Henry. Submitted/source date: 2020/02/29. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P384`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We propose a method to reduce false voice triggers of a speech-enabled personal assistant by post-processing the hypothesis …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We propose a method to reduce false voice triggers of a speech-enabled personal assistant by post-processing the hypothesis …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: bidirectional, detection, hypothesis, lattice, lattices | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies bidirectional, detection, hypothesis. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around bidirectional, detection, hypothesis. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We propose a method to reduce false voice triggers of a speech-enabled personal assistant by post-processing the hypothesis …”. The full-paper rendering contains 27 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We propose a method to reduce false voice triggers of a speech-enabled personal assistant by post-processing the hypothesis …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Typically, an on-device detector [ 1 ] decides whether the trigger phrase was spoken, and if so allows …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving bidirectional, detection, hypothesis. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 55,085 of 75,964 units; duplicate exclusions 1; focus exclusions 9; source-gate exclusions 0; reselections 10.
...
- The related DEPs show how bidirectional, detection, hypothesis, lattice, lattices connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: bidirectional, detection, hypothesis, lattice, lattices.
...
|---|---|---|---|
| ST-GIN An Uncertainty - DEP-E | Related DEP | Overlap: bidirectional, recurrent, networks, neural, detection | `.lake-data/DEP-E/DEP-E-20260819-ST-GIN An Uncertainty/st_gin_an_uncertainty_manuscript.md` |
| Unifying Isolated and - DEP-E | Related DEP | Overlap: recurrent, networks, neural, detection, hypothesis | `.lake-data/DEP-E/DEP-E-20260819-Unifying Isolated and/unifying_isolated_and_manuscript.md` |
| Lattice Spoken LM - DEP-E | Related DEP | Overlap: lattice, neural, lattices, voice, bidirectional | `.lake-data/DEP-E/DEP-E-20260731-Lattice Spoken LM/lattice_spoken_lm_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2003.00304 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2003.00304 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2003.00304 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-ST-GIN An Uncertainty/st_gin_an_uncertainty_manuscript.md` | Related synthesis: bidirectional, recurrent, networks, neural, detection | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Unifying Isolated and/unifying_isolated_and_manuscript.md` | Related synthesis: recurrent, networks, neural, detection, hypothesis | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260731-Lattice Spoken LM/lattice_spoken_lm_manuscript.md` | Related synthesis: lattice, neural, lattices, voice, bidirectional | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 55,085 of 75,964 units from 75,967 PDFs.
