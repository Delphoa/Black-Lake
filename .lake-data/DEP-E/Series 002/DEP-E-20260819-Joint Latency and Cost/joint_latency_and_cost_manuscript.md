---
title: "Joint Latency and Cost - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Joint Latency and Cost Optimization for Erasure-coded Data Center Storage."
...
primary_url: "https://arxiv.org/abs/1404.4975"
stable_identifier: "arXiv:1404.4975; DOI:10.1109/TNET.2015.2466453"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P35"
...
# Joint Latency and Cost - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1404.4975 | https://arxiv.org/abs/1404.4975 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1404.4975 rendering | https://arxiv.org/html/1404.4975 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1404.4975 | https://arxiv.org/pdf/1404.4975 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | A practice-oriented - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A practice-oriented/a_practice_oriented_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Joint Sensing MEC - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260715-Joint Sensing MEC/joint_sensing_mec_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | COEVO Co-Evolutionary Framework - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-COEVO Co-Evolutionary Fra/coevo_co_evolutionary_fra_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P35` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Xiang, Yu; Lan, Tian; Aggarwal, Vaneet; Chen, Yih-Farn R. Submitted/source date: 2014/04/19. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P35`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Queuing-theoretic analysis. For a single file or multiple but homogeneous files, under an assumption of exponential service time …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Modern distributed storage systems offer large capacity to satisfy the exponentially increasing need of storage space. They often …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: center, cost, joint, latency, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies center, cost, erasure-coded. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around center, cost, erasure-coded. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Queuing-theoretic analysis. For a single file or multiple but homogeneous files, under an assumption of exponential service time …”. The full-paper rendering contains 69 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Modern distributed storage systems offer large capacity to satisfy the exponentially increasing need of storage space. They often …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Modern distributed storage systems offer large capacity to satisfy the exponentially increasing need of storage space. They often …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving center, cost, erasure-coded. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 11,599 of 75,964 units; duplicate exclusions 4; focus exclusions 17; source-gate exclusions 0; reselections 21.
...
- The related DEPs show how center, cost, joint, latency, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: center, cost, joint, latency, optimization.
...
|---|---|---|---|
| A practice-oriented - DEP-E | Related DEP | Overlap: center, optimization, joint, storage, cost | `.lake-data/DEP-E/DEP-E-20260819-A practice-oriented/a_practice_oriented_manuscript.md` |
| Joint Sensing MEC - DEP-E | Related DEP | Overlap: optimization, joint, latency, cost | `.lake-data/DEP-E/DEP-E-20260715-Joint Sensing MEC/joint_sensing_mec_manuscript.md` |
| COEVO Co-Evolutionary Framework - DEP-E | Related DEP | Overlap: optimization, joint, storage, cost | `.lake-data/DEP-E/DEP-E-20260723-COEVO Co-Evolutionary Fra/coevo_co_evolutionary_fra_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1404.4975 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1404.4975 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1404.4975 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-A practice-oriented/a_practice_oriented_manuscript.md` | Related synthesis: center, optimization, joint, storage, cost | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260715-Joint Sensing MEC/joint_sensing_mec_manuscript.md` | Related synthesis: optimization, joint, latency, cost | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260723-COEVO Co-Evolutionary Fra/coevo_co_evolutionary_fra_manuscript.md` | Related synthesis: optimization, joint, storage, cost | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 11,599 of 75,964 units from 75,967 PDFs.
