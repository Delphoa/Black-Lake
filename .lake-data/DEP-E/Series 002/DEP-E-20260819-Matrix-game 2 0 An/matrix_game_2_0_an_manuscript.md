---
title: "Matrix-game 2 0 An - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Matrix-game 2.0: An open-source real-time and streaming interactive world model."
...
primary_url: "https://arxiv.org/abs/2508.13009"
stable_identifier: "arXiv:2508.13009; DOI:10.48550/arXiv.2508.13009"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P216"
...
# Matrix-game 2 0 An - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2508.13009 | https://arxiv.org/abs/2508.13009 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2508.13009 rendering | https://arxiv.org/html/2508.13009 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2508.13009 | https://arxiv.org/pdf/2508.13009 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | How Far Are We to GPT-4V - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260813-How Far Are We to GPT-4V/how_far_are_we_to_gpt_4v_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | OpenYield An Open-Source - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-OpenYield An Open-Source/openyield_an_open_source_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P216` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: He, Xianglong; Peng, Chunli; Liu, Zexiang; Wang, Boyang; Zhang, Yifan; Cui, Qi; Kang, Fei; Jiang, Biao; An, Mengyin; Ren, Yangyang; Xu, Baixin; Guo, Hao-Xiang; Gong, Kaixiong; Wu, Size; Li, Wei; Song, Xuchen; Liu, Yang; Li, Yangguang; Zhou, Yahui. Submitted/source date: 2025/08/18. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P216`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Recent advances in interactive video generations have demonstrated diffusion model’s potential as world models by capturing complex physical …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “While some other works 51 ; 59 adopt a two-stage pipeline, first generating key frames and then applying …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: open-source, real-time, world | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies interactive, matrix-game, open-source. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around interactive, matrix-game, open-source. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Recent advances in interactive video generations have demonstrated diffusion model’s potential as world models by capturing complex physical …”. The full-paper rendering contains 74 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “While some other works 51 ; 59 adopt a two-stage pipeline, first generating key frames and then applying …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Recent advances in interactive video generations have demonstrated diffusion model’s potential as world models by capturing complex physical …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving interactive, matrix-game, open-source. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 61,817 of 75,964 units; duplicate exclusions 5; focus exclusions 23; source-gate exclusions 0; reselections 28.
...
- The related DEPs show how open-source, real-time, world connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: open-source, real-time, world.
...
|---|---|---|---|
| MoVerse Real-Time Video - DEP-E | Related DEP | Overlap: real-time, world | `.lake-data/DEP-E/DEP-E-20260819-MoVerse Real-Time Video/moverse_real_time_video_manuscript.md` |
...
| OpenYield An Open-Source - DEP-E | Related DEP | Overlap: open-source | `.lake-data/DEP-E/DEP-E-20260819-OpenYield An Open-Source/openyield_an_open_source_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2508.13009 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2508.13009 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2508.13009 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-MoVerse Real-Time Video/moverse_real_time_video_manuscript.md` | Related synthesis: real-time, world | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260813-How Far Are We to GPT-4V/how_far_are_we_to_gpt_4v_manuscript.md` | Related synthesis: open-source | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-OpenYield An Open-Source/openyield_an_open_source_manuscript.md` | Related synthesis: open-source | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 61,817 of 75,964 units from 75,967 PDFs.
