...
primary_subject: "Source-grounded review of Multi-objective optimization and explanation for stroke risk assessment in Shanxi province."
...
primary_url: "https://arxiv.org/abs/2107.14060"
stable_identifier: "arXiv:2107.14060; DOI:10.48550/arXiv.2107.14060"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P212"
...
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2107.14060 | https://arxiv.org/abs/2107.14060 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2107.14060 rendering | https://arxiv.org/html/2107.14060 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2107.14060 | https://arxiv.org/pdf/2107.14060 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | CLCI-Net Cross-Level - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260725-CLCI-Net Cross-Level/clci_net_cross_level_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P212` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Ma, Jing; Sun, Yiyang; Liu, Junjie; Huang, Huaxiong; Zhou, Xiaoshuang; Xu, Shixin. Submitted/source date: 2021/07/29. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P212`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Machine learning (ML) techniques are a set of powerful algorithms that are capable of modeling complex and hidden …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Stroke is the top leading causes of death in China (Zhou et al. The Lancet 2019). A dataset …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: assessment, multi-objective, optimization, risk, stroke | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies assessment, explanation, multi-objective. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around assessment, explanation, multi-objective. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Machine learning (ML) techniques are a set of powerful algorithms that are capable of modeling complex and hidden …”. The full-paper rendering contains 51 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Stroke is the top leading causes of death in China (Zhou et al. The Lancet 2019). A dataset …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Meanwhile, stroke is a preventable disease. A number of potent risk factors are reported such as age, systolic …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving assessment, explanation, multi-objective. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 9,459 of 75,964 units; duplicate exclusions 3; focus exclusions 2; source-gate exclusions 0; reselections 5.
...
- The related DEPs show how assessment, multi-objective, optimization, risk, stroke connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: assessment, multi-objective, optimization, risk, stroke.
...
|---|---|---|---|
| CLCI-Net Cross-Level - DEP-E | Related DEP | Overlap: stroke, risk, assessment | `.lake-data/DEP-E/DEP-E-20260725-CLCI-Net Cross-Level/clci_net_cross_level_manuscript.md` |
| Matching-Based Selection - DEP-E | Related DEP | Overlap: multi-objective, optimization, risk, assessment | `.lake-data/DEP-E/DEP-E-20260812-Matching-Based Selection/matching_based_selection_manuscript.md` |
| A Framework Based on - DEP-E | Related DEP | Overlap: multi-objective, optimization, risk, assessment | `.lake-data/DEP-E/DEP-E-20260819-A Framework Based on/a_framework_based_on_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2107.14060 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2107.14060 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2107.14060 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260725-CLCI-Net Cross-Level/clci_net_cross_level_manuscript.md` | Related synthesis: stroke, risk, assessment | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260812-Matching-Based Selection/matching_based_selection_manuscript.md` | Related synthesis: multi-objective, optimization, risk, assessment | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-A Framework Based on/a_framework_based_on_manuscript.md` | Related synthesis: multi-objective, optimization, risk, assessment | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 9,459 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 3; focus exclusions: 2; source-gate exclusions: 0; reselections: 5; 24-hour cutoff: 2026-08-18.
