---
title: "Movable Antenna Empowered - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Movable Antenna Empowered Downlink NOMA Systems: Power Allocation and Antenna Position Optimization."
...
primary_url: "https://arxiv.org/abs/2405.18692"
stable_identifier: "arXiv:2405.18692; DOI:10.48550/arXiv.2405.18692"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P73"
...
# Movable Antenna Empowered - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2405.18692 | https://arxiv.org/abs/2405.18692 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2405.18692 rendering | https://arxiv.org/html/2405.18692 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2405.18692 | https://arxiv.org/pdf/2405.18692 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Agentic AI Empowered - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Agentic AI Empowered/agentic_ai_empowered_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | SIM MARL Power - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260722-SIM MARL Power/sim_marl_power_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P73` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhou, Yufeng; Chen, Wen; Wu, Qingqing; Zhu, Xusheng; Cheng, Nan. Submitted/source date: 2024/05/29. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P73`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “This paper investigates a novel communication paradigm employing movable antennas (MAs) within a multiple-input single-output (MISO) non-orthogonal multiple …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “This paper investigates a novel communication paradigm employing movable antennas (MAs) within a multiple-input single-output (MISO) non-orthogonal multiple …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: allocation, antenna, downlink, empowered, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies antenna, allocation, downlink. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around antenna, allocation, downlink. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “This paper investigates a novel communication paradigm employing movable antennas (MAs) within a multiple-input single-output (MISO) non-orthogonal multiple …”. The full-paper rendering contains 28 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “This paper investigates a novel communication paradigm employing movable antennas (MAs) within a multiple-input single-output (MISO) non-orthogonal multiple …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In response to the limitations inherent in conventional antenna configurations, a pioneering antenna arrangement, namely the movable antenna …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving antenna, allocation, downlink. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 28,876 of 75,964 units; duplicate exclusions 4; focus exclusions 16; source-gate exclusions 0; reselections 20.
...
- The related DEPs show how allocation, antenna, downlink, empowered, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: allocation, antenna, downlink, empowered, optimization.
...
|---|---|---|---|
| Agentic AI Empowered - DEP-E | Related DEP | Overlap: empowered, optimization, systems | `.lake-data/DEP-E/DEP-E-20260819-Agentic AI Empowered/agentic_ai_empowered_manuscript.md` |
| SIM MARL Power - DEP-E | Related DEP | Overlap: allocation, power, downlink, optimization, systems | `.lake-data/DEP-E/DEP-E-20260722-SIM MARL Power/sim_marl_power_manuscript.md` |
| Low-Complexity - DEP-E | Related DEP | Overlap: downlink, antenna, power, optimization, systems | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2405.18692 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2405.18692 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2405.18692 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Agentic AI Empowered/agentic_ai_empowered_manuscript.md` | Related synthesis: empowered, optimization, systems | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260722-SIM MARL Power/sim_marl_power_manuscript.md` | Related synthesis: allocation, power, downlink, optimization, systems | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` | Related synthesis: downlink, antenna, power, optimization, systems | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 28,876 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 4; focus exclusions: 16; source-gate exclusions: 0; reselections: 20; 24-hour cutoff: 2026-08-18.
