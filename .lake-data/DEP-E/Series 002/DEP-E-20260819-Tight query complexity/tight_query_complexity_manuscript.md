---
title: "Tight query complexity - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Tight query complexity bounds for learning graph partitions."
...
primary_url: "https://arxiv.org/abs/2112.07897"
stable_identifier: "arXiv:2112.07897; DOI:10.48550/arXiv.2112.07897"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P233"
...
# Tight query complexity - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2112.07897 | https://arxiv.org/abs/2112.07897 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2112.07897 rendering | https://arxiv.org/html/2112.07897 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2112.07897 | https://arxiv.org/pdf/2112.07897 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Query Complexity of the - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Query Complexity of the/query_complexity_of_the_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Parameterized Complexity - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Parameterized Complexity/parameterized_complexity_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P233` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Xizhi; Mukherjee, Sayan. Submitted/source date: 2021/12/15. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P233`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Given a partition of a graph into connected components, the membership oracle asserts whether any two vertices of …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Given a partition of a graph into connected components, the membership oracle asserts whether any two vertices of …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: complexity, graph, query | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies bounds, complexity, graph. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around bounds, complexity, graph. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Given a partition of a graph into connected components, the membership oracle asserts whether any two vertices of …”. The full-paper rendering contains 52 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Given a partition of a graph into connected components, the membership oracle asserts whether any two vertices of …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “However, the best known lower bound for this fundamental problem of learning components with α \alpha was an …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving bounds, complexity, graph. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 75,771 of 75,964 units; duplicate exclusions 0; focus exclusions 6; source-gate exclusions 0; reselections 6.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; title/abstract evidence terms complexity, graph.
...
- The related DEPs show how complexity, graph, query connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: complexity, graph, query.
...
|---|---|---|---|
| Query Complexity of the - DEP-E | Related DEP | Overlap: query, complexity, graph | `.lake-data/DEP-E/DEP-E-20260818-Query Complexity of the/query_complexity_of_the_manuscript.md` |
| Memory-augmented Query - DEP-E | Related DEP | Overlap: query, graph | `.lake-data/DEP-E/DEP-E-20260819-Memory-augmented Query/memory_augmented_query_manuscript.md` |
| Parameterized Complexity - DEP-E | Related DEP | Overlap: complexity, graph | `.lake-data/DEP-E/DEP-E-20260818-Parameterized Complexity/parameterized_complexity_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2112.07897 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2112.07897 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2112.07897 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Query Complexity of the/query_complexity_of_the_manuscript.md` | Related synthesis: query, complexity, graph | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Memory-augmented Query/memory_augmented_query_manuscript.md` | Related synthesis: query, graph | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Parameterized Complexity/parameterized_complexity_manuscript.md` | Related synthesis: complexity, graph | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 75,771 of 75,964 units from 75,967 PDFs.
...
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; terms complexity, graph.
