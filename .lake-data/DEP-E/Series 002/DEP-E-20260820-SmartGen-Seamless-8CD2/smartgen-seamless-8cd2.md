---
title: "SmartGen Seamless - DEP-E"
generated_at: "2026-08-19T22:59:33Z"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of SmartGen: Seamless Disaggregated LLM Inference with Selective KV Cache Transfer"
...
primary_url: "https://arxiv.org/abs/2607.28150"
stable_identifier: "arXiv:2607.28150"
...
# SmartGen Seamless - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Repository-relative path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | SmartGen: Seamless Disaggregated LLM Inference with Selective KV Cache Transfer | Primary research artifact | arXiv HTML and Atom metadata | arXiv:2607.28150 | https://arxiv.org/abs/2607.28150; https://arxiv.org/html/2607.28150 | Public research source; no source file redistributed | 2026-08-20 | Inspected |
| S2 | Selected source DEP | Provenance and deposited finding | Markdown | DEP-20260731-Tech Intel 1305 | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201305 | Repository evidence; no source file copied | 2026-08-20 | Inspected |

The selected DEP contains 2 inspected Markdown file(s) and no newly collected source payload. The primary publication date recorded by official metadata is `2026-07-30T12:56:05Z`. No prior Report-Mark was present in the selected DEP, so this is an initial processing pass and no iterative supporting-document draw was required.
...
This DEP-E artifact reviews *SmartGen: Seamless Disaggregated LLM Inference with Selective KV Cache Transfer*, attributed to Xuchuan Luo; Jiacheng Shen; Xin Wang; Yangfan Zhou. The selected source DEP characterizes the work as a current research claim and summarizes it as follows: This work defines derived-feature over-trust as the failure mode where an LLM treats derived measurements as direct facts or applies them outside their valid scope. Using paired PPG-ECG records, it evaluates whether LLM pipelines over-accept unreliable PPG-derived rhythm or over-reject reliable PPG under misleading history. The authors define five estimands and test an ECG-to-PPG privileged distillation baseline on 50,000 paired records and a protocol-locked 187-patient test. [E1, E3]. Official arXiv metadata and full HTML were inspected, while no source file, dataset, code repository, model, or execution trace was collected.
...
Reviewer interpretation: This is relevant to inference cost and energy because it moves dynamic sparsity below the layer level while still addressing kernel practicality. Agentic workloads with heterogeneous context and decode profiles need these kinds of adaptive compute controls to scale economically. This is a reason to prioritize structured evaluation, not a basis for production, clinical, security, procurement, or policy decisions without the independent checks listed below.

## Detailed Summary

### Problem and contribution

The primary source addresses the research object identified by its canonical title, *SmartGen: Seamless Disaggregated LLM Inference with Selective KV Cache Transfer*. The source DEP preserves the following concise account: This work defines derived-feature over-trust as the failure mode where an LLM treats derived measurements as direct facts or applies them outside their valid scope. Using paired PPG-ECG records, it evaluates whether LLM pipelines over-accept unreliable PPG-derived rhythm or over-reject reliable PPG under misleading history. The authors define five estimands and test an ECG-to-PPG privileged distillation baseline on 50,000 paired records and a protocol-locked 187-patient test. [E1, E3]. This artifact treats that account as a source-reported claim rather than an independently established fact.
...
- Sources inspected: Every Markdown file in `Black-Lake-Data/.lake-data/DEP-20260731-Tech Intel 1305`, the canonical primary record, official metadata, and full HTML when accessible; the latest Report-Mark was also inspected for iterative passes.
...
|---|---|---|---|
| SmartGen: Seamless Disaggregated LLM Inference with Selective KV Cache Transfer | Primary research thread | Primary work selected from the source DEP and inspected in this pass. | https://arxiv.org/abs/2607.28150 |
| Official full-text representation | Primary source format | Full HTML used to locate abstract, methodology, evaluation, limitations, and conclusion evidence where available. | https://arxiv.org/html/2607.28150 |
| Selected source DEP | Provenance record | Preserves the deposited finding, source inventory, and explicit non-reproduction boundary. | https://github.com/Delphoa-Labs/Black-Lake-Data/tree/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201305 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | http://arxiv.org/abs/1911.12237 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2107.03374 |
| Related locator | Citation or source-deposited context | Discovered through inspected evidence but not independently reviewed in this pass. | https://arxiv.org/abs/2607.27844 |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2607.28150 | Canonical title, authors, abstract, identifier, and source status | 2026-08-20 | Primary record inspected |
| R2 | https://arxiv.org/html/2607.28150 | Full-text section structure, method/evaluation trace, limitations, and conclusion | 2026-08-20 | Full HTML inspected |
| R3 | https://export.arxiv.org/api/query?id_list=2607.28150 | Canonical Atom metadata and abstract | 2026-08-20 | Official arXiv API inspected |
| R4 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201305/daily_research_findings_2026-07-31_1305.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
| R5 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260731-Tech%20Intel%201305/README.md | Selected DEP inventory, deposited claim, or prior Report-Mark context | 2026-08-20 | Repository file inspected by URL; not collected |
...
- Selection order: 196 of 200
- Cryptographic draw: `1159733815` accepted on attempt 1, rejection limit `4294967056`, zero-based index `73` from a pool of 823.
...
- `Black-Lake-Data/.lake-data/DEP-20260731-Tech Intel 1305/daily_research_findings_2026-07-31_1305.md` - inspected repository file
- `Black-Lake-Data/.lake-data/DEP-20260731-Tech Intel 1305/README.md` - inspected repository file
