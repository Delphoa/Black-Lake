---
title: "Sparse Convolutional - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Sparse Convolutional Recurrent Learning for Efficient Event-based Neuromorphic Object Detection."
...
primary_url: "https://arxiv.org/abs/2506.13440"
stable_identifier: "arXiv:2506.13440; DOI:10.48550/arXiv.2506.13440"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P353"
...
# Sparse Convolutional - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2506.13440 | https://arxiv.org/abs/2506.13440 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2506.13440 rendering | https://arxiv.org/html/2506.13440 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2506.13440 | https://arxiv.org/pdf/2506.13440 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | MambaPupil Bidirectional - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-MambaPupil Bidirectional/mambapupil_bidirectional_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | From Sim-to-Real Toward - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-From Sim-to-Real Toward/from_sim_to_real_toward_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P353` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Shenqi; Xu, Yingfu; Yousefzadeh, Amirreza; Eissa, Sherif; Corporaal, Henk; Corradi, Federico; Tang, Guangzhi. Submitted/source date: 2025/06/16. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P353`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: convolutional, detection, event-based, object, recurrent | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies convolutional, detection, event-based. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around convolutional, detection, event-based. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 51 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving convolutional, detection, event-based. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 28,751 of 75,964 units; duplicate exclusions 6; focus exclusions 29; source-gate exclusions 0; reselections 35.
...
- The related DEPs show how convolutional, detection, event-based, object, recurrent connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: convolutional, detection, event-based, object, recurrent.
...
|---|---|---|---|
| MambaPupil Bidirectional - DEP-E | Related DEP | Overlap: event-based, recurrent, object, detection | `.lake-data/DEP-E/DEP-E-20260819-MambaPupil Bidirectional/mambapupil_bidirectional_manuscript.md` |
| Unifying Isolated and - DEP-E | Related DEP | Overlap: recurrent, convolutional, detection | `.lake-data/DEP-E/DEP-E-20260819-Unifying Isolated and/unifying_isolated_and_manuscript.md` |
| From Sim-to-Real Toward - DEP-E | Related DEP | Overlap: event-based, detection | `.lake-data/DEP-E/DEP-E-20260819-From Sim-to-Real Toward/from_sim_to_real_toward_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2506.13440 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2506.13440 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2506.13440 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-MambaPupil Bidirectional/mambapupil_bidirectional_manuscript.md` | Related synthesis: event-based, recurrent, object, detection | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Unifying Isolated and/unifying_isolated_and_manuscript.md` | Related synthesis: recurrent, convolutional, detection | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-From Sim-to-Real Toward/from_sim_to_real_toward_manuscript.md` | Related synthesis: event-based, detection | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 28,751 of 75,964 units from 75,967 PDFs.
