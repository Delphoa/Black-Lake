---
title: "RTLCurator Label - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "RTLCurator: Label-Efficient Data Curation for RTL Generation"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260804-Tech Intel 1103"
selection_record: "117 candidates; 39 excluded; 78 eligible; draw 3470485740; zero-based index 72"
expansion_record: "10 retained public locators; draw 3210305186; zero-based index 6"
...
# RTLCurator Label - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260804-Tech Intel 1103 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260804-Tech%20Intel%201103/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-08-04_1103.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260804-Tech%20Intel%201103/daily_research_findings_2026-08-04_1103.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | RTLCurator: Label-Efficient Data Curation for RTL Generation | Selected supporting source | arXiv record | 2607.29283 | https://arxiv.org/abs/2607.29283v1 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: RTLCurator: Label-Efficient Data Curation for RTL Generation
- Authors or producing organization: Siyang Cai; Cangyuan Li; Wenjing Chang; Kun Wang; Haoyu Gao; Yinhe Han; Ying Wang
- Source platform: arXiv
- Publication date: 2026-07-31
- Revision/version date: 2026-07-31
- Stable identifier: 2607.29283
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260804-Tech%20Intel%201103/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260804-Tech%20Intel%201103/daily_research_findings_2026-08-04_1103.md | Deposited source synthesis | ** RTLCurator addresses scarce and noisy specification-to-RTL corpora, noting that only 24.4% and 53.5% of pairs pass generated functional tests in two widely used datasets. Rather than filtering only by correctness, it learns a behavior-aware compatibility prior from simulation failures and balances alignment, representation coverage, and structural richness. On CodeV and RTLCoder, retaining 80% of the corpus with only 10% of the pool validated improves all reported metrics over full-corpus training, while score-only ranking performs worse than random selection. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2607.29283v1 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through RTLCurator: Label-Efficient Data Curation for RTL Generation. The deposited source package reports that ** RTLCurator addresses scarce and noisy specification-to-RTL corpora, noting that only 24.4% and 53.5% of pairs pass generated functional tests in two widely used datasets. Rather than filtering only by correctness, it learns a behavior-aware compatibility prior from simulation failures and balances alignment, representation coverage, and structural richness. On CodeV and RTLCoder, retaining 80% of the corpus with only 10% of the pool validated improves all reported metrics over full-corpus training, while score-only ranking performs worse than random selection. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** AI-assisted chip design depends on training data that captures difficult sequential behavior, not merely syntactic or short-module regularities. Label-efficient curation can make RTL generation more reliable without requiring exhaustive simulation of every example. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** AI-assisted chip design depends on training data that captures difficult sequential behavior, not merely syntactic or short-module regularities. Label-efficient curation can make RTL generation more reliable without requiring exhaustive simulation of every example.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** RTLCurator addresses scarce and noisy specification-to-RTL corpora, noting that only 24.4% and 53.5% of pairs pass generated functional tests in two widely used datasets. Rather than filtering only by correctness, it learns a behavior-aware compatibility prior from simulation failures and balances alignment, representation coverage, and structural richness. On CodeV and RTLCoder, retaining 80% of the corpus with only 10% of the pool validated improves all reported metrics over full-corpus training, while score-only ranking performs worse than random selection. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is RTLCurator: Label-Efficient Data Curation for RTL Generation, credited to Siyang Cai; Cangyuan Li; Wenjing Chang; Kun Wang; Haoyu Gao; Yinhe Han; Ying Wang. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** AI-assisted chip design depends on training data that captures difficult sequential behavior, not merely syntactic or short-module regularities. Label-efficient curation can make RTL generation more reliable without requiring exhaustive simulation of every example. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260804-Tech Intel 1103 as a schema-complete DEP-E research artifact.
...
### New in this pass: RTLCurator: Label-Efficient Data Curation for RTL Generation

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [RTLCurator: Label-Efficient Data Curation for RTL Generation](https://arxiv.org/abs/2607.29283v1) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://arxiv.org/abs/2607.29167 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.29069 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.28884 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.29019 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.29626 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260804-Tech%20Intel%201103/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260804-Tech%20Intel%201103/daily_research_findings_2026-08-04_1103.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2607.29283v1 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 38 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 39; eligible count 78.
- DEP draw: accepted UInt32 3470485740; rejection limit 4294967274; attempts 1; zero-based index 72.
- Supporting draw: pool 10; accepted UInt32 3210305186; rejection limit 4294967290; attempts 1; zero-based index 6.
