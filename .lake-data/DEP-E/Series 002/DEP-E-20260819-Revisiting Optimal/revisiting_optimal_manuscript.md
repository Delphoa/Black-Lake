---
title: "Revisiting Optimal - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Revisiting Optimal Convergence Rate for Smooth and Non-convex Stochastic Decentralized Optimization."
...
primary_url: "https://arxiv.org/abs/2210.07863"
stable_identifier: "arXiv:2210.07863; DOI:10.48550/arXiv.2210.07863"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P331"
...
# Revisiting Optimal - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2210.07863 | https://arxiv.org/abs/2210.07863 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2210.07863 rendering | https://arxiv.org/html/2210.07863 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2210.07863 | https://arxiv.org/pdf/2210.07863 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | STIMULUS Achieving Fast - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-STIMULUS Achieving Fast/stimulus_achieving_fast_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Optimal Convergence - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Optimal Convergence/optimal_convergence_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Hypersphere Optimization - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Hypersphere Optimization/hypersphere_optimization_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P331` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Yuan, Kun; Huang, Xinmeng; Chen, Yiming; Zhang, Xiaohan; Zhang, Yingya; Pan, Pan. Submitted/source date: 2022/10/14. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P331`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “This paper revisits non-convex stochastic decentralized optimization and establishes an optimal convergence rate with general weight matrices. In …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “This paper revisits non-convex stochastic decentralized optimization and establishes an optimal convergence rate with general weight matrices. In …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: convergence, optimal, optimization, smooth, stochastic | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies convergence, decentralized, non-convex. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around convergence, decentralized, non-convex. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “This paper revisits non-convex stochastic decentralized optimization and establishes an optimal convergence rate with general weight matrices. In …”. The full-paper rendering contains 110 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “This paper revisits non-convex stochastic decentralized optimization and establishes an optimal convergence rate with general weight matrices. In …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Decentralized optimization is effective to save communication in large-scale machine learning. Although numerous algorithms have been proposed with …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving convergence, decentralized, non-convex. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 51,700 of 75,964 units; duplicate exclusions 4; focus exclusions 6; source-gate exclusions 0; reselections 10.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; title/abstract evidence terms convergence, optimization.
...
- The related DEPs show how convergence, optimal, optimization, smooth, stochastic connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: convergence, optimal, optimization, smooth, stochastic.
...
|---|---|---|---|
| STIMULUS Achieving Fast - DEP-E | Related DEP | Overlap: stochastic, convergence | `.lake-data/DEP-E/DEP-E-20260819-STIMULUS Achieving Fast/stimulus_achieving_fast_manuscript.md` |
| Optimal Convergence - DEP-E | Related DEP | Overlap: optimal, convergence | `.lake-data/DEP-E/DEP-E-20260819-Optimal Convergence/optimal_convergence_manuscript.md` |
| Hypersphere Optimization - DEP-E | Related DEP | Overlap: smooth, optimization | `.lake-data/DEP-E/DEP-E-20260819-Hypersphere Optimization/hypersphere_optimization_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2210.07863 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2210.07863 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2210.07863 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-STIMULUS Achieving Fast/stimulus_achieving_fast_manuscript.md` | Related synthesis: stochastic, convergence | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Optimal Convergence/optimal_convergence_manuscript.md` | Related synthesis: optimal, convergence | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Hypersphere Optimization/hypersphere_optimization_manuscript.md` | Related synthesis: smooth, optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 51,700 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 4; focus exclusions: 6; source-gate exclusions: 0; reselections: 10; 24-hour cutoff: 2026-08-18.
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; terms convergence, optimization.
