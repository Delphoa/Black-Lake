---
title: "Improving Viability of - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Improving Viability of Electric Taxis by Taxi Service Strategy Optimization: A Big Data Study of New York City."
...
primary_url: "https://arxiv.org/abs/1709.08463"
stable_identifier: "arXiv:1709.08463; DOI:10.1109/TITS.2018.2839265"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P179"
...
# Improving Viability of - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1709.08463 | https://arxiv.org/abs/1709.08463 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1709.08463 rendering | https://arxiv.org/html/1709.08463 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1709.08463 | https://arxiv.org/pdf/1709.08463 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P179` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Tseng, Chien-Ming; Chau, Sid Chi-Kin; Liu, Xue. Submitted/source date: 2017/09/25. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P179`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: big, improving, optimization, strategy | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies big, city, electric. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around big, city, electric. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving big, city, electric. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 26,609 of 75,964 units; duplicate exclusions 2; focus exclusions 8; source-gate exclusions 0; reselections 10.
...
- The related DEPs show how big, improving, optimization, strategy connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: big, improving, optimization, strategy.
...
|---|---|---|---|
| When Traffic Flow - DEP-E | Related DEP | Overlap: big, optimization, strategy | `.lake-data/DEP-E/DEP-E-20260818-When Traffic Flow/when_traffic_flow_manuscript.md` |
| HERO Hessian-Enhanced - DEP-E | Related DEP | Overlap: improving, optimization, strategy | `.lake-data/DEP-E/DEP-E-20260819-HERO Hessian-Enhanced/hero_hessian_enhanced_manuscript.md` |
| Improving Visual-Semantic - DEP-E | Related DEP | Overlap: improving, optimization, strategy | `.lake-data/DEP-E/DEP-E-20260819-Improving Visual-Semantic/improving_visual_semantic_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1709.08463 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1709.08463 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1709.08463 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-When Traffic Flow/when_traffic_flow_manuscript.md` | Related synthesis: big, optimization, strategy | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-HERO Hessian-Enhanced/hero_hessian_enhanced_manuscript.md` | Related synthesis: improving, optimization, strategy | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Improving Visual-Semantic/improving_visual_semantic_manuscript.md` | Related synthesis: improving, optimization, strategy | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 26,609 of 75,964 units from 75,967 PDFs.
