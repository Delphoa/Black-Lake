---
title: "Improving Factual - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Improving Factual Consistency of News Summarization by Contrastive Preference Optimization."
...
primary_url: "https://arxiv.org/abs/2310.19347"
stable_identifier: "arXiv:2310.19347; DOI:10.18653/v1/2024.findings-emnlp.648"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P229"
...
# Improving Factual - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2310.19347 | https://arxiv.org/abs/2310.19347 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2310.19347 rendering | https://arxiv.org/html/2310.19347 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2310.19347 | https://arxiv.org/pdf/2310.19347 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Improving Code - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Improving Code/improving_code_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | COVID Fake News - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Chunks as Arms - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Chunks as Arms/chunks_as_arms_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P229` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Feng, Huawen; Fan, Yan; Liu, Xiong; Lin, Ting-En; Yao, Zekun; Wu, Yuchuan; Huang, Fei; Li, Yongbin; Ma, Qianli. Submitted/source date: 2023/10/30. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P229`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Despite the recent progress in news summarization made by large language models (LLMs), they often generate summaries that …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Despite the recent progress in news summarization made by large language models (LLMs), they often generate summaries that …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: factual, improving, news, optimization, preference | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies consistency, contrastive, factual. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around consistency, contrastive, factual. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Despite the recent progress in news summarization made by large language models (LLMs), they often generate summaries that …”. The full-paper rendering contains 67 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Despite the recent progress in news summarization made by large language models (LLMs), they often generate summaries that …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Despite the recent progress in news summarization made by large language models (LLMs), they often generate summaries that …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving consistency, contrastive, factual. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 44,629 of 75,964 units; duplicate exclusions 7; focus exclusions 35; source-gate exclusions 0; reselections 42.
...
- The related DEPs show how factual, improving, news, optimization, preference connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: factual, improving, news, optimization, preference.
...
|---|---|---|---|
| Improving Code - DEP-E | Related DEP | Overlap: preference, improving, optimization | `.lake-data/DEP-E/DEP-E-20260819-Improving Code/improving_code_manuscript.md` |
| COVID Fake News - DEP-E | Related DEP | Overlap: news, factual | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` |
| Chunks as Arms - DEP-E | Related DEP | Overlap: preference, optimization, summarization | `.lake-data/DEP-E/DEP-E-20260819-Chunks as Arms/chunks_as_arms_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2310.19347 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2310.19347 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2310.19347 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Improving Code/improving_code_manuscript.md` | Related synthesis: preference, improving, optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` | Related synthesis: news, factual | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Chunks as Arms/chunks_as_arms_manuscript.md` | Related synthesis: preference, optimization, summarization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 44,629 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 7; focus exclusions: 35; source-gate exclusions: 0; reselections: 42; 24-hour cutoff: 2026-08-18.
