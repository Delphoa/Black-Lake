---
title: "UAV-Enabled Mobile Edge - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of UAV-Enabled Mobile Edge Computing: Offloading Optimization and Trajectory Design."
...
primary_url: "https://arxiv.org/abs/1802.03906"
stable_identifier: "arXiv:1802.03906; DOI:10.48550/arXiv.1802.03906"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P222"
...
# UAV-Enabled Mobile Edge - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1802.03906 | https://arxiv.org/abs/1802.03906 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1802.03906 rendering | https://arxiv.org/html/1802.03906 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1802.03906 | https://arxiv.org/pdf/1802.03906 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Dynamic Service Migration - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Dynamic Service Migration/dynamic_service_migration_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Analysis and Optimization - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Analysis and Optimization/analysis_and_optimization_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P222` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhou, Fuhui; Wu, Yongpeng; Sun, Haijian; Chu, Zheng. Submitted/source date: 2018/02/12. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P222`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “With the emergence of diverse mobile applications (such as augmented reality), the quality of experience of mobile users …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “With the emergence of diverse mobile applications (such as augmented reality), the quality of experience of mobile users …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: computing, design, edge, mobile, offloading | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies computing, design, edge. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around computing, design, edge. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “With the emergence of diverse mobile applications (such as augmented reality), the quality of experience of mobile users …”. The full-paper rendering contains 35 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “With the emergence of diverse mobile applications (such as augmented reality), the quality of experience of mobile users …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “With the emergence of diverse mobile applications (such as augmented reality), the quality of experience of mobile users …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving computing, design, edge. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 55,248 of 75,964 units; duplicate exclusions 0; focus exclusions 5; source-gate exclusions 0; reselections 5.
...
- The related DEPs show how computing, design, edge, mobile, offloading connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: computing, design, edge, mobile, offloading.
...
|---|---|---|---|
| Dynamic Service Migration - DEP-E | Related DEP | Overlap: computing, mobile, edge, design | `.lake-data/DEP-E/DEP-E-20260819-Dynamic Service Migration/dynamic_service_migration_manuscript.md` |
| Analysis and Optimization - DEP-E | Related DEP | Overlap: offloading, optimization, design | `.lake-data/DEP-E/DEP-E-20260819-Analysis and Optimization/analysis_and_optimization_manuscript.md` |
| EdgeSlice Slicing - DEP-E | Related DEP | Overlap: computing, edge, design | `.lake-data/DEP-E/DEP-E-20260727-EdgeSlice Slicing/edgeslice_slicing_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1802.03906 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1802.03906 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1802.03906 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Dynamic Service Migration/dynamic_service_migration_manuscript.md` | Related synthesis: computing, mobile, edge, design | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Analysis and Optimization/analysis_and_optimization_manuscript.md` | Related synthesis: offloading, optimization, design | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260727-EdgeSlice Slicing/edgeslice_slicing_manuscript.md` | Related synthesis: computing, edge, design | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 55,248 of 75,964 units from 75,967 PDFs.
