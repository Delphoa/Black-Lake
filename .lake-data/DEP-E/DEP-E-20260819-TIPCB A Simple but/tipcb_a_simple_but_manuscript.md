---
title: "TIPCB A Simple but - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of TIPCB: A Simple but Effective Part-based Convolutional Baseline for Text-based Person Search."
...
primary_url: "https://arxiv.org/abs/2105.11628"
stable_identifier: "arXiv:2105.11628; DOI:10.48550/arXiv.2105.11628"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P173"
...
# TIPCB A Simple but - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2105.11628 | https://arxiv.org/abs/2105.11628 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2105.11628 rendering | https://arxiv.org/html/2105.11628 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2105.11628 | https://arxiv.org/pdf/2105.11628 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Large-Scale - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260801-Large-Scale/large_scale_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Constrained Deep Metric - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260811-Constrained Deep Metric/constrained_deep_metric_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P173` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Chen, Yuhao; Zhang, Guoqing; Lu, Yujiang; Wang, Zhenxing; Zheng, Yuhui; Wang, Ruili. Submitted/source date: 2021/05/25. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P173`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Text-based person search is a sub-task in the field of image retrieval, which aims to retrieve target person …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Text-based person search is a sub-task in the field of image retrieval, which aims to retrieve target person …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: baseline, but, convolutional, effective, person | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies baseline, but, convolutional. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around baseline, but, convolutional. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Text-based person search is a sub-task in the field of image retrieval, which aims to retrieve target person …”. The full-paper rendering contains 41 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Text-based person search is a sub-task in the field of image retrieval, which aims to retrieve target person …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Text-based person search is a sub-task in the field of image retrieval, which aims to retrieve target person …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving baseline, but, convolutional. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 60,045 of 75,964 units; duplicate exclusions 0; focus exclusions 7; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how baseline, but, convolutional, effective, person connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: baseline, but, convolutional, effective, person.
...
|---|---|---|---|
| Stacked BNAS Rethinking - DEP-E | Related DEP | Overlap: convolutional, search, simple, baseline, but | `.lake-data/DEP-E/DEP-E-20260818-Stacked BNAS Rethinking/stacked_bnas_rethinking_manuscript.md` |
| Large-Scale - DEP-E | Related DEP | Overlap: person, effective, simple, baseline, but | `.lake-data/DEP-E/DEP-E-20260801-Large-Scale/large_scale_manuscript.md` |
| Constrained Deep Metric - DEP-E | Related DEP | Overlap: person, simple, baseline, but | `.lake-data/DEP-E/DEP-E-20260811-Constrained Deep Metric/constrained_deep_metric_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2105.11628 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2105.11628 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2105.11628 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Stacked BNAS Rethinking/stacked_bnas_rethinking_manuscript.md` | Related synthesis: convolutional, search, simple, baseline, but | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260801-Large-Scale/large_scale_manuscript.md` | Related synthesis: person, effective, simple, baseline, but | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260811-Constrained Deep Metric/constrained_deep_metric_manuscript.md` | Related synthesis: person, simple, baseline, but | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 60,045 of 75,964 units from 75,967 PDFs.
