---
title: "On a Utilitarian Approach - DEP-E"
generated_at: "2026-07-29 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of On a Utilitarian Approach to Privacy Preserving Text Generation."
...
primary_url: "https://arxiv.org/abs/2104.11838"
stable_identifier: "arXiv:2104.11838; DOI:10.48550/arXiv.2104.11838"
deployment_job_id: "BLAD-2200-20260729-5EE3EF9C"
deployment_item_id: "BLAD-2200-20260729-5EE3EF9C-P01"
...
# On a Utilitarian Approach - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2104.11838 | https://arxiv.org/abs/2104.11838 | Metadata only. | 2026-07-29 | Inspected |
| S2 | Full paper | Primary | HTML | 2104.11838 rendering | https://ar5iv.labs.arxiv.org/html/2104.11838 | Verified local copy withheld. | 2026-07-29 | Inspected in full |
| S3 | PDF | Primary | PDF | 2104.11838 | https://arxiv.org/pdf/2104.11838 | Verified local copy withheld. | 2026-07-29 | Integrity checked and sampled |
| S4 | Multi-step Problem - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260728-Multi-step Problem/multi_step_problem_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S5 | DiscourseFlip Risk Review | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-DiscourseFlip RAG Risk/discourseflip_rag_risk_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S6 | Smart Coverage Goals - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260729-5EE3EF9C-P01` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-29 | Verified |

Authors: Xu, Zekun; Aggarwal, Abhinav; Feyisetan, Oluwaseyi; Teissier, Nathanael. Submitted/source date: 2021/04/23. Job `BLAD-2200-20260729-5EE3EF9C`; item `BLAD-2200-20260729-5EE3EF9C-P01`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Differentially-private mechanisms for text generation typically add carefully calibrated noise to input words and use the nearest neighbor …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Differentially-private mechanisms for text generation typically add carefully calibrated noise to input words and use the nearest neighbor …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: empirical, generation, problem, risk, selection | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies mechanisms, privacy, text. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around mechanisms, privacy, text. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Differentially-private mechanisms for text generation typically add carefully calibrated noise to input words and use the nearest neighbor …”. The full-paper rendering contains 39 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Differentially-private mechanisms for text generation typically add carefully calibrated noise to input words and use the nearest neighbor …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The literature is replete with approaches proposed for privacy-preserving text analysis, such as replacing sensitive information with general …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving mechanisms, privacy, text. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 71,576 of 75,778 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how empirical, generation, problem, risk, selection connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: empirical, generation, problem, risk, selection.
...
|---|---|---|---|
| Multi-step Problem - DEP-E | Related DEP | Overlap: empirical, problem, solving | `.lake-data/DEP-E/DEP-E-20260728-Multi-step Problem/multi_step_problem_manuscript.md` |
| DiscourseFlip Risk Review | Related DEP | Overlap: risk, generation | `.lake-data/DEP-E/DEP-E-20260719-DiscourseFlip RAG Risk/discourseflip_rag_risk_manuscript.md` |
| Smart Coverage Goals - DEP-E | Related DEP | Overlap: selection, generation | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2104.11838 | Metadata and abstract | 2026-07-29 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/2104.11838 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-29 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2104.11838 | Primary paper integrity | 2026-07-29 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260728-Multi-step Problem/multi_step_problem_manuscript.md` | Related synthesis: empirical, problem, solving | 2026-07-29 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260719-DiscourseFlip RAG Risk/discourseflip_rag_risk_manuscript.md` | Related synthesis: risk, generation | 2026-07-29 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` | Related synthesis: selection, generation | 2026-07-29 | Repository-relative |

## Appendix

- Uniform selected index: 71,576 of 75,778 units from 75,781 PDFs.
