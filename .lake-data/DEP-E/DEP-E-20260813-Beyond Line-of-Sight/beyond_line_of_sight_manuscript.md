---
title: "Beyond Line-of-Sight - DEP-E"
generated_at: "2026-08-13 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Beyond Line-of-Sight: Cooperative Localization Using Vision and V2X Communication."
...
primary_url: "https://arxiv.org/abs/2507.20772"
stable_identifier: "arXiv:2507.20772; DOI:10.48550/arXiv.2507.20772"
deployment_job_id: "BLAD-2200-20260813-F994AA5E"
deployment_item_id: "BLAD-2200-20260813-F994AA5E-P09"
...
# Beyond Line-of-Sight - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2507.20772 | https://arxiv.org/abs/2507.20772 | Metadata only. | 2026-08-13 | Inspected |
| S2 | Full paper | Primary | HTML | 2507.20772 rendering | https://arxiv.org/html/2507.20772 | Verified local copy withheld. | 2026-08-13 | Inspected in full |
| S3 | PDF | Primary | PDF | 2507.20772 | https://arxiv.org/pdf/2507.20772 | Verified local copy withheld. | 2026-08-13 | Integrity checked and sampled |
| S4 | Empirical Study on - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Empirical Study on/empirical_study_on_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S5 | UAV-Assisted Cooperative - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260805-UAV-Assisted Cooperative/uav_assisted_cooperative_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S6 | Multi-Point ISAC - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260813-F994AA5E-P09` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-13 | Verified |

Authors: Wong, Annika; Tang, Zhiqi; Jiang, Frank J.; Johansson, Karl H.; Mårtensson, Jonas. Submitted/source date: 2025/07/28. Job `BLAD-2200-20260813-F994AA5E`; item `BLAD-2200-20260813-F994AA5E-P09`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: communication, cooperative | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies communication, cooperative, line-of-sight. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around communication, cooperative, line-of-sight. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving communication, cooperative, line-of-sight. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 4,164 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how communication, cooperative connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: communication, cooperative.
...
| Multi-Point ISAC - DEP-E | Related DEP | Overlap: communication, cooperative | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2507.20772 | Metadata and abstract | 2026-08-13 | Metadata only |
| R2 | https://arxiv.org/html/2507.20772 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-13 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2507.20772 | Primary paper integrity | 2026-08-13 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260803-Empirical Study on/empirical_study_on_manuscript.md` | Related synthesis: cooperative | 2026-08-13 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260805-UAV-Assisted Cooperative/uav_assisted_cooperative_manuscript.md` | Related synthesis: cooperative | 2026-08-13 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Related synthesis: communication, cooperative | 2026-08-13 | Repository-relative |

## Appendix

- Uniform selected index: 4,164 of 75,964 units from 75,967 PDFs.
