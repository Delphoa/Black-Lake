---
title: "ELECRec Training - DEP-E"
generated_at: "2026-08-04 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of ELECRec: Training Sequential Recommenders as Discriminators."
...
primary_url: "https://arxiv.org/abs/2204.02011"
stable_identifier: "arXiv:2204.02011; DOI:10.48550/arXiv.2204.02011"
deployment_job_id: "BLAD-2200-20260804-92EFB161"
deployment_item_id: "BLAD-2200-20260804-92EFB161-P08"
...
# ELECRec Training - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2204.02011 | https://arxiv.org/abs/2204.02011 | Metadata only. | 2026-08-04 | Inspected |
| S2 | Full paper | Primary | HTML | 2204.02011 rendering | https://arxiv.org/html/2204.02011 | Verified local copy withheld. | 2026-08-04 | Inspected in full |
| S3 | PDF | Primary | PDF | 2204.02011 | https://arxiv.org/pdf/2204.02011 | Verified local copy withheld. | 2026-08-04 | Integrity checked and sampled |
| S4 | AMAD Anomaly Detection - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-AMAD Anomaly/amad_anomaly_manuscript.md` | Synthesis only. | 2026-08-04 | Inspected |
| S5 | Mixed-Interest CTR Transfer | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer/minet_ctr_manuscript.md` | Synthesis only. | 2026-08-04 | Inspected |
| S6 | Dual Set-Wise CTR Pre-Ranking | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-DUET Setwise CTR/duet_setwise_ctr_manuscript.md` | Synthesis only. | 2026-08-04 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260804-92EFB161-P08` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-04 | Verified |

Authors: Chen, Yongjun; Li, Jia; Xiong, Caiming. Submitted/source date: 2022/04/05. Job `BLAD-2200-20260804-92EFB161`; item `BLAD-2200-20260804-92EFB161-P08`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Sequential recommendation is often considered as a generative task, i.e., training a sequential encoder to generate the next …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Sequential recommendation is often considered as a generative task, i.e., training a sequential encoder to generate the next …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: discriminators, recommenders, sequential, training | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies discriminators, elecrec, recommenders. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around discriminators, elecrec, recommenders. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Sequential recommendation is often considered as a generative task, i.e., training a sequential encoder to generate the next …”. The full-paper rendering contains 47 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Sequential recommendation is often considered as a generative task, i.e., training a sequential encoder to generate the next …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Alleviating the issue mentioned above under the generative task is challenging because it requires more meaningful training data …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving discriminators, elecrec, recommenders. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 49,197 of 75,957 units; duplicate exclusions 0; source-gate exclusions 1; reselections 1.
...
- The related DEPs show how discriminators, recommenders, sequential, training connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: discriminators, recommenders, sequential, training.
...
|---|---|---|---|
| AMAD Anomaly Detection - DEP-E | Related DEP | Overlap: discriminators, sequential, training | `.lake-data/DEP-E/DEP-E-20260721-AMAD Anomaly/amad_anomaly_manuscript.md` |
| Mixed-Interest CTR Transfer | Related DEP | Overlap: recommenders, sequential, training | `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer/minet_ctr_manuscript.md` |
| Dual Set-Wise CTR Pre-Ranking | Related DEP | Overlap: recommenders, training | `.lake-data/DEP-E/DEP-E-20260719-DUET Setwise CTR/duet_setwise_ctr_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2204.02011 | Metadata and abstract | 2026-08-04 | Metadata only |
| R2 | https://arxiv.org/html/2204.02011 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-04 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2204.02011 | Primary paper integrity | 2026-08-04 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260721-AMAD Anomaly/amad_anomaly_manuscript.md` | Related synthesis: discriminators, sequential, training | 2026-08-04 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer/minet_ctr_manuscript.md` | Related synthesis: recommenders, sequential, training | 2026-08-04 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260719-DUET Setwise CTR/duet_setwise_ctr_manuscript.md` | Related synthesis: recommenders, training | 2026-08-04 | Repository-relative |

## Appendix

- Uniform selected index: 49,197 of 75,957 units from 75,960 PDFs.
...
- Duplicate exclusions: 0; source-gate exclusions: 1; reselections: 1; 24-hour cutoff: 2026-08-03.
