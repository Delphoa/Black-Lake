---
title: "The performance of the - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of The performance of the amplitude-based model for complex phase retrieval."
...
primary_url: "https://arxiv.org/abs/2204.05492"
stable_identifier: "arXiv:2204.05492; DOI:10.48550/arXiv.2204.05492"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P53"
...
# The performance of the - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2204.05492 | https://arxiv.org/abs/2204.05492 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2204.05492 rendering | https://arxiv.org/html/2204.05492 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2204.05492 | https://arxiv.org/pdf/2204.05492 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Acoustic Phase Retrieval - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Acoustic Phase Retrieval/acoustic_phase_retrieval_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Aerial RIS-Enhanced - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Aerial RIS-Enhanced/aerial_ris_enhanced_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P53` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Xia, Yu; Xu, Zhiqiang. Submitted/source date: 2022/04/12. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P53`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “provided that m ≳ d m\gtrsim d [ 23 ] . It is also shown that the bound …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The paper aims to study the performance of the amplitude-based model 𝒙 ^ ∈ argmin 𝒙 ∈ ℂ …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: complex, performance, phase, retrieval | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies amplitude-based, complex, performance. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around amplitude-based, complex, performance. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “provided that m ≳ d m\gtrsim d [ 23 ] . It is also shown that the bound …”. The full-paper rendering contains 74 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The paper aims to study the performance of the amplitude-based model 𝒙 ^ ∈ argmin 𝒙 ∈ ℂ …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The paper aims to study the performance of the amplitude-based model 𝒙 ^ ∈ argmin 𝒙 ∈ ℂ …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving amplitude-based, complex, performance. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 45,625 of 75,964 units; duplicate exclusions 0; focus exclusions 5; source-gate exclusions 0; reselections 5.
...
- The related DEPs show how complex, performance, phase, retrieval connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: complex, performance, phase, retrieval.
...
|---|---|---|---|
| Acoustic Phase Retrieval - DEP-E | Related DEP | Overlap: phase, retrieval, complex | `.lake-data/DEP-E/DEP-E-20260716-Acoustic Phase Retrieval/acoustic_phase_retrieval_manuscript.md` |
| SIM MARL Power - DEP-E | Related DEP | Overlap: phase, performance | `.lake-data/DEP-E/DEP-E-20260722-SIM MARL Power/sim_marl_power_manuscript.md` |
| Aerial RIS-Enhanced - DEP-E | Related DEP | Overlap: phase, performance | `.lake-data/DEP-E/DEP-E-20260818-Aerial RIS-Enhanced/aerial_ris_enhanced_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2204.05492 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2204.05492 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2204.05492 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260716-Acoustic Phase Retrieval/acoustic_phase_retrieval_manuscript.md` | Related synthesis: phase, retrieval, complex | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260722-SIM MARL Power/sim_marl_power_manuscript.md` | Related synthesis: phase, performance | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Aerial RIS-Enhanced/aerial_ris_enhanced_manuscript.md` | Related synthesis: phase, performance | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 45,625 of 75,964 units from 75,967 PDFs.
