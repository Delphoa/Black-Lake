---
title: "Projection-Volume - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Projection-Volume Fidelity Divergence: Diagnosing and Controlling Optimization Drift in Sparse-View 3D Gaussian Tomography."
...
primary_url: "https://arxiv.org/abs/2606.22525"
stable_identifier: "arXiv:2606.22525; DOI:10.48550/arXiv.2606.22525"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P88"
...
# Projection-Volume - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2606.22525 | https://arxiv.org/abs/2606.22525 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2606.22525 rendering | https://arxiv.org/html/2606.22525 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2606.22525 | https://arxiv.org/pdf/2606.22525 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Residual Gaussian CBCT - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260717-Residual Gaussian/residual_gaussian_cbct_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Voice Evaluation of - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260809-Voice Evaluation of/voice_evaluation_of_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | MTAVG-Bench 2 0 - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260811-MTAVG-Bench 2 0/mtavg_bench_2_0_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P88` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Yuluo, Yikuang; Wang, Ao; Kuan, Shen; Liu, Yujie; Liao, Wang; Chen, Ying; Zhong, Shuangyang; Huang, Yixing; Wang, Fuquan. Submitted/source date: 2026/06/21. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P88`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Sparse-view computed tomography is a severely ill-posed inverse problem, where recent 3D Gaussian Splatting methods offer an efficient …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Sparse-view computed tomography is a severely ill-posed inverse problem, where recent 3D Gaussian Splatting methods offer an efficient …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: controlling, diagnosing, drift, fidelity, gaussian | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies controlling, diagnosing, divergence. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around controlling, diagnosing, divergence. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Sparse-view computed tomography is a severely ill-posed inverse problem, where recent 3D Gaussian Splatting methods offer an efficient …”. The full-paper rendering contains 221 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Sparse-view computed tomography is a severely ill-posed inverse problem, where recent 3D Gaussian Splatting methods offer an efficient …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Sparse-view computed tomography is a severely ill-posed inverse problem, where recent 3D Gaussian Splatting methods offer an efficient …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving controlling, diagnosing, divergence. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 2,912 of 75,964 units; duplicate exclusions 0; focus exclusions 3; source-gate exclusions 0; reselections 3.
...
- The related DEPs show how controlling, diagnosing, drift, fidelity, gaussian connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: controlling, diagnosing, drift, fidelity, gaussian.
...
|---|---|---|---|
| Residual Gaussian CBCT - DEP-E | Related DEP | Overlap: sparse-view, gaussian, tomography, controlling, optimization | `.lake-data/DEP-E/DEP-E-20260717-Residual Gaussian/residual_gaussian_cbct_manuscript.md` |
| Voice Evaluation of - DEP-E | Related DEP | Overlap: diagnosing, fidelity, drift | `.lake-data/DEP-E/DEP-E-20260809-Voice Evaluation of/voice_evaluation_of_manuscript.md` |
| MTAVG-Bench 2 0 - DEP-E | Related DEP | Overlap: diagnosing, fidelity, drift | `.lake-data/DEP-E/DEP-E-20260811-MTAVG-Bench 2 0/mtavg_bench_2_0_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2606.22525 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2606.22525 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2606.22525 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260717-Residual Gaussian/residual_gaussian_cbct_manuscript.md` | Related synthesis: sparse-view, gaussian, tomography, controlling, optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260809-Voice Evaluation of/voice_evaluation_of_manuscript.md` | Related synthesis: diagnosing, fidelity, drift | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260811-MTAVG-Bench 2 0/mtavg_bench_2_0_manuscript.md` | Related synthesis: diagnosing, fidelity, drift | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 2,912 of 75,964 units from 75,967 PDFs.
