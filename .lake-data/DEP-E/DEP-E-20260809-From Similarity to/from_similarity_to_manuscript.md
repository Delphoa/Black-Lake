---
title: "From Similarity to - DEP-E"
generated_at: "2026-08-09 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of From Similarity to Vulnerability: Key Collision Attack on LLM Semantic Caching."
...
primary_url: "https://arxiv.org/abs/2601.23088"
stable_identifier: "arXiv:2601.23088; DOI:10.48550/arXiv.2601.23088"
deployment_job_id: "BLAD-2200-20260809-2E4CB30E"
deployment_item_id: "BLAD-2200-20260809-2E4CB30E-P07"
...
# From Similarity to - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2601.23088 | https://arxiv.org/abs/2601.23088 | Metadata only. | 2026-08-09 | Inspected |
| S2 | Full paper | Primary | HTML | 2601.23088 rendering | https://arxiv.org/html/2601.23088 | Verified local copy withheld. | 2026-08-09 | Inspected in full |
| S3 | PDF | Primary | PDF | 2601.23088 | https://arxiv.org/pdf/2601.23088 | Verified local copy withheld. | 2026-08-09 | Integrity checked and sampled |
| S4 | PIArena Evaluation - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-PIArena Evaluation/piarena_evaluation_manuscript.md` | Synthesis only. | 2026-08-09 | Inspected |
| S5 | ViT Semantic Robustness - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-ViT Semantic Robustness/vit_semantic_robustness_manuscript.md` | Synthesis only. | 2026-08-09 | Inspected |
| S6 | SAGE-Nav Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-SAGE-Nav Review/sage_nav_manuscript.md` | Synthesis only. | 2026-08-09 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260809-2E4CB30E-P07` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-09 | Verified |

Authors: Zhang, Zhixiang; Liu, Zesen; Xie, Yuchong; Huang, Quanfeng; She, Dongdong. Submitted/source date: 2026/01/30. Job `BLAD-2200-20260809-2E4CB30E`; item `BLAD-2200-20260809-2E4CB30E-P07`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Semantic caching has emerged as a pivotal technique for scaling LLM applications, widely adopted by providers including AWS …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Real-world LLM agents often need to process repeated LLM queries for different users. ( zaharia2024compound ) . These …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: adversarial, attack, caching, collision, defense | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies attack, caching, collision. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around attack, caching, collision. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Semantic caching has emerged as a pivotal technique for scaling LLM applications, widely adopted by providers including AWS …”. The full-paper rendering contains 81 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Real-world LLM agents often need to process repeated LLM queries for different users. ( zaharia2024compound ) . These …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “While caching improves efficiency, it also exposes a unique attack surface of LLM agents. Previous security about LLM …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving attack, caching, collision. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 49,818 of 75,957 units; duplicate exclusions 0; source-gate exclusions 1; reselections 1.
...
- The related DEPs show how adversarial, attack, caching, collision, defense connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: adversarial, attack, caching, collision, defense.
...
|---|---|---|---|
| PIArena Evaluation - DEP-E | Related DEP | Overlap: vulnerability, defense, attack, security, similarity | `.lake-data/DEP-E/DEP-E-20260716-PIArena Evaluation/piarena_evaluation_manuscript.md` |
| ViT Semantic Robustness - DEP-E | Related DEP | Overlap: vulnerability, attack, similarity, adversarial, llm | `.lake-data/DEP-E/DEP-E-20260716-ViT Semantic Robustness/vit_semantic_robustness_manuscript.md` |
| SAGE-Nav Review - DEP-E | Related DEP | Overlap: caching, collision, similarity, adversarial, llm | `.lake-data/DEP-E/DEP-E-20260723-SAGE-Nav Review/sage_nav_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2601.23088 | Metadata and abstract | 2026-08-09 | Metadata only |
| R2 | https://arxiv.org/html/2601.23088 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-09 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2601.23088 | Primary paper integrity | 2026-08-09 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260716-PIArena Evaluation/piarena_evaluation_manuscript.md` | Related synthesis: vulnerability, defense, attack, security, similarity | 2026-08-09 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260716-ViT Semantic Robustness/vit_semantic_robustness_manuscript.md` | Related synthesis: vulnerability, attack, similarity, adversarial, llm | 2026-08-09 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260723-SAGE-Nav Review/sage_nav_manuscript.md` | Related synthesis: caching, collision, similarity, adversarial, llm | 2026-08-09 | Repository-relative |

## Appendix

- Uniform selected index: 49,818 of 75,957 units from 75,960 PDFs.
...
- Duplicate exclusions: 0; source-gate exclusions: 1; reselections: 1; 24-hour cutoff: 2026-08-08.
