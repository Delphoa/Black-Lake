---
title: "DoA-LF A Location - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of DoA-LF: A Location Fingerprint Positioning Algorithm with Millimeter-Wave."
...
primary_url: "https://arxiv.org/abs/2102.13297"
stable_identifier: "arXiv:2102.13297; DOI:10.1109/ACCESS.2017.2753781"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P138"
...
# DoA-LF A Location - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2102.13297 | https://arxiv.org/abs/2102.13297 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2102.13297 rendering | https://arxiv.org/html/2102.13297 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2102.13297 | https://arxiv.org/pdf/2102.13297 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Hierarchical Perceptual - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260815-Hierarchical Perceptual/hierarchical_perceptual_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | RGB-T Semantic - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260811-RGB-T Semantic/rgb_t_semantic_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P138` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wei, Zhiqing; Zhao, Yadong; Liu, Xinyi; Feng, Zhiyong. Submitted/source date: 2021/02/26. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P138`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Location fingerprint (LF) has been widely applied in indoor positioning. However, the existing studies on LF mostly focus …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Location fingerprint (LF) has been widely applied in indoor positioning. However, the existing studies on LF mostly focus …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, fingerprint, location | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, doa-lf, fingerprint. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, doa-lf, fingerprint. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Location fingerprint (LF) has been widely applied in indoor positioning. However, the existing studies on LF mostly focus …”. The full-paper rendering contains 36 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Location fingerprint (LF) has been widely applied in indoor positioning. However, the existing studies on LF mostly focus …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Location fingerprint (LF) has been widely applied in indoor positioning. However, the existing studies on LF mostly focus …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, doa-lf, fingerprint. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 20,329 of 75,964 units; duplicate exclusions 0; focus exclusions 4; source-gate exclusions 0; reselections 4.
...
- The related DEPs show how algorithm, fingerprint, location connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, fingerprint, location.
...
|---|---|---|---|
| Hierarchical Perceptual - DEP-E | Related DEP | Overlap: fingerprint | `.lake-data/DEP-E/DEP-E-20260815-Hierarchical Perceptual/hierarchical_perceptual_manuscript.md` |
| RGB-T Semantic - DEP-E | Related DEP | Overlap: location | `.lake-data/DEP-E/DEP-E-20260811-RGB-T Semantic/rgb_t_semantic_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2102.13297 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2102.13297 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2102.13297 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260815-Hierarchical Perceptual/hierarchical_perceptual_manuscript.md` | Related synthesis: fingerprint | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260811-RGB-T Semantic/rgb_t_semantic_manuscript.md` | Related synthesis: location | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260801-High-Order Langevin/high_order_langevin_manuscript.md` | Related synthesis: algorithm | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 20,329 of 75,964 units from 75,967 PDFs.
