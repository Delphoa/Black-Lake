---
title: "Planning with Logical - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Planning with Logical Graph-based Language Model for Instruction Generation."
...
primary_url: "https://arxiv.org/abs/2308.13782"
stable_identifier: "arXiv:2308.13782; DOI:10.48550/arXiv.2308.13782"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P58"
...
# Planning with Logical - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2308.13782 | https://arxiv.org/abs/2308.13782 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2308.13782 rendering | https://arxiv.org/html/2308.13782 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2308.13782 | https://arxiv.org/pdf/2308.13782 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | LogiAgent - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260727-LogiAgent REST/logiagent_rest_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Graph-based data - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260811-Graph-based data/graph_based_data_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P58` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhang, Fan; Jin, Kebing; Zhuo, Hankz Hankui. Submitted/source date: 2023/08/26. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P58`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: generation, graph-based, logical, planning | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies generation, graph-based, instruction. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around generation, graph-based, instruction. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving generation, graph-based, instruction. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 70,723 of 75,964 units; duplicate exclusions 0; focus exclusions 11; source-gate exclusions 0; reselections 11.
...
- The related DEPs show how generation, graph-based, logical, planning connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: generation, graph-based, logical, planning.
...
|---|---|---|---|
| LogiAgent - DEP-E | Related DEP | Overlap: logical, generation, planning | `.lake-data/DEP-E/DEP-E-20260727-LogiAgent REST/logiagent_rest_manuscript.md` |
| Graph Alignment Review - DEP-E | Related DEP | Overlap: graph-based, planning | `.lake-data/DEP-E/DEP-E-20260722-Graph Alignment/graph_alignment_manuscript.md` |
| Graph-based data - DEP-E | Related DEP | Overlap: graph-based, planning | `.lake-data/DEP-E/DEP-E-20260811-Graph-based data/graph_based_data_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2308.13782 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2308.13782 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2308.13782 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260727-LogiAgent REST/logiagent_rest_manuscript.md` | Related synthesis: logical, generation, planning | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260722-Graph Alignment/graph_alignment_manuscript.md` | Related synthesis: graph-based, planning | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260811-Graph-based data/graph_based_data_manuscript.md` | Related synthesis: graph-based, planning | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 70,723 of 75,964 units from 75,967 PDFs.
