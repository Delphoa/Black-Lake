---
title: "Rank Optimization for - DEP-E"
generated_at: "2026-07-29 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Rank Optimization for MIMO Channel with RIS: Simulation and Measurement."
...
primary_url: "https://arxiv.org/abs/2307.13237"
stable_identifier: "arXiv:2307.13237; DOI:10.1109/LWC.2023.3331489"
deployment_job_id: "BLAD-2200-20260729-5EE3EF9C"
deployment_item_id: "BLAD-2200-20260729-5EE3EF9C-P04"
...
# Rank Optimization for - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2307.13237 | https://arxiv.org/abs/2307.13237 | Metadata only. | 2026-07-29 | Inspected |
| S2 | Full paper | Primary | HTML | 2307.13237 rendering | https://arxiv.org/html/2307.13237 | Verified local copy withheld. | 2026-07-29 | Inspected in full |
| S3 | PDF | Primary | PDF | 2307.13237 | https://arxiv.org/pdf/2307.13237 | Verified local copy withheld. | 2026-07-29 | Integrity checked and sampled |
| S4 | Compressed CSI Feedback - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback/compressed_csi_feedback_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S5 | VG Navigable Space Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-VG Navigable Space/vg_navigable_space_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S6 | Habitat Synthetic Scenes - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260724-Habitat Synthetic Scenes/habitat_synthetic_scenes_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260729-5EE3EF9C-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-29 | Verified |

Authors: Meng, Shengguo; Tang, Wankai; Chen, Weicong; Lan, Jifeng; Zhou, Qun Yan; Han, Yu; Li, Xiao; Jin, Shi. Submitted/source date: 2023/07/25. Job `BLAD-2200-20260729-5EE3EF9C`; item `BLAD-2200-20260729-5EE3EF9C-P04`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Reconfigurable intelligent surface (RIS) is a promising technology that can reshape the electromagnetic environment in wireless networks, offering …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Reconfigurable intelligent surface (RIS) is a promising technology that can reshape the electromagnetic environment in wireless networks, offering …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: measurement, mimo, navigable, navigation, scene | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies mimo, ris, channel. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around mimo, ris, channel. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Reconfigurable intelligent surface (RIS) is a promising technology that can reshape the electromagnetic environment in wireless networks, offering …”. The full-paper rendering contains 29 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Reconfigurable intelligent surface (RIS) is a promising technology that can reshape the electromagnetic environment in wireless networks, offering …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In recent years, the increasing presence of various mobile communication services such as video streaming and online gaming …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving mimo, ris, channel. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 20,734 of 75,778 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how measurement, mimo, navigable, navigation, scene connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: measurement, mimo, navigable, navigation, scene.
...
|---|---|---|---|
| Compressed CSI Feedback - DEP-E | Related DEP | Overlap: mimo, measurement | `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback/compressed_csi_feedback_manuscript.md` |
| VG Navigable Space Review - DEP-E | Related DEP | Overlap: navigable, navigation | `.lake-data/DEP-E/DEP-E-20260720-VG Navigable Space/vg_navigable_space_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2307.13237 | Metadata and abstract | 2026-07-29 | Metadata only |
| R2 | https://arxiv.org/html/2307.13237 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-29 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2307.13237 | Primary paper integrity | 2026-07-29 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback/compressed_csi_feedback_manuscript.md` | Related synthesis: mimo, measurement | 2026-07-29 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260720-VG Navigable Space/vg_navigable_space_manuscript.md` | Related synthesis: navigable, navigation | 2026-07-29 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260724-Habitat Synthetic Scenes/habitat_synthetic_scenes_manuscript.md` | Related synthesis: navigation, scene | 2026-07-29 | Repository-relative |

## Appendix

- Uniform selected index: 20,734 of 75,778 units from 75,781 PDFs.
