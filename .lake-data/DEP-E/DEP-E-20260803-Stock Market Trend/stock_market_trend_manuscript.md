---
title: "Stock Market Trend - DEP-E"
generated_at: "2026-08-03 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Stock Market Trend Analysis Using Hidden Markov Model and Long Short Term Memory."
...
primary_url: "https://arxiv.org/abs/2104.09700"
stable_identifier: "arXiv:2104.09700; DOI:10.48550/arXiv.2104.09700"
deployment_job_id: "BLAD-2200-20260803-11C1283E"
deployment_item_id: "BLAD-2200-20260803-11C1283E-P03"
...
# Stock Market Trend - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2104.09700 | https://arxiv.org/abs/2104.09700 | Metadata only. | 2026-08-03 | Inspected |
| S2 | Full paper | Primary | HTML | 2104.09700 rendering | https://arxiv.org/html/2104.09700 | Verified local copy withheld. | 2026-08-03 | Inspected in full |
| S3 | PDF | Primary | PDF | 2104.09700 | https://arxiv.org/pdf/2104.09700 | Verified local copy withheld. | 2026-08-03 | Integrity checked and sampled |
| S4 | CausalStock Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-CausalStock Review/causalstock_review_manuscript.md` | Synthesis only. | 2026-08-03 | Inspected |
| S5 | Quantum Quant Trading - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260714-Quantum Quant Trading/quantum_quant_trading_manuscript.md` | Synthesis only. | 2026-08-03 | Inspected |
| S6 | SMES Expert Sparsity - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260713-SMES Expert Sparsity/smes_expert_sparsity_manuscript.md` | Synthesis only. | 2026-08-03 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260803-11C1283E-P03` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-03 | Verified |

Authors: Liu, Mingwen; Huo, Junbang; Wu, Yulin; Wu, Jinge. Submitted/source date: 2021/04/20. Job `BLAD-2200-20260803-11C1283E`; item `BLAD-2200-20260803-11C1283E-P03`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “HMM and LSTM have been widely used in the field of speech recognition in recent years, which has …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “This paper intends to apply the Hidden Markov Model into stock market and and make predictions. Moreover, four …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: long, market, markov, memory, quantization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies hidden, long, market. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around hidden, long, market. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “HMM and LSTM have been widely used in the field of speech recognition in recent years, which has …”. The full-paper rendering contains 80 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “This paper intends to apply the Hidden Markov Model into stock market and and make predictions. Moreover, four …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “It sets three dividing lines and marks them according to the first barrier touched by the path. First, …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving hidden, long, market. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 16,080 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how long, market, markov, memory, quantization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: long, market, markov, memory, quantization.
...
|---|---|---|---|
| CausalStock Review - DEP-E | Related DEP | Overlap: stock, market, markov, sparsity, memory | `.lake-data/DEP-E/DEP-E-20260723-CausalStock Review/causalstock_review_manuscript.md` |
| Quantum Quant Trading - DEP-E | Related DEP | Overlap: stock, market, term, long, memory | `.lake-data/DEP-E/DEP-E-20260714-Quantum Quant Trading/quantum_quant_trading_manuscript.md` |
| SMES Expert Sparsity - DEP-E | Related DEP | Overlap: trend, quantization, sparsity, term, long | `.lake-data/DEP-E/DEP-E-20260713-SMES Expert Sparsity/smes_expert_sparsity_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2104.09700 | Metadata and abstract | 2026-08-03 | Metadata only |
| R2 | https://arxiv.org/html/2104.09700 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-03 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2104.09700 | Primary paper integrity | 2026-08-03 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260723-CausalStock Review/causalstock_review_manuscript.md` | Related synthesis: stock, market, markov, sparsity, memory | 2026-08-03 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260714-Quantum Quant Trading/quantum_quant_trading_manuscript.md` | Related synthesis: stock, market, term, long, memory | 2026-08-03 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260713-SMES Expert Sparsity/smes_expert_sparsity_manuscript.md` | Related synthesis: trend, quantization, sparsity, term, long | 2026-08-03 | Repository-relative |

## Appendix

- Uniform selected index: 16,080 of 75,957 units from 75,960 PDFs.
