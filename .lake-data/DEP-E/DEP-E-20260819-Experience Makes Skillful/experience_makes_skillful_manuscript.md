---
title: "Experience Makes Skillful - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Experience Makes Skillful: Enabling Generalizable Medical Agent Reasoning via Self-Evolving Skill Memory."
...
primary_url: "https://arxiv.org/abs/2606.09365"
stable_identifier: "arXiv:2606.09365; DOI:10.48550/arXiv.2606.09365"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P248"
...
# Experience Makes Skillful - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2606.09365 | https://arxiv.org/abs/2606.09365 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2606.09365 rendering | https://arxiv.org/html/2606.09365 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2606.09365 | https://arxiv.org/pdf/2606.09365 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | ManipulationNet An - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260726-ManipulationNet An/manipulationnet_an_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P248` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Sun, Haoran; Li, Wenjie; Zhang, Yujie; Lin, Zekai; Zhang, Fanrui; Chen, Kaitao; He, Xingqi; Li, Yichen; Liu, Mianxin; Liu, Lei; Jiang, Yankai. Submitted/source date: 2026/06/08. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P248`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: experience, memory, reasoning, skill | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies agent, enabling, experience. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around agent, enabling, experience. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving agent, enabling, experience. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 56,287 of 75,964 units; duplicate exclusions 3; focus exclusions 4; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how experience, memory, reasoning, skill connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: experience, memory, reasoning, skill.
...
|---|---|---|---|
| ManipulationNet An - DEP-E | Related DEP | Overlap: skill, reasoning, memory | `.lake-data/DEP-E/DEP-E-20260726-ManipulationNet An/manipulationnet_an_manuscript.md` |
| ARPO End-to-End Policy - DEP-E | Related DEP | Overlap: experience, memory | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` |
| ONER Online Experience - DEP-E | Related DEP | Overlap: experience, memory | `.lake-data/DEP-E/DEP-E-20260819-ONER Online Experience/oner_online_experience_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2606.09365 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2606.09365 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2606.09365 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260726-ManipulationNet An/manipulationnet_an_manuscript.md` | Related synthesis: skill, reasoning, memory | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` | Related synthesis: experience, memory | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-ONER Online Experience/oner_online_experience_manuscript.md` | Related synthesis: experience, memory | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 56,287 of 75,964 units from 75,967 PDFs.
