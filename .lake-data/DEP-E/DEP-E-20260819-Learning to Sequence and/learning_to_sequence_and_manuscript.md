---
title: "Learning to Sequence and - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Learning to Sequence and Blend Robot Skills via Differentiable Optimization."
...
primary_url: "https://arxiv.org/abs/2206.00559"
stable_identifier: "arXiv:2206.00559; DOI:10.48550/arXiv.2206.00559"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P283"
...
# Learning to Sequence and - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2206.00559 | https://arxiv.org/abs/2206.00559 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2206.00559 rendering | https://arxiv.org/html/2206.00559 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2206.00559 | https://arxiv.org/pdf/2206.00559 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Exploiting Operation - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Exploiting Operation/exploiting_operation_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P283` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Jaquier, Noémie; Zhou, You; Starke, Julia; Asfour, Tamim. Submitted/source date: 2022/06/01. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P283`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: differentiable | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies blend, differentiable, optimization. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around blend, differentiable, optimization. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving blend, differentiable, optimization. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 15,393 of 75,964 units; duplicate exclusions 1; focus exclusions 10; source-gate exclusions 0; reselections 11.
...
- The related DEPs show how differentiable connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: differentiable.
...
|---|---|---|---|
| Enhancing State - DEP-E | Related DEP | Overlap: differentiable | `.lake-data/DEP-E/DEP-E-20260818-Enhancing State/enhancing_state_manuscript.md` |
| Exploiting Operation - DEP-E | Related DEP | Overlap: differentiable | `.lake-data/DEP-E/DEP-E-20260819-Exploiting Operation/exploiting_operation_manuscript.md` |
| Meta Learning with - DEP-E | Related DEP | Overlap: differentiable | `.lake-data/DEP-E/DEP-E-20260819-Meta Learning with/meta_learning_with_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2206.00559 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2206.00559 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2206.00559 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Enhancing State/enhancing_state_manuscript.md` | Related synthesis: differentiable | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Exploiting Operation/exploiting_operation_manuscript.md` | Related synthesis: differentiable | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Meta Learning with/meta_learning_with_manuscript.md` | Related synthesis: differentiable | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 15,393 of 75,964 units from 75,967 PDFs.
