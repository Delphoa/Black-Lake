---
title: "Improving Robust Fairness - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Improving Robust Fairness via Balance Adversarial Training."
...
primary_url: "https://arxiv.org/abs/2209.07534"
stable_identifier: "arXiv:2209.07534; DOI:10.48550/arXiv.2209.07534"
deployment_job_id: "BLAD-2200-20260819-7C79A486"
deployment_item_id: "BLAD-2200-20260819-7C79A486-P01"
...
# Improving Robust Fairness - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2209.07534 | https://arxiv.org/abs/2209.07534 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2209.07534 rendering | https://arxiv.org/html/2209.07534 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2209.07534 | https://arxiv.org/pdf/2209.07534 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Adversarial Label Noise - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Adversarial Label Noise/adversarial_label_noise_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Failure Cases Are Better - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Failure Cases Are Better/failure_cases_are_better_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | IntactKV Improving Large - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260731-IntactKV Improving Large/intactkv_improving_large_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-7C79A486-P01` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Sun, Chunyu; Xu, Chenye; Yao, Chengyuan; Liang, Siyuan; Wu, Yichao; Liang, Ding; Liu, XiangLong; Liu, Aishan. Submitted/source date: 2022/09/15. Job `BLAD-2200-20260819-7C79A486`; item `BLAD-2200-20260819-7C79A486-P01`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Adversarial training (AT) methods are effective against adversarial attacks, yet they introduce severe disparity of accuracy and robustness …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Adversarial training (AT) methods are effective against adversarial attacks, yet they introduce severe disparity of accuracy and robustness …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: adversarial, improving, robust, training | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies adversarial, balance, fairness. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around adversarial, balance, fairness. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Adversarial training (AT) methods are effective against adversarial attacks, yet they introduce severe disparity of accuracy and robustness …”. The full-paper rendering contains 58 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Adversarial training (AT) methods are effective against adversarial attacks, yet they introduce severe disparity of accuracy and robustness …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Adversarial training (AT) methods are effective against adversarial attacks, yet they introduce severe disparity of accuracy and robustness …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving adversarial, balance, fairness. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 70,259 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how adversarial, improving, robust, training connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: adversarial, improving, robust, training.
...
|---|---|---|---|
| Adversarial Label Noise - DEP-E | Related DEP | Overlap: adversarial, robust, training, improving | `.lake-data/DEP-E/DEP-E-20260716-Adversarial Label Noise/adversarial_label_noise_manuscript.md` |
| Failure Cases Are Better - DEP-E | Related DEP | Overlap: adversarial, training, robust | `.lake-data/DEP-E/DEP-E-20260803-Failure Cases Are Better/failure_cases_are_better_manuscript.md` |
| IntactKV Improving Large - DEP-E | Related DEP | Overlap: improving | `.lake-data/DEP-E/DEP-E-20260731-IntactKV Improving Large/intactkv_improving_large_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2209.07534 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2209.07534 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2209.07534 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260716-Adversarial Label Noise/adversarial_label_noise_manuscript.md` | Related synthesis: adversarial, robust, training, improving | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260803-Failure Cases Are Better/failure_cases_are_better_manuscript.md` | Related synthesis: adversarial, training, robust | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260731-IntactKV Improving Large/intactkv_improving_large_manuscript.md` | Related synthesis: improving | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 70,259 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 0; focus exclusions: 0; source-gate exclusions: 0; reselections: 0; 24-hour cutoff: 2026-08-18.
