---
title: "Breaking the Sample - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Breaking the Sample Complexity Barrier to Regret-Optimal Model-Free Reinforcement Learning."
...
primary_url: "https://arxiv.org/abs/2110.04645"
stable_identifier: "arXiv:2110.04645; DOI:10.48550/arXiv.2110.04645"
deployment_job_id: "BLAD-2200-20260818-A4DB6AFC"
deployment_item_id: "BLAD-2200-20260818-A4DB6AFC-P07"
...
# Breaking the Sample - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2110.04645 | https://arxiv.org/abs/2110.04645 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2110.04645 rendering | https://arxiv.org/html/2110.04645 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2110.04645 | https://arxiv.org/pdf/2110.04645 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | RRT-CBF Motion - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260711-RRT-CBF Motion/rrt_cbf_motion_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-A4DB6AFC-P07` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Li, Gen; Shi, Laixi; Chen, Yuxin; Chi, Yuejie. Submitted/source date: 2021/10/09. Job `BLAD-2200-20260818-A4DB6AFC`; item `BLAD-2200-20260818-A4DB6AFC-P07`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: barrier, complexity, reinforcement, sample | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies barrier, breaking, complexity. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around barrier, breaking, complexity. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 209 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving barrier, breaking, complexity. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 35,845 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 2; reselections 2.
...
- The related DEPs show how barrier, complexity, reinforcement, sample connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: barrier, complexity, reinforcement, sample.
...
|---|---|---|---|
| RRT-CBF Motion - DEP-E | Related DEP | Overlap: barrier, complexity, sample | `.lake-data/DEP-E/DEP-E-20260711-RRT-CBF Motion/rrt_cbf_motion_manuscript.md` |
| GPMD Regularized RL - DEP-E | Related DEP | Overlap: reinforcement, barrier, complexity, sample | `.lake-data/DEP-E/DEP-E-20260716-GPMD Regularized RL/gpmd_regularized_rl_manuscript.md` |
| RLMF Uncertainty - DEP-E | Related DEP | Overlap: reinforcement, complexity, sample | `.lake-data/DEP-E/DEP-E-20260714-RLMF Uncertainty/rlmf_uncertainty_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2110.04645 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2110.04645 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2110.04645 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260711-RRT-CBF Motion/rrt_cbf_motion_manuscript.md` | Related synthesis: barrier, complexity, sample | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260716-GPMD Regularized RL/gpmd_regularized_rl_manuscript.md` | Related synthesis: reinforcement, barrier, complexity, sample | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260714-RLMF Uncertainty/rlmf_uncertainty_manuscript.md` | Related synthesis: reinforcement, complexity, sample | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 35,845 of 75,964 units from 75,967 PDFs.
