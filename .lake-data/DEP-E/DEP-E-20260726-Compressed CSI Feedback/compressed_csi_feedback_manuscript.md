---
title: "Compressed CSI Feedback - DEP-E"
generated_at: "2026-07-26 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Compressed CSI Feedback With Learned Measurement Matrix for mmWave Massive MIMO."
...
primary_url: "https://arxiv.org/abs/1903.02127"
stable_identifier: "arXiv:1903.02127; DOI:10.48550/arXiv.1903.02127"
deployment_job_id: "BLAD-2200-20260726-1DBD5211"
deployment_item_id: "BLAD-2200-20260726-1DBD5211-P01"
...
# Compressed CSI Feedback - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1903.02127 | https://arxiv.org/abs/1903.02127 | Metadata only. | 2026-07-26 | Inspected |
| S2 | Full paper | Primary | HTML | 1903.02127 rendering | https://ar5iv.labs.arxiv.org/html/1903.02127 | Verified local copy withheld. | 2026-07-26 | Inspected in full |
| S3 | PDF | Primary | PDF | 1903.02127 | https://arxiv.org/pdf/1903.02127 | Verified local copy withheld. | 2026-07-26 | Integrity checked and sampled |
| S4 | Acoustic Phase Retrieval - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Acoustic Phase Retrieval/acoustic_phase_retrieval_manuscript.md` | Synthesis only. | 2026-07-26 | Inspected |
| S5 | SMES Expert Sparsity - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260713-SMES Expert Sparsity/smes_expert_sparsity_manuscript.md` | Synthesis only. | 2026-07-26 | Inspected |
| S6 | CAP Compression - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-CAP Rank Sparsity/cap_rank_sparsity_manuscript.md` | Synthesis only. | 2026-07-26 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260726-1DBD5211-P01` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-26 | Verified |

Authors: Wu, Pengxia; Liu, Zichuan; Cheng, Julian. Submitted/source date: 2019/03/06. Job `BLAD-2200-20260726-1DBD5211`; item `BLAD-2200-20260726-1DBD5211-P01`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “A major challenge to implement the compressed sensing method for channel state information (CSI) acquisition lies in the …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Unfortunately, the widely adopted randomized measurement matrices drawn from Gaussian or Bernoulli distribution are not optimal for all …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: compression, problem, recovery, sparse, sparsity | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies measurement, matrix, csi. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around measurement, matrix, csi. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “A major challenge to implement the compressed sensing method for channel state information (CSI) acquisition lies in the …”. The full-paper rendering contains 28 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Unfortunately, the widely adopted randomized measurement matrices drawn from Gaussian or Bernoulli distribution are not optimal for all …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “A major challenge to implement the compressed sensing method for channel state information (CSI) acquisition lies in the …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving measurement, matrix, csi. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 18,733 of 75,778 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how compression, problem, recovery, sparse, sparsity connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: compression, problem, recovery, sparse, sparsity.
...
|---|---|---|---|
| Acoustic Phase Retrieval - DEP-E | Related DEP | Overlap: recovery, problem | `.lake-data/DEP-E/DEP-E-20260716-Acoustic Phase Retrieval/acoustic_phase_retrieval_manuscript.md` |
| SMES Expert Sparsity - DEP-E | Related DEP | Overlap: sparsity, sparse | `.lake-data/DEP-E/DEP-E-20260713-SMES Expert Sparsity/smes_expert_sparsity_manuscript.md` |
| CAP Compression - DEP-E | Related DEP | Overlap: compression, sparse | `.lake-data/DEP-E/DEP-E-20260719-CAP Rank Sparsity/cap_rank_sparsity_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1903.02127 | Metadata and abstract | 2026-07-26 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/1903.02127 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-26 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1903.02127 | Primary paper integrity | 2026-07-26 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260716-Acoustic Phase Retrieval/acoustic_phase_retrieval_manuscript.md` | Related synthesis: recovery, problem | 2026-07-26 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260713-SMES Expert Sparsity/smes_expert_sparsity_manuscript.md` | Related synthesis: sparsity, sparse | 2026-07-26 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260719-CAP Rank Sparsity/cap_rank_sparsity_manuscript.md` | Related synthesis: compression, sparse | 2026-07-26 | Repository-relative |

## Appendix

- Uniform selected index: 18,733 of 75,778 units from 75,781 PDFs.
