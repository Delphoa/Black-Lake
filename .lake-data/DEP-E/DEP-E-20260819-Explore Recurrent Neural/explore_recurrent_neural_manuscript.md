---
title: "Explore Recurrent Neural - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Explore Recurrent Neural Network for PUE Attack Detection in Practical CRN Models."
...
primary_url: "https://arxiv.org/abs/1805.00428"
stable_identifier: "arXiv:1805.00428; DOI:10.48550/arXiv.1805.00428"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P105"
...
# Explore Recurrent Neural - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1805.00428 | https://arxiv.org/abs/1805.00428 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1805.00428 rendering | https://arxiv.org/html/1805.00428 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1805.00428 | https://arxiv.org/pdf/1805.00428 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Multi-Path Feedback - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Multi-Path Feedback/multi_path_feedback_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P105` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Dong, Qi; Chen, Yu; Li, Xiaohua; Zeng, Kai. Submitted/source date: 2018/05/01. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P105`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The proliferation of the Internet of Things (IoTs) and pervasive use of many different types of mobile computing …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The proliferation of the Internet of Things (IoTs) and pervasive use of many different types of mobile computing …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: detection, explore, network, neural, practical | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies attack, crn, detection. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around attack, crn, detection. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The proliferation of the Internet of Things (IoTs) and pervasive use of many different types of mobile computing …”. The full-paper rendering contains 36 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The proliferation of the Internet of Things (IoTs) and pervasive use of many different types of mobile computing …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The proliferation of the Internet of Things (IoTs) and pervasive use of many different types of mobile computing …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving attack, crn, detection. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 7,882 of 75,964 units; duplicate exclusions 1; focus exclusions 24; source-gate exclusions 0; reselections 25.
...
- The related DEPs show how detection, explore, network, neural, practical connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: detection, explore, network, neural, practical.
...
|---|---|---|---|
| Multi-Path Feedback - DEP-E | Related DEP | Overlap: recurrent, neural, network, practical, detection | `.lake-data/DEP-E/DEP-E-20260818-Multi-Path Feedback/multi_path_feedback_manuscript.md` |
| AV Emotion Fusion - DEP-E | Related DEP | Overlap: recurrent, neural, network, practical, detection | `.lake-data/DEP-E/DEP-E-20260713-AV Emotion Fusion/av_emotion_fusion_manuscript.md` |
| MoCom MAV Comms - DEP-E | Related DEP | Overlap: neural, network, explore, practical, detection | `.lake-data/DEP-E/DEP-E-20260819-MoCom MAV Comms/mocom_mav_comms_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1805.00428 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1805.00428 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1805.00428 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Multi-Path Feedback/multi_path_feedback_manuscript.md` | Related synthesis: recurrent, neural, network, practical, detection | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260713-AV Emotion Fusion/av_emotion_fusion_manuscript.md` | Related synthesis: recurrent, neural, network, practical, detection | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-MoCom MAV Comms/mocom_mav_comms_manuscript.md` | Related synthesis: neural, network, explore, practical, detection | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 7,882 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 1; focus exclusions: 24; source-gate exclusions: 0; reselections: 25; 24-hour cutoff: 2026-08-18.
