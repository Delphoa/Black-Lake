---
title: "The Boating Store Had Its - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of \"The Boating Store Had Its Best Sail Ever\": Pronunciation-attentive Contextualized Pun Recognition."
...
primary_url: "https://arxiv.org/abs/2004.14457"
stable_identifier: "arXiv:2004.14457; DOI:10.48550/arXiv.2004.14457"
deployment_job_id: "BLAD-2200-20260819-7C79A486"
deployment_item_id: "BLAD-2200-20260819-7C79A486-P09"
...
# The Boating Store Had Its - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2004.14457 | https://arxiv.org/abs/2004.14457 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2004.14457 rendering | https://arxiv.org/html/2004.14457 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2004.14457 | https://arxiv.org/pdf/2004.14457 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | RAR Visual Reranking - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-RAR Visual Reranking/rar_visual_reranking_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | CrossNER - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260801-CrossNER Adapt/crossner_domain_adaptation_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Relational Contrastive - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260801-Relational Contrastive/relational_contrastive_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-7C79A486-P09` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhou, Yichao; Jiang, Jyun-Yu; Zhao, Jieyu; Chang, Kai-Wei; Wang, Wei. Submitted/source date: 2020/04/29. Job `BLAD-2200-20260819-7C79A486`; item `BLAD-2200-20260819-7C79A486-P09`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Have a free development cycle? Help support accessibility at arXiv! Our collaborators at LaTeXML maintain a list of …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We are continuing to improve HTML versions of papers, and your feedback helps enhance accessibility and mobile support. …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: best, had, its, recognition, store | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies best, boating, contextualized. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around best, boating, contextualized. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Have a free development cycle? Help support accessibility at arXiv! Our collaborators at LaTeXML maintain a list of …”. The full-paper rendering contains 39 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We are continuing to improve HTML versions of papers, and your feedback helps enhance accessibility and mobile support. …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “We are continuing to improve HTML versions of papers, and your feedback helps enhance accessibility and mobile support. …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving best, boating, contextualized. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 6,672 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how best, had, its, recognition, store connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: best, had, its, recognition, store.
...
|---|---|---|---|
| RAR Visual Reranking - DEP-E | Related DEP | Overlap: recognition, had, best, store, its | `.lake-data/DEP-E/DEP-E-20260723-RAR Visual Reranking/rar_visual_reranking_manuscript.md` |
| CrossNER - DEP-E | Related DEP | Overlap: recognition, had, best, its | `.lake-data/DEP-E/DEP-E-20260801-CrossNER Adapt/crossner_domain_adaptation_manuscript.md` |
| Relational Contrastive - DEP-E | Related DEP | Overlap: recognition, best, store, its | `.lake-data/DEP-E/DEP-E-20260801-Relational Contrastive/relational_contrastive_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2004.14457 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2004.14457 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2004.14457 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260723-RAR Visual Reranking/rar_visual_reranking_manuscript.md` | Related synthesis: recognition, had, best, store, its | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260801-CrossNER Adapt/crossner_domain_adaptation_manuscript.md` | Related synthesis: recognition, had, best, its | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260801-Relational Contrastive/relational_contrastive_manuscript.md` | Related synthesis: recognition, best, store, its | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 6,672 of 75,964 units from 75,967 PDFs.
