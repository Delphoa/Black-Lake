---
title: "CDGraph Dual Conditional - DEP-E"
generated_at: "2026-08-09 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of CDGraph: Dual Conditional Social Graph Synthesizing via Diffusion Model."
...
primary_url: "https://arxiv.org/abs/2311.01729"
stable_identifier: "arXiv:2311.01729; DOI:10.48550/arXiv.2311.01729"
deployment_job_id: "BLAD-2200-20260809-2E4CB30E"
deployment_item_id: "BLAD-2200-20260809-2E4CB30E-P10"
...
# CDGraph Dual Conditional - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2311.01729 | https://arxiv.org/abs/2311.01729 | Metadata only. | 2026-08-09 | Inspected |
| S2 | Full paper | Primary | HTML | 2311.01729 rendering | https://arxiv.org/html/2311.01729 | Verified local copy withheld. | 2026-08-09 | Inspected in full |
| S3 | PDF | Primary | PDF | 2311.01729 | https://arxiv.org/pdf/2311.01729 | Verified local copy withheld. | 2026-08-09 | Integrity checked and sampled |
...
| S5 | MA-VLM Moderation - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-MA-VLM PNU Moderation/ma_vlm_pnu_moderation_manuscript.md` | Synthesis only. | 2026-08-09 | Inspected |
| S6 | Heartcare ECG - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260802-Heartcare ECG/heartcare_ecg_manuscript.md` | Synthesis only. | 2026-08-09 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260809-2E4CB30E-P10` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-09 | Verified |

Authors: Tsai, Jui-Yi; Teng, Ya-Wen; Yew, Ho Chiok; Yang, De-Nian; Chen, Lydia Y.. Submitted/source date: 2023/11/03. Job `BLAD-2200-20260809-2E4CB30E`; item `BLAD-2200-20260809-2E4CB30E-P10`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The social graphs synthesized by the generative models are increasingly in demand due to data scarcity and concerns …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The social graphs synthesized by the generative models are increasingly in demand due to data scarcity and concerns …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: conditional, diffusion, dual, social, synthesizing | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies cdgraph, conditional, diffusion. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around cdgraph, conditional, diffusion. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The social graphs synthesized by the generative models are increasingly in demand due to data scarcity and concerns …”. The full-paper rendering contains 54 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The social graphs synthesized by the generative models are increasingly in demand due to data scarcity and concerns …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Social networks offer a wide range of applications, such as viral marketing, friend recommendations, fake news detection, and …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving cdgraph, conditional, diffusion. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 33,498 of 75,957 units; duplicate exclusions 0; source-gate exclusions 1; reselections 1.
...
- The related DEPs show how conditional, diffusion, dual, social, synthesizing connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: conditional, diffusion, dual, social, synthesizing.
...
|---|---|---|---|
| Telecom AI Roadmap - DEP-E | Related DEP | Overlap: synthesizing, diffusion, conditional | `.lake-data/DEP-E/DEP-E-20260711-Telecom AI Roadmap/telecom_ai_roadmap_manuscript.md` |
| MA-VLM Moderation - DEP-E | Related DEP | Overlap: social, dual, conditional | `.lake-data/DEP-E/DEP-E-20260719-MA-VLM PNU Moderation/ma_vlm_pnu_moderation_manuscript.md` |
| Heartcare ECG - DEP-E | Related DEP | Overlap: dual, diffusion, conditional | `.lake-data/DEP-E/DEP-E-20260802-Heartcare ECG/heartcare_ecg_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2311.01729 | Metadata and abstract | 2026-08-09 | Metadata only |
| R2 | https://arxiv.org/html/2311.01729 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-09 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2311.01729 | Primary paper integrity | 2026-08-09 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260711-Telecom AI Roadmap/telecom_ai_roadmap_manuscript.md` | Related synthesis: synthesizing, diffusion, conditional | 2026-08-09 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260719-MA-VLM PNU Moderation/ma_vlm_pnu_moderation_manuscript.md` | Related synthesis: social, dual, conditional | 2026-08-09 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260802-Heartcare ECG/heartcare_ecg_manuscript.md` | Related synthesis: dual, diffusion, conditional | 2026-08-09 | Repository-relative |

## Appendix

- Uniform selected index: 33,498 of 75,957 units from 75,960 PDFs.
