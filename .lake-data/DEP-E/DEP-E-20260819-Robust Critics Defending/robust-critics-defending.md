...
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260725-Tech Intel 1101 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260725-Tech%20Intel%201101/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-25_1101.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260725-Tech%20Intel%201101/daily_research_findings_2026-07-25_1101.md | Repository evidence; public URL | 2026-08-19 | Inspected |
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260725-Tech%20Intel%201101/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260725-Tech%20Intel%201101/daily_research_findings_2026-07-25_1101.md | Deposited source synthesis | Dialogue Critic Guided Sampling treats adversarial dialogue as a Markov decision process, infers intent at every turn, and scores candidate responses with token- and utterance-level value and regret critics. The paper reports improvements over robust baselines and frontier models on CARES-18k, WildJailbreak, Redbench, and HarmBench, with transfer to frontier models without fine-tuning. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
...
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260725-Tech%20Intel%201101/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/DEP-20260725-Tech%20Intel%201101/daily_research_findings_2026-07-25_1101.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
