---
title: "Vortex Efficient - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Vortex: Efficient Sample-Free Dynamic Tensor Program Optimization via Hardware-aware Strategy Space Hierarchization."
...
primary_url: "https://arxiv.org/abs/2409.01075"
stable_identifier: "arXiv:2409.01075; DOI:10.48550/arXiv.2409.01075"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P232"
...
# Vortex Efficient - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2409.01075 | https://arxiv.org/abs/2409.01075 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2409.01075 rendering | https://arxiv.org/html/2409.01075 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2409.01075 | https://arxiv.org/pdf/2409.01075 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | HAO Hardware-aware neural - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-HAO Hardware-aware neural/hao_hardware_aware_neural_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | An Online Prediction - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-An Online Prediction/an_online_prediction_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P232` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhou, Yangjie; Zhu, Honglin; Qiu, Qian; Cui, Weihao; Liu, Zihan; Guo, Cong; Feng, Siyuan; Meng, Jintao; Lan, Haidong; Leng, Jingwen; Zhu, Wenxi; Deng, Minwen. Submitted/source date: 2024/09/02. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P232`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: dynamic, hardware-aware, optimization, strategy | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies dynamic, hardware-aware, hierarchization. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around dynamic, hardware-aware, hierarchization. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Have a free development cycle? Help support accessibility at arXiv! Our collaborators at LaTeXML maintain a list of …”. The full-paper rendering contains 89 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving dynamic, hardware-aware, hierarchization. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 55,883 of 75,964 units; duplicate exclusions 2; focus exclusions 22; source-gate exclusions 0; reselections 24.
...
- The related DEPs show how dynamic, hardware-aware, optimization, strategy connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: dynamic, hardware-aware, optimization, strategy.
...
|---|---|---|---|
| HAO Hardware-aware neural - DEP-E | Related DEP | Overlap: hardware-aware, optimization, strategy | `.lake-data/DEP-E/DEP-E-20260819-HAO Hardware-aware neural/hao_hardware_aware_neural_manuscript.md` |
| A Framework Based on - DEP-E | Related DEP | Overlap: dynamic, optimization, strategy | `.lake-data/DEP-E/DEP-E-20260819-A Framework Based on/a_framework_based_on_manuscript.md` |
| An Online Prediction - DEP-E | Related DEP | Overlap: dynamic, optimization, strategy | `.lake-data/DEP-E/DEP-E-20260819-An Online Prediction/an_online_prediction_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2409.01075 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2409.01075 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2409.01075 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-HAO Hardware-aware neural/hao_hardware_aware_neural_manuscript.md` | Related synthesis: hardware-aware, optimization, strategy | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-A Framework Based on/a_framework_based_on_manuscript.md` | Related synthesis: dynamic, optimization, strategy | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-An Online Prediction/an_online_prediction_manuscript.md` | Related synthesis: dynamic, optimization, strategy | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 55,883 of 75,964 units from 75,967 PDFs.
