---
title: "Practical Poisoning - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Practical Poisoning Attacks against Retrieval-Augmented Generation."
...
primary_url: "https://arxiv.org/abs/2504.03957"
stable_identifier: "arXiv:2504.03957; DOI:10.48550/arXiv.2504.03957"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P262"
...
# Practical Poisoning - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2504.03957 | https://arxiv.org/abs/2504.03957 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2504.03957 rendering | https://arxiv.org/html/2504.03957 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2504.03957 | https://arxiv.org/pdf/2504.03957 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P262` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhang, Baolei; Chen, Yuxi; Liu, Zhuqing; Nie, Lihai; Li, Tong; Liu, Zheli; Fang, Minghong. Submitted/source date: 2025/04/04. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P262`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Large language models (LLMs) have demonstrated impressive natural language processing abilities but face challenges such as hallucination and …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Large language models (LLMs) have demonstrated impressive natural language processing abilities but face challenges such as hallucination and …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: attacks, generation, poisoning, practical, retrieval-augmented | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies attacks, generation, poisoning. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around attacks, generation, poisoning. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Large language models (LLMs) have demonstrated impressive natural language processing abilities but face challenges such as hallucination and …”. The full-paper rendering contains 62 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Large language models (LLMs) have demonstrated impressive natural language processing abilities but face challenges such as hallucination and …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Large language models (LLMs) have demonstrated impressive natural language processing abilities but face challenges such as hallucination and …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving attacks, generation, poisoning. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 32,018 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how attacks, generation, poisoning, practical, retrieval-augmented connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: attacks, generation, poisoning, practical, retrieval-augmented.
...
|---|---|---|---|
| DiscourseFlip Risk Review | Related DEP | Overlap: retrieval-augmented, generation, poisoning, attacks | `.lake-data/DEP-E/DEP-E-20260719-DiscourseFlip RAG Risk/discourseflip_rag_risk_manuscript.md` |
| A-RAG Scaling Agentic - DEP-E | Related DEP | Overlap: retrieval-augmented, generation, practical | `.lake-data/DEP-E/DEP-E-20260818-A-RAG Scaling Agentic/a_rag_scaling_agentic_manuscript.md` |
| Language-Coupled - DEP-E | Related DEP | Overlap: retrieval-augmented, generation, practical | `.lake-data/DEP-E/DEP-E-20260818-Language-Coupled/language_coupled_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2504.03957 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2504.03957 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2504.03957 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260719-DiscourseFlip RAG Risk/discourseflip_rag_risk_manuscript.md` | Related synthesis: retrieval-augmented, generation, poisoning, attacks | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-A-RAG Scaling Agentic/a_rag_scaling_agentic_manuscript.md` | Related synthesis: retrieval-augmented, generation, practical | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Language-Coupled/language_coupled_manuscript.md` | Related synthesis: retrieval-augmented, generation, practical | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 32,018 of 75,964 units from 75,967 PDFs.
