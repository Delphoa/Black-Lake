---
title: "On the Transformer Growth - DEP-E"
generated_at: "2026-08-17 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of On the Transformer Growth for Progressive BERT Training."
...
primary_url: "https://arxiv.org/abs/2010.12562"
stable_identifier: "arXiv:2010.12562; DOI:10.48550/arXiv.2010.12562"
deployment_job_id: "BLAD-2200-20260817-2C1A830E"
deployment_item_id: "BLAD-2200-20260817-2C1A830E-P06"
...
# On the Transformer Growth - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2010.12562 | https://arxiv.org/abs/2010.12562 | Metadata only. | 2026-08-17 | Inspected |
| S2 | Full paper | Primary | HTML | 2010.12562 rendering | https://arxiv.org/html/2010.12562 | Verified local copy withheld. | 2026-08-17 | Inspected in full |
| S3 | PDF | Primary | PDF | 2010.12562 | https://arxiv.org/pdf/2010.12562 | Verified local copy withheld. | 2026-08-17 | Integrity checked and sampled |
| S4 | COVID Fake News - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S5 | Spiking Pose Tracking - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S6 | Inception Transformer - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260806-Inception Transformer/inception_transformer_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260817-2C1A830E-P06` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-17 | Verified |

Authors: Gu, Xiaotao; Liu, Liyuan; Yu, Hongkun; Li, Jing; Chen, Chen; Han, Jiawei. Submitted/source date: 2020/10/23. Job `BLAD-2200-20260817-2C1A830E`; item `BLAD-2200-20260817-2C1A830E-P06`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Due to the excessive cost of large-scale language model pre-training, considerable efforts have been made to train BERT …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Further, we explore the potential choices of growth operators on each dimension. We conduct controlled experiments and comprehensive …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: bert, training, transformer | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies bert, growth, progressive. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around bert, growth, progressive. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Due to the excessive cost of large-scale language model pre-training, considerable efforts have been made to train BERT …”. The full-paper rendering contains 34 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Further, we explore the potential choices of growth operators on each dimension. We conduct controlled experiments and comprehensive …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Thanks to the rapid increase of computing power, large-scale pre-training has been breaking the glass ceiling for natural …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving bert, growth, progressive. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 64,506 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how bert, training, transformer connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: bert, training, transformer.
...
|---|---|---|---|
| COVID Fake News - DEP-E | Related DEP | Overlap: transformer, bert, training | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` |
| Spiking Pose Tracking - DEP-E | Related DEP | Overlap: transformer, training | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` |
| Inception Transformer - DEP-E | Related DEP | Overlap: transformer, training | `.lake-data/DEP-E/DEP-E-20260806-Inception Transformer/inception_transformer_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2010.12562 | Metadata and abstract | 2026-08-17 | Metadata only |
| R2 | https://arxiv.org/html/2010.12562 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-17 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2010.12562 | Primary paper integrity | 2026-08-17 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260802-COVID Fake News/covid_fake_news_manuscript.md` | Related synthesis: transformer, bert, training | 2026-08-17 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Related synthesis: transformer, training | 2026-08-17 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260806-Inception Transformer/inception_transformer_manuscript.md` | Related synthesis: transformer, training | 2026-08-17 | Repository-relative |

## Appendix

- Uniform selected index: 64,506 of 75,964 units from 75,967 PDFs.
