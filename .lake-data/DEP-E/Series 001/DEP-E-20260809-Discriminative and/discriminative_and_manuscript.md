---
title: "Discriminative and - DEP-E"
generated_at: "2026-08-09 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Discriminative and Semantic Feature Selection for Place Recognition towards Dynamic Environments."
...
primary_url: "https://arxiv.org/abs/2103.10023"
stable_identifier: "arXiv:2103.10023; DOI:10.48550/arXiv.2103.10023"
deployment_job_id: "BLAD-2200-20260809-2E4CB30E"
deployment_item_id: "BLAD-2200-20260809-2E4CB30E-P06"
...
# Discriminative and - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2103.10023 | https://arxiv.org/abs/2103.10023 | Metadata only. | 2026-08-09 | Inspected |
| S2 | Full paper | Primary | HTML | 2103.10023 rendering | https://arxiv.org/html/2103.10023 | Verified local copy withheld. | 2026-08-09 | Inspected in full |
| S3 | PDF | Primary | PDF | 2103.10023 | https://arxiv.org/pdf/2103.10023 | Verified local copy withheld. | 2026-08-09 | Integrity checked and sampled |
| S4 | UAV Visual Localization - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-UAV Visual Localization/uav_visual_localization_manuscript.md` | Synthesis only. | 2026-08-09 | Inspected |
| S5 | Feature Denoising - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-Feature Denoising/feature_denoising_manuscript.md` | Synthesis only. | 2026-08-09 | Inspected |
| S6 | CLOVER Test Benchmark - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-CLOVER Test Benchmark/clover_test_benchmark_manuscript.md` | Synthesis only. | 2026-08-09 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260809-2E4CB30E-P06` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-09 | Verified |

Authors: Tian, Yuxin; MIao, Jinyu; Wu, Xingming; Yue, Haosong; Liu, Zhong; Chen, Weihai. Submitted/source date: 2021/03/18. Job `BLAD-2200-20260809-2E4CB30E`; item `BLAD-2200-20260809-2E4CB30E-P06`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In this paper, we propose a novel fully convolutional network (FCN), named DSFeat, to estimate a pixel-wise stability …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Features play an important role in various visual tasks, especially in visual place recognition applied in perceptual changing …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: discriminative, dynamic, environments, feature, place | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies discriminative, dynamic, environments. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around discriminative, dynamic, environments. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In this paper, we propose a novel fully convolutional network (FCN), named DSFeat, to estimate a pixel-wise stability …”. The full-paper rendering contains 42 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Features play an important role in various visual tasks, especially in visual place recognition applied in perceptual changing …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Features play an important role in various visual tasks, especially in visual place recognition applied in perceptual changing …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving discriminative, dynamic, environments. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 63,827 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how discriminative, dynamic, environments, feature, place connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: discriminative, dynamic, environments, feature, place.
...
|---|---|---|---|
| UAV Visual Localization - DEP-E | Related DEP | Overlap: place, recognition, environments, feature, semantic | `.lake-data/DEP-E/DEP-E-20260716-UAV Visual Localization/uav_visual_localization_manuscript.md` |
| Feature Denoising - DEP-E | Related DEP | Overlap: place, recognition, environments, feature, semantic | `.lake-data/DEP-E/DEP-E-20260721-Feature Denoising/feature_denoising_manuscript.md` |
| CLOVER Test Benchmark - DEP-E | Related DEP | Overlap: discriminative, environments, dynamic, semantic, selection | `.lake-data/DEP-E/DEP-E-20260719-CLOVER Test Benchmark/clover_test_benchmark_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2103.10023 | Metadata and abstract | 2026-08-09 | Metadata only |
| R2 | https://arxiv.org/html/2103.10023 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-09 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2103.10023 | Primary paper integrity | 2026-08-09 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260716-UAV Visual Localization/uav_visual_localization_manuscript.md` | Related synthesis: place, recognition, environments, feature, semantic | 2026-08-09 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260721-Feature Denoising/feature_denoising_manuscript.md` | Related synthesis: place, recognition, environments, feature, semantic | 2026-08-09 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260719-CLOVER Test Benchmark/clover_test_benchmark_manuscript.md` | Related synthesis: discriminative, environments, dynamic, semantic, selection | 2026-08-09 | Repository-relative |

## Appendix

- Uniform selected index: 63,827 of 75,957 units from 75,960 PDFs.
