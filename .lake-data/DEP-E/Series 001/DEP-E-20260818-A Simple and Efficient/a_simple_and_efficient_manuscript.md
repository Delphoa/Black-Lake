---
title: "A Simple and Efficient - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A Simple and Efficient Multi-task Network for 3D Object Detection and Road Understanding."
...
primary_url: "https://arxiv.org/abs/2103.04056"
stable_identifier: "arXiv:2103.04056; DOI:10.48550/arXiv.2103.04056"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P11"
...
# A Simple and Efficient - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2103.04056 | https://arxiv.org/abs/2103.04056 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2103.04056 rendering | https://arxiv.org/html/2103.04056 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2103.04056 | https://arxiv.org/pdf/2103.04056 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | DoubleTransfer MEDIQA - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-DoubleTransfer MEDIQA/doubletransfer_mediqa_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | Dirty Road Can Attack - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Dirty Road Can Attack/dirty_road_can_attack_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | Device Tuning MTL - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-Device Tuning MTL/device_tuning_mtl_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P11` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Feng, Di; Zhou, Yiyang; Xu, Chenfeng; Tomizuka, Masayoshi; Zhan, Wei. Submitted/source date: 2021/03/06. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P11`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Detecting dynamic objects and predicting static road information such as drivable areas and ground heights are crucial for …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Detecting dynamic objects and predicting static road information such as drivable areas and ground heights are crucial for …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: detection, multi-task, network, object, road | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies detection, multi-task, network. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around detection, multi-task, network. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Detecting dynamic objects and predicting static road information such as drivable areas and ground heights are crucial for …”. The full-paper rendering contains 67 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Detecting dynamic objects and predicting static road information such as drivable areas and ground heights are crucial for …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Reliable traffic object detection and road understanding near the ego-vehicle are fundamental perception problems in autonomous driving. Movable …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving detection, multi-task, network. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 10,178 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how detection, multi-task, network, object, road connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: detection, multi-task, network, object, road.
...
|---|---|---|---|
| DoubleTransfer MEDIQA - DEP-E | Related DEP | Overlap: multi-task, understanding, object | `.lake-data/DEP-E/DEP-E-20260719-DoubleTransfer MEDIQA/doubletransfer_mediqa_manuscript.md` |
| Dirty Road Can Attack - DEP-E | Related DEP | Overlap: road, simple, detection | `.lake-data/DEP-E/DEP-E-20260818-Dirty Road Can Attack/dirty_road_can_attack_manuscript.md` |
| Device Tuning MTL - DEP-E | Related DEP | Overlap: multi-task, object, network | `.lake-data/DEP-E/DEP-E-20260719-Device Tuning MTL/device_tuning_mtl_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2103.04056 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2103.04056 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2103.04056 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260719-DoubleTransfer MEDIQA/doubletransfer_mediqa_manuscript.md` | Related synthesis: multi-task, understanding, object | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Dirty Road Can Attack/dirty_road_can_attack_manuscript.md` | Related synthesis: road, simple, detection | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260719-Device Tuning MTL/device_tuning_mtl_manuscript.md` | Related synthesis: multi-task, object, network | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 10,178 of 75,964 units from 75,967 PDFs.
