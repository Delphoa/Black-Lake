---
title: "An Efficient 13767 - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of An Efficient Diffusion-based Non-Autoregressive Solver for Traveling Salesman Problem."
...
primary_url: "https://arxiv.org/abs/2501.13767"
stable_identifier: "arXiv:2501.13767; DOI:10.48550/arXiv.2501.13767"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P245"
...
# An Efficient 13767 - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2501.13767 | https://arxiv.org/abs/2501.13767 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2501.13767 rendering | https://arxiv.org/html/2501.13767 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2501.13767 | https://arxiv.org/pdf/2501.13767 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | Improving Reliability - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Improving Reliability/improving_reliability_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P245` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Mingzhao; Zhou, You; Cao, Zhiguang; Xiao, Yubin; Wu, Xuan; Pang, Wei; Jiang, Yuan; Yang, Hui; Zhao, Peng; Li, Yuanshu. Submitted/source date: 2025/01/23. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P245`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Recent advances in neural models have shown considerable promise in solving Traveling Salesman Problems (TSPs) without relying on …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Recent advances in neural models have shown considerable promise in solving Traveling Salesman Problems (TSPs) without relying on …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: diffusion-based, problem | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies diffusion-based, non-autoregressive, problem. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around diffusion-based, non-autoregressive, problem. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Recent advances in neural models have shown considerable promise in solving Traveling Salesman Problems (TSPs) without relying on …”. The full-paper rendering contains 70 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Recent advances in neural models have shown considerable promise in solving Traveling Salesman Problems (TSPs) without relying on …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Recent advances in neural models have shown considerable promise in solving Traveling Salesman Problems (TSPs) without relying on …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving diffusion-based, non-autoregressive, problem. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 24,658 of 75,964 units; duplicate exclusions 8; focus exclusions 50; source-gate exclusions 0; reselections 58.
...
- The related DEPs show how diffusion-based, problem connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: diffusion-based, problem.
...
|---|---|---|---|
| TopoDiffuser A - DEP-E | Related DEP | Overlap: diffusion-based, problem | `.lake-data/DEP-E/DEP-E-20260730-TopoDiffuser A/topodiffuser_a_manuscript.md` |
| VanGogh A Unified - DEP-E | Related DEP | Overlap: diffusion-based, problem | `.lake-data/DEP-E/DEP-E-20260818-VanGogh A Unified/vangogh_a_unified_manuscript.md` |
| Improving Reliability - DEP-E | Related DEP | Overlap: diffusion-based, problem | `.lake-data/DEP-E/DEP-E-20260819-Improving Reliability/improving_reliability_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2501.13767 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2501.13767 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2501.13767 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260730-TopoDiffuser A/topodiffuser_a_manuscript.md` | Related synthesis: diffusion-based, problem | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-VanGogh A Unified/vangogh_a_unified_manuscript.md` | Related synthesis: diffusion-based, problem | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Improving Reliability/improving_reliability_manuscript.md` | Related synthesis: diffusion-based, problem | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 24,658 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 8; focus exclusions: 50; source-gate exclusions: 0; reselections: 58; 24-hour cutoff: 2026-08-18.
