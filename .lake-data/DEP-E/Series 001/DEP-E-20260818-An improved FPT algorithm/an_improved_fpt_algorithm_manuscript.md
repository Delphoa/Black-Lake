---
title: "An improved FPT algorithm - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of An improved FPT algorithm for Independent Feedback Vertex Set."
...
primary_url: "https://arxiv.org/abs/1803.00937"
stable_identifier: "arXiv:1803.00937; DOI:10.48550/arXiv.1803.00937"
deployment_job_id: "BLAD-2200-20260818-BBEE0F31"
deployment_item_id: "BLAD-2200-20260818-BBEE0F31-P04"
...
# An improved FPT algorithm - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1803.00937 | https://arxiv.org/abs/1803.00937 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 1803.00937 rendering | https://arxiv.org/html/1803.00937 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 1803.00937 | https://arxiv.org/pdf/1803.00937 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | RLMF Uncertainty - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260714-RLMF Uncertainty/rlmf_uncertainty_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | Compressed CSI Feedback - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback/compressed_csi_feedback_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-BBEE0F31-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Li, Shaohua; Pilipczuk, Marcin. Submitted/source date: 2018/03/02. Job `BLAD-2200-20260818-BBEE0F31`; item `BLAD-2200-20260818-BBEE0F31-P04`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We study the Independent Feedback Vertex Set problem — a variant of the classic Feedback Vertex Set problem …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We study the Independent Feedback Vertex Set problem — a variant of the classic Feedback Vertex Set problem …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: feedback, independent, set | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, feedback, fpt. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, feedback, fpt. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We study the Independent Feedback Vertex Set problem — a variant of the classic Feedback Vertex Set problem …”. The full-paper rendering contains 41 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We study the Independent Feedback Vertex Set problem — a variant of the classic Feedback Vertex Set problem …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Disjoint Independent Feedback Vertex Set Input: An undirected (multi)graph G G , a feedback vertex set W W …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, feedback, fpt. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 13,290 of 75,964 units; duplicate exclusions 1; focus exclusions 4; source-gate exclusions 0; reselections 5.
...
- The related DEPs show how feedback, independent, set connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: feedback, independent, set.
...
|---|---|---|---|
| RLMF Uncertainty - DEP-E | Related DEP | Overlap: feedback, set, independent | `.lake-data/DEP-E/DEP-E-20260714-RLMF Uncertainty/rlmf_uncertainty_manuscript.md` |
| Compressed CSI Feedback - DEP-E | Related DEP | Overlap: feedback, set, independent | `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback/compressed_csi_feedback_manuscript.md` |
| RLHF-V Towards - DEP-E | Related DEP | Overlap: feedback, set, independent | `.lake-data/DEP-E/DEP-E-20260730-RLHF-V Towards/rlhf_v_towards_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1803.00937 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/1803.00937 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1803.00937 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260714-RLMF Uncertainty/rlmf_uncertainty_manuscript.md` | Related synthesis: feedback, set, independent | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback/compressed_csi_feedback_manuscript.md` | Related synthesis: feedback, set, independent | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260730-RLHF-V Towards/rlhf_v_towards_manuscript.md` | Related synthesis: feedback, set, independent | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 13,290 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 1; focus exclusions: 4; source-gate exclusions: 0; reselections: 5; 24-hour cutoff: 2026-08-17.
