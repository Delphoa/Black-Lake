---
title: "A density peaks - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A density peaks clustering algorithm with sparse search and K-d tree."
...
primary_url: "https://arxiv.org/abs/2203.00973"
stable_identifier: "arXiv:2203.00973; DOI:10.1109/ACCESS.2022.3190958"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P281"
...
# A density peaks - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2203.00973 | https://arxiv.org/abs/2203.00973 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2203.00973 rendering | https://arxiv.org/html/2203.00973 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2203.00973 | https://arxiv.org/pdf/2203.00973 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Federated Matrix - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Federated Matrix/federated_matrix_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P281` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Shan, Yunxiao; Li, Shu; Li, Fuxiang; Cui, Yuxin; Li, Shuai; Zhou, Ming; Li, Xiang. Submitted/source date: 2022/03/02. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P281`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Density peaks clustering has become a nova of clustering algorithm because of its simplicity and practicality. However, there …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Density peaks clustering has become a nova of clustering algorithm because of its simplicity and practicality. However, there …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, clustering | Cross-DEP synthesis | Medium | No joint experiment exists |
...
The method evidence is represented by “Density peaks clustering has become a nova of clustering algorithm because of its simplicity and practicality. However, there …”. The full-paper rendering contains 48 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Density peaks clustering has become a nova of clustering algorithm because of its simplicity and practicality. However, there …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Density peaks clustering has become a nova of clustering algorithm because of its simplicity and practicality. However, there …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.
...
- `Selection and dedup`: Draw 30,078 of 75,964 units; duplicate exclusions 3; focus exclusions 18; source-gate exclusions 0; reselections 21.
...
- The related DEPs show how algorithm, clustering connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, clustering.
...
| Image Clustering - DEP-E | Related DEP | Overlap: clustering, algorithm | `.lake-data/DEP-E/DEP-E-20260819-Image Clustering/image_clustering_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2203.00973 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2203.00973 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2203.00973 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
...
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Federated Matrix/federated_matrix_manuscript.md` | Related synthesis: clustering, algorithm | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Image Clustering/image_clustering_manuscript.md` | Related synthesis: clustering, algorithm | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 30,078 of 75,964 units from 75,967 PDFs.
