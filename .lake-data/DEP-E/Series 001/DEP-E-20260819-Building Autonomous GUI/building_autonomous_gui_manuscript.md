---
title: "Building Autonomous GUI - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Building Autonomous GUI Navigation via Agentic-Q Estimation and Step-Wise Policy Optimization."
...
primary_url: "https://arxiv.org/abs/2602.13653"
stable_identifier: "arXiv:2602.13653; DOI:10.48550/arXiv.2602.13653"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P439"
...
# Building Autonomous GUI - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2602.13653 | https://arxiv.org/abs/2602.13653 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2602.13653 rendering | https://arxiv.org/html/2602.13653 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2602.13653 | https://arxiv.org/pdf/2602.13653 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | LPO Towards Accurate GUI - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-LPO Towards Accurate GUI/lpo_towards_accurate_gui_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P439` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Yibo; Huzhang, Guangda; Hu, Yuwei; Xia, Yu; Lu, Shiyin; Chen, Qing-Guo; Xu, Zhao; Luo, Weihua; Zhang, Kaifu; Zhang, Lijun. Submitted/source date: 2026/02/14. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P439`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: autonomous, building, gui, optimization, policy | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies agentic-q, autonomous, building. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around agentic-q, autonomous, building. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 37 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving agentic-q, autonomous, building. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 38,815 of 75,964 units; duplicate exclusions 13; focus exclusions 73; source-gate exclusions 0; reselections 86.
...
- The related DEPs show how autonomous, building, gui, optimization, policy connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: autonomous, building, gui, optimization, policy.
...
|---|---|---|---|
| ARPO End-to-End Policy - DEP-E | Related DEP | Overlap: gui, policy, optimization, autonomous | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` |
| LPO Towards Accurate GUI - DEP-E | Related DEP | Overlap: gui, optimization, policy, autonomous | `.lake-data/DEP-E/DEP-E-20260819-LPO Towards Accurate GUI/lpo_towards_accurate_gui_manuscript.md` |
| MCPWorld - DEP-E | Related DEP | Overlap: gui, building, policy, autonomous | `.lake-data/DEP-E/DEP-E-20260730-MCPWorld Benchmark/mcpworld_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2602.13653 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2602.13653 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2602.13653 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` | Related synthesis: gui, policy, optimization, autonomous | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-LPO Towards Accurate GUI/lpo_towards_accurate_gui_manuscript.md` | Related synthesis: gui, optimization, policy, autonomous | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260730-MCPWorld Benchmark/mcpworld_manuscript.md` | Related synthesis: gui, building, policy, autonomous | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 38,815 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 13; focus exclusions: 73; source-gate exclusions: 0; reselections: 86; 24-hour cutoff: 2026-08-18.
