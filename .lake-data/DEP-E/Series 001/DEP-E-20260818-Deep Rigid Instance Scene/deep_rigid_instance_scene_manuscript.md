---
title: "Deep Rigid Instance Scene - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Deep Rigid Instance Scene Flow."
...
primary_url: "https://arxiv.org/abs/1904.08913"
stable_identifier: "arXiv:1904.08913; DOI:10.48550/arXiv.1904.08913"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P44"
...
# Deep Rigid Instance Scene - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1904.08913 | https://arxiv.org/abs/1904.08913 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 1904.08913 rendering | https://arxiv.org/html/1904.08913 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 1904.08913 | https://arxiv.org/pdf/1904.08913 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | Periodic Vibration - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260811-Periodic Vibration/periodic_vibration_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | Free Energy Surface - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260810-Free Energy Surface/free_energy_surface_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | Unveil Inversion and - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Unveil Inversion and/unveil_inversion_and_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P44` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Ma, Wei-Chiu; Wang, Shenlong; Hu, Rui; Xiong, Yuwen; Urtasun, Raquel. Submitted/source date: 2019/04/18. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P44`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “With these problems in mind, we develop a novel deep rigid instance scene flow (DRISF) model that takes …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In this paper we tackle the problem of scene flow estimation in the context of self-driving. We leverage …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: flow, scene | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies flow, instance, rigid. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around flow, instance, rigid. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “With these problems in mind, we develop a novel deep rigid instance scene flow (DRISF) model that takes …”. The full-paper rendering contains 87 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In this paper we tackle the problem of scene flow estimation in the context of self-driving. We leverage …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Optical flow is traditionally posed as an energy minimization task. It dates back to Horn and Schunck horn1981determining …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving flow, instance, rigid. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 14,652 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how flow, scene connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: flow, scene.
...
|---|---|---|---|
| Periodic Vibration - DEP-E | Related DEP | Overlap: scene, flow | `.lake-data/DEP-E/DEP-E-20260811-Periodic Vibration/periodic_vibration_manuscript.md` |
| Free Energy Surface - DEP-E | Related DEP | Overlap: flow | `.lake-data/DEP-E/DEP-E-20260810-Free Energy Surface/free_energy_surface_manuscript.md` |
| Unveil Inversion and - DEP-E | Related DEP | Overlap: flow | `.lake-data/DEP-E/DEP-E-20260818-Unveil Inversion and/unveil_inversion_and_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1904.08913 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/1904.08913 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1904.08913 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260811-Periodic Vibration/periodic_vibration_manuscript.md` | Related synthesis: scene, flow | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260810-Free Energy Surface/free_energy_surface_manuscript.md` | Related synthesis: flow | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Unveil Inversion and/unveil_inversion_and_manuscript.md` | Related synthesis: flow | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 14,652 of 75,964 units from 75,967 PDFs.
