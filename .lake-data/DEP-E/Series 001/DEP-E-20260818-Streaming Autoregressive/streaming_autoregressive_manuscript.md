---
title: "Streaming Autoregressive - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Streaming Autoregressive Video Generation via Diagonal Distillation."
...
primary_url: "https://arxiv.org/abs/2603.09488"
stable_identifier: "arXiv:2603.09488; DOI:10.48550/arXiv.2603.09488"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P04"
...
# Streaming Autoregressive - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2603.09488 | https://arxiv.org/abs/2603.09488 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2603.09488 rendering | https://arxiv.org/html/2603.09488 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2603.09488 | https://arxiv.org/pdf/2603.09488 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
...
| S5 | Avatar V Scaling - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260810-Avatar V Scaling/avatar_v_scaling_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | VideoWeave - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260709-VideoWeave Geometry/videoweave_geometry_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Liu, Jinxiu; Liu, Xuanming; Mei, Kangfu; Wen, Yandong; Yang, Ming-Hsuan; Liu, Weiyang. Submitted/source date: 2026/03/10. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P04`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: autoregressive, distillation, generation, streaming, video | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies autoregressive, diagonal, distillation. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around autoregressive, diagonal, distillation. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving autoregressive, diagonal, distillation. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 31,176 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how autoregressive, distillation, generation, streaming, video connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: autoregressive, distillation, generation, streaming, video.
...
|---|---|---|---|
| AR-Drag Motion Control - DEP-E | Related DEP | Overlap: autoregressive, video, streaming, distillation, generation | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` |
| Avatar V Scaling - DEP-E | Related DEP | Overlap: video, generation, autoregressive | `.lake-data/DEP-E/DEP-E-20260810-Avatar V Scaling/avatar_v_scaling_manuscript.md` |
| VideoWeave - DEP-E | Related DEP | Overlap: video, generation, distillation | `.lake-data/DEP-E/DEP-E-20260709-VideoWeave Geometry/videoweave_geometry_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2603.09488 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2603.09488 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2603.09488 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260720-AR-Drag Motion/ar_drag_motion_manuscript.md` | Related synthesis: autoregressive, video, streaming, distillation, generation | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260810-Avatar V Scaling/avatar_v_scaling_manuscript.md` | Related synthesis: video, generation, autoregressive | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260709-VideoWeave Geometry/videoweave_geometry_manuscript.md` | Related synthesis: video, generation, distillation | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 31,176 of 75,964 units from 75,967 PDFs.
