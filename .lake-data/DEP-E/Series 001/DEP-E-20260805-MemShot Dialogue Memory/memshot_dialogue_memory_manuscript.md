...
| S4 | C-DIC Dialogue Memory DEP | Related research | Black Lake DEP-A manuscript | arXiv:2606.12411v1 | [repository artifact](https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/Series%20001/DEP-A-20260714-C-DIC%20Dialogue%20Memory/2606.12411-whitepaper-review.md) | Derived review; source paper not deposited here | 2026-08-05 | Read for conceptual comparison |
| S5 | MemRouter DEP | Related research | Black Lake DEP-A manuscript | arXiv:2605.00356v1 | [repository artifact](https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/Series%20001/DEP-A-20260714-MemRouter/2605.00356-whitepaper-review.md) | Derived review; source paper not deposited here | 2026-08-05 | Read for conceptual comparison |
...
|---|---|---|---|
| C-DIC Dialogue Memory | Related DEP review | Revisable latent memory and retrieval-aware write-back | [Black Lake artifact](https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/Series%20001/DEP-A-20260714-C-DIC%20Dialogue%20Memory/2606.12411-whitepaper-review.md) |
| MemRouter | Related DEP review | Learned memory admission separated from retrieval and answering | [Black Lake artifact](https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/Series%20001/DEP-A-20260714-MemRouter/2605.00356-whitepaper-review.md) |
| Agent Memory Forensics | Defensive related DEP | Provenance, memory poisoning, telemetry, and audit boundaries | [Black Lake artifact](https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/Series%20001/DEP-A-20260714-Agent%20Memory%20Forensics/agent-memory-forensics-intake-review.md) |
