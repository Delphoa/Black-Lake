---
title: "ChatABL Abductive - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of ChatABL: Abductive Learning via Natural Language Interaction with ChatGPT."
...
primary_url: "https://arxiv.org/abs/2304.11107"
stable_identifier: "arXiv:2304.11107; DOI:10.48550/arXiv.2304.11107"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P09"
...
# ChatABL Abductive - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2304.11107 | https://arxiv.org/abs/2304.11107 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2304.11107 rendering | https://arxiv.org/html/2304.11107 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2304.11107 | https://arxiv.org/pdf/2304.11107 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | Multimodal Cyber-physical - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260725-Multimodal Cyber-physical/multimodal_cyber_physical_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | Interaction Measures - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Interaction Measures/interaction_measures_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | Building Taiwanese Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260722-Building Taiwanese/building_taiwanese_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P09` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Zhong, Tianyang; Wei, Yaonai; Yang, Li; Wu, Zihao; Liu, Zhengliang; Wei, Xiaozheng; Li, Wenjun; Yao, Junjie; Ma, Chong; Li, Xiang; Zhu, Dajiang; Jiang, Xi; Han, Junwei; Shen, Dinggang; Liu, Tianming; Zhang, Tuo. Submitted/source date: 2023/04/21. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P09`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Large language models (LLMs) such as ChatGPT have recently demonstrated significant potential in mathematical abilities, providing valuable reasoning …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “From the perspective of human perception and cognitive ability [ 9 , 29 , 42 , 61 , …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: interaction, language | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies abductive, chatabl, chatgpt. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around abductive, chatabl, chatgpt. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Large language models (LLMs) such as ChatGPT have recently demonstrated significant potential in mathematical abilities, providing valuable reasoning …”. The full-paper rendering contains 47 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “From the perspective of human perception and cognitive ability [ 9 , 29 , 42 , 61 , …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Large language models (LLMs) such as ChatGPT have recently demonstrated significant potential in mathematical abilities, providing valuable reasoning …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving abductive, chatabl, chatgpt. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 41,139 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how interaction, language connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: interaction, language.
...
|---|---|---|---|
| Multimodal Cyber-physical - DEP-E | Related DEP | Overlap: interaction, language | `.lake-data/DEP-E/DEP-E-20260725-Multimodal Cyber-physical/multimodal_cyber_physical_manuscript.md` |
| Interaction Measures - DEP-E | Related DEP | Overlap: interaction | `.lake-data/DEP-E/DEP-E-20260803-Interaction Measures/interaction_measures_manuscript.md` |
| Building Taiwanese Review - DEP-E | Related DEP | Overlap: language, interaction | `.lake-data/DEP-E/DEP-E-20260722-Building Taiwanese/building_taiwanese_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2304.11107 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2304.11107 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2304.11107 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260725-Multimodal Cyber-physical/multimodal_cyber_physical_manuscript.md` | Related synthesis: interaction, language | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260803-Interaction Measures/interaction_measures_manuscript.md` | Related synthesis: interaction | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260722-Building Taiwanese/building_taiwanese_manuscript.md` | Related synthesis: language, interaction | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 41,139 of 75,964 units from 75,967 PDFs.
