---
title: "GraphDx A Cost Aware - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "GraphDx: A Cost-Aware Knowledge-Enhanced Multi-Agent Framework for Sequential Diagnosis"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260720-Tech Intel 1303"
selection_record: "117 candidates; 50 excluded; 67 eligible; draw 1447135520; zero-based index 41"
expansion_record: "10 retained public locators; draw 1658138390; zero-based index 0"
...
- Authors or producing organization: Shaoting Tan; Ning Liu; Yuntao Du; Shuyue Wei; Wu Shuai; Qian Li; Yanyu Xu; Wei Zhang; Lizhen Cui; Haitao Yuan
- Source platform: arXiv
- Publication date: 2026-04-08
- Revision/version date: 2026-04-08
- Stable identifier: 2607.15280
- Categories: cs.AI
...
This artifact expands the selected DEP through GraphDx: A Cost-Aware Knowledge-Enhanced Multi-Agent Framework for Sequential Diagnosis. The deposited source package reports that ** GraphDx constructs Medical Diagnosis Knowledge Graphs with quantized typicality, action-centric topology, and attributes for both diagnostic relevance and test cost. Perception, Reasoning, and Decision agents divide language handling, deterministic evidence scoring, and cost-aware planning. On MedQA and MIMIC-IV using DeepSeek-V3, Kimi-k2, and Llama-3.3, the authors report diagnostic success rising from 50–68% to 79–93% while test costs fall 20–54%. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** Clinical agents must choose which information to acquire, not merely answer after being given an unconstrained workup. Explicit evidence scoring and cost-sensitive planning make resource use inspectable and could reduce unnecessary tests. These are benchmark results, not evidence of clinical safety; external cohorts, calibration, clinician oversight, and prospective evaluation remain essential. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** Clinical agents must choose which information to acquire, not merely answer after being given an unconstrained workup. Explicit evidence scoring and cost-sensitive planning make resource use inspectable and could reduce unnecessary tests. These are benchmark results, not evidence of clinical safety; external cohorts, calibration, clinician oversight, and prospective evaluation remain essential.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** GraphDx constructs Medical Diagnosis Knowledge Graphs with quantized typicality, action-centric topology, and attributes for both diagnostic relevance and test cost. Perception, Reasoning, and Decision agents divide language handling, deterministic evidence scoring, and cost-aware planning. On MedQA and MIMIC-IV using DeepSeek-V3, Kimi-k2, and Llama-3.3, the authors report diagnostic success rising from 50–68% to 79–93% while test costs fall 20–54%. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is GraphDx: A Cost-Aware Knowledge-Enhanced Multi-Agent Framework for Sequential Diagnosis, credited to Shaoting Tan; Ning Liu; Yuntao Du; Shuyue Wei; Wu Shuai; Qian Li; Yanyu Xu; Wei Zhang; Lizhen Cui; Haitao Yuan. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** Clinical agents must choose which information to acquire, not merely answer after being given an unconstrained workup. Explicit evidence scoring and cost-sensitive planning make resource use inspectable and could reduce unnecessary tests. These are benchmark results, not evidence of clinical safety; external cohorts, calibration, clinician oversight, and prospective evaluation remain essential. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260720-Tech Intel 1303 as a schema-complete DEP-E research artifact.
...
### New in this pass: GraphDx: A Cost-Aware Knowledge-Enhanced Multi-Agent Framework for Sequential Diagnosis

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [GraphDx: A Cost-Aware Knowledge-Enhanced Multi-Agent Framework for Sequential Diagnosis](https://arxiv.org/abs/2607.15280v1) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://arxiv.org/abs/2607.15596 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.15657 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.16109 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.15660 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.15550 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
...
- Batch item: 49 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 50; eligible count 67.
- DEP draw: accepted UInt32 1447135520; rejection limit 4294967263; attempts 1; zero-based index 41.
- Supporting draw: pool 10; accepted UInt32 1658138390; rejection limit 4294967290; attempts 1; zero-based index 0.
