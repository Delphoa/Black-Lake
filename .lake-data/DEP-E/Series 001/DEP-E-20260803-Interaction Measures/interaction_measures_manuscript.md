---
title: "Interaction Measures - DEP-E"
generated_at: "2026-08-03 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Interaction Measures, Partition Lattices and Kernel Tests for High-Order Interactions."
...
primary_url: "https://arxiv.org/abs/2306.00904"
stable_identifier: "arXiv:2306.00904; DOI:10.48550/arXiv.2306.00904"
deployment_job_id: "BLAD-2200-20260803-11C1283E"
deployment_item_id: "BLAD-2200-20260803-11C1283E-P04"
...
# Interaction Measures - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2306.00904 | https://arxiv.org/abs/2306.00904 | Metadata only. | 2026-08-03 | Inspected |
| S2 | Full paper | Primary | HTML | 2306.00904 rendering | https://arxiv.org/html/2306.00904 | Verified local copy withheld. | 2026-08-03 | Inspected in full |
| S3 | PDF | Primary | PDF | 2306.00904 | https://arxiv.org/pdf/2306.00904 | Verified local copy withheld. | 2026-08-03 | Integrity checked and sampled |
| S4 | VaTD Canonical - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-VaTD Canonical/vatd_canonical_manuscript.md` | Synthesis only. | 2026-08-03 | Inspected |
| S5 | Moran Spectra - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260717-Moran Spectra/moran_spectra_manuscript.md` | Synthesis only. | 2026-08-03 | Inspected |
| S6 | SpOctA Accelerator - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260718-SpOctA Accelerator/spocta_accelerator_manuscript.md` | Synthesis only. | 2026-08-03 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260803-11C1283E-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-03 | Verified |

Authors: Liu, Zhaolu; Peach, Robert L.; Mediano, Pedro A. M.; Barahona, Mauricio. Submitted/source date: 2023/06/01. Job `BLAD-2200-20260803-11C1283E`; item `BLAD-2200-20260803-11C1283E-P04`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Kernel-based hypothesis tests provide a non-parametric, statistically robust framework for detecting relationships between variables from observational data. Such …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Models that rely solely on pairwise relationships often fail to capture the complete statistical structure of the complex …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: interactions, kernel, lattices, measures, partition | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies high-order, interaction, interactions. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around high-order, interaction, interactions. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Kernel-based hypothesis tests provide a non-parametric, statistically robust framework for detecting relationships between variables from observational data. Such …”. The full-paper rendering contains 99 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Models that rely solely on pairwise relationships often fail to capture the complete statistical structure of the complex …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Direct measurements of group interactions are seldom available, leading to their omission, partial representation as projected pairwise interactions …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving high-order, interaction, interactions. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 75,267 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how interactions, kernel, lattices, measures, partition connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: interactions, kernel, lattices, measures, partition.
...
|---|---|---|---|
| VaTD Canonical - DEP-E | Related DEP | Overlap: lattices, partition, interactions, tests | `.lake-data/DEP-E/DEP-E-20260720-VaTD Canonical/vatd_canonical_manuscript.md` |
| Moran Spectra - DEP-E | Related DEP | Overlap: lattices, partition, measures, tests | `.lake-data/DEP-E/DEP-E-20260717-Moran Spectra/moran_spectra_manuscript.md` |
| SpOctA Accelerator - DEP-E | Related DEP | Overlap: partition, kernel, measures, tests | `.lake-data/DEP-E/DEP-E-20260718-SpOctA Accelerator/spocta_accelerator_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2306.00904 | Metadata and abstract | 2026-08-03 | Metadata only |
| R2 | https://arxiv.org/html/2306.00904 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-03 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2306.00904 | Primary paper integrity | 2026-08-03 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260720-VaTD Canonical/vatd_canonical_manuscript.md` | Related synthesis: lattices, partition, interactions, tests | 2026-08-03 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260717-Moran Spectra/moran_spectra_manuscript.md` | Related synthesis: lattices, partition, measures, tests | 2026-08-03 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260718-SpOctA Accelerator/spocta_accelerator_manuscript.md` | Related synthesis: partition, kernel, measures, tests | 2026-08-03 | Repository-relative |

## Appendix

- Uniform selected index: 75,267 of 75,957 units from 75,960 PDFs.
