---
title: "Cooperative Training of - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Cooperative Training of Fast Thinking Initializer and Slow Thinking Solver for Conditional Learning."
...
primary_url: "https://arxiv.org/abs/1902.02812"
stable_identifier: "arXiv:1902.02812; DOI:10.48550/arXiv.1902.02812"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P150"
...
# Cooperative Training of - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1902.02812 | https://arxiv.org/abs/1902.02812 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1902.02812 rendering | https://arxiv.org/html/1902.02812 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1902.02812 | https://arxiv.org/pdf/1902.02812 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Empirical Study on - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Empirical Study on/empirical_study_on_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Beyond Line-of-Sight - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260813-Beyond Line-of-Sight/beyond_line_of_sight_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P150` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Xie, Jianwen; Zheng, Zilong; Fang, Xiaolin; Zhu, Song-Chun; Wu, Ying Nian. Submitted/source date: 2019/02/07. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P150`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: cooperative | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies thinking, conditional, cooperative. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around thinking, conditional, cooperative. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving thinking, conditional, cooperative. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 59,368 of 75,964 units; duplicate exclusions 1; focus exclusions 7; source-gate exclusions 0; reselections 8.
...
- The related DEPs show how cooperative connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: cooperative.
...
| Beyond Line-of-Sight - DEP-E | Related DEP | Overlap: cooperative | `.lake-data/DEP-E/DEP-E-20260813-Beyond Line-of-Sight/beyond_line_of_sight_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1902.02812 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1902.02812 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1902.02812 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260803-Empirical Study on/empirical_study_on_manuscript.md` | Related synthesis: cooperative | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260805-UAV-Assisted Cooperative/uav_assisted_cooperative_manuscript.md` | Related synthesis: cooperative | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260813-Beyond Line-of-Sight/beyond_line_of_sight_manuscript.md` | Related synthesis: cooperative | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 59,368 of 75,964 units from 75,967 PDFs.
