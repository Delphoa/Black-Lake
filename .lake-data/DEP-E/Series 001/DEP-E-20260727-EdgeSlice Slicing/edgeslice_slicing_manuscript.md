---
title: "EdgeSlice Slicing - DEP-E"
generated_at: "2026-07-27 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of EdgeSlice: Slicing Wireless Edge Computing Network with Decentralized Deep Reinforcement Learning."
...
primary_url: "https://arxiv.org/abs/2003.12911"
stable_identifier: "arXiv:2003.12911; DOI:10.48550/arXiv.2003.12911"
deployment_job_id: "BLAD-2200-20260727-ADBD50D5"
deployment_item_id: "BLAD-2200-20260727-ADBD50D5-P10"
...
# EdgeSlice Slicing - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2003.12911 | https://arxiv.org/abs/2003.12911 | Metadata only. | 2026-07-27 | Inspected |
| S2 | Full paper | Primary | HTML | 2003.12911 rendering | https://ar5iv.labs.arxiv.org/html/2003.12911 | Verified local copy withheld. | 2026-07-27 | Inspected in full |
| S3 | PDF | Primary | PDF | 2003.12911 | https://arxiv.org/pdf/2003.12911 | Verified local copy withheld. | 2026-07-27 | Integrity checked and sampled |
| S4 | WorkflowLLM Enhancing - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260724-WorkflowLLM Enhancing/workflowllm_enhancing_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S5 | One-Touch Instruction Routing | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-MIRA One Touch/mira_one_touch_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S6 | DMNN Conditional Paths - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-DMNN Conditional Paths/dmnn_conditional_paths_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260727-ADBD50D5-P10` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-27 | Verified |

Authors: Liu, Qiang; Han, Tao; Moges, Ephraim. Submitted/source date: 2020/03/28. Job `BLAD-2200-20260727-ADBD50D5`; item `BLAD-2200-20260727-ADBD50D5-P10`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “where θ π ′ superscript 𝜃 superscript 𝜋 ′ \theta^{\pi^{\prime}} are parameters of the target network. The target …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “5G and edge computing will serve various emerging use cases that have diverse requirements of multiple resources, e.g., …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: constrained, dynamic, instruction, networks, orchestration | Cross-DEP synthesis | Medium | No joint experiment exists |
...
The work is organized around network, computing, edgeslice. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “where θ π ′ superscript 𝜃 superscript 𝜋 ′ \theta^{\pi^{\prime}} are parameters of the target network. The target …”. The full-paper rendering contains 79 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “5G and edge computing will serve various emerging use cases that have diverse requirements of multiple resources, e.g., …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The emerging use cases and heterogeneous services, e.g., Internet of things (IoT), augmented/virtual reality (AR/VR), vehicle-to-everything (V2X), and …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving network, computing, edgeslice. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 770 of 75,778 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how constrained, dynamic, instruction, networks, orchestration connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: constrained, dynamic, instruction, networks, orchestration.
...
|---|---|---|---|
| WorkflowLLM Enhancing - DEP-E | Related DEP | Overlap: orchestration, workflow | `.lake-data/DEP-E/DEP-E-20260724-WorkflowLLM Enhancing/workflowllm_enhancing_manuscript.md` |
| One-Touch Instruction Routing | Related DEP | Overlap: constrained, instruction | `.lake-data/DEP-E/DEP-E-20260719-MIRA One Touch/mira_one_touch_manuscript.md` |
| DMNN Conditional Paths - DEP-E | Related DEP | Overlap: dynamic, networks | `.lake-data/DEP-E/DEP-E-20260716-DMNN Conditional Paths/dmnn_conditional_paths_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2003.12911 | Metadata and abstract | 2026-07-27 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/2003.12911 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-27 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2003.12911 | Primary paper integrity | 2026-07-27 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260724-WorkflowLLM Enhancing/workflowllm_enhancing_manuscript.md` | Related synthesis: orchestration, workflow | 2026-07-27 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260719-MIRA One Touch/mira_one_touch_manuscript.md` | Related synthesis: constrained, instruction | 2026-07-27 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260716-DMNN Conditional Paths/dmnn_conditional_paths_manuscript.md` | Related synthesis: dynamic, networks | 2026-07-27 | Repository-relative |

## Appendix

- Uniform selected index: 770 of 75,778 units from 75,781 PDFs.
