---
title: "A General Neural Backbone - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A General Neural Backbone for Mixed-Integer Linear Optimization via Dual Attention."
...
primary_url: "https://arxiv.org/abs/2601.04509"
stable_identifier: "arXiv:2601.04509; DOI:10.48550/arXiv.2601.04509"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P390"
...
# A General Neural Backbone - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2601.04509 | https://arxiv.org/abs/2601.04509 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2601.04509 rendering | https://arxiv.org/html/2601.04509 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2601.04509 | https://arxiv.org/pdf/2601.04509 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Traceable Group-Wise - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Traceable Group-Wise/traceable_group_wise_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | UDuo Universal Dual - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-UDuo Universal Dual/uduo_universal_dual_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P390` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Huang, Peixin; Wu, Yaoxin; Ma, Yining; Wu, Cathy; Zhang, Wei; Song, Wen. Submitted/source date: 2026/01/08. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P390`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: attention, dual, neural, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies attention, backbone, dual. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around attention, backbone, dual. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving attention, backbone, dual. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 34,504 of 75,964 units; duplicate exclusions 0; focus exclusions 3; source-gate exclusions 0; reselections 3.
...
- The related DEPs show how attention, dual, neural, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: attention, dual, neural, optimization.
...
|---|---|---|---|
| ST-GIN An Uncertainty - DEP-E | Related DEP | Overlap: attention, neural | `.lake-data/DEP-E/DEP-E-20260819-ST-GIN An Uncertainty/st_gin_an_uncertainty_manuscript.md` |
| Traceable Group-Wise - DEP-E | Related DEP | Overlap: dual, optimization | `.lake-data/DEP-E/DEP-E-20260819-Traceable Group-Wise/traceable_group_wise_manuscript.md` |
| UDuo Universal Dual - DEP-E | Related DEP | Overlap: dual, optimization | `.lake-data/DEP-E/DEP-E-20260819-UDuo Universal Dual/uduo_universal_dual_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2601.04509 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2601.04509 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2601.04509 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-ST-GIN An Uncertainty/st_gin_an_uncertainty_manuscript.md` | Related synthesis: attention, neural | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Traceable Group-Wise/traceable_group_wise_manuscript.md` | Related synthesis: dual, optimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-UDuo Universal Dual/uduo_universal_dual_manuscript.md` | Related synthesis: dual, optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 34,504 of 75,964 units from 75,967 PDFs.
