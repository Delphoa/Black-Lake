---
title: "A Dual-mode Local Search - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A Dual-mode Local Search Algorithm for Solving the Minimum Dominating Set Problem."
...
primary_url: "https://arxiv.org/abs/2307.16815"
stable_identifier: "arXiv:2307.16815; DOI:10.48550/arXiv.2307.16815"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P286"
...
# A Dual-mode Local Search - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2307.16815 | https://arxiv.org/abs/2307.16815 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2307.16815 rendering | https://arxiv.org/html/2307.16815 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2307.16815 | https://arxiv.org/pdf/2307.16815 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Proposing and solving - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Proposing and solving/proposing_and_solving_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Multi-step Problem - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260728-Multi-step Problem/multi_step_problem_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P286` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhu, Enqiang; Zhang, Yu; Wang, Shengzhi; Strash, Darren; Liu, Chanjuan. Submitted/source date: 2023/07/25. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P286`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Given a graph, the minimum dominating set (MinDS) problem is to identify a smallest set D D of …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Given a graph, the minimum dominating set (MinDS) problem is to identify a smallest set D D of …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, problem, search, set, solving | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, dominating, dual-mode. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, dominating, dual-mode. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Given a graph, the minimum dominating set (MinDS) problem is to identify a smallest set D D of …”. The full-paper rendering contains 70 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Given a graph, the minimum dominating set (MinDS) problem is to identify a smallest set D D of …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Given a graph, the minimum dominating set (MinDS) problem is to identify a smallest set D D of …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, dominating, dual-mode. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 66,283 of 75,964 units; duplicate exclusions 0; focus exclusions 7; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how algorithm, problem, search, set, solving connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, problem, search, set, solving.
...
|---|---|---|---|
| Proposing and solving - DEP-E | Related DEP | Overlap: solving, search, set, problem | `.lake-data/DEP-E/DEP-E-20260819-Proposing and solving/proposing_and_solving_manuscript.md` |
| Schwarz Neural Inference - DEP-E | Related DEP | Overlap: solving, algorithm, search, set, problem | `.lake-data/DEP-E/DEP-E-20260723-Schwarz Neural Inference/schwarz_neural_inference_manuscript.md` |
| Multi-step Problem - DEP-E | Related DEP | Overlap: solving, problem, set | `.lake-data/DEP-E/DEP-E-20260728-Multi-step Problem/multi_step_problem_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2307.16815 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2307.16815 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2307.16815 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Proposing and solving/proposing_and_solving_manuscript.md` | Related synthesis: solving, search, set, problem | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260723-Schwarz Neural Inference/schwarz_neural_inference_manuscript.md` | Related synthesis: solving, algorithm, search, set, problem | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260728-Multi-step Problem/multi_step_problem_manuscript.md` | Related synthesis: solving, problem, set | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 66,283 of 75,964 units from 75,967 PDFs.
