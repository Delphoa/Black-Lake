---
title: "Estimating the persistent - DEP-E"
generated_at: "2026-07-31 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Estimating the persistent homology of $\\mathbb{R}^n$-valued functions using function-geometric multifiltrations."
...
primary_url: "https://arxiv.org/abs/2412.04162"
stable_identifier: "arXiv:2412.04162; DOI:10.48550/arXiv.2412.04162"
deployment_job_id: "BLAD-2200-20260731-3D09E72F"
deployment_item_id: "BLAD-2200-20260731-3D09E72F-P03"
...
# Estimating the persistent - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2412.04162 | https://arxiv.org/abs/2412.04162 | Metadata only. | 2026-07-31 | Inspected |
| S2 | Full paper | Primary | HTML | 2412.04162 rendering | https://arxiv.org/html/2412.04162 | Verified local copy withheld. | 2026-07-31 | Inspected in full |
| S3 | PDF | Primary | PDF | 2412.04162 | https://arxiv.org/pdf/2412.04162 | Verified local copy withheld. | 2026-07-31 | Integrity checked and sampled |
| S4 | VaTD Canonical - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-VaTD Canonical/vatd_canonical_manuscript.md` | Synthesis only. | 2026-07-31 | Inspected |
| S5 | iKalibr Calibration - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260714-iKalibr Calibration/ikalibr_calibration_manuscript.md` | Synthesis only. | 2026-07-31 | Inspected |
| S6 | Flag Hardy Operators - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Flag Hardy Operators/flag_hardy_operators_manuscript.md` | Synthesis only. | 2026-07-31 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260731-3D09E72F-P03` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-31 | Verified |

Authors: André, Ethan; Li, Jingyi; Loiseaux, David; Oudot, Steve. Submitted/source date: 2024/12/05. Job `BLAD-2200-20260731-3D09E72F`; item `BLAD-2200-20260731-3D09E72F-P03`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Given an unknown ℝ n superscript ℝ 𝑛 \mathbb{R}^{n} blackboard_R start_POSTSUPERSCRIPT italic_n end_POSTSUPERSCRIPT -valued function 𝒻 𝒻 \mathscr{f} …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “For Q2 we study the extension of the estimator of [ 23 ] to vector-valued functions 𝒻 : …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: assuming, continuous, estimating, estimators, extensive | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies multifiltrations, function-geometric, approximation. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around multifiltrations, function-geometric, approximation. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Given an unknown ℝ n superscript ℝ 𝑛 \mathbb{R}^{n} blackboard_R start_POSTSUPERSCRIPT italic_n end_POSTSUPERSCRIPT -valued function 𝒻 𝒻 \mathscr{f} …”. The full-paper rendering contains 96 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “For Q2 we study the extension of the estimator of [ 23 ] to vector-valued functions 𝒻 : …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Let X 𝑋 X italic_X be a metric space and 𝒻 : X → ℝ n : 𝒻 …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving multifiltrations, function-geometric, approximation. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 29,171 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how assuming, continuous, estimating, estimators, extensive connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: assuming, continuous, estimating, estimators, extensive.
...
|---|---|---|---|
| VaTD Canonical - DEP-E | Related DEP | Overlap: estimating, good, estimators, properties, continuous | `.lake-data/DEP-E/DEP-E-20260720-VaTD Canonical/vatd_canonical_manuscript.md` |
| iKalibr Calibration - DEP-E | Related DEP | Overlap: manifold, pairwise, extensive, sufficiently, geometric | `.lake-data/DEP-E/DEP-E-20260714-iKalibr Calibration/ikalibr_calibration_manuscript.md` |
| Flag Hardy Operators - DEP-E | Related DEP | Overlap: multiparameter, manifold, assuming, sufficiently, continuous | `.lake-data/DEP-E/DEP-E-20260716-Flag Hardy Operators/flag_hardy_operators_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2412.04162 | Metadata and abstract | 2026-07-31 | Metadata only |
| R2 | https://arxiv.org/html/2412.04162 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-31 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2412.04162 | Primary paper integrity | 2026-07-31 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260720-VaTD Canonical/vatd_canonical_manuscript.md` | Related synthesis: estimating, good, estimators, properties, continuous | 2026-07-31 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260714-iKalibr Calibration/ikalibr_calibration_manuscript.md` | Related synthesis: manifold, pairwise, extensive, sufficiently, geometric | 2026-07-31 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260716-Flag Hardy Operators/flag_hardy_operators_manuscript.md` | Related synthesis: multiparameter, manifold, assuming, sufficiently, continuous | 2026-07-31 | Repository-relative |

## Appendix

- Uniform selected index: 29,171 of 75,957 units from 75,960 PDFs.
