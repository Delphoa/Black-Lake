---
title: "An Attention-based Long - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of An Attention-based Long Short-Term Memory Framework for Detection of Bitcoin Scams."
...
primary_url: "https://arxiv.org/abs/2210.14408"
stable_identifier: "arXiv:2210.14408; DOI:10.48550/arXiv.2210.14408"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P298"
...
# An Attention-based Long - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2210.14408 | https://arxiv.org/abs/2210.14408 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2210.14408 rendering | https://arxiv.org/html/2210.14408 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2210.14408 | https://arxiv.org/pdf/2210.14408 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Deep Learning with Long - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Deep Learning with Long/deep_learning_with_long_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Stock Market Trend - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Stock Market Trend/stock_market_trend_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P298` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhao, Puyang; Tian, Wei; Xiao, Lefu; Liu, Xinhui; Wu, Jingjin. Submitted/source date: 2022/10/26. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P298`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: detection, long, memory, short-term | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies attention-based, bitcoin, detection. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around attention-based, bitcoin, detection. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving attention-based, bitcoin, detection. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 27,606 of 75,964 units; duplicate exclusions 0; focus exclusions 7; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how detection, long, memory, short-term connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: detection, long, memory, short-term.
...
|---|---|---|---|
| Deep Learning with Long - DEP-E | Related DEP | Overlap: short-term, long, memory, detection | `.lake-data/DEP-E/DEP-E-20260819-Deep Learning with Long/deep_learning_with_long_manuscript.md` |
| Mixed-Interest CTR Transfer | Related DEP | Overlap: short-term, memory | `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer/minet_ctr_manuscript.md` |
| Stock Market Trend - DEP-E | Related DEP | Overlap: long, memory, detection | `.lake-data/DEP-E/DEP-E-20260803-Stock Market Trend/stock_market_trend_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2210.14408 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2210.14408 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2210.14408 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Deep Learning with Long/deep_learning_with_long_manuscript.md` | Related synthesis: short-term, long, memory, detection | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer/minet_ctr_manuscript.md` | Related synthesis: short-term, memory | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260803-Stock Market Trend/stock_market_trend_manuscript.md` | Related synthesis: long, memory, detection | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 27,606 of 75,964 units from 75,967 PDFs.
