---
title: "ORFuzz Fuzzing the Other - DEP-E"
generated_at: "2026-08-17 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of ORFuzz: Fuzzing the \"Other Side\" of LLM Safety -- Testing Over-Refusal."
...
primary_url: "https://arxiv.org/abs/2508.11222"
stable_identifier: "arXiv:2508.11222; DOI:10.1109/ASE63991.2025.00156"
deployment_job_id: "BLAD-2200-20260817-2C1A830E"
deployment_item_id: "BLAD-2200-20260817-2C1A830E-P05"
...
# ORFuzz Fuzzing the Other - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2508.11222 | https://arxiv.org/abs/2508.11222 | Metadata only. | 2026-08-17 | Inspected |
| S2 | Full paper | Primary | HTML | 2508.11222 rendering | https://arxiv.org/html/2508.11222 | Verified local copy withheld. | 2026-08-17 | Inspected in full |
| S3 | PDF | Primary | PDF | 2508.11222 | https://arxiv.org/pdf/2508.11222 | Verified local copy withheld. | 2026-08-17 | Integrity checked and sampled |
| S4 | KDFlow LLM Distill - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260712-KDFlow LLM Distill/kdflow_llm_distill_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S5 | SAGE-Nav Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-SAGE-Nav Review/sage_nav_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S6 | Document Fraud LLM - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM/document_fraud_llm_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260817-2C1A830E-P05` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-17 | Verified |

Authors: Zhang, Haonan; Wang, Dongxia; Liu, Yi; Chen, Kexin; Wang, Jiashui; Ying, Xinlei; Liu, Long; Wang, Wenhai. Submitted/source date: 2025/08/15. Job `BLAD-2200-20260817-2C1A830E`; item `BLAD-2200-20260817-2C1A830E-P05`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Large Language Models (LLMs) have been found to show over-refusal problems—erroneously rejecting benign queries due to overly conservative …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Large Language Models (LLMs) have been found to show over-refusal problems—erroneously rejecting benign queries due to overly conservative …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: llm, other, safety, side, testing | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies fuzzing, llm, orfuzz. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around fuzzing, llm, orfuzz. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Large Language Models (LLMs) have been found to show over-refusal problems—erroneously rejecting benign queries due to overly conservative …”. The full-paper rendering contains 95 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Large Language Models (LLMs) have been found to show over-refusal problems—erroneously rejecting benign queries due to overly conservative …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Large Language Models (LLMs) have been found to show over-refusal problems—erroneously rejecting benign queries due to overly conservative …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving fuzzing, llm, orfuzz. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 61,904 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how llm, other, safety, side, testing connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: llm, other, safety, side, testing.
...
|---|---|---|---|
| KDFlow LLM Distill - DEP-E | Related DEP | Overlap: llm, side, other, testing, safety | `.lake-data/DEP-E/DEP-E-20260712-KDFlow LLM Distill/kdflow_llm_distill_manuscript.md` |
| SAGE-Nav Review - DEP-E | Related DEP | Overlap: llm, other, testing, safety | `.lake-data/DEP-E/DEP-E-20260723-SAGE-Nav Review/sage_nav_manuscript.md` |
| Document Fraud LLM - DEP-E | Related DEP | Overlap: llm, other, safety | `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM/document_fraud_llm_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2508.11222 | Metadata and abstract | 2026-08-17 | Metadata only |
| R2 | https://arxiv.org/html/2508.11222 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-17 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2508.11222 | Primary paper integrity | 2026-08-17 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260712-KDFlow LLM Distill/kdflow_llm_distill_manuscript.md` | Related synthesis: llm, side, other, testing, safety | 2026-08-17 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260723-SAGE-Nav Review/sage_nav_manuscript.md` | Related synthesis: llm, other, testing, safety | 2026-08-17 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM/document_fraud_llm_manuscript.md` | Related synthesis: llm, other, safety | 2026-08-17 | Repository-relative |

## Appendix

- Uniform selected index: 61,904 of 75,964 units from 75,967 PDFs.
