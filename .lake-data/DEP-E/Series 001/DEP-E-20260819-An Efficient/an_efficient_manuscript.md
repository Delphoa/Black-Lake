---
title: "An Efficient - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of An Efficient Memory-Augmented Transformer for Knowledge-Intensive NLP Tasks."
...
primary_url: "https://arxiv.org/abs/2210.16773"
stable_identifier: "arXiv:2210.16773; DOI:10.48550/arXiv.2210.16773"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P43"
...
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2210.16773 | https://arxiv.org/abs/2210.16773 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2210.16773 rendering | https://arxiv.org/html/2210.16773 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2210.16773 | https://arxiv.org/pdf/2210.16773 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Towards Unified World - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Towards Unified World/towards_unified_world_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Self-Supervised - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260812-Self-Supervised/self_supervised_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P43` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wu, Yuxiang; Zhao, Yu; Hu, Baotian; Minervini, Pasquale; Stenetorp, Pontus; Riedel, Sebastian. Submitted/source date: 2022/10/30. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P43`.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving knowledge-intensive, memory-augmented, nlp. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 49,024 of 75,964 units; duplicate exclusions 0; focus exclusions 17; source-gate exclusions 0; reselections 17.
...
- The related DEPs show how memory-augmented, tasks, transformer connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: memory-augmented, tasks, transformer.
...
| Self-Supervised - DEP-E | Related DEP | Overlap: transformer, tasks | `.lake-data/DEP-E/DEP-E-20260812-Self-Supervised/self_supervised_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2210.16773 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2210.16773 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2210.16773 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-M 4 -SAM Multi-Modal/m_4_sam_multi_modal_manuscript.md` | Related synthesis: memory-augmented | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Towards Unified World/towards_unified_world_manuscript.md` | Related synthesis: memory-augmented | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260812-Self-Supervised/self_supervised_manuscript.md` | Related synthesis: transformer, tasks | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 49,024 of 75,964 units from 75,967 PDFs.
