---
title: "Classifying Relations via - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Classifying Relations via Long Short Term Memory Networks along Shortest Dependency Path."
...
primary_url: "https://arxiv.org/abs/1508.03720"
stable_identifier: "arXiv:1508.03720; DOI:10.48550/arXiv.1508.03720"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P260"
...
# Classifying Relations via - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1508.03720 | https://arxiv.org/abs/1508.03720 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1508.03720 rendering | https://arxiv.org/html/1508.03720 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1508.03720 | https://arxiv.org/pdf/1508.03720 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Stock Market Trend - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Stock Market Trend/stock_market_trend_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | An Attention-based Long - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-An Attention-based Long/an_attention_based_long_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Deep Learning with Long - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Deep Learning with Long/deep_learning_with_long_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P260` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Yan, Xu; Mou, Lili; Li, Ge; Chen, Yunchuan; Peng, Hao; Jin, Zhi. Submitted/source date: 2015/08/15. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P260`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: dependency, long, memory, short, term | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies along, classifying, dependency. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around along, classifying, dependency. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving along, classifying, dependency. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 10,657 of 75,964 units; duplicate exclusions 0; focus exclusions 2; source-gate exclusions 0; reselections 2.
...
- The related DEPs show how dependency, long, memory, short, term connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: dependency, long, memory, short, term.
...
|---|---|---|---|
| Stock Market Trend - DEP-E | Related DEP | Overlap: term, short, long, memory, dependency | `.lake-data/DEP-E/DEP-E-20260803-Stock Market Trend/stock_market_trend_manuscript.md` |
| An Attention-based Long - DEP-E | Related DEP | Overlap: long, memory, term, short, dependency | `.lake-data/DEP-E/DEP-E-20260819-An Attention-based Long/an_attention_based_long_manuscript.md` |
| Deep Learning with Long - DEP-E | Related DEP | Overlap: long, memory, term, short, dependency | `.lake-data/DEP-E/DEP-E-20260819-Deep Learning with Long/deep_learning_with_long_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1508.03720 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1508.03720 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1508.03720 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260803-Stock Market Trend/stock_market_trend_manuscript.md` | Related synthesis: term, short, long, memory, dependency | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-An Attention-based Long/an_attention_based_long_manuscript.md` | Related synthesis: long, memory, term, short, dependency | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Deep Learning with Long/deep_learning_with_long_manuscript.md` | Related synthesis: long, memory, term, short, dependency | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 10,657 of 75,964 units from 75,967 PDFs.
