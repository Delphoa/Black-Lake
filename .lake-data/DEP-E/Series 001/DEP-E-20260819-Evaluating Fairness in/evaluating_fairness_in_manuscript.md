---
title: "Evaluating Fairness in - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Evaluating Fairness in Black-box Algorithmic Markets: A Case Study of Ride Sharing in Chicago."
...
primary_url: "https://arxiv.org/abs/2407.20522"
stable_identifier: "arXiv:2407.20522; DOI:10.48550/arXiv.2407.20522"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P294"
...
# Evaluating Fairness in - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2407.20522 | https://arxiv.org/abs/2407.20522 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2407.20522 rendering | https://arxiv.org/html/2407.20522 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2407.20522 | https://arxiv.org/pdf/2407.20522 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Does Travel Stage Matter - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260815-Does Travel Stage Matter/does_travel_stage_matter_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Black-Box Prompt - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Black-Box Prompt/black_box_prompt_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P294` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Yuhan; Zheng, Yuhan; Zhang, Siyuan; Liu, Lydia T.. Submitted/source date: 2024/07/30. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P294`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithmic, black-box, sharing | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithmic, black-box, case. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithmic, black-box, case. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 39 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithmic, black-box, case. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 28,143 of 75,964 units; duplicate exclusions 12; focus exclusions 50; source-gate exclusions 0; reselections 62.
...
- The related DEPs show how algorithmic, black-box, sharing connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithmic, black-box, sharing.
...
|---|---|---|---|
| Choosing the Better - DEP-E | Related DEP | Overlap: sharing, algorithmic | `.lake-data/DEP-E/DEP-E-20260819-Choosing the Better/choosing_the_better_manuscript.md` |
| Does Travel Stage Matter - DEP-E | Related DEP | Overlap: sharing | `.lake-data/DEP-E/DEP-E-20260815-Does Travel Stage Matter/does_travel_stage_matter_manuscript.md` |
| Black-Box Prompt - DEP-E | Related DEP | Overlap: black-box, algorithmic | `.lake-data/DEP-E/DEP-E-20260819-Black-Box Prompt/black_box_prompt_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2407.20522 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2407.20522 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2407.20522 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Choosing the Better/choosing_the_better_manuscript.md` | Related synthesis: sharing, algorithmic | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260815-Does Travel Stage Matter/does_travel_stage_matter_manuscript.md` | Related synthesis: sharing | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Black-Box Prompt/black_box_prompt_manuscript.md` | Related synthesis: black-box, algorithmic | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 28,143 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 12; focus exclusions: 50; source-gate exclusions: 0; reselections: 62; 24-hour cutoff: 2026-08-18.
