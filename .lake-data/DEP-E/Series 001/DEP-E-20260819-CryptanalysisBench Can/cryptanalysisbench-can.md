---
title: "CryptanalysisBench Can - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "CryptanalysisBench: Can LLMs do Cryptanalysis?"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260723-Tech Intel 0102"
selection_record: "117 candidates; 51 excluded; 66 eligible; draw 1275697678; zero-based index 46"
expansion_record: "10 retained public locators; draw 3421616172; zero-based index 2"
...
# CryptanalysisBench Can - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260723-Tech Intel 0102 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260723-Tech%20Intel%200102/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-23_0102.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260723-Tech%20Intel%200102/daily_research_findings_2026-07-23_0102.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | CryptanalysisBench: Can LLMs do Cryptanalysis? | Selected supporting source | arXiv record | 2607.18538 | https://arxiv.org/abs/2607.18538v2 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: CryptanalysisBench: Can LLMs do Cryptanalysis?
- Authors or producing organization: Lukas Fluri; Avital Shafran; Nicholas Carlini; Matthew Jagielski; Milad Nasr; Orr Dunkelman; Eyal Ronen; Florian Tramèr
- Source platform: arXiv
- Publication date: 2026-07-20
- Revision/version date: 2026-07-29
- Stable identifier: 2607.18538
- Categories: cs.CR
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260723-Tech%20Intel%200102/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260723-Tech%20Intel%200102/daily_research_findings_2026-07-23_0102.md | Deposited source synthesis | CryptanalysisBench introduces 191 tasks across six families of cryptographic primitives, with tiers for known practical breaks, full-strength primitives without known practical breaks, scaled-down variants, and a frontier challenge set. The authors report that five frontier models break 65–86% of Tier-1 schemes, solve 6–12 Tier-2 schemes at full strength, and produce previously unreported attacks including a key-recovery attack against SpoC AEAD and a flaw in a KINDI CCA-security proof. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2607.18538v2 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through CryptanalysisBench: Can LLMs do Cryptanalysis?. The deposited source package reports that CryptanalysisBench introduces 191 tasks across six families of cryptographic primitives, with tiers for known practical breaks, full-strength primitives without known practical breaks, scaled-down variants, and a frontier challenge set. The authors report that five frontier models break 65–86% of Tier-1 schemes, solve 6–12 Tier-2 schemes at full strength, and produce previously unreported attacks including a key-recovery attack against SpoC AEAD and a flaw in a KINDI CCA-security proof. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that Cryptanalysis is both a high-stakes capability domain and a relatively clean reasoning benchmark because attacks can be mechanically checked. The benchmark can support release-gating and defensive stress tests for candidate primitives, but the reported results are an early snapshot and require careful reproduction, human review, and responsible disclosure. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: Cryptanalysis is both a high-stakes capability domain and a relatively clean reasoning benchmark because attacks can be mechanically checked. The benchmark can support release-gating and defensive stress tests for candidate primitives, but the reported results are an early snapshot and require careful reproduction, human review, and responsible disclosure.

### Source-reported contribution

The selected DEP summarizes the contribution this way: CryptanalysisBench introduces 191 tasks across six families of cryptographic primitives, with tiers for known practical breaks, full-strength primitives without known practical breaks, scaled-down variants, and a frontier challenge set. The authors report that five frontier models break 65–86% of Tier-1 schemes, solve 6–12 Tier-2 schemes at full strength, and produce previously unreported attacks including a key-recovery attack against SpoC AEAD and a flaw in a KINDI CCA-security proof. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is CryptanalysisBench: Can LLMs do Cryptanalysis?, credited to Lukas Fluri; Avital Shafran; Nicholas Carlini; Matthew Jagielski; Milad Nasr; Orr Dunkelman; Eyal Ronen; Florian Tramèr. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | Cryptanalysis is both a high-stakes capability domain and a relatively clean reasoning benchmark because attacks can be mechanically checked. The benchmark can support release-gating and defensive stress tests for candidate primitives, but the reported results are an early snapshot and require careful reproduction, human review, and responsible disclosure. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260723-Tech Intel 0102 as a schema-complete DEP-E research artifact.
...
### New in this pass: CryptanalysisBench: Can LLMs do Cryptanalysis?

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [CryptanalysisBench: Can LLMs do Cryptanalysis?](https://arxiv.org/abs/2607.18538v2) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://arxiv.org/abs/2607.19109 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.19246 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.19331 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.19146 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.19336 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260723-Tech%20Intel%200102/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260723-Tech%20Intel%200102/daily_research_findings_2026-07-23_0102.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2607.18538v2 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 50 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 51; eligible count 66.
- DEP draw: accepted UInt32 1275697678; rejection limit 4294967292; attempts 1; zero-based index 46.
- Supporting draw: pool 10; accepted UInt32 3421616172; rejection limit 4294967290; attempts 1; zero-based index 2.
