---
title: "OmniSQL Synthesizing - DEP-E"
generated_at: "2026-07-24 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of OmniSQL: Synthesizing High-quality Text-to-SQL Data at Scale."
...
primary_url: "https://arxiv.org/abs/2503.02240"
stable_identifier: "arXiv:2503.02240; DOI:10.48550/arXiv.2503.02240"
deployment_job_id: "BLAD-2200-20260724-CF53BCCB"
deployment_item_id: "BLAD-2200-20260724-CF53BCCB-P02"
...
# OmniSQL Synthesizing - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2503.02240 | https://arxiv.org/abs/2503.02240 | Metadata only. | 2026-07-24 | Inspected |
| S2 | Full paper | Primary | HTML | 2503.02240 rendering | https://arxiv.org/html/2503.02240 | Verified local copy withheld. | 2026-07-24 | Inspected in full |
| S3 | PDF | Primary | PDF | 2503.02240 | https://arxiv.org/pdf/2503.02240 | Verified local copy withheld. | 2026-07-24 | Integrity checked and sampled |
| S4 | Efficient FM Survey - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` | Synthesis only. | 2026-07-24 | Inspected |
| S5 | LA-Pose Latent Action - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260713-LA-Pose Latent Action/la_pose_latent_action_manuscript.md` | Synthesis only. | 2026-07-24 | Inspected |
| S6 | RLMF Uncertainty - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260714-RLMF Uncertainty/rlmf_uncertainty_manuscript.md` | Synthesis only. | 2026-07-24 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260724-CF53BCCB-P02` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-24 | Verified |

Authors: Li, Haoyang; Wu, Shang; Zhang, Xiaokang; Huang, Xinmei; Zhang, Jing; Jiang, Fuxin; Wang, Shuai; Zhang, Tieying; Chen, Jianjun; Shi, Rui; Chen, Hong; Li, Cuiping. Submitted/source date: 2025/03/04. Job `BLAD-2200-20260724-CF53BCCB`; item `BLAD-2200-20260724-CF53BCCB-P02`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Text-to-SQL, the task of translating natural language questions into SQL queries, plays a crucial role in enabling non-experts …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Text-to-SQL, the task of translating natural language questions into SQL queries, plays a crucial role in enabling non-experts …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: achieves, across, all, automatically, available | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies text-to-sql, omnisql, datasets. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around text-to-sql, omnisql, datasets. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Text-to-SQL, the task of translating natural language questions into SQL queries, plays a crucial role in enabling non-experts …”. The full-paper rendering contains 86 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Text-to-SQL, the task of translating natural language questions into SQL queries, plays a crucial role in enabling non-experts …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Text-to-SQL, the task of translating natural language questions into SQL queries, plays a crucial role in enabling non-experts …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving text-to-sql, omnisql, datasets. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 63,249 of 75,777 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how achieves, across, all, automatically, available connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: achieves, across, all, automatically, available.
...
|---|---|---|---|
| Efficient FM Survey - DEP-E | Related DEP | Overlap: across, all, automatically, code, concerns | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` |
| LA-Pose Latent Action - DEP-E | Related DEP | Overlap: achieves, across, code, coverage, dataset | `.lake-data/DEP-E/DEP-E-20260713-LA-Pose Latent Action/la_pose_latent_action_manuscript.md` |
| RLMF Uncertainty - DEP-E | Related DEP | Overlap: across, all, automatically, available, code | `.lake-data/DEP-E/DEP-E-20260714-RLMF Uncertainty/rlmf_uncertainty_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2503.02240 | Metadata and abstract | 2026-07-24 | Metadata only |
| R2 | https://arxiv.org/html/2503.02240 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-24 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2503.02240 | Primary paper integrity | 2026-07-24 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` | Related synthesis: across, all, automatically, code, concerns | 2026-07-24 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260713-LA-Pose Latent Action/la_pose_latent_action_manuscript.md` | Related synthesis: achieves, across, code, coverage, dataset | 2026-07-24 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260714-RLMF Uncertainty/rlmf_uncertainty_manuscript.md` | Related synthesis: across, all, automatically, available, code | 2026-07-24 | Repository-relative |

## Appendix

- Uniform selected index: 63,249 of 75,777 units from 75,780 PDFs.
