---
title: "FT-CNN Algorithm-Based - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of FT-CNN: Algorithm-Based Fault Tolerance for Convolutional Neural Networks."
...
primary_url: "https://arxiv.org/abs/2003.12203"
stable_identifier: "arXiv:2003.12203; DOI:10.1109/TPDS.2020.3043449"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P325"
...
# FT-CNN Algorithm-Based - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2003.12203 | https://arxiv.org/abs/2003.12203 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2003.12203 rendering | https://arxiv.org/html/2003.12203 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2003.12203 | https://arxiv.org/pdf/2003.12203 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Unifying Isolated and - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Unifying Isolated and/unifying_isolated_and_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | An - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-An/an_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P325` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhao, Kai; Di, Sheng; Li, Sihuan; Liang, Xin; Zhai, Yujia; Chen, Jieyang; Ouyang, Kaiming; Cappello, Franck; Chen, Zizhong. Submitted/source date: 2020/03/27. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P325`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Convolutional neural networks (CNNs) are becoming more and more important for solving challenging and critical problems in many …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Convolutional neural networks (CNNs) are becoming more and more important for solving challenging and critical problems in many …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm-based, convolutional, networks, neural | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm-based, convolutional, fault. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm-based, convolutional, fault. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Convolutional neural networks (CNNs) are becoming more and more important for solving challenging and critical problems in many …”. The full-paper rendering contains 86 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Convolutional neural networks (CNNs) are becoming more and more important for solving challenging and critical problems in many …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Convolutional neural networks (CNNs) are becoming more and more important for solving challenging and critical problems in many …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm-based, convolutional, fault. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 71,242 of 75,964 units; duplicate exclusions 2; focus exclusions 14; source-gate exclusions 0; reselections 16.
...
- The related DEPs show how algorithm-based, convolutional, networks, neural connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm-based, convolutional, networks, neural.
...
|---|---|---|---|
| Unifying Isolated and - DEP-E | Related DEP | Overlap: convolutional, networks, neural | `.lake-data/DEP-E/DEP-E-20260819-Unifying Isolated and/unifying_isolated_and_manuscript.md` |
| An - DEP-E | Related DEP | Overlap: algorithm-based | `.lake-data/DEP-E/DEP-E-20260819-An/an_manuscript.md` |
| AVGCN Trajectory - DEP-E | Related DEP | Overlap: convolutional, networks | `.lake-data/DEP-E/DEP-E-20260805-AVGCN Trajectory/avgcn_trajectory_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2003.12203 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2003.12203 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2003.12203 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Unifying Isolated and/unifying_isolated_and_manuscript.md` | Related synthesis: convolutional, networks, neural | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-An/an_manuscript.md` | Related synthesis: algorithm-based | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260805-AVGCN Trajectory/avgcn_trajectory_manuscript.md` | Related synthesis: convolutional, networks | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 71,242 of 75,964 units from 75,967 PDFs.
