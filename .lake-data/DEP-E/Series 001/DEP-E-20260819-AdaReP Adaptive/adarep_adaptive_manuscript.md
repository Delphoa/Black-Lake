---
title: "AdaReP Adaptive - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of AdaReP:Adaptive Re-Planning under Model Mismatch for Neural World-Model Predictive Control."
...
primary_url: "https://arxiv.org/abs/2606.23079"
stable_identifier: "arXiv:2606.23079; DOI:10.48550/arXiv.2606.23079"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P106"
...
# AdaReP Adaptive - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2606.23079 | https://arxiv.org/abs/2606.23079 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2606.23079 rendering | https://arxiv.org/html/2606.23079 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2606.23079 | https://arxiv.org/pdf/2606.23079 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Neural Architecture - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Neural Architecture/neural_architecture_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Contact Optimization for - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Contact Optimization for/contact_optimization_for_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Adversarial Label Noise - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Adversarial Label Noise/adversarial_label_noise_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P106` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Cheng, Yutian; Ma, Xiaojian; Wang, Xianhao; Yang, Min; Su, Rongpeng; Liu, Hangxin; Chen, Xi; Li, Shuai; Li, Qing. Submitted/source date: 2026/06/22. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P106`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Neural world models coupled with model predictive control (MPC) replan at every environment step to bound accumulated prediction …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Neural world models provide a predictive interface for control in robotics. Recent systems plan in image space [ …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: adaptive, control, mismatch, neural, predictive | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies adaptive, adarep, control. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around adaptive, adarep, control. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Neural world models coupled with model predictive control (MPC) replan at every environment step to bound accumulated prediction …”. The full-paper rendering contains 139 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Neural world models provide a predictive interface for control in robotics. Recent systems plan in image space [ …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “This section presents the key analytical results and insights behind our trigger design. Due to page limits, we …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving adaptive, adarep, control. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 43,207 of 75,964 units; duplicate exclusions 0; focus exclusions 11; source-gate exclusions 0; reselections 11.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories stateful systems, algorithmic research; title/abstract evidence terms planning, world model.
...
- The related DEPs show how adaptive, control, mismatch, neural, predictive connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: adaptive, control, mismatch, neural, predictive.
...
|---|---|---|---|
| Neural Architecture - DEP-E | Related DEP | Overlap: predictive, neural, control, under | `.lake-data/DEP-E/DEP-E-20260818-Neural Architecture/neural_architecture_manuscript.md` |
| Contact Optimization for - DEP-E | Related DEP | Overlap: predictive, control, neural, under | `.lake-data/DEP-E/DEP-E-20260818-Contact Optimization for/contact_optimization_for_manuscript.md` |
| Adversarial Label Noise - DEP-E | Related DEP | Overlap: mismatch, predictive, adaptive, under | `.lake-data/DEP-E/DEP-E-20260716-Adversarial Label Noise/adversarial_label_noise_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2606.23079 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2606.23079 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2606.23079 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Neural Architecture/neural_architecture_manuscript.md` | Related synthesis: predictive, neural, control, under | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Contact Optimization for/contact_optimization_for_manuscript.md` | Related synthesis: predictive, control, neural, under | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260716-Adversarial Label Noise/adversarial_label_noise_manuscript.md` | Related synthesis: mismatch, predictive, adaptive, under | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 43,207 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 0; focus exclusions: 11; source-gate exclusions: 0; reselections: 11; 24-hour cutoff: 2026-08-18.
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories stateful systems, algorithmic research; terms planning, world model.
