---
title: "CMamba Learned Image - DEP-E"
generated_at: "2026-08-12 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of CMamba: Learned Image Compression with State Space Models."
...
primary_url: "https://arxiv.org/abs/2502.04988"
stable_identifier: "arXiv:2502.04988; DOI:10.48550/arXiv.2502.04988"
deployment_job_id: "BLAD-2200-20260812-9483C5E4"
deployment_item_id: "BLAD-2200-20260812-9483C5E4-P08"
...
# CMamba Learned Image - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2502.04988 | https://arxiv.org/abs/2502.04988 | Metadata only. | 2026-08-12 | Inspected |
| S2 | Full paper | Primary | HTML | 2502.04988 rendering | https://arxiv.org/html/2502.04988 | Verified local copy withheld. | 2026-08-12 | Inspected in full |
| S3 | PDF | Primary | PDF | 2502.04988 | https://arxiv.org/pdf/2502.04988 | Verified local copy withheld. | 2026-08-12 | Integrity checked and sampled |
| S4 | Conceptual Comp - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260804-Conceptual Compression/conceptual_compression_manuscript.md` | Synthesis only. | 2026-08-12 | Inspected |
| S5 | CAP Compression - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-CAP Rank Sparsity/cap_rank_sparsity_manuscript.md` | Synthesis only. | 2026-08-12 | Inspected |
| S6 | ConMax - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260708-ConMax Reasoning/conmax_reasoning_manuscript.md` | Synthesis only. | 2026-08-12 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260812-9483C5E4-P08` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-12 | Verified |

Authors: Wu, Zhuojie; Du, Heming; Wang, Shuyun; Lu, Ming; Sun, Haiyang; Guo, Yandong; Yu, Xin. Submitted/source date: 2025/02/07. Job `BLAD-2200-20260812-9483C5E4`; item `BLAD-2200-20260812-9483C5E4-P08`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Learned Image Compression (LIC) has explored various architectures, such as Convolutional Neural Networks (CNNs) and transformers, in modeling …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Learned Image Compression (LIC) has explored various architectures, such as Convolutional Neural Networks (CNNs) and transformers, in modeling …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: compression, image, learned, space, state | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies cmamba, compression, image. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around cmamba, compression, image. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Learned Image Compression (LIC) has explored various architectures, such as Convolutional Neural Networks (CNNs) and transformers, in modeling …”. The full-paper rendering contains 45 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Learned Image Compression (LIC) has explored various architectures, such as Convolutional Neural Networks (CNNs) and transformers, in modeling …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Learned Image Compression (LIC) has explored various architectures, such as Convolutional Neural Networks (CNNs) and transformers, in modeling …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving cmamba, compression, image. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 10,701 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how compression, image, learned, space, state connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: compression, image, learned, space, state.
...
|---|---|---|---|
| Conceptual Comp - DEP-E | Related DEP | Overlap: compression, image, learned, state | `.lake-data/DEP-E/DEP-E-20260804-Conceptual Compression/conceptual_compression_manuscript.md` |
| CAP Compression - DEP-E | Related DEP | Overlap: compression, space, learned, image, state | `.lake-data/DEP-E/DEP-E-20260719-CAP Rank Sparsity/cap_rank_sparsity_manuscript.md` |
| ConMax - DEP-E | Related DEP | Overlap: compression, image, state | `.lake-data/DEP-E/DEP-E-20260708-ConMax Reasoning/conmax_reasoning_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2502.04988 | Metadata and abstract | 2026-08-12 | Metadata only |
| R2 | https://arxiv.org/html/2502.04988 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-12 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2502.04988 | Primary paper integrity | 2026-08-12 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260804-Conceptual Compression/conceptual_compression_manuscript.md` | Related synthesis: compression, image, learned, state | 2026-08-12 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260719-CAP Rank Sparsity/cap_rank_sparsity_manuscript.md` | Related synthesis: compression, space, learned, image, state | 2026-08-12 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260708-ConMax Reasoning/conmax_reasoning_manuscript.md` | Related synthesis: compression, image, state | 2026-08-12 | Repository-relative |

## Appendix

- Uniform selected index: 10,701 of 75,964 units from 75,967 PDFs.
