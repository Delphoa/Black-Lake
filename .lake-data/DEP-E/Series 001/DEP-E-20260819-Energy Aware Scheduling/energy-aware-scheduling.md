---
title: "Energy Aware Scheduling - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Energy-Aware Scheduling for Serverless LLM Serving on Shared GPUs"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260701-Tech Intel 1103"
selection_record: "117 candidates; 34 excluded; 83 eligible; draw 2665531814; zero-based index 11"
expansion_record: "10 retained public locators; draw 2625304091; zero-based index 1"
...
# Energy Aware Scheduling - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260701-Tech Intel 1103 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260701-Tech%20Intel%201103/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-01_1103.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260701-Tech%20Intel%201103/daily_research_findings_2026-07-01_1103.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | Energy-Aware Scheduling for Serverless LLM Serving on Shared GPUs | Selected supporting source | arXiv record | 2606.30391 | https://arxiv.org/abs/2606.30391v1 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: Energy-Aware Scheduling for Serverless LLM Serving on Shared GPUs
- Authors or producing organization: Tianyu Wang; Gourav Rattihalli; Aditya Dhakal; Longfei Shangguan; Dejan Milojicic
- Source platform: arXiv
- Publication date: 2026-06-29
- Revision/version date: 2026-06-29
- Stable identifier: 2606.30391
- Categories: cs.DC
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260701-Tech%20Intel%201103/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260701-Tech%20Intel%201103/daily_research_findings_2026-07-01_1103.md | Deposited source synthesis | ** Festina proposes energy-aware scheduling for serverless LLM serving on shared GPUs, targeting lower energy consumption while preserving useful serving properties. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2606.30391v1 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through Energy-Aware Scheduling for Serverless LLM Serving on Shared GPUs. The deposited source package reports that ** Festina proposes energy-aware scheduling for serverless LLM serving on shared GPUs, targeting lower energy consumption while preserving useful serving properties. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** As inference workloads expand, datacenter energy use becomes a first-order systems problem. Energy-aware scheduling is especially relevant for bursty agent workloads and shared GPU platforms where utilization and latency objectives compete. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** As inference workloads expand, datacenter energy use becomes a first-order systems problem. Energy-aware scheduling is especially relevant for bursty agent workloads and shared GPU platforms where utilization and latency objectives compete.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** Festina proposes energy-aware scheduling for serverless LLM serving on shared GPUs, targeting lower energy consumption while preserving useful serving properties. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
|---|---|---|---|---|---|
| C1 | The deposited source package reports that ** Festina proposes energy-aware scheduling for serverless LLM serving on shared GPUs, targeting lower energy consumption while preserving useful serving properties. | Source-package claim | E2 | Preserved as a source claim; no independent rerun was performed. | Medium |
| C2 | The selected supporting record is Energy-Aware Scheduling for Serverless LLM Serving on Shared GPUs, credited to Tianyu Wang; Gourav Rattihalli; Aditya Dhakal; Longfei Shangguan; Dejan Milojicic. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** As inference workloads expand, datacenter energy use becomes a first-order systems problem. Energy-aware scheduling is especially relevant for bursty agent workloads and shared GPU platforms where utilization and latency objectives compete. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260701-Tech Intel 1103 as a schema-complete DEP-E research artifact.
...
### New in this pass: Energy-Aware Scheduling for Serverless LLM Serving on Shared GPUs

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [Energy-Aware Scheduling for Serverless LLM Serving on Shared GPUs](https://arxiv.org/abs/2606.30391v1) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://arxiv.org/abs/2606.30639 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2606.30560 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2606.30566 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2606.30602 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2606.30555 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260701-Tech%20Intel%201103/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260701-Tech%20Intel%201103/daily_research_findings_2026-07-01_1103.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2606.30391v1 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 33 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 34; eligible count 83.
- DEP draw: accepted UInt32 2665531814; rejection limit 4294967219; attempts 1; zero-based index 11.
- Supporting draw: pool 10; accepted UInt32 2625304091; rejection limit 4294967290; attempts 1; zero-based index 1.
