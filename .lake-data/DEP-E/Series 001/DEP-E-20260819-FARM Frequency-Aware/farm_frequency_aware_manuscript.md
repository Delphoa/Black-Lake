---
title: "FARM Frequency-Aware - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of FARM: Frequency-Aware Model for Cross-Domain Live-Streaming Recommendation."
...
primary_url: "https://arxiv.org/abs/2502.09375"
stable_identifier: "arXiv:2502.09375; DOI:10.48550/arXiv.2502.09375"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P347"
...
# FARM Frequency-Aware - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2502.09375 | https://arxiv.org/abs/2502.09375 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2502.09375 rendering | https://arxiv.org/html/2502.09375 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2502.09375 | https://arxiv.org/pdf/2502.09375 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | AcroFOD An Adaptive - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-AcroFOD An Adaptive/acrofod_an_adaptive_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P347` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Li, Xiaodong; Yang, Ruochen; Wen, Shuang; Wang, Shen; Liu, Yueyang; Wang, Guoquan; Hu, Weisong; Luo, Qiang; Sheng, Jiawei; Liu, Tingwen; Cao, Jiangxia; Yang, Shuang; Liu, Zhaojie. Submitted/source date: 2025/02/13. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P347`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: cross-domain | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies cross-domain, farm, frequency-aware. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around cross-domain, farm, frequency-aware. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving cross-domain, farm, frequency-aware. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 57,612 of 75,964 units; duplicate exclusions 3; focus exclusions 4; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how cross-domain connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: cross-domain.
...
|---|---|---|---|
| Mixed-Interest CTR Transfer | Related DEP | Overlap: cross-domain | `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer/minet_ctr_manuscript.md` |
...
| AcroFOD An Adaptive - DEP-E | Related DEP | Overlap: cross-domain | `.lake-data/DEP-E/DEP-E-20260818-AcroFOD An Adaptive/acrofod_an_adaptive_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2502.09375 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2502.09375 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2502.09375 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer/minet_ctr_manuscript.md` | Related synthesis: cross-domain | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260801-CrossNER Adapt/crossner_domain_adaptation_manuscript.md` | Related synthesis: cross-domain | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-AcroFOD An Adaptive/acrofod_an_adaptive_manuscript.md` | Related synthesis: cross-domain | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 57,612 of 75,964 units from 75,967 PDFs.
