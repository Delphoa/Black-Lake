---
title: "A Fast Tree Algorithm for - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A Fast Tree Algorithm for Electric Field Calculation in Electrical Discharge Simulations."
...
primary_url: "https://arxiv.org/abs/1710.05781"
stable_identifier: "arXiv:1710.05781; DOI:10.1109/TMAG.2017.2756991"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P337"
...
# A Fast Tree Algorithm for - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1710.05781 | https://arxiv.org/abs/1710.05781 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1710.05781 rendering | https://arxiv.org/html/1710.05781 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1710.05781 | https://arxiv.org/pdf/1710.05781 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Fast Block Linear System - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Fast Block Linear System/fast_block_linear_system_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Improving Viability of - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Improving Viability of/improving_viability_of_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | A density peaks - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A density peaks/a_density_peaks_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P337` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhuang, Chijie; Zhang, Yong; Zhou, Xin; Zeng, Rong; He, Jinliang; Liu, Lei. Submitted/source date: 2017/10/16. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P337`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The simulation of electrical discharges has been attracting a great deal of attention. In such simulations, the electric …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The simulation of electrical discharges has been attracting a great deal of attention. In such simulations, the electric …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, electric, fast, simulations, tree | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, calculation, discharge. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, calculation, discharge. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The simulation of electrical discharges has been attracting a great deal of attention. In such simulations, the electric …”. The full-paper rendering contains 34 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The simulation of electrical discharges has been attracting a great deal of attention. In such simulations, the electric …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Because of its high computational load, the simulation of electrical discharge under atmospheric pressure is, at present, mainly …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, calculation, discharge. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 44,712 of 75,964 units; duplicate exclusions 2; focus exclusions 3; source-gate exclusions 0; reselections 5.
...
- The related DEPs show how algorithm, electric, fast, simulations, tree connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, electric, fast, simulations, tree.
...
|---|---|---|---|
| Fast Block Linear System - DEP-E | Related DEP | Overlap: simulations, fast | `.lake-data/DEP-E/DEP-E-20260819-Fast Block Linear System/fast_block_linear_system_manuscript.md` |
| Improving Viability of - DEP-E | Related DEP | Overlap: electric | `.lake-data/DEP-E/DEP-E-20260819-Improving Viability of/improving_viability_of_manuscript.md` |
| A density peaks - DEP-E | Related DEP | Overlap: tree, algorithm | `.lake-data/DEP-E/DEP-E-20260819-A density peaks/a_density_peaks_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1710.05781 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1710.05781 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1710.05781 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Fast Block Linear System/fast_block_linear_system_manuscript.md` | Related synthesis: simulations, fast | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Improving Viability of/improving_viability_of_manuscript.md` | Related synthesis: electric | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-A density peaks/a_density_peaks_manuscript.md` | Related synthesis: tree, algorithm | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 44,712 of 75,964 units from 75,967 PDFs.
