---
title: "Controllable Dynamic - DEP-E"
generated_at: "2026-08-13 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Controllable Dynamic Appearance for Neural 3D Portraits."
...
primary_url: "https://arxiv.org/abs/2309.11009"
stable_identifier: "arXiv:2309.11009; DOI:10.48550/arXiv.2309.11009"
deployment_job_id: "BLAD-2200-20260813-F994AA5E"
deployment_item_id: "BLAD-2200-20260813-F994AA5E-P01"
...
# Controllable Dynamic - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2309.11009 | https://arxiv.org/abs/2309.11009 | Metadata only. | 2026-08-13 | Inspected |
| S2 | Full paper | Primary | HTML | 2309.11009 rendering | https://arxiv.org/html/2309.11009 | Verified local copy withheld. | 2026-08-13 | Inspected in full |
| S3 | PDF | Primary | PDF | 2309.11009 | https://arxiv.org/pdf/2309.11009 | Verified local copy withheld. | 2026-08-13 | Integrity checked and sampled |
| S4 | Self-Learned IDC - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260710-Self Learned IDC/self_learned_idc_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S5 | DMNN Conditional Paths - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-DMNN Conditional Paths/dmnn_conditional_paths_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S6 | 4DContrast Contrastive Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260722-4DContrast Contrastive/4dcontrast_contrastive_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260813-F994AA5E-P01` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-13 | Verified |

Authors: Athar, ShahRukh; Shu, Zhixin; Xu, Zexiang; Luan, Fujun; Bi, Sai; Sunkavalli, Kalyan; Samaras, Dimitris. Submitted/source date: 2023/09/20. Job `BLAD-2200-20260813-F994AA5E`; item `BLAD-2200-20260813-F994AA5E-P01`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Recent advances in Neural Radiance Fields (NeRFs) have made it possible to reconstruct and reanimate dynamic portrait scenes …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In the real world, there is self-shadowing of the face, and the head casts its shadow on other …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: dynamic, neural | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies appearance, controllable, dynamic. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around appearance, controllable, dynamic. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
The evaluation evidence is represented by “In the real world, there is self-shadowing of the face, and the head casts its shadow on other …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving appearance, controllable, dynamic. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 36,584 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how dynamic, neural connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: dynamic, neural.
...
|---|---|---|---|
| Self-Learned IDC - DEP-E | Related DEP | Overlap: dynamic, neural | `.lake-data/DEP-E/DEP-E-20260710-Self Learned IDC/self_learned_idc_manuscript.md` |
| DMNN Conditional Paths - DEP-E | Related DEP | Overlap: dynamic, neural | `.lake-data/DEP-E/DEP-E-20260716-DMNN Conditional Paths/dmnn_conditional_paths_manuscript.md` |
| 4DContrast Contrastive Review - DEP-E | Related DEP | Overlap: dynamic | `.lake-data/DEP-E/DEP-E-20260722-4DContrast Contrastive/4dcontrast_contrastive_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2309.11009 | Metadata and abstract | 2026-08-13 | Metadata only |
| R2 | https://arxiv.org/html/2309.11009 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-13 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2309.11009 | Primary paper integrity | 2026-08-13 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260710-Self Learned IDC/self_learned_idc_manuscript.md` | Related synthesis: dynamic, neural | 2026-08-13 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260716-DMNN Conditional Paths/dmnn_conditional_paths_manuscript.md` | Related synthesis: dynamic, neural | 2026-08-13 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260722-4DContrast Contrastive/4dcontrast_contrastive_manuscript.md` | Related synthesis: dynamic | 2026-08-13 | Repository-relative |

## Appendix

- Uniform selected index: 36,584 of 75,964 units from 75,967 PDFs.
