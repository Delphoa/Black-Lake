---
title: "DeepVerse 4D - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of DeepVerse: 4D Autoregressive Video Generation as a World Model."
...
primary_url: "https://arxiv.org/abs/2506.01103"
stable_identifier: "arXiv:2506.01103; DOI:10.48550/arXiv.2506.01103"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P388"
...
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2506.01103 | https://arxiv.org/abs/2506.01103 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2506.01103 rendering | https://arxiv.org/html/2506.01103 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2506.01103 | https://arxiv.org/pdf/2506.01103 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Streaming Autoregressive - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Streaming Autoregressive/streaming_autoregressive_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Qwen-RobotWorld Technical - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Qwen-RobotWorld Technical/qwen_robotworld_technical_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Stereo World Model - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Stereo World Model/stereo_world_model_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P388` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Chen, Junyi; Zhu, Haoyi; He, Xianglong; Wang, Yifan; Zhou, Jianjun; Chang, Wenzheng; Zhou, Yang; Li, Zizun; Fu, Zhoujie; Pang, Jiangmiao; He, Tong. Submitted/source date: 2025/06/01. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P388`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: autoregressive, generation, video, world | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies autoregressive, deepverse, generation. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around autoregressive, deepverse, generation. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving autoregressive, deepverse, generation. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 36,794 of 75,964 units; duplicate exclusions 4; focus exclusions 17; source-gate exclusions 0; reselections 21.
...
- The related DEPs show how autoregressive, generation, video, world connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: autoregressive, generation, video, world.
...
|---|---|---|---|
| Streaming Autoregressive - DEP-E | Related DEP | Overlap: autoregressive, video, generation | `.lake-data/DEP-E/DEP-E-20260818-Streaming Autoregressive/streaming_autoregressive_manuscript.md` |
| Qwen-RobotWorld Technical - DEP-E | Related DEP | Overlap: video, world, generation | `.lake-data/DEP-E/DEP-E-20260819-Qwen-RobotWorld Technical/qwen_robotworld_technical_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2506.01103 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2506.01103 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2506.01103 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Streaming Autoregressive/streaming_autoregressive_manuscript.md` | Related synthesis: autoregressive, video, generation | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Qwen-RobotWorld Technical/qwen_robotworld_technical_manuscript.md` | Related synthesis: video, world, generation | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Stereo World Model/stereo_world_model_manuscript.md` | Related synthesis: video, world, generation | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 36,794 of 75,964 units from 75,967 PDFs.
