---
title: "Protecting Neural - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Protecting Neural Networks with Hierarchical Random Switching: Towards Better Robustness-Accuracy Trade-off for Stochastic Defenses."
...
primary_url: "https://arxiv.org/abs/1908.07116"
stable_identifier: "arXiv:1908.07116; DOI:10.48550/arXiv.1908.07116"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P19"
...
# Protecting Neural - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1908.07116 | https://arxiv.org/abs/1908.07116 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 1908.07116 rendering | https://arxiv.org/html/1908.07116 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 1908.07116 | https://arxiv.org/pdf/1908.07116 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | A New System of Global - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260727-A New System of Global/a_new_system_of_global_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | The Clock and the Pizza - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260815-The Clock and the Pizza/the_clock_and_the_pizza_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | Failure Cases Are Better - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Failure Cases Are Better/failure_cases_are_better_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P19` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Wang, Xiao; Wang, Siyue; Chen, Pin-Yu; Wang, Yanzhi; Kulis, Brian; Lin, Xue; Chin, Peter. Submitted/source date: 2019/08/20. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P19`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Despite achieving remarkable success in various domains, recent studies have uncovered the vulnerability of deep neural networks to …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Despite achieving remarkable success in various domains, recent studies have uncovered the vulnerability of deep neural networks to …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: better, networks, neural, trade-off | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies better, defenses, hierarchical. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around better, defenses, hierarchical. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Despite achieving remarkable success in various domains, recent studies have uncovered the vulnerability of deep neural networks to …”. The full-paper rendering contains 98 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Despite achieving remarkable success in various domains, recent studies have uncovered the vulnerability of deep neural networks to …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Despite achieving remarkable success in various domains, recent studies have uncovered the vulnerability of deep neural networks to …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving better, defenses, hierarchical. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 13,724 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how better, networks, neural, trade-off connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: better, networks, neural, trade-off.
...
|---|---|---|---|
| A New System of Global - DEP-E | Related DEP | Overlap: neural, networks, better | `.lake-data/DEP-E/DEP-E-20260727-A New System of Global/a_new_system_of_global_manuscript.md` |
| The Clock and the Pizza - DEP-E | Related DEP | Overlap: neural, networks, better | `.lake-data/DEP-E/DEP-E-20260815-The Clock and the Pizza/the_clock_and_the_pizza_manuscript.md` |
| Failure Cases Are Better - DEP-E | Related DEP | Overlap: trade-off, better, neural, networks | `.lake-data/DEP-E/DEP-E-20260803-Failure Cases Are Better/failure_cases_are_better_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1908.07116 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/1908.07116 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1908.07116 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260727-A New System of Global/a_new_system_of_global_manuscript.md` | Related synthesis: neural, networks, better | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260815-The Clock and the Pizza/the_clock_and_the_pizza_manuscript.md` | Related synthesis: neural, networks, better | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260803-Failure Cases Are Better/failure_cases_are_better_manuscript.md` | Related synthesis: trade-off, better, neural, networks | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 13,724 of 75,964 units from 75,967 PDFs.
