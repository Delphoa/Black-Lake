---
title: "A parallel structured - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A parallel structured divide-and-conquer algorithm for symmetric tridiagonal eigenvalue problems."
...
primary_url: "https://arxiv.org/abs/2008.01990"
stable_identifier: "arXiv:2008.01990; DOI:10.1109/TPDS.2020.3019471"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P37"
...
# A parallel structured - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2008.01990 | https://arxiv.org/abs/2008.01990 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2008.01990 rendering | https://arxiv.org/html/2008.01990 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2008.01990 | https://arxiv.org/pdf/2008.01990 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | WKGM MRI Reconstruction - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-WKGM MRI Reconstruction/wkgm_mri_reconstruction_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | Automatically Planning Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260722-Automatically Planning/automatically_planning_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | Efficient LLM-based - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260802-Efficient LLM-based/efficient_llm_based_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P37` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Liao, Xia; Li, Shengguo; Lu, Yutong; Roman, Jose E.. Submitted/source date: 2020/08/05. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P37`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In this paper, a parallel structured divide-and-conquer (PSDC) eigensolver is proposed for symmetric tridiagonal matrices based on ScaLAPACK …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In this paper, a parallel structured divide-and-conquer (PSDC) eigensolver is proposed for symmetric tridiagonal matrices based on ScaLAPACK …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, parallel, problems, structured | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, divide-and-conquer, eigenvalue. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, divide-and-conquer, eigenvalue. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In this paper, a parallel structured divide-and-conquer (PSDC) eigensolver is proposed for symmetric tridiagonal matrices based on ScaLAPACK …”. The full-paper rendering contains 44 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In this paper, a parallel structured divide-and-conquer (PSDC) eigensolver is proposed for symmetric tridiagonal matrices based on ScaLAPACK …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “It is known that some Cauchy-like matrices with off-diagonally low-rank properties appear in the DC algorithm [ 1 …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, divide-and-conquer, eigenvalue. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 18,032 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how algorithm, parallel, problems, structured connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, parallel, problems, structured.
...
|---|---|---|---|
| WKGM MRI Reconstruction - DEP-E | Related DEP | Overlap: parallel, problems, algorithm, structured | `.lake-data/DEP-E/DEP-E-20260720-WKGM MRI Reconstruction/wkgm_mri_reconstruction_manuscript.md` |
| Automatically Planning Review - DEP-E | Related DEP | Overlap: parallel, algorithm | `.lake-data/DEP-E/DEP-E-20260722-Automatically Planning/automatically_planning_manuscript.md` |
| Efficient LLM-based - DEP-E | Related DEP | Overlap: parallel, structured | `.lake-data/DEP-E/DEP-E-20260802-Efficient LLM-based/efficient_llm_based_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2008.01990 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2008.01990 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2008.01990 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260720-WKGM MRI Reconstruction/wkgm_mri_reconstruction_manuscript.md` | Related synthesis: parallel, problems, algorithm, structured | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260722-Automatically Planning/automatically_planning_manuscript.md` | Related synthesis: parallel, algorithm | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260802-Efficient LLM-based/efficient_llm_based_manuscript.md` | Related synthesis: parallel, structured | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 18,032 of 75,964 units from 75,967 PDFs.
