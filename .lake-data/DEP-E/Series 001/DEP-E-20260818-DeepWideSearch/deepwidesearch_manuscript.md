---
title: "DeepWideSearch - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of DeepWideSearch: Benchmarking Depth and Width in Agentic Information Seeking."
...
primary_url: "https://arxiv.org/abs/2510.20168"
stable_identifier: "arXiv:2510.20168; DOI:10.48550/arXiv.2510.20168"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P13"
...
# DeepWideSearch - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2510.20168 | https://arxiv.org/abs/2510.20168 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2510.20168 rendering | https://arxiv.org/html/2510.20168 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2510.20168 | https://arxiv.org/pdf/2510.20168 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | STRUCTSENSE A - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260817-STRUCTSENSE A/structsense_a_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | Kimi K2 5 Visual Agentic - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260727-Kimi K2 5 Visual Agentic/kimi_k2_5_visual_agentic_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | PreGenie Slides - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260806-PreGenie Slides/pregenie_slides_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P13` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Lan, Tian; Zhu, Bin; Jia, Qianghuai; Ren, Junyang; Li, Haijun; Wang, Longyue; Xu, Zhao; Luo, Weihua; Zhang, Kaifu. Submitted/source date: 2025/10/23. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P13`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: agentic, benchmarking, information | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies agentic, benchmarking, deepwidesearch. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around agentic, benchmarking, deepwidesearch. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 78 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving agentic, benchmarking, deepwidesearch. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 17,490 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how agentic, benchmarking, information connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: agentic, benchmarking, information.
...
|---|---|---|---|
| STRUCTSENSE A - DEP-E | Related DEP | Overlap: agentic, benchmarking, information | `.lake-data/DEP-E/DEP-E-20260817-STRUCTSENSE A/structsense_a_manuscript.md` |
| Kimi K2 5 Visual Agentic - DEP-E | Related DEP | Overlap: agentic | `.lake-data/DEP-E/DEP-E-20260727-Kimi K2 5 Visual Agentic/kimi_k2_5_visual_agentic_manuscript.md` |
| PreGenie Slides - DEP-E | Related DEP | Overlap: agentic | `.lake-data/DEP-E/DEP-E-20260806-PreGenie Slides/pregenie_slides_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2510.20168 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2510.20168 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2510.20168 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260817-STRUCTSENSE A/structsense_a_manuscript.md` | Related synthesis: agentic, benchmarking, information | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260727-Kimi K2 5 Visual Agentic/kimi_k2_5_visual_agentic_manuscript.md` | Related synthesis: agentic | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260806-PreGenie Slides/pregenie_slides_manuscript.md` | Related synthesis: agentic | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 17,490 of 75,964 units from 75,967 PDFs.
