---
title: "APSQ Additive Partial Sum - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of APSQ: Additive Partial Sum Quantization with Algorithm-Hardware Co-Design."
...
primary_url: "https://arxiv.org/abs/2505.03748"
stable_identifier: "arXiv:2505.03748; DOI:10.48550/arXiv.2505.03748"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P168"
...
# APSQ Additive Partial Sum - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2505.03748 | https://arxiv.org/abs/2505.03748 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2505.03748 rendering | https://arxiv.org/html/2505.03748 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2505.03748 | https://arxiv.org/pdf/2505.03748 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Gen-NeRF Efficient and - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Gen-NeRF Efficient and/gen_nerf_efficient_and_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Schwarz Neural Inference - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-Schwarz Neural Inference/schwarz_neural_inference_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Anisotropic - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Anisotropic/anisotropic_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P168` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Tan, Yonghao; Dong, Pingcheng; Wu, Yongkun; Liu, Yu; Liu, Xuejiao; Luo, Peng; Liu, Shih-Yang; Huang, Xijie; Zhang, Dong; Liang, Luhong; Cheng, Kwang-Ting. Submitted/source date: 2025/04/10. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P168`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: additive, algorithm-hardware, co-design, partial | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies additive, algorithm-hardware, apsq. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around additive, algorithm-hardware, apsq. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Have a free development cycle? Help support accessibility at arXiv! Our collaborators at LaTeXML maintain a list of …”. The full-paper rendering contains 44 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving additive, algorithm-hardware, apsq. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 51,344 of 75,964 units; duplicate exclusions 2; focus exclusions 8; source-gate exclusions 0; reselections 10.
...
- The related DEPs show how additive, algorithm-hardware, co-design, partial connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: additive, algorithm-hardware, co-design, partial.
...
|---|---|---|---|
| Gen-NeRF Efficient and - DEP-E | Related DEP | Overlap: algorithm-hardware, co-design | `.lake-data/DEP-E/DEP-E-20260819-Gen-NeRF Efficient and/gen_nerf_efficient_and_manuscript.md` |
| Schwarz Neural Inference - DEP-E | Related DEP | Overlap: additive, partial | `.lake-data/DEP-E/DEP-E-20260723-Schwarz Neural Inference/schwarz_neural_inference_manuscript.md` |
| Anisotropic - DEP-E | Related DEP | Overlap: additive | `.lake-data/DEP-E/DEP-E-20260819-Anisotropic/anisotropic_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2505.03748 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2505.03748 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2505.03748 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Gen-NeRF Efficient and/gen_nerf_efficient_and_manuscript.md` | Related synthesis: algorithm-hardware, co-design | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260723-Schwarz Neural Inference/schwarz_neural_inference_manuscript.md` | Related synthesis: additive, partial | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Anisotropic/anisotropic_manuscript.md` | Related synthesis: additive | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 51,344 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 2; focus exclusions: 8; source-gate exclusions: 0; reselections: 10; 24-hour cutoff: 2026-08-18.
