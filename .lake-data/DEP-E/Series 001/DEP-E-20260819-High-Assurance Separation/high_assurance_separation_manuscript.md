---
title: "High-Assurance Separation - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of High-Assurance Separation Kernels: A Survey on Formal Methods."
...
primary_url: "https://arxiv.org/abs/1701.01535"
stable_identifier: "arXiv:1701.01535; DOI:10.48550/arXiv.1701.01535"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P298"
...
# High-Assurance Separation - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1701.01535 | https://arxiv.org/abs/1701.01535 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1701.01535 rendering | https://arxiv.org/html/1701.01535 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1701.01535 | https://arxiv.org/pdf/1701.01535 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | A Survey on - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A Survey on/a_survey_on_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P298` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhao, Yongwang; Sanan, David; Zhang, Fuyuan; Liu, Yang. Submitted/source date: 2017/01/06. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P298`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Separation kernels provide temporal/spatial separation and controlled information flow to their hosted applications. They are introduced to decouple …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “High-assurance systems require compelling evidences to show that their delivered services satisfy critical properties, e.g. security and safety …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: formal, kernels, methods, separation, survey | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies formal, high-assurance, kernels. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around formal, high-assurance, kernels. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Separation kernels provide temporal/spatial separation and controlled information flow to their hosted applications. They are introduced to decouple …”. The full-paper rendering contains 96 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “High-assurance systems require compelling evidences to show that their delivered services satisfy critical properties, e.g. security and safety …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Separation kernels provide temporal/spatial separation and controlled information flow to their hosted applications. They are introduced to decouple …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving formal, high-assurance, kernels. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 1,145 of 75,964 units; duplicate exclusions 1; focus exclusions 5; source-gate exclusions 0; reselections 6.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; title/abstract evidence terms formal method.
...
- The related DEPs show how formal, kernels, methods, separation, survey connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: formal, kernels, methods, separation, survey.
...
|---|---|---|---|
| Efficient FM Survey - DEP-E | Related DEP | Overlap: survey, kernels, formal, separation, methods | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` |
| A Survey on - DEP-E | Related DEP | Overlap: survey, methods | `.lake-data/DEP-E/DEP-E-20260819-A Survey on/a_survey_on_manuscript.md` |
| A Systematic Survey of - DEP-E | Related DEP | Overlap: survey | `.lake-data/DEP-E/DEP-E-20260729-A Systematic Survey of/a_systematic_survey_of_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1701.01535 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1701.01535 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1701.01535 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` | Related synthesis: survey, kernels, formal, separation, methods | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-A Survey on/a_survey_on_manuscript.md` | Related synthesis: survey, methods | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260729-A Systematic Survey of/a_systematic_survey_of_manuscript.md` | Related synthesis: survey | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 1,145 of 75,964 units from 75,967 PDFs.
...
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; terms formal method.
