---
title: "Hierarchical Trajec 02606 - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Hierarchical Trajectory Planning for Autonomous Driving in Low-speed Driving Scenarios Based on RRT and Optimization."
...
primary_url: "https://arxiv.org/abs/1904.02606"
stable_identifier: "arXiv:1904.02606; DOI:10.48550/arXiv.1904.02606"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P346"
...
# Hierarchical Trajec 02606 - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1904.02606 | https://arxiv.org/abs/1904.02606 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1904.02606 rendering | https://arxiv.org/html/1904.02606 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1904.02606 | https://arxiv.org/pdf/1904.02606 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | PiP Planning-informed - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-PiP Planning-informed/pip_planning_informed_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Hierarchical Trajectory - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Hierarchical Trajectory/hierarchical_trajectory_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P346` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Chen, Yuying; Ye, Haoyang; Liu, Ming. Submitted/source date: 2019/04/04. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P346`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: autonomous, driving, hierarchical, planning, trajectory | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies driving, autonomous, hierarchical. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around driving, autonomous, hierarchical. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 43 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving driving, autonomous, hierarchical. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 17,513 of 75,964 units; duplicate exclusions 3; focus exclusions 17; source-gate exclusions 1; reselections 21.
...
- The related DEPs show how autonomous, driving, hierarchical, planning, trajectory connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: autonomous, driving, hierarchical, planning, trajectory.
...
|---|---|---|---|
| HiP-AD Hierarchical and - DEP-E | Related DEP | Overlap: driving, hierarchical, autonomous, planning | `.lake-data/DEP-E/DEP-E-20260819-HiP-AD Hierarchical and/hip_ad_hierarchical_and_manuscript.md` |
| PiP Planning-informed - DEP-E | Related DEP | Overlap: driving, trajectory, autonomous, planning | `.lake-data/DEP-E/DEP-E-20260819-PiP Planning-informed/pip_planning_informed_manuscript.md` |
| Hierarchical Trajectory - DEP-E | Related DEP | Overlap: hierarchical, trajectory, planning, autonomous | `.lake-data/DEP-E/DEP-E-20260819-Hierarchical Trajectory/hierarchical_trajectory_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1904.02606 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1904.02606 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1904.02606 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-HiP-AD Hierarchical and/hip_ad_hierarchical_and_manuscript.md` | Related synthesis: driving, hierarchical, autonomous, planning | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-PiP Planning-informed/pip_planning_informed_manuscript.md` | Related synthesis: driving, trajectory, autonomous, planning | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Hierarchical Trajectory/hierarchical_trajectory_manuscript.md` | Related synthesis: hierarchical, trajectory, planning, autonomous | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 17,513 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 3; focus exclusions: 17; source-gate exclusions: 1; reselections: 21; 24-hour cutoff: 2026-08-18.
