---
title: "Communication-Efficient - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Communication-Efficient Device Scheduling for Federated Learning Using Lyapunov Optimization."
...
primary_url: "https://arxiv.org/abs/2503.00569"
stable_identifier: "arXiv:2503.00569; DOI:10.48550/arXiv.2503.00569"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P486"
...
# Communication-Efficient - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2503.00569 | https://arxiv.org/abs/2503.00569 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2503.00569 rendering | https://arxiv.org/html/2503.00569 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2503.00569 | https://arxiv.org/pdf/2503.00569 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Accelerating Federated - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Accelerating Federated/accelerating_federated_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Certifying the Right to - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Certifying the Right to/certifying_the_right_to_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Federated Split Learning - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Federated Split Learning/federated_split_learning_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P486` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Perazzone, Jake B.; Wang, Shiqiang; Ji, Mingyue; Chan, Kevin. Submitted/source date: 2025/03/01. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P486`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Federated learning (FL) is a useful tool that enables the training of machine learning models over distributed data …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In this paper, we consider the scenario where training is coordinated by a central aggregator that communicates with …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: federated, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies communication-efficient, device, federated. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around communication-efficient, device, federated. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Federated learning (FL) is a useful tool that enables the training of machine learning models over distributed data …”. The full-paper rendering contains 68 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In this paper, we consider the scenario where training is coordinated by a central aggregator that communicates with …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving communication-efficient, device, federated. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 70,279 of 75,964 units; duplicate exclusions 12; focus exclusions 43; source-gate exclusions 3; reselections 58.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; title/abstract evidence terms optimization, scheduling.
...
- The related DEPs show how federated, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: federated, optimization.
...
|---|---|---|---|
| Accelerating Federated - DEP-E | Related DEP | Overlap: federated, optimization | `.lake-data/DEP-E/DEP-E-20260819-Accelerating Federated/accelerating_federated_manuscript.md` |
| Certifying the Right to - DEP-E | Related DEP | Overlap: federated, optimization | `.lake-data/DEP-E/DEP-E-20260819-Certifying the Right to/certifying_the_right_to_manuscript.md` |
| Federated Split Learning - DEP-E | Related DEP | Overlap: federated, optimization | `.lake-data/DEP-E/DEP-E-20260819-Federated Split Learning/federated_split_learning_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2503.00569 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2503.00569 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2503.00569 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Accelerating Federated/accelerating_federated_manuscript.md` | Related synthesis: federated, optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Certifying the Right to/certifying_the_right_to_manuscript.md` | Related synthesis: federated, optimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Federated Split Learning/federated_split_learning_manuscript.md` | Related synthesis: federated, optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 70,279 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 12; focus exclusions: 43; source-gate exclusions: 3; reselections: 58; 24-hour cutoff: 2026-08-18.
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories algorithmic research; terms optimization, scheduling.
