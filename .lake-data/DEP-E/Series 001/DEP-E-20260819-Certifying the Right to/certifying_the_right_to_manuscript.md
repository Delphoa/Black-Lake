---
title: "Certifying the Right to - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Certifying the Right to Be Forgotten: Primal-Dual Optimization for Sample and Label Unlearning in Vertical Federated Learning."
...
primary_url: "https://arxiv.org/abs/2512.23171"
stable_identifier: "arXiv:2512.23171; DOI:10.1109/TIFS.2025.3636788"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P139"
...
# Certifying the Right to - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2512.23171 | https://arxiv.org/abs/2512.23171 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2512.23171 rendering | https://arxiv.org/html/2512.23171 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2512.23171 | https://arxiv.org/pdf/2512.23171 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | Unlearning for Federated - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Unlearning for Federated/unlearning_for_federated_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P139` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Jiang, Yu; Tong, Xindi; Liu, Ziyao; Zhang, Xiaoxi; Lam, Kwok-Yan; Tan, Chee Wei. Submitted/source date: 2025/12/29. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P139`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Federated unlearning has become an attractive approach to address privacy concerns in collaborative machine learning, for situations when …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “To address such challenges, we propose FedORA (Federated Optimization for data Removal via primal-dual Algorithm), designed for sample …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: federated, forgotten, optimization, right, unlearning | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies certifying, federated, forgotten. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around certifying, federated, forgotten. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Federated unlearning has become an attractive approach to address privacy concerns in collaborative machine learning, for situations when …”. The full-paper rendering contains 99 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “To address such challenges, we propose FedORA (Federated Optimization for data Removal via primal-dual Algorithm), designed for sample …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “To address such challenges, we propose FedORA (Federated Optimization for data Removal via primal-dual Algorithm), designed for sample …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving certifying, federated, forgotten. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 65,341 of 75,964 units; duplicate exclusions 0; focus exclusions 7; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how federated, forgotten, optimization, right, unlearning connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: federated, forgotten, optimization, right, unlearning.
...
|---|---|---|---|
| FOLTR Unlearning - DEP-E | Related DEP | Overlap: unlearning, federated, forgotten, right, optimization | `.lake-data/DEP-E/DEP-E-20260804-Forget FOLTR/forget_foltr_manuscript.md` |
| Unlearning for Federated - DEP-E | Related DEP | Overlap: unlearning, federated, forgotten, right | `.lake-data/DEP-E/DEP-E-20260819-Unlearning for Federated/unlearning_for_federated_manuscript.md` |
| Privacy-Preserving - DEP-E | Related DEP | Overlap: unlearning, federated | `.lake-data/DEP-E/DEP-E-20260814-Privacy-Preserving/privacy_preserving_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2512.23171 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2512.23171 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2512.23171 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260804-Forget FOLTR/forget_foltr_manuscript.md` | Related synthesis: unlearning, federated, forgotten, right, optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Unlearning for Federated/unlearning_for_federated_manuscript.md` | Related synthesis: unlearning, federated, forgotten, right | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260814-Privacy-Preserving/privacy_preserving_manuscript.md` | Related synthesis: unlearning, federated | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 65,341 of 75,964 units from 75,967 PDFs.
