---
title: "A partitioned - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A partitioned shift-without-invert algorithm to improve parallel eigensolution efficiency in real-space electronic transport."
...
primary_url: "https://arxiv.org/abs/1606.01139"
stable_identifier: "arXiv:1606.01139; DOI:10.1016/j.cpc.2016.05.015"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P285"
...
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1606.01139 | https://arxiv.org/abs/1606.01139 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1606.01139 rendering | https://arxiv.org/html/1606.01139 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1606.01139 | https://arxiv.org/pdf/1606.01139 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | A parallel structured - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-A parallel structured/a_parallel_structured_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Transport Convexity - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260718-Transport Convexity/transport_convexity_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P285` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Feldman, Baruch; Zhou, Yunkai. Submitted/source date: 2016/06/02. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P285`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We present an eigenspectrum partitioning scheme without inversion for the recently described real-space electronic transport code, TRANSEC. The …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We present an eigenspectrum partitioning scheme without inversion for the recently described real-space electronic transport code, TRANSEC. The …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, efficiency, electronic, parallel, transport | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, efficiency, eigensolution. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, efficiency, eigensolution. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We present an eigenspectrum partitioning scheme without inversion for the recently described real-space electronic transport code, TRANSEC. The …”. The full-paper rendering contains 35 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We present an eigenspectrum partitioning scheme without inversion for the recently described real-space electronic transport code, TRANSEC. The …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “A single partition’s complexity is quadratic in n r , j n_{r,j} , thus it is theoretically possible …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, efficiency, eigensolution. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 4,470 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how algorithm, efficiency, electronic, parallel, transport connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, efficiency, electronic, parallel, transport.
...
|---|---|---|---|
| Heterogeneous Similarity - DEP-E | Related DEP | Overlap: electronic | `.lake-data/DEP-E/DEP-E-20260805-Heterogeneous Similarity/heterogeneous_similarity_manuscript.md` |
| A parallel structured - DEP-E | Related DEP | Overlap: parallel, algorithm | `.lake-data/DEP-E/DEP-E-20260818-A parallel structured/a_parallel_structured_manuscript.md` |
| Transport Convexity - DEP-E | Related DEP | Overlap: transport, efficiency | `.lake-data/DEP-E/DEP-E-20260718-Transport Convexity/transport_convexity_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1606.01139 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1606.01139 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1606.01139 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260805-Heterogeneous Similarity/heterogeneous_similarity_manuscript.md` | Related synthesis: electronic | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-A parallel structured/a_parallel_structured_manuscript.md` | Related synthesis: parallel, algorithm | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260718-Transport Convexity/transport_convexity_manuscript.md` | Related synthesis: transport, efficiency | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 4,470 of 75,964 units from 75,967 PDFs.
