---
title: "Deep Reinforcement - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Deep Reinforcement Learning Based Intelligent Reflecting Surface Optimization for TDD MultiUser MIMO Systems."
...
primary_url: "https://arxiv.org/abs/2307.15393"
stable_identifier: "arXiv:2307.15393; DOI:10.48550/arXiv.2307.15393"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P242"
...
# Deep Reinforcement - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2307.15393 | https://arxiv.org/abs/2307.15393 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2307.15393 rendering | https://arxiv.org/html/2307.15393 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2307.15393 | https://arxiv.org/pdf/2307.15393 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Intelligent Reflecting - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Intelligent Reflecting/intelligent_reflecting_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Rank Optimization for - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260729-Rank Optimization for/rank_optimization_for_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P242` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhao, Fengyu; Chen, Wen; Liu, Ziwei; Li, Jun; Wu, Qingqing. Submitted/source date: 2023/07/28. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P242`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In this letter, we investigate the discrete phase shift design of the intelligent reflecting surface (IRS) in a …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In this letter, we investigate the discrete phase shift design of the intelligent reflecting surface (IRS) in a …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: intelligent, mimo, optimization, reflecting, surface | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies intelligent, mimo, multiuser. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around intelligent, mimo, multiuser. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In this letter, we investigate the discrete phase shift design of the intelligent reflecting surface (IRS) in a …”. The full-paper rendering contains 34 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In this letter, we investigate the discrete phase shift design of the intelligent reflecting surface (IRS) in a …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Intelligent reflecting surface (IRS) is a low power technology that smartly tunes the radio signal prorogation in wireless …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving intelligent, mimo, multiuser. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 41,689 of 75,964 units; duplicate exclusions 0; focus exclusions 8; source-gate exclusions 0; reselections 8.
...
- The related DEPs show how intelligent, mimo, optimization, reflecting, surface connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: intelligent, mimo, optimization, reflecting, surface.
...
|---|---|---|---|
| Intelligent Reflecting - DEP-E | Related DEP | Overlap: reflecting, intelligent, surface, optimization, systems | `.lake-data/DEP-E/DEP-E-20260819-Intelligent Reflecting/intelligent_reflecting_manuscript.md` |
| Rank Optimization for - DEP-E | Related DEP | Overlap: mimo, optimization, intelligent, surface | `.lake-data/DEP-E/DEP-E-20260729-Rank Optimization for/rank_optimization_for_manuscript.md` |
| Fluid Antenna Index - DEP-E | Related DEP | Overlap: mimo, systems, optimization | `.lake-data/DEP-E/DEP-E-20260819-Fluid Antenna Index/fluid_antenna_index_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2307.15393 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2307.15393 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2307.15393 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Intelligent Reflecting/intelligent_reflecting_manuscript.md` | Related synthesis: reflecting, intelligent, surface, optimization, systems | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260729-Rank Optimization for/rank_optimization_for_manuscript.md` | Related synthesis: mimo, optimization, intelligent, surface | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Fluid Antenna Index/fluid_antenna_index_manuscript.md` | Related synthesis: mimo, systems, optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 41,689 of 75,964 units from 75,967 PDFs.
