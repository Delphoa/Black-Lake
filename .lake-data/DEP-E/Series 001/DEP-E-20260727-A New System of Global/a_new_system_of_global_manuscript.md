---
title: "A New System of Global - DEP-E"
generated_at: "2026-07-27 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A New System of Global Fractional-order Interval Implicit Projection Neural Networks."
...
primary_url: "https://arxiv.org/abs/1611.06665"
stable_identifier: "arXiv:1611.06665; DOI:10.48550/arXiv.1611.06665"
deployment_job_id: "BLAD-2200-20260727-ADBD50D5"
deployment_item_id: "BLAD-2200-20260727-ADBD50D5-P01"
...
# A New System of Global - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1611.06665 | https://arxiv.org/abs/1611.06665 | Metadata only. | 2026-07-27 | Inspected |
| S2 | Full paper | Primary | HTML | 1611.06665 rendering | https://ar5iv.labs.arxiv.org/html/1611.06665 | Verified local copy withheld. | 2026-07-27 | Inspected in full |
| S3 | PDF | Primary | PDF | 1611.06665 | https://arxiv.org/pdf/1611.06665 | Verified local copy withheld. | 2026-07-27 | Integrity checked and sampled |
| S4 | Global NS Existence - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260712-Global NS Existence/global_ns_existence_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S5 | PAC Confidence - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260713-PAC Confidence/pac_confidence_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S6 | FGLE Midpoint Scheme - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-FGLE Midpoint Scheme/fgle_midpoint_scheme_manuscript.md` | Synthesis only. | 2026-07-27 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260727-ADBD50D5-P01` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-27 | Verified |

Authors: Wu, Zeng-bao; Li, Jin-dong; Huang, Nan-jing. Submitted/source date: 2016/11/21. Job `BLAD-2200-20260727-ADBD50D5`; item `BLAD-2200-20260727-ADBD50D5-P01`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: existence, global, implicit, interval | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies fractional-order, global, implicit. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around fractional-order, global, implicit. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving fractional-order, global, implicit. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 27,246 of 75,778 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how existence, global, implicit, interval connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: existence, global, implicit, interval.
...
|---|---|---|---|
| Global NS Existence - DEP-E | Related DEP | Overlap: existence, global | `.lake-data/DEP-E/DEP-E-20260712-Global NS Existence/global_ns_existence_manuscript.md` |
| PAC Confidence - DEP-E | Related DEP | Overlap: interval | `.lake-data/DEP-E/DEP-E-20260713-PAC Confidence/pac_confidence_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1611.06665 | Metadata and abstract | 2026-07-27 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/1611.06665 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-27 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1611.06665 | Primary paper integrity | 2026-07-27 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260712-Global NS Existence/global_ns_existence_manuscript.md` | Related synthesis: existence, global | 2026-07-27 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260713-PAC Confidence/pac_confidence_manuscript.md` | Related synthesis: interval | 2026-07-27 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260716-FGLE Midpoint Scheme/fgle_midpoint_scheme_manuscript.md` | Related synthesis: implicit | 2026-07-27 | Repository-relative |

## Appendix

- Uniform selected index: 27,246 of 75,778 units from 75,781 PDFs.
