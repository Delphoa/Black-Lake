---
title: "UAV-Assisted Cooperative - DEP-E"
generated_at: "2026-08-05 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of UAV-Assisted Cooperative Edge Inference for Low-Altitude Economy via MoE-based Hierarchical Deep Reinforcement Learning."
...
primary_url: "https://arxiv.org/abs/2605.19290"
stable_identifier: "arXiv:2605.19290; DOI:10.48550/arXiv.2605.19290"
deployment_job_id: "BLAD-2200-20260805-6C10E207"
deployment_item_id: "BLAD-2200-20260805-6C10E207-P04"
...
# UAV-Assisted Cooperative - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2605.19290 | https://arxiv.org/abs/2605.19290 | Metadata only. | 2026-08-05 | Inspected |
| S2 | Full paper | Primary | HTML | 2605.19290 rendering | https://arxiv.org/html/2605.19290 | Verified local copy withheld. | 2026-08-05 | Inspected in full |
| S3 | PDF | Primary | PDF | 2605.19290 | https://arxiv.org/pdf/2605.19290 | Verified local copy withheld. | 2026-08-05 | Integrity checked and sampled |
| S4 | Lattice Spoken LM - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260731-Lattice Spoken LM/lattice_spoken_lm_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S5 | Empirical Study on - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Empirical Study on/empirical_study_on_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S6 | Telecom AI Roadmap - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260711-Telecom AI Roadmap/telecom_ai_roadmap_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260805-6C10E207-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-05 | Verified |

Authors: Zhuang, Wenhao; Mao, Yuyi; Ho, Ivan Wang-Hei; Yu, Xianghao. Submitted/source date: 2026/05/19. Job `BLAD-2200-20260805-6C10E207`; item `BLAD-2200-20260805-6C10E207-P04`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “The low-altitude economy (LAE) is reshaping the industrial landscape by deploying unmanned aerial vehicles (UAVs) to facilitate a …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “The low-altitude economy (LAE) is reshaping the industrial landscape by deploying unmanned aerial vehicles (UAVs) to facilitate a …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: cooperative, economy, edge, hierarchical, inference | Cross-DEP synthesis | Medium | No joint experiment exists |
...
The work is organized around cooperative, economy, edge. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “The low-altitude economy (LAE) is reshaping the industrial landscape by deploying unmanned aerial vehicles (UAVs) to facilitate a …”. The full-paper rendering contains 59 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “The low-altitude economy (LAE) is reshaping the industrial landscape by deploying unmanned aerial vehicles (UAVs) to facilitate a …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The low-altitude economy (LAE) is reshaping the industrial landscape by deploying unmanned aerial vehicles (UAVs) to facilitate a …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving cooperative, economy, edge. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 20,177 of 75,957 units; duplicate exclusions 0; source-gate exclusions 1; reselections 1.
...
- The related DEPs show how cooperative, economy, edge, hierarchical, inference connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: cooperative, economy, edge, hierarchical, inference.
...
|---|---|---|---|
| Lattice Spoken LM - DEP-E | Related DEP | Overlap: economy, hierarchical, edge, inference | `.lake-data/DEP-E/DEP-E-20260731-Lattice Spoken LM/lattice_spoken_lm_manuscript.md` |
| Empirical Study on - DEP-E | Related DEP | Overlap: cooperative, reinforcement | `.lake-data/DEP-E/DEP-E-20260803-Empirical Study on/empirical_study_on_manuscript.md` |
| Telecom AI Roadmap - DEP-E | Related DEP | Overlap: reinforcement, edge, inference | `.lake-data/DEP-E/DEP-E-20260711-Telecom AI Roadmap/telecom_ai_roadmap_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2605.19290 | Metadata and abstract | 2026-08-05 | Metadata only |
| R2 | https://arxiv.org/html/2605.19290 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-05 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2605.19290 | Primary paper integrity | 2026-08-05 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260731-Lattice Spoken LM/lattice_spoken_lm_manuscript.md` | Related synthesis: economy, hierarchical, edge, inference | 2026-08-05 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260803-Empirical Study on/empirical_study_on_manuscript.md` | Related synthesis: cooperative, reinforcement | 2026-08-05 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260711-Telecom AI Roadmap/telecom_ai_roadmap_manuscript.md` | Related synthesis: reinforcement, edge, inference | 2026-08-05 | Repository-relative |

## Appendix

- Uniform selected index: 20,177 of 75,957 units from 75,960 PDFs.
...
- Duplicate exclusions: 0; source-gate exclusions: 1; reselections: 1; 24-hour cutoff: 2026-08-04.
