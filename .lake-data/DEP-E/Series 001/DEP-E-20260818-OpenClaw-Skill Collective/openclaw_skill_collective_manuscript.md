---
title: "OpenClaw-Skill Collective - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of OpenClaw-Skill: Collective Skill Tree Search for Agentic Large Language Models."
...
primary_url: "https://arxiv.org/abs/2606.16774"
stable_identifier: "arXiv:2606.16774; DOI:10.48550/arXiv.2606.16774"
deployment_job_id: "BLAD-2200-20260818-BBEE0F31"
deployment_item_id: "BLAD-2200-20260818-BBEE0F31-P50"
...
# OpenClaw-Skill Collective - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2606.16774 | https://arxiv.org/abs/2606.16774 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2606.16774 rendering | https://arxiv.org/html/2606.16774 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2606.16774 | https://arxiv.org/pdf/2606.16774 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
...
| S6 | Agentic Design of - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260815-Agentic Design of/agentic_design_of_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-BBEE0F31-P50` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Lin, Tianyi; Sun, Chuanyu; Zhang, Jingyi; Wei, Changxu; Yao, Huanjin; Liu, Shunyu; Zhang, Xikun; Liu, Liu; Huang, Jiaxing. Submitted/source date: 2026/06/15. Job `BLAD-2200-20260818-BBEE0F31`; item `BLAD-2200-20260818-BBEE0F31-P50`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Equipping Large Language Model (LLM) agents with effective skills is crucial for solving complex tasks in real-world systems …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Equipping Large Language Model (LLM) agents with effective skills is crucial for solving complex tasks in real-world systems …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: agentic, language, search, skill, tree | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies agentic, collective, language. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around agentic, collective, language. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Equipping Large Language Model (LLM) agents with effective skills is crucial for solving complex tasks in real-world systems …”. The full-paper rendering contains 41 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Equipping Large Language Model (LLM) agents with effective skills is crucial for solving complex tasks in real-world systems …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “However, current skills 4 are largely handcrafted and require substantial manual design and maintenance, making large-scale skill construction …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving agentic, collective, language. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 8,878 of 75,964 units; duplicate exclusions 0; focus exclusions 20; source-gate exclusions 0; reselections 20.
...
- The related DEPs show how agentic, language, search, skill, tree connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: agentic, language, search, skill, tree.
...
|---|---|---|---|
| Adapt as You Say Online - DEP-E | Related DEP | Overlap: skill, language | `.lake-data/DEP-E/DEP-E-20260813-Adapt as You Say Online/adapt_as_you_say_online_manuscript.md` |
| Graph-O1 Monte Carlo Tree - DEP-E | Related DEP | Overlap: tree, search | `.lake-data/DEP-E/DEP-E-20260725-Graph-O1 Monte Carlo Tree/graph_o1_monte_carlo_tree_manuscript.md` |
| Agentic Design of - DEP-E | Related DEP | Overlap: agentic, skill | `.lake-data/DEP-E/DEP-E-20260815-Agentic Design of/agentic_design_of_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2606.16774 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2606.16774 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2606.16774 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260813-Adapt as You Say Online/adapt_as_you_say_online_manuscript.md` | Related synthesis: skill, language | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260725-Graph-O1 Monte Carlo Tree/graph_o1_monte_carlo_tree_manuscript.md` | Related synthesis: tree, search | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260815-Agentic Design of/agentic_design_of_manuscript.md` | Related synthesis: agentic, skill | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 8,878 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 0; focus exclusions: 20; source-gate exclusions: 0; reselections: 20; 24-hour cutoff: 2026-08-17.
