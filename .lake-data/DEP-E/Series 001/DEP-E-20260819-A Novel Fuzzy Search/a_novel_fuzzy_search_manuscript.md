---
title: "A Novel Fuzzy Search - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A Novel Fuzzy Search Approach over Encrypted Data with Improved Accuracy and Efficiency."
...
primary_url: "https://arxiv.org/abs/1904.12111"
stable_identifier: "arXiv:1904.12111; DOI:10.48550/arXiv.1904.12111"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P44"
...
# A Novel Fuzzy Search - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1904.12111 | https://arxiv.org/abs/1904.12111 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1904.12111 rendering | https://arxiv.org/html/1904.12111 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1904.12111 | https://arxiv.org/pdf/1904.12111 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S5 | A novel metric for - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260811-A novel metric for/a_novel_metric_for_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | A Novel K-Repetition - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260813-A Novel K-Repetition/a_novel_k_repetition_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P44` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Cao, Jinkun; Zhu, Jinhao; Lin, Liwei; Xue, Zhengui; Ma, Ruhui; Guan, Haibing. Submitted/source date: 2019/04/27. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P44`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “As cloud computing becomes prevalent in recent years, more and more enterprises and individuals outsource their data to …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “As cloud computing becomes prevalent in recent years, more and more enterprises and individuals outsource their data to …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: novel, search | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies accuracy, efficiency, encrypted. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around accuracy, efficiency, encrypted. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “As cloud computing becomes prevalent in recent years, more and more enterprises and individuals outsource their data to …”. The full-paper rendering contains 111 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “As cloud computing becomes prevalent in recent years, more and more enterprises and individuals outsource their data to …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “As cloud computing becomes prevalent in recent years, more and more enterprises and individuals outsource their data to …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving accuracy, efficiency, encrypted. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 3,613 of 75,964 units; duplicate exclusions 0; focus exclusions 4; source-gate exclusions 0; reselections 4.
...
- The related DEPs show how novel, search connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: novel, search.
...
|---|---|---|---|
| A Novel Training Protocol - DEP-E | Related DEP | Overlap: novel, search | `.lake-data/DEP-E/DEP-E-20260819-A Novel Training Protocol/a_novel_training_protocol_manuscript.md` |
| A novel metric for - DEP-E | Related DEP | Overlap: novel | `.lake-data/DEP-E/DEP-E-20260811-A novel metric for/a_novel_metric_for_manuscript.md` |
| A Novel K-Repetition - DEP-E | Related DEP | Overlap: novel | `.lake-data/DEP-E/DEP-E-20260813-A Novel K-Repetition/a_novel_k_repetition_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1904.12111 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1904.12111 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1904.12111 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-A Novel Training Protocol/a_novel_training_protocol_manuscript.md` | Related synthesis: novel, search | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260811-A novel metric for/a_novel_metric_for_manuscript.md` | Related synthesis: novel | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260813-A Novel K-Repetition/a_novel_k_repetition_manuscript.md` | Related synthesis: novel | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 3,613 of 75,964 units from 75,967 PDFs.
