---
title: "Can AI Agents Really - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Can AI Agents Really Complete RTL-to-GDS? Lessons from Benchmarking Tool-Interactive EDA Workflows"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260721-Tech Intel 1302"
selection_record: "117 candidates; 2 excluded; 115 eligible; draw 1162215255; zero-based index 70"
expansion_record: "10 retained public locators; draw 3837805400; zero-based index 0"
...
# Can AI Agents Really - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260721-Tech Intel 1302 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260721-Tech%20Intel%201302/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-21_1302.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260721-Tech%20Intel%201302/daily_research_findings_2026-07-21_1302.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | Can AI Agents Really Complete RTL-to-GDS? Lessons from Benchmarking Tool-Interactive EDA Workflows | Selected supporting source | arXiv record | 2607.17528 | https://arxiv.org/abs/2607.17528v3 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: Can AI Agents Really Complete RTL-to-GDS? Lessons from Benchmarking Tool-Interactive EDA Workflows
- Authors or producing organization: Jinyuan Deng; Zhengrui Chen; Xufeng Wei; Tianyu Xing; Chenyi Wen; Qi Sun; Cheng Zhuo
- Source platform: arXiv
- Publication date: 2026-07-20
- Revision/version date: 2026-07-23
- Stable identifier: 2607.17528
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260721-Tech%20Intel%201302/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260721-Tech%20Intel%201302/daily_research_findings_2026-07-21_1302.md | Deposited source synthesis | FluxBench evaluates agents across RTL generation, iterative repair, tool feedback, synthesis, placement and routing, and engineering-change-order automation under unified prompts, tools, and technology libraries. The paper reports up to an 86.27% performance gap between agent architectures using the same foundation model and as much as a 105.92× difference in Token ROI; in a PicoRV32 RTL-to-GDS case, FluxEDA reaches a reported end-to-end score of 97.94 and outperforms Claude Code with EDA skills by up to 8.39×. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2607.17528v3 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through Can AI Agents Really Complete RTL-to-GDS? Lessons from Benchmarking Tool-Interactive EDA Workflows. The deposited source package reports that FluxBench evaluates agents across RTL generation, iterative repair, tool feedback, synthesis, placement and routing, and engineering-change-order automation under unified prompts, tools, and technology libraries. The paper reports up to an 86.27% performance gap between agent architectures using the same foundation model and as much as a 105.92× difference in Token ROI; in a PicoRV32 RTL-to-GDS case, FluxEDA reaches a reported end-to-end score of 97.94 and outperforms Claude Code with EDA skills by up to 8.39×. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that Chip design is a demanding test of tool use, state, cost, and physical feedback, not just code generation. The result argues for domain-specific agent evaluation on full flows and for measuring quality per token and runtime, while the commercial-tool case study and preprint status limit generalization. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: Chip design is a demanding test of tool use, state, cost, and physical feedback, not just code generation. The result argues for domain-specific agent evaluation on full flows and for measuring quality per token and runtime, while the commercial-tool case study and preprint status limit generalization.

### Source-reported contribution

The selected DEP summarizes the contribution this way: FluxBench evaluates agents across RTL generation, iterative repair, tool feedback, synthesis, placement and routing, and engineering-change-order automation under unified prompts, tools, and technology libraries. The paper reports up to an 86.27% performance gap between agent architectures using the same foundation model and as much as a 105.92× difference in Token ROI; in a PicoRV32 RTL-to-GDS case, FluxEDA reaches a reported end-to-end score of 97.94 and outperforms Claude Code with EDA skills by up to 8.39×. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is Can AI Agents Really Complete RTL-to-GDS? Lessons from Benchmarking Tool-Interactive EDA Workflows, credited to Jinyuan Deng; Zhengrui Chen; Xufeng Wei; Tianyu Xing; Chenyi Wen; Qi Sun; Cheng Zhuo. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | Chip design is a demanding test of tool use, state, cost, and physical feedback, not just code generation. The result argues for domain-specific agent evaluation on full flows and for measuring quality per token and runtime, while the commercial-tool case study and preprint status limit generalization. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260721-Tech Intel 1302 as a schema-complete DEP-E research artifact.
...
### New in this pass: Can AI Agents Really Complete RTL-to-GDS? Lessons from Benchmarking Tool-Interactive EDA Workflows

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [Can AI Agents Really Complete RTL-to-GDS? Lessons from Benchmarking Tool-Interactive EDA Workflows](https://arxiv.org/abs/2607.17528v3) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://arxiv.org/abs/2607.17641 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.17621 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.17947 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.17986 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.17619 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260721-Tech%20Intel%201302/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260721-Tech%20Intel%201302/daily_research_findings_2026-07-21_1302.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2607.17528v3 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 1 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 2; eligible count 115.
- DEP draw: accepted UInt32 1162215255; rejection limit 4294967215; attempts 1; zero-based index 70.
- Supporting draw: pool 10; accepted UInt32 3837805400; rejection limit 4294967290; attempts 1; zero-based index 0.
