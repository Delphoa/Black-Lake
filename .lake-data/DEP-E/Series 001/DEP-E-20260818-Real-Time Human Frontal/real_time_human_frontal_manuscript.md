---
title: "Real-Time Human Frontal - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Real-Time Human Frontal View Synthesis from a Single Image."
...
primary_url: "https://arxiv.org/abs/2603.15433"
stable_identifier: "arXiv:2603.15433; DOI:10.48550/arXiv.2603.15433"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P01"
...
# Real-Time Human Frontal - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2603.15433 | https://arxiv.org/abs/2603.15433 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2603.15433 rendering | https://arxiv.org/html/2603.15433 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2603.15433 | https://arxiv.org/pdf/2603.15433 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | Learning Nonparametric - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260816-Learning Nonparametric/learning_nonparametric_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | Pixie System Recommending Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260722-Pixie System Recommending/pixie_system_recommending_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P01` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Lin, Fangyu; Hu, Yingdong; Zhu, Lunjie; Liu, Zhening; Huang, Yushi; Lin, Zehong; Zhang, Jun. Submitted/source date: 2026/03/16. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P01`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Photorealistic human novel view synthesis from a single image is crucial for democratizing immersive 3D telepresence, eliminating the …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Photorealistic human novel view synthesis from a single image is crucial for democratizing immersive 3D telepresence, eliminating the …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: human, image, real-time, single, synthesis | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies frontal, human, image. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around frontal, human, image. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Photorealistic human novel view synthesis from a single image is crucial for democratizing immersive 3D telepresence, eliminating the …”. The full-paper rendering contains 60 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Photorealistic human novel view synthesis from a single image is crucial for democratizing immersive 3D telepresence, eliminating the …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Photorealistic human novel view synthesis from a single image is crucial for democratizing immersive 3D telepresence, eliminating the …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving frontal, human, image. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 12,112 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how human, image, real-time, single, synthesis connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: human, image, real-time, single, synthesis.
...
|---|---|---|---|
| Learning Nonparametric - DEP-E | Related DEP | Overlap: image, single, human, synthesis | `.lake-data/DEP-E/DEP-E-20260816-Learning Nonparametric/learning_nonparametric_manuscript.md` |
| Pixie System Recommending Review - DEP-E | Related DEP | Overlap: real-time, human, synthesis | `.lake-data/DEP-E/DEP-E-20260722-Pixie System Recommending/pixie_system_recommending_manuscript.md` |
| CanCal Towards Real-time - DEP-E | Related DEP | Overlap: real-time, human, synthesis | `.lake-data/DEP-E/DEP-E-20260728-CanCal Towards Real-time/cancal_towards_real_time_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2603.15433 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2603.15433 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2603.15433 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260816-Learning Nonparametric/learning_nonparametric_manuscript.md` | Related synthesis: image, single, human, synthesis | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260722-Pixie System Recommending/pixie_system_recommending_manuscript.md` | Related synthesis: real-time, human, synthesis | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260728-CanCal Towards Real-time/cancal_towards_real_time_manuscript.md` | Related synthesis: real-time, human, synthesis | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 12,112 of 75,964 units from 75,967 PDFs.
