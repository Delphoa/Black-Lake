---
title: "FOUND AF Benchmarking ECG - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "FOUND-AF: Benchmarking ECG Foundation Models for Atrial Fibrillation Detection"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260806-Tech Intel 0102"
selection_record: "117 candidates; 7 excluded; 110 eligible; draw 62599673; zero-based index 103"
expansion_record: "11 retained public locators; draw 2552962909; zero-based index 2"
...
# FOUND AF Benchmarking ECG - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260806-Tech Intel 0102 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%200102/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-08-06_0102.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%200102/daily_research_findings_2026-08-06_0102.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | FOUND-AF: Benchmarking ECG Foundation Models for Atrial Fibrillation Detection | Selected supporting source | arXiv record | 2608.03597 | https://arxiv.org/abs/2608.03597v1 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: FOUND-AF: Benchmarking ECG Foundation Models for Atrial Fibrillation Detection
- Authors or producing organization: Amirhossein Taleshinosrati; Yangyang Wang; Atitaya Phoemsuk; Vahid Abolghasemi; Naser Hossein Motlagh; Sadasivan Puthusserypady; Daniel Teichmann; Abdolrahman Peimankar
- Source platform: arXiv
- Publication date: 2026-08-04
- Revision/version date: 2026-08-04
- Stable identifier: 2608.03597
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%200102/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%200102/daily_research_findings_2026-08-06_0102.md | Deposited source synthesis | ** This paper models test-time scaling as budgeted inference over an implicit prefix tree and distinguishes single-trajectory sequential scaling, leaf-level sampling with terminal reduction, and prefix-level search. It argues that the evaluated object is the full inference system, not only the base model, and proposes an evaluation profile that reports compute, uncertainty, and protocol-matched metrics. It also separates exact replay from distributional reproducibility and identifies the artifacts needed for each; the authors report assembling more than 2 billion reasoning traces with progressively richer verifier and token-level signals. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2608.03597v1 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through FOUND-AF: Benchmarking ECG Foundation Models for Atrial Fibrillation Detection. The deposited source package reports that ** This paper models test-time scaling as budgeted inference over an implicit prefix tree and distinguishes single-trajectory sequential scaling, leaf-level sampling with terminal reduction, and prefix-level search. It argues that the evaluated object is the full inference system, not only the base model, and proposes an evaluation profile that reports compute, uncertainty, and protocol-matched metrics. It also separates exact replay from distributional reproducibility and identifies the artifacts needed for each; the authors report assembling more than 2 billion reasoning traces with progressively richer verifier and token-level signals. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** Scalar test-time-compute budgets hide different statistical structures and failure modes. Requiring protocol disclosure and reproducibility artifacts would make reasoning-model comparisons more credible and gives evaluators a way to separate model capability from search, voting, verification, and sampling design. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** Scalar test-time-compute budgets hide different statistical structures and failure modes. Requiring protocol disclosure and reproducibility artifacts would make reasoning-model comparisons more credible and gives evaluators a way to separate model capability from search, voting, verification, and sampling design.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** This paper models test-time scaling as budgeted inference over an implicit prefix tree and distinguishes single-trajectory sequential scaling, leaf-level sampling with terminal reduction, and prefix-level search. It argues that the evaluated object is the full inference system, not only the base model, and proposes an evaluation profile that reports compute, uncertainty, and protocol-matched metrics. It also separates exact replay from distributional reproducibility and identifies the artifacts needed for each; the authors report assembling more than 2 billion reasoning traces with progressively richer verifier and token-level signals. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is FOUND-AF: Benchmarking ECG Foundation Models for Atrial Fibrillation Detection, credited to Amirhossein Taleshinosrati; Yangyang Wang; Atitaya Phoemsuk; Vahid Abolghasemi; Naser Hossein Motlagh; Sadasivan Puthusserypady; Daniel Teichmann; Abdolrahman Peimankar. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** Scalar test-time-compute budgets hide different statistical structures and failure modes. Requiring protocol disclosure and reproducibility artifacts would make reasoning-model comparisons more credible and gives evaluators a way to separate model capability from search, voting, verification, and sampling design. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260806-Tech Intel 0102 as a schema-complete DEP-E research artifact.
...
### New in this pass: FOUND-AF: Benchmarking ECG Foundation Models for Atrial Fibrillation Detection

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [FOUND-AF: Benchmarking ECG Foundation Models for Atrial Fibrillation Detection](https://arxiv.org/abs/2608.03597v1) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://arxiv.org/abs/2608.04001 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2608.03866 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2608.03874 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2608.03485 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2608.03700 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%200102/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%200102/daily_research_findings_2026-08-06_0102.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2608.03597v1 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 6 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 7; eligible count 110.
- DEP draw: accepted UInt32 62599673; rejection limit 4294967270; attempts 1; zero-based index 103.
- Supporting draw: pool 11; accepted UInt32 2552962909; rejection limit 4294967292; attempts 1; zero-based index 2.
