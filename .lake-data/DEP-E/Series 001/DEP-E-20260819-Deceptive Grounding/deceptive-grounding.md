---
title: "Deceptive Grounding - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Deceptive Grounding: Entity Attribution Failure in Clinical Retrieval-Augmented Generation"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260714-Tech Intel 0104"
selection_record: "117 candidates; 41 excluded; 76 eligible; draw 2874160506; zero-based index 30"
expansion_record: "10 retained public locators; draw 1322054761; zero-based index 1"
...
# Deceptive Grounding - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260714-Tech Intel 0104 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260714-Tech%20Intel%200104/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-07-14_0104.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260714-Tech%20Intel%200104/daily_research_findings_2026-07-14_0104.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | Deceptive Grounding: Entity Attribution Failure in Clinical Retrieval-Augmented Generation | Selected supporting source | arXiv record | 2607.09349 | https://arxiv.org/abs/2607.09349v1 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: Deceptive Grounding: Entity Attribution Failure in Clinical Retrieval-Augmented Generation
- Authors or producing organization: Cedric Caruzzo; Donggeun Yoo; Tae Soo Kim
- Source platform: arXiv
- Publication date: 2026-07-10
- Revision/version date: 2026-07-10
- Stable identifier: 2607.09349
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260714-Tech%20Intel%200104/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260714-Tech%20Intel%200104/daily_research_findings_2026-07-14_0104.md | Deposited source synthesis | ** Caruzzo, Yoo, and Kim define deceptive grounding as a clinical RAG failure in which claims are genuinely supported by retrieved evidence but the evidence belongs to the wrong drug or disease entity. Across 13 models, the benchmark reports adversarial deceptive-grounding rates of 8–87%, with domain-specialized models reaching 86.7%. A production measurement across 740 drug–disease pairs reports 7.8% overall failure and 13.6% for recently approved drugs; entity-attribution verification achieved 97.0% precision and 98.7% recall against the reported human gold standard. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2607.09349v1 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through Deceptive Grounding: Entity Attribution Failure in Clinical Retrieval-Augmented Generation. The deposited source package reports that ** Caruzzo, Yoo, and Kim define deceptive grounding as a clinical RAG failure in which claims are genuinely supported by retrieved evidence but the evidence belongs to the wrong drug or disease entity. Across 13 models, the benchmark reports adversarial deceptive-grounding rates of 8–87%, with domain-specialized models reaching 86.7%. A production measurement across 740 drug–disease pairs reports 7.8% overall failure and 13.6% for recently approved drugs; entity-attribution verification achieved 97.0% precision and 98.7% recall against the reported human gold standard. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** Standard faithfulness, hallucination, and citation checks can all pass while a medical system answers the wrong entity. Entity-level attribution should therefore be a separate safety gate for clinical retrieval, drug information, and other high-stakes knowledge systems. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** Standard faithfulness, hallucination, and citation checks can all pass while a medical system answers the wrong entity. Entity-level attribution should therefore be a separate safety gate for clinical retrieval, drug information, and other high-stakes knowledge systems.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** Caruzzo, Yoo, and Kim define deceptive grounding as a clinical RAG failure in which claims are genuinely supported by retrieved evidence but the evidence belongs to the wrong drug or disease entity. Across 13 models, the benchmark reports adversarial deceptive-grounding rates of 8–87%, with domain-specialized models reaching 86.7%. A production measurement across 740 drug–disease pairs reports 7.8% overall failure and 13.6% for recently approved drugs; entity-attribution verification achieved 97.0% precision and 98.7% recall against the reported human gold standard. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is Deceptive Grounding: Entity Attribution Failure in Clinical Retrieval-Augmented Generation, credited to Cedric Caruzzo; Donggeun Yoo; Tae Soo Kim. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** Standard faithfulness, hallucination, and citation checks can all pass while a medical system answers the wrong entity. Entity-level attribution should therefore be a separate safety gate for clinical retrieval, drug information, and other high-stakes knowledge systems. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260714-Tech Intel 0104 as a schema-complete DEP-E research artifact.
...
### New in this pass: Deceptive Grounding: Entity Attribution Failure in Clinical Retrieval-Augmented Generation

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [Deceptive Grounding: Entity Attribution Failure in Clinical Retrieval-Augmented Generation](https://arxiv.org/abs/2607.09349v1) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://arxiv.org/abs/2607.09328 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.09415 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.09473 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.09541 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2607.09422 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260714-Tech%20Intel%200104/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260714-Tech%20Intel%200104/daily_research_findings_2026-07-14_0104.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2607.09349v1 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 40 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 41; eligible count 76.
- DEP draw: accepted UInt32 2874160506; rejection limit 4294967252; attempts 1; zero-based index 30.
- Supporting draw: pool 10; accepted UInt32 1322054761; rejection limit 4294967290; attempts 1; zero-based index 1.
