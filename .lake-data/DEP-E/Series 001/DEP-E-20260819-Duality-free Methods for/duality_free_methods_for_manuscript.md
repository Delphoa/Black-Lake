---
title: "Duality-free Methods for - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Duality-free Methods for Stochastic Composition Optimization."
...
primary_url: "https://arxiv.org/abs/1710.09554"
stable_identifier: "arXiv:1710.09554; DOI:10.48550/arXiv.1710.09554"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P230"
...
# Duality-free Methods for - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1710.09554 | https://arxiv.org/abs/1710.09554 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1710.09554 rendering | https://arxiv.org/html/1710.09554 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1710.09554 | https://arxiv.org/pdf/1710.09554 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | Stochastic - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Stochastic/stochastic_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P230` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Liu, Liu; Liu, Ji; Tao, Dacheng. Submitted/source date: 2017/10/26. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P230`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We consider the composition optimization with two expected-value functions in the form of 1 n ​ ∑ i …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “We consider the composition optimization with two expected-value functions in the form of 1 n ​ ∑ i …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: methods, optimization, stochastic | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies composition, duality-free, methods. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around composition, duality-free, methods. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We consider the composition optimization with two expected-value functions in the form of 1 n ​ ∑ i …”. The full-paper rendering contains 143 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “We consider the composition optimization with two expected-value functions in the form of 1 n ​ ∑ i …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “where F ∗ ​ ( z ) = max G ⁡ ( x ) { ⟨ z , …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving composition, duality-free, methods. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 49,543 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how methods, optimization, stochastic connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: methods, optimization, stochastic.
...
|---|---|---|---|
| Local Stochastic Bilevel - DEP-E | Related DEP | Overlap: stochastic, optimization, methods | `.lake-data/DEP-E/DEP-E-20260728-Local Stochastic Bilevel/local_stochastic_bilevel_manuscript.md` |
...
| Stochastic - DEP-E | Related DEP | Overlap: stochastic, optimization | `.lake-data/DEP-E/DEP-E-20260819-Stochastic/stochastic_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1710.09554 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1710.09554 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1710.09554 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260728-Local Stochastic Bilevel/local_stochastic_bilevel_manuscript.md` | Related synthesis: stochastic, optimization, methods | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Graphon Particle Systems/graphon_particle_systems_manuscript.md` | Related synthesis: stochastic, optimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Stochastic/stochastic_manuscript.md` | Related synthesis: stochastic, optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 49,543 of 75,964 units from 75,967 PDFs.
