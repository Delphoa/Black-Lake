---
title: "An Item is Worth a Prompt - DEP-E"
generated_at: "2026-08-17 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of An Item is Worth a Prompt: Versatile Image Editing with Disentangled Control."
...
primary_url: "https://arxiv.org/abs/2403.04880"
stable_identifier: "arXiv:2403.04880; DOI:10.48550/arXiv.2403.04880"
deployment_job_id: "BLAD-2200-20260817-2C1A830E"
deployment_item_id: "BLAD-2200-20260817-2C1A830E-P04"
...
# An Item is Worth a Prompt - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2403.04880 | https://arxiv.org/abs/2403.04880 | Metadata only. | 2026-08-17 | Inspected |
| S2 | Full paper | Primary | HTML | 2403.04880 rendering | https://arxiv.org/html/2403.04880 | Verified local copy withheld. | 2026-08-17 | Inspected in full |
| S3 | PDF | Primary | PDF | 2403.04880 | https://arxiv.org/pdf/2403.04880 | Verified local copy withheld. | 2026-08-17 | Integrity checked and sampled |
| S4 | Disentangled Knowledge - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260815-Disentangled Knowledge/disentangled_knowledge_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S5 | Rethinking Residual - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260815-Rethinking Residual/rethinking_residual_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S6 | CFE2 Search Explanations - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-CFE2 Search Explain/cfe2_search_explanation_manuscript.md` | Synthesis only. | 2026-08-17 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260817-2C1A830E-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-17 | Verified |

Authors: Feng, Aosong; Qiu, Weikang; Bai, Jinbin; Zhang, Xiao; Dong, Zhen; Zhou, Kaicheng; Ying, Rex; Tassiulas, Leandros. Submitted/source date: 2024/03/07. Job `BLAD-2200-20260817-2C1A830E`; item `BLAD-2200-20260817-2C1A830E-P04`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Building on the success of text-to-image diffusion models (DPMs), image editing has emerged as a crucial application for …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Building on the success of text-to-image diffusion models (DPMs), image editing has emerged as a crucial application for …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: control, disentangled, editing, item | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies control, disentangled, editing. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around control, disentangled, editing. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Building on the success of text-to-image diffusion models (DPMs), image editing has emerged as a crucial application for …”. The full-paper rendering contains 50 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Building on the success of text-to-image diffusion models (DPMs), image editing has emerged as a crucial application for …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Building on the success of text-to-image diffusion models (DPMs), image editing has emerged as a crucial application for …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving control, disentangled, editing. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 1,930 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how control, disentangled, editing, item connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: control, disentangled, editing, item.
...
|---|---|---|---|
| Disentangled Knowledge - DEP-E | Related DEP | Overlap: disentangled, item, control | `.lake-data/DEP-E/DEP-E-20260815-Disentangled Knowledge/disentangled_knowledge_manuscript.md` |
| Rethinking Residual - DEP-E | Related DEP | Overlap: editing, item, control | `.lake-data/DEP-E/DEP-E-20260815-Rethinking Residual/rethinking_residual_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2403.04880 | Metadata and abstract | 2026-08-17 | Metadata only |
| R2 | https://arxiv.org/html/2403.04880 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-17 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2403.04880 | Primary paper integrity | 2026-08-17 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260815-Disentangled Knowledge/disentangled_knowledge_manuscript.md` | Related synthesis: disentangled, item, control | 2026-08-17 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260815-Rethinking Residual/rethinking_residual_manuscript.md` | Related synthesis: editing, item, control | 2026-08-17 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260720-CFE2 Search Explain/cfe2_search_explanation_manuscript.md` | Related synthesis: editing | 2026-08-17 | Repository-relative |

## Appendix

- Uniform selected index: 1,930 of 75,964 units from 75,967 PDFs.
