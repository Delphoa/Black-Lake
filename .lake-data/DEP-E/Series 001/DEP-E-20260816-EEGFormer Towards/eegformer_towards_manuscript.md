---
title: "EEGFormer Towards - DEP-E"
generated_at: "2026-08-16 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of EEGFormer: Towards Transferable and Interpretable Large-Scale EEG Foundation Model."
...
primary_url: "https://arxiv.org/abs/2401.10278"
stable_identifier: "arXiv:2401.10278; DOI:10.48550/arXiv.2401.10278"
deployment_job_id: "BLAD-2200-20260816-7EAAB41B"
deployment_item_id: "BLAD-2200-20260816-7EAAB41B-P06"
...
# EEGFormer Towards - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2401.10278 | https://arxiv.org/abs/2401.10278 | Metadata only. | 2026-08-16 | Inspected |
| S2 | Full paper | Primary | HTML | 2401.10278 rendering | https://arxiv.org/html/2401.10278 | Verified local copy withheld. | 2026-08-16 | Inspected in full |
| S3 | PDF | Primary | PDF | 2401.10278 | https://arxiv.org/pdf/2401.10278 | Verified local copy withheld. | 2026-08-16 | Integrity checked and sampled |
| S4 | CanCal Towards Real-time - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260728-CanCal Towards Real-time/cancal_towards_real_time_manuscript.md` | Synthesis only. | 2026-08-16 | Inspected |
| S5 | RLHF-V Towards - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260730-RLHF-V Towards/rlhf_v_towards_manuscript.md` | Synthesis only. | 2026-08-16 | Inspected |
| S6 | Discriminative and - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260809-Discriminative and/discriminative_and_manuscript.md` | Synthesis only. | 2026-08-16 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260816-7EAAB41B-P06` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-16 | Verified |

Authors: Chen, Yuqi; Ren, Kan; Song, Kaitao; Wang, Yansen; Wang, Yifan; Li, Dongsheng; Qiu, Lili. Submitted/source date: 2024/01/11. Job `BLAD-2200-20260816-7EAAB41B`; item `BLAD-2200-20260816-7EAAB41B-P06`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: large-scale, towards | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies eeg, eegformer, foundation. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around eeg, eegformer, foundation. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 53 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving eeg, eegformer, foundation. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 66,277 of 75,964 units; duplicate exclusions 0; source-gate exclusions 1; reselections 1.
...
- The related DEPs show how large-scale, towards connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: large-scale, towards.
...
|---|---|---|---|
| CanCal Towards Real-time - DEP-E | Related DEP | Overlap: towards, large-scale | `.lake-data/DEP-E/DEP-E-20260728-CanCal Towards Real-time/cancal_towards_real_time_manuscript.md` |
...
| Discriminative and - DEP-E | Related DEP | Overlap: towards | `.lake-data/DEP-E/DEP-E-20260809-Discriminative and/discriminative_and_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2401.10278 | Metadata and abstract | 2026-08-16 | Metadata only |
| R2 | https://arxiv.org/html/2401.10278 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-16 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2401.10278 | Primary paper integrity | 2026-08-16 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260728-CanCal Towards Real-time/cancal_towards_real_time_manuscript.md` | Related synthesis: towards, large-scale | 2026-08-16 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260730-RLHF-V Towards/rlhf_v_towards_manuscript.md` | Related synthesis: towards | 2026-08-16 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260809-Discriminative and/discriminative_and_manuscript.md` | Related synthesis: towards | 2026-08-16 | Repository-relative |

## Appendix

- Uniform selected index: 66,277 of 75,964 units from 75,967 PDFs.
