---
title: "Fluid Antenna Index - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Fluid Antenna Index Modulation for MIMO Systems: Robust Transmission and Low-Complexity Detection."
...
primary_url: "https://arxiv.org/abs/2412.04877"
stable_identifier: "arXiv:2412.04877; DOI:10.48550/arXiv.2412.04877"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P22"
...
# Fluid Antenna Index - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2412.04877 | https://arxiv.org/abs/2412.04877 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2412.04877 rendering | https://arxiv.org/html/2412.04877 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2412.04877 | https://arxiv.org/pdf/2412.04877 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | Rank Optimization for - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260729-Rank Optimization for/rank_optimization_for_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P22` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Guo, Xinghao; Xu, Yin; He, Dazhi; Zhang, Cixiao; Hong, Hanjiang; Wong, Kai-Kit; Zhang, Wenjun; Wu, Yiyan. Submitted/source date: 2024/12/06. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P22`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: antenna, detection, index, low-complexity, mimo | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies antenna, detection, fluid. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around antenna, detection, fluid. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving antenna, detection, fluid. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 46,791 of 75,964 units; duplicate exclusions 0; focus exclusions 10; source-gate exclusions 0; reselections 10.
...
- The related DEPs show how antenna, detection, index, low-complexity, mimo connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: antenna, detection, index, low-complexity, mimo.
...
|---|---|---|---|
| Low-Complexity - DEP-E | Related DEP | Overlap: low-complexity, mimo, antenna, systems, detection | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` |
| Compressed CSI Feedback - DEP-E | Related DEP | Overlap: mimo, detection, index | `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback/compressed_csi_feedback_manuscript.md` |
| Rank Optimization for - DEP-E | Related DEP | Overlap: mimo, detection, index | `.lake-data/DEP-E/DEP-E-20260729-Rank Optimization for/rank_optimization_for_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2412.04877 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2412.04877 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2412.04877 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` | Related synthesis: low-complexity, mimo, antenna, systems, detection | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback/compressed_csi_feedback_manuscript.md` | Related synthesis: mimo, detection, index | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260729-Rank Optimization for/rank_optimization_for_manuscript.md` | Related synthesis: mimo, detection, index | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 46,791 of 75,964 units from 75,967 PDFs.
