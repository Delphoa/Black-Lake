---
title: "Adversarial Attacks on - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Adversarial Attacks on Online Learning to Rank with Click Feedback."
...
primary_url: "https://arxiv.org/abs/2305.17071"
stable_identifier: "arXiv:2305.17071; DOI:10.48550/arXiv.2305.17071"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P138"
...
# Adversarial Attacks on - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2305.17071 | https://arxiv.org/abs/2305.17071 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2305.17071 rendering | https://arxiv.org/html/2305.17071 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2305.17071 | https://arxiv.org/pdf/2305.17071 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | GADT Enhancing - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260731-GADT Enhancing/gadt_enhancing_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Learning Adversarial - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Learning Adversarial/learning_adversarial_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P138` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zuo, Jinhang; Zhang, Zhiyao; Wang, Zhiyong; Li, Shuai; Hajiesmaili, Mohammad; Wierman, Adam. Submitted/source date: 2023/05/26. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P138`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Online learning to rank (OLTR) is a sequential decision-making problem where a learning agent selects an ordered list …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Online learning to rank (OLTR) is a sequential decision-making problem where a learning agent selects an ordered list …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: adversarial, attacks, click, feedback, online | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies adversarial, attacks, click. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around adversarial, attacks, click. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Online learning to rank (OLTR) is a sequential decision-making problem where a learning agent selects an ordered list …”. The full-paper rendering contains 70 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Online learning to rank (OLTR) is a sequential decision-making problem where a learning agent selects an ordered list …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Online learning to rank (OLTR) has been extensively studied [ 1 , 2 , 3 , 4 , …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving adversarial, attacks, click. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 28,295 of 75,964 units; duplicate exclusions 1; focus exclusions 20; source-gate exclusions 0; reselections 21.
...
- The related DEPs show how adversarial, attacks, click, feedback, online connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: adversarial, attacks, click, feedback, online.
...
|---|---|---|---|
| GADT Enhancing - DEP-E | Related DEP | Overlap: attacks, adversarial | `.lake-data/DEP-E/DEP-E-20260731-GADT Enhancing/gadt_enhancing_manuscript.md` |
| FOLTR Unlearning - DEP-E | Related DEP | Overlap: rank, online, click, feedback | `.lake-data/DEP-E/DEP-E-20260804-Forget FOLTR/forget_foltr_manuscript.md` |
| Learning Adversarial - DEP-E | Related DEP | Overlap: feedback, adversarial | `.lake-data/DEP-E/DEP-E-20260818-Learning Adversarial/learning_adversarial_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2305.17071 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2305.17071 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2305.17071 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260731-GADT Enhancing/gadt_enhancing_manuscript.md` | Related synthesis: attacks, adversarial | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260804-Forget FOLTR/forget_foltr_manuscript.md` | Related synthesis: rank, online, click, feedback | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Learning Adversarial/learning_adversarial_manuscript.md` | Related synthesis: feedback, adversarial | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 28,295 of 75,964 units from 75,967 PDFs.
