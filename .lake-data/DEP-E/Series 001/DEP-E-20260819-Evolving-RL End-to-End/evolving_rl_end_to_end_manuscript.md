---
title: "Evolving-RL End-to-End - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Evolving-RL: End-to-End Optimization of Experience-Driven Self-Evolving Capability within Agents."
...
primary_url: "https://arxiv.org/abs/2605.10663"
stable_identifier: "arXiv:2605.10663; DOI:10.48550/arXiv.2605.10663"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P418"
...
# Evolving-RL End-to-End - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2605.10663 | https://arxiv.org/abs/2605.10663 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2605.10663 rendering | https://arxiv.org/html/2605.10663 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2605.10663 | https://arxiv.org/pdf/2605.10663 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Rethinking Memory - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Rethinking Memory/rethinking_memory_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | DeepPlanner Scaling - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-DeepPlanner Scaling/deepplanner_scaling_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P418` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Fan, Zhiyuan; Jin, Wenwei; Zhang, Feng; Li, Bin; Dong, Yihong; Hu, Yao; Li, Jiawei. Submitted/source date: 2026/05/11. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P418`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: agents, capability, end-to-end, optimization, self-evolving | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies agents, capability, end-to-end. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around agents, capability, end-to-end. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Have a free development cycle? Help support accessibility at arXiv! Our collaborators at LaTeXML maintain a list of …”. The full-paper rendering contains 85 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving agents, capability, end-to-end. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 64,275 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how agents, capability, end-to-end, optimization, self-evolving connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: agents, capability, end-to-end, optimization, self-evolving.
...
|---|---|---|---|
| Rethinking Memory - DEP-E | Related DEP | Overlap: self-evolving, agents | `.lake-data/DEP-E/DEP-E-20260819-Rethinking Memory/rethinking_memory_manuscript.md` |
| ARPO End-to-End Policy - DEP-E | Related DEP | Overlap: agents, end-to-end, optimization | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` |
| DeepPlanner Scaling - DEP-E | Related DEP | Overlap: capability, agents | `.lake-data/DEP-E/DEP-E-20260818-DeepPlanner Scaling/deepplanner_scaling_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2605.10663 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2605.10663 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2605.10663 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Rethinking Memory/rethinking_memory_manuscript.md` | Related synthesis: self-evolving, agents | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` | Related synthesis: agents, end-to-end, optimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-DeepPlanner Scaling/deepplanner_scaling_manuscript.md` | Related synthesis: capability, agents | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 64,275 of 75,964 units from 75,967 PDFs.
