---
title: "Analysis and Optimi 02227 - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Analysis and Optimization of Tail-Biting Spatially Coupled Protograph LDPC Codes for BICM-ID Systems."
...
primary_url: "https://arxiv.org/abs/1911.02227"
stable_identifier: "arXiv:1911.02227; DOI:10.1109/TVT.2019.2949600"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P236"
...
# Analysis and Optimi 02227 - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1911.02227 | https://arxiv.org/abs/1911.02227 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1911.02227 rendering | https://arxiv.org/html/1911.02227 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1911.02227 | https://arxiv.org/pdf/1911.02227 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Irregular Clipped SR - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260711-Irregular Clipped SR/irregular_clipped_sr_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | A Coupled Optimization - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A Coupled Optimization/a_coupled_optimization_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Theoretical and Empirical - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Theoretical and Empirical/theoretical_and_empirical_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P236` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Yang, Zhaojie; Fang, Yi; Zhang, Guohua; Lau, Francis C. M.; Mumtaz, Shahid; da Costa, Daniel B.. Submitted/source date: 2019/11/06. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P236`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “As a typical example of bandwidth-efficient techniques, bit-interleaved coded modulation with iterative decoding (BICM-ID) provides desirable spectral efficiencies …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “As a typical example of bandwidth-efficient techniques, bit-interleaved coded modulation with iterative decoding (BICM-ID) provides desirable spectral efficiencies …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: codes, coupled, optimization, spatially, systems | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies bicm-id, codes, coupled. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around bicm-id, codes, coupled. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “As a typical example of bandwidth-efficient techniques, bit-interleaved coded modulation with iterative decoding (BICM-ID) provides desirable spectral efficiencies …”. The full-paper rendering contains 60 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “As a typical example of bandwidth-efficient techniques, bit-interleaved coded modulation with iterative decoding (BICM-ID) provides desirable spectral efficiencies …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “As a type of bandwidth-efficient coded modulation techniques, bit-interleaved coded modulation (BICM) has attracted a significant amount of …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving bicm-id, codes, coupled. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 10,107 of 75,964 units; duplicate exclusions 1; focus exclusions 0; source-gate exclusions 0; reselections 1.
...
- The related DEPs show how codes, coupled, optimization, spatially, systems connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: codes, coupled, optimization, spatially, systems.
...
|---|---|---|---|
| Irregular Clipped SR - DEP-E | Related DEP | Overlap: codes, spatially, coupled, optimization, systems | `.lake-data/DEP-E/DEP-E-20260711-Irregular Clipped SR/irregular_clipped_sr_manuscript.md` |
| A Coupled Optimization - DEP-E | Related DEP | Overlap: coupled, optimization, systems | `.lake-data/DEP-E/DEP-E-20260819-A Coupled Optimization/a_coupled_optimization_manuscript.md` |
| Theoretical and Empirical - DEP-E | Related DEP | Overlap: codes, systems | `.lake-data/DEP-E/DEP-E-20260819-Theoretical and Empirical/theoretical_and_empirical_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1911.02227 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1911.02227 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1911.02227 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260711-Irregular Clipped SR/irregular_clipped_sr_manuscript.md` | Related synthesis: codes, spatially, coupled, optimization, systems | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-A Coupled Optimization/a_coupled_optimization_manuscript.md` | Related synthesis: coupled, optimization, systems | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Theoretical and Empirical/theoretical_and_empirical_manuscript.md` | Related synthesis: codes, systems | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 10,107 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 1; focus exclusions: 0; source-gate exclusions: 0; reselections: 1; 24-hour cutoff: 2026-08-18.
