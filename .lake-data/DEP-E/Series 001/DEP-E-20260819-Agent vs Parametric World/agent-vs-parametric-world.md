---
title: "Agent vs Parametric World - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Agent vs. Parametric World Models: Hybrid Planning for Reliable Language Agents"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260630-Tech Intel 1103"
selection_record: "117 candidates; 37 excluded; 80 eligible; draw 1139220649; zero-based index 9"
expansion_record: "10 retained public locators; draw 2463088510; zero-based index 0"
...
# Agent vs Parametric World - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260630-Tech Intel 1103 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260630-Tech%20Intel%201103/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-06-30_1103.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260630-Tech%20Intel%201103/daily_research_findings_2026-06-30_1103.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | Agent vs. Parametric World Models: Hybrid Planning for Reliable Language Agents | Selected supporting source | arXiv record | 2606.27806 | https://arxiv.org/abs/2606.27806v3 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: Agent vs. Parametric World Models: Hybrid Planning for Reliable Language Agents
- Authors or producing organization: Xinyuan Song; Zekun Cai
- Source platform: arXiv
- Publication date: 2026-06-26
- Revision/version date: 2026-07-05
- Stable identifier: 2606.27806
- Categories: cs.AI
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260630-Tech%20Intel%201103/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260630-Tech%20Intel%201103/daily_research_findings_2026-06-30_1103.md | Deposited source synthesis | ** The paper introduces Agent-Native Immune System (ANIS), a runtime architecture intended to detect, localize, and mitigate prompt injection, tool misuse, data exfiltration, and malicious agent behavior while preserving agent operation. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2606.27806v3 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through Agent vs. Parametric World Models: Hybrid Planning for Reliable Language Agents. The deposited source package reports that ** The paper introduces Agent-Native Immune System (ANIS), a runtime architecture intended to detect, localize, and mitigate prompt injection, tool misuse, data exfiltration, and malicious agent behavior while preserving agent operation. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** Agentic systems need defenses that understand agent state, tool calls, memory, and inter-agent actions rather than treating attacks as ordinary text-classification problems. ANIS is directly relevant to CCB/CCA pipelines that may rely on autonomous source-processing agents. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** Agentic systems need defenses that understand agent state, tool calls, memory, and inter-agent actions rather than treating attacks as ordinary text-classification problems. ANIS is directly relevant to CCB/CCA pipelines that may rely on autonomous source-processing agents.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** The paper introduces Agent-Native Immune System (ANIS), a runtime architecture intended to detect, localize, and mitigate prompt injection, tool misuse, data exfiltration, and malicious agent behavior while preserving agent operation. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is Agent vs. Parametric World Models: Hybrid Planning for Reliable Language Agents, credited to Xinyuan Song; Zekun Cai. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** Agentic systems need defenses that understand agent state, tool calls, memory, and inter-agent actions rather than treating attacks as ordinary text-classification problems. ANIS is directly relevant to CCB/CCA pipelines that may rely on autonomous source-processing agents. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260630-Tech Intel 1103 as a schema-complete DEP-E research artifact.
...
### New in this pass: Agent vs. Parametric World Models: Hybrid Planning for Reliable Language Agents

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [Agent vs. Parametric World Models: Hybrid Planning for Reliable Language Agents](https://arxiv.org/abs/2606.27806v3) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |
...
| https://arxiv.org/abs/2606.28277 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2606.28279 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2606.28179 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260630-Tech%20Intel%201103/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260630-Tech%20Intel%201103/daily_research_findings_2026-06-30_1103.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2606.27806v3 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 36 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 37; eligible count 80.
- DEP draw: accepted UInt32 1139220649; rejection limit 4294967280; attempts 1; zero-based index 9.
- Supporting draw: pool 10; accepted UInt32 2463088510; rejection limit 4294967290; attempts 1; zero-based index 0.
