---
title: "Back to the Future - DEP-E"
generated_at: "2026-08-05 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Back to the Future! Studying Data Cleanness in Defects4J and its Impact on Fault Localization."
...
primary_url: "https://arxiv.org/abs/2310.19139"
stable_identifier: "arXiv:2310.19139; DOI:10.48550/arXiv.2310.19139"
deployment_job_id: "BLAD-2200-20260805-6C10E207"
deployment_item_id: "BLAD-2200-20260805-6C10E207-P05"
...
# Back to the Future - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2310.19139 | https://arxiv.org/abs/2310.19139 | Metadata only. | 2026-08-05 | Inspected |
| S2 | Full paper | Primary | HTML | 2310.19139 rendering | https://arxiv.org/html/2310.19139 | Verified local copy withheld. | 2026-08-05 | Inspected in full |
| S3 | PDF | Primary | PDF | 2310.19139 | https://arxiv.org/pdf/2310.19139 | Verified local copy withheld. | 2026-08-05 | Integrity checked and sampled |
| S4 | Document Fraud LLM - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM/document_fraud_llm_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S5 | iKalibr Calibration - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260714-iKalibr Calibration/ikalibr_calibration_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S6 | Smart Coverage Goals - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260805-6C10E207-P05` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-05 | Verified |

Authors: Rafi, Md Nakhla; Chen, An Ran; Chen, Tse-Hsun; Wang, Shaohua. Submitted/source date: 2023/10/29. Job `BLAD-2200-20260805-6C10E207`; item `BLAD-2200-20260805-6C10E207-P05`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Paper Organization. Section 2 discusses the background and motivation of this study. Section 3 presents our studied dataset …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “For software testing research, Defects4J stands out as the primary benchmark dataset, offering a controlled environment to study …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: back, defects4j, fault, future, impact | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies back, cleanness, defects4j. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around back, cleanness, defects4j. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Paper Organization. Section 2 discusses the background and motivation of this study. Section 3 presents our studied dataset …”. The full-paper rendering contains 33 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “For software testing research, Defects4J stands out as the primary benchmark dataset, offering a controlled environment to study …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “For software testing research, Defects4J stands out as the primary benchmark dataset, offering a controlled environment to study …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving back, cleanness, defects4j. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 47,266 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how back, defects4j, fault, future, impact connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: back, defects4j, fault, future, impact.
...
|---|---|---|---|
| Document Fraud LLM - DEP-E | Related DEP | Overlap: studying, impact, localization, future, its | `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM/document_fraud_llm_manuscript.md` |
| iKalibr Calibration - DEP-E | Related DEP | Overlap: fault, back, impact, future, its | `.lake-data/DEP-E/DEP-E-20260714-iKalibr Calibration/ikalibr_calibration_manuscript.md` |
| Smart Coverage Goals - DEP-E | Related DEP | Overlap: defects4j, fault, future, its | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2310.19139 | Metadata and abstract | 2026-08-05 | Metadata only |
| R2 | https://arxiv.org/html/2310.19139 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-05 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2310.19139 | Primary paper integrity | 2026-08-05 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260715-Document Fraud LLM/document_fraud_llm_manuscript.md` | Related synthesis: studying, impact, localization, future, its | 2026-08-05 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260714-iKalibr Calibration/ikalibr_calibration_manuscript.md` | Related synthesis: fault, back, impact, future, its | 2026-08-05 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260717-Smart Coverage Goals/smart_coverage_goals_manuscript.md` | Related synthesis: defects4j, fault, future, its | 2026-08-05 | Repository-relative |

## Appendix

- Uniform selected index: 47,266 of 75,957 units from 75,960 PDFs.
