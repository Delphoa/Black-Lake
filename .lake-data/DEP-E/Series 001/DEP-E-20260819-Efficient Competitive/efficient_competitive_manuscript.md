---
title: "Efficient Competitive - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Efficient Competitive Self-Play Policy Optimization."
...
primary_url: "https://arxiv.org/abs/2009.06086"
stable_identifier: "arXiv:2009.06086; DOI:10.48550/arXiv.2009.06086"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P286"
...
# Efficient Competitive - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2009.06086 | https://arxiv.org/abs/2009.06086 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2009.06086 rendering | https://arxiv.org/html/2009.06086 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2009.06086 | https://arxiv.org/pdf/2009.06086 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Absolute Zero Reinforced - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Absolute Zero Reinforced/absolute_zero_reinforced_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P286` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhong, Yuanyi; Zhou, Yuan; Peng, Jian. Submitted/source date: 2020/09/13. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P286`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Reinforcement learning from self-play has recently reported many successes. Self-play, where the agents compete with themselves, is often …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Reinforcement learning from self-play has recently reported many successes. Self-play, where the agents compete with themselves, is often …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: optimization, policy, self-play | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies competitive, optimization, policy. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around competitive, optimization, policy. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Reinforcement learning from self-play has recently reported many successes. Self-play, where the agents compete with themselves, is often …”. The full-paper rendering contains 77 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Reinforcement learning from self-play has recently reported many successes. Self-play, where the agents compete with themselves, is often …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Reinforcement learning from self-play has recently reported many successes. Self-play, where the agents compete with themselves, is often …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving competitive, optimization, policy. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 8,631 of 75,964 units; duplicate exclusions 1; focus exclusions 10; source-gate exclusions 0; reselections 11.
...
- The related DEPs show how optimization, policy, self-play connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: optimization, policy, self-play.
...
|---|---|---|---|
| Absolute Zero Reinforced - DEP-E | Related DEP | Overlap: self-play | `.lake-data/DEP-E/DEP-E-20260818-Absolute Zero Reinforced/absolute_zero_reinforced_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2009.06086 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2009.06086 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2009.06086 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Absolute Zero Reinforced/absolute_zero_reinforced_manuscript.md` | Related synthesis: self-play | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-A Policy Optimization/a_policy_optimization_manuscript.md` | Related synthesis: policy, optimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-Learning adaptive/learning_adaptive_manuscript.md` | Related synthesis: policy, optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 8,631 of 75,964 units from 75,967 PDFs.
