---
title: "Computational Protein - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Computational Protein Design Using AND/OR Branch-and-Bound Search."
...
primary_url: "https://arxiv.org/abs/1412.3138"
stable_identifier: "arXiv:1412.3138; DOI:10.48550/arXiv.1412.3138"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P90"
...
# Computational Protein - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1412.3138 | https://arxiv.org/abs/1412.3138 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 1412.3138 rendering | https://arxiv.org/html/1412.3138 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 1412.3138 | https://arxiv.org/pdf/1412.3138 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | PTransIPs Protein PLM - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260801-PTransIPs Protein PLM/ptransips_protein_plm_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Calibrated Dataset - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Calibrated Dataset/calibrated_dataset_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P90` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhou, Yichao; Wu, Yuexin; Zeng, Jianyang. Submitted/source date: 2014/12/08. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P90`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: computational, design, protein, search | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies branch-and-bound, computational, design. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around branch-and-bound, computational, design. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Have a free development cycle? Help support accessibility at arXiv! Our collaborators at LaTeXML maintain a list of …”. The full-paper rendering contains 41 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving branch-and-bound, computational, design. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 4,638 of 75,964 units; duplicate exclusions 0; focus exclusions 1; source-gate exclusions 0; reselections 1.
...
- The related DEPs show how computational, design, protein, search connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: computational, design, protein, search.
...
|---|---|---|---|
| PTransIPs Protein PLM - DEP-E | Related DEP | Overlap: protein, computational, design | `.lake-data/DEP-E/DEP-E-20260801-PTransIPs Protein PLM/ptransips_protein_plm_manuscript.md` |
| Calibrated Dataset - DEP-E | Related DEP | Overlap: search, computational, design | `.lake-data/DEP-E/DEP-E-20260819-Calibrated Dataset/calibrated_dataset_manuscript.md` |
| RL4RLA Teaching ML to - DEP-E | Related DEP | Overlap: search, design | `.lake-data/DEP-E/DEP-E-20260818-RL4RLA Teaching ML to/rl4rla_teaching_ml_to_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1412.3138 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/1412.3138 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1412.3138 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260801-PTransIPs Protein PLM/ptransips_protein_plm_manuscript.md` | Related synthesis: protein, computational, design | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Calibrated Dataset/calibrated_dataset_manuscript.md` | Related synthesis: search, computational, design | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260818-RL4RLA Teaching ML to/rl4rla_teaching_ml_to_manuscript.md` | Related synthesis: search, design | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 4,638 of 75,964 units from 75,967 PDFs.
