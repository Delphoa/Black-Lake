---
title: "Bias Behind the Wheel - DEP-E"
generated_at: "2026-08-14 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Bias Behind the Wheel: Fairness Testing of Autonomous Driving Systems."
...
primary_url: "https://arxiv.org/abs/2308.02935"
stable_identifier: "arXiv:2308.02935; DOI:10.48550/arXiv.2308.02935"
deployment_job_id: "BLAD-2200-20260814-24737ACA"
deployment_item_id: "BLAD-2200-20260814-24737ACA-P01"
...
# Bias Behind the Wheel - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2308.02935 | https://arxiv.org/abs/2308.02935 | Metadata only. | 2026-08-14 | Inspected |
| S2 | Full paper | Primary | HTML | 2308.02935 rendering | https://arxiv.org/html/2308.02935 | Verified local copy withheld. | 2026-08-14 | Inspected in full |
| S3 | PDF | Primary | PDF | 2308.02935 | https://arxiv.org/pdf/2308.02935 | Verified local copy withheld. | 2026-08-14 | Integrity checked and sampled |
| S4 | Stable Diffusion Depth - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260718-Stable Diffusion Depth/stable_diffusion_depth_manuscript.md` | Synthesis only. | 2026-08-14 | Inspected |
| S5 | ADReFT Adaptive Decision - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-ADReFT Adaptive Decision/adreft_adaptive_decision_manuscript.md` | Synthesis only. | 2026-08-14 | Inspected |
| S6 | Light the Night A - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260805-Light the Night A/light_the_night_a_manuscript.md` | Synthesis only. | 2026-08-14 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260814-24737ACA-P01` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-14 | Verified |

Authors: Li, Xinyue; Chen, Zhenpeng; Zhang, Jie M.; Sarro, Federica; Zhang, Ying; Liu, Xuanzhe. Submitted/source date: 2023/08/05. Job `BLAD-2200-20260814-24737ACA`; item `BLAD-2200-20260814-24737ACA-P01`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Extensive research efforts have been devoted to the testing of autonomous driving systems. For example, Tian et al. …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “This paper conducts fairness testing of automated pedestrian detection, a crucial but under-explored issue in autonomous driving systems. …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: autonomous, behind, bias, driving, systems | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies autonomous, behind, bias. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around autonomous, behind, bias. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Extensive research efforts have been devoted to the testing of autonomous driving systems. For example, Tian et al. …”. The full-paper rendering contains 77 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “This paper conducts fairness testing of automated pedestrian detection, a crucial but under-explored issue in autonomous driving systems. …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “This paper conducts fairness testing of automated pedestrian detection, a crucial but under-explored issue in autonomous driving systems. …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving autonomous, behind, bias. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 68,864 of 75,964 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how autonomous, behind, bias, driving, systems connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: autonomous, behind, bias, driving, systems.
...
|---|---|---|---|
| Stable Diffusion Depth - DEP-E | Related DEP | Overlap: driving, behind, bias, systems, autonomous | `.lake-data/DEP-E/DEP-E-20260718-Stable Diffusion Depth/stable_diffusion_depth_manuscript.md` |
| ADReFT Adaptive Decision - DEP-E | Related DEP | Overlap: driving, autonomous, systems, testing | `.lake-data/DEP-E/DEP-E-20260803-ADReFT Adaptive Decision/adreft_adaptive_decision_manuscript.md` |
| Light the Night A - DEP-E | Related DEP | Overlap: driving, autonomous, systems, testing | `.lake-data/DEP-E/DEP-E-20260805-Light the Night A/light_the_night_a_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2308.02935 | Metadata and abstract | 2026-08-14 | Metadata only |
| R2 | https://arxiv.org/html/2308.02935 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-14 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2308.02935 | Primary paper integrity | 2026-08-14 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260718-Stable Diffusion Depth/stable_diffusion_depth_manuscript.md` | Related synthesis: driving, behind, bias, systems, autonomous | 2026-08-14 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260803-ADReFT Adaptive Decision/adreft_adaptive_decision_manuscript.md` | Related synthesis: driving, autonomous, systems, testing | 2026-08-14 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260805-Light the Night A/light_the_night_a_manuscript.md` | Related synthesis: driving, autonomous, systems, testing | 2026-08-14 | Repository-relative |

## Appendix

- Uniform selected index: 68,864 of 75,964 units from 75,967 PDFs.
