---
title: "Bidirectional Learning - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Bidirectional Learning for Offline Infinite-width Model-based Optimization."
...
primary_url: "https://arxiv.org/abs/2209.07507"
stable_identifier: "arXiv:2209.07507; DOI:10.48550/arXiv.2209.07507"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P107"
...
# Bidirectional Learning - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2209.07507 | https://arxiv.org/abs/2209.07507 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2209.07507 rendering | https://arxiv.org/html/2209.07507 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2209.07507 | https://arxiv.org/pdf/2209.07507 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Offline Model-Based - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Offline Model-Based/offline_model_based_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Mosaic Safety - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260709-Mosaic Safety/mosaic_safety_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | RawBMamba Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260801-RawBMamba/rawbmamba_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P107` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Chen, Can; Zhang, Yingxue; Fu, Jie; Liu, Xue; Coates, Mark. Submitted/source date: 2022/09/15. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P107`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In offline model-based optimization, we strive to maximize a black-box objective function by only leveraging a static dataset …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In offline model-based optimization, we strive to maximize a black-box objective function by only leveraging a static dataset …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: bidirectional, model-based, offline, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies bidirectional, infinite-width, model-based. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around bidirectional, infinite-width, model-based. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In offline model-based optimization, we strive to maximize a black-box objective function by only leveraging a static dataset …”. The full-paper rendering contains 68 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In offline model-based optimization, we strive to maximize a black-box objective function by only leveraging a static dataset …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Designing a new object or entity with desired properties is a fundamental problem in science and engineering [ …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving bidirectional, infinite-width, model-based. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 72,459 of 75,964 units; duplicate exclusions 2; focus exclusions 21; source-gate exclusions 0; reselections 23.
...
- The related DEPs show how bidirectional, model-based, offline, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: bidirectional, model-based, offline, optimization.
...
| RawBMamba Review - DEP-E | Related DEP | Overlap: bidirectional, optimization | `.lake-data/DEP-E/DEP-E-20260801-RawBMamba/rawbmamba_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2209.07507 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2209.07507 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2209.07507 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Offline Model-Based/offline_model_based_manuscript.md` | Related synthesis: model-based, optimization, offline | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260709-Mosaic Safety/mosaic_safety_manuscript.md` | Related synthesis: model-based, optimization, offline | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260801-RawBMamba/rawbmamba_manuscript.md` | Related synthesis: bidirectional, optimization | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 72,459 of 75,964 units from 75,967 PDFs.
