---
title: "EvolveNet Collaborative - DEP-E"
generated_at: "2026-08-18T20:49:54Z"
run_date: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "EvolveNet: Collaborative Harness Evolution for Agent Self-Improvement"
...
source_dep: "Black-Lake-Data/.lake-data/DEP-20260806-Tech Intel 1303"
selection_record: "117 candidates; 16 excluded; 101 eligible; draw 4275651984; zero-based index 97"
expansion_record: "10 retained public locators; draw 3199142124; zero-based index 4"
...
# EvolveNet Collaborative - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | Selected source DEP README | Source package boundary | Markdown | DEP-20260806-Tech Intel 1303 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%201303/README.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S2 | Deposited source artifact | Source synthesis | Markdown | daily_research_findings_2026-08-06_1303.md | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%201303/daily_research_findings_2026-08-06_1303.md | Repository evidence; public URL | 2026-08-19 | Inspected |
| S3 | EvolveNet: Collaborative Harness Evolution for Agent Self-Improvement | Selected supporting source | arXiv record | 2608.04968 | https://arxiv.org/abs/2608.04968v1 | Metadata and source-package claims only | 2026-08-19 | Canonical arXiv Atom record inspected |

- Paper/work title: EvolveNet: Collaborative Harness Evolution for Agent Self-Improvement
- Authors or producing organization: Jun Nie; Yonggang Zhang; Qianshu Cai; Yiu-ming Cheung; Xinmei Tian; Bo Han
- Source platform: arXiv
- Publication date: 2026-08-05
- Revision/version date: 2026-08-05
- Stable identifier: 2608.04968
- Categories: cs.LG
...
|---|---|---|---|---|---|---|
| E1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%201303/README.md | Source DEP README | DEP identity, inventory, attribution, and package boundaries | Source package identity | High | Repository metadata does not independently validate linked claims. |
| E2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%201303/daily_research_findings_2026-08-06_1303.md | Deposited source synthesis | ** Argus is a persistent runtime in which Manager, Planner, Engineer, and Reviewer execute bounded missions over durable project state. It separates stable user intent from operational objectives, constraints, and verification criteria, and admits memories, skills, procedures, verifiers, routing decisions, and rejected routes only after role-owned review and, when available, task-native verification. Across seven GPT-5.5 benchmark arenas, the authors report about 78% on SWE-Bench Pro versus 59% for Direct Copilot at 1.41× the aggregate tokens; mature waves use 21% fewer solve-input tokens and 15% less active workflow time, with recorded verifier recoveries and strict review-loop rescues. | Source-package claim and selected-thread context | Medium | Derived source synthesis; not an independent reproduction. |
| E3 | https://arxiv.org/abs/2608.04968v1 | Canonical arXiv metadata | Title, identity, version/date metadata, authors or credited organization, and availability | Primary source identity | High | No code, data, model, benchmark, or experiment was executed. |

## Executive Summary

This artifact expands the selected DEP through EvolveNet: Collaborative Harness Evolution for Agent Self-Improvement. The deposited source package reports that ** Argus is a persistent runtime in which Manager, Planner, Engineer, and Reviewer execute bounded missions over durable project state. It separates stable user intent from operational objectives, constraints, and verification criteria, and admits memories, skills, procedures, verifiers, routing decisions, and rejected routes only after role-owned review and, when available, task-native verification. Across seven GPT-5.5 benchmark arenas, the authors report about 78% on SWE-Bench Pro versus 59% for Direct Copilot at 1.41× the aggregate tokens; mature waves use 21% fewer solve-input tokens and 15% less active workflow time, with recorded verifier recoveries and strict review-loop rescues. This is a source-package claim tied to E2, not an independently reproduced result.

The practical relevance is that ** This is a concrete design for self-improvement without changing model weights: persistent state and control policy become the adaptation substrate. The evidence-gated admission of both successful and rejected routes gives agent memory a reviewable lifecycle, although the benchmark and efficiency figures remain source-reported preprint results. Canonical source identity and availability were inspected (E3), while implementation, data, model, benchmark, and production behavior remain untested. Confidence is therefore high for provenance, medium for the deposited synthesis, and low for claims that would require independent execution.

## Detailed Summary

### Problem context

The selected thread addresses a research or engineering decision represented in the source package as consequential for downstream systems. The package frames the motivation as follows: ** This is a concrete design for self-improvement without changing model weights: persistent state and control policy become the adaptation substrate. The evidence-gated admission of both successful and rejected routes gives agent memory a reviewable lifecycle, although the benchmark and efficiency figures remain source-reported preprint results.

### Source-reported contribution

The selected DEP summarizes the contribution this way: ** Argus is a persistent runtime in which Manager, Planner, Engineer, and Reviewer execute bounded missions over durable project state. It separates stable user intent from operational objectives, constraints, and verification criteria, and admits memories, skills, procedures, verifiers, routing decisions, and rejected routes only after role-owned review and, when available, task-native verification. Across seven GPT-5.5 benchmark arenas, the authors report about 78% on SWE-Bench Pro versus 59% for Direct Copilot at 1.41× the aggregate tokens; mature waves use 21% fewer solve-input tokens and 15% less active workflow time, with recorded verifier recoveries and strict review-loop rescues. The canonical record confirms the work's identity, credited authorship or organization, publication locator, and version/date metadata, but this review does not elevate the deposited summary into independently verified evidence.
...
| C2 | The selected supporting record is EvolveNet: Collaborative Harness Evolution for Agent Self-Improvement, credited to Jun Nie; Yonggang Zhang; Qianshu Cai; Yiu-ming Cheung; Xinmei Tian; Bo Han. | Source metadata | E3 | Canonical identity and availability were directly checked. | High |
| C3 | ** This is a concrete design for self-improvement without changing model weights: persistent state and control policy become the adaptation substrate. The evidence-gated admission of both successful and rejected routes gives agent memory a reviewable lifecycle, although the benchmark and efficiency figures remain source-reported preprint results. | Reviewer interpretation grounded in source package | E1-E3 | Useful as a research direction, not proof of deployment readiness. | Medium |

## Methodology

- **Research objective**: Preserve and expand one randomly selected supporting thread from DEP-20260806-Tech Intel 1303 as a schema-complete DEP-E research artifact.
...
### New in this pass: EvolveNet: Collaborative Harness Evolution for Agent Self-Improvement

| Item | Type | New evidence inspected | Relevance |
|---|---|---|---|
| [EvolveNet: Collaborative Harness Evolution for Agent Self-Improvement](https://arxiv.org/abs/2608.04968v1) | Primary arXiv record | Canonical identity, authorship or credited organization, version/date metadata, categories when available, and public availability | Expands the selected DEP through one cryptographically selected supporting thread. |

### Retained from the selected DEP

| Item | Type | Relevance |
|---|---|---|
| https://arxiv.org/abs/2608.05144 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2608.04830 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
...
| https://arxiv.org/abs/2608.04735 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |
| https://arxiv.org/abs/2608.05108 | Retained source-package context | Listed by the selected DEP; not re-opened as the expansion target in this pass. |

## Source References

| ID | Reference | Supports | Access date | Notes |
|---|---|---|---|---|
| R1 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%201303/README.md | E1 and selected DEP identity | 2026-08-19 | Live source DEP README inspected. |
| R2 | https://github.com/Delphoa-Labs/Black-Lake-Data/blob/main/.lake-data/Series/AA/AA/00/00/AA-AA00-0000/DEP-20260806-Tech%20Intel%201303/daily_research_findings_2026-08-06_1303.md | E2 and source-package synthesis | 2026-08-19 | Deposited artifact inspected; claims remain source-qualified. |
| R3 | https://arxiv.org/abs/2608.04968v1 | E3 and selected supporting-source identity | 2026-08-19 | Canonical arXiv Atom record inspected; no source payload redistributed. |
...
- Batch item: 15 of 50.
- Eligibility cutoff: 2026-08-17T20:49:54Z; candidate count 117; excluded count 16; eligible count 101.
- DEP draw: accepted UInt32 4275651984; rejection limit 4294967228; attempts 1; zero-based index 97.
- Supporting draw: pool 10; accepted UInt32 3199142124; rejection limit 4294967290; attempts 1; zero-based index 4.
