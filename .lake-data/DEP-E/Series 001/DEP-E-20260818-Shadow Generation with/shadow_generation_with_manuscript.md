---
title: "Shadow Generation with - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Shadow Generation with Decomposed Mask Prediction and Attentive Shadow Filling."
...
primary_url: "https://arxiv.org/abs/2306.17358"
stable_identifier: "arXiv:2306.17358; DOI:10.48550/arXiv.2306.17358"
deployment_job_id: "BLAD-2200-20260818-D85F5742"
deployment_item_id: "BLAD-2200-20260818-D85F5742-P28"
...
# Shadow Generation with - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2306.17358 | https://arxiv.org/abs/2306.17358 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2306.17358 rendering | https://arxiv.org/html/2306.17358 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2306.17358 | https://arxiv.org/pdf/2306.17358 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | Controlling Latent Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260721-Controlling Latent/controlling_latent_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | Mask Proposal Voting - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Mask Proposal Voting/mask_proposal_voting_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | Mixed-Interest CTR Transfer | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer/minet_ctr_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-D85F5742-P28` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Tao, Xinhao; Cao, Junyan; Hong, Yan; Niu, Li. Submitted/source date: 2023/06/30. Job `BLAD-2200-20260818-D85F5742`; item `BLAD-2200-20260818-D85F5742-P28`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “We propose a novel network DMASNet with decomposed mask prediction and attentive shadow filling.” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Image composition refers to inserting a foreground object into a background image to obtain a composite image. In …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: generation, mask, prediction, shadow | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies shadow, attentive, decomposed. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around shadow, attentive, decomposed. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “We propose a novel network DMASNet with decomposed mask prediction and attentive shadow filling.”. The full-paper rendering contains 51 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Image composition refers to inserting a foreground object into a background image to obtain a composite image. In …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Image composition refers to cutting out a foreground object and pasting it on another background image to acquire …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving shadow, attentive, decomposed. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 37,923 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how generation, mask, prediction, shadow connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: generation, mask, prediction, shadow.
...
|---|---|---|---|
| Controlling Latent Review - DEP-E | Related DEP | Overlap: shadow, generation | `.lake-data/DEP-E/DEP-E-20260721-Controlling Latent/controlling_latent_manuscript.md` |
| Mask Proposal Voting - DEP-E | Related DEP | Overlap: mask | `.lake-data/DEP-E/DEP-E-20260818-Mask Proposal Voting/mask_proposal_voting_manuscript.md` |
| Mixed-Interest CTR Transfer | Related DEP | Overlap: prediction, shadow | `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer/minet_ctr_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2306.17358 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2306.17358 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2306.17358 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260721-Controlling Latent/controlling_latent_manuscript.md` | Related synthesis: shadow, generation | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Mask Proposal Voting/mask_proposal_voting_manuscript.md` | Related synthesis: mask | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260719-MiNet CTR Transfer/minet_ctr_manuscript.md` | Related synthesis: prediction, shadow | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 37,923 of 75,964 units from 75,967 PDFs.
