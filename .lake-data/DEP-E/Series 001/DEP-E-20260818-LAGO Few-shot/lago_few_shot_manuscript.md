---
title: "LAGO Few-shot - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of LAGO: Few-shot Crosslingual Embedding Inversion Attacks via Language Similarity-Aware Graph Optimization."
...
primary_url: "https://arxiv.org/abs/2505.16008"
stable_identifier: "arXiv:2505.16008; DOI:10.48550/arXiv.2505.16008"
deployment_job_id: "BLAD-2200-20260818-BBEE0F31"
deployment_item_id: "BLAD-2200-20260818-BBEE0F31-P07"
...
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2505.16008 | https://arxiv.org/abs/2505.16008 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2505.16008 rendering | https://arxiv.org/html/2505.16008 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2505.16008 | https://arxiv.org/pdf/2505.16008 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
...
| S5 | Stealthy Jailbreak - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260804-Stealthy Jailbreak/stealthy_jailbreak_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S6 | Data-Free - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260812-Data-Free/data_free_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-BBEE0F31-P07` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Yu, Wenrui; Chen, Yiyi; Bjerva, Johannes; Kosta, Sokol; Li, Qiongxiu. Submitted/source date: 2025/05/21. Job `BLAD-2200-20260818-BBEE0F31`; item `BLAD-2200-20260818-BBEE0F31-P07`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: attacks, few-shot, graph, inversion, language | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies attacks, crosslingual, embedding. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around attacks, crosslingual, embedding. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving attacks, crosslingual, embedding. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 52,992 of 75,964 units; duplicate exclusions 0; focus exclusions 64; source-gate exclusions 6; reselections 70.
...
- The related DEPs show how attacks, few-shot, graph, inversion, language connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: attacks, few-shot, graph, inversion, language.
...
|---|---|---|---|
| NLP-AKG Few-Shot - DEP-E | Related DEP | Overlap: few-shot, graph, language | `.lake-data/DEP-E/DEP-E-20260802-NLP-AKG Few-Shot/nlp_akg_few_shot_manuscript.md` |
| Stealthy Jailbreak - DEP-E | Related DEP | Overlap: attacks, language | `.lake-data/DEP-E/DEP-E-20260804-Stealthy Jailbreak/stealthy_jailbreak_manuscript.md` |
| Data-Free - DEP-E | Related DEP | Overlap: inversion, language | `.lake-data/DEP-E/DEP-E-20260812-Data-Free/data_free_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2505.16008 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2505.16008 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2505.16008 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260802-NLP-AKG Few-Shot/nlp_akg_few_shot_manuscript.md` | Related synthesis: few-shot, graph, language | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260804-Stealthy Jailbreak/stealthy_jailbreak_manuscript.md` | Related synthesis: attacks, language | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260812-Data-Free/data_free_manuscript.md` | Related synthesis: inversion, language | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 52,992 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 0; focus exclusions: 64; source-gate exclusions: 6; reselections: 70; 24-hour cutoff: 2026-08-17.
