---
title: "Low-Complexity - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Low-Complexity Pareto-Optimal 3D Beamforming for the Full-Dimensional Multi-User Massive MIMO Downlink."
...
primary_url: "https://arxiv.org/abs/2302.09274"
stable_identifier: "arXiv:2302.09274; DOI:10.1109/TVT.2023.3245539"
deployment_job_id: "BLAD-2200-20260818-BBEE0F31"
deployment_item_id: "BLAD-2200-20260818-BBEE0F31-P02"
...
# Low-Complexity - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2302.09274 | https://arxiv.org/abs/2302.09274 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2302.09274 rendering | https://arxiv.org/html/2302.09274 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2302.09274 | https://arxiv.org/pdf/2302.09274 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | Compressed CSI Feedback - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback/compressed_csi_feedback_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S5 | Multi-Point ISAC - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-BBEE0F31-P02` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Zhu, W.; Tuan, H. D.; Dutkiewicz, E.; Fang, Y.; Hanzo, L.. Submitted/source date: 2023/02/18. Job `BLAD-2200-20260818-BBEE0F31`; item `BLAD-2200-20260818-BBEE0F31-P02`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “where 𝐰 1 , k a ∈ ℂ M \mathbf{w}^{a}_{1,k}\in\mathbb{C}^{M} and 𝐰 1 , k e ∈ ℂ …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Full-dimensional (FD) multi-user massive multiple-input multiple output (m-MIMO) systems employ large two-dimensional (2D) rectangular antenna arrays to control …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: beamforming, massive, mimo | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies beamforming, downlink, full-dimensional. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around beamforming, downlink, full-dimensional. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “where 𝐰 1 , k a ∈ ℂ M \mathbf{w}^{a}_{1,k}\in\mathbb{C}^{M} and 𝐰 1 , k e ∈ ℂ …”. The full-paper rendering contains 59 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Full-dimensional (FD) multi-user massive multiple-input multiple output (m-MIMO) systems employ large two-dimensional (2D) rectangular antenna arrays to control …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Subject to the sum transmit power constraint, the beamforming design aims for maximizing either the sum rate (SR) …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving beamforming, downlink, full-dimensional. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 10,403 of 75,964 units; duplicate exclusions 0; focus exclusions 9; source-gate exclusions 0; reselections 9.
...
- The related DEPs show how beamforming, massive, mimo connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: beamforming, massive, mimo.
...
|---|---|---|---|
| Compressed CSI Feedback - DEP-E | Related DEP | Overlap: mimo, massive | `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback/compressed_csi_feedback_manuscript.md` |
| Multi-Point ISAC - DEP-E | Related DEP | Overlap: beamforming | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` |
| Rank Optimization for - DEP-E | Related DEP | Overlap: mimo | `.lake-data/DEP-E/DEP-E-20260729-Rank Optimization for/rank_optimization_for_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2302.09274 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2302.09274 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2302.09274 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260726-Compressed CSI Feedback/compressed_csi_feedback_manuscript.md` | Related synthesis: mimo, massive | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Related synthesis: beamforming | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260729-Rank Optimization for/rank_optimization_for_manuscript.md` | Related synthesis: mimo | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 10,403 of 75,964 units from 75,967 PDFs.
