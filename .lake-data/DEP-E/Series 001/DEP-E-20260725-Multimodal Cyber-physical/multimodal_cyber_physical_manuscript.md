---
title: "Multimodal Cyber-physical - DEP-E"
generated_at: "2026-07-25 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Multimodal Cyber-physical Interaction in XR: Hybrid Doctoral Thesis Defense."
...
primary_url: "https://arxiv.org/abs/2603.15392"
stable_identifier: "arXiv:2603.15392; DOI:10.48550/arXiv.2603.15392"
deployment_job_id: "BLAD-2200-20260725-FF48EE13"
deployment_item_id: "BLAD-2200-20260725-FF48EE13-P05"
...
# Multimodal Cyber-physical - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2603.15392 | https://arxiv.org/abs/2603.15392 | Metadata only. | 2026-07-25 | Inspected |
| S2 | Full paper | Primary | HTML | 2603.15392 rendering | https://arxiv.org/html/2603.15392 | Verified local copy withheld. | 2026-07-25 | Inspected in full |
| S3 | PDF | Primary | PDF | 2603.15392 | https://arxiv.org/pdf/2603.15392 | Verified local copy withheld. | 2026-07-25 | Integrity checked and sampled |
| S4 | Spiking Pose Tracking - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Synthesis only. | 2026-07-25 | Inspected |
...
| S6 | Efficient FM Survey - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` | Synthesis only. | 2026-07-25 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260725-FF48EE13-P05` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-25 | Verified |

Authors: Alhilal, Ahmad; Lam, Kit Yung; Lee, Lik-Hang; Wang, Xuetong; Li, Sijia; Siekkinen, Matti; Braud, Tristan; Hui, Pan. Submitted/source date: 2026/03/16. Job `BLAD-2200-20260725-FF48EE13`; item `BLAD-2200-20260725-FF48EE13-P05`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Academic events, such as a doctoral thesis defense, are typically limited to either physical co-location or flat video …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Academic events, such as a doctoral thesis defense, are typically limited to either physical co-location or flat video …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: binary, detection, human, language, multimodal | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies defense, doctoral, hybrid. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around defense, doctoral, hybrid. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Academic events, such as a doctoral thesis defense, are typically limited to either physical co-location or flat video …”. The full-paper rendering contains 48 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Academic events, such as a doctoral thesis defense, are typically limited to either physical co-location or flat video …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Academic events, such as a doctoral thesis defense, are typically limited to either physical co-location or flat video …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving defense, doctoral, hybrid. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 27,130 of 75,778 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how binary, detection, human, language, multimodal connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: binary, detection, human, language, multimodal.
...
|---|---|---|---|
| Spiking Pose Tracking - DEP-E | Related DEP | Overlap: human, pose, tracking | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` |
| A Large Scale Study of - DEP-E | Related DEP | Overlap: binary, security, detection | `.lake-data/DEP-E/DEP-E-20260724-A Large Scale Study of/a_large_scale_study_of_manuscript.md` |
| Efficient FM Survey - DEP-E | Related DEP | Overlap: multimodal, language | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2603.15392 | Metadata and abstract | 2026-07-25 | Metadata only |
| R2 | https://arxiv.org/html/2603.15392 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-25 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2603.15392 | Primary paper integrity | 2026-07-25 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Related synthesis: human, pose, tracking | 2026-07-25 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260724-A Large Scale Study of/a_large_scale_study_of_manuscript.md` | Related synthesis: binary, security, detection | 2026-07-25 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` | Related synthesis: multimodal, language | 2026-07-25 | Repository-relative |

## Appendix

- Uniform selected index: 27,130 of 75,778 units from 75,781 PDFs.
