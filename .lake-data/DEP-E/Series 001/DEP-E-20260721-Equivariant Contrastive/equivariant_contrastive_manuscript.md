---
title: "Equivariant Contrastive Review - DEP-E"
generated_at: "2026-07-21 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Equivariant Contrastive Learning for Sequential Recommendation."
...
primary_url: "https://arxiv.org/abs/2211.05290"
stable_identifier: "arXiv:2211.05290; DOI:10.48550/arXiv.2211.05290"
deployment_job_id: "BLAD-2200-20260721-F7EDC854"
deployment_item_id: "BLAD-2200-20260721-F7EDC854-P04"
...
# Equivariant Contrastive Review - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2211.05290 | https://arxiv.org/abs/2211.05290 | Metadata only. | 2026-07-21 | Inspected |
| S2 | Full paper | Primary | HTML | 2211.05290 rendering | https://arxiv.org/html/2211.05290 | Verified local copy withheld. | 2026-07-21 | Inspected in full |
| S3 | PDF | Primary | PDF | 2211.05290 | https://arxiv.org/pdf/2211.05290 | Verified local copy withheld. | 2026-07-21 | Integrity checked |
| S4 | AV Emotion Fusion - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260713-AV Emotion Fusion/av_emotion_fusion_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S5 | Decentralized SSL Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-Decentralized SSL/decentralized_ssl_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S6 | Mosaic Safety - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260709-Mosaic Safety/mosaic_safety_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260721-F7EDC854-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-21 | Verified |

Authors: Zhou, Peilin; Gao, Jingqi; Xie, Yueqi; Ye, Qichen; Hua, Yining; Kim, Jae Boum; Wang, Shoujin; Kim, Sunghun. Submitted/source date: 2022/11/10. Job `BLAD-2200-20260721-F7EDC854`; item `BLAD-2200-20260721-F7EDC854-P04`.
...
| E2 | S2/S3 | Primary paper | Problem framing around sequential, behavior, equivariant | Research objective | High for transcription | Source framing is not independent validation |
| E3 | S2/S3 | Primary paper | Method and evaluation narrative associated with ECL-SR | Mechanism and author-reported results | Medium-high | Experiments were not rerun |
...
This paper studies sequential, behavior, equivariant and presents ECL-SR as its central contribution. The inspected full paper connects the method to contrastive, recommendation, augmentation and reports empirical or analytical support in its chosen setting. The review preserves those claims as source-reported evidence. It does not claim independent reproduction, current operational validity, or deployment readiness. The main downstream value is a versioned evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

The research object is *Equivariant Contrastive Learning for Sequential Recommendation*. Its problem framing concentrates on sequential, behavior, equivariant. The paper positions ECL-SR as a way to organize or improve the relevant mechanism and connects the proposal to contrastive, recommendation, augmentation.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a meaningful problem involving sequential, behavior, equivariant. | Author claim | E2 | Directly supported as source framing; practical importance depends on target context. | Medium-high |
| C2 | ECL-SR is the source's principal mechanism or contribution. | Source-supported mechanism | E3 | Supported by the inspected method narrative. | High for transcription |
...
2. **Frozen comparison harness:** evaluate ECL-SR and simple baselines under a versioned split manifest.
...
|---|---|---|---|
| AV Emotion Fusion - DEP-E | Related DEP | Related representation, evidence, or implementation lens | `.lake-data/DEP-E/DEP-E-20260713-AV Emotion Fusion/av_emotion_fusion_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2211.05290 | Metadata and abstract | 2026-07-21 | Metadata only |
| R2 | https://arxiv.org/html/2211.05290 | Full-paper method and evidence | 2026-07-21 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2211.05290 | Primary paper integrity | 2026-07-21 | Verified local copy withheld |
| R4 | https://doi.org/10.48550/arXiv.2211.05290 | Publisher identifier | 2026-07-21 | DOI locator |
| R5 | `.lake-data/DEP-E/DEP-E-20260713-AV Emotion Fusion/av_emotion_fusion_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260720-Decentralized SSL/decentralized_ssl_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |
| R7 | `.lake-data/DEP-E/DEP-E-20260709-Mosaic Safety/mosaic_safety_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |

## Appendix

Uniform selected index 53,468 of 75,776 units from 75,779 PDFs; duplicate exclusions 0; reselections 0. The complete-source gate passed after one bounded archive repair. Source documents and companion integrity records remain local; none was staged or uploaded.
