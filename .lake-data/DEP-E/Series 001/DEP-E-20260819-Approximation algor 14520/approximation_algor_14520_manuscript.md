---
title: "Approximation algor 14520 - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Approximation algorithms for $k$-submodular maximization subject to a knapsack constraint."
...
primary_url: "https://arxiv.org/abs/2306.14520"
stable_identifier: "arXiv:2306.14520; DOI:10.48550/arXiv.2306.14520"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P132"
...
# Approximation algor 14520 - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2306.14520 | https://arxiv.org/abs/2306.14520 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2306.14520 rendering | https://arxiv.org/html/2306.14520 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2306.14520 | https://arxiv.org/pdf/2306.14520 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Near-Tight Approximation - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Near-Tight Approximation/near_tight_approximation_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P132` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Xiao, Hao; Liu, Qian; Zhou, Yang; Li, Min. Submitted/source date: 2023/06/26. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P132`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In this paper, we study the problem of maximizing k k -submodular functions subject to a knapsack constraint. …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “When the objective function f f is monotone, a deterministic 1 2 ​ ( 1 − e − …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithms, approximation, knapsack, maximization, subject | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithms, approximation, constraint. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithms, approximation, constraint. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In this paper, we study the problem of maximizing k k -submodular functions subject to a knapsack constraint. …”. The full-paper rendering contains 25 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “When the objective function f f is monotone, a deterministic 1 2 ​ ( 1 − e − …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “As a generalization of submodular function, k k -submodular functions have many applications [ 1 , 2 , …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithms, approximation, constraint. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 20,503 of 75,964 units; duplicate exclusions 5; focus exclusions 17; source-gate exclusions 0; reselections 22.
...
- The related DEPs show how algorithms, approximation, knapsack, maximization, subject connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithms, approximation, knapsack, maximization, subject.
...
|---|---|---|---|
| Near-Tight Approximation - DEP-E | Related DEP | Overlap: knapsack, approximation, algorithms, subject | `.lake-data/DEP-E/DEP-E-20260819-Near-Tight Approximation/near_tight_approximation_manuscript.md` |
| Approximation Algorithms - DEP-E | Related DEP | Overlap: approximation, algorithms, subject | `.lake-data/DEP-E/DEP-E-20260819-Approximation Algorithms/approximation_algorithms_manuscript.md` |
| Online Learning with - DEP-E | Related DEP | Overlap: maximization, subject | `.lake-data/DEP-E/DEP-E-20260819-Online Learning with/online_learning_with_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2306.14520 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2306.14520 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2306.14520 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Near-Tight Approximation/near_tight_approximation_manuscript.md` | Related synthesis: knapsack, approximation, algorithms, subject | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Approximation Algorithms/approximation_algorithms_manuscript.md` | Related synthesis: approximation, algorithms, subject | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Online Learning with/online_learning_with_manuscript.md` | Related synthesis: maximization, subject | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 20,503 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 5; focus exclusions: 17; source-gate exclusions: 0; reselections: 22; 24-hour cutoff: 2026-08-18.
