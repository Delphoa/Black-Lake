---
title: "Distributional Successor - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Distributional Successor Features Enable Zero-Shot Policy Optimization."
...
primary_url: "https://arxiv.org/abs/2403.06328"
stable_identifier: "arXiv:2403.06328; DOI:10.48550/arXiv.2403.06328"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P413"
...
# Distributional Successor - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2403.06328 | https://arxiv.org/abs/2403.06328 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2403.06328 rendering | https://arxiv.org/html/2403.06328 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2403.06328 | https://arxiv.org/pdf/2403.06328 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Robust Zero-Shot - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Robust Zero-Shot/robust_zero_shot_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | DRIVE Distributional and - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-DRIVE Distributional and/drive_distributional_and_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Decision-Making under - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Decision-Making under/decision_making_under_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P413` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhu, Chuning; Wang, Xinqi; Han, Tyler; Du, Simon S.; Gupta, Abhishek. Submitted/source date: 2024/03/10. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P413`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: distributional, optimization, zero-shot | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies distributional, enable, features. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around distributional, enable, features. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving distributional, enable, features. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 7,566 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how distributional, optimization, zero-shot connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: distributional, optimization, zero-shot.
...
|---|---|---|---|
| Robust Zero-Shot - DEP-E | Related DEP | Overlap: zero-shot, optimization | `.lake-data/DEP-E/DEP-E-20260819-Robust Zero-Shot/robust_zero_shot_manuscript.md` |
| DRIVE Distributional and - DEP-E | Related DEP | Overlap: distributional | `.lake-data/DEP-E/DEP-E-20260819-DRIVE Distributional and/drive_distributional_and_manuscript.md` |
| Decision-Making under - DEP-E | Related DEP | Overlap: distributional | `.lake-data/DEP-E/DEP-E-20260819-Decision-Making under/decision_making_under_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2403.06328 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2403.06328 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2403.06328 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Robust Zero-Shot/robust_zero_shot_manuscript.md` | Related synthesis: zero-shot, optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-DRIVE Distributional and/drive_distributional_and_manuscript.md` | Related synthesis: distributional | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Decision-Making under/decision_making_under_manuscript.md` | Related synthesis: distributional | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 7,566 of 75,964 units from 75,967 PDFs.
