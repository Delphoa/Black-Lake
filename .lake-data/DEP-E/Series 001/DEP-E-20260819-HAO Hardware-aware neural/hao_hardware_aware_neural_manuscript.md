---
title: "HAO Hardware-aware neural - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of HAO: Hardware-aware neural Architecture Optimization for Efficient Inference."
...
primary_url: "https://arxiv.org/abs/2104.12766"
stable_identifier: "arXiv:2104.12766; DOI:10.48550/arXiv.2104.12766"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P114"
...
# HAO Hardware-aware neural - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2104.12766 | https://arxiv.org/abs/2104.12766 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2104.12766 rendering | https://arxiv.org/html/2104.12766 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2104.12766 | https://arxiv.org/pdf/2104.12766 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P114` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Dong, Zhen; Gao, Yizhao; Huang, Qijing; Wawrzynek, John; So, Hayden K. H.; Keutzer, Kurt. Submitted/source date: 2021/04/26. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P114`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: architecture, inference, neural, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies architecture, hao, hardware-aware. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around architecture, hao, hardware-aware. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving architecture, hao, hardware-aware. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 7,570 of 75,964 units; duplicate exclusions 4; focus exclusions 12; source-gate exclusions 0; reselections 16.
...
- The related DEPs show how architecture, inference, neural, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: architecture, inference, neural, optimization.
...
|---|---|---|---|
| Schwarz Neural Inference - DEP-E | Related DEP | Overlap: neural, inference, architecture | `.lake-data/DEP-E/DEP-E-20260723-Schwarz Neural Inference/schwarz_neural_inference_manuscript.md` |
| Neural Architecture - DEP-E | Related DEP | Overlap: neural, optimization, architecture | `.lake-data/DEP-E/DEP-E-20260818-Neural Architecture/neural_architecture_manuscript.md` |
| Model Evolution Under - DEP-E | Related DEP | Overlap: neural, optimization, architecture | `.lake-data/DEP-E/DEP-E-20260819-Model Evolution Under/model_evolution_under_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2104.12766 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2104.12766 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2104.12766 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260723-Schwarz Neural Inference/schwarz_neural_inference_manuscript.md` | Related synthesis: neural, inference, architecture | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Neural Architecture/neural_architecture_manuscript.md` | Related synthesis: neural, optimization, architecture | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Model Evolution Under/model_evolution_under_manuscript.md` | Related synthesis: neural, optimization, architecture | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 7,570 of 75,964 units from 75,967 PDFs.
