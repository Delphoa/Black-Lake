...
- Source URL: https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/Series%20001/DEP-E-20260708-Tech%20Intel%20Review/tech-intel-agent-systems-review.md
  - Applies to: `piarena_evaluation_manuscript.md`
  - Notes: Related DEP evidence for distributed tool-description injection and agent evaluation.
- Source URL: https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/Series%20001/DEP-E-20260711-Agent%20Memory%20Forensics/memory-forensics.md
  - Applies to: `piarena_evaluation_manuscript.md`
  - Notes: Related DEP evidence for compromise channels and trace observability.
- Source URL: https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/Series%20001/DEP-E-20260716-Judge%20Conformal/llm_judge_conformal_manuscript.md
  - Applies to: `piarena_evaluation_manuscript.md`
