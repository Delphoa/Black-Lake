---
title: "AgriAgent Contract-Driven - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of AgriAgent: Contract-Driven Planning and Capability-Aware Tool Orchestration in Real-World Agriculture."
...
primary_url: "https://arxiv.org/abs/2601.08308"
stable_identifier: "arXiv:2601.08308; DOI:10.48550/arXiv.2601.08308"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P219"
...
# AgriAgent Contract-Driven - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2601.08308 | https://arxiv.org/abs/2601.08308 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2601.08308 rendering | https://arxiv.org/html/2601.08308 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2601.08308 | https://arxiv.org/pdf/2601.08308 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P219` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Yang, Bo; Zhang, Yu; Chen, Yunkui; Feng, Lanfei; Xu, Xiao; Aierken, Nueraili; Li, Shijian. Submitted/source date: 2026/01/13. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P219`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: orchestration, planning, real-world | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies agriagent, agriculture, capability-aware. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around agriagent, agriculture, capability-aware. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving agriagent, agriculture, capability-aware. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 9,322 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how orchestration, planning, real-world connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: orchestration, planning, real-world.
...
|---|---|---|---|
| WorkflowLLM Enhancing - DEP-E | Related DEP | Overlap: orchestration, planning | `.lake-data/DEP-E/DEP-E-20260724-WorkflowLLM Enhancing/workflowllm_enhancing_manuscript.md` |
| ManipulationNet An - DEP-E | Related DEP | Overlap: real-world, planning | `.lake-data/DEP-E/DEP-E-20260726-ManipulationNet An/manipulationnet_an_manuscript.md` |
| RRT-CBF Motion - DEP-E | Related DEP | Overlap: planning | `.lake-data/DEP-E/DEP-E-20260711-RRT-CBF Motion/rrt_cbf_motion_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2601.08308 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2601.08308 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2601.08308 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260724-WorkflowLLM Enhancing/workflowllm_enhancing_manuscript.md` | Related synthesis: orchestration, planning | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260726-ManipulationNet An/manipulationnet_an_manuscript.md` | Related synthesis: real-world, planning | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260711-RRT-CBF Motion/rrt_cbf_motion_manuscript.md` | Related synthesis: planning | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 9,322 of 75,964 units from 75,967 PDFs.
