---
title: "Contact Optimization for - DEP-E"
generated_at: "2026-08-18 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Contact Optimization for Non-Prehensile Loco-Manipulation via Hierarchical Model Predictive Control."
...
primary_url: "https://arxiv.org/abs/2210.03442"
stable_identifier: "arXiv:2210.03442; DOI:10.48550/arXiv.2210.03442"
deployment_job_id: "BLAD-2200-20260818-BBEE0F31"
deployment_item_id: "BLAD-2200-20260818-BBEE0F31-P47"
...
# Contact Optimization for - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2210.03442 | https://arxiv.org/abs/2210.03442 | Metadata only. | 2026-08-18 | Inspected |
| S2 | Full paper | Primary | HTML | 2210.03442 rendering | https://arxiv.org/html/2210.03442 | Verified local copy withheld. | 2026-08-18 | Inspected in full |
| S3 | PDF | Primary | PDF | 2210.03442 | https://arxiv.org/pdf/2210.03442 | Verified local copy withheld. | 2026-08-18 | Integrity checked and sampled |
| S4 | Neural Architecture - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-Neural Architecture/neural_architecture_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
...
| S6 | SAGE-Nav Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-SAGE-Nav Review/sage_nav_manuscript.md` | Synthesis only. | 2026-08-18 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260818-BBEE0F31-P47` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-18 | Verified |

Authors: Rigo, Alberto; Chen, Yiyu; Gupta, Satyandra K.; Nguyen, Quan. Submitted/source date: 2022/10/07. Job `BLAD-2200-20260818-BBEE0F31`; item `BLAD-2200-20260818-BBEE0F31-P47`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Recent studies on quadruped robots have focused on either locomotion or mobile manipulation using a robotic arm. Legged …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Recent studies on quadruped robots have focused on either locomotion or mobile manipulation using a robotic arm. Legged …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: control, hierarchical, optimization, predictive | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies contact, control, hierarchical. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around contact, control, hierarchical. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Recent studies on quadruped robots have focused on either locomotion or mobile manipulation using a robotic arm. Legged …”. The full-paper rendering contains 29 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Recent studies on quadruped robots have focused on either locomotion or mobile manipulation using a robotic arm. Legged …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In mobile manipulation, robots can exhibit different modes of interaction with the object. For example, mobile robots equipped …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving contact, control, hierarchical. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 62,899 of 75,964 units; duplicate exclusions 0; focus exclusions 6; source-gate exclusions 0; reselections 6.
...
- The related DEPs show how control, hierarchical, optimization, predictive connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: control, hierarchical, optimization, predictive.
...
|---|---|---|---|
| Neural Architecture - DEP-E | Related DEP | Overlap: predictive, optimization, control | `.lake-data/DEP-E/DEP-E-20260818-Neural Architecture/neural_architecture_manuscript.md` |
| UAV Visual Localization - DEP-E | Related DEP | Overlap: hierarchical, optimization, control | `.lake-data/DEP-E/DEP-E-20260716-UAV Visual Localization/uav_visual_localization_manuscript.md` |
| SAGE-Nav Review - DEP-E | Related DEP | Overlap: hierarchical, optimization, control | `.lake-data/DEP-E/DEP-E-20260723-SAGE-Nav Review/sage_nav_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2210.03442 | Metadata and abstract | 2026-08-18 | Metadata only |
| R2 | https://arxiv.org/html/2210.03442 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-18 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2210.03442 | Primary paper integrity | 2026-08-18 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260818-Neural Architecture/neural_architecture_manuscript.md` | Related synthesis: predictive, optimization, control | 2026-08-18 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260716-UAV Visual Localization/uav_visual_localization_manuscript.md` | Related synthesis: hierarchical, optimization, control | 2026-08-18 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260723-SAGE-Nav Review/sage_nav_manuscript.md` | Related synthesis: hierarchical, optimization, control | 2026-08-18 | Repository-relative |

## Appendix

- Uniform selected index: 62,899 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 0; focus exclusions: 6; source-gate exclusions: 0; reselections: 6; 24-hour cutoff: 2026-08-17.
