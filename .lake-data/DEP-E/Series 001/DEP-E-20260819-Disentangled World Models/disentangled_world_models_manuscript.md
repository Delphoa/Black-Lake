---
title: "Disentangled World Models - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Disentangled World Models: Learning to Transfer Semantic Knowledge from Distracting Videos for Reinforcement Learning."
...
primary_url: "https://arxiv.org/abs/2503.08751"
stable_identifier: "arXiv:2503.08751; DOI:10.48550/arXiv.2503.08751"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P403"
...
# Disentangled World Models - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2503.08751 | https://arxiv.org/abs/2503.08751 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2503.08751 rendering | https://arxiv.org/html/2503.08751 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2503.08751 | https://arxiv.org/pdf/2503.08751 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | GigaBrain-0 5M a VLA That - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-GigaBrain-0 5M a VLA That/gigabrain_0_5m_a_vla_that_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P403` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Qi; Zhang, Zhipeng; Xie, Baao; Jin, Xin; Wang, Yunbo; Wang, Shiyu; Zheng, Liaomo; Yang, Xiaokang; Zeng, Wenjun. Submitted/source date: 2025/03/11. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P403`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: disentangled, knowledge, reinforcement, transfer, world | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies disentangled, distracting, knowledge. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around disentangled, distracting, knowledge. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving disentangled, distracting, knowledge. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 8,818 of 75,964 units; duplicate exclusions 4; focus exclusions 16; source-gate exclusions 0; reselections 20.
...
- The related DEPs show how disentangled, knowledge, reinforcement, transfer, world connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: disentangled, knowledge, reinforcement, transfer, world.
...
|---|---|---|---|
| Disentangled Knowledge - DEP-E | Related DEP | Overlap: disentangled, knowledge, transfer | `.lake-data/DEP-E/DEP-E-20260815-Disentangled Knowledge/disentangled_knowledge_manuscript.md` |
| Think2Drive Efficient - DEP-E | Related DEP | Overlap: reinforcement, world, transfer | `.lake-data/DEP-E/DEP-E-20260818-Think2Drive Efficient/think2drive_efficient_manuscript.md` |
| GigaBrain-0 5M a VLA That - DEP-E | Related DEP | Overlap: reinforcement, world, transfer | `.lake-data/DEP-E/DEP-E-20260819-GigaBrain-0 5M a VLA That/gigabrain_0_5m_a_vla_that_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2503.08751 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2503.08751 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2503.08751 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260815-Disentangled Knowledge/disentangled_knowledge_manuscript.md` | Related synthesis: disentangled, knowledge, transfer | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Think2Drive Efficient/think2drive_efficient_manuscript.md` | Related synthesis: reinforcement, world, transfer | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-GigaBrain-0 5M a VLA That/gigabrain_0_5m_a_vla_that_manuscript.md` | Related synthesis: reinforcement, world, transfer | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 8,818 of 75,964 units from 75,967 PDFs.
