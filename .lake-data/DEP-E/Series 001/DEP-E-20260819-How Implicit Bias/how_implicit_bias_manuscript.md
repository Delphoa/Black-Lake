---
title: "How Implicit Bias - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of How Implicit Bias Accumulates and Propagates in LLM Long-term Memory."
...
primary_url: "https://arxiv.org/abs/2602.01558"
stable_identifier: "arXiv:2602.01558; DOI:10.48550/arXiv.2602.01558"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P161"
...
# How Implicit Bias - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2602.01558 | https://arxiv.org/abs/2602.01558 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2602.01558 rendering | https://arxiv.org/html/2602.01558 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2602.01558 | https://arxiv.org/pdf/2602.01558 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | MemShot Dialogue Memory - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260805-MemShot Dialogue Memory/memshot_dialogue_memory_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | A New System of Global - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260727-A New System of Global/a_new_system_of_global_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P161` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Ma, Yiming; Wang, Lixu; Wang, Lionel Z.; Yang, Hongkun; Sun, Haoming; Xu, Xin; Wu, Jiaqi; Chen, Bin; Dong, Wei. Submitted/source date: 2026/02/02. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P161`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Long-term memory mechanisms enable Large Language Models (LLMs) to maintain continuity and personalization across extended interaction lifecycles, but …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Long-term memory mechanisms enable Large Language Models (LLMs) to maintain continuity and personalization across extended interaction lifecycles, but …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: bias, how, implicit, llm, long-term | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies accumulates, bias, how. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around accumulates, bias, how. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Long-term memory mechanisms enable Large Language Models (LLMs) to maintain continuity and personalization across extended interaction lifecycles, but …”. The full-paper rendering contains 62 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Long-term memory mechanisms enable Large Language Models (LLMs) to maintain continuity and personalization across extended interaction lifecycles, but …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Long-term memory mechanisms enable Large Language Models (LLMs) to maintain continuity and personalization across extended interaction lifecycles, but …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving accumulates, bias, how. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 40,898 of 75,964 units; duplicate exclusions 1; focus exclusions 19; source-gate exclusions 0; reselections 20.
...
- The related DEPs show how bias, how, implicit, llm, long-term connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: bias, how, implicit, llm, long-term.
...
|---|---|---|---|
| MemShot Dialogue Memory - DEP-E | Related DEP | Overlap: long-term, memory, llm, bias | `.lake-data/DEP-E/DEP-E-20260805-MemShot Dialogue Memory/memshot_dialogue_memory_manuscript.md` |
| LLM-based Medical - DEP-E | Related DEP | Overlap: long-term, memory, llm, how | `.lake-data/DEP-E/DEP-E-20260818-LLM-based Medical/llm_based_medical_manuscript.md` |
| A New System of Global - DEP-E | Related DEP | Overlap: implicit, how, memory | `.lake-data/DEP-E/DEP-E-20260727-A New System of Global/a_new_system_of_global_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2602.01558 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2602.01558 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2602.01558 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260805-MemShot Dialogue Memory/memshot_dialogue_memory_manuscript.md` | Related synthesis: long-term, memory, llm, bias | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-LLM-based Medical/llm_based_medical_manuscript.md` | Related synthesis: long-term, memory, llm, how | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260727-A New System of Global/a_new_system_of_global_manuscript.md` | Related synthesis: implicit, how, memory | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 40,898 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 1; focus exclusions: 19; source-gate exclusions: 0; reselections: 20; 24-hour cutoff: 2026-08-18.
