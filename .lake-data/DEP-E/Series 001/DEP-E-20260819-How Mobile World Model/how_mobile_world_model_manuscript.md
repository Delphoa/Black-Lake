---
title: "How Mobile World Model - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of How Mobile World Model Guides GUI Agents?."
...
primary_url: "https://arxiv.org/abs/2605.10347"
stable_identifier: "arXiv:2605.10347; DOI:10.48550/arXiv.2605.10347"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P391"
...
# How Mobile World Model - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2605.10347 | https://arxiv.org/abs/2605.10347 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2605.10347 rendering | https://arxiv.org/html/2605.10347 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2605.10347 | https://arxiv.org/pdf/2605.10347 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | MobileWorldBench Towards - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-MobileWorldBench Towards/mobileworldbench_towards_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | MCPWorld - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260730-MCPWorld Benchmark/mcpworld_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P391` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Xu, Weikai; Huang, Kun; Feng, Yunren; Li, Jiaxing; Chen, Yuhan; Liu, Yuxuan; Jiang, Zhizheng; Qu, Heng; Gao, Pengzhi; Liu, Wei; Luan, Jian; Hu, Xiaolin; An, Bo. Submitted/source date: 2026/05/11. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P391`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Experimental Results. Table 4 shows that simple self-reflection is not sufficient without additional inputs. We observe a diminishing …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Recent advances in vision-language models have enabled mobile GUI agents to perceive visual interfaces and execute user instructions, …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: agents, gui, how, mobile, world | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies agents, gui, guides. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around agents, gui, guides. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Experimental Results. Table 4 shows that simple self-reflection is not sufficient without additional inputs. We observe a diminishing …”. The full-paper rendering contains 109 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving agents, gui, guides. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 44,006 of 75,964 units; duplicate exclusions 2; focus exclusions 18; source-gate exclusions 1; reselections 21.
...
- The related DEPs show how agents, gui, how, mobile, world connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: agents, gui, how, mobile, world.
...
|---|---|---|---|
| MobileWorldBench Towards - DEP-E | Related DEP | Overlap: mobile, agents, world, how | `.lake-data/DEP-E/DEP-E-20260819-MobileWorldBench Towards/mobileworldbench_towards_manuscript.md` |
| MCPWorld - DEP-E | Related DEP | Overlap: gui, agents, how | `.lake-data/DEP-E/DEP-E-20260730-MCPWorld Benchmark/mcpworld_manuscript.md` |
| ARPO End-to-End Policy - DEP-E | Related DEP | Overlap: gui, agents, how | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2605.10347 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2605.10347 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2605.10347 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-MobileWorldBench Towards/mobileworldbench_towards_manuscript.md` | Related synthesis: mobile, agents, world, how | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260730-MCPWorld Benchmark/mcpworld_manuscript.md` | Related synthesis: gui, agents, how | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-ARPO End-to-End Policy/arpo_end_to_end_policy_manuscript.md` | Related synthesis: gui, agents, how | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 44,006 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 2; focus exclusions: 18; source-gate exclusions: 1; reselections: 21; 24-hour cutoff: 2026-08-18.
