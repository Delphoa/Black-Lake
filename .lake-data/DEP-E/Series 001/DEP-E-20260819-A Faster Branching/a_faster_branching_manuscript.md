---
title: "A Faster Branching - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A Faster Branching Algorithm for the Maximum $k$-Defective Clique Problem."
...
primary_url: "https://arxiv.org/abs/2407.16588"
stable_identifier: "arXiv:2407.16588; DOI:10.48550/arXiv.2407.16588"
deployment_job_id: "BLAD-2200-20260819-9951C2C3"
deployment_item_id: "BLAD-2200-20260819-9951C2C3-P197"
...
# A Faster Branching - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2407.16588 | https://arxiv.org/abs/2407.16588 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2407.16588 rendering | https://arxiv.org/html/2407.16588 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2407.16588 | https://arxiv.org/pdf/2407.16588 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | Calibrated Dataset - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Calibrated Dataset/calibrated_dataset_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-9951C2C3-P197` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Luo, Chunyu; Zhou, Yi; Wang, Zhengren; Xiao, Mingyu. Submitted/source date: 2024/07/23. Job `BLAD-2200-20260819-9951C2C3`; item `BLAD-2200-20260819-9951C2C3-P197`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “A k k -defective clique of an undirected graph G G is a subset of its vertices that …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “A k k -defective clique of an undirected graph G G is a subset of its vertices that …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, faster, problem | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, branching, clique. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, branching, clique. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “A k k -defective clique of an undirected graph G G is a subset of its vertices that …”. The full-paper rendering contains 68 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “A k k -defective clique of an undirected graph G G is a subset of its vertices that …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Finding cohesive subgraphs is a fundamental task in many real-world network applications, such as community detection in social …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, branching, clique. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 30,082 of 75,964 units; duplicate exclusions 3; focus exclusions 20; source-gate exclusions 0; reselections 23.
...
- The related DEPs show how algorithm, faster, problem connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, faster, problem.
...
|---|---|---|---|
| Provably Faster Algorithms for B - DEP-E | Related DEP | Overlap: faster, algorithm, problem | `.lake-data/DEP-E/DEP-E-20260723-Provably Faster Algorithm/provably_faster_algorithm_manuscript.md` |
| Train Faster Perform - DEP-E | Related DEP | Overlap: faster, algorithm, problem | `.lake-data/DEP-E/DEP-E-20260816-Train Faster Perform/train_faster_perform_manuscript.md` |
| Calibrated Dataset - DEP-E | Related DEP | Overlap: faster, algorithm, problem | `.lake-data/DEP-E/DEP-E-20260819-Calibrated Dataset/calibrated_dataset_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2407.16588 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2407.16588 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2407.16588 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260723-Provably Faster Algorithm/provably_faster_algorithm_manuscript.md` | Related synthesis: faster, algorithm, problem | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260816-Train Faster Perform/train_faster_perform_manuscript.md` | Related synthesis: faster, algorithm, problem | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Calibrated Dataset/calibrated_dataset_manuscript.md` | Related synthesis: faster, algorithm, problem | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 30,082 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 3; focus exclusions: 20; source-gate exclusions: 0; reselections: 23; 24-hour cutoff: 2026-08-18.
