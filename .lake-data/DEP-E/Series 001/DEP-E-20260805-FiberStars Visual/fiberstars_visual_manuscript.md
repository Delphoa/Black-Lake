---
title: "FiberStars Visual - DEP-E"
generated_at: "2026-08-05 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of FiberStars: Visual Comparison of Diffusion Tractography Data between Multiple Subjects."
...
primary_url: "https://arxiv.org/abs/2005.08090"
stable_identifier: "arXiv:2005.08090; DOI:10.1109/PacificVis52677.2021.00023"
deployment_job_id: "BLAD-2200-20260805-6C10E207"
deployment_item_id: "BLAD-2200-20260805-6C10E207-P09"
...
# FiberStars Visual - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2005.08090 | https://arxiv.org/abs/2005.08090 | Metadata only. | 2026-08-05 | Inspected |
| S2 | Full paper | Primary | HTML | 2005.08090 rendering | https://arxiv.org/html/2005.08090 | Verified local copy withheld. | 2026-08-05 | Inspected in full |
| S3 | PDF | Primary | PDF | 2005.08090 | https://arxiv.org/pdf/2005.08090 | Verified local copy withheld. | 2026-08-05 | Integrity checked and sampled |
| S4 | Deep Learning for - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260805-Deep Learning for/deep_learning_for_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S5 | Spiking Pose Tracking - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S6 | Vid2Curve Reconstruction - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction/vid2curve_reconstruction_manuscript.md` | Synthesis only. | 2026-08-05 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260805-6C10E207-P09` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-05 | Verified |

Authors: Franke, Loraine; Weidele, Daniel Karl I.; Zhang, Fan; Cetin-Karayumak, Suheyla; Pieper, Steve; O'Donnell, Lauren J.; Rathi, Yogesh; Haehn, Daniel. Submitted/source date: 2020/05/16. Job `BLAD-2200-20260805-6C10E207`; item `BLAD-2200-20260805-6C10E207-P09`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Our main goal is to visualize fiber data in an efficient way that allows comparisons between different clusters …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Tractography from high-dimensional diffusion magnetic resonance imaging (dMRI) data allows brain’s structural connectivity analysis. Recent dMRI studies aim …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algebraic, avatar, avatars, geometric, manifold | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies comparison, diffusion, fiberstars. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around comparison, diffusion, fiberstars. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Our main goal is to visualize fiber data in an efficient way that allows comparisons between different clusters …”. The full-paper rendering contains 82 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Tractography from high-dimensional diffusion magnetic resonance imaging (dMRI) data allows brain’s structural connectivity analysis. Recent dMRI studies aim …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Tractography data needs interpretation to be useful, and therefore visualizations are required to understand the underlying tissue microstructure …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving comparison, diffusion, fiberstars. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 43,486 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how algebraic, avatar, avatars, geometric, manifold connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algebraic, avatar, avatars, geometric, manifold.
...
| Spiking Pose Tracking - DEP-E | Related DEP | Overlap: avatars, algebraic, avatar, pose, motion | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` |
| Vid2Curve Reconstruction - DEP-E | Related DEP | Overlap: topological, geometric, topology, pose, motion | `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction/vid2curve_reconstruction_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2005.08090 | Metadata and abstract | 2026-08-05 | Metadata only |
| R2 | https://arxiv.org/html/2005.08090 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-05 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2005.08090 | Primary paper integrity | 2026-08-05 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260805-Deep Learning for/deep_learning_for_manuscript.md` | Related synthesis: avatars, topological, persistence, manifold, avatar | 2026-08-05 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260724-Spiking Pose Tracking/spiking_pose_tracking_manuscript.md` | Related synthesis: avatars, algebraic, avatar, pose, motion | 2026-08-05 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction/vid2curve_reconstruction_manuscript.md` | Related synthesis: topological, geometric, topology, pose, motion | 2026-08-05 | Repository-relative |

## Appendix

- Uniform selected index: 43,486 of 75,957 units from 75,960 PDFs.
