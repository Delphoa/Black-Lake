---
title: "Hybrid Beamforming - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Hybrid Beamforming Optimization for DOA Estimation Based on the CRB Analysis."
...
primary_url: "https://arxiv.org/abs/2103.15357"
stable_identifier: "arXiv:2103.15357; DOI:10.1109/LSP.2021.3092613"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P169"
...
# Hybrid Beamforming - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2103.15357 | https://arxiv.org/abs/2103.15357 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2103.15357 rendering | https://arxiv.org/html/2103.15357 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2103.15357 | https://arxiv.org/pdf/2103.15357 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | Low-complexity Joint - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Low-complexity Joint/low_complexity_joint_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P169` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Lin, Tian; Zhou, Xuemeng; Zhu, Yu; Jiang, Yi. Submitted/source date: 2021/03/29. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P169`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Direction-of-arrival (DOA) estimation is one of the most demanding tasks for the millimeter wave (mmWave) communication of massive …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Direction-of-arrival (DOA) estimation is one of the most demanding tasks for the millimeter wave (mmWave) communication of massive …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: beamforming, estimation, hybrid, optimization | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies beamforming, crb, doa. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around beamforming, crb, doa. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Direction-of-arrival (DOA) estimation is one of the most demanding tasks for the millimeter wave (mmWave) communication of massive …”. The full-paper rendering contains 30 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Direction-of-arrival (DOA) estimation is one of the most demanding tasks for the millimeter wave (mmWave) communication of massive …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Hybrid beamforming (HBF) is regarded as a promising technology for millimeter wave (mmWave) massive multiple-input multiple-output (MIMO) communication …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving beamforming, crb, doa. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 4,079 of 75,964 units; duplicate exclusions 1; focus exclusions 2; source-gate exclusions 0; reselections 3.
...
- The related DEPs show how beamforming, estimation, hybrid, optimization connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: beamforming, estimation, hybrid, optimization.
...
|---|---|---|---|
| Multi-Point ISAC - DEP-E | Related DEP | Overlap: beamforming, hybrid, estimation, optimization | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` |
| Low-Complexity - DEP-E | Related DEP | Overlap: beamforming, optimization | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` |
| Low-complexity Joint - DEP-E | Related DEP | Overlap: beamforming | `.lake-data/DEP-E/DEP-E-20260819-Low-complexity Joint/low_complexity_joint_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2103.15357 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2103.15357 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2103.15357 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260716-Multi-Point ISAC/multi_point_isac_manuscript.md` | Related synthesis: beamforming, hybrid, estimation, optimization | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-Low-Complexity/low_complexity_manuscript.md` | Related synthesis: beamforming, optimization | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Low-complexity Joint/low_complexity_joint_manuscript.md` | Related synthesis: beamforming | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 4,079 of 75,964 units from 75,967 PDFs.
