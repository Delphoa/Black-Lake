---
title: "NeMO Neural Map Growing - DEP-E"
generated_at: "2026-07-25 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of NeMO: Neural Map Growing System for Spatiotemporal Fusion in Bird's-Eye-View and BDD-Map Benchmark."
...
primary_url: "https://arxiv.org/abs/2306.04540"
stable_identifier: "arXiv:2306.04540; DOI:10.48550/arXiv.2306.04540"
deployment_job_id: "BLAD-2200-20260725-FF48EE13"
deployment_item_id: "BLAD-2200-20260725-FF48EE13-P01"
...
# NeMO Neural Map Growing - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2306.04540 | https://arxiv.org/abs/2306.04540 | Metadata only. | 2026-07-25 | Inspected |
| S2 | Full paper | Primary | HTML | 2306.04540 rendering | https://ar5iv.labs.arxiv.org/html/2306.04540 | Verified local copy withheld. | 2026-07-25 | Inspected in full |
| S3 | PDF | Primary | PDF | 2306.04540 | https://arxiv.org/pdf/2306.04540 | Verified local copy withheld. | 2026-07-25 | Integrity checked and sampled |
| S4 | OE-BevSeg Perception - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260724-OE-BevSeg Perception/oe_bevseg_perception_manuscript.md` | Synthesis only. | 2026-07-25 | Inspected |
| S5 | iKalibr Calibration - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260714-iKalibr Calibration/ikalibr_calibration_manuscript.md` | Synthesis only. | 2026-07-25 | Inspected |
| S6 | Rethinking Facial Expression Rec - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-Rethinking Facial Express/rethinking_facial_express_manuscript.md` | Synthesis only. | 2026-07-25 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260725-FF48EE13-P01` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-25 | Verified |

Authors: Zhu, Xi; Cao, Xiya; Dong, Zhiwei; Zhou, Caifa; Liu, Qiangbo; Li, Wei; Wang, Yongliang. Submitted/source date: 2023/06/07. Job `BLAD-2200-20260725-FF48EE13`; item `BLAD-2200-20260725-FF48EE13-P01`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: benchmark, bird, datasets, perception, s-eye-view | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies map, fusion, bdd-map. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around map, fusion, bdd-map. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving map, fusion, bdd-map. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 30,208 of 75,778 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how benchmark, bird, datasets, perception, s-eye-view connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: benchmark, bird, datasets, perception, s-eye-view.
...
|---|---|---|---|
| OE-BevSeg Perception - DEP-E | Related DEP | Overlap: bird, s-eye-view, perception, segmentation | `.lake-data/DEP-E/DEP-E-20260724-OE-BevSeg Perception/oe_bevseg_perception_manuscript.md` |
| iKalibr Calibration - DEP-E | Related DEP | Overlap: spatiotemporal, systems | `.lake-data/DEP-E/DEP-E-20260714-iKalibr Calibration/ikalibr_calibration_manuscript.md` |
| Rethinking Facial Expression Rec - DEP-E | Related DEP | Overlap: datasets, benchmark | `.lake-data/DEP-E/DEP-E-20260723-Rethinking Facial Express/rethinking_facial_express_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2306.04540 | Metadata and abstract | 2026-07-25 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/2306.04540 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-25 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2306.04540 | Primary paper integrity | 2026-07-25 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260724-OE-BevSeg Perception/oe_bevseg_perception_manuscript.md` | Related synthesis: bird, s-eye-view, perception, segmentation | 2026-07-25 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260714-iKalibr Calibration/ikalibr_calibration_manuscript.md` | Related synthesis: spatiotemporal, systems | 2026-07-25 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260723-Rethinking Facial Express/rethinking_facial_express_manuscript.md` | Related synthesis: datasets, benchmark | 2026-07-25 | Repository-relative |

## Appendix

- Uniform selected index: 30,208 of 75,778 units from 75,781 PDFs.
