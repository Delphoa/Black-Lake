---
title: "Training Networks in Null - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Training Networks in Null Space of Feature Covariance for Continual Learning."
...
primary_url: "https://arxiv.org/abs/2103.07113"
stable_identifier: "arXiv:2103.07113; DOI:10.48550/arXiv.2103.07113"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P253"
...
# Training Networks in Null - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2103.07113 | https://arxiv.org/abs/2103.07113 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2103.07113 rendering | https://arxiv.org/html/2103.07113 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2103.07113 | https://arxiv.org/pdf/2103.07113 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | How to Evaluate the Next - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-How to Evaluate the Next/how_to_evaluate_the_next_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Online Continual Learning - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Online Continual Learning/online_continual_learning_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P253` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Wang, Shipeng; Li, Xiaorong; Sun, Jian; Xu, Zongben. Submitted/source date: 2021/03/12. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P253`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In the setting of continual learning, a network is trained on a sequence of tasks, and suffers from …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In the setting of continual learning, a network is trained on a sequence of tasks, and suffers from …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: continual, networks | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies continual, covariance, feature. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around continual, covariance, feature. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In the setting of continual learning, a network is trained on a sequence of tasks, and suffers from …”. The full-paper rendering contains 57 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In the setting of continual learning, a network is trained on a sequence of tasks, and suffers from …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Deep neural networks have achieved promising performance on various tasks in natural language processing, machine intelligence, etc., [ …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving continual, covariance, feature. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 24,551 of 75,964 units; duplicate exclusions 1; focus exclusions 0; source-gate exclusions 1; reselections 2.
...
- The related DEPs show how continual, networks connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: continual, networks.
...
|---|---|---|---|
| How to Evaluate the Next - DEP-E | Related DEP | Overlap: continual, networks | `.lake-data/DEP-E/DEP-E-20260819-How to Evaluate the Next/how_to_evaluate_the_next_manuscript.md` |
| KAC Kolmogorov-Arnold - DEP-E | Related DEP | Overlap: continual, networks | `.lake-data/DEP-E/DEP-E-20260819-KAC Kolmogorov-Arnold/kac_kolmogorov_arnold_manuscript.md` |
| Online Continual Learning - DEP-E | Related DEP | Overlap: continual, networks | `.lake-data/DEP-E/DEP-E-20260819-Online Continual Learning/online_continual_learning_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2103.07113 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2103.07113 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2103.07113 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-How to Evaluate the Next/how_to_evaluate_the_next_manuscript.md` | Related synthesis: continual, networks | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-KAC Kolmogorov-Arnold/kac_kolmogorov_arnold_manuscript.md` | Related synthesis: continual, networks | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Online Continual Learning/online_continual_learning_manuscript.md` | Related synthesis: continual, networks | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 24,551 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 1; focus exclusions: 0; source-gate exclusions: 1; reselections: 2; 24-hour cutoff: 2026-08-18.
