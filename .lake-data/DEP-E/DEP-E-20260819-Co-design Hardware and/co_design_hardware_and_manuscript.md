---
title: "Co-design Hardware and - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Co-design Hardware and Algorithm for Vector Search."
...
primary_url: "https://arxiv.org/abs/2306.11182"
stable_identifier: "arXiv:2306.11182; DOI:10.48550/arXiv.2306.11182"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P127"
...
# Co-design Hardware and - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2306.11182 | https://arxiv.org/abs/2306.11182 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2306.11182 rendering | https://arxiv.org/html/2306.11182 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2306.11182 | https://arxiv.org/pdf/2306.11182 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | APSQ Additive Partial Sum - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-APSQ Additive Partial Sum/apsq_additive_partial_sum_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Gen-NeRF Efficient and - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Gen-NeRF Efficient and/gen_nerf_efficient_and_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | GoVector An I O-Efficient - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-GoVector An I O-Efficient/govector_an_i_o_efficient_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P127` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Jiang, Wenqi; Li, Shigang; Zhu, Yu; Licht, Johannes de Fine; He, Zhenhao; Shi, Runbin; Renggli, Cedric; Zhang, Shuai; Rekatsinas, Theodoros; Hoefler, Torsten; Alonso, Gustavo. Submitted/source date: 2023/06/19. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P127`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Vector search has emerged as the foundation for large-scale information retrieval and machine learning systems, with search engines …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “To meet the surging performance demands of vector search systems in the post-Moore’s Law era, designing specialized vector …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, co-design, search, vector | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, co-design, hardware. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, co-design, hardware. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Vector search has emerged as the foundation for large-scale information retrieval and machine learning systems, with search engines …”. The full-paper rendering contains 95 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “To meet the surging performance demands of vector search systems in the post-Moore’s Law era, designing specialized vector …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “The benefit of hardware-algorithm co-design. Maximizing the performance of an IVF-PQ accelerator is challenging because one needs to …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, co-design, hardware. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 30,608 of 75,964 units; duplicate exclusions 0; focus exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how algorithm, co-design, search, vector connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, co-design, search, vector.
...
|---|---|---|---|
| APSQ Additive Partial Sum - DEP-E | Related DEP | Overlap: co-design, algorithm | `.lake-data/DEP-E/DEP-E-20260819-APSQ Additive Partial Sum/apsq_additive_partial_sum_manuscript.md` |
| Gen-NeRF Efficient and - DEP-E | Related DEP | Overlap: co-design, algorithm | `.lake-data/DEP-E/DEP-E-20260819-Gen-NeRF Efficient and/gen_nerf_efficient_and_manuscript.md` |
| GoVector An I O-Efficient - DEP-E | Related DEP | Overlap: vector, search | `.lake-data/DEP-E/DEP-E-20260819-GoVector An I O-Efficient/govector_an_i_o_efficient_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2306.11182 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2306.11182 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2306.11182 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-APSQ Additive Partial Sum/apsq_additive_partial_sum_manuscript.md` | Related synthesis: co-design, algorithm | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Gen-NeRF Efficient and/gen_nerf_efficient_and_manuscript.md` | Related synthesis: co-design, algorithm | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-GoVector An I O-Efficient/govector_an_i_o_efficient_manuscript.md` | Related synthesis: vector, search | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 30,608 of 75,964 units from 75,967 PDFs.
