---
title: "Adaptive Client Sampling - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Adaptive Client Sampling in Federated Learning via Online Learning with Bandit Feedback."
...
primary_url: "https://arxiv.org/abs/2112.14332"
stable_identifier: "arXiv:2112.14332; DOI:10.48550/arXiv.2112.14332"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P78"
...
# Adaptive Client Sampling - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2112.14332 | https://arxiv.org/abs/2112.14332 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2112.14332 rendering | https://arxiv.org/html/2112.14332 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2112.14332 | https://arxiv.org/pdf/2112.14332 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Privacy-Preserving - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260814-Privacy-Preserving/privacy_preserving_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Is Non-IID Data a Threat - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Is Non-IID Data a Threat/is_non_iid_data_a_threat_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P78` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Zhao, Boxin; Wang, Lingxiao; Liu, Ziqi; Zhang, Zhiqiang; Zhou, Jun; Chen, Chaochao; Kolar, Mladen. Submitted/source date: 2021/12/28. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P78`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Boxin Zhao, Lingxiao Wang, Ziqi Liu, Zhiqiang Zhang, Jun Zhou, Chaochao Chen, and Mladen Kolar” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Boxin Zhao, Lingxiao Wang, Ziqi Liu, Zhiqiang Zhang, Jun Zhou, Chaochao Chen, and Mladen Kolar” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: client, federated, feedback, online | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies adaptive, bandit, client. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around adaptive, bandit, client. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Boxin Zhao, Lingxiao Wang, Ziqi Liu, Zhiqiang Zhang, Jun Zhou, Chaochao Chen, and Mladen Kolar”. The full-paper rendering contains 122 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Boxin Zhao, Lingxiao Wang, Ziqi Liu, Zhiqiang Zhang, Jun Zhou, Chaochao Chen, and Mladen Kolar”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Boxin Zhao, Lingxiao Wang, Ziqi Liu, Zhiqiang Zhang, Jun Zhou, Chaochao Chen, and Mladen Kolar”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving adaptive, bandit, client. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 58,550 of 75,964 units; duplicate exclusions 5; focus exclusions 35; source-gate exclusions 0; reselections 40.
...
- The related DEPs show how client, federated, feedback, online connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: client, federated, feedback, online.
...
|---|---|---|---|
| Privacy-Preserving - DEP-E | Related DEP | Overlap: client, federated | `.lake-data/DEP-E/DEP-E-20260814-Privacy-Preserving/privacy_preserving_manuscript.md` |
| FOLTR Unlearning - DEP-E | Related DEP | Overlap: federated, online, client, feedback | `.lake-data/DEP-E/DEP-E-20260804-Forget FOLTR/forget_foltr_manuscript.md` |
| Is Non-IID Data a Threat - DEP-E | Related DEP | Overlap: federated, online | `.lake-data/DEP-E/DEP-E-20260819-Is Non-IID Data a Threat/is_non_iid_data_a_threat_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2112.14332 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2112.14332 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2112.14332 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260814-Privacy-Preserving/privacy_preserving_manuscript.md` | Related synthesis: client, federated | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260804-Forget FOLTR/forget_foltr_manuscript.md` | Related synthesis: federated, online, client, feedback | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Is Non-IID Data a Threat/is_non_iid_data_a_threat_manuscript.md` | Related synthesis: federated, online | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 58,550 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 5; focus exclusions: 35; source-gate exclusions: 0; reselections: 40; 24-hour cutoff: 2026-08-18.
