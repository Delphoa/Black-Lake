---
title: "AG3D Learning to Generate - DEP-E"
generated_at: "2026-07-24 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of AG3D: Learning to Generate 3D Avatars from 2D Image Collections."
...
primary_url: "https://arxiv.org/abs/2305.02312"
stable_identifier: "arXiv:2305.02312; DOI:10.48550/arXiv.2305.02312"
deployment_job_id: "BLAD-2200-20260724-CF53BCCB"
deployment_item_id: "BLAD-2200-20260724-CF53BCCB-P04"
...
# AG3D Learning to Generate - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2305.02312 | https://arxiv.org/abs/2305.02312 | Metadata only. | 2026-07-24 | Inspected |
| S2 | Full paper | Primary | HTML | 2305.02312 rendering | https://ar5iv.labs.arxiv.org/html/2305.02312 | Verified local copy withheld. | 2026-07-24 | Inspected in full |
| S3 | PDF | Primary | PDF | 2305.02312 | https://arxiv.org/pdf/2305.02312 | Verified local copy withheld. | 2026-07-24 | Integrity checked and sampled |
| S4 | Input-Output Coordinated CIL | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260719-Coordinated CIL/coordinated_cil_manuscript.md` | Synthesis only. | 2026-07-24 | Inspected |
...
| S6 | InterDance Reactive 3D Dance Gen - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260723-InterDance Reactive 3D Da/interdance_reactive_3d_da_manuscript.md` | Synthesis only. | 2026-07-24 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260724-CF53BCCB-P04` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-24 | Verified |

Authors: Dong, Zijian; Chen, Xu; Yang, Jinlong; Black, Michael J.; Hilliges, Otmar; Geiger, Andreas. Submitted/source date: 2023/05/03. Job `BLAD-2200-20260724-CF53BCCB`; item `BLAD-2200-20260724-CF53BCCB-P04`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “While progress in 2D generative models of human appearance has been rapid, many applications require 3D avatars that …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “While progress in 2D generative models of human appearance has been rapid, many applications require 3D avatars that …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: adversarial, especially, generate, geometry, human | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies appearance, avatars, generative. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around appearance, avatars, generative. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “While progress in 2D generative models of human appearance has been rapid, many applications require 3D avatars that …”. The full-paper rendering contains 31 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “While progress in 2D generative models of human appearance has been rapid, many applications require 3D avatars that …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “While progress in 2D generative models of human appearance has been rapid, many applications require 3D avatars that …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving appearance, avatars, generative. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 17,272 of 75,777 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how adversarial, especially, generate, geometry, human connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: adversarial, especially, generate, geometry, human.
...
|---|---|---|---|
| Input-Output Coordinated CIL | Related DEP | Overlap: especially, previous, learn, many, adversarial | `.lake-data/DEP-E/DEP-E-20260719-Coordinated CIL/coordinated_cil_manuscript.md` |
| CAR Avatar - DEP-E | Related DEP | Overlap: shape, normal, predicted, images, human | `.lake-data/DEP-E/DEP-E-20260709-Clothed Avatar CAR/clothed_avatar_car_manuscript.md` |
| InterDance Reactive 3D Dance Gen - DEP-E | Related DEP | Overlap: realistic, generate, most, which, geometry | `.lake-data/DEP-E/DEP-E-20260723-InterDance Reactive 3D Da/interdance_reactive_3d_da_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2305.02312 | Metadata and abstract | 2026-07-24 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/2305.02312 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-24 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2305.02312 | Primary paper integrity | 2026-07-24 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260719-Coordinated CIL/coordinated_cil_manuscript.md` | Related synthesis: especially, previous, learn, many, adversarial | 2026-07-24 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260709-Clothed Avatar CAR/clothed_avatar_car_manuscript.md` | Related synthesis: shape, normal, predicted, images, human | 2026-07-24 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260723-InterDance Reactive 3D Da/interdance_reactive_3d_da_manuscript.md` | Related synthesis: realistic, generate, most, which, geometry | 2026-07-24 | Repository-relative |

## Appendix

- Uniform selected index: 17,272 of 75,777 units from 75,780 PDFs.
