---
title: "Reconstruction Guarantee - DEP-E"
generated_at: "2026-08-04 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Reconstruction Guarantee Analysis of Binary Measurement Matrices Based on Girth."
...
primary_url: "https://arxiv.org/abs/1301.4926"
stable_identifier: "arXiv:1301.4926; DOI:10.48550/arXiv.1301.4926"
deployment_job_id: "BLAD-2200-20260804-92EFB161"
deployment_item_id: "BLAD-2200-20260804-92EFB161-P09"
...
# Reconstruction Guarantee - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 1301.4926 | https://arxiv.org/abs/1301.4926 | Metadata only. | 2026-08-04 | Inspected |
| S2 | Full paper | Primary | HTML | 1301.4926 rendering | https://arxiv.org/html/1301.4926 | Verified local copy withheld. | 2026-08-04 | Inspected in full |
| S3 | PDF | Primary | PDF | 1301.4926 | https://arxiv.org/pdf/1301.4926 | Verified local copy withheld. | 2026-08-04 | Integrity checked and sampled |
| S4 | Residual Gaussian CBCT - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260717-Residual Gaussian/residual_gaussian_cbct_manuscript.md` | Synthesis only. | 2026-08-04 | Inspected |
| S5 | MeDSLIP Medical - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260802-MeDSLIP Medical/medslip_medical_manuscript.md` | Synthesis only. | 2026-08-04 | Inspected |
| S6 | WKGM MRI Reconstruction - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-WKGM MRI Reconstruction/wkgm_mri_reconstruction_manuscript.md` | Synthesis only. | 2026-08-04 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260804-92EFB161-P09` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-04 | Verified |

Authors: Liu, Xin-Ji; Xia, Shu-Tao. Submitted/source date: 2013/01/21. Job `BLAD-2200-20260804-92EFB161`; item `BLAD-2200-20260804-92EFB161-P09`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “where ‖ x ‖ 0 ≜ \| { i : x i ≠ 0 } \| ≜ subscript …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Binary 0-1 measurement matrices, especially those from coding theory, were introduced to compressed sensing (CS) recently. Good measurement …” | Author-reported results | Medium | Measurements were not reproduced |
...
This paper studies binary, girth, guarantee. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around binary, girth, guarantee. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “where ‖ x ‖ 0 ≜ \| { i : x i ≠ 0 } \| ≜ subscript …”. The full-paper rendering contains 37 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Binary 0-1 measurement matrices, especially those from coding theory, were introduced to compressed sensing (CS) recently. Good measurement …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In order to recover the original signals exactly, measurement matrices need to satisfy some properties. Cand e ` …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving binary, girth, guarantee. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 34,340 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
| MeDSLIP Medical - DEP-E | Related DEP | Overlap: pediatric, pet, tomography, patients, scatter | `.lake-data/DEP-E/DEP-E-20260802-MeDSLIP Medical/medslip_medical_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/1301.4926 | Metadata and abstract | 2026-08-04 | Metadata only |
| R2 | https://arxiv.org/html/1301.4926 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-04 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/1301.4926 | Primary paper integrity | 2026-08-04 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260717-Residual Gaussian/residual_gaussian_cbct_manuscript.md` | Related synthesis: tomography, scatter, attenuation, cbct, mri | 2026-08-04 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260802-MeDSLIP Medical/medslip_medical_manuscript.md` | Related synthesis: pediatric, pet, tomography, patients, scatter | 2026-08-04 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260720-WKGM MRI Reconstruction/wkgm_mri_reconstruction_manuscript.md` | Related synthesis: cbct, patient, mri, imaging, health | 2026-08-04 | Repository-relative |

## Appendix

- Uniform selected index: 34,340 of 75,957 units from 75,960 PDFs.
