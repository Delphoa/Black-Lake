---
title: "Federated Quantum Long - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Federated Quantum Long Short-term Memory (FedQLSTM)."
...
primary_url: "https://arxiv.org/abs/2312.14309"
stable_identifier: "arXiv:2312.14309; DOI:10.48550/arXiv.2312.14309"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P395"
...
# Federated Quantum Long - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2312.14309 | https://arxiv.org/abs/2312.14309 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2312.14309 rendering | https://arxiv.org/html/2312.14309 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2312.14309 | https://arxiv.org/pdf/2312.14309 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | An Attention-based Long - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-An Attention-based Long/an_attention_based_long_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | Deep Learning with Long - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Deep Learning with Long/deep_learning_with_long_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Long Short-Term Memory - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Long Short-Term Memory/long_short_term_memory_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P395` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Chehimi, Mahdi; Chen, Samuel Yen-Chi; Saad, Walid; Yoo, Shinjae. Submitted/source date: 2023/12/21. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P395`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Quantum federated learning (QFL) can facilitate collaborative learning across multiple clients using quantum machine learning (QML) models, while …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Quantum federated learning (QFL) can facilitate collaborative learning across multiple clients using quantum machine learning (QML) models, while …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: long, memory, short-term | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies federated, fedqlstm, long. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around federated, fedqlstm, long. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Quantum federated learning (QFL) can facilitate collaborative learning across multiple clients using quantum machine learning (QML) models, while …”. The full-paper rendering contains 41 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Quantum federated learning (QFL) can facilitate collaborative learning across multiple clients using quantum machine learning (QML) models, while …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “However, such quantum sensors are typically deployed across distributed quantum sensor networks (QSNs), where multiple quantum sensors jointly …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving federated, fedqlstm, long. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 46,628 of 75,964 units; duplicate exclusions 0; focus exclusions 1; source-gate exclusions 0; reselections 1.
- `Focus eligibility`: ML memory, stateful systems, and algorithmic research; matched categories ML memory; title/abstract evidence terms short term memory.
...
- The related DEPs show how long, memory, short-term connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: long, memory, short-term.
...
|---|---|---|---|
| An Attention-based Long - DEP-E | Related DEP | Overlap: short-term, long, memory | `.lake-data/DEP-E/DEP-E-20260819-An Attention-based Long/an_attention_based_long_manuscript.md` |
| Deep Learning with Long - DEP-E | Related DEP | Overlap: short-term, long, memory | `.lake-data/DEP-E/DEP-E-20260819-Deep Learning with Long/deep_learning_with_long_manuscript.md` |
| Long Short-Term Memory - DEP-E | Related DEP | Overlap: short-term, long, memory | `.lake-data/DEP-E/DEP-E-20260819-Long Short-Term Memory/long_short_term_memory_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2312.14309 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2312.14309 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2312.14309 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-An Attention-based Long/an_attention_based_long_manuscript.md` | Related synthesis: short-term, long, memory | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Deep Learning with Long/deep_learning_with_long_manuscript.md` | Related synthesis: short-term, long, memory | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Long Short-Term Memory/long_short_term_memory_manuscript.md` | Related synthesis: short-term, long, memory | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 46,628 of 75,964 units from 75,967 PDFs.
...
- One-time focus: ML memory, stateful systems, and algorithmic research; matched categories ML memory; terms short term memory.
