---
title: "A Fast Algorithm for - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of A Fast Algorithm for Onboard Atmospheric Powered Descent Guidance."
...
primary_url: "https://arxiv.org/abs/2209.04157"
stable_identifier: "arXiv:2209.04157; DOI:10.1109/TAES.2023.3271961"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P472"
...
# A Fast Algorithm for - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2209.04157 | https://arxiv.org/abs/2209.04157 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2209.04157 rendering | https://arxiv.org/html/2209.04157 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2209.04157 | https://arxiv.org/pdf/2209.04157 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | A Mirror Descent-Based - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A Mirror Descent-Based/a_mirror_descent_based_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | A Multi-parameter - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-A Multi-parameter/a_multi_parameter_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | Earth-o1 A Grid-free - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Earth-o1 A Grid-free/earth_o1_a_grid_free_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P472` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Chen, Yushu; Yang, Guangwen; Wang, Lu; Gan, Qingzhong; Chen, Haipeng; Xu, Quanyong. Submitted/source date: 2022/09/09. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P472`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Atmospheric powered descent guidance (APDG) can be solved by successive convexification; however, its onboard application is impeded by …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Nonlinear aerodynamic forces complicate dynamics for reusable-rocket landing on earth or a planet with a thick atmosphere, which …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: algorithm, atmospheric, descent | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies algorithm, atmospheric, descent. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around algorithm, atmospheric, descent. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Atmospheric powered descent guidance (APDG) can be solved by successive convexification; however, its onboard application is impeded by …”. The full-paper rendering contains 51 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Nonlinear aerodynamic forces complicate dynamics for reusable-rocket landing on earth or a planet with a thick atmosphere, which …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Atmospheric powered descent guidance (APDG) can be solved by successive convexification; however, its onboard application is impeded by …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving algorithm, atmospheric, descent. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 69,508 of 75,964 units; duplicate exclusions 5; focus exclusions 17; source-gate exclusions 0; reselections 22.
...
- The related DEPs show how algorithm, atmospheric, descent connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: algorithm, atmospheric, descent.
...
|---|---|---|---|
| A Mirror Descent-Based - DEP-E | Related DEP | Overlap: descent, algorithm | `.lake-data/DEP-E/DEP-E-20260819-A Mirror Descent-Based/a_mirror_descent_based_manuscript.md` |
| A Multi-parameter - DEP-E | Related DEP | Overlap: descent, algorithm | `.lake-data/DEP-E/DEP-E-20260819-A Multi-parameter/a_multi_parameter_manuscript.md` |
| Earth-o1 A Grid-free - DEP-E | Related DEP | Overlap: atmospheric | `.lake-data/DEP-E/DEP-E-20260819-Earth-o1 A Grid-free/earth_o1_a_grid_free_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2209.04157 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2209.04157 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2209.04157 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-A Mirror Descent-Based/a_mirror_descent_based_manuscript.md` | Related synthesis: descent, algorithm | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-A Multi-parameter/a_multi_parameter_manuscript.md` | Related synthesis: descent, algorithm | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Earth-o1 A Grid-free/earth_o1_a_grid_free_manuscript.md` | Related synthesis: atmospheric | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 69,508 of 75,964 units from 75,967 PDFs.
