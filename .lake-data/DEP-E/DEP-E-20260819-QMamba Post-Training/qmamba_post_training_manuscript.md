---
title: "QMamba Post-Training - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of QMamba: Post-Training Quantization for Vision State Space Models."
...
primary_url: "https://arxiv.org/abs/2501.13624"
stable_identifier: "arXiv:2501.13624; DOI:10.48550/arXiv.2501.13624"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P493"
...
# QMamba Post-Training - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2501.13624 | https://arxiv.org/abs/2501.13624 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2501.13624 rendering | https://arxiv.org/html/2501.13624 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2501.13624 | https://arxiv.org/pdf/2501.13624 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | VideoWeave - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260709-VideoWeave Geometry/videoweave_geometry_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S5 | S3MOT Monocular 3D Object - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260818-S3MOT Monocular 3D Object/s3mot_monocular_3d_object_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S6 | CMamba Learned Image - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260812-CMamba Learned Image/cmamba_learned_image_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P493` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Li, Yinglong; Liu, Xiaoyu; Li, Jiacheng; Xu, Ruikang; Chen, Yinda; Xiong, Zhiwei. Submitted/source date: 2025/01/23. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P493`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: post-training, space, state, vision | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies post-training, qmamba, quantization. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around post-training, qmamba, quantization. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving post-training, qmamba, quantization. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 59,959 of 75,964 units; duplicate exclusions 5; focus exclusions 13; source-gate exclusions 0; reselections 18.
...
- The related DEPs show how post-training, space, state, vision connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: post-training, space, state, vision.
...
|---|---|---|---|
| VideoWeave - DEP-E | Related DEP | Overlap: post-training, space, state | `.lake-data/DEP-E/DEP-E-20260709-VideoWeave Geometry/videoweave_geometry_manuscript.md` |
| S3MOT Monocular 3D Object - DEP-E | Related DEP | Overlap: space, state, vision | `.lake-data/DEP-E/DEP-E-20260818-S3MOT Monocular 3D Object/s3mot_monocular_3d_object_manuscript.md` |
| CMamba Learned Image - DEP-E | Related DEP | Overlap: space, state | `.lake-data/DEP-E/DEP-E-20260812-CMamba Learned Image/cmamba_learned_image_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2501.13624 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2501.13624 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2501.13624 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260709-VideoWeave Geometry/videoweave_geometry_manuscript.md` | Related synthesis: post-training, space, state | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260818-S3MOT Monocular 3D Object/s3mot_monocular_3d_object_manuscript.md` | Related synthesis: space, state, vision | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260812-CMamba Learned Image/cmamba_learned_image_manuscript.md` | Related synthesis: space, state | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 59,959 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 5; focus exclusions: 13; source-gate exclusions: 0; reselections: 18; 24-hour cutoff: 2026-08-18.
