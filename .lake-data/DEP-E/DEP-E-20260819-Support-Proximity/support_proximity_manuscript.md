---
title: "Support-Proximity - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Support-Proximity Augmented Diffusion Estimation for Offline Black-Box Optimization."
...
primary_url: "https://arxiv.org/abs/2605.11246"
stable_identifier: "arXiv:2605.11246; DOI:10.48550/arXiv.2605.11246"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P441"
...
# Support-Proximity - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2605.11246 | https://arxiv.org/abs/2605.11246 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2605.11246 rendering | https://arxiv.org/html/2605.11246 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2605.11246 | https://arxiv.org/pdf/2605.11246 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P441` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Yang, Yonghan; Yuan, Ye; Sun, Zipeng; Du, Linfeng; He, Bowei; Wu, Haolun; Chen, Can; Liu, Xue. Submitted/source date: 2026/05/11. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P441`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: augmented, black-box, diffusion, estimation, offline | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies augmented, black-box, diffusion. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around augmented, black-box, diffusion. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “the inspected method sections”. The full-paper rendering contains 97 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving augmented, black-box, diffusion. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 65,879 of 75,964 units; duplicate exclusions 2; focus exclusions 19; source-gate exclusions 0; reselections 21.
...
- The related DEPs show how augmented, black-box, diffusion, estimation, offline connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: augmented, black-box, diffusion, estimation, offline.
...
|---|---|---|---|
| Stable Diffusion Depth - DEP-E | Related DEP | Overlap: estimation, diffusion, augmented, offline | `.lake-data/DEP-E/DEP-E-20260718-Stable Diffusion Depth/stable_diffusion_depth_manuscript.md` |
| Black-Box Prompt - DEP-E | Related DEP | Overlap: black-box, optimization, offline | `.lake-data/DEP-E/DEP-E-20260819-Black-Box Prompt/black_box_prompt_manuscript.md` |
| Distributed Evolution - DEP-E | Related DEP | Overlap: black-box, optimization, offline | `.lake-data/DEP-E/DEP-E-20260819-Distributed Evolution/distributed_evolution_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2605.11246 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2605.11246 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2605.11246 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260718-Stable Diffusion Depth/stable_diffusion_depth_manuscript.md` | Related synthesis: estimation, diffusion, augmented, offline | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Black-Box Prompt/black_box_prompt_manuscript.md` | Related synthesis: black-box, optimization, offline | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Distributed Evolution/distributed_evolution_manuscript.md` | Related synthesis: black-box, optimization, offline | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 65,879 of 75,964 units from 75,967 PDFs.
