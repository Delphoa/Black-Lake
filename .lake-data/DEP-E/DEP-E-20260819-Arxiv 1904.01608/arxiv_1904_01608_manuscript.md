---
title: "arXiv 1904.01608 - DEP-E"
generated_at: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of [1904.01608] Structural Scaffolds for Citation Intent Classification in Scientific Publications."
...
primary_url: "https://arxiv.org/abs/1904.01608"
stable_identifier: "arXiv:1904.01608"
...
# arXiv 1904.01608 - DEP-E

## Source Metadata

| Field | Value |
|---|---|
| Paper title | [1904.01608] Structural Scaffolds for Citation Intent Classification in Scientific Publications |
| Authors | Not available from inspected sources |
| Platform | arXiv |
| arXiv ID | 1904.01608 |
| Revision/publication date | Not available from inspected sources |
| Primary URLs | https://arxiv.org/abs/1904.01608; https://arxiv.org/html/1904.01608; https://arxiv.org/pdf/1904.01608 |
...
|---|---|---|---|---|---|---|
| E1 | https://arxiv.org/html/1904.01608 | Primary paper HTML | Full-paper title, abstract, headings, method/evidence text, and limitations cues | Research object, method, evidence, and reviewer notes | High | Text extraction may omit visual layout and fine-grained table context. |
| E2 | https://arxiv.org/pdf/1904.01608 | Primary paper PDF | PDF integrity gate and source-presence cross-check | Complete-source status | High | No independent reproduction or figure-by-figure audit in this batch pass. |
| E3 | https://arxiv.org/abs/1904.01608 | Canonical metadata record | arXiv identifier and public locator | Stable identity and provenance | High | Abstract page is metadata only and was not treated as the full paper. |

## Executive Summary

The reviewed paper, *[1904.01608] Structural Scaffolds for Citation Intent Classification in Scientific Publications*, addresses a research problem described in its full-paper HTML as follows: Abstract Identifying the intent of a citation in scientific papers (e.g., background information, use of methods, comparing results ) is critical for machine reading of individual publications and automated analysis of the scientific literature. We propose structural scaffolds, a multitask model to incorporate structural information of scientific papers into citations for effective classification of citation intents. Our model achieves a new state-of-the-art on an existing ACL anthology dataset (ACL-ARC) with a 13.3% absolute increase in F1 score, without relying on external linguistic resources or hand-engineered features as done in existing methods. In addition, we introduce a new dataset of citation intents (SciCite) which is more than five times larger and covers multiple scientific domains compared with existing datasets. Our code and data are available at: https://github.com/allenai/scicite . The source presents the paper's contribution through the following visible section structure: Structural Scaffolds for Citation Intent Classification in Scientific Publications, Abstract, 1 Introduction, 2 Model, 2.1 Structural scaffolds, Citation worthiness., Section title., Multitask formulation., 2.2 Training, 3 Data, 3.1 ACL-ARC citations dataset, 3.2 SciCite dataset. Reviewer interpretation: the work is most useful as a source-grounded design or evaluation reference, while the exact strength of its claims depends on the experiments, datasets, baselines, and boundary conditions reported in the paper. Full-paper source integrity passed; independent reproduction was not performed.

## Detailed Summary

### Problem and contribution

The paper frames its problem and motivation in the primary source. The extracted abstract is: Abstract Identifying the intent of a citation in scientific papers (e.g., background information, use of methods, comparing results ) is critical for machine reading of individual publications and automated analysis of the scientific literature. We propose structural scaffolds, a multitask model to incorporate structural information of scientific papers into citations for effective classification of citation intents. Our model achieves a new state-of-the-art on an existing ACL anthology dataset (ACL-ARC) with a 13.3% absolute increase in F1 score, without relying on external linguistic resources or hand-engineered features as done in existing methods. In addition, we introduce a new dataset of citation intents (SciCite) which is more than five times larger and covers multiple scientific domains compared with existing datasets. Our code and data are available at: https://github.com/allenai/scicite .

### Method and mechanism

The full-paper text contains the following method-related evidence: [1904.01608] Structural Scaffolds for Citation Intent Classification in Scientific Publications Structural Scaffolds for Citation Intent Classification in Scientific Publications Arman Cohan Waleed Ammar Madeleine van Zuylen Field Cady Allen Institute for Artificial Intelligence {armanc,waleeda,madeleinev,fieldc}@allenai.org Abstract Identifying the intent of a citation in scientific papers (e.g., background... The available heading structure is retained as a navigation aid rather than treated as proof of every technical claim.

### Evidence and results

Evidence-related text includes: [1904.01608] Structural Scaffolds for Citation Intent Classification in Scientific Publications Structural Scaffolds for Citation Intent Classification in Scientific Publications Arman Cohan Waleed Ammar Madeleine van Zuylen Field Cady Allen Institute for Artificial Intelligence {armanc,waleeda,madeleinev,fieldc}@allenai.org Abstract Identifying the intent of a citation in scientific papers (e.g., background... Exact metrics and comparisons should be checked against the paper's tables and figures before making deployment decisions.

### Limitations and conclusion

Limitation-related text includes: Dataset Categories (distribution) Source #papers #instances ACL-ARC Background (0.51) Extends (0.04) Uses (0.19) Motivation (0.05) Compare/Contrast (0.18) Future work (0.04) Computational Linguistics 186 1,941 \hdashline SciCite Background (0.58) Method (0.29) Result comparison (0.13) Computer Science & Medicine 6,627 11,020 Table 2: Characteristics of SciCite compared with ACL-ARC dataset by Jurgens et al. To... Where the source did not expose a clear limitation in the extracted text, this review records the gap rather than inferring that no limitation exists.
...
- `Sources inspected`: The local verified full-paper PDF and full-paper HTML for arXiv:1904.01608; canonical arXiv metadata URL; three existing Black Lake DEP entries for related context.
...
- `Batch selection`: 75967 PDF candidates; 894 integrity-valid source units; 865 valid identified IDs; 2084 IDs found in repository/memory dedup scans; 396 duplicate exclusions; 0 reselections; 469 unseen eligible IDs; this item is sample position 11 of 200.
...
- `Temporal boundary`: Public deposition date 2026-08-19; source version is the locally archived arXiv version identified as 1904.01608.
...
|---|---|---|---|---|
| S1 | https://arxiv.org/html/1904.01608 | Full-paper text and section-level review | 2026-08-19 | Primary public locator; source file withheld locally. |
| S2 | https://arxiv.org/pdf/1904.01608 | PDF/source integrity status | 2026-08-19 | Primary public locator; source file withheld locally. |
| S3 | https://arxiv.org/abs/1904.01608 | Canonical metadata and stable identifier | 2026-08-19 | Metadata page only; not treated as the paper document. |
