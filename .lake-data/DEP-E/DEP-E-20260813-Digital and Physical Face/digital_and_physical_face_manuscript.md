---
title: "Digital and Physical Face - DEP-E"
generated_at: "2026-08-13 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Digital and Physical Face Attacks: Reviewing and One Step Further."
...
primary_url: "https://arxiv.org/abs/2209.14692"
stable_identifier: "arXiv:2209.14692; DOI:10.48550/arXiv.2209.14692"
deployment_job_id: "BLAD-2200-20260813-F994AA5E"
deployment_item_id: "BLAD-2200-20260813-F994AA5E-P03"
...
# Digital and Physical Face - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2209.14692 | https://arxiv.org/abs/2209.14692 | Metadata only. | 2026-08-13 | Inspected |
| S2 | Full paper | Primary | HTML | 2209.14692 rendering | https://arxiv.org/html/2209.14692 | Verified local copy withheld. | 2026-08-13 | Inspected in full |
| S3 | PDF | Primary | PDF | 2209.14692 | https://arxiv.org/pdf/2209.14692 | Verified local copy withheld. | 2026-08-13 | Integrity checked and sampled |
| S4 | Stealthy Jailbreak - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260804-Stealthy Jailbreak/stealthy_jailbreak_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S5 | GADT Enhancing - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260731-GADT Enhancing/gadt_enhancing_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S6 | APB2Face Safety Review - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-APB2Face Safety/apb2face_safety_manuscript.md` | Synthesis only. | 2026-08-13 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260813-F994AA5E-P03` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-13 | Verified |

Authors: Kong, Chenqi; Wang, Shiqi; Li, Haoliang. Submitted/source date: 2022/09/29. Job `BLAD-2200-20260813-F994AA5E`; item `BLAD-2200-20260813-F994AA5E-P03`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Face presentation attacks can be generally divided into two categories: obfuscation attacks and impersonation attacks. As shown in …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “With the rapid progress over the past five years, face authentication has become the most pervasive biometric recognition …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: attacks, digital, face, one | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies attacks, digital, face. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around attacks, digital, face. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Face presentation attacks can be generally divided into two categories: obfuscation attacks and impersonation attacks. As shown in …”. The full-paper rendering contains 64 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “With the rapid progress over the past five years, face authentication has become the most pervasive biometric recognition …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “With the rapid progress over the past five years, face authentication has become the most pervasive biometric recognition …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving attacks, digital, face. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 28,387 of 75,964 units; duplicate exclusions 0; source-gate exclusions 1; reselections 1.
...
- The related DEPs show how attacks, digital, face, one connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: attacks, digital, face, one.
...
|---|---|---|---|
| Stealthy Jailbreak - DEP-E | Related DEP | Overlap: attacks, face, one | `.lake-data/DEP-E/DEP-E-20260804-Stealthy Jailbreak/stealthy_jailbreak_manuscript.md` |
| GADT Enhancing - DEP-E | Related DEP | Overlap: attacks, one | `.lake-data/DEP-E/DEP-E-20260731-GADT Enhancing/gadt_enhancing_manuscript.md` |
| APB2Face Safety Review - DEP-E | Related DEP | Overlap: face, digital | `.lake-data/DEP-E/DEP-E-20260720-APB2Face Safety/apb2face_safety_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2209.14692 | Metadata and abstract | 2026-08-13 | Metadata only |
| R2 | https://arxiv.org/html/2209.14692 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-13 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2209.14692 | Primary paper integrity | 2026-08-13 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260804-Stealthy Jailbreak/stealthy_jailbreak_manuscript.md` | Related synthesis: attacks, face, one | 2026-08-13 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260731-GADT Enhancing/gadt_enhancing_manuscript.md` | Related synthesis: attacks, one | 2026-08-13 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260720-APB2Face Safety/apb2face_safety_manuscript.md` | Related synthesis: face, digital | 2026-08-13 | Repository-relative |

## Appendix

- Uniform selected index: 28,387 of 75,964 units from 75,967 PDFs.
...
- Duplicate exclusions: 0; source-gate exclusions: 1; reselections: 1; 24-hour cutoff: 2026-08-12.
