---
title: "4 Adic Complexity Review - DEP-E"
generated_at: "2026-07-21 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of The 4-Adic Complexity of Interleaved Quaternary Sequences of Even Length with Optimal Autocorrelation."
...
primary_url: "https://arxiv.org/abs/2209.10279"
stable_identifier: "arXiv:2209.10279; DOI:10.48550/arXiv.2209.10279"
deployment_job_id: "BLAD-2200-20260721-F7EDC854"
deployment_item_id: "BLAD-2200-20260721-F7EDC854-P02"
...
# 4 Adic Complexity Review - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2209.10279 | https://arxiv.org/abs/2209.10279 | Metadata only. | 2026-07-21 | Inspected |
| S2 | Full paper | Primary | HTML | 2209.10279 rendering | https://ar5iv.labs.arxiv.org/html/2209.10279 | Verified local copy withheld. | 2026-07-21 | Inspected in full |
| S3 | PDF | Primary | PDF | 2209.10279 | https://arxiv.org/pdf/2209.10279 | Verified local copy withheld. | 2026-07-21 | Integrity checked |
| S4 | Context Backdoor Defense - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260720-Context Backdoor/context_backdoor_defense_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S5 | Integrals and Rigidity - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260717-Integrals and Rigidity/integrals_and_rigidity_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S6 | Adversarial Label Noise - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260716-Adversarial Label Noise/adversarial_label_noise_manuscript.md` | Synthesis only. | 2026-07-21 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260721-F7EDC854-P02` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-21 | Verified |

Authors: Jing, Xiaoyan; Xu, Zhefeng; Yang, Minghui; Feng, Keqin. Submitted/source date: 2022/09/21. Job `BLAD-2200-20260721-F7EDC854`; item `BLAD-2200-20260721-F7EDC854-P02`.
...
| E2 | S2/S3 | Primary paper | Problem framing around sequences, quaternary, complexity | Research objective | High for transcription | Source framing is not independent validation |
| E3 | S2/S3 | Primary paper | Method and evaluation narrative associated with the proposed method | Mechanism and author-reported results | Medium-high | Experiments were not rerun |
...
This paper studies sequences, quaternary, complexity and presents the proposed method as its central contribution. The inspected full paper connects the method to interleaved, length, optimal and reports empirical or analytical support in its chosen setting. The review preserves those claims as source-reported evidence. It does not claim independent reproduction, current operational validity, or deployment readiness. The main downstream value is a versioned evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

The research object is *The 4-Adic Complexity of Interleaved Quaternary Sequences of Even Length with Optimal Autocorrelation*. Its problem framing concentrates on sequences, quaternary, complexity. The paper positions the proposed method as a way to organize or improve the relevant mechanism and connects the proposal to interleaved, length, optimal.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a meaningful problem involving sequences, quaternary, complexity. | Author claim | E2 | Directly supported as source framing; practical importance depends on target context. | Medium-high |
| C2 | the proposed method is the source's principal mechanism or contribution. | Source-supported mechanism | E3 | Supported by the inspected method narrative. | High for transcription |
...
- `Temporal boundary`: Paper and repository context inspected on 2026-07-21.
...
2. **Frozen comparison harness:** evaluate the proposed method and simple baselines under a versioned split manifest.
...
|---|---|---|---|
| Context Backdoor Defense - DEP-E | Related DEP | Related representation, evidence, or implementation lens | `.lake-data/DEP-E/DEP-E-20260720-Context Backdoor/context_backdoor_defense_manuscript.md` |
| Integrals and Rigidity - DEP-E | Related DEP | Related representation, evidence, or implementation lens | `.lake-data/DEP-E/DEP-E-20260717-Integrals and Rigidity/integrals_and_rigidity_manuscript.md` |
| Adversarial Label Noise - DEP-E | Related DEP | Related representation, evidence, or implementation lens | `.lake-data/DEP-E/DEP-E-20260716-Adversarial Label Noise/adversarial_label_noise_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2209.10279 | Metadata and abstract | 2026-07-21 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/2209.10279 | Full-paper method and evidence | 2026-07-21 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2209.10279 | Primary paper integrity | 2026-07-21 | Verified local copy withheld |
| R4 | https://doi.org/10.48550/arXiv.2209.10279 | Publisher identifier | 2026-07-21 | DOI locator |
| R5 | `.lake-data/DEP-E/DEP-E-20260720-Context Backdoor/context_backdoor_defense_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260717-Integrals and Rigidity/integrals_and_rigidity_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |
| R7 | `.lake-data/DEP-E/DEP-E-20260716-Adversarial Label Noise/adversarial_label_noise_manuscript.md` | Related synthesis | 2026-07-21 | Repository-relative |

## Appendix

Uniform selected index 64,478 of 75,776 units from 75,779 PDFs; duplicate exclusions 0; reselections 0. The complete-source gate passed after one bounded archive repair. Source documents and companion integrity records remain local; none was staged or uploaded.
