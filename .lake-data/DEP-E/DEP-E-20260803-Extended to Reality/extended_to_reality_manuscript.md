---
title: "Extended to Reality - DEP-E"
generated_at: "2026-08-03 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Extended to Reality: Prompt Injection in 3D Environments."
...
primary_url: "https://arxiv.org/abs/2602.07104"
stable_identifier: "arXiv:2602.07104; DOI:10.48550/arXiv.2602.07104"
deployment_job_id: "BLAD-2200-20260803-11C1283E"
deployment_item_id: "BLAD-2200-20260803-11C1283E-P08"
...
# Extended to Reality - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2602.07104 | https://arxiv.org/abs/2602.07104 | Metadata only. | 2026-08-03 | Inspected |
| S2 | Full paper | Primary | HTML | 2602.07104 rendering | https://arxiv.org/html/2602.07104 | Verified local copy withheld. | 2026-08-03 | Inspected in full |
| S3 | PDF | Primary | PDF | 2602.07104 | https://arxiv.org/pdf/2602.07104 | Verified local copy withheld. | 2026-08-03 | Integrity checked and sampled |
| S4 | Efficient FM Survey - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` | Synthesis only. | 2026-08-03 | Inspected |
| S5 | Telecom AI Roadmap - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260711-Telecom AI Roadmap/telecom_ai_roadmap_manuscript.md` | Synthesis only. | 2026-08-03 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260803-11C1283E-P08` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-03 | Verified |

Authors: Li, Zhuoheng; Chen, Ying. Submitted/source date: 2026/02/06. Job `BLAD-2200-20260803-11C1283E`; item `BLAD-2200-20260803-11C1283E-P08`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “To answer the above research question, in this paper, we study prompt injection in 3D environments against MLLMs, …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Multimodal large language models (MLLMs) have advanced the capabilities to interpret and act on visual input in 3D …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: agents, environments, injection, instruction, orchestration | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies environments, extended, injection. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around environments, extended, injection. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “To answer the above research question, in this paper, we study prompt injection in 3D environments against MLLMs, …”. The full-paper rendering contains 75 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Multimodal large language models (MLLMs) have advanced the capabilities to interpret and act on visual input in 3D …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Physical-world risks. Machine learning models are shown to be vulnerable to physical world attacks in various applications, including …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving environments, extended, injection. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 40,924 of 75,957 units; duplicate exclusions 0; source-gate exclusions 0; reselections 0.
...
- The related DEPs show how agents, environments, injection, instruction, orchestration connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: agents, environments, injection, instruction, orchestration.
...
|---|---|---|---|
| Efficient FM Survey - DEP-E | Related DEP | Overlap: reality, orchestration, workflows, agents, tools | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` |
| Telecom AI Roadmap - DEP-E | Related DEP | Overlap: instruction, workflows, injection, tools, environments | `.lake-data/DEP-E/DEP-E-20260711-Telecom AI Roadmap/telecom_ai_roadmap_manuscript.md` |
| PIArena Evaluation - DEP-E | Related DEP | Overlap: instruction, workflows, injection, agents, environments | `.lake-data/DEP-E/DEP-E-20260716-PIArena Evaluation/piarena_evaluation_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2602.07104 | Metadata and abstract | 2026-08-03 | Metadata only |
| R2 | https://arxiv.org/html/2602.07104 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-03 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2602.07104 | Primary paper integrity | 2026-08-03 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260718-Efficient FM Survey/efficient_fm_survey_manuscript.md` | Related synthesis: reality, orchestration, workflows, agents, tools | 2026-08-03 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260711-Telecom AI Roadmap/telecom_ai_roadmap_manuscript.md` | Related synthesis: instruction, workflows, injection, tools, environments | 2026-08-03 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260716-PIArena Evaluation/piarena_evaluation_manuscript.md` | Related synthesis: instruction, workflows, injection, agents, environments | 2026-08-03 | Repository-relative |

## Appendix

- Uniform selected index: 40,924 of 75,957 units from 75,960 PDFs.
