---
title: "OMAD Object Model with - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of OMAD: Object Model with Articulated Deformations for Pose Estimation and Retrieval."
...
primary_url: "https://arxiv.org/abs/2112.07334"
stable_identifier: "arXiv:2112.07334; DOI:10.48550/arXiv.2112.07334"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P58"
...
# OMAD Object Model with - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2112.07334 | https://arxiv.org/abs/2112.07334 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2112.07334 rendering | https://arxiv.org/html/2112.07334 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2112.07334 | https://arxiv.org/pdf/2112.07334 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Vid2Curve Reconstruction - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction/vid2curve_reconstruction_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P58` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Xue, Han; Liu, Liu; Xu, Wenqiang; Fu, Haoyuan; Lu, Cewu. Submitted/source date: 2021/12/14. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P58`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “Articulated objects are pervasive in daily life. However, due to the intrinsic high-DoF structure, the joint states of …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “Articulated objects are pervasive in daily life. However, due to the intrinsic high-DoF structure, the joint states of …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: estimation, object, pose | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies articulated, deformations, estimation. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around articulated, deformations, estimation. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “Articulated objects are pervasive in daily life. However, due to the intrinsic high-DoF structure, the joint states of …”. The full-paper rendering contains 46 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “Articulated objects are pervasive in daily life. However, due to the intrinsic high-DoF structure, the joint states of …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “Articulated objects are pervasive in daily life. However, due to the intrinsic high-DoF structure, the joint states of …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving articulated, deformations, estimation. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 60,433 of 75,964 units; duplicate exclusions 0; focus exclusions 7; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how estimation, object, pose connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: estimation, object, pose.
...
|---|---|---|---|
| Vid2Curve Reconstruction - DEP-E | Related DEP | Overlap: estimation, pose, object | `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction/vid2curve_reconstruction_manuscript.md` |
| LA-Pose Latent Action - DEP-E | Related DEP | Overlap: estimation, pose | `.lake-data/DEP-E/DEP-E-20260713-LA-Pose Latent Action/la_pose_latent_action_manuscript.md` |
| IKOL Inverse kinematics - DEP-E | Related DEP | Overlap: estimation, pose | `.lake-data/DEP-E/DEP-E-20260819-IKOL Inverse kinematics/ikol_inverse_kinematics_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2112.07334 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2112.07334 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2112.07334 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260803-Vid2Curve Reconstruction/vid2curve_reconstruction_manuscript.md` | Related synthesis: estimation, pose, object | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260713-LA-Pose Latent Action/la_pose_latent_action_manuscript.md` | Related synthesis: estimation, pose | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-IKOL Inverse kinematics/ikol_inverse_kinematics_manuscript.md` | Related synthesis: estimation, pose | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 60,433 of 75,964 units from 75,967 PDFs.
