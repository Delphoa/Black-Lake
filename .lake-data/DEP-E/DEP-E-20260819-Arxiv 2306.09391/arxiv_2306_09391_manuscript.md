---
title: "arXiv 2306.09391 - DEP-E"
generated_at: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Multi-omics Prediction from High-content Cellular Imaging with Deep Learning."
...
primary_url: "https://arxiv.org/abs/2306.09391"
stable_identifier: "arXiv:2306.09391"
...
# arXiv 2306.09391 - DEP-E

## Source Metadata

| Field | Value |
|---|---|
| Paper title | Multi-omics Prediction from High-content Cellular Imaging with Deep Learning |
| Authors | Not available from inspected sources |
| Platform | arXiv |
| arXiv ID | 2306.09391 |
| Revision/publication date | Not available from inspected sources |
| Primary URLs | https://arxiv.org/abs/2306.09391; https://arxiv.org/html/2306.09391; https://arxiv.org/pdf/2306.09391 |
...
|---|---|---|---|---|---|---|
| E1 | https://arxiv.org/html/2306.09391 | Primary paper HTML | Full-paper title, abstract, headings, method/evidence text, and limitations cues | Research object, method, evidence, and reviewer notes | High | Text extraction may omit visual layout and fine-grained table context. |
| E2 | https://arxiv.org/pdf/2306.09391 | Primary paper PDF | PDF integrity gate and source-presence cross-check | Complete-source status | High | No independent reproduction or figure-by-figure audit in this batch pass. |
| E3 | https://arxiv.org/abs/2306.09391 | Canonical metadata record | arXiv identifier and public locator | Stable identity and provenance | High | Abstract page is metadata only and was not treated as the full paper. |

## Executive Summary

The reviewed paper, *Multi-omics Prediction from High-content Cellular Imaging with Deep Learning*, addresses a research problem described in its full-paper HTML as follows: High-content cellular imaging, transcriptomics, and proteomics data provide rich and complementary views on the molecular layers of biology that influence cellular states ... The source presents the paper's contribution through the following visible section structure: Multi-omics Prediction from High-content Cellular Imaging with Deep Learning, 1 Abstract, 2 Introduction, 3 Results, Image2Omics., Predictability by gene product., Predictability by subcellular localisation., Predictability by pathway membership, number of modes of the measurement distribution, and abundance., Qualitative analysis of feature importance., Cell image embedding., 4 Discussion, Limitations.. Reviewer interpretation: the work is most useful as a source-grounded design or evaluation reference, while the exact strength of its claims depends on the experiments, datasets, baselines, and boundary conditions reported in the paper. Full-paper source integrity passed; independent reproduction was not performed.

## Detailed Summary

### Problem and contribution

The paper frames its problem and motivation in the primary source. The extracted abstract is: High-content cellular imaging, transcriptomics, and proteomics data provide rich and complementary views on the molecular layers of biology that influence cellular states ...

### Method and mechanism

The full-paper text contains the following method-related evidence: 5 Materials and methods 5.1 Data Acquisition 5.1.1 Library selection 5.1.2 High-throughput 3’ RNA-seq 5.1.3 Proteomics 5.1.4 LC-MS/MS analysis of proteomics samples 5.1.5 Protein Identification and quantification 5.2 Automated High-Content Imaging 5.3 Image2Omics 5.3.1 Image Preprocessing 5.3.2 Backbone Pre-training 5.3.3 Multi-omics Fine-tuning 5.3.4 Inference 5.3.5 Potential integration of Image2Omics into... The available heading structure is retained as a navigation aid rather than treated as proof of every technical claim.

### Evidence and results

Evidence-related text includes: Multi-omics Prediction from High-content Cellular Imaging with Deep Learning 1 Abstract 2 Introduction 3 Results Image2Omics. 5 Materials and methods 5.1 Data Acquisition 5.1.1 Library selection 5.1.2 High-throughput 3’ RNA-seq 5.1.3 Proteomics 5.1.4 LC-MS/MS analysis of proteomics samples 5.1.5 Protein Identification and quantification 5.2 Automated High-Content Imaging 5.3 Image2Omics 5.3.1 Image Preprocessing... Exact metrics and comparisons should be checked against the paper's tables and figures before making deployment decisions.

### Limitations and conclusion

Limitation-related text includes: 4 Discussion Limitations. Given the shared information content in cellular images and omics measurements, potential avenues for future work could be in exploring the inverse task of generating images from multi-omics measurements [ 20 , 41 ] . Where the source did not expose a clear limitation in the extracted text, this review records the gap rather than inferring that no limitation exists.
...
- `Sources inspected`: The local verified full-paper PDF and full-paper HTML for arXiv:2306.09391; canonical arXiv metadata URL; three existing Black Lake DEP entries for related context.
...
- `Batch selection`: 75967 PDF candidates; 894 integrity-valid source units; 865 valid identified IDs; 2084 IDs found in repository/memory dedup scans; 396 duplicate exclusions; 0 reselections; 469 unseen eligible IDs; this item is sample position 124 of 200.
...
- `Temporal boundary`: Public deposition date 2026-08-19; source version is the locally archived arXiv version identified as 2306.09391.
...
|---|---|---|---|
| DEP-A-20260806-Multi scale Deep Intake | .lake-data/DEP-A/DEP-A-20260806-Multi scale Deep Intake | Shared terms: multi, deep | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260806-Multi%20scale%20Deep%20Intake/README.md |
| DEP-E-20260805-Multi-scale Deep Neural | .lake-data/DEP-E/DEP-E-20260805-Multi-scale Deep Neural | Shared terms: multi, deep | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260805-Multi-scale%20Deep%20Neural/README.md |
...
|---|---|---|---|---|
| S1 | https://arxiv.org/html/2306.09391 | Full-paper text and section-level review | 2026-08-19 | Primary public locator; source file withheld locally. |
| S2 | https://arxiv.org/pdf/2306.09391 | PDF/source integrity status | 2026-08-19 | Primary public locator; source file withheld locally. |
| S3 | https://arxiv.org/abs/2306.09391 | Canonical metadata and stable identifier | 2026-08-19 | Metadata page only; not treated as the paper document. |
| S4 | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260806-Multi%20scale%20Deep%20Intake/README.md | Related DEP context: multi, deep | 2026-08-19 | Repository file used for conceptual context. |
| S5 | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260805-Multi-scale%20Deep%20Neural/README.md | Related DEP context: multi, deep | 2026-08-19 | Repository file used for conceptual context. |
...
- https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260806-Multi%20scale%20Deep%20Intake/README.md — repository context entry `.lake-data/DEP-A/DEP-A-20260806-Multi scale Deep Intake`; selected for conceptual overlap indicated by multi, deep; not used as primary evidence.
- https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260805-Multi-scale%20Deep%20Neural/README.md — repository context entry `.lake-data/DEP-E/DEP-E-20260805-Multi-scale Deep Neural`; selected for conceptual overlap indicated by multi, deep; not used as primary evidence.
