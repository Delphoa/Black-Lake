---
title: "NEO Saving GPU Memory - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of NEO: Saving GPU Memory Crisis with CPU Offloading for Online LLM Inference."
...
primary_url: "https://arxiv.org/abs/2411.01142"
stable_identifier: "arXiv:2411.01142; DOI:10.48550/arXiv.2411.01142"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P438"
...
# NEO Saving GPU Memory - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2411.01142 | https://arxiv.org/abs/2411.01142 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2411.01142 rendering | https://arxiv.org/html/2411.01142 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2411.01142 | https://arxiv.org/pdf/2411.01142 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
| S4 | Make LLM Inference - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Make LLM Inference/make_llm_inference_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
...
| S6 | Energy-Constrained - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Energy-Constrained/energy_constrained_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P438` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Jiang, Xuanlin; Zhou, Yang; Cao, Shiyi; Stoica, Ion; Yu, Minlan. Submitted/source date: 2024/11/02. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P438`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: gpu, inference, llm, memory, offloading | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies cpu, crisis, gpu. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around cpu, crisis, gpu. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving cpu, crisis, gpu. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 33,517 of 75,964 units; duplicate exclusions 1; focus exclusions 6; source-gate exclusions 0; reselections 7.
...
- The related DEPs show how gpu, inference, llm, memory, offloading connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: gpu, inference, llm, memory, offloading.
...
|---|---|---|---|
| Make LLM Inference - DEP-E | Related DEP | Overlap: gpu, llm, inference, memory | `.lake-data/DEP-E/DEP-E-20260819-Make LLM Inference/make_llm_inference_manuscript.md` |
| Analysis and Optimization - DEP-E | Related DEP | Overlap: offloading, memory | `.lake-data/DEP-E/DEP-E-20260819-Analysis and Optimization/analysis_and_optimization_manuscript.md` |
| Energy-Constrained - DEP-E | Related DEP | Overlap: offloading, memory | `.lake-data/DEP-E/DEP-E-20260819-Energy-Constrained/energy_constrained_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2411.01142 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2411.01142 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2411.01142 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Make LLM Inference/make_llm_inference_manuscript.md` | Related synthesis: gpu, llm, inference, memory | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Analysis and Optimization/analysis_and_optimization_manuscript.md` | Related synthesis: offloading, memory | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Energy-Constrained/energy_constrained_manuscript.md` | Related synthesis: offloading, memory | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 33,517 of 75,964 units from 75,967 PDFs.
