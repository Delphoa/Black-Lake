---
title: "arXiv 2303.10112 - DEP-E"
generated_at: "2026-08-19"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of [2303.10112] Causal Discovery from Temporal Data: An Overview and New Perspectives."
...
primary_url: "https://arxiv.org/abs/2303.10112"
stable_identifier: "arXiv:2303.10112"
...
# arXiv 2303.10112 - DEP-E

## Source Metadata

| Field | Value |
|---|---|
| Paper title | [2303.10112] Causal Discovery from Temporal Data: An Overview and New Perspectives |
| Authors | Not available from inspected sources |
| Platform | arXiv |
| arXiv ID | 2303.10112 |
| Revision/publication date | Not available from inspected sources |
| Primary URLs | https://arxiv.org/abs/2303.10112; https://arxiv.org/html/2303.10112; https://arxiv.org/pdf/2303.10112 |
...
|---|---|---|---|---|---|---|
| E1 | https://arxiv.org/html/2303.10112 | Primary paper HTML | Full-paper title, abstract, headings, method/evidence text, and limitations cues | Research object, method, evidence, and reviewer notes | High | Text extraction may omit visual layout and fine-grained table context. |
| E2 | https://arxiv.org/pdf/2303.10112 | Primary paper PDF | PDF integrity gate and source-presence cross-check | Complete-source status | High | No independent reproduction or figure-by-figure audit in this batch pass. |
| E3 | https://arxiv.org/abs/2303.10112 | Canonical metadata record | arXiv identifier and public locator | Stable identity and provenance | High | Abstract page is metadata only and was not treated as the full paper. |

## Executive Summary

The reviewed paper, *[2303.10112] Causal Discovery from Temporal Data: An Overview and New Perspectives*, addresses a research problem described in its full-paper HTML as follows: Abstract. Temporal data, representing chronological observations of complex systems, has always been a typical data structure that can be widely generated by many domains, such as industry, medicine and finance. Analyzing this type of data is extremely valuable for various applications. Thus, different temporal data analysis tasks, e.g. , classification, clustering and prediction, have been proposed in the past decades. Among them, causal discovery, learning the causal relations from temporal data, is considered an interesting yet critical task and has attracted much research attention. Existing causal discovery works can be divided into two highly correlated categories according to whether the temporal data is calibrated, i.e. , multivariate time series causal discovery, and event sequence causal discovery. However, most previous surveys are only focused on the time series causal discovery and ignore the second category. In this paper, we specify the correlation between the two categories and provide a systematical overview of existing solutions. Furthermore, we provide public datasets, evaluation metrics and new perspectives for temporal data causal discovery. The source presents the paper's contribution through the following visible section structure: Causal Discovery from Temporal Data: An Overview and New Perspectives, Abstract., 1. Introduction, 2. Background & preliminaries, 2.1. Key concepts and assumptions in causal discovery, 2.2. Causal Structure for Temporal Data, 2.3. Problem Definitions, 3. Causal Discovery from Multivariate Time Series, 3.1. Constraint-Based Approaches, 3.1.1. Methods with causal sufficiency, 3.1.2. Methods without causal sufficiency, 3.2. Score-Based Approaches. Reviewer interpretation: the work is most useful as a source-grounded design or evaluation reference, while the exact strength of its claims depends on the experiments, datasets, baselines, and boundary conditions reported in the paper. Full-paper source integrity passed; independent reproduction was not performed.

## Detailed Summary

### Problem and contribution

The paper frames its problem and motivation in the primary source. The extracted abstract is: Abstract. Temporal data, representing chronological observations of complex systems, has always been a typical data structure that can be widely generated by many domains, such as industry, medicine and finance. Analyzing this type of data is extremely valuable for various applications. Thus, different temporal data analysis tasks, e.g. , classification, clustering and prediction, have been proposed in the past decades. Among them, causal discovery, learning the causal relations from temporal data, is considered an interesting yet critical task and has attracted much research attention. Existing causal discovery works can be divided into two highly correlated categories according to whether the temporal data is calibrated, i.e. , multivariate time series causal discovery, and event sequence causal discovery. However, most previous surveys are only focused on the time series causal discovery and ignore the second category. In this paper, we specify the correlation between the two categories and provide a systematical overview of existing solutions. Furthermore, we provide public datasets, evaluation metrics and new perspectives for temporal data causal discovery.

### Method and mechanism

The full-paper text contains the following method-related evidence: The learned causal structures could be beneficial for explaining the data generation process and guiding the design of data analysis methods. Therefore, existing causal discovery methods can also be divided into two groups respectively. The available heading structure is retained as a navigation aid rather than treated as proof of every technical claim.

### Evidence and results

Evidence-related text includes: Furthermore, we provide public datasets, evaluation metrics and new perspectives for temporal data causal discovery. , 2022b ) Yes Yes Yes Yes No No A recent and comprehensive review for causal discovery in time series with comparative evaluations Ours Yes Yes Yes Yes Yes Yes A systematic review of causal discovery in both MTS and event sequence, with new perspectives Recently, many surveys (Glymour et al . Exact metrics and comparisons should be checked against the paper's tables and figures before making deployment decisions.

### Limitations and conclusion

Limitation-related text includes: , constraint-based methods, score-based methods, functional causal model (FCM)-based methods and Granger causality-based methods. In accordance with the MTS task, we classify the corresponding methods into three main categories: constraint-based, score-based, and Granger causality-based methods. Where the source did not expose a clear limitation in the extracted text, this review records the gap rather than inferring that no limitation exists.
...
- `Sources inspected`: The local verified full-paper PDF and full-paper HTML for arXiv:2303.10112; canonical arXiv metadata URL; three existing Black Lake DEP entries for related context.
...
- `Batch selection`: 75967 PDF candidates; 894 integrity-valid source units; 865 valid identified IDs; 2084 IDs found in repository/memory dedup scans; 396 duplicate exclusions; 0 reselections; 469 unseen eligible IDs; this item is sample position 44 of 200.
...
- `Temporal boundary`: Public deposition date 2026-08-19; source version is the locally archived arXiv version identified as 2303.10112.
...
|---|---|---|---|
| DEP-A-20260731-Representing data Intake | .lake-data/DEP-A/DEP-A-20260731-Representing data Intake | Shared terms: data, representing | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260731-Representing%20data%20Intake/README.md |
| DEP-A-20260802-Temporal Causal PFN | .lake-data/DEP-A/DEP-A-20260802-Temporal Causal PFN | Shared terms: causal, temporal | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260802-Temporal%20Causal%20PFN/README.md |
| DEP-E-20260730-Representing data by | .lake-data/DEP-E/DEP-E-20260730-Representing data by | Shared terms: data, representing | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260730-Representing%20data%20by/README.md |
...
|---|---|---|---|---|
| S1 | https://arxiv.org/html/2303.10112 | Full-paper text and section-level review | 2026-08-19 | Primary public locator; source file withheld locally. |
| S2 | https://arxiv.org/pdf/2303.10112 | PDF/source integrity status | 2026-08-19 | Primary public locator; source file withheld locally. |
| S3 | https://arxiv.org/abs/2303.10112 | Canonical metadata and stable identifier | 2026-08-19 | Metadata page only; not treated as the paper document. |
| S4 | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260731-Representing%20data%20Intake/README.md | Related DEP context: data, representing | 2026-08-19 | Repository file used for conceptual context. |
| S5 | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260802-Temporal%20Causal%20PFN/README.md | Related DEP context: causal, temporal | 2026-08-19 | Repository file used for conceptual context. |
| S6 | https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260730-Representing%20data%20by/README.md | Related DEP context: data, representing | 2026-08-19 | Repository file used for conceptual context. |
...
- https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260731-Representing%20data%20Intake/README.md — repository context entry `.lake-data/DEP-A/DEP-A-20260731-Representing data Intake`; selected for conceptual overlap indicated by data, representing; not used as primary evidence.
- https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-A/DEP-A-20260802-Temporal%20Causal%20PFN/README.md — repository context entry `.lake-data/DEP-A/DEP-A-20260802-Temporal Causal PFN`; selected for conceptual overlap indicated by causal, temporal; not used as primary evidence.
- https://github.com/Delphoa/Black-Lake/blob/main/.lake-data/DEP-E/DEP-E-20260730-Representing%20data%20by/README.md — repository context entry `.lake-data/DEP-E/DEP-E-20260730-Representing data by`; selected for conceptual overlap indicated by data, representing; not used as primary evidence.
