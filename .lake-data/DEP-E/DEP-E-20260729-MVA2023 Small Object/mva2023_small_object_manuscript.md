---
title: "MVA2023 Small Object - DEP-E"
generated_at: "2026-07-29 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of MVA2023 Small Object Detection Challenge for Spotting Birds: Dataset, Methods, and Results."
...
primary_url: "https://arxiv.org/abs/2307.09143"
stable_identifier: "arXiv:2307.09143; DOI:10.23919/MVA57639.2023.10215935"
deployment_job_id: "BLAD-2200-20260729-5EE3EF9C"
deployment_item_id: "BLAD-2200-20260729-5EE3EF9C-P10"
...
# MVA2023 Small Object - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2307.09143 | https://arxiv.org/abs/2307.09143 | Metadata only. | 2026-07-29 | Inspected |
| S2 | Full paper | Primary | HTML | 2307.09143 rendering | https://ar5iv.labs.arxiv.org/html/2307.09143 | Verified local copy withheld. | 2026-07-29 | Inspected in full |
| S3 | PDF | Primary | PDF | 2307.09143 | https://arxiv.org/pdf/2307.09143 | Verified local copy withheld. | 2026-07-29 | Integrity checked and sampled |
| S4 | HeightFormer Learning - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260728-HeightFormer Learning/heightformer_learning_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S5 | SSP Detection - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260711-SSP Oriented Detection/ssp_oriented_detection_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S6 | Visible-Thermal Tiny - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260724-Visible-Thermal Tiny/visible_thermal_tiny_manuscript.md` | Synthesis only. | 2026-07-29 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260729-5EE3EF9C-P10` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-07-29 | Verified |

Authors: Kondo, Yuki; Ukita, Norimichi; Yamaguchi, Takayuki; Hou, Hao-Yu; Shen, Mu-Yi; Hsu, Chia-Chi; Huang, En-Ming; Huang, Yu-Chen; Xia, Yu-Cheng; Wang, Chien-Yao; Lee, Chun-Yi; Huo, Da; Kastner, Marc A.; Liu, Tingwei; Kawanishi, Yasutomo; Hirayama, Takatsugu; Komamizu, Takahiro; Ide, Ichiro; Shinya, Yosuke; Liu, Xinyao; Liang, Guang; Yasui, Syusuke. Submitted/source date: 2023/07/18. Job `BLAD-2200-20260729-5EE3EF9C`; item `BLAD-2200-20260729-5EE3EF9C-P10`.
...
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: detection, object, vision | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies detection, object, small. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around detection, object, small. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.
...
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving detection, object, small. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 36,389 of 75,778 units; duplicate exclusions 0; source-gate exclusions 1; reselections 1.
...
- The related DEPs show how detection, object, vision connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: detection, object, vision.
...
|---|---|---|---|
| HeightFormer Learning - DEP-E | Related DEP | Overlap: object, vision, detection | `.lake-data/DEP-E/DEP-E-20260728-HeightFormer Learning/heightformer_learning_manuscript.md` |
...
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2307.09143 | Metadata and abstract | 2026-07-29 | Metadata only |
| R2 | https://ar5iv.labs.arxiv.org/html/2307.09143 | Full-paper method, evaluation, limitations, and conclusion | 2026-07-29 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2307.09143 | Primary paper integrity | 2026-07-29 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260728-HeightFormer Learning/heightformer_learning_manuscript.md` | Related synthesis: object, vision, detection | 2026-07-29 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260711-SSP Oriented Detection/ssp_oriented_detection_manuscript.md` | Related synthesis: object, detection | 2026-07-29 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260724-Visible-Thermal Tiny/visible_thermal_tiny_manuscript.md` | Related synthesis: object, detection | 2026-07-29 | Repository-relative |

## Appendix

- Uniform selected index: 36,389 of 75,778 units from 75,781 PDFs.
