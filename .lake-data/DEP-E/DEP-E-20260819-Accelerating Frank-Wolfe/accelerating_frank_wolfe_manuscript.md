---
title: "Accelerating Frank-Wolfe - DEP-E"
generated_at: "2026-08-19 (public-safe date; exact execution time withheld)"
artifact_type: "DEP research artifact"
primary_subject: "Source-grounded review of Accelerating Frank-Wolfe Algorithm using Low-Dimensional and Adaptive Data Structures."
...
primary_url: "https://arxiv.org/abs/2207.09002"
stable_identifier: "arXiv:2207.09002; DOI:10.48550/arXiv.2207.09002"
deployment_job_id: "BLAD-2200-20260819-8DFEF0DE"
deployment_item_id: "BLAD-2200-20260819-8DFEF0DE-P359"
...
# Accelerating Frank-Wolfe - DEP-E

## Source Metadata

| ID | Source | Role | Type | Identifier / Version | URL / Local Path | License / Usage Notes | Access Date | Status |
|---|---|---|---|---|---|---|---|---|
| S1 | arXiv record | Metadata | HTML | 2207.09002 | https://arxiv.org/abs/2207.09002 | Metadata only. | 2026-08-19 | Inspected |
| S2 | Full paper | Primary | HTML | 2207.09002 rendering | https://arxiv.org/html/2207.09002 | Verified local copy withheld. | 2026-08-19 | Inspected in full |
| S3 | PDF | Primary | PDF | 2207.09002 | https://arxiv.org/pdf/2207.09002 | Verified local copy withheld. | 2026-08-19 | Integrity checked and sampled |
...
| S6 | Accelerating Federated - DEP-E | Related | Markdown | DEP-E | `.lake-data/DEP-E/DEP-E-20260819-Accelerating Federated/accelerating_federated_manuscript.md` | Synthesis only. | 2026-08-19 | Inspected |
| S7 | Workflow evidence | Process | Private | `BLAD-2200-20260819-8DFEF0DE-P359` | Local path withheld | Selection, dedup, repair, and integrity. | 2026-08-19 | Verified |

Authors: Song, Zhao; Xu, Zhaozhuo; Yang, Yuanyuan; Zhang, Lichen. Submitted/source date: 2022/07/19. Job `BLAD-2200-20260819-8DFEF0DE`; item `BLAD-2200-20260819-8DFEF0DE-P359`.
...
| E3 | S2/S3 | Primary paper | Method material represented by “In this paper, we study the problem of speeding up a type of optimization algorithms called Frank-Wolfe, a …” | Mechanism | Medium-high | Implementation was not rerun |
| E4 | S2/S3 | Primary paper | Evaluation material represented by “In this paper, we study the problem of speeding up a type of optimization algorithms called Frank-Wolfe, a …” | Author-reported results | Medium | Measurements were not reproduced |
| E5 | S4, S5, S6 | Related DEP manuscripts | Shared concepts: accelerating, algorithm, low-dimensional | Cross-DEP synthesis | Medium | No joint experiment exists |

## Executive Summary

This paper studies accelerating, adaptive, algorithm. The complete source describes an identifiable problem, a named mechanism, an evaluation narrative, and limitations. The review preserves those elements as author claims tied to primary-paper evidence, not as independent reproduction. Its durable downstream value is an auditable evaluation pattern with provenance, baseline comparisons, uncertainty, abstention, and explicit failure boundaries.

## Detailed Summary

### Problem and background

The work is organized around accelerating, adaptive, algorithm. Its title, abstract, introduction, and related-work structure establish the target problem and motivate the proposed mechanism. The review treats that framing as source-supported context whose practical importance remains target-dependent.

### Method and mechanism

The method evidence is represented by “In this paper, we study the problem of speeding up a type of optimization algorithms called Frank-Wolfe, a …”. The full-paper rendering contains 169 section or heading markers, allowing the mechanism to be traced beyond the abstract. This review does not infer reproducibility from source availability alone.

### Evidence and results

The evaluation evidence is represented by “In this paper, we study the problem of speeding up a type of optimization algorithms called Frank-Wolfe, a …”. It remains author-reported because this run did not execute code, recreate data, or reproduce measurements. Transfer requires a fresh manifest, baseline parity, leakage checks, sensitivity tests, and documented acceptance criteria.

### Limitations and conclusion

The limitation evidence is represented by “In [ SSX21a ] , they solve the direction search problem via a reduction from nearest neighbor search …”. The paper's conclusion is retained within its reported setting; production readiness, external validity, and causal generalization remain unverified.

## Key Claims and Evidence

| Claim ID | Claim | Claim Type | Evidence | Reviewer Assessment | Confidence |
|---|---|---|---|---|---|
| C1 | The paper identifies a problem involving accelerating, adaptive, algorithm. | Author claim | E2 | Supported as source framing; practical importance remains target-dependent. | Medium-high |
...
- `Selection and dedup`: Draw 47,888 of 75,964 units; duplicate exclusions 7; focus exclusions 30; source-gate exclusions 0; reselections 37.
...
- The related DEPs show how accelerating, algorithm, low-dimensional connect the source to neighboring evidence and implementation choices.
...
- Connects to three repository artifacts with concrete shared terms: accelerating, algorithm, low-dimensional.
...
|---|---|---|---|
| Sample Complexity of - DEP-E | Related DEP | Overlap: low-dimensional | `.lake-data/DEP-E/DEP-E-20260819-Sample Complexity of/sample_complexity_of_manuscript.md` |
| Accelerating Min-Max - DEP-E | Related DEP | Overlap: accelerating, algorithm | `.lake-data/DEP-E/DEP-E-20260819-Accelerating Min-Max/accelerating_min_max_manuscript.md` |
| Accelerating Federated - DEP-E | Related DEP | Overlap: accelerating | `.lake-data/DEP-E/DEP-E-20260819-Accelerating Federated/accelerating_federated_manuscript.md` |

## Source References

| ID | Reference | Supports | Access Date | Notes |
|---|---|---|---|---|
| R1 | https://arxiv.org/abs/2207.09002 | Metadata and abstract | 2026-08-19 | Metadata only |
| R2 | https://arxiv.org/html/2207.09002 | Full-paper method, evaluation, limitations, and conclusion | 2026-08-19 | Verified local copy withheld |
| R3 | https://arxiv.org/pdf/2207.09002 | Primary paper integrity | 2026-08-19 | Verified local copy withheld |
| R4 | `.lake-data/DEP-E/DEP-E-20260819-Sample Complexity of/sample_complexity_of_manuscript.md` | Related synthesis: low-dimensional | 2026-08-19 | Repository-relative |
| R5 | `.lake-data/DEP-E/DEP-E-20260819-Accelerating Min-Max/accelerating_min_max_manuscript.md` | Related synthesis: accelerating, algorithm | 2026-08-19 | Repository-relative |
| R6 | `.lake-data/DEP-E/DEP-E-20260819-Accelerating Federated/accelerating_federated_manuscript.md` | Related synthesis: accelerating | 2026-08-19 | Repository-relative |

## Appendix

- Uniform selected index: 47,888 of 75,964 units from 75,967 PDFs.
